...
privacy-passwords-the-lock-means = O cadeado significa que o site que você está usando é criptografado, de modo que, mesmo que alguém esteja vigiando sua navegação na rede (como outra pessoa num ponto de acesso de WiFi público), essa pessoa não consegue ver sua senha. O { -brand-name-firefox } tenta te avisar quando você estiver prestes a inserir sua senha num site não criptografado.
