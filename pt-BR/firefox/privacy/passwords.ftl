...
privacy-passwords-the-lock-means = O cadeado significa que o site é criptografado, Assim, mesmo que alguém esteja vigiando sua navegação (por exemplo, em uma rede Wi-Fi pública), não consegue ver sua senha. O { -brand-name-firefox } te avisa quando você está prestes a inserir uma senha num site não criptografado.
...
privacy-passwords-when-youre-logged = Quando você entra no { -brand-name-firefox } com sua Conta { -brand-name-firefox }, pode sincronizar todos os seus dispositivos e acessar suas senhas em um navegador { -brand-name-firefox } móvel. Saiba mais sobre <a { $url_sumo-manager }>como usar o gerenciador de senhas integrado</a> ao máximo.
