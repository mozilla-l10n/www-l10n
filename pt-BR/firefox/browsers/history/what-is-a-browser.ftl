...
what-is-a-browser-most-major-web = A maioria dos principais navegadores web permitem aos usuários modificar sua experiência de uso através de extensões. Extensões são trechos de código que você pode adicionar em seu navegador para personalizar ou adicionar funcionalidades. Extensões podem fazer todo tipo de coisa, práticas e divertidas, como ativar novos recursos, incluir dicionários de idiomas estrangeiros, ou mudar a aparência e o tema.
what-is-a-browser-all-browser-makers = Todos os produtores de navegadores desenvolvem seus produtos para exibir imagens e vídeos o mais rápido possível e sem dificuldades, facilitando aproveitar a web ao máximo. Todos trabalham duro para garantir que os usuários tenham um navegador rápido, poderoso e fácil de usar. Como eles diferem, é importante escolher o navegador correto para você. A { -brand-name-mozilla } produz o { -brand-name-firefox } para garantir que os usuários tenham controle sobre suas vidas online e assegurar que a internet seja um recurso público e global, acessível a todos.
