...
compare-edge-firefox-makes-privacy-protection = O { -brand-name-firefox } torna a proteção de privacidade fácil e conveniente, para que você não precise se preocupar com isso.
compare-edge-we-block-trackers-by-default = Nós bloqueamos rastreadores por padrão. O Edge não.
compare-edge-and-we-make-it-easy-for-you = E facilitamos você escolher o mecanismo de pesquisa a ser usado sempre que fizer uma pesquisa. No Edge você precisa vasculhar nas configurações para usar um mecanismo de pesquisa diferente do Bing.
# Variables:
