...
firefox-browsers-join-firefox-and-get-the-most = Junte-se ao { -brand-name-firefox } e aproveite ao máximo todos os produtos — em todos os dispositivos.
# Variables:
#   $fxa_attr (string) - anchor link url and attributes
#   $accounts_attr (string) - anchor link url and attributes
firefox-browsers-already-have-an-account-sign = Já tem uma conta? <a { $fxa_attr }>Entre</a> ou <a { $accounts_attr }>saiba mais</a> sobre como se juntar ao Firefox.
