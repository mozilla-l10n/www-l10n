...
features-fingerprinting-the-practice-of = A prática de rastreamento de identidade digital permite que você seja <a { $url_tracked }>rastreado durante meses</a>, mesmo quando limpa o armazenamento do navegador ou usa o modo de navegação privativa, desprezando indicações claras suas de que não quer ser rastreado. Apesar de um acordo quase completo entre <a { $url_bodies }>órgãos</a> de <a { $url_standards }>normas</a> e <a { $url_vendors }>produtores</a> de <a { $url_browser }>navegadores</a> de que rastreamento de identidade digital é <a { $url_harmful }>prejudicial</a>, seu uso na web <a { $url_has }>tem</a> <a { $url_increased }>aumentado</a> <a { $url_steadily }>continuamente</a> ao longo da última década.
