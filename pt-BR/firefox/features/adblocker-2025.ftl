...
features-adblocker-using-an-adblocker = Usar um bloqueador de anúncios é simples. Muitas opções confiáveis estão disponíveis como extensões do navegador, facilitando encontrar uma solução que atenda o que você precisa. Por exemplo, o <a href="{ $firefox }">{ -brand-name-firefox }</a> oferece uma <a href="{ $addons }">lista de extensões aprovadas</a>, projetadas para melhorar sua experiência de navegação, respeitando sua privacidade.
