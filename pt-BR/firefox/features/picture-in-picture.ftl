...
features-pip-click-the-picture-in-picture-button = <strong>Clique no botão Picture-in-Picture</strong> que aparece sobre o vídeo e ele é destacado.
...
features-pip-repeat-steps-1-3-to-have = <strong>Repita as etapas 1 a 3</strong> para ter quantos vídeos picture-in-picture quiser.
