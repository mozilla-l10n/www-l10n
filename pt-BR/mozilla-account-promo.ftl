...
moz-account-already-have = Já tem uma conta? <a { $sign_in_url }>Entre</a> ou <a { $learn_more_url }>saiba mais</a> sobre a { -brand-name-mozilla }
moz-account-get-a-mozilla-account = Tenha uma { -brand-name-mozilla-account }
