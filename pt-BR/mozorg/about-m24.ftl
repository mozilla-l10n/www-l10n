...
# HTML Page title
m24-about-page-title = Saiba mais sobre a { -brand-name-mozilla }
# HTML page description
m24-about-page-desc = A { -brand-name-mozilla } faz navegadores, aplicativos, códigos e ferramentas que priorizam as pessoas, não o lucro. Nossa missão: Manter a internet aberta e acessível a todos.
