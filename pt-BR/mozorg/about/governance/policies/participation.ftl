...
participation-violence-and-threats-of = Violência e ameaças de violência não são aceitáveis, sejam online ou offline. Isso inclui incitação à violência contra qualquer indivíduo, inclusive incentivar a pessoa a agredir a si mesma. Isso também inclui publicar ou ameaçar publicar informações de identificação pessoal de outras pessoas ("doxxing") online.
...
participation-anyone-asked-to-stop = É esperado que, ao receber uma solicitação para interromper um comportamento inaceitável, isso seja feito imediatamente. Violação destas diretrizes pode resultar em receber solicitação de sair de um evento ou espaço online, temporariamente ou durante todo o evento, ou ser banido definitivamente de participação em espaços ou futuras atividades e eventos.
...
participation-additional-resources = Recursos adicionais: <a href="{ $url }">Como denunciar</a>
participation-questions-cpg-questionsmozillacom = Perguntas: <a href="{ $url }">cpg-questions@mozilla.com</a>
...
participation-1-the-anti-harassment = [1] A política antiassédio pode ser acessada pelos funcionários pagos <a href="{ $url }">aqui</a>.
