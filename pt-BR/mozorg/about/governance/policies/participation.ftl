...
participation-these-guidelines-outline = Estas diretrizes descrevem o comportamento esperado dos membros da comunidade { -brand-name-mozilla } em todas as atividades da { -brand-name-mozilla }, tanto offline como online. Sua participação depende de seguir estas diretrizes em todas as atividades da { -brand-name-mozilla }, incluindo, mas não limitado a:
