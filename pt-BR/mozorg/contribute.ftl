...
contribute-tag-individual-event = Participação individual e organização de eventos
contribute-tag-individual = Participação individual
contribute-tag-support = Suporte
contribute-task-translate-heading = Traduza conteúdo
contribute-task-translate-desc = A internet só é global se for entendida em todo lugar. Ajude-nos a traduzir os produtos e sites da { -brand-name-mozilla } para seu idioma local.
...
contribute-meet-volunteers = Conheça nossos apaixonados voluntários
...
contribute-made-by-desc-cont = Acreditamos que a colaboração da comunidade é vital para criar uma internet diversificada, inovadora e responsável para as pessoas que mais precisam dela. Quer você tenha experiência em tecnologia, organização de comunidades ou apenas um computador e algum tempo livre, pode nos ajudar a tornar a internet um lugar melhor.

## Newsletter

contribute-newsletter-heading = Ainda não tem certeza?
contribute-newsletter-sub-heading = Receba notícias sobre comunidades e contribuições em sua caixa de entrada
contribute-newsletter-desc = Inscreva-se no nosso boletim informativo, junte-se aos Mozillians do mundo todo e saiba mais sobre oportunidades impactantes para apoiar a missão da { -brand-name-mozilla }.
...
contribute-web-compat-desc = Caso sua experiência em um site seja diferente entre navegadores, você pode ter descoberto um problema de compatibilidade da web. Adoraríamos saber sobre isso!
