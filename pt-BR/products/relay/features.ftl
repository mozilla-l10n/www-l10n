...
highlighted-features-section-unlimited-masks-body-v2 =
    { $mask_limit ->
        [one] Todos podem ter { $mask_limit } máscara de email gratuitamente. Mas com o { -brand-name-relay-premium }, você pode gerar quantas máscaras precisar para ajudar a proteger sua caixa de entrada de email contra spam, hackers e rastreadores online.
       *[other]
