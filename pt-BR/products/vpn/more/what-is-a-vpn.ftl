...
vpn-what-is-its-very-hard = É muito difícil encontrar uma VPN confiável. Serviços de VPN têm o objetivo de proteger os usuários enquanto estão online, mas nem todos são iguais em relação ao que entregam. Ao escolher um serviço de VPN, tenha certeza de que entende com clareza os termos com os quais irá concordar. Muitos alegam ser ótimos e focados em privacidade, mas grande parte não cumpre suas promessas. Algumas VPNs registram sua atividade online para vender dados e informações para empresas de marketing. Outras tentam te convencer a instalar malware (código malicioso) nos seus dispositivos.
# Variables
#   $mozvpn (url) - https://www.mozilla.org/products/vpn/
...
vpn-what-is-weve-done-the = Nós nos empenhamos para assegurar que o <a href="{ $mozvpn }">{ -brand-name-mozilla-vpn }</a> realmente respeite sua privacidade. Estamos dispostos a apostar nossa reputação nisso. A { -brand-name-mozilla } é conhecida por desenvolver produtos que ajudam a manter suas informações protegidas. Seguimos nossos <a href="{ $principles }">princípios de privacidade de dados</a>, simples e transparentes, o que nos permite focar somente nas informações que precisamos para fornecer cada serviço. A tecnologia do { -brand-name-mozilla-vpn } é enxuta e moderna, de modo a oferecer aos usuários uma conexão de VPN veloz, com proteção e segurança completa. Como os fabricantes desta VPN são respaldados por uma empresa <a href="{ $mission }">guiada por uma missão</a>, pode ter certeza que o dinheiro que gastar neste produto irá não apenas garantir que você tenha uma VPN de primeira, mas também tornar a internet melhor para todos.
...
# Variables
#   $mozvpn (url) - https://www.mozilla.org/products/vpn/
vpn-what-is-vpns-can-be = VPNs podem ser usadas para proteger todos os seus dispositivos — computadores, notebooks, tablets e celulares. Se você acessa a internet não apenas pelo navegador, mas também por outros aplicativos, usar uma VPN é uma boa escolha para proteger sua privacidade e segurança em qualquer dispositivo. Para que uma VPN seja eficaz, é necessário instalar em cada dispositivo. O <a href="{ $mozvpn }">{ -brand-name-mozilla-vpn }</a>  oferece conexão ilimitada para até cinco dispositivos quando você se conecta à internet de qualquer aplicativo ou navegador.
vpn-what-is-mozilla-vpn-fast = { -brand-name-mozilla-vpn }: Rápido, seguro, confiável
# Variables
#   $mozvpn (url) - https://www.mozilla.org/products/vpn/
vpn-what-is-mozilla-vpn-is-a-v3 = O <a href="{ $mozvpn }">{ -brand-name-mozilla-vpn }</a> é um serviço em que você pode confiar para manter sua conexão com a internet segura em todos os seus dispositivos. Não mantemos registro de sua atividade de rede e não fazemos parceria com terceiros que traçam perfil do que você faz online. Em um mundo onde a imprevisibilidade se tornou o “novo normal”, sabemos que é mais importante que nunca você se sentir seguro e saber que o que faz online é da sua conta.
# Obsolete string
# Variables
#   $mozvpn (url) - https://www.mozilla.org/products/vpn/
vpn-what-is-mozilla-vpn-is-a-v2 = O <a href="{ $mozvpn }">{ -brand-name-mozilla-vpn }</a> é um serviço em que você pode confiar para manter sua conexão com a internet segura em todos os seus dispositivos. Não mantemos registro de sua atividade de rede e não fazemos parceria com terceiros que traçam perfil do que você faz online. Em um mundo onde a imprevisibilidade se tornou o novo normal…
# Obsolete string
# Variables
#   $mozvpn (url) - https://www.mozilla.org/products/vpn/
vpn-what-is-mozilla-vpn-is-a = O <a href="{ $mozvpn }">{ -brand-name-mozilla-vpn }</a> é um serviço em que você pode confiar para manter sua conexão de internet protegida em todos os seus dispositivos. Não guardamos registros de dados de usuários, nem fazemos parceria com plataformas analíticas de terceiros que querem traçar um perfil do que você faz online. Em um mundo onde a imprevisibilidade se tornou o “novo normal”, sabemos que é mais importante do que nunca você se sentir seguro e saber que o faz online é apenas da sua conta.
