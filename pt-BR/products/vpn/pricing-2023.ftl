...
vpn-pricing-access =
    { $servers ->
        [one] Acesse { $servers } servidor em mais de { $countries } países
       *[other] Acesse { $servers } servidores em mais de { $countries } países
    }
...
vpn-pricing-transaction-may-be-in = * A transação pode ser no equivalente em moeda local.
