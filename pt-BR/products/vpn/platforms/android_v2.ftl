...
vpn-android-low-video = Você tenha baixa qualidade de transmissão de vídeos devido a restrições de quantidade e velocidade do seu provedor de serviços de internet.
vpn-android-your-personal = Seus dados pessoais sejam roubados ao usar uma rede pública de WiFi.
vpn-android-why-should-i = Por que devo usar o { -brand-name-mozilla-vpn } para Android?
vpn-android-browse-the-internet = Navegue na internet sem revelar sua localização.
vpn-android-be-more-comfortable = Sinta-se mais confortável em usar redes públicas de WiFi em cafés, aeroportos e muito mais.
vpn-android-avoid-intrusive = Evite publicidade intrusiva com base em usa localização.
vpn-android-the-mozilla-vpn-mobile = O aplicativo para dispositivos móveis { -brand-name-mozilla-vpn } é pequeno, por isso não consome muita memória, não deixa o celular mais lento nem esgota a bateria.
vpn-android-unlike-free = Ao contrário de VPNs gratuitas ou sites de proxy, que podem pagar pelos servidores espionando você e vendendo suas informações, o { -brand-name-mozilla } não mantém registros de onde você vai nem do que você faz.
