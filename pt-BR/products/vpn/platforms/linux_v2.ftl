...
vpn-linux-mozilla-vpn = { -brand-name-mozilla-vpn } em Linux
vpn-linux-looking-for = Procura uma VPN para proteger seu Linux? O { -brand-name-mozilla-vpn } oferece o único serviço de uma empresa sem fins lucrativos. Saiba como uma VPN te protege e por que deve confiar na { -brand-name-mozilla } para sua privacidade e segurança.
vpn-linux-mozilla-vpn-on-linux = { -brand-name-mozilla-vpn } em Linux para ter uma internet mais privativa e segura
...
vpn-linux-multi-hop = <strong>Roteamento em saltos múltiplos:</strong> Para proteção adicional, o { -brand-name-mozilla-vpn } pode criptografar seu tráfego de rede e rotear através de dois locais, em vez de um, dificultando para qualquer um rastrear sua atividade online.
