...
vpn-shared-one-subscription-heading = Uma única assinatura para todos os seus dispositivos
vpn-shared-choose-a-plan-sub-heading = Escolha um plano que funciona para você
...
vpn-shared-increase-your-privacy = Aumente sua privacidade com { -brand-name-vpn } + { -brand-name-relay }
# Variables:
#   $url (string) - link to https://relay.firefox.com/premium/
vpn-add-relay-to-protect = Adicione o { -brand-name-firefox-relay } à sua assinatura para proteger seu email e número de celular. <a href="{ $url }">Saiba mais</a>.
# Variables:
...
vpn-shared-unsupported-language-warning = Atualmente o { -brand-name-mozilla-vpn } não é oferecido em { $idioma }, mas você pode usar em inglês, francês, alemão, espanhol e <a { $href }>mais de 30 outros idiomas</a> .
# Variables
