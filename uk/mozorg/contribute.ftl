...
contribute-mission-desc = Наша місія — зробити Інтернет загальним суспільним ресурсом, відкритим та доступним для всіх. Інтернет, який по-справжньому ставить людей на перше місце, де люди можуть формувати свій власний досвід і отримують повноваження, безпеку та незалежність.
