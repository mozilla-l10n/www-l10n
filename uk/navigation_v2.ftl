...
navigation-v2-protect-your-browsers-connection = Захистіть з’єднання браузера з Інтернетом.
navigation-v2-mdn-plus = { -brand-name-mdn-plus }
navigation-v2-new-features-and-tools = Нові функції та інструменти для персоналізованої роботи з { -brand-name-mdn }
navigation-v2-view-all-products = Переглянути всі прдукти

## Who We Are menu

navigation-v2-who-we-are = Хто ми
navigation-v2-close-who-we-are-menu = Закрити меню Хто ми
...
navigation-v2-check-out-the-home-for-web = Завітайте до домівки джерел для веброзробників.
navigation-v2-firefox-reality = { -brand-name-firefox-reality }
navigation-v2-explore-the-web-with-the = Досліджуйте Інтернет за допомогою браузера { -brand-name-firefox } для віртуальної реальності.
...
navigation-v2-more-mozilla-innovation = Більше нововведень { -brand-name-mozilla }
