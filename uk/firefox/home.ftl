...
firefox-home-get-trackers-off = Заблокуйте понад 2000 елементів стеження — включаючи { -brand-name-facebook }
...
firefox-home-start-sending-files = Почніть безпечно надсилати файли
...
firefox-home-one-login-all-your = Один вхід. Усі ваші пристрої. Продукти, що поважають вашу <strong>приватність</strong>.
...
firefox-home-download-the-app = Завантажити додаток
