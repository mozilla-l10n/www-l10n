...
welcome-page1-find-ways-to-protect-your = Знайдіть способи захисту ваших даних за допомогою <a href="{ $security_tips }">{ -brand-name-monitor }порад щодо безпеки</a>.
welcome-page1-stay-in-the-know = Будьте в курсі
...
welcome-page1-were-you-one-of-many = Чи були ви одним зі 100,985,047 запрошених <a href="{ $evite_breach }">на “свято” викрадених даних</a>?
welcome-page1-why-am-i-seeing-this = Чому я це бачу?
