...
firefox-sync-all-you-need = Все, що вам потрібно для { -brand-name-firefox-sync(case: "gen", capitalization: "lower") } – це { -brand-name-firefox-account(case: "nom", capitalization: "lower") }.
...
firefox-sync-enter-an-email = Введіть адресу електронної пошти та пароль, щоб <strong>“Створити { -brand-name-firefox-account(case: "nom", capitalization: "lower") }.”</strong>
...
firefox-sync-learn-more = Додаткова допомога в керуванні вашим { -brand-name-firefox-account(case: "abl", capitalization: "lower") }
