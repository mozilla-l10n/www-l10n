...
firefox-privacy-hub-firefox-products-are-designed = Продукти { -brand-name-firefox } створено для захисту вашої <strong>приватності</strong>
...
firefox-privacy-hub-keep-it-safe = Зберігайте їх у безпеці
firefox-privacy-hub-we-do-the-hard-work-to-protect = Ми робимо багато роботи для захисту вашої особистої інформації
firefox-privacy-hub-data-security-is-complicated = Захист даних є складним — або, принаймні, таким повинен бути. Ось чому ми робимо додаткові кроки для класифікації даних, які ми маємо, дотримуємось правил збереження та захисту кожного типу даних і постійно вдосконалюємо ці процеси. Ми ставимо вашу приватність понад усе. Ми інвестуємо в це. Ми дотримуємось цього. Ми навіть навчаємо інші компанії як це робити.
firefox-privacy-hub-no-secrets = Нічого не приховуємо
firefox-privacy-hub-youll-always-know-where-you = Ви завжди знатимете про всі наші дії
# Variables:
#   $privacy (url) - link to https://www.mozilla.org/privacy/firefox/
firefox-privacy-hub-theres-no-hidden-agenda-here-v2 = Ми нічого не приховуємо. Наш бізнес не залежить від прихованого зловживання вашою довірою. Наше <a href="{ $privacy }">Положення про приватність</a> викладено зрозумілою мовою. Якщо ви хочете дізнатися найдетальніші подробиці про дані, які ми збираємо, наш відкритий код, як і ми, до ваших послуг.
# Obsolete string
# Variables:
#   $privacy (url) - link to https://www.mozilla.org/privacy/firefox/
...
firefox-privacy-hub-because-we-put-people-first = Тому що ми ставимо людей на перше місце. Нас підтримує <a href="{ $foundation }">некомерційна організація</a>. Від початку, нашою місією є захист Інтернету та всіх, хто користується ним.
firefox-privacy-hub-learn-more-about-our-mission = Докладніше про нашу місію
firefox-privacy-hub-your-privacy-by-the-product = Ваша приватність у різних продуктах
firefox-privacy-hub-firefox-products-work-differently = Продукти { -brand-name-firefox } працюють інакше, оскільки їх створено для захисту вашої приватності.
firefox-privacy-hub-learn-about-our-products = Докладніше про наші продукти
firefox-privacy-hub-firefox-privacy-by-the = Приватність продуктів { -brand-name-firefox }
# Obsolete string
firefox-privacy-hub-firefox-protects-your-privacy = { -brand-name-firefox } захищає вашу приватність у всіх продуктах.
firefox-privacy-hub-mozilla-protects-your-privacy = { -brand-name-mozilla } захищає вашу приватність у всіх продуктах.
# Obsolete string
firefox-privacy-hub-firefox-protects-your-privacy-strong = { -brand-name-firefox }  <strong>захищає</strong> вашу приватність у всіх продуктах.
firefox-privacy-hub-mozilla-protects-your-privacy-strong = { -brand-name-mozilla }  <strong>захищає</strong> вашу приватність у всіх продуктах.
...
firefox-privacy-hub-if-you-want-to-see-what = Якщо ви хочете побачити, що блокує для вас { -brand-name-firefox }, відвідайте цю сторінку зі свого браузера { -brand-name-firefox } для комп'ютера.
...
firefox-privacy-hub-download-the-firefox-browser = Завантажити { -brand-name-firefox }
firefox-privacy-hub-update-your-firefox-browser = Оновити свій { -brand-name-firefox }
firefox-privacy-hub-invisible-to-the-top-trackers = Невидимий для найпоширеніших елементів стеження
firefox-privacy-hub-meet-four-of-the-most-common = Зустрічайте чотири найпоширеніші категорії елементів стеження, які не дістануться до вас.
...
firefox-privacy-hub-when-you-enter-your-email-v2 = Коли ви вводите свою електронну адресу до { -brand-name-mozilla-monitor }, ми відразу забуваємо її після перевірки на наявність у відомих витоках даних, якщо ви не надаєте нам дозвіл на продовження перевірки нових витоків на наявність там вашої приватної інформації.
firefox-privacy-hub-check-for-breaches = Перевірити на витік даних
firefox-privacy-hub-firefox-lockwise = { -brand-name-firefox-lockwise }
firefox-privacy-hub-the-passwords-and-credentials = Паролі та облікові дані, які ви зберігаєте в { -brand-name-firefox-lockwise }, зашифровано на всіх ваших пристроях, тож навіть ми не можемо їх побачити.
firefox-privacy-hub-firefox-send = { -brand-name-firefox-send }
firefox-privacy-hub-we-cant-see-the-names-or = Ми не можемо побачити імена чи вміст великих файлів, якими ви ділитесь через { -brand-name-firefox-send }, оскільки їх зашифровано наскрізним шифруванням — ви вибираєте, хто бачить, що ви надсилаєте та навіть можете встановити термін дії та пароль.
firefox-privacy-hub-send-a-file = Надіслати файл
...
#   $class_name (string) - CSS class name for sign in link
#   $learn_more (url) - link to https://www.mozilla.org/firefox/accounts/
firefox-privacy-hub-already-have-an-account = Уже маєте обліковий запис? <a { $sign_in } class="{ $class_name }">Увійдіть</a> або <a href="{ $learn_more }">дізнайтеся більше</a> про те, як приєднатися до { -brand-name-firefox }.
# Variables:
#   $url (url) - link to https://www.mozilla.org/privacy/firefox/
firefox-privacy-hub-read-the-privacy-notice-for = Ознайомтеся з <a href="{ $url }">Положенням про приватність</a> для наших продуктів
firefox-privacy-hub-mozilla-vpn = { -brand-name-mozilla-vpn }
firefox-privacy-hub-surf-stream-and-get-work = Перегляд, потокове відео та виконання роботи на серверах у понад 30 країнах для безпечного Інтернет-зв’язку з новою перспективою.
firefox-privacy-hub-get-mozilla-vpn = Отримати { -brand-name-mozilla-vpn }
