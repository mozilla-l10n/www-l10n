...
misinformation-tracking-advertising = Можливо, ви чули про відстеження насамперед у контексті оголошень. Однак це також потужний засіб, коли йдеться про поширення неправдивої інформації. Чому так? Коли ви переглядаєте Інтернет або стрічку соціальних мереж, ваша поведінка, інтереси, контакти в деяких випадках та багато іншого відстежуються різними сторонами на вебсайтах, щоб створити надзвичайно детальний профіль про вас, який можна продавати іншим без вашого відома чи згоди. Ці профілі застосовуються для персоналізованої реклами, але можуть також служити для представлення вам будь-якої цільової інформації.
...
misinformation-known-to-br-credible = Чи воно відоме та чи заслуговує довіри? Якщо ви не впевнені, спробуйте дізнатися більше про джерело та його репутацію в Інтернеті.
