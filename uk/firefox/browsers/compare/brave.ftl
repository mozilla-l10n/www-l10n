...
compare-brave-when-comparing-the-two-browsers = Якщо порівнювати ці браузери, то { -brand-name-firefox } і { -brand-name-brave } пропонують достатній рівень приватності й безпеки, доступний автоматично після першого ж запуску.
