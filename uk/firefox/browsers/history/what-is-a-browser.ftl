...
what-is-a-browser-websites-save = Вебсайти зберігають інформацію про вас у файлах під назвою <a href="{ $cookies }">куки</a>. Вони зберігаються на вашому комп’ютері до наступних відвідин цих сайтів. Після повернення, код вебсайту прочитає цей файл, щоб впевнитися, що це ви. Наприклад, ви переходите на вебсайт і сторінка запам'ятовує ваше ім’я користувача та пароль — це можливо завдяки кукам.
what-is-a-browser-there-are-also = Також є куки, які зберігають детальнішу інформацію про вас. Можливо, ваші інтереси, ваші звички під час перегляду Інтернету тощо. Це означає, що сайт може показати вам відповідніший вміст — часто у вигляді реклами. Існують типи куків, які називаються <em>сторонніми</em> куками, які встановлюються сайтами, які ви навіть не відвідували та можуть стежити за вашими діями в Інтернеті, для збору інформації про вас, яку іноді продають іншим компаніям. Існують можливості блокування таких куків, але не в усіх браузерах.
what-is-a-browser-when-you-go-to = Коли ви переходите на вебсайт і сторінка запам'ятовує ваші ім’я користувача та пароль — це можливо завдяки кукам.
