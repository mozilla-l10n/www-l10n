...
# Outdated string
mobile-focus-focus-blocks-the = { -brand-name-focus } блокує рекламу, яку ви зазвичай бачите на вебсторінках, без жодних додатків чи розширень. Зі зменшенням кількості оголошень зростає швидкість завантаження сторінок, тож ви значно швидше дістаєтеся потрібних матеріалів.
mobile-focus-focus-blocks-the-v2 = { -brand-name-focus } блокує рекламу, яка намагається стежити за вами між вебсторінками, без жодних додатків чи розширень. Зі зменшенням кількості оголошень зростає швидкість завантаження сторінок, тож ви значно швидше дістаєтеся потрібних матеріалів.
mobile-focus-see-it-all = Пришвидшення перегляду
# Outdated string
mobile-focus-focus-removes-trackers = { -brand-name-focus } прибирає елементи стеження та оголошення, тому сторінки, які ви переглядаєте, використовують менше даних і завантажуються значно швидше.
