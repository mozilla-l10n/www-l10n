...
mobile-focus-delete-your-history = Видаліть свою історію
...
mobile-focus-private-browsing-on-v2 = “Приватний перегляд” у більшості браузерів насправді не такий вже й приватний. { -brand-name-firefox-focus } — пропонує вищий рівень приватності типово й підтримуваний { -brand-name-mozilla }, некомерційною організацією, яка бореться за ваші права в інтернеті.
...
mobile-focus-focus-blocks-the-v2 = { -brand-name-focus } блокує рекламу, яка намагається стежити за вами на вебсторінках — без жодних додатків чи розширень. Зі зменшенням кількості оголошень ви отримуєте зростання швидкості завантажень сторінки, а це означає, що ви набагато швидше дістаєтеся до потрібного вмісту.
