...
mobile-android-got-lots-of = У вас багато відкритих вкладок? Немає проблем, упорядкуйте їх у збірки, щоб продовжувати роботу. Збірками також можна надсилати на інші пристрої, щоб ви могли продовжувати переглядати сайти, незалежно від того, яким пристроєм ви користуєтесь.
mobile-android-supercharge-firefox-with = Суперзаряд { -brand-name-firefox } за допомогою додатків
mobile-android-addons-are-like = Додатки — це як потужні маленькі інструменти, які ви можете додати до свого браузера, наприклад, щоб розширити типові налаштування приватності та налагодити свою роботу.
mobile-android-pick-up-where = Продовжуйте звідти, де зупинилися
mobile-android-go-from-your = Переходьте від телефону до ноутбука, планшета та назад, не пропускаючи жодного моменту. Завдяки { -brand-name-firefox } на всіх ваших пристроях ви можете брати свої закладки, паролі, збережені дані для входу та історію перегляду куди б ви не пішли.
mobile-android-search-from-your = Шукайте з головного екрана телефона
mobile-android-no-need-to = Відкривати застосунок не потрібно. Додайте віджет пошуку { -brand-name-firefox } і виконайте пошук в інтернеті безпосередньо з головного екрана вашого пристрою.
