...
whatsnew-s2d-download-firefox-for-android = Завантажте { -brand-name-firefox } для { -brand-name-android } та { -brand-name-ios }
whatsnew-s2d-want-privacy-on-every-device = Хочете приватності на кожному пристрої?
...
whatsnew-s2d-qr-code-alt = Сканувати QR-код
