...
firefox-is-independent = { -brand-name-firefox } — незалежний браузер та підтримуваний некомерційною організацією { -brand-name-mozilla } яка бореться за ваші права в Інтернеті та робить Інтернет доступним для кожного та скрізь.
...
the-firefox-browser = Браузер { -brand-name-firefox } створено для захисту вашої приватности на кожному кроці — адже це найшвидший спосіб позбавити вас від повільних завантажень, поганих оголошень та елементів стеження.
firefox-is-more = { -brand-name-firefox } — більше, ніж браузер
its-a-lightning = Це блискавичні двері до найкращої роботи в Мережі.
...
firefox-doesnt-spy = { -brand-name-firefox } не стежить за пошуковими запитами. Ми зупиняємо відомі сторонні куки стеження і надаємо вам повний контроль.
