...
features-memory-chrome-uses-up-to-177x-more = <a href="{ $url }">{ -brand-name-chrome } використовує до 1.77 рази більше пам'яті, ніж { -brand-name-firefox }</a>. Якщо вашому комп'ютеру вже не вистачає пам'яті, то це може спричинити помітне сповільнення. Використовуючи найновішу версію { -brand-name-firefox } з багатопроцесним режимом, ви можете звільнити більше пам'яті для роботи потрібних програм.
features-memory-browse-faster-privately = Працюйте швидше, з більшою приватністю
# Variables:
