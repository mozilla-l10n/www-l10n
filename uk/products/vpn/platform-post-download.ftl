...
vpn-windows-download-page-title = Звантажити { -brand-name-mozilla-vpn } для { -brand-name-windows }
vpn-windows-downloading-mozilla-vpn = Звантаження { -brand-name-mozilla-vpn } для { -brand-name-windows }…
...
vpn-enter-your-email = Введіть адресу електронної пошти, щоб увійти або зареєструватися та розпочати
