...
vpn-landing-privacy-desc = Переглядайте, транслюйте, грайте та виконуйте роботу, зберігаючи приватність в Інтернеті. Незалежно від того, подорожуєте ви, користуєтесь загальнодоступним WiFi або просто шукаєте більшої безпеки в Інтернеті, ми завжди ставимо вашу приватність понад усе.
...
vpn-landing-faq-uses-question-desc = Оскільки повсякденне життя відбувається через Інтернет, приватність та безпека в Інтернеті стають ще важливішими. VPN, <a href="{ $url }">Віртуальна приватна мережа</a>, може допомогти вам створити безпечне приватне з’єднання з Інтернетом. Це працює, створюючи "тунель" між вашим пристроєм та Інтернетом у цілому і захищає вас двома важливими способами:
...
vpn-landing-faq-uses-examples = Ознайомтеся з <a href="{ $url }">п’ятьма справжніми прикладами</a>, які допоможуть вам захотіти мати VPN на своєму пристрої.
