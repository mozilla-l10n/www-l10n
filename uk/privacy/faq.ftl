...
privacy-faq-mozilla-doesnt-know-as-much = { -brand-name-mozilla } знає про те, що люди роблять в інтернеті не настільки багато, як вам могло здаватися. Як для компанії, що розробляє браузер, це насправді є складним завданням. Ось чому ми розробили інструменти, такі як <a href="{ $link }">{ -brand-name-firefox } Pioneer</a>, які дозволяють зацікавленим користувачам надавати нам розуміння про роботу їхнього браузера. Якщо ви синхронізуєте дані { -brand-name-firefox } між різними пристроями, ми не маємо доступу до них і не можемо дізнатися їх вміст, тому що всі дані шифруються на ваших пристроях і передаються в зашифрованому вигляді.
