...
navigation-v2-get-the-customizable-mobile = 下載適用於 { -brand-name-android } 智慧型手機，可自訂各種功能的行動瀏覽器。
...
navigation-v2-firefox-for-mobile = { -brand-name-firefox-browser }行動版
navigation-v2-take-speed-privacy-and = 帶上速度、隱私與平靜的心靈。提供 { -brand-name-android } 與 { -brand-name-ios } 版本。
...
navigation-v2-use-ai-to-detect = 使用 AI 偵測虛假評論與詐騙內容
...
navigation-v2-impact = 影響
navigation-v2-find-out-how = 看看我們如何讓網際網路變得更有包容性、更可持續
