...
privacy-firefox-transparency-first = 透明第一
# Variables:
...
privacy-firefox-how-we-use-v2 = 預設就保護隱私
# Obsolete string (expires: 2026-02-10)
...
privacy-firefox-firefox-protects-you = { -brand-name-firefox } 保護您不受已知的第三方追蹤器、社群網路追蹤器、加密貨幣採礦程式、Cookie 與數位指紋追蹤追蹤技術，嘗試在網站間窺探您的影響。
...
privacy-firefox-lost-in-the = 太多詳細資訊了嗎？回到 <a { $attrs }>{ -brand-name-firefox } 隱私權基本資訊</a>。
