...
footer-privacy = 隱私權
footer-press = 媒體中心
footer-brand-standards = 品牌設計準則
footer-browsers = Firefox 瀏覽器
footer-desktop = 桌面
footer-mobile = 行動裝置
...
footer-portions-of-this-content = 本頁的部分內容著作權為 ©1998–{ $current_year } 由個別 mozilla.org 貢獻者所有，使用<a rel="license" href="{ $url }">創用 CC 授權條款</a>授權大眾使用。
footer-mozilla = { -brand-name-mozilla }
footer-company = 公司
footer-about = 關於我們
footer-press-center = 新聞中心
footer-careers = 徵才
footer-test-new-features = 測試新功能
