...
m24-about-a-group-of = 一群思想家在場地上圍成一圈分享點子。
...
m24-about-we-uncover-insights = 我們發掘符合您興趣的意見、活動來改善產品並推行政策。
# Obsolete string (expires: 2025-02-03)
...
# Used as an accessible text alternative for an image
m24-about-rise25-award = { -brand-name-rise25 } 得獎者指著她的戰利品。
m24-about-empowering-chicagos-entrepreneurs = 賦權於芝加哥的創業者，進行世代交替
# Used as an accessible text alternative for an image
m24-about-chicago = 來自芝加哥的創業者。
...
# Used as an accessible text alternative for an image
m24-about-alt-trustworthy = 可信任的 AI、{ -brand-name-common-voice }、Fedated Learning。
# Used as an accessible text alternative for an image
m24-about-alt-conversation = { -brand-name-mozilla } 員工進行對話。
# Used as an accessible text alternative for an image
m24-about-alt-drinking-coffee = { -brand-name-mozilla } 員工在喝咖啡。
# Used as an accessible text alternative for an image
m24-about-alt-collaborating = { -brand-name-mozilla } 的員工。
...
m24-about-community-love-v2 = 社群的愛是我們的動力
# Obsolete string (expires: 2025-02-03)
...
# Used as an accessible text alternative for an image
m24-about-alt-community = 有筆記本電腦包與 { -brand-name-mozilla } 掛鍊的人。
