...
manifesto-details-the-mozilla-project-global-v2 = { -brand-name-mozilla } 專案為全球性社群，成員們信奉開放、創新及機會是網際網路健全發展的關鍵因素。我們自 1998 年起為確保網際網路的發展裨益全民而生，以創作 { -brand-name-mozilla } { -brand-name-firefox } 網頁瀏覽器聞名。
...
manifesto-details-the-mozilla-project-community-v2 = { -brand-name-mozilla } 專案以社群力量建立世界一流的開放源碼軟體，並開創各種新式的合作活動；成員們志同道合，為了提昇全民的網路體驗而努力。
# Obsolete string (expires 2026-09-20)
