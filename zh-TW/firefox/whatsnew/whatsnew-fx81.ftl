...
# html page title
whatsnew81-page-title = { -brand-name-firefox } 有什麼新鮮事？
# Main title
whatsnew81-main-title = 在各種裝置上都有全新 { -brand-name-firefox }
whatsnew81-main-intro = 不論您用的是哪套作業系統，都有個比以往更好，由非營利組織全力相挺的行動瀏覽器可以安裝使用。
whatsnew81-send-form-label = 請輸入您的電子郵件信箱，即可收到下載鏈結
whatsnew81-send-form-label-alt = 請輸入您的電子郵件信箱或手機號碼，即可取得下載鏈結
