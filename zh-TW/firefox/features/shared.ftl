...
features-shared-bookmark-manager = 書籤管理員
features-shared-private-browsing-mode = 隱私瀏覽模式
features-shared-firefox-add-ons-and-browser-extensions = { -brand-name-firefox } 附加元件與瀏覽器擴充套件
features-shared-pinned-browser-tabs = 釘選的瀏覽器分頁
features-shared-eyedropper-tool = 滴管工具
features-shared-pdf-editor = PDF 編輯器
