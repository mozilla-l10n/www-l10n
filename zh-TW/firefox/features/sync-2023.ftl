...
features-sync-sign-up-for-a-free-mozilla-account-v3 = <a href="{ $fxa }">註冊免費的 { -brand-name-mozilla-account }</a>，即可在所有使用 { -brand-name-firefox } 與其他 { -brand-name-mozilla } 產品的地方之間同步資料。
# Obsolete string
