...
features-adblocker-there-are-many = 有許多廣告封鎖工具等您探索。每種工具都提供符合不同偏好的功能。這取決於您的需求與上網習慣。以下是一些您需要考慮的小秘訣:
features-adblocker-tip-1 = <strong>封鎖廣告</strong>若您只想要封鎖廣告也可以選擇簡單輕量的選項。
features-adblocker-tip-2 = <strong>關注隱私</strong>
features-adblocker-tip-3 = <strong>可自訂性</strong> 某些廣告封鎖器可讓您將特定網站列入白名單或封鎖特定元素。
features-adblocker-tip-4 = <strong>裝置相容性:</strong> 考慮您需要的是在桌面版、行動版或兩者皆可使用。
features-adblocker-tip-5 = <strong>Malware Blocking:</strong> 某些廣告封鎖器可保護您不受惡意廣告的影響。
features-adblocker-tip-6 = <strong>家長控制:</strong>若您想要封鎖不適當的內容就可以使用。
...
features-adblocker-tool-1 = <strong>標準模式:</strong> 是一個相當平衡的選項可封鎖常見追踪器同時保持網站功能正常。
features-adblocker-tool-2 = <strong>嚴格模式:</strong> 非常適合需要封鎖更多追踪器與 Cookie 來加強保護隱私的使用者。請注意某些網站在此模式中可能需要調整。
features-adblocker-tool-3 = <strong>自訂模式:</strong> 若您想要完全自行控制您的使用者可在自訂模式中選擇要封鎖哪些東西、Cookie、追踪器等等。
