...
firefox-privacy-hub-all-tech-companies-collect = 所有科技公司為了改善產品都會收集各種資料，但不需要包含這麼多關於您的個人資訊。我們只收集對您有用的資料就夠了。我們也時常問自己: 真的需要這些資料嗎？這些資料用來做什麼？什麼時候可以刪除這些資料？
...
firefox-privacy-hub-theres-no-hidden-agenda-here = 這裡沒有不成文的規定。我們的營運並不依賴於偷偷濫用您對我們的信任。我們的<a href="{ $privacy }">隱私權公告</a>好讀易懂；世上的每一個人都能參與我們的<a href="{ $meetings }">公司內部週會</a>。若您想了解我們收集的每一個資料點，程式碼是開放的，我們也是。
...
firefox-privacy-hub-mozilla-protects-your-privacy = { -brand-name-mozilla } 在每套產品中都保護您的隱私權。
# Obsolete string
firefox-privacy-hub-firefox-protects-your-privacy-strong = { -brand-name-firefox } 在每套產品中都<strong>保護</strong>您的隱私權。
firefox-privacy-hub-mozilla-protects-your-privacy-strong = { -brand-name-mozilla } 在每套產品中都<strong>保護</strong>您的隱私權。
...
firefox-privacy-hub-when-you-enter-your-email-v2 = 當您把 E-Mail 信箱輸入到 { -brand-name-mozilla-monitor }，我們會檢查是否有相關的資料外洩事件，然後自動忘記您輸入的內容。除非您授權我們持續為您監控資料外洩事件，不然不會保留。
# Obsolete string
