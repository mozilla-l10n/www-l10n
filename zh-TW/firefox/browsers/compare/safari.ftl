...
compare-safari-screenshots-is-another-popular = <a { $attrs }>Screenshots</a> 是另一套直接內建於 { -brand-name-firefox } 瀏覽器的熱門功能，讓您可以簡單地拍攝畫面擷圖。拍攝後可以選擇要複製檔案，或是想要將檔案儲存到哪個資料夾，而不讓桌面變得凌亂。
