...
compare-opera-switching-to-firefox-is-easy = 很簡單又快速就能改用 { -brand-name-firefox } — 只要滑鼠一點即可匯入您的 Opera 書籤、密碼、瀏覽紀錄、偏好設定，立即開始使用 { -brand-name-firefox }。以下是<a { $howto }>如何使用「匯入」按鈕進行切換的方法</a>。
