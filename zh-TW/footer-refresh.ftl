...
footer-refresh-mozilla-advertising = { -brand-name-mozilla } 廣告
...
footer-refresh-visit-mozilla-corporations-v2 = 造訪<a { $moco_link }>{ -brand-name-mozilla-corporation }</a>的非營利母公司<a { $mofo_link }>{ -brand-name-mozilla-foundation }</a>。
