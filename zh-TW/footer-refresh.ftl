...
footer-refresh-find-out-about = 了解 { -brand-name-mozilla } 的產品、計畫與更多資訊。我們絕對不會賣掉您的信箱就算是提供您終生免費的比薩。
...
footer-refresh-x = X
footer-refresh-x-formerly-twitter = X（原 Twitter）
...
footer-refresh-follow-firefox = 關注 @{ -brand-name-firefox }
footer-refresh-youtube = YouTube
footer-refresh-company = 公司
footer-refresh-press-center = 新聞中心
footer-refresh-careers = 徵才啟事
footer-refresh-contact = 聯絡人
footer-refresh-support = 技術支援
...
footer-refresh-portions-of-this-content = 本頁的部分內容著作權為 ©1998–{ $current_year } 由個別 mozilla.org 貢獻者所有。內容依照 <a rel="license" { $href }>{ -brand-name-creative-commons } 授權條款</a>授權大眾使用。
footer-refresh-websites-privacy-notice = 網站隱私權保護政策
