...
moz-account-promo-title = 單次登入。 <br> <span { $class }>一切</span> { -brand-name-mozilla }。
# Variables
#   $sign_in_url - link to
#   $learn_more_url - link to https://www.mozilla.org/en-US/firefox/accounts/
moz-account-already-have = 已經有帳號了嗎<a { $sign_in_url }>登入</a>或<a { $learn_more_url }>了解</a> { -brand-name-mozilla } 的更多資訊
moz-account-get-a-mozilla-account = 註冊 { -brand-name-mozilla-account }
