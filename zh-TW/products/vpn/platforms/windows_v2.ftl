...
vpn-windows-get-a-vpn = 透過 { -brand-name-mozilla } 下載 Windows 平台的 VPN
...
vpn-windows-stay-safe = 安裝 VPN 後在您的 Windows 裝置上保持安全
...
vpn-windows-avoid-your-online = 避免您的線上活動被收集或提供給第三方或廣告商。
