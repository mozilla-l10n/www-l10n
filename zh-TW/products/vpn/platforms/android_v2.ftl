...
vpn-android-low-video = 由於您的網路供應商 (ISP) 限制了頻寬且速度較慢降低影音串流畫質
vpn-android-your-personal = 使用公共 Wi-Fi 網路時您的個人資料被盜取。
vpn-android-why-should-i = 為什麼我要下載 { -brand-name-mozilla-vpn } for Android？
vpn-android-browse-the-internet = 上網不送出所在地點。
vpn-android-be-more-comfortable = 在網吧、機場等場所使用公共 Wi-Fi 時更自如。
vpn-android-avoid-intrusive = 避免煩人的地理位置廣告。
vpn-android-the-mozilla-vpn-mobile = { -brand-name-mozilla-vpn } 行動應用程式體型小不會佔用您太多記憶體、也不會拖慢手機或消耗電池。
