...
vpn-landing-easy-firefox-integration = 透過 { -brand-name-firefox } 的擴充套件輕鬆整合 { -brand-name-mozilla-vpn } （僅 Windows）
...
# HTML for emphasis
vpn-landing-powered-by-mozilla-fighting-for = <strong>由 { -brand-name-mozilla } 提供。</strong>自 1998 年起，就為了您的隱私權而戰。
