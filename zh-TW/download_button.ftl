...
download-button-supported-devices = 支援裝置
download-button-whats-new = 新鮮事
download-button-systems-languages = 其他系統與語言
download-button-recommended = 推薦
# Variables:
...
download-button-app-store = { -brand-name-app-store } 免費下載
...
download-button-linux-32 = 下載 { -brand-name-linux } 32 位元
download-button-linux-64 = 下載 { -brand-name-linux } 64 位元
# Variables
#   $attrs (attrs) - link to https://support.mozilla.org/kb/install-firefox-linux#w_install-firefox-deb-package-for-debian-based-distributions
# Note: Debian and Ubuntu are brand names and shouldn't be translated
download-button-using-debian = 使用 Debug、Ubuntu 或任何以 Debug 為基礎的發行版
