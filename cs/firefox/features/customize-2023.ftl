...
features-customize-you-can-find-more-free-custom = Další bezplatné motivy najdete na <a { $amo }>addons.mozilla.org</a>. Prohlédněte si <a { $top }">nejlépe hodnocené</a>, <a { $trending }>populární</a> a <a { $recommended }>nejdoporučovanější</a> motivy. Nebo hledejte motivy podle kategorií, například <a { $music }>hudba</a>, <a { $seasonal }>sezónní</a>, <a { $sports }>sport</a> a <a { $nature }>příroda</a>. Přizpůsobte si zážitek svému vkusu. Roztomilá zvířátka, zlí roboti, krásná krajina - existují tisíce možností, jak si { -brand-name-firefox } upravit podle svého.
# Used as accessible alternative text for an image
