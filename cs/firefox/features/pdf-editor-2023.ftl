...
# page title
pdf-editor-add-text-to-pdfs-v2 = Upravujte zdarma soubory PDF s editorem PDF ve { -brand-name-firefox(case: "loc") }
...
pdf-editor-add-image-with-alt-text = Přidá obrázek s náhradním textem
