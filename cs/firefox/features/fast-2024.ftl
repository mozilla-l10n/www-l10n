...
features-fast-faster-every-day = Každý den rychlejší
features-fast-firefox-is-powered-by-the-world = { -brand-name-firefox } je poháněn prvotřídním jádrem { -brand-name-gecko }, s úžasně rychlým stylem a rozložením stránek, moderními funkcemi JavaScriptu a nikdy nekončícím rytmem nových vylepšování, které si udržují šťastný a posouvat webovou platformu vpřed.
# Variables
#   $link (url) - link to https://hacks.mozilla.org/2023/10/down-and-to-the-right-firefox-got-faster-for-real-users-in-2023/
features-fast-all-browsers-had-to-make = Všechny prohlížeče musely provést vylepšení, aby si vedly dobře v nových testech Speedometru 3. Zejména { -brand-name-firefox } udělal obrovské pokroky, protože <a { $link }>byl znatelně rychlejší</a> pro naše uživatele jako přímý výsledek této práce. { -brand-name-firefox } je rychlejší než kdykoli předtím. Opravdu cítit, včetně rychlejšího načítání stránek a plynulejších interakcí.
