...
features-pip-new-feature-firefox-multi-picture = Nová funkce: Více obrazů v obraze ve { -brand-name-firefox(case: "loc") }
...
features-pip-click-the-picture-in-picture-button = <strong>Klikněte na tlačítko Obraz v obraze</strong> nacházející se na videu, a to se vysune ze stránky.
