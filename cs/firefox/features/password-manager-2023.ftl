...
password-manager-with-a-free-firefox-account = S <a href="{ $fxa }">bezplatným { -brand-name-firefox-account(case: "ins", capitalization: "lower") }</a> můžete bezpečně synchronizovat svoje hesla na všech svých zařízeních.
