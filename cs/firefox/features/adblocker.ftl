...
features-adblocker-how-to-block-annoying = Jak blokovat obtěžující reklamy pomocí blokátoru reklam
features-adblocker-how-to-stop-seeing-too = Jak zatočit s reklamami a zabránit společnostem ve sledování? Návod na blokování reklam od webového prohlížeče { -brand-name-firefox }.
...
features-adblocker-one-of-the-most-popular = Jedním z nejpopulárnějších blokátorů reklam pro { -brand-name-chrome }, { -brand-name-safari } a { -brand-name-firefox } je <a href="{ $url }">AdBlock</a>. Ten používejte k blokování reklam na { -brand-name-facebook }u, { -brand-name-youtube } a { -brand-name-hulu }.
...
features-adblocker-on-firefox-you-can-use = Ve { -brand-name-firefox }u můžete pomocí nastavení <a href="{ $privacy }">soukromí</a> nebo <a href="{ $blocking }">blokování obsahu</a> získat ještě větší kontrolu nad reklamními sledovacími prvky, které vám reklamy předkládají.
features-adblocker-choose-your-level-of-protection = Vyberte si úroveň ochrany
features-adblocker-to-start-click-on-the = Začněte ve { -brand-name-firefox }u klepnutím na tlačítko nabídky nacházející se v pravém horním rohu obrazovky. Vypadá jako tři čárky naskládané nad sebou. V rozbalovací nabídce klepněte na položku Blokování obsahu. Měli byste spatřit modré vyskakovací okno s různými možnostmi výběru.
...
features-adblocker-if-seeing-too-many-ads = Pokud vám koukání na příliš mnoho reklam kazí den, bude pro vás přísné nastavení vhodnější. Tento režim zablokuje známé sledovací prvky a cookies třetích stran ve všech oknech { -brand-name-firefox }u.
...
features-adblocker-in-firefox-you-can-block = Ve { -brand-name-firefox }u můžete zablokovat všechny cookies třetích stran nebo jen ty, které jsou ukládány sledovacími prvky. Pamatujte, že po zablokování všech cookies nemusí některé funkce webových stránek správně fungovat.
