...
firefox-more-little-book = Malá kniha o soukromí
...
we-compare-firefox = Porovnáváme { -brand-name-firefox(case: "acc") } s { -brand-name-chrome(case: "ins") }, { -brand-name-edge(case: "ins") }, { -brand-name-safari(case: "ins") }, { -brand-name-opera(case: "ins") }, { -brand-name-brave(case: "ins") } a { -brand-name-ie(case: "ins") }, abychom vám pomohli s rozhodováním..
comparing-firefox-chrome = Porovnání { -brand-name-firefox-browser(case: "gen", capitalization: "lower") } s { -brand-name-google } { -brand-name-chrome(case: "ins") }
...
be-free-to = Opěvujte klidně { -brand-name-firefox(case: "acc") }, kdykoli se vám zachce.
...
firefox-more-fingerprinting-is-a = Vytváření otisku prohlížeče je invazivní technika vašeho sledování bez použití běžných cookies – proto ji { -brand-name-firefox-browser(capitalize: "lower") } blokuje.
