...
privacy-passwords-when-youre-logged-v2 = Když jste přihlášeni k { -brand-name-firefox(case: "dat") } pomocí svého { -brand-name-mozilla-account(case: "gen") }, můžete synchronizovat svá hesla ve všech svých zařízeních a přistupovat k nim z mobilního prohlížeče { -brand-name-firefox }. . Přečtěte si více o tom, <a { $url_sumo_manager }>jak využívat vestavěného správce hesel na maximum</a>.
...
#   $url_sumo_2fa (string) - link to https://support.mozilla.org/kb/secure-firefox-account-two-step-authentication with additional attributes for analytics
privacy-passwords-your-mozilla-account = Například váš { -brand-name-mozilla-account } může být chráněn pomocí dvoufázového ověření, o kterém se více můžete dozvědět <a { $url_sumo_2fa }>zde</a>.
