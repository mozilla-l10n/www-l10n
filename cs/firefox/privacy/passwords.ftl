...
privacy-passwords-your-browser-also = Prohlížeč vás také průběžně informuje o důvěryhodnosti stránek, aby vám pomohl chránit se před phishingem. Na jedné straně, když se pokusíte navštívit webovou stránku, o které je známo, že je phishingová, zobrazí Firefox (a jakýkoli jiný hlavní prohlížeč) varování na celé obrazovce - dávejte pozor a dvakrát si rozmyslete, zda takovou stránku použijete!
