...
firefox-products-download-lockwise = Stáhnout { -brand-name-lockwise }
firefox-products-open-in-firefox = Otevřít ve { -brand-name-firefox }u
firefox-products-learn-more-about-lockwise = Zjistěte více o { -brand-name-lockwise }
...
firefox-products-get-pocket = Získejte { -brand-name-pocket }
firefox-products-learn-more-about-pocket = Zjistěte více o službě { -brand-name-pocket }
firefox-products-join-firefox-and-get-the-most = Přihlaste se k { -brand-name-firefox }u a využívejte naše produkty na maximum — na všech zařízeních.
# Variables:
#   $fxa_attr (string) - anchor link url and attributes
#   $accounts_attr (string) - anchor link url and attributes
firefox-products-already-have-an-account-sign = Už máte účet? <a { $fxa_attr }>Přihlaste se</a> nebo <a { $accounts_attr }>zjistěte více</a> o připojení se do { -brand-name-firefox }u.
