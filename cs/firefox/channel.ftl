...
firefox-channel-be-among-the-first-to-explore = Buďte první, kdo si může vyzkoušet budoucí verze { -brand-name-firefox }u pro počítač, { -brand-name-android } a { -brand-name-ios }.
...
firefox-channel-try-new-features-in-a-pre = Vyzkoušejte nové funkce v nefinální verzi prohlížeče pro { -brand-name-android } | { -brand-name-firefox }
firefox-channel-download-and-test-future = Stáhněte a vyzkoušejte budoucí verze { -brand-name-firefox }u pro počítač, { -brand-name-android } a { -brand-name-ios }.
firefox-channel-experience-cutting-edge-android-updated = Vyzkoušejte nejnovější funkce ještě než se dostanou do finální verze prohlížeče pro { -brand-name-android }: { -brand-name-firefox-beta } a { -brand-name-firefox-nightly }. Nainstalujte si ho hned teď!
firefox-channel-experience-cutting-edge-android = Vyzkoušejte nejnovější funkce ještě než se dostanou do finální verze prohlížeče pro { -brand-name-android }: { -brand-name-firefox-beta }, { -brand-name-firefox-aurora } a { -brand-name-firefox-nightly }. Nainstalujte si ho hned teď!
firefox-channel-download-and-test-the-latest-android = Stáhněte a vyzkoušejte nejnovější funkce { -brand-name-firefox }u pro { -brand-name-android } s verzemi { -brand-name-aurora }, { -brand-name-beta } a nebo { -brand-name-nightly }.
firefox-channel-try-the-latest-android-features = Vyzkoušejte nejnovější funkce Firefoxu pro { -brand-name-android } dříve, než je spatří ostatní.
...
firefox-channel-try-new-features-in-a-pre-release = Vyzkoušejte nové funkce v nefinální verzi prohlížeče pro { -brand-name-ios } | { -brand-name-firefox }
firefox-channel-experience-cutting-edge-features-ios = Vyzkoušejte si nejnovější funkce ještě než se dostanou do finální verze prohlížeče pro { -brand-name-ios } pomocí programu { -brand-name-apple } { -brand-name-test-flight }. Nainstalujte si ho hned teď!
firefox-channel-test-beta-versions-of-firefox-ios-long = Vyzkoušejte betaverze { -brand-name-firefox }u pro { -brand-name-ios } v programu { -brand-name-apple } { -brand-name-test-flight } a pomozte nám vylepšit mobilní prohlížeč pro váš { -brand-name-iphone }, { -brand-name-ipad } a iPod touch.
firefox-channel-test-flight = { -brand-name-test-flight }
firefox-channel-test-beta-versions-of-firefox-ios = Vyzkoušejte betaverze { -brand-name-firefox }u pro { -brand-name-ios } v programu { -brand-name-apple } { -brand-name-test-flight }.
