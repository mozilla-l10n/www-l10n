...
compare-chrome-switching-to-firefox-is-easy = Přechod na { -brand-name-firefox(case: "acc") } je snadný a rychlý – importujte své záložky, hesla, historii a nastavení z Chromu jedním klepnutím a buďte připraveni { -brand-name-firefox(case: "acc") } okamžitě používat. Podívejte se, <a { $howto }>jak přejít z Chromu na { -brand-name-firefox(case: "acc") }</a>.
