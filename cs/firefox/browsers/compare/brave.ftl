...
compare-brave-switching-to-firefox-is-easy = Přechod na { -brand-name-firefox(case: "acc") } je snadný a rychlý – naimportujte si své záložky, hesla, historii a nastavení z Brave jedním kliknutím a buďte připraveni { -brand-name-firefox(case: "acc") } okamžitě používat. Zde se dozvíte, <a { $howto }>importovat data z Brave</a>.
