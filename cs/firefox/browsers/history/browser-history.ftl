...
browser-history-netscape-created = Společnost { -brand-name-netscape } vytvořila a uvolnila JavaScript, který webovým stránkám poskytl dosud nevídané výpočetní možnosti. (Vytvořili také nechvalně proslulou <a href="{ $blink }">značku &lt;blink&gt;</a>.) { -brand-name-microsoft } odpověděl kaskádovými styly (CSS), které se staly standardem tvorby webových stránek.
