...
browser-history-other-competitors = Koncem 90. let a počátkem nového tisíciletí se objevili další konkurenti, včetně prohlížečů { -brand-name-opera }, { -brand-name-safari } a { -brand-name-google } { -brand-name-chrome }. S vydáním systému { -brand-name-windows } 10 v roce 2015 byl { -brand-name-ie } nahrazen prohlížečem { -brand-name-microsoft } { -brand-name-edge }.
browser-history-browsing-the-web = Prohlížení webu dnes
# Variables:
#   $applications (url) - https://blog.mozilla.org/firefox/no-judgment-digital-definitions-app-vs-web-app/
browser-history-today-there-are = Dnes existuje jen několik způsobů přístupu na internet. Hlavními konkurenty jsou { -brand-name-firefox }, { -brand-name-google } { -brand-name-chrome }, { -brand-name-microsoft } { -brand-name-edge }, { -brand-name-safari } a { -brand-name-opera }. V posledním desetiletí se jako preferovaný způsob přístupu na internet prosadila mobilní zařízení. Dnes většina uživatelů internetu používá k přístupu na internet pouze mobilní prohlížeče a <a href="{ $applications }">aplikace</a>. Mobilní verze hlavních prohlížečů jsou k dispozici pro zařízení se systémy { -brand-name-ios } a { -brand-name-android }. Tyto aplikace jsou sice velmi užitečné k určitým účelům, ale poskytují pouze omezený přístup k webu.
