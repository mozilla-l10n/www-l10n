...
browsers-mobile-see-how-firefox-for-desktop-stacks-v2 = Podívejte se, jak si { -brand-name-firefox } pro počítač stojí v porovnání s ostatními prohlížeči.
...
browsers-mobile-see-how-firefox-for-desktop-strong-v2 = Podívejte se, jak si { -brand-name-firefox } pro <strong>počítač</strong> stojí v porovnání s ostatními prohlížeči.
# Obsolete string (expires 30 June 2024)
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words; please omit the strong tags if they need to be around multiple words in your language.
