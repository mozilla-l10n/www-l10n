...
welcome-page5-with-256-bit-encryption-your = Vaše hesla jsou na cestě mezi vašimi zařízeními zabezpečena 256-bitovým šifrováním.
welcome-page5-no-more-making-up-new-passwords = Konec vymýšlení nových hesel
welcome-page5-lockwise-will-recommend-new = { -brand-name-lockwise } pro vás vytvoří nové a silné heslo, kdykoliv si budete potřebovat založit nový účet.
welcome-page5-help-during-a-breach = Pomoci při úniku dat
welcome-page5-lockwise-will-let-you-know = { -brand-name-lockwise } vás upozorní, pokud budou vaše přihlašovací údaje součástí nějakého úniku dat, takže je můžete rychle změnit.
welcome-page5-why-am-i-seeing-this = Co to je?
