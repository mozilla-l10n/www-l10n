...
# Obsolete
nightly-whatsnew-every-6-to-8-weeks = Každých 6 až 8 týdnů vychází nová hlavní verze { -brand-name-firefox(case: "gen") } a v důsledku toho i nová verze { -brand-name-nightly(case: "gen") }.
