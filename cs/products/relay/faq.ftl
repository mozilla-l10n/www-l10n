...
faq-question-longevity-question = Co se stane, když { -brand-name-mozilla } službu { -brand-name-firefox-relay } vypne?
...
faq-question-acceptable-use-answer-measure-account-v2 = Vyžaduje { -brand-name-mozilla-account } s ověřenou e-mailovou adresou
# Obsolete string
...
phone-masking-faq-question-how-i-save-card = Jak uložím kartu kontaktu služby { -brand-name-relay }?
phone-masking-faq-answer-how-i-save-card = Po upgradu na maskování telefonních čísel pomocí služby { -brand-name-relay } vám zašleme textovou zprávu s kartou kontaktu, která obsahuje číslo, z něhož budete dostávat přesměrované hovory a textové zprávy, podobně jako jakákoli karta kontaktu, která uchovává telefonní čísla osob, které vás kontaktují. Ve většině zařízení můžete tuto kartu kontaktu vybrat a uložit ji jako jakýkoli jiný kontakt v telefonu.
