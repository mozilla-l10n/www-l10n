...
vpn-landing-faq-compatibility-question-desc-mac-v4 = <a { $url }>{ -brand-name-mac }</a> ({ $minversion } a vyšší)
# Obsolete string
# Variables:
#   $url (url) - link to https://www.mozilla.org/products/vpn/desktop/mac/
...
vpn-landing-faq-compatibility-question-desc-ios-v4 = <a href="{ $url }">{ -brand-name-ios }</a> ({ $version } a vyšší)
# Obsolete string
# Variables:
#   $url (url) - link to https://www.mozilla.org/products/vpn/mobile/ios/
...
vpn-landing-faq-compatibility-question-desc-linux-v4 = <a href="{ $url }">Linux</a> (Ubuntu 20.04 a vyšší)
# Obsolete string
#   $url (url) - link to https://www.mozilla.org/products/vpn/desktop/linux/
...
vpn-landing-faq-download-heading = Jak si mohu stáhnout aplikaci { -brand-name-mozilla-vpn }, když už mám tuto síť předplacenou?
# Variables:
#   $attrs (string) - link href and additional HTML attributes
vpn-landing-faq-download-desc = Navštivte její <a { $attrs }>stránku ke stažení</a>, nainstalujte si síť { -brand-name-mozilla-vpn } do svého zařízení a poté se přihlaste pomocí svého { -brand-name-firefox-account(case: "gen", capitalization: "lower") }.
