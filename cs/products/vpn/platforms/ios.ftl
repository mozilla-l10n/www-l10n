...
# Meta strings
vpn-ios-page-title = { -brand-name-mozilla-vpn } pro { -brand-name-ios } ({ -brand-name-iphone } a { -brand-name-ipad })
vpn-ios-page-description = Pořiďte si rychlé a snadné zabezpečení svého { -brand-name-iphone(case: "gen") } nebo { -brand-name-ipad(case: "gen") } prostřednictvím { -brand-name-mozilla(case: "gen") }, jedné z nejdůvěryhodnějších značek na poli technologií.
# Mobile strings
vpn-ios-hero-headline = Chraňte se na internetu pomocí sítě { -brand-name-mozilla-vpn } pro { -brand-name-ios(case: "acc") }
vpn-ios-ability = Se sítí { -brand-name-mozilla-vpn } se budete na internetu cítit v bezpečí před hackery a zvědavci – doma i na cestách. Za nízký měsíční poplatek bude na vašem { -brand-name-iphone(case: "loc") }, { -brand-name-ipad(case: "loc") } a většině dalších zařízení šifrovat osobní data prostřednictvím pokročilého protokolu { -brand-name-wireguard }®, takže budete moci streamovat pořady, hrát hry, nakupovat a žít si svůj každodenní online život s vědomím, že jste v bezpečí.
...
vpn-ios-wifi-copy = Používáte veřejnou wifi? Žádný problém. Díky síti { -brand-name-mozilla-vpn } si můžete klidně zkontrolovat svůj bankovní účet v kavárně, upravovat hesla na rohu ulice – v podstatě můžete bez obav dělat vše, co běžně děláte na { -brand-name-iphone(case: "loc") } nebo { -brand-name-ipad(case: "loc") }.
