...
# Meta strings
vpn-mobile-page-title = { -brand-name-mozilla-vpn } pro mobily (chytré telefony a tablety)
...
vpn-mobile-wifi-headline = Mějte při používání veřejné sítě Wi-Fi pocit bezpečí
vpn-mobile-wifi-copy = Naše VPN slouží vašemu internetovému připojení jako štít, takže můžete nakupovat v kavárně, kontrolovat svůj bankovní účet ve vlaku a kdekoli se věnovat svým online záležitostem s vědomím, že je vaše IP adresa chráněna.
