...
vpn-linux-looking-for = Hledáte VPN pro ochranu svého počítače s Linuxem? { -brand-name-mozilla-vpn } nabízí jedinou službu od neziskové společnosti. Přečtěte si, jak vás VPN chrání a proč byste měli důvěřovat { -brand-name-mozilla } pro vaše soukromí a bezpečnost.
...
vpn-linux-additional-security = <strong>Další bezpečnostní funkce:</strong> Pomocí blokování DNS blokujeme reklamy, sledovací prvky a malware. Zatímco prohlížeč může zabránit pouze webovým stránkám, aby vám poskytovaly malware a sledovaly vás.
