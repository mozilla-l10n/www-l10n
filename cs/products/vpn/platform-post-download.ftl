...
vpn-download-faq-visual-indicators-v2 = { -brand-name-mozilla-vpn } zobrazuje svůj aktuální stav na liště a na domovské obrazovce. Díky tomu snadno poznáte, zda je vaše online aktivita chráněna či nikoliv. Tyto indikátory vám umožňují potvrdit, že je vaše navigace soukromá a bezpečná. Až budete připojeni, můžete navštívit <a href="{ $monitor }">https://monitor.mozilla.org/</a> a ověřit, zda je vaše IP adresa maskovaná. Další podrobnosti naleznete v části <a href="{ $connected }">Jak poznám, že je { -brand-name-mozilla-vpn } připojena?</a>.
# Obsolete string
# Variables:
#   $connected (url) - link to https://support.mozilla.org/kb/how-can-i-tell-if-mozilla-vpn-connected
