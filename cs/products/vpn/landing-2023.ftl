...
vpn-landing-how-a-vpn-helps-you-v2 = Jak vám { -brand-name-mozilla-vpn } pomůže
...
# HTML for emphasis
vpn-landing-powered-by-mozilla-fighting-for = <strong>Od { -brand-name-mozilla(case: "gen") }.</strong> Bojujeme za vaše právo na soukromí už od roku 1998.
