...
vpn-features-features-that-protect = Funkce, které <br> chrání váš život online
vpn-features-convenient = Pohodlí
# Variables
...
vpn-features-see-our-list = Podívejte se na náš seznam serverů.
# Variables:
...
vpn-features-with-the-mozilla-vpn-extention = Pomocí rozšíření { -brand-name-mozilla-vpn } pro { -brand-name-firefox } (pouze pro Windows) můžete vyladit práci s VPN pro jednotlivé webové stránky. Vylučte jednotlivé webové stránky z ochrany VPN nebo nastavte preferovaná umístění serverů pro konkrétní weby, čímž získáte flexibilnější a personalizovanější prostředí.
...
vpn-features-reviewed-by-third = Zkontrolováno bezpečnostními experty třetích stran
# Variables
#   $report (url) - link to https://blog.mozilla.org/mozilla/news/mozilla-vpn-completes-independent-security-audit-by-cure53
vpn-features-weve-been-audited = Byli jsme auditováni Cure53, přední společností zabývající se auditem kybernetické bezpečnosti. <a { $report }>Podívejte se na hlášení</a>.
vpn-features-people-over-profits = Lidé nad ziskem
# Variables
#   $mofo (url) - link to https://www.mozillafoundation.org/
# Obsolete string (expires 19-10-2025)
vpn-features-were-backed-by-mofo = Stojí za námi <a { $mofo }>{ -brand-name-mozilla-foundation }</a>, nezisková organizace bojující za zachování otevřeného a zdravého webu pro všechny lidi.
vpn-features-were-backed-by-mofo-v2 = Stojí za námi <a { $mofo }>{ -brand-name-mozilla-foundation }</a>, nezisková organizace bojující za zachování otevřeného a zdravého webu pro všechny lidi.
