...
privacy-firefox-firefox-protects-you = { -brand-name-firefox } vás chrání před známými sledovacími prvky třetích stran, sledovacími prvky sociálních médií, kryptoměnami, soubory cookie a technologiemi snímání otisků, které se vás snaží sledovat na webu.
