...
manifesto-details-the-mozilla-project-global-v2 = { -brand-name-mozilla } Project je celosvětová komunita lidí, kteří věří, že otevřenost, inovace a příležitosti jsou klíčem k dalšímu zdraví internetu. Pracujeme společně od roku 1998, abychom zajistili, že se internet vyvíjí cestou, která vyhovuje všem. Jsme známí především díky vytvoření webového prohlížeče { -brand-name-mozilla } { -brand-name-firefox }.
...
manifesto-details-the-mozilla-project-community-v2 = Projekt { -brand-name-mozilla } využívá metody založené na lidech k vytvoření celosvětového software s otevřeným zdrojovým kódem a vyvíjí nové typy aktivit pro spolupráci. Vytváříme komunity lidí, kteří se podílí na vylepšování internetu pro nás pro všechny.
# Obsolete string (expires 2026-09-20)
