...
home-that-one-time = Jednoho dne jsme zpřístupnili náš zdrojový kód…
...
home-today-mozilla-continues = Dnes { -brand-name-mozilla } pokračuje ve své snaze za lepší internet s miliony aktivních členů komunity po celém světě, kteří se zasazují o etické technologie, důvěryhodnou umělou inteligenci a tvorbu produktů, které se zaměřují na ochranu soukromí a dávající lidem více kontroly.
