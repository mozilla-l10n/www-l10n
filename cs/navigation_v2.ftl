...
navigation-v2-product-promise = Slib našich produktů
navigation-v2-learn-how-each-firefox-product = Zjistěte, jak každý produkt { -brand-name-firefox } chrání a respektuje vaše data.
...
navigation-v2-gather-in-this-interactive-online = Navštivte tento interaktivní, online a vícedimenzionální prostor.
