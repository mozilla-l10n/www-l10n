...
navigation-refresh-landmark-label = Hlavní
...
navigation-refresh-mozilla-new-products = Nové produkty { -brand-name-mozilla(case: "gen") }

## Firefox

navigation-refresh-firefox-browsers = Prohlížeče { -brand-name-firefox }
navigation-refresh-close-firefox-browsers-menu = Zavře nabídku prohlížeče { -brand-name-firefox }
navigation-refresh-firefox-for-desktop = { -brand-name-firefox } pro počítač
navigation-refresh-firefox-for-android = { -brand-name-firefox } pro { -brand-name-android(case: "acc") }
navigation-refresh-firefox-for-ios = { -brand-name-firefox } pro { -brand-name-ios(case: "acc") }
navigation-refresh-firefox-focus = { -brand-name-firefox-focus }
navigation-refresh-firefox-relay = { -brand-name-firefox-relay }
navigation-refresh-all-products = Všechny produkty
