...
data-preferences-mozilla-uses = { -brand-name-mozilla } oipuru { -brand-name-glean } ombyaty hag̃ua ojepurúva mba’ekuaarã ñanduti renda pegua mozilla.org mba’éva ohechauka hag̃ua rome’ẽha puruhárape mba’e porã oike vove ñandutípe. { -brand-name-glean } nomoherakuãi marandu oimeraẽva ndive. Peteĩteĩva mba’ekuaarã rombyatýva katuete ohasa heta jehechajey rire. Ikatu eñemomaranduve mba’eichaguaite mba’ekuaarãpa umi rombyatýva <a href="{ $dictionary }">{ -brand-name-glean } Ñe’ẽryru</a>. Eñemomaranduve hag̃ua mba’éichapa rojapo ha romoherakuã ne marandu { -brand-name-mozilla } ñanduti rendápe, emoñe’ẽkuaa ore <a href="{ $privacy_notice }"> Ñanduti renda marandu’i ñemigua, momarandu ha kookie</a>.
