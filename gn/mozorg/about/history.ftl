...
history-new-versions-of-firefox = Upete guive, oñemoasãi memete { -brand-name-firefox } hekopyahúva ha ko’ẽreíre osẽ tenondete. Pe { -brand-name-firefox } ojekuaa rupive oipypytyvõ poruhárape oiporavojey hag̃ua.
# Variables:
...
history-the-mozilla-community-together = { -brand-name-mozilla } rekoha, ambue apopyrã ijayvu jurujáva ndive ha ambue tendaguasu pytyvõhárarava, omba’apóva tapichakuéra omongu’éva umi ore rembipota añetehápe rehehápe.
# Variables:
...
history-the-history-of-firefox-and = <a href="{ $link }">Umi { -brand-name-firefox } ra’ãngaguasu rembiasakue ha { -brand-name-mozilla }</a> (oĩva inglés ha Japón ñe’ẽme)
