...
vpn-or-proxy-when-you-use-firefox = Eiporúvo <a href="{ $firefox }"> { -brand-name-firefox }</a>, pe <a href="{ $etp }">ñemo’ã tapykuehoha iporãvéva rovake</a> ojoko ijehegui heta <a href="{ $trackers }"> ñanduti rapykuehoha mbohapyháva</a> nde rapykuehóva ñandutípe. Hákatu ápe oĩ mba’e iporãva: ne ñanduti me’ẽhára (ISP), ehepyme’ẽva ñandutípe eikekuaa hag̃ua, ikatu gueteri nde recha ha nde rapykueho.
vpn-or-proxy-because-your-internet = Nde jeike Ñandutípe oku’e ne mba’e’oka gotyo ha guive (mohendaha, pumbyry, TV ha tabléta) ISP rupive, ha’ekuéra ohecha nde jeike ñandutípe. ISP ikatu ohecha tenda eikeha, mboy aravópa eiporu, ne rendaite ha marandu ne mba’e’oka rehegua. ISP ikatu ndoikuaái mba’emimivéva ejapova’ekue umi tendápe (mba’épa ejogua, eheka térã emoñe’ẽ) papapy reko rupive, hákatu oikuaáta katuete nde rehegua umi tenda eikehague rupive. Umi mba’ekuaarã nemba’eteéva oiporukuaa omoheñói hag̃ua mba’ete japuguáva nde reheguaite. ¿Mba’érepa umi ISP ikatu ojapo umíva? Mbykymi: ko’ã mba’ekuaarã iporã añetehápe.
vpn-or-proxy-isps-can-use = Umi ISP ojeporukuaa ko marandu imaranduñemurã térã viru ñembyatyrã oikekuaahápe marandu moherakuã mbohapyháva ndive oipotáva mba’ekuaarã, marketing ha marandu ñemurã, he’iséva tekorosã’ive ha jehapykueho. Pe ñeikundaha tekoñemi ayvúpe nomboykéi umi ISP ohechávo moõpa oho ñandutípe. Hákatu emondóvo tembiapo ñandutípe peteĩ proxy térã VPN ikatu ombohasyve.
vpn-or-proxy-when-should-you = ¿Araka’épa eiporavóta VPN térã proxy hekorosãva?
vpn-or-proxy-vpns-and-secure = VPN ha ñanduti proxy hekorosãva ohupytyse peteĩ mba’e: oikéta tekorosãme. Ikatu, ha ojapo, IP kundaharape ypygua ha omo’ã ñandutípe jeike nendive ha VPN me’ẽhára térã pe proxy hekorosãva. Hákatu ¿araka’épa eiporukuaa VPN térã proxy?
...
vpn-or-proxy-firefox-private-network = <a href="{ $fpn }">{ -brand-name-firefox-private-network }</a> ha’e kundahára jepysokue hasy’ỹva iñemohenda ome’ẽkuaáva tapeyvyguy hekorosã ha ipapapýva ñandutíre omo’ã hag̃ua kundahárape jeike eiporu eiporuhápe { -brand-name-firefox }. Ipya’e ha ndahasýi imyandy eiporuse vove ereko hag̃ua tekorosãve ne kundahárape.
...
vpn-or-proxy-a-vpn-also = VPN ome’ẽ tekorosã WiFi opavave oiporukuaa ha ijurujávape jeike. WiFi pyha ijurujáva imarãkuaa ha hasyeterei eikuaa hag̃ua ambue oikéramo nde eike aja oikuaaségui mba’etépa ejapo eike jave ñandutípe. Jepémo nde jeike ipapapy, ikatu gueteri ohecha umi tenda eikeha. Ha reiporúramo peteĩ tembiporu’i ipapapy’ỹva — ko ára rupi, heta ndoguerekóiva — upévare ikatu ojehecha opaite mba’e ejapóva pe tembiporu’ípe. { -brand-name-mozilla-vpn } ha’e mba’eporurã ipya’éva, hekorosã ha jeroviaha ne pytyvõkuaáva emboty hag̃ua tekorosã ndéve g̃uarã. <a href="{ $mozvpn }">{ -brand-name-mozilla-vpn }</a> avei omoneĩ eiporavokuaa hag̃ua ne “rendaite” (moõguipa ou pe ne rembiapo) hetave { $countries } tetãnguéra pa’ũgui.
vpn-or-proxy-choose-a-trustworthy = Eiporúvo mba’eporu jeroviaha
# Variables
...
vpn-or-proxy-the-most-important = Tuichave mba’éva pe eiporavóvo peteĩ VPN térã proxy ha’e eiporavoha mba’apohaguasu ojejeroviaha. Eñeha’ãke eikũmby porã mba’etépa pe emoneĩva. Heta he’íva tuichaha ha omomba’éva tekoñemi, hákatu hetave pe ndojapóiva he’iva’ekue. Ndaopavavéi proxy ha VPN mba’eporurã hekorosã ha hekoñemi. Ndahetái <a href="{ $pcmag }">ohaíta</a> <a href="{ $cnet }">katuete</a> ne rembiapo ñandutípe ohepyme’ẽ hag̃ua ne mba’ekuaarã ha marandu umi mba’apohaguasu jehepyme’ẽkuaaha pegua. Ambue mba’eporurã omohendaséta malware ne mba’e’okápe.
# Variables
#   $mozvpn (url) - https://www.mozilla.org/products/vpn/
#   $fpn (url) - https://fpn.firefox.com/
