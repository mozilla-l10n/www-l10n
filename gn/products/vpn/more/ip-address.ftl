...
vpn-ip-address-no-your-ip-v2 = Nahániri. Nde IP kundaharape oñemoirũ petẽi tendaite ndereiporuimba’éiramo VPN (tenodeve romyesakãta upéva). Reime jave nde rógape ha reikévo ñanduti nde rehepyme’ẽvape, reiporuhína upéva. Upeicharamo jepe, ehechajeývo ne ñanduti veve nde rógape pyharevekue, upéi ehecha marandu taperyva’uhápe eha’ãrõnguévo ne mba’ejerurepy, ha upe rire emba’apóvo peteĩ mba’apoha guive, eipuru heta IP kundaharape peteĩteĩ tendápe.
# Outdated string
vpn-ip-address-no-your-ip = Nahániri. Nde IP kundaharape oñemoirũ tendaite ndereipuruimba’éiramo <a href="{ $url }">eiporúvo VPN</a> (tenodeve romyesakãta upéva). Reime jave nde rógape ha reikévo ñanduti nde rehepyme’ẽvape, reiporuhína upéva. Upeicharamo jepe, ehechajeývo ne ñanduti veve nde rógape pyharevekue, upéi ehecha marandu taperyva’uhápe eha’ãrõnguévo ne mba’ejerurepy, ha upe rire emba’apóvo peteĩ mba’apoha guive, eiporu heta IP kundaharape peteĩteĩva umi tendápe.
...
vpn-ip-address-you-dont-need = Natekotevẽi remokañy nde IP renda, ha katu oĩ sapy’ánte ikatuhápe reñomise. Pe mba’érepa ojehechavéva ha’e tekoñemi. Estados Unidos-pe, <a href="{ $congress }">Congreso ombogue umi ñe’ẽñemi</a> ojejapóva oñeñangareko hag̃ua poruhára banda ancha ñemiguáre. Umi ome’ẽva Pytyvõ Ñandutiroguépe ohecha mba’éichapa reiporu, mba’épe g̃uarãpa reiporu Ñandutiveve ha mboy árapa reiporu peteĩteĩva kuatiaroguépe. Ko momarandu ndaha’éi iñemíva, upévare mbohapyha ikatu ohecha ñandutirogue reikehápe. Tape oñembohovái hag̃ua kóva ha’e ojeporu <a href="{ $doh }">DNS-over-HTTPS</a> (DoH). Kóva ombogue DNS (Domain Name System) jeguata, hasyve ISP ohecha hag̃ua ñanduti renda reñeha’ãva reike. <a href="{ $firefox }">oipurúvape g̃uarã { -brand-name-firefox }</a> EE. UU.-pe, ñepyrũrã, iñeporandu DoH pegua ojegueraha DNS poruhára ojeroviapyrévape, hasyve oñembojoaju hag̃ua hendivekuéra umi ñandutirogue oñeha’ãva oho hikuái.
# Variables
#   $url (url) - https://www.mozilla.org/products/vpn/more/when-to-use-a-vpn/
