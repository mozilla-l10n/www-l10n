...
# Outdated string
vpn-ip-address-no-your-ip = Nahániri. Nde IP kundaharape oñemoirũ petẽi tendaite ndereipuruimba’éiramo <a href="{ $url }">eipurúvo VPN</a> (tenodeve romyesakãta upéva). Reime jave nde rógape ha reikévo ñanduti nde rehepyme’ẽvape, reipuruhína upéva. Upeicharamo jepe, ehechajeývo ne ñanduti veve nde rógape pyharevekue, upéi ehecha marandu taperyva’uhápe eha’ãrõnguévo ne mba’ejerurepy, ha upe rire emba’apóvo peteĩ mba’apoha guive, eipuru heta IP kundaharape peteĩteĩva umi tendápe.
...
vpn-ip-address-when-the-internet = Oñemoheñóiramoguare Ñanduti ñepyrũrãite, oipuruva’ekue kundaharape “versión 4”. Ha’éva 32 bits, he’iséva ojeguerekokuaaha <a href="{ $sr }">4.200.000.000 kundaharape</a>. Kóva ha’ete ku tuicháva upérõguare, hákatu ndahetái peteĩ arapy ojepuruhápe EE. UU. retãme <a href="{ $variety }">11 mba’e’oka hendyhápe</a>.
