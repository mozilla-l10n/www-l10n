...
# Obsolete string
vpn-linux-fast-and = <strong>Ipya’e ha jeroviaha:</strong> { -brand-name-mozilla-vpn } oipuru taperekoite { -brand-name-wireguard }®, ome’ẽva jeku’epya’e ha tekopyta ambue VPN raperekoitégui
