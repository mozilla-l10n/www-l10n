...
vpn-windows-protect-your-windows = Emo’ã ne Windows mba’e’oka VPN ndive. { -brand-name-mozilla } VPN oykeko mba’apohaguasu viru’ỹgua. Eñemomaranduve mba’éichapa nemo’ãta VPN ha mba’érepa ejeroviáta { -brand-name-mozilla } rehe tekoñemi ha tekorosãrã.
...
vpn-windows-the-mozilla = Tembiporu’i { -brand-name-mozilla-vpn } ndoipurúi heta mandu’arenda ne Windows mba’e’okápe, naimbeguemo’ãi ne mohendaha ha ipukuvéta nde batería jeporu.
