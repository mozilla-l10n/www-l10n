...
vpn-desktop-if-you-are = Ehekápa peteĩ VPN emo’ã hag̃ua ne pumbyry térã mesa arigua, eiporu { -brand-name-mozilla-vpn }-pe oykeko mba’apohaguasu viru’ỹgua. Eñemomaranduve mba’éichapa nemo’ãta peteĩ VPN ha mba’érepa ejeroviáta { -brand-name-mozilla } rehe nde rekoñemi ha rekorosãverã.
