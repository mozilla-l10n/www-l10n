...
vpn-landing-page-desc = Eipuru { -brand-name-mozilla-vpn } emo’ã hag̃ua mba’e’oka opa tembiporu’ípe g̃uarã. Apopyvusu ndive { $countries }+ tetãme, eikekuaa oimeraẽva tendápe, eime eimehápe.
