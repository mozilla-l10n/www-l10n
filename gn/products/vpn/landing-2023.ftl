...
vpn-landing-how-a-vpn-helps-you-v2 = Mba’éicha nepytyvõ { -brand-name-mozilla-vpn }
...
vpn-landing-built-transparently = Ojejapo tesakãme ayvu ijurujávape
vpn-landing-easy-firefox-integration = Ndahasýi { -brand-name-firefox } jeike { -brand-name-mozilla-vpn } jepysokue ndive (Windows añoite)
