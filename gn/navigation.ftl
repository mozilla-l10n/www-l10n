...
navigation-test-soon-to-be-released = Eipuru tembiapoite oikétamava peteĩchagua hekopytavétavape.
navigation-developer-innovations = Mba’epyahu mboguatahárape g̃uarã
navigation-projects-that-help-keep = Apopyrã oipytyvõtava ñanduti ijuruja ha oipurukuaa hag̃ua opavave.
...
navigation-build-test-scale-and = Emoheñói, eipuru ha hetave ko kundahára oñemoheñóiva ñangakohakuérape.
