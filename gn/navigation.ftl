...
navigation-watch-videos-and-browse = Ehecha ta’ãngamýi ha eikundaha ñandutípe ne { -brand-name-amazon } { -brand-name-fire-tv } rupive.
...
navigation-meet-the-firefox-family = Eikuaa { -brand-name-firefox } pehẽngue
...
navigation-get-the-browser-that-gives = Eguereko pe kundahára ome’ẽvéva pokatu { -brand-name-windows }, { -brand-name-mac } térã { -brand-name-linux } rupive.
navigation-take-firefox-and-firefox = Egueraha { -brand-name-firefox } ha { -brand-name-firefox-focus } nendive. { -brand-name-android } ha { -brand-name-ios } peg̃uarã.
...
navigation-mozilla-open-source-support = { -brand-name-mozilla } ayvu ijurujáva pytyvõ (MOSS)
navigation-mozilla-manifesto = { -brand-name-mozilla } Je’epy
navigation-menu = Poravorã
navigation-check-out-the-benefits = Ema’ẽmi mba’eporã rehe
navigation-browsers = Kundaha
navigation-close-browsers-menu = Emboty kundahára poravorã
navigation-download = Mboguejy
navigation-extensions = Jepysokue
navigation-support = Pytyvõha
navigation-privacy = Ñemigua
navigation-get-unmatched-data-protection = Eguereko mba’ekuaarã ñemo’ã ijojaha’ỹva ojogueraháva nde atyguasu ndive.
navigation-made-with-respect = Poyhúpe jejapopy
navigation-close-products-menu = Emboty poravorã Apopyre
navigation-see-if-your-personal = Ehecha ne marandúpa osẽ ñandutípe ha eñemboheraguapy ou hag̃ua ndéve mba’ekuaarã ñembyai rehegua.
navigation-check-for-breaches = Ehechajey oĩva ñembyai
navigation-see-breaches = Ehecha ñembyai
navigation-security-tips = Ñe’ẽporã tekorosãrã
...
navigation-sign-in = Tembiapo ñepyrũ
navigation-benefits = Jopoiguasu
...
navigation-test-soon-to-be-released = Eiporu tembiapoite oikétamava peteĩchagua hekopytavétavape.
navigation-developer-innovations = Mba’epyahu mboguatahárape g̃uarã
navigation-projects-that-help-keep = Apopyrã oipytyvõtava ñanduti ijuruja ha oiporukuaa hag̃ua opavave.
navigation-mixed-reality = Mixed Reality
navigation-resources = Mba’eita
navigation-resources-for-developers = Mba’eita mboguatahárape g̃uarã, mboguatahára rupi.
navigation-developer-blog = Mboguatahára blog
navigation-build-test-scale-and = Emoheñói, eiporu ha hetave ko kundahára oñemoheñóiva ñangakohakuérape.
navigation-leadership = Ñemotenonde
navigation-mission = Tembipota
navigation-press-center = Momaranduha renda
navigation-contact = Ñe’ẽha
navigation-careers = Mba’aporã
navigation-work-for-a-mission-driven = Emba’apo peteĩ atyguasu oguerekóva hembipotáramo apopyre opavavépe g̃uarãva.
navigation-get-involved = Eikéke
navigation-join-the-fight-for-a = Eipytyvõke ñanduti hekoresãi hag̃ua.
navigation-events = Tembiaporã
navigation-donate = Me’ẽ
navigation-your-right-to-security = Nde derécho tekorosã ha ñemigua ñandutípe imbareteveva’erã, araka’eve mokõiguávaramo.
navigation-release-notes = Jehaipy rehegua
navigation-features = Reheguáva
navigation-products = Apopyre
