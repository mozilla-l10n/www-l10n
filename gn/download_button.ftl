...
download-button-free-google-play = Eguereko reiete { -brand-name-google-play } rupive
download-button-app-store = Eguerekokuaa reiete { -brand-name-app-store } guive
...
download-button-your-system-may = Ikatu hína nde apopyvusu ndorekói { -brand-name-firefox } ojeruréva, hákatu eipurukuaa peteĩva ãva rehegua:
