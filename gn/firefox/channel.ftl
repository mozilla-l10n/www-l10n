...
# Variables:
#   $link (url) - link to https://www.mozilla.org/privacy/firefox/#pre-release
firefox-channel-nightly-is-an-unstable-testing = { -brand-name-nightly } ha’e jehechaukaha oikoporã’ỹva gueteri. Ijypykue rupi, Beta omondo mba’ekuaarã { -brand-name-mozilla }-pe — ha avei orendiveguápe — oipytyvõ hag̃ua apañuãi ñembohapépe ha iñamindu’úpe. <a href="{ $link }">Moherakuãngue jekuaa</a>.
firefox-channel-firefox-nightly-automatically = { -brand-name-firefox-nightly } omondo marandu ijeheguite { -brand-name-mozilla }-pe.
firefox-channel-try-new-browser-features = Eipurumína umi tembiapoite ipyahuvéva | { -brand-name-firefox } rehegua
firefox-channel-experience-cutting-edge-desktop = Eipurumína umi tembiapoite ipyahuvéva | { -brand-name-firefox-developer-edition }, { -brand-name-firefox-beta } ha { -brand-name-firefox-nightly }. ¡Emboguejymína!
firefox-channel-download-and-test-the-latest-desktop = Emboguejy ha eipuru { -brand-name-firefox } rembiapokue ipyahuvéva mesa ariguápe g̃uarã umi { -brand-name-developer-edition }, { -brand-name-beta } ha { -brand-name-nightly } reheguáva.
...
# Variables:
#   $link (url) - link to https://www.mozilla.org/privacy/firefox/#pre-release
firefox-channel-developer-edition-is-an = { -brand-name-developer-edition } ha’e jehechaukaha oikoporã’ỹva gueteri. Ijypykue rupi, Beta omondo mba’ekuaarã { -brand-name-mozilla }-pe — ha avei orendiveguápe — oipytyvõ hag̃ua apañuãi ñembohapépe ha iñamindu’úpe. <a href="{ $link }">Moherakuãngue jekuaa</a>.
...
firefox-channel-get-a-sneak-peek-at-our = Eikuaa umi kundaha tenondeve g̃uarãva ha orepytyvõ rojapo hag̃ua chugui peteĩ kundaha iporãvéva: eipuru { -brand-name-firefox-nightly }.
firefox-channel-test-brand-new-features = Eipuru mba’e ipyahuvéva ko’ẽreíre (térã… nightly). Eipuru nde kyhyjepópe.
firefox-channel-try-new-features-in-a-pre-release = Eipurumína tembiapoitekue oĩmba’ỹva gueteri kundaha { -brand-name-ios } | { -brand-name-firefox } peg̃uarã
firefox-channel-experience-cutting-edge-features-ios = Eipurumína umi tembiapoite ipyahuvéva { -brand-name-ios } peg̃uarã { -brand-name-apple }’s rupive { -brand-name-test-flight } apopyre ¡Emboguejymína!
firefox-channel-test-beta-versions-of-firefox-ios-long = Eipurumína beta { -brand-name-firefox } { -brand-name-ios } peg̃uarã { -brand-name-test-flight } { -brand-name-apple } mba’éva rupive ha orepytyvõ kundha pumbyryguáva { -brand-name-iphone }, { -brand-name-ipad } ha iPod touch iporãve hag̃ua.
firefox-channel-test-flight = { -brand-name-test-flight }
firefox-channel-test-beta-versions-of-firefox-ios = Eipurumína beta { -brand-name-firefox } { -brand-name-ios } peg̃uarã { -brand-name-test-flight } { -brand-name-apple } mba’éva rupive.
