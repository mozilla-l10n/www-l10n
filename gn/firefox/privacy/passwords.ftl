...
privacy-passwords-use-a-password = Eiporu ñe’ẽñemi ñangarekohára hasy’ỹ hag̃ua imoheñói ha ñe’ẽñemi ñemomandu’a
privacy-passwords-use-twofactor-authentication = Eiporu “ñemoneĩ mokõi reheguáva” ikatúma guive
...
privacy-passwords-using-password-recovery = Aiporu ñe’ẽñemi guerujeyrã oĩporãjey hag̃ua
...
privacy-passwords-use-mozilla-monitor = Oiporu <a { $url_monitor }>{ -brand-name-mozilla-monitor }</a> oma’ẽ ñanduti veve kundaharape ojuajúva ne mba’etére. Ne ñanduti veve kundaharape ojekuaárõ mba’ekuaarã mboguaha atyguasu herakuãva, eñeñatõita ha oje’éta mba’épa ejapóta emo’ã hag̃ua ne mba’ete iñapañuáiva.
...
privacy-passwords-randomness-can-be = Pe jereguáva iñapañuaikuaa, porandu tekorasãgua oiporúva tenda ha’eha mba’e tapichakuéra ikatukúva oikuaa nde rehegua, oikehápe tenda ne reñoihague, nde arareñói térã umi ne pehenguekuéra réra, térã ikatúva ojeikuaa ava ñandutieta reñoiha rupive. Pe marandu iporãva ha’e ñanduti renda ndoikuaaséi pe mbohováipa ha’e japu térã añetegua — ¡ikatu ijapu! Hákatu ijapu iporã hag̃uáicha: <strong>Embohovái porandu tekorosãgua ipuku ha jereguáva</strong>, ne ñe’ẽñemichagua.
