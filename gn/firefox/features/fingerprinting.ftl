...
features-fingerprinting-the-practice-of = Pe kuãhũ kuaaukaha ñemoheñói (fingerprinting) omoneĩ <a { $url_tracked }>ejehapykuehóvo heta jasy</a>, emboguéramo jepe kundahára mbyatyhágui térã eipuru ñeikundaha ñemigua ayvu, ema’ẽ’ỹre erehague ndereipotaiha ejehapykueho. Oĩmaramo jepe jokupytypaite <a { $url_bodies }>tete</a> <a { $url_standards }>ypykuéva</a> mba’e ha <a { $url_vendors }>me’ẽhára</a> <a { $url_browser }>kundahára</a> mba’e umi kuãhũ kuaaukaha ha’e <a { $url_harmful }>ivaikuaáva</a>, ijepuru ñandutípe <a { $url_has }>oguereko</a> peteĩ <a { $url_increased }>tuichavéva</a> <a { $url_steadily }>tapiaite</a> 10 ary ohasaramóva pukukue.
