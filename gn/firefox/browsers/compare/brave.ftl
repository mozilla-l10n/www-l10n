...
compare-brave-there-are-a-few-of-braves = Oĩ hetaichagua tekorosã { -brand-name-brave }-pe emomba’ekuaáva, ha’éva ñembohekopyahu ijeheguíva HTTPS jeiképe ({ -brand-name-firefox } ome’ẽkuaáva jepysokue ndive <a { $extension }></a>). { -brand-name-brave } ha { -brand-name-firefox } ome’ẽkuaa puruhárape <a { $lockwise }> ñe’ẽñemi ñangarekohára</a> ypygua ha ehechajey hag̃ua ne rekorosã rapykuere ejapose vove. { -brand-name-brave } ohechauka tapykuere ha’éva tapykuehoha papapy ojokóva embojurujajeývo tendayke pyahu. { -brand-name-firefox } ohechauka marandu ojojoguáva ehechávo <a { $privacy }>ne rekoñemi marandu</a> eikekuaahápe ejapose vove eikutúvo pe jokoha kundaharape rendápe.
...
compare-brave-what-might-surprise-some-new = Pe ikatúva omondýi ndahetái { -brand-name-brave } puruhára pyahúpe ha’e pe pya’eterei henyhẽre umi kuatiarogue kundahárape. Ha pe mba’ére pya’ete umi kuatiarogue ñemyanyhẽ ha’e ejoko rupi opáichagua marandu ñemurã pypegua. Oĩre sa’ive henyhẽva’erã, upévare oiporu’ive aravo’i.
...
compare-brave-customization-of-ui-elements = Pe mba’epuru ñemboava ha puruhára rechaha téma ha’e umi puruhára ohecharamovéva { -brand-name-firefox } rehegua heta arýma ha ore mboguatahára rekoha omoheñóima <a { $addons }>arandukarenda tuicháva</a> moĩmbaha ha jepysokue ijayvu jurujáva omoneĩva ñemboava ha tembiapoite tuicháva. Tembiapoite oumavoi { -brand-name-firefox } ndive emboguejývo oĩhápe ore <a { $screenshot }>tembiporu japyhyha</a> imbaretéva, tembiapoite jeikekuaaha ha <a { $pocket }>{ -brand-name-pocket }</a> ndivegua, mba’eita omoneĩva puruhárape oñongatúvo pya’e jehaipyre omoñe’ẽkuaáva uperire oimeraẽva mba’e’okápe.
...
compare-brave-the-firefox-browser-also-gives = { -brand-name-firefox } kundahára avei ome’ẽ puruhárape oñemboheraguapývo erekokuaa hag̃ua <a { $accounts }>{ -brand-name-firefox-account }</a>. Erekóvo mba’ete { -brand-name-firefox } ndive ha’e pe nepytyvõkuaáva embojuruja hag̃uã mbojuehe mba’e’okakuéra pa’ũme, avei orekóta hendive apopyre <a { $monitor }>{ -brand-name-firefox-monitor }</a> oma’ẽag̃uíva ne ñanduti veve kundaharapére ha neatõi ne marandu ha oĩraramo <a { $breaches }>mba’ekuaarã ñembogua</a> ojekuaávape.
# "Basic Attention Token" is a brand name.
