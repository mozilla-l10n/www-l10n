...
best-browser-at-firefox-weve-worked = <a href="{ $firefox }">{ -brand-name-firefox }</a>-pe, romba’apo mbarete rojapo hag̃ua kundaha ipya’e añetéva ha ome’ẽva puruhárape pokatu ijeikekue ñandutípe rehegua.
