...
# HTML description
# Obsolete string
mobile-ios-firefox-browser-for = Kundahára { -brand-name-firefox } { -brand-name-ios } peg̃uarã ipya’e, hekorosã ha hekoñemíva eike ñepyrũ guive.
mobile-ios-firefox-browser = { -brand-name-firefox-browser }
# Obsolete string
mobile-ios-get-automatic-privacy = Erekóke tekoñemi ijeheguíva { -brand-name-iphone } ha { -brand-name-ipad }-pe.
...
mobile-ios-now-iphone-and = Ko’ág̃a { -brand-name-iphone } puruhára ha { -brand-name-ipad } oiporavokuaa ikundahára ypygua teéva. Péva he’ise ndaha’éi katuete eipuruva’erã { -brand-name-safari }, ha ne kundahára pumbyrygua oñembojuehe kundahára mohendahagua ndive. Avei, embohekóvo { -brand-name-firefox } kundahára ypyguávarõ, eipytyvõ mba’apohaguasu tembipurupyahugua ijeheguíva. { -brand-name-firefox } ha’e kundahára oykekóva chupe tendaguasu viru’ỹguáva.
...
mobile-ios-firefox-gives-you = { -brand-name-firefox } oikuave’ẽ tekoñemi ñemo’ãve eikundahakuévo. Ijejeguite, ore Ñemo’ã rapykuehoha tuichavéva ojokóma tapykuehoha ha scripts ava ñandutieta rapykuehoháramo, kookie rapykuehoha tenda pa’ũme, criptominero ha kuãhũ kuaaukaha myesakãha.
