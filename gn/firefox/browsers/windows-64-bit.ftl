...
windows-64-bit-heres-the-key-thing = Ápe oĩ mba’eñemi: tembipuru’ikuéra 64 bits ikatu oguerekove mandu’arenda ha sa’ive oñembyaikuaáva tembipurukuéra 32 bits-vagui. Avei, opóvo 32 gui 64 bits-pe, peteĩ tekorosã rehegua <a href="{ $ASLR }">jeregua renda kundaharape pa’ũ(ASLR)</a> oikoporãve eñemo’ã hag̃ua tapicha ñañágui. { -brand-name-linux } ha { -brand-name-mac } puruhára, ani peñemyangekói, emba’apomahína { -brand-name-firefox } oikoporãvéva 64 bits peg̃uarã.
