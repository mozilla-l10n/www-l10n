...
browser-history-today-there-are = Ko ára rupi, ndahatái hendáicha ereko eike hag̃ua ñandutípe. { -brand-name-firefox }, { -brand-name-google } { -brand-name-chrome }, { -brand-name-microsoft } { -brand-name-edge }, { -brand-name-safari } ha { -brand-name-opera } ha’e umi oñorairõva upevarã. Umi pumbyry mba’e’oka oñemoheñói 10 ary ohasaramóvape eikekuaaha ñandutípe. Ko ára rupi, hetaiterei ñanduti puruhára oipuru pumbyry kundahára ha <a href="{ $applications }">tembipuru’i</a> oike hag̃ua. Umi tembiapokue pumbyrygua kundahára ojehayhuvéva eipurukuaa mba’e’okápe { -brand-name-ios } ha { -brand-name-android }. Ko’ã tembipuru’i iporã añete peteĩ mba’eaporã, ome’ẽkuaa nda’aréi jeike ñandutípe.
# Variables:
