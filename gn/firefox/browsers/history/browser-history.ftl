...
browser-history-then-microsoft-began = Upéicharamo { -brand-name-microsoft } oñepyrũ omyasãi { -brand-name-ie } ijapopyvusu { -brand-name-windows } ndive. 4 arýpe, orekómo 75% puruhárape ha 1999 jave ohupytýma 99%. Ko mba’apohaguasu apañuãi juicio antimonopolio mba’éicha omyasãi rehe, ha { -brand-name-netscape } ombojuruja teñoiha ayvu ha omoheñói tendaguasu viru’ỹgua <a href="{ $mozilla }">{ -brand-name-mozilla }</a>, ha kóva omoheñói ha omyasãi { -brand-name-firefox } ary 2002 jave. Ohechakuaa rire kundahára ojapyhypáva naiporãiha puruharakuérape g̃uarã ha ñanduti ijurujáva, { -brand-name-firefox } omoheñói ome’ẽ hag̃ua puruhárape ñanduti jeporavokuáva. 2010 jave, { -brand-name-mozilla } { -brand-name-firefox } ha ambue <a href="{ $marketshare }">omomichĩ { -brand-name-ie } jepuru 50%</ a>.
