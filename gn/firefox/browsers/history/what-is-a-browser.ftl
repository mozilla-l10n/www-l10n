...
what-is-a-browser-its-important = Opavave oikekuaava’erã ñandutípe, avei opavave <a href="{ $tools }">jaikuaapava’erã tembiporukuéra</a> jaipurúva jaike hag̃ua pype. Jaiporu ñanduti kundahára { -brand-name-mozilla } { -brand-name-firefox }, { -brand-name-google } { -brand-name-chrome }, { -brand-name-microsoft } { -brand-name-edge } ha { -brand-name-apple } { -brand-name-safari } opaite ára, hákatu ¿roikumby añetete mba’eichagua ha mba’éichapa oku’e?
