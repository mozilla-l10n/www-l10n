...
new-platform-faster-page-loading = Emyenyhẽ kuatiarogue pya’e, sa’ive oipuru mandu’arenda ha heta hembiapoite, ko’ápe oĩma { -brand-name-firefox } pyahu.
new-platform-the-new-firefox = Ipyahúva <strong>{ -brand-name-firefox }</strong>
new-platform-2x-faster = Mokõi jevy ipya’eve
new-platform-the-best-firefox-ever = Eipuru { -brand-name-firefox } ipya’evéva tembiasakuépe
new-platform-lightweight = Ivevúi
new-platform-uses-30-less-memory = Oipuru 30% sa’ive mandu’arenda { -brand-name-chrome }-gui
new-platform-powerfully-private = Ñemigua imbaretevéva
new-platform-truly-private-browsing = Kundaha ñemigua añetéva tapykuere mo'ãha ndive
...
new-platform-own-your-online-life = Nemba’eteva’erã nde rekove ñandutípe.
...
new-platform-firefox-respects-your = { -brand-name-firefox } omomba’e <span>ne ñemigua { -brand-name-mac-short }-pe.</span>
...
new-platform-firefox-fights = { -brand-name-firefox } oñorairõ nde rehe <span>{ -brand-name-windows }-pe.</span>
