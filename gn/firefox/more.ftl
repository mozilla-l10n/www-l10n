...
firefox-more-access-your-sync = Eike ha embojuehe techaukaha, ñe’ẽñemi, tendayke ijurujáva ha hetave, eiporúvo { -brand-name-firefox } oimehápe.
...
be-bold-and = Eñembopya’aguasu ha eiporavo kundahára iporãvéva ndéve g̃uarã.
comparing-firefox-edge = Romoñondive { -brand-name-firefox-browser } { -brand-name-microsoft } { -brand-name-edge } ndive
youll-never-guess = Araka’eve ndereikuaamo’ãi mba’e kundahárapa iporãve ipya’e ha hembiapoite rupive.
comparing-firefox-ie = Romoñondive { -brand-name-firefox-browser } { -brand-name-microsoft } { -brand-name-ie } ndive
...
you-dont-have = Ani ejekoiterei kundahára ijypykuévare.
comparing-firefox-opera = Romoñondive { -brand-name-firefox-browser } { -brand-name-opera } ndive
be-free-to = Ehecharamo { -brand-name-firefox }-pe ejapose vove.
the-ad-blocker = Maranduñemurã jokoha – neirũ maranduñemurã ne myangekóiva rovake.
so-many-ads = Heta maranduñemurã, sa’íma pya’aguapy… Ejokómake kóva.
