...
switch-firefox-makes-switching-fast-email = { -brand-name-firefox } ndive ipya’eterei eva hag̃ua { -brand-name-chrome }-gui. Che ahayhueterei ha nde eipurumiva’erã avei.
