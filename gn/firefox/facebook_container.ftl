...
facebook-container-facebook-container-for-firefox = { -brand-name-facebook-container } { -brand-name-firefox } peg̃uarã | Ani eheja { -brand-name-facebook }-pe ohechávo eike hague.
facebook-container-millions-of-people-around = Hetaiterei tapicha arapy tuichakue jave ojerovia { -brand-name-firefox } ñanduti kundaha rehe { -brand-name-android }, { -brand-name-ios } ha mesa ariguápe g̃uarã. Ipya’e: Iñemi. ¡Emboguejy ko’ág̃a!
...
facebook-container-were-backed-by-mozilla-the = Ore pytyvõ <a href="{ $mozilla }">{ -brand-name-mozilla }</a>, atyguasu viru’ỹ rehegua oguerekóva yvypórape viru ári ha ome’ẽ opavavéve pokatu ñandutípe g̃uarã. Romoheñói ko jepysokue roguerovia rupi eguerekosetaha tembiporu asy’ỹva ijeporu neipytyvõtava nde ñemigua ha tekorosãrãme.
