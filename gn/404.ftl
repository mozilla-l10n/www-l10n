...
not-found-page-donate-to-mozilla-reclaim-from-v2 = <a { $donate }>Embojopói</a> { -brand-name-mozilla-foundation } ha erekóta Ñanduti mba’apohaguasu tembiporupyahugua.
