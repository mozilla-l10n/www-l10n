...
# HTML page title
features-independent-firefox-a-different = { -brand-name-firefox }, aparta retumilo por nia tempo. Retumu libere.
# HTML page description
features-independent-browse-the-internet = La reto, kia ĝi devus esti… libera, sekura kaj alirebla por ĉiuj. Retumu tiel kaj deklaru vian retan sendependecon.
features-independent-firefox-rebel-with-a = { -brand-name-firefox }: ribelanto kun kaŭzo
...
features-independent-in-addition-to-fighting = Dum ni batalas por viaj rajtoj en la reto kaj malpermesas al korporaciojn translimiĝi, ni ankaŭ kunlaboras kun aliaj tra la tuta mondo por antaŭenigi praktikojn, kiu konservos la interreton sana. Do, kiam vi elektas { -brand-name-firefox }, ni iel ankaŭ elektas vin.
# Obsolete string
features-independent-firefox-is-a-browser = { -brand-name-firefox } estas retumilo, kiu havas konsciencon. Kiel parto de la teĥnologio de la neprofitcela organizo { -brand-name-mozilla }, ni batalas por viaj rajtoj en la reto, certigas ke korporacioj ne translimiĝu kaj helpas eduki disvolvantaj landojn pri sanaj interretaj praktikoj. Do, kiam vi elektas { -brand-name-firefox }, iel ankaŭ ni elektas vin.
