...
firefox-sticky-promo-meet-our-family-of = Malkovru nian gamon de produktoj
firefox-sticky-promo-get-the-latest-firefox = Elŝutu la lastan retumilon { -brand-name-firefox }.
# Products List
firefox-sticky-promo-browsers = Retumiloj
