...
mission-at-mozilla-were-a-global-community = En Mozilla, ni estas tutmonda komunumo de teĥnikistoj, pensistoj kaj konstruistoj kiuj kunlaboras por gari la Interreton viva kaj alirebla, tiel ke homoj en la tuta mondo havu la eblon kontribui kaj krei en la Teksaĵo.
...
mission-read-the-mozilla-manifesto-to-learn = Legu la <a href="{ $url }">Manifeston de Mozilla</a> por scii eĉ pli pri la valoroj kaj principoj kiuj gvidas la sekvadon de nia misio.
...
mission-where-we-come-from-and-how-we-got = Origino kaj disvolviĝo de la projekto
mission-forums = Forumoj
mission-topics-include-support-products = Temoj inkluzivas subtenon, produktojn kaj teĥnologiojn
mission-governance = Regeblo
mission-our-structure-organization-and-the = Nia strukturo, organizado kaj la komunumo de Mozilla
