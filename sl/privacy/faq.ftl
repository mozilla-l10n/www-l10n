...
privacy-faq-mozillas-pre-release-versions = Predizdajne različice { -brand-name-firefox }a so razvojne platforme, ki se pogosto posodabljajo s poskusnimi zmogljivostmi. Pred izdajo zbiramo več podatkov kot po njej, kar nam pomaga razumeti, kako poskusne zmogljivosti delujejo. Zbiranje teh podatkov lahko izklopite v nastavitvah.
