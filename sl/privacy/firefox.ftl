...
privacy-firefox-youre-in-control-v2 = Vaši podatki so pod vašim nadzorom
...
privacy-firefox-how-we-use-v2 = Privzeto zaseben
privacy-firefox-always-protected = Vedno zaščiteni
...
privacy-firefox-contents = Vsebina
# Variables:
#   $attrs (string) - in-page link to the start of the legal portion of the privacy notice
privacy-firefox-take-me-back = Vrni me <a { $attrs }>na vrh</a> obvestila o zasebnosti
# Variables:
#   $attrs (string) - in-page link to the top of the page
privacy-firefox-lost-in-the = Ste se izgubili v podrobnostih? Vrnite se na <a { $attrs }>osnove zasebnosti { -brand-name-firefox }</a>.
