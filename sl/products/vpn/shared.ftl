...
vpn-shared-one-subscription-heading = Ena naročnina za vse naprave
vpn-shared-choose-a-plan-sub-heading = Izberite paket, ki vam ustreza
...
# Variables:
#   $amount (string) - a string containing the total annual subscription price together with the appropriate currency symbol e.g. '35,94 €'
vpn-shared-pricing-total-plus-tax = skupaj { $amount } + davek
...
vpn-shared-platform-what-is = Kaj je { -brand-name-mozilla-vpn }?
vpn-shared-platfrom-why-choose = Zakaj { -brand-name-mozilla-vpn }?
# Variables:
...
vpn-press-as-seen-in = O nas so napisali
