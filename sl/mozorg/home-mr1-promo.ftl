...
home-promo-title-soraya = Kjer se vse začenja
home-promo-title-gary = Odločitve, ki jih sprejemate, so pomembne
home-promo-title-ryan = Kjer se vse začenja
home-promo-explore-firefox = Raziščite { -brand-name-firefox }
