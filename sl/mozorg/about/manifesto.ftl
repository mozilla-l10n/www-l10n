...
manifesto-visualize-who-you-interact = Vizualizacija vaših stikov na spletu z orodjem Lightbeam
manifesto-learn-about-creating-web = Naučite se ustvarjati spletne vire z drugimi
manifesto-host-or-join-a-maker-party = Priredite ali sodelujte na delavnici Maker Party
...
manifesto-details-articulate-a-vision = v besede preliti vizijo interneta, ki naj jo po skupni želji sodelavcev Mozille zasleduje ustanova { -brand-name-mozilla } Foundation,
manifesto-details-speak-to-people = biti v stiku z vsemi ljudmi, ne glede na to, ali imajo tehnično ozadje,
manifesto-details-make-mozilla-contributors = zagotoviti, da bodo sodelavci Mozille na opravljeno delo ponosni in motivirani za naloge, ki stojijo pred njimi, in
manifesto-details-provide-a-framework = zagotoviti okolje, v katerem bo tudi drugim omogočeno širiti to vizijo interneta.
manifesto-details-these-principles = Ta načela ne bodo oživela sama od sebe. Da se internet odpre in da postane prijaznejši za sodelovanje, so potrebni ljudje – ljudje, ki delujejo bodisi sami zase, bodisi v skupinah, in ki lahko vodijo druge. { -brand-name-mozilla } Foundation se obvezuje, da bo podpirala in uveljavljala načela, ki so zapisana v Manifestu Mozille. Vas druge pa vabimo, da se nam pridružite, da bomo skupaj internet naredili prijetnejši za vse nas.
...
manifesto-details-advancing-the = Kako širiti Manifest Mozille
...
manifesto-details-the-mozilla-foundation-pleges = { -brand-name-mozilla } Foundation se zavezuje, da bo podpirala dejavnosti Manifesta Mozille, zato bomo:
...
manifesto-details-use-the-mozilla = uporabljali sredstva Mozille (intelektualno lastnino, kot so avtorske pravice in blagovne znamke, infrastrukturo, sklade in ugled), tako da internet ostane dalje odprta platforma,
manifesto-details-promote-models = podpirali modele, ki bodo ustvarjali ekonomsko vrednost iz projektov javne koristi in
manifesto-details-promote-the-mozilla = spodbujali načela Manifesta Mozille v javnih razpravah in v okviru industrije, ki se ukvarja z internetom.
...
manifesto-details-the-mozilla-foundation-invites = { -brand-name-mozilla } Foundation vabi vse, ki podpirate načela Manifesta Mozille, da se nam pridružite. Skupaj bomo iskali in našli nove možnosti in poti, kako uresničiti našo vizijo interneta.
