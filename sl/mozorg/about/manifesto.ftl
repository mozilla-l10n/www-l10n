...
manifesto-the-internet-is-a-global = Internet je globalni javni vir, ki mora ostati odprt in dostopen.
manifesto-the-internet-must-enrich = Internet mora bogatiti življenje vsakega posameznika.
manifesto-individuals-security-and = Varnost in zasebnost posameznika na internetu sta bistveni, zato se ju ne sme obravnavati kot nekaj neobveznega.
manifesto-individuals-must-have = Posamezniki morajo imeti možnost oblikovanja interneta in svojih izkušenj z njim.
manifesto-the-effectiveness-of-the = Učinkovitost interneta kot javnega vira je odvisna od povezljivosti (protokolov, oblik podatkov in vsebine), inovacij in decentraliziranega sodelovanja po vsem svetu.
...
manifesto-transparent-community = Pregledni procesi, ki temeljijo na skupnosti, spodbujajo sodelovanje, odgovornost in zaupanje.
...
manifesto-we-are-committed-to-people = Predani smo internetu, ki vključuje vse ljudi sveta – kjer demografske lastnosti človeka ne vplivajo na njegov dostop do interneta, priložnosti in kakovost uporabniške izkušnje.
...
manifesto-share-on-x = Deli na X
manifesto-share-on-x-aria-label = Deli na omrežju X (nekdanjem Twitterju)
