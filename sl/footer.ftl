...
footer-visit-mozilla-corporations = Obiščite neprofitno starševsko organizacijo <a { $moco_link }>{ -brand-name-mozilla-corporation }</a> - <a { $mofo_link }>{ -brand-name-mozilla-foundation }</a>.
