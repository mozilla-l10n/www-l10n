...
switch-firefox-makes-switching-fast-tweet = 🔥 Preklop s { -brand-name-chrome(sklon: "rodilnik") } na { -brand-name-firefox } je resnično hiter. Poskusite ga!
switch-switch-to-firefox = Preklop na { -brand-name-firefox }
switch-firefox-makes-switching-fast-email = Preklop s { -brand-name-chrome(sklon: "rodilnik") } na { -brand-name-firefox } je res hiter in enostaven. { -brand-name-firefox } je super, tudi ti ga moraš preskusiti.
