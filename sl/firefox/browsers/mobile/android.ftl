...
mobile-android-go-mobile-go = Postanite mobilni. Postanite neodvisni s { -brand-name-firefox(sklon: "orodnik") } za { -brand-name-android }.
# Obsolete string
mobile-android-when-you-download = Prenos { -brand-name-firefox(sklon: "rodilnik") } pomeni podporo neodvisnemu tehnološkemu podjetju. { -brand-name-firefox } je edini od velikih spletnih brskalnikov, za katerim stoji neprofitna organizacija, ki se bori za večjo odprtost in transparentnost ter vam daje nadzor nad vašim spletnim življenjem.
