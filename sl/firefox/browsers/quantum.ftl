...
firefox-doesnt-spy = { -brand-name-firefox } ne vohuni za vami po spletu. Ustavljamo številne znane sledilne piškotke tretjih strani in vam zagotavljamo popoln nadzor.
super-fast = Super hiter
get-speed-and = Hitrost in varnost. { -brand-name-firefox } je hiter, ker ne sledi vaši dejavnosti.
always-evolving = Venomer v razvoju
# Variables:
# $url (url) - link to https://www.mozilla.org/firefox/features
find-out-about = Spoznajte vse neprekosljive <a href="{ $url }">zmožnosti { -brand-name-firefox }a</a>.
