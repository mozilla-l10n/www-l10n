...
firefox-privacy-hub-firefox-products-are-designed = Izdelki { -brand-name-firefox } so zasnovani, da varujejo vašo <strong>zasebnost</strong>
...
firefox-privacy-hub-we-make-a-point-of-knowing = Skušamo vedeti čim manj o vas
...
firefox-privacy-hub-theres-no-hidden-agenda-here-v2 = Nobene skrite agende. Naši posli niso odvisni od skrivnega zlorabljanja vašega zaupanja. Naše <a href="{ $privacy }">obvestilo o zasebnosti</a> je dejansko berljivo. Naša koda je odprta za vsakogar, ki se želi poglobiti v katerikoli podatek, ki ga zbiramo. In prav tako smo odprti mi.
# Obsolete string
# Variables:
#   $privacy (url) - link to https://www.mozilla.org/privacy/firefox/
...
#   $class_name (string) - CSS class name for sign in link
#   $learn_more (url) - link to https://www.mozilla.org/firefox/accounts/
firefox-privacy-hub-already-have-an-account = Že imate račun? <a { $sign_in } class="{ $class_name }">Prijavite se</a> ali <a href="{ $learn_more }">izvedite več</a> o pridružitvi { -brand-name-firefox }u.
# Variables:
