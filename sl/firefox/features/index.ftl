...
features-index-independent-browser = { -brand-name-firefox } je edini veliki neodvisen brskalnik.
features-index-on-a-mission = S poslanstvom ohraniti internet odprt in dostopen vsem.
features-index-read-mozillas-mission = Preberite poslanstvo Mozille
