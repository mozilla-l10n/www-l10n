...
set-as-default-landing-firefox-is-the-only-major = { -brand-name-firefox } je edini večji neodvisen brskalnik. { -brand-name-chrome }, { -brand-name-edge } in { -brand-name-brave } vsi temeljijo na kodi { -brand-name-google(sklon: "rodilnik") }, največjega oglaševalskega omrežja na svetu.
