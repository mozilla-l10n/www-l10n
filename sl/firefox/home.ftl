...
firefox-home-firefox-protect-your = { -brand-name-firefox } – Zaščitite svoje spletno življenje z izdelki, ki na prvo mesto postavljajo zasebnost
firefox-home-firefox-is-more-than = { -brand-name-firefox } je več kot le brskalnik. Spoznajte { -brand-name-firefox }ove izdelke, ki z vašimi podatki ravnajo spoštljivo in so zasnovani za zasebnost, kjerkoli na spletu se nahajate.
# Obsolete string
firefox-home-the-browser-is-just = Brskalnik je šele začetek
firefox-home-firefox-is-just = { -brand-name-firefox } je zgolj začetek.
# Obsolete string
firefox-home-meet-our-family-of = Spoznajte našo družino izdelkov
firefox-home-meet-mozillas-family = Spoznajte družino izdelkov { -brand-name-mozilla }
...
firefox-home-every-single-mozilla = Vsak izdelek { -brand-name-mozilla } deluje v skladu našo zavezo o osebnih podatkih: <strong>Vzemi manj. Ohrani varnost. Brez skrivnosti.</strong>
# Obsolete string
