...
firefox-more-you-can-reclaim = Lahko si povrnete zasebnost in ponovno prevzamete nadzor nad svojo internetno izkušnjo! Pravzaprav je presenetljivo enostavno. To lahko stori vsak.
...
be-bold-and = Bodite drzni in samostojni pri izbiri, kateri brskalnik je pravi za vas.
comparing-firefox-edge = Primerjava: { -brand-name-firefox-browser } in { -brand-name-microsoft } { -brand-name-edge }
youll-never-guess = Nikoli ne boste uganili, kateri brskalnik zmaga po hitrosti in zmogljivostih.
comparing-firefox-ie = Primerjava: { -brand-name-firefox-browser } in { -brand-name-microsoft } { -brand-name-ie }
