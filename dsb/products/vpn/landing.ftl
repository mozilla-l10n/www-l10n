...
vpn-landing-page-desc = Wužywajśo { -brand-name-mozilla-vpn } za dopołny šćit swójogo grata za wšě nałoženja. Ze serwerami we wěcej ako { $countries } krajach, móžośo do něźi a wót něźi zwězaś.
