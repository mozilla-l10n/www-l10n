...
# HTML page title
vpn-landing-title = { -brand-name-mozilla-vpn }: Šćitajśo swój ceły rěd
...
vpn-landing-powerful-privacy-for-peace = Wugbała priwatnosć za dušyny měr
...
vpn-landing-easy-firefox-integration = Lažka integracija { -brand-name-firefox } z rozšyrjenim { -brand-name-mozilla-vpn } (jano Windows)
