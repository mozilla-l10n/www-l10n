...
vpn-windows-if-youre = Jolic wjelgin cesto streaming wideo abo muziki online wužywaśo, móžośo snaź pśez wužywanje VPN tomu zajźowaś, až waš póbitowaŕ internetneje słužby wašu šyrokosć pasma wobgranicujo abo droslujo.
vpn-windows-you-can-exclude = Móžośo wěste nałoženja z rozdźěloneju tunelujuceju funkciju wuzamknuś. To groni, až někotare nałoženja pśez VPN běže, mjaztym až druge zwenka tunela wóstawaju.
vpn-windows-using-a-windows = Gaž rěd Windows w zjawnej, njewěstej seśi WLAN wužywaśo, budu waše informacije wó internetnem wobchaźe napadojte na seśowe špiony a VPN móžo pomagaś, waše daty pśez to priwatne źaržaś, až mócnu šćitnu rowninu pśidawa.
