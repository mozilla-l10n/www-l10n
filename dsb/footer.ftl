...
footer-donate-not-for-profit = Pósććo za wše wužytnej załožbje <a { $mofo_link }>{ -brand-name-mozilla-foundation }</a>.
...
footer-localize-mozilla = { -brand-name-mozilla } lokalizěrowaś
