...
privacy-principles-data-privacy-principles = Principy datowego šćita
# HTML page description
privacy-principles-mozilla-is-an-open-source = { -brand-name-mozilla } jo projekt wótwórjonego žrědła z misiju, wašo internetne dožywjenje pólěpšyś. To jo pógónjujuca móc za našymi praktikami datowego šćita.
# Variables:
...
privacy-principles-use-and-share-information = Wužywamy a źělimy daty na nałog, kótaryž jo transparentny a jo wužytny za wužywarja.
privacy-principles-user-control = Kontrola za wužywarje
privacy-principles-develop-products-and = Wuwijamy produkty a zasajźamy se za nejlěpšě wašnje póstupowanja, kótarež zmóžnjaju wužywarjam, jich daty a dožywjenja online same kontrolěrowaś.
