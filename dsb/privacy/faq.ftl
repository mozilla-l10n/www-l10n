...
privacy-faq-we-adhere-to-no-surprises-principle = Za nas princip „žedne pśechwatanja“ płaśi, to groni, źěłamy śěžko na tom, až se wócakowanja luźi na { -brand-name-firefox } z napšawdnosću kšyju.
...
# Obsolete string (expires 2024-09-11)
privacy-faq-firefox-the-web-browser-that = { -brand-name-firefox }, webwobglědowak, kótaryž na wašom rěźe abo licadle běžy, jo waše wrota do interneta. Waš wobglědowak zastoj wjele informacijow wó websedłach, ku kotarymž woglědujośo, ale toś te informacije wóstawaju na wašom rěźe. { -brand-name-mozilla }, organizacija, kótaraž { -brand-name-firefox } gótujo, je njezběra (snaźkuli pšosyśo wó to).
...
# Obsolete string (expires 2024-09-11)
privacy-faq-the-second-is-what-we-call-interaction = Drugu pomjenjujomy „interakciske daty“. To su daty wó interakciji jadnotliwego wužywarja z { -brand-name-firefox }, na pśikład licba wócynjonych rejtarikow, status wužywaŕskich nastajenjow abo kak cesto su se wěste funkcije wobglědowaku wužyli, na pśikład fota wobrazowki abo kontejnery. Zběramy toś te daty na pśikład z pomocu tłocaška Slědk, toś teje šypki w lěwem górnym rožku wašogo wobglědowaka, kótaryž wam zmóžnja, k pjerwjejšnemu bokoju nawigěrowaś, aby my mógli wiźeś, lěc něchten jo tłocašk Slědk wužył, ale njamóžomy wiźeś, ku kótarym webbokam sćo woglědał.
privacy-faq-do-you-collect-more-data-in = Zběraśo wěcej datow w pśedwersijach { -brand-name-firefox }?
# Obsolete string (expires 2024-09-11)
privacy-faq-sort-of-in-addition-to-the-data = We wěstem nastupanju. Pśidatnje k datam, kótarež smy górjejce wopisali, dostawamy w pśedwersiji { -brand-name-firefox } pó standarźe rozpšawy wó zmólkach a wowalenjach.
# Obsolete string (expires 2024-09-11)
# Variables:
#   $link (url) - link to https://support.mozilla.org/kb/shield
privacy-faq-we-may-also-collect-additional = Móžomy teke dalšne daty w pśedwersiji zběraś, za jadnu z našych <a href="{ $link }">studijow</a>. Někotare studije na pśikład trjebaju tak pomjenjone „daty webaktiwity“, ku kótarymž móža URL a druge daty wó wěstych websedłach słušaś. To nam pomaga, na wěste pšašanja wótegroniś, aby my { -brand-name-firefox } pólěpšyli, na pśikład, kak daju se wěste woblubowane websedła do wěstych rěcnych wersijow integrěrowaś.
