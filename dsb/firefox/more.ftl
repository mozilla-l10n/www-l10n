...
firefox-more-access-your-sync = Mějśo pśistup k swójim cytańskim znamjenjam, gronidłam, wócynjonym rejtarikam a wěcej – wšuźi, źož { -brand-name-firefox } wužywaśo a sychronizěrujśo je.
...
comparing-firefox-edge = Pśirownanje mjazy { -brand-name-firefox-browser } a { -brand-name-microsoft } { -brand-name-edge }
comparing-firefox-ie = Pśirownanje mjazy { -brand-name-firefox-browser } a { -brand-name-microsoft } { -brand-name-ie }
comparing-firefox-safari = Pśirownanje mjazy { -brand-name-firefox-browser } a { -brand-name-apple } { -brand-name-safari }
you-dont-have = Njetrjebaśo pó standarźe standardny wobglědowak wužywaś.
comparing-firefox-opera = Pśirownanje mjazy { -brand-name-firefox-browser } a { -brand-name-opera }
be-free-to = Spiwajśo chwalbu na { -brand-name-firefox }, gažkuli cośo.
the-ad-blocker = Wabjeński blokěrowak - pótajmna bróń pśeśiwo gramnemu wabjenjeju.
so-many-ads = Tak wjele wabjenja, tak mało sćerpnosći… Jo cas, błaznosć skóńcyś.
