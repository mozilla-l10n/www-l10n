...
# HTML page title
features-independent-firefox-a-different = { -brand-name-firefox }, drugi wobglědowak za druge case. Pśeglědujśo dermo.
# HTML page description
features-independent-browse-the-internet = Pśeglědujśo internet ako ma byś… dermo, wěsće a za wše pśistupny. Pśipowěźejśo swóju njewótwisnosć online.
features-independent-firefox-rebel-with-a = { -brand-name-firefox }: Rebel ze zawinu
...
features-independent-in-addition-to-fighting = Wójujomy za waše pšawa online, źaržymy teke komercielne pśedewześa w šachu a źěłamy z partnerami z cełego swěta gromaźe, aby my wašnje póstupowanja za strowy internet spěchowali. Gaž se za { -brand-name-firefox } rozsuźujośo, rozsuźujomy teke za was.
# Obsolete string
features-independent-firefox-is-a-browser = { -brand-name-firefox } jo wobglědowak z wědobnosću. Ako źěl technologije za wše wužytnego { -brand-name-mozilla }, wójujomy za waše pšawa online, źaržymy komercielne mocy w granicach a pomagamy wuwiśowe kraje w praktiskich źěłabnosćach strowego interneta rozwucowaś. Jolic pótakim { -brand-name-firefox } wuběraśo, wuběramy was teke.
