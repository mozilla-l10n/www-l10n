...
# HTML page title
compare-chrome-firefox-vs-chrome-which-is = { -brand-name-firefox } w pśirownanju ku { -brand-name-chrome }: Kótary jo lěpšy?
...
compare-chrome-google-chrome-is-by-all-accounts = Ako se zda, jo { -brand-name-google } { -brand-name-chrome } wěsty wobglědowak, z funkcijami ako wěste pśeglědowanje, kótarež pomaga, wužywarje pśez to šćitaś, až njepśewidne warnowanje pokazujo, gaž se wopytujo, se k tšašnym sedłam woglědaś abo tšašne dataje ześěgnuś.
...
compare-chrome-fast-forward-to-today-the-updated = Malsny pśedběg až do źinsnajšego, wuběźowańska krajina za wobglědowaki jo se změniła z wjele luźimi, kótarež su zachopili se jadnorje pšasaś, co se z jich datami online ako pśeglědowańska historija, gronidła a druge sensibelne informacije stawa. Wjele jo se wót lěta 2008 změniło, gaž { -brand-name-chrome } jo se zjawił na scenje. Pla { -brand-name-firefox } smy se slědk śěgnuli, aby my naš wužywarski pówjerch pśewugótowali a wužywarjow z rosćeceju licbu pólěpšenjow priwatnosći a wugbaśa, kótarež su pó standarźe awtomatiski, a z wjele pśirucnymi rědami wobglědowaka wobstarali.
# Obsolete string
compare-chrome-fast-forward-to-today-the = Malsny pśedběg až do źinsnajšego, wuběźowańska krajina za wobglědowaki jo se změniła z wjele luźimi, kótarež su zachopili se jadnorje pšasaś, co se z jich datami online ako pśeglědowańska historija, gronidła a druge sensibelne informacije stawa. Wjele jo se wót lěta 2008 změniło, gaž { -brand-name-chrome } jo se zjawił na scenje. Pla { -brand-name-firefox } smy se slědk śěgnuli, aby my naš wužywarski pówjerch pśewugótowali a wužywarjow z rosćeceju licbu pólěpšenjow priwatnosći a wugbaśa a z wjele pśirucnymi rědami wobglědowaka wobstarali.
compare-chrome-and-so-here-we-are-the-browser = A něnto wójna wobglědowaka znowego eskalěrujo a jo cas za nowe pógódnośenje a pśirownanje { -brand-name-firefox-browser } z { -brand-name-google } { -brand-name-chrome }.
compare-chrome-in-2008-google-introduced = W lěśe 2008 jo { -brand-name-google } { -brand-name-chrome } zawjadł a jogo wucynk ako inowacija w technologiji wobglědowaka jo był njepósrědny. Jo sedła malsnjej zacytał a jo zabrał minimalne městno na wobrazowce a jo bitował bźeze cwiblowanja jadnory wužywarski pówjerch.
compare-chrome-in-fact-both-chrome-and-firefox = { -brand-name-chrome } a { -brand-name-firefox } napšawdu striktne wěstotne napšawy k dispoziciji stajotej. Wobej matej něco z mjenim „sandboxing“, kótaryž procese wobglědowaka źěli, až njeby něco ako škódne websedło druge źěle wašogo laptopa abo drugego rěda inficěrowało.
compare-chrome-firefox-also-has-a-sync-feature = { -brand-name-firefox } ma teke synchronizěrowańsku funkciju, aby waše wótwórjone a nejnowše rejtariki, pśeglědowańsku historiju a cytańske znamjenja pśez wšykne waše rědy pokazał.
compare-chrome-almost-needless-to-say-versions = Jo skóro zbytne groniś, wersije { -brand-name-firefox } ako teke { -brand-name-chrome } su za nejwěcej woblubowane desktopowe a mobilne źěłowe systemy ({ -brand-name-windows }, { -brand-name-mac }, { -brand-name-linux }, { -brand-name-android } a { -brand-name-ios }) k dispoziciji.
