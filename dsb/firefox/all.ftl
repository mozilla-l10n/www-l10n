...
firefox-all-download-the-firefox = Ześěgniśo wobglědowak Firefox w engelšćinje (US) a wěcej ako 90 drugich rěcach
# HTML page description, also used as the introductory text.
firefox-all-everyone-deserves-access = Kuždy se pśistup na internet zasłužy - waša rěc njeměła nigda zajźowu byś. Togodla stajamy z pomocu angažěrowanych dobrowólnikow z cełego swěta wobglědowak Firefox we wěcej ako 90 rěcach k dispoziciji.
firefox-all-choose-which-firefox = Wubjeŕśo wobglědowak Firefox, kótaryž cośo w swójej rěcy ześěgnuś
...
firefox-all-windows-installers-for = Instalěrowaki Windows za IT pśedewześow, kótarež konfiguraciju, pśewóstajenje a zastojanje wobglědowaka Firefox wólažcuju.
# Variables:
...
firefox-all-download-product-for = { $product_label } za platformu { $platform } w rěcy { $locale } ześěgnuś
firefox-all-msi-installers = MSI-instalěrowaki
firefox-all-which-version = Kótaru wersiju cośo?
firefox-all-select-your-preferred-installer = Wubjeŕśo instalěrowak, kótaryž maśo lubjej
