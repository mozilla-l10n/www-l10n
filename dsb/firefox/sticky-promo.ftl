...
firefox-sticky-promo-meet-our-family-of = Póznajśo našu produktowu swójźbu
firefox-sticky-promo-meet-mozillas-family = Zeznajśo swójźbu produktow { -brand-name-mozilla }
firefox-sticky-promo-get-the-latest-firefox = Wobstarajśo se nejnowšy wobglědowak { -brand-name-firefox }.
# Products List
firefox-sticky-promo-browsers = Wobglědowaki
