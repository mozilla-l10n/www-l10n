...
sub-navigation-compare-mobile-browsers = Mobilne wobglědowaki pśirownaś
...
sub-navigation-add-ons = Dodanki
...
sub-navigation-android-add-ons = Dodanki { -brand-name-android }
