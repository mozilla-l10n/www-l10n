...
# HTML page title
opt-out-confirmation-cool-we-hear = Wjelicnje. Smy zrozměli.
# Field of a form
opt-out-confirmation-your-email = Waša e-mailowa adresa:
# Only localize "yourname". Do not touch @example.com.
opt-out-confirmation-yournameexamplecom = wašomě@example.com
# This is a button
opt-out-confirmation-manage-preferences = Nastajenja zastojaś
opt-out-confirmation-prefer-to-get = Cośo se lubjej na drugi nałog informěrowaś?
# Link to https://blog.mozilla.org/
opt-out-confirmation-check-out-our = Cytajśo naše blogi
# Link to https://support.mozilla.org/
opt-out-confirmation-get-help = Pomoc se wobstaraś
opt-out-confirmation-subscribe-to = Aboněrujśo naše pśigóźbne aktualizacije powěsćowego lista { -brand-name-firefox }
