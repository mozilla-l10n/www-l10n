...
newsletters-newsletter-subscriptions = Подписки на новостные рассылки
...
newsletters-the-supplied-link-has-expired-v2 = Срок действия предоставленной ссылки истёк. Пожалуйста, <a { $recovery_href }>запросите новую ссылку здесь</a>.
# Obsolete string
...
newsletters-while-here-why-not-check = Пока вы здесь, взгляните на другие удивительные возможности { -brand-name-firefox }.
newsletters-get-up-and-go = С вами в пути
newsletters-its-your-web-anywhere-you = Свой Интернет всегда с собой.
newsletters-get-firefox-for-mobile = Загрузите мобильный { -brand-name-firefox }!
newsletters-added-extras = Добавьте новые трюки
newsletters-make-firefox-do-more-with = Расширьте функционал { -brand-name-firefox } с помощью дополнений.
newsletters-find-out-how = Узнайте как!
newsletters-about-us = О нас
newsletters-whats-mozilla-all-about = В чём заключается работа { -brand-name-mozilla }?
newsletters-were-glad-you-asked = Мы рады, что вы спросили!
# Headline for https://www-dev.allizom.org/newsletter/developer/
newsletters-love-the-web-so-do-we = Любите Интернет? Мы тоже!
...
# Obsolete string
newsletters-join-thousands-of-developers = Присоединяйтесь к тысячам разработчиков, изучающих лучшие практики веб-разработки.
...
# Obsolete string
newsletters-sign-up-read-up-make-a-difference = Подпишитесь. Читайте.<br> Делайте мир лучше.
...
# Name for the newsletter in Newsletter subscription page
newsletters-addon-development = Разработка дополнений
# Name for the newsletter in Newsletter subscription page
newsletters-developer-newsletter = Новости разработчиков
# Description for the newsletter in Newsletter subscription page (Developer Newsletter)
newsletters-a-developers-guide = Руководство разработчика c инновациями веб-платформы, лучшими практиками, новой документацией и многим другим.
# Name for the newsletter in Newsletter subscription page
newsletters-drumbeat-newsgroup = Группа новостей Drumbeat
# Name for the newsletter in Newsletter subscription page
...
newsletters-get-all-the-knowledge = Получите все необходимые вам знания об Интернете, и оставайтесь в нём в безопасности.
# Name for the newsletter in Newsletter subscription page
newsletters-about-labs = О лабораториях
# Name for the newsletter in Newsletter subscription page
newsletters-desktop = Компьютер
# Name for the newsletter in Newsletter subscription page
newsletters-mozillians = Мозилльяне
# Description for the newsletter in Newsletter subscription page (Mozillians)
newsletters-email-updates-from-vouched = Почтовые обновления для поручённых Мозилльян на mozillians.org.
# Name for the newsletter in Newsletter subscription page
newsletters-shapre-of-the-web = Состояние Интернета
# Description for the newsletter in Newsletter subscription page (Shape of the Web)
newsletters-news-and-information = Новости и информация о здоровье Интернета.
# Name for the newsletter in Newsletter subscription page
...
# Obsolete string
newsletters-help-us-make-a-better = Помогите сделать { -brand-name-firefox } ещё лучше, тестируя наши новые продукты и функции.
# Name for the newsletter in Newsletter subscription page
...
newsletters-join-mozillians-all-around = Присоединяйтесь к Мозилльянам со всего мира и узнайте о том, что можно сделать для поддержки { -brand-name-mozilla }.
# Name for the newsletter in Newsletter subscription page
...
newsletters-a-monthly-newsletter-affiliates = Ежемесячная новостная рассылка с новостями программы { -brand-name-firefox } Affiliates.
# Name for the newsletter in Newsletter subscription page
newsletters-firefox-student-ambassadors = Студенты-послы { -brand-name-firefox }
# Description for the newsletter in Newsletter subscription page (Firefox Student Ambassadors)
newsletters-a-monthly-newsletter-ambassadors = Ежемесячная новостная рассылка о том, как принять участие в проекте { -brand-name-mozilla } в вашем кампусе.
# Name for the newsletter in Newsletter subscription page
...
# Name for the newsletter in Newsletter subscription page
newsletters-firefox-os-smartphone-owner = Владеете смартфоном на { -brand-name-firefox-os }?
...
# Name for the newsletter in Newsletter subscription page
newsletters-firefox-weekly-tips = Еженедельные советы { -brand-name-firefox }
# Description for the newsletter in Newsletter subscription page (Firefox Weekly Tips)
newsletters-get-a-weekly-tip = Получайте советы каждую неделю и прокачивайте опыт работы с { -brand-name-firefox }.
# Name for the newsletter in Newsletter subscription page
newsletters-join-mozilla = Присоединиться к { -brand-name-mozilla }
# Name for the newsletter in Newsletter subscription page
newsletters-maker-party = Встреча Создателей
# Description for the newsletter in Newsletter subscription page (Maker Party)
newsletters-mozillas-largest-celebration = Крупнейший праздник в { -brand-name-mozilla } по творению и обучению Интернету.
# Name for the newsletter in Newsletter subscription page
newsletters-firefox-os = { -brand-name-firefox-os }
# Description for the newsletter in Newsletter subscription page (Firefox OS)
newsletters-discover-the-latest = Откройте для себя крутые новые HTML5-приложения на { -brand-name-firefox-os }.
# Description for the newsletter in Newsletter subscription page (Firefox OS)
newsletters-firefox-os-news = { -brand-name-firefox-os }: Новости, советы, информация по запуску и покупке устройств.
# Name for the newsletter in Newsletter subscription page
...
newsletters-keep-up-with-releases = Будьте в курсе релизов и новостей о { -brand-name-firefox } для { -brand-name-android }.
# Name for the newsletter in Newsletter subscription page
newsletters-firefox-news = Новости { -brand-name-firefox }
...
newsletters-special-accouncements-and-messages = Объявления и сообщения от команды, посвятившей себя борьбе за открытость и свободу Интернета.
# Name for the newsletter in Newsletter subscription page
...
newsletters-welcome-emails = Приветственные письма
# Description for the newsletter in Newsletter subscription page (Welcome emails)
newsletter-welcome-emails-that-get-you = Приветственные письма, которые помогут вам начать пользоваться нашими продуктами и услугами.
# Name for the newsletter in Newsletter subscription page
...
newsletters-get-the-news-and-tips = Получайте новости и советы от { -brand-name-mozilla }, чтобы оставаться в безопасности и быть в курсе всего, что делает Интернет лучше.
...
newsletters-opt-out-delay = Обработка вашего запроса на отказ от подписки может занять 1-2 рабочих дня, в течение которых вы можете получить ещё одно электронное письмо.
