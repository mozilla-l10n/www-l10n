...
mission-at-mozilla-were-a-global-community-v2 = { -brand-name-mozilla } представляет собой глобальное сообщество технологов, мыслителей и разработчиков, работающих вместе, чтобы сделать Интернет живым и доступным, чтобы люди во всём мире могли быть информированными участниками и создателями Интернета.
