...
m24-home-keep-your-location = Сохраняйте своё местоположение и онлайн-приключения конфиденциальными — проводите стримы как местный пользователь, где бы вы ни находились.
...
m24-home-solo-desc = Мгновенно создавайте красивый веб-сайт, чтобы вы могли развивать свой бизнес.
m24-home-0din = { -brand-name-0din }
m24-home-0din-desc = Защитите свой ИИ, найдя и исправив уязвимости ГенАи раньше злоумышленников.
...
m24-home-get-started-now = Начать сейчас
...
m24-home-mozilla-is-reinventing-itself = { -brand-name-mozilla } заново изобретает себя, диверсифицируется вокруг множества организаций, переосмысливает рекламу и создаёт экосистему ИИ с открытым исходным кодом. Прочитайте об этом в Отчёте о состоянии { -brand-name-mozilla } в 2024 году.
# Variables
#   $year - year of report
