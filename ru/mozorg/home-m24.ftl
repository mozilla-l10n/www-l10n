...
# HTML Page title
m24-home-page-title = Интернет для людей, а не для прибыли — { -brand-name-mozilla }
m24-home-page-title-v2 = { -brand-name-mozilla } — Интернет для людей, а не для прибыли
# HTML page description
m24-home-page-desc = Знаете ли вы, что { -brand-name-mozilla } — создатель { -brand-name-firefox } — борется за то, чтобы Интернет стал глобальным публичным ресурсом, открытым и доступным для всех и каждого?
m24-home-page-desc-v2 = Мы работаем над тем, чтобы вернуть контроль над Интернетом в руки людей, которые его используют.
...
m24-home-alt-flag = Стилизованный зелёный флаг на чёрном фоне, созданный из буквы «M», означающей { -brand-name-mozilla }, и пикселя, смещенного для отсылки на исходный логотип динозавра.

## Products

m24-home-love-the-internet = Полюбите Интернет снова
m24-home-break-free-from = Освободитесь от больших технологий — наши продукты обеспечивают вам контроль над более безопасным и приватным Интернетом.
m24-home-explore-our-products = Ознакомьтесь с нашими продуктами
m24-home-firefox = { -brand-name-firefox }
m24-home-get-the-gold = Получите золотой стандарт для сёрфинга со скоростью, конфиденциальностью и контролем.
m24-home-thunderbird = { -brand-name-thunderbird }
m24-home-go-chaosfree-with = Упростите свою жизнь с помощью одного приложения для всей электронной почты, календарей и контактов.
m24-home-mozilla-vpn = { -brand-name-mozilla-vpn }
m24-home-keep-your-location = Сохраняйте свое местоположение и онлайн-приключения конфиденциальными — проводите стримы как местный пользователь, где бы вы ни находились.
...
m24-home-donate-to-the = Сделайте пожертвование в пользу некоммерческой организации { -brand-name-mozilla }
m24-home-donate-to-v2 = Пожертвовать { -brand-name-mozilla-foundation }
# Obsolete string (expires 04-12-2025)
m24-home-mozilla-is-building = { -brand-name-mozilla } строит движение за возвращение Интернета. Вместе мы можем построить будущее, в котором наша конфиденциальность защищена, ИИ заслуживает доверия, а безответственные технологические компании несут ответственность. Но это возможно, только если мы будем делать это вместе.
m24-home-mozilla-foundation-is-building-v2 = { -brand-name-mozilla-foundation } строит будущее, в котором технологии поддерживаются людьми и являются открытыми по замыслу. Вот почему мы поддерживаем технологии, ориентированные на сообщества, через защиту интересов, обучение, финансирование и инновации, чтобы убедиться, что будущее технологий — это хорошо для всех и каждого. Но это возможно, только если мы будем делать это вместе.
m24-home-were-proudly-nonprofit = Мы — некоммерческая организация. Можете ли вы сделать пожертвование в пользу { -brand-name-mozilla }?
m24-home-donate = Пожертвовать

## AI gallery

m24-home-tag-product = Продукт
m24-home-tag-project = Проект
m24-home-tag-program = Программа
m24-home-tag-event = Событие
m24-home-read-more = Подробнее
...
# Used as an accessible text alternative for an image
m24-home-alt-mozfest = Большая группа людей, собравшихся в оживлённом закрытом месте, вид сверху.
m24-home-mozfest-join-us = Присоединяйтесь к нам на { -brand-name-mozilla-festival }
m24-home-mozfest-the-future = Будущее технологий не предопределено — мы можем его формировать. Присоединяйтесь к нам в Атланте 7 и 9 ноября, чтобы отучиться от настроек по умолчанию, смелее воображать и строить то, что будет дальше.
m24-home-mozfest-get-your = Получите ваш значок сегодня
# Used as an accessible text alternative for an image
...
m24-home-introducing-thundermail-and-v2 = Представляем { -brand-name-thundermail } и { -brand-name-thunderbird-pro }
...
m24-home-rise25-awards = Награды { -brand-name-rise25 }
m24-home-get-to-know = Познакомьтесь с лидерами, отстаивающими доверенное, всеохватывающее и прозрачное развитие ИИ, поскольку они устанавливают новый стандарт и вдохновляют следующее поколение новаторов.
m24-home-watch-the-award = Посмотреть награждение
# Used as an accessible text alternative for an image
m24-home-alt-rise25-proud = Гордый наградой на { -brand-name-rise25 }.
# Used as an accessible text alternative for an image
...
m24-home-state-of-mozilla = Состояние { -brand-name-mozilla }
m24-home-mozilla-is-reinventing-itself = { -brand-name-mozilla } заново изобретает себя, диверсифицируется вокруг множества организаций, переосмысливает рекламу и создает экосистему ИИ с открытым исходным кодом. Прочитайте об этом в Отчёте о состоянии { -brand-name-mozilla } в 2024 году.
# Used as an accessible text alternative for an image
