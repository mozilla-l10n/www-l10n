...
features-private-browsing-private-browsing-mode-opens = В режиме приватного просмотра открывается новое окно браузера. Когда вы закроете его, ваша история посещений этого окна и все отслеживающие куки с посещенных вами веб-сайтов будут удалены. <strong>Профессиональный совет { -brand-name-firefox }:</strong> не забудьте закрыть окно приватного просмотра, когда закончите!
