...
bookmark-manager-you-can-import-your-bookmarks = Вы можете импортировать свои закладки из Chrome, Safari или Edge с помощью мастера импорта { -brand-name-firefox }. Просто нажмите «Закладки» > «Управление закладками», а затем выберите «Импорт и резервное копирование».
# Used as an accessible text alternative for an image
...
bookmark-manager-get-quick-access-to-your = Получите быстрый доступ к вашим любимым закладкам в меню сверху { -brand-name-firefox } или закрепите их на панели инструментов.
# Used as an accessible text alternative for an image
