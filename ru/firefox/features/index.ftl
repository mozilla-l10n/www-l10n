...
# Hero description
features-index-firefox-is-fast = { -brand-name-firefox } — это быстрый, лёгкий, ориентированный на приватность браузер, работающий на всех ваших устройствах.
features-index-add-powerful-functions = Добавьте мощные и полезные функции и даже немного развлечений в свой браузер { -brand-name-firefox }.
features-index-see-all = Посмотреть все расширения
...
features-index-by-not-for-profit-mozilla = От некоммерческой организации { -brand-name-mozilla }
features-index-keep-corporate-power = Держим корпоративную силу под контролем
features-index-independent-browser = { -brand-name-firefox } является единственным крупным независимым браузером.
features-index-on-a-mission = С миссией сделать Интернет открытым и доступным для всех и каждого.
features-index-read-mozillas-mission = Прочитайте о миссии { -brand-name-mozilla }
...
features-index-fingerprinting-is-a = Сбор цифровых отпечатков — это более агрессивный вид онлайн-отслеживания, чем обычное отслеживание с помощью кук, поэтому { -brand-name-firefox-browser } блокирует его.
