...
firefox-desktop-download-meta-desc = Получите { -brand-name-firefox }, бесплатный веб-браузер, поддерживаемый { -brand-name-mozilla }, некоммерческой организацией, занимающейся вопросами интернет-здоровья и приватности. Уже доступен на { -brand-name-windows }, { -brand-name-mac-short }, { -brand-name-linux }, { -brand-name-android } и { -brand-name-ios }.
...
firefox-desktop-download-take-your-privacy = Ваша приватность всегда будет с вами. { -brand-name-firefox-browsers } для { -brand-name-ios } и { -brand-name-android } имеют одинаково строгие настройки приватности, чтобы трекеры не могли следить за вами в Интернете, где бы вы ни находились.
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words, please omit the strong tags if they need to be around multiple words in your language
