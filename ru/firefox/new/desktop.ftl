...
firefox-desktop-download-get-all-the-speed = Получите всю скорость и инструменты без вторжения в приватность. { -brand-name-firefox-browser(case: "nominative_uppercase") } собирает о вас так мало данных, что нам даже не нужен ваш адрес электронной почты для загрузки. Это потому, что, в отличие от других браузеров, мы не заинтересованы в том, чтобы следить за вами в Интернете.
