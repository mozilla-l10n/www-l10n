...
# Obsolete string
browsers-mobile-at-home-or-on-the-move = Дома или в пути, вы достойны приватности на всех устройствах. Улучшенная защита от отслеживания встроена во все мобильные браузеры { -brand-name-firefox }.
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words; please omit the strong tags if they need to be around multiple words in your language.
# Obsolete string
browsers-mobile-get-the-mobile-browser-privacy = Получите мобильный браузер, для которого ваша <strong>приватность</strong> — на первом месте
