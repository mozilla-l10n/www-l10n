...
browsers-mobile-see-how-firefox-for-desktop-stacks-v2 = Посмотрите, чем { -brand-name-firefox } для компьютера отличается от других браузеров.
...
browsers-mobile-see-how-firefox-for-desktop-strong-v2 = Посмотрите, чем { -brand-name-firefox } для <strong>компьютера</strong> отличается от других браузеров.
# Obsolete string (expires 30 June 2024)
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words; please omit the strong tags if they need to be around multiple words in your language.
