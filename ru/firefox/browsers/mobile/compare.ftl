...
# Obsolete string
mobile-compare-at-a-minimum = Как минимум, браузер должен поддерживать некоторую версию «режима приватного просмотра», который будет автоматически удалять вашу историю просмотра и поиска. Этому критерию отвечают все семь сравниваемых браузеров.
mobile-compare-another-mobile-feature = Ещё одна функция браузера, обязательная к предоставлению — возможность предотвращать отслеживание веб-сайтами и компаниями ваших просмотров и покупок даже в обычном режиме.
