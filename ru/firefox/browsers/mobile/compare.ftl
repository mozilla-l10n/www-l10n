...
mobile-compare-since-your-mobile = Поскольку мобильный браузер является вашим ключевым средством доступа к информации, его скорость, безопасность, приватность и удобство очень важны. Так какой же из мобильных браузеров — лучший? Сравним самых популярных игроков и выясним, какой из них наиболее полно соответствует вашим потребностям.
mobile-compare-which-mobile-browser = Какой мобильный браузер заботится о вашей приватности?
mobile-compare-at-a-minimum-v2 = Как минимум, мобильный браузер должен поддерживать некоторую версию «режима приватного просмотра», который будет автоматически удалять вашу историю просмотра и поиска. Этому критерию отвечают все пять сравниваемых браузеров.
# Obsolete string
mobile-compare-at-a-minimum = Как минимум, мобильный браузер должен поддерживать некоторую версию «режима приватного просмотра», который будет автоматически удалять вашу историю просмотра и поиска. Этому критерию отвечают все семь сравниваемых браузеров.
mobile-compare-another-mobile-feature = Ещё одна функция, обязательная к предоставлению — возможность предотвращать отслеживание веб-сайтами и компаниями ваших просмотров и покупок даже в обычном режиме.
mobile-compare-blocking-thirdparty-trackers = Блокировка сторонних трекеров не только важна для приватности — она также помогает страницам загружаться намного быстрее, не давая лишним фрагментам кода прикрепляться к вашему браузеру и замедлять его работу.
...
mobile-compare-the-good-news = Хорошая новость для пользователей { -brand-name-iphone }: недавно { -brand-name-apple } разрешила выбирать собственный браузер по умолчанию в { -brand-name-iphone }, поэтому теперь вы можете синхронизировать устройства между платформами, например, установив { -brand-name-firefox } на свои { -brand-name-iphone } и ПК { -brand-name-windows }.
mobile-compare-conclusion = Заключение
mobile-compare-based-on-the = Исходя из изложенных нами критериев — приватности, функциональности и переносимости — существует только один браузер, соответствующий всем трём, и это — { -brand-name-firefox }. Несмотря на схожесть в возможностях и категориях синхронизации, { -brand-name-firefox } выделяется приватностью, потому что мы считаем её основной составляющей, позволяющей вам наслаждаться Интернетом именно так, как вы хотите.
mobile-compare-our-recommendations-aside = Наши рекомендации не обязательны, поиск подходящего для вас браузера всегда будет зависеть от ваших индивидуальных потребностей и того, что вы больше всего цените при работе в Интернете.
...
mobile-compare-add-to-homescreen = Добавление на домашний экран
mobile-compare-read-text-aloud = Озвучивание текста
...
mobile-compare-mobile-os-availability = Доступность для мобильных ОС
...
mobile-compare-primary-password = Основной пароль
mobile-compare-get-firefox-for-mobile = Получите { -brand-name-firefox } для мобильных устройств
mobile-compare-send-a-download-link-to-your = Отправить ссылку для загрузки на мой телефон.
mobile-compare-scan-the-qr-code-to-get-started = Отсканируйте QR-код, чтобы начать загрузку
mobile-compare-scan-alt-text = Отсканируйте QR-код, чтобы получить { -brand-name-firefox } на своё мобильное устройство
