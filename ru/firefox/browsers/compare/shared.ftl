...
compare-shared-tab-browsing = Поддержка вкладок
...
compare-shared-in-browser-screenshot-tool = Встроенный инструмент для создания снимков экрана
compare-shared-os-availability = Доступность для ОС
...
compare-shared-download-firefox-browser = Загрузить { -brand-name-firefox-browser }
compare-shared-download-the-app = Загрузить приложение
compare-shared-desktop = Для компьютера
