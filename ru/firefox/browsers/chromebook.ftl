...
browsers-chromebook-alwayson-tracking-protection = Всегда включенная защита от отслеживания: по умолчанию в { -brand-name-firefox } включена Улучшенная защита от отслеживания (ETP), чтобы защищать ваши личные данные от известных рекламных трекеров, трекеров социальных сетей и криптомайнинговых скриптов, отслеживающих вас в Интернете.
