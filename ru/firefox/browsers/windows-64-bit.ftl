...
windows-64-bit-users-on-64-bit-windows-crashes = Пользователи 64-битной { -brand-name-windows }, загружающие { -brand-name-firefox }, получат 64-битную версию по умолчанию. Это означает, что вы будете использовать более безопасную версию { -brand-name-firefox }, которая также <a href="{ $crashes }">гораздо реже падает</a>. Насколько реже? По нашим тестам, 64-битный { -brand-name-firefox } падает на 39 % реже на машинах с 4 ГБ памяти и более.
