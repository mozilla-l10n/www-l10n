...
privacy-passwords-when-youre-logged-v2 = Когда вы вошли в { -brand-name-firefox } со своим { -brand-name-mozilla-account }, вы можете синхронизировать все свои устройства и получить доступ к своим паролям из мобильного браузера { -brand-name-firefox }. Узнайте больше о том, <a { $url_sumo_manager }>как максимально эффективно использовать встроенный менеджер паролей</a>.
...
#   $url_sumo_2fa (string) - link to https://support.mozilla.org/kb/secure-firefox-account-two-step-authentication with additional attributes for analytics
privacy-passwords-your-mozilla-account = Например, ваш { -brand-name-mozilla-account } можно защитить с помощью двухфакторной аутентификации, <a { $url_sumo_2fa }>о чём вы можете узнать подробнее здесь</a>.
