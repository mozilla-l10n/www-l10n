...
choose-which-firefox = Выберите, какой { -brand-name-firefox-browser } скачать на вашем языке
...
firefox-more-quantum-was-revolution = { -brand-name-firefox-quantum } произвёл революцию в разработке { -brand-name-firefox }. В 2017 году мы создали новый, молниеносно быстрый браузер, который постоянно совершенствуется. { -brand-name-firefox-quantum } — это { -brand-name-firefox-browser }.
