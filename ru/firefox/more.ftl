...
firefox-more-you-can-reclaim = Вы можете вернуть свою приватность и обрести контроль над собственными действиями в Интернете! На самом деле это удивительно легко. Это может каждый.
firefox-more-firefox-sync = { -brand-name-firefox-sync }
firefox-more-access-your-sync = Получайте доступ и синхронизируйте свои закладки, пароли, открытые вкладки и многое другое — где бы вы ни использовали { -brand-name-firefox }.
...
be-bold-and = Будьте смелыми и отважными, выбирая подходящий браузер.
comparing-firefox-edge = Сравнение { -brand-name-firefox-browser(case: "genitive") } с { -brand-name-microsoft } { -brand-name-edge }
youll-never-guess = Вы никогда не угадаете, какой браузер имеет преимущество, когда дело касается скорости и функций.
comparing-firefox-ie = Сравнение { -brand-name-firefox-browser(case: "genitive") } с { -brand-name-microsoft } { -brand-name-ie }
old-habits-that = От старых привычек трудно избавиться, но когда вы это сделаете, вы почувствуете себя лучше.
comparing-firefox-safari = Сравнение { -brand-name-firefox-browser(case: "genitive") } с { -brand-name-apple } { -brand-name-safari }
you-dont-have = Вам не обязательно использовать стандартный браузер по умолчанию.
comparing-firefox-opera = Сравнение { -brand-name-firefox-browser(case: "genitive") } с { -brand-name-opera }
be-free-to = Смело воспевайте { -brand-name-firefox }, когда захотите.
the-ad-blocker = Блокировщик рекламы — секретное оружие против раздражающей рекламы.
so-many-ads = Так много рекламы, так мало терпения… Пришло время остановить это безумие.
firefox-more-protection = { -brand-name-firefox }: Больше защиты. Меньше волнения.
...
firefox-more-is-firefox-a-private-browser = Является ли { -brand-name-firefox } конфиденциальным браузером?
firefox-more-were-focused-on-your-right-to = Мы сосредоточены на вашем праве на неприкосновенность частной жизни. Ваши данные, ваша активность в Интернете, ваша жизнь в Интернете защищены с помощью { -brand-name-firefox }.
