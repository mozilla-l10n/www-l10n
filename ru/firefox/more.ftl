...
choose-which-firefox = Выберите, какой { -brand-name-firefox-browser(case: "nominative") } скачать на вашем языке
...
firefox-more-quantum-was-revolution = { -brand-name-firefox-quantum } произвёл революцию в разработке { -brand-name-firefox }. В 2017 году мы создали новый, молниеносно быстрый браузер, который постоянно совершенствуется. { -brand-name-firefox-quantum } — это { -brand-name-firefox-browser(case: "nominative") }.
we-believe-everyone = Мы считаем, что у каждого должен быть доступ к Интернету, поэтому мы делаем { -brand-name-firefox-browser(case: "nominative") } доступным на более чем 90 языках с помощью волонтёров со всего мира.
