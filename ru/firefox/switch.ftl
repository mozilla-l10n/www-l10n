...
switch-spread-the-word = Расскажите о { -brand-name-firefox } и помогите вашим близким и друзьям попрощаться с { -brand-name-chrome }.
switch-share-with-your-friends = Поделитесь со своими друзьями информацией о том, как перейти на { -brand-name-firefox }
switch-firefox-makes-switching-fast-tweet = 🔥 { -brand-name-firefox } делает переход с { -brand-name-chrome } действительно быстрым. Попробуйте!
