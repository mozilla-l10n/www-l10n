...
lockwise-only-in-the-firefox-browser = Только в { -brand-name-firefox-browser(case: "prepositional") }
lockwise-256-bit-encryption-protects = 256-битное шифрование защищает вас во время синхронизации
lockwise-get-to-your-passwords-securely = Безопасный доступ к паролям с помощью Face или Touch ID
lockwise-your-privacy-comes-first = Ваша приватность всегда на первом месте.
lockwise-we-keep-your-data-safe = Мы храним ваши данные в безопасности, и никогда их не продадим.
lockwise-support = Поддержка
lockwise-your-privacy = Ваша приватность
