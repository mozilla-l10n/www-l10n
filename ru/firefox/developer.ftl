...
firefox-developer-the-new-fonts-panel = Новая панель шрифтов в { -brand-name-firefox-devtools(case: "prepositional") } даёт быстрый доступ ко всей необходимой информации о шрифтах, использованных в элементе. Она также отображает полезные сведения, например, источник шрифта, размер, стиль и другое.
