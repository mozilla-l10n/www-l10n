...
firefox-accounts-travel-the-internet = Работайте в Интернете с защитой на всех устройствах.
firefox-accounts-encrypt-your = Зашифруйте свою сетевую активность и скройте свой IP-адрес
firefox-accounts-we-never = Мы никогда не регистрируем, не отслеживаем и не передаём ваши сетевые данные
firefox-accounts-save-articles = Сохраняйте статьи из Интернета
firefox-accounts-read-in-a = Читайте в тихом, уединенном месте
...
firefox-accounts-firefox-browser = { -brand-name-firefox-browser(case: "nominative_uppercase") }
