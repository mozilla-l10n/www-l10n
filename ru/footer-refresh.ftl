...
footer-refresh-get-the-best = Получайте лучшие советы, хитрости и обновления { -brand-name-firefox }. Мы обещаем, что ваша электронная почта будет приватной и безопасной — только лучшее от { -brand-name-firefox } будет отправлено прямо в ваш почтовый ящик.
footer-refresh-leadership = Руководство
footer-refresh-advertise = Рекламируйтесь в { -brand-name-mozilla }
...
footer-refresh-x = н
footer-refresh-x-formerly-twitter = X (ранее Twitter)
footer-refresh-mastodon = Mastodon
footer-refresh-instagram = Инстаграм
footer-refresh-linkedin = LinkedIn
footer-refresh-tiktok = TikTok
footer-refresh-spotify = Spotify
footer-refresh-follow-firefox = Подписаться на @{ -brand-name-firefox }
footer-refresh-youtube = YouTube
footer-refresh-company = Компания
...
footer-refresh-resources = Ресурсы
footer-refresh-brand-standards = Стандарты бренда
...
footer-refresh-visit-mozilla-corporations = Посетите сайт некоммерческой материнской компании <a { $moco_link }>{ -brand-name-mozilla-corporation }</a> — <a { $mofo_link }>{ -brand-name-mozilla-foundation }</a>.
...
footer-refresh-community-participation-guidelines = Правила поведения в сообществах
