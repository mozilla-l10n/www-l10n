...
footer-visit-mozilla-corporations = Посетите сайт некоммерческой <a { $mofo_link }>{ -brand-name-mozilla-foundation }</a> — родительской компании для <a { $moco_link }>{ -brand-name-mozilla-corporation }</a>.
