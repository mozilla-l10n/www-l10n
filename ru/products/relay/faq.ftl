...
phone-masking-faq-answer-what-is = Подобно псевдониму электронной почты, псевдоним номера телефона — это номер телефона, который может пересылать текстовые сообщения и звонки на ваш настоящий номер телефона, не раскрывая ваш настоящий номер человеку, который вам звонит или пишет.
...
phone-masking-faq-question-disable-logging = Могу ли я отключить регистрацию звонящих или отправителей текстовых сообщений?
phone-masking-faq-answer-disable-logging = Да, вы можете отключить регистрацию номеров на панели управления { -brand-name-relay }. Однако вы больше не сможете отвечать на текстовые сообщения или блокировать определенные номера, поскольку с помощью журнала мы можем отслеживать, кто отправил вам текстовое сообщение.
