...
vpn-mac-devices-headline = Защитите { $devices } устройств с помощью одной подписки
vpn-mac-speed-headline = Не нужно жертвовать скоростью
vpn-mac-log-headline = То, что вы делаете в Интернете — ваше дело
