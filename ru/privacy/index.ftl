...
privacy-index-to-review-and-comment-on-proposed = Чтобы просмотреть и прокомментировать предложения по изменению политики конфиденциальности, <a href="{ $group }"> подпишитесь на группу управления { -brand-name-mozilla }</a>.
# Variables:
