...
page-gone-title = Эта страница была удалена
page-gone-body = Извините, но это содержимое больше недоступно. Вы можете перейти по некоторым ссылкам ниже, чтобы найти более актуальную информацию.
gone-page-go-back = Вернуться назад
# Variables:
