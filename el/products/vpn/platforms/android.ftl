...
vpn-android-ability = Προστατέψτε τα δεδομένα σας από hackers και αδιάκριτα βλέμματα — τόσο στο σπίτι όσο και σε δημόσια Wi-Fi — με το { -brand-name-mozilla-vpn }. Στην τιμή ενός καφέ, τα προσωπικά σας δεδομένα στην { -brand-name-android } συσκευή σας λαμβάνουν προηγμένη κρυπτογράφηση μέσω του πρωτοκόλλου { -brand-name-wireguard }®. Χρησιμοποιήστε το { -brand-name-mozilla-vpn } για παρακολούθηση εκπομπών, παιχνίδια, διαχείριση οικονομικών, αγορές και οτιδήποτε άλλο στο διαδίκτυο, γνωρίζοντας ότι η σύνδεσή σας είναι ασφαλής.
...
vpn-android-about-copy = Είμαστε κυρίως γνωστοί για το πρόγραμμα περιήγησής μας, το { -brand-name-firefox }, αλλά η { -brand-name-mozilla } έχει μια βασική αποστολή — να αγωνιστεί για τα δικαιώματά σας στο διαδίκτυο. Είναι αυτό που κάνουμε πάντα, από το 1998. Είμαστε υποστηρικτές του διαδικτύου και δεσμευόμαστε να διασφαλίσουμε ότι θα παραμείνει ανοικτό και δωρεάν, σεβόμενοι παράλληλα το δικαίωμα του καθενός στην ιδιωτικότητα και την ασφάλεια.
