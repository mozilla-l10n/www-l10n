...
phone-masking-faq-answer-can-i-see = Ναι, μπορείτε να δείτε τον αριθμό που σας έστειλε μήνυμα ή σας κάλεσε. Μπορείτε επίσης να απενεργοποιήσετε την αποθήκευση αυτών των αρχείων καταγραφής, αλλά θα χάσετε τη δυνατότητα να απαντάτε ή να αποκλείετε μεμονωμένους καλούντες και αποστολείς μηνυμάτων.
phone-masking-faq-question-can-i-block = Μπορώ να αποκλείσω μια κλήση ή ένα μήνυμα κειμένου;
phone-masking-faq-answer-can-i-block = Μπορείτε να αποκλείσετε όλες τις προωθήσεις από έναν αριθμό.
phone-masking-faq-question-spam = Τι κάνω αν η μάσκα τηλεφώνου μου αρχίσει να λαμβάνει ανεπιθύμητα μηνύματα;
...
phone-masking-faq-answer-disable-logging = Ναι, μπορείτε να απενεργοποιήσετε την καταγραφή των αριθμών από τον πίνακα ελέγχου του { -brand-name-relay }. Ωστόσο, δεν θα μπορείτε πλέον να απαντάτε σε μηνύματα ή να αποκλείετε συγκεκριμένους αριθμούς, επειδή το αρχείο καταγραφής μάς επιτρέπει να παρακολουθούμε ποιος σας έστειλε μήνυμα.
...
phone-masking-faq-answer-how-i-save-card = Μόλις κάνετε αναβάθμιση στην απόκρυψη αριθμού τηλεφώνου του { -brand-name-relay }, θα σας στείλουμε μια κάρτα επαφής με τον αριθμό από τον οποίο θα λαμβάνετε προωθημένες κλήσεις και μηνύματα, όπως κάθε κάρτα επαφής που αποθηκεύει τους αριθμούς των ατόμων που επικοινωνούν μαζί σας. Στις περισσότερες συσκευές, μπορείτε να αποθηκεύσετε αυτήν την κάρτα επαφής όπως κάθε άλλη επαφή.
