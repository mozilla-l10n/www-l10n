...
sub-navigation-compare-mobile-browsers = Σύγκριση προγραμμάτων περιήγησης κινητών συσκευών
...
sub-navigation-addons = Πρόσθετα
sub-navigation-add-ons = Πρόσθετα
...
sub-navigation-privacy = Απόρρητο
