...
navigation-v2-get-mozilla-vpn = Λήψη του { -brand-name-mozilla-vpn }
navigation-v2-menu = Μενού

## Firefox menu

navigation-v2-firefox-browsers = { -brand-name-firefox-browsers }
navigation-v2-close-firefox-browsers-menu = Κλείσιμο μενού { -brand-name-firefox-browsers }
navigation-v2-firefox-for-desktop = { -brand-name-firefox } για υπολογιστές
navigation-v2-get-the-not-for-profit-backed = Αποκτήστε το μη κερδοσκοπικό πρόγραμμα περιήγησης για { -brand-name-windows }, { -brand-name-mac-short } ή { -brand-name-linux }.
navigation-v2-firefox-for-android = { -brand-name-firefox } για { -brand-name-android }
navigation-v2-get-the-customizable-mobile = Αποκτήστε το προσαρμόσιμο πρόγραμμα περιήγησης για { -brand-name-android } smartphones.
navigation-v2-firefox-for-ios = { -brand-name-firefox } για { -brand-name-ios }
navigation-v2-get-the-mobile-browser = Αποκτήστε το πρόγραμμα περιήγησης για το { -brand-name-iphone } ή το { -brand-name-ipad } σας.
navigation-v2-firefox-for-mobile = { -brand-name-firefox-browser } για κινητές συσκευές
navigation-v2-take-speed-privacy-and = Ταχύτητα, απόρρητο και ξέγνοιαστη περιήγηση. Σε { -brand-name-android } και { -brand-name-ios }.
navigation-v2-firefox-focus = { -brand-name-firefox-focus }
navigation-v2-simply-private-mobile = Απλά ιδιωτική περιήγηση σε κινητές συσκευές.
...
navigation-v2-view-all-firefox-browsers = Προβολή όλων των προϊόντων { -brand-name-firefox-browsers }

## Products menu

navigation-v2-products = Προϊόντα
navigation-v2-close-products-menu = Κλείσιμο μενού προϊόντων
...
navigation-v2-use-ai-to-detect = Χρησιμοποιήστε τεχνητή νοημοσύνη για να εντοπίσετε ψευδείς κριτικές και απάτες
...
navigation-v2-leadership = Ηγεσία
navigation-v2-meet-the-team-thats-building = Γνωρίστε την ομάδα που δημιουργεί τεχνολογία για ένα καλύτερο διαδίκτυο.
...
navigation-v2-impact = Επίδραση
navigation-v2-find-out-how = Μάθετε πώς κάνουμε το διαδίκτυο πιο συμπεριληπτικό και βιώσιμο

## Innovation menu

navigation-v2-innovation = Καινοτομία
navigation-v2-close-innovation-menu = Κλείσιμο μενού καινοτομίας
...
navigation-v2-check-out-the-home-for-web = Δείτε το αρχείο μας με πόρους προγραμματισμού web.
navigation-v2-firefox-reality = { -brand-name-firefox-reality }
navigation-v2-explore-the-web-with-the = Εξερευνήστε το διαδίκτυο με το { -brand-name-firefox } για εικονική πραγματικότητα.
...
navigation-v2-mozilla-innovation-projects = Έργα καινοτομίας της { -brand-name-mozilla }
navigation-v2-discover-ways-to-bring = Ανακαλύψτε τρόπους για να υλοποιήσετε λαμπρές ιδέες.
