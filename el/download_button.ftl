...
download-button-free-google-play = Δωρεάν από το { -brand-name-google-play }
download-button-app-store = Δωρεάν από το { -brand-name-app-store }
download-button-download-app-store = Λήψη από το { -brand-name-app-store }
download-button-download-firefox = Λήψη του { -brand-name-firefox }
download-button-your-system-may = Το σύστημά σας ενδέχεται να μην πληροί τις απαιτήσεις για την εκτέλεση του { -brand-name-firefox }, ωστόσο μπορείτε να δοκιμάσετε μια από αυτές τις εκδόσεις:
