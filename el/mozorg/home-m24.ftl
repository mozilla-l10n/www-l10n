...
m24-home-get-the-gold = Αποκτήστε τη βέλτιστη επιλογή για γρήγορη και ιδιωτική περιήγηση, όπου έχετε τον απόλυτο έλεγχο.
m24-home-thunderbird = { -brand-name-thunderbird }
m24-home-go-chaosfree-with = Απλοποιήστε τη ζωή σας με μία εφαρμογή για όλα τα email, τα ημερολόγια και τις επαφές σας.
...
m24-home-tabstack-desc = Αυτοματοποιήστε αξιόπιστα τις διαδικτυακές εργασίες με ένα απλό API που εστιάζει στους προγραμματιστές.
...
m24-home-mozilla-foundation-is-building-v2 = Το { -brand-name-mozilla-foundation } χτίζει ένα μέλλον όπου η τεχνολογία θα βασίζεται στους ανθρώπους και θα έχει ανοικτό σχεδιασμό. Γι' αυτό υποστηρίζουμε την τεχνολογία που λειτουργεί με γνώμονα την κοινότητα, μέσω της ευαισθητοποίησης, της εκπαίδευσης, της χρηματοδότησης και της καινοτομίας. Στόχος μας είναι να διασφαλίσουμε ότι το μέλλον της τεχνολογίας θα ωφελεί όλους τους ανθρώπους. Αλλά αυτό μπορεί να συμβεί μόνο αν το κάνουμε μαζί.
...
m24-home-tag-product = Προϊόν
m24-home-tag-project = Έργο
m24-home-tag-program = Πρόγραμμα
...
m24-home-get-to-know = Γνωρίστε τους ηγέτες που υπερασπίζονται την ανάπτυξη της αξιόπιστης, συμπεριληπτικής και διαφανούς τεχνητής νοημοσύνης, καθώς θέτουν νέα πρότυπα και εμπνέουν την επόμενη γενιά καινοτόμων.
