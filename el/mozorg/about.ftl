...
about-pioneers-of-the-open-web = Πρωτοπόροι του ανοικτού ιστού
about-our-leadership-has-been-at = Η ηγεσία μας έχει βρεθεί στην πρώτη γραμμή της δημιουργίας ενός πιο υγιούς διαδικτύου από την 1η ημέρα. Αυτό που ξεκίνησε ως μια εναλλακτική λύση στην εταιρική κυριαρχία, έχει εξελιχθεί σε μια παγκόσμια δύναμη για το καλό του διαδικτύου.
...
about-learn-about-the-mozilla-foundation = Μάθετε σχετικά με το Ίδρυμα Mozilla
...
about-taipei = Ταϊπέι
# The number inside the strong tag will be big, bold, and on its own line. Remove the strong tag if you need to put the number in the middle of the phrase.
about-400-collaborative-visits-with = <strong>400</strong> συνεργατικές επισκέψεις με υπαλλήλους της { -brand-name-mozilla } employees κάθε χρόνο.
about-toronto = Τορόντο
# The number inside the strong tag will be big, bold, and on its own line. Remove the strong tag if you need to put the number in the middle of the phrase.
about-800-bottles-of-cold-brew-coffee = <strong>800</strong> μπουκάλια κρύου καφέ καταναλώνονται ετησίως.
