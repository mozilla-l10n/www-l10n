...
history-new-versions-of-firefox = Νέες εκδόσεις του { -brand-name-firefox } κυκλοφορούν τακτικά από τότε και συνεχίζουν να κάνουν νέα ρεκόρ. Η δημοτικότητα του { -brand-name-firefox } έχει δώσει ξανά στους χρήστες την ελευθερία της επιλογής.
# Variables:
