...
moz-account-already-have = Έχετε ήδη λογαριασμό; <a { $sign_in_url }>Συνδεθείτε</a> ή <a { $learn_more_url }>μάθετε περισσότερα</a> σχετικά με τη { -brand-name-mozilla }
moz-account-get-a-mozilla-account = Αποκτήστε έναν { -brand-name-mozilla-account(case: "acc", capitalization: "lower") }
