...
privacy-firefox-firefox-protects-you = Το { -brand-name-firefox } σάς προστατεύει από γνωστούς ιχνηλάτες τρίτων, κοινωνικών δικτύων, cryptominers, cookies και τεχνολογίες fingerprinting που προσπαθούν να σας ακολουθήσουν στο διαδίκτυο.
