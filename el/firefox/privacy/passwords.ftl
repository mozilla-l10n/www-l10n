...
privacy-passwords-when-an-attacker = Όταν ένας εισβολέας υποκλέψει τη βάση δεδομένων κωδικών πρόσβασης ενός ιστοτόπου που χρησιμοποιείτε (όπως το <a { $url_linkedin }>LinkedIn</a> ή το <a { $url_yahoo }>Yahoo</a>), το μόνο που μπορείτε να κάνετε είναι να αλλάξετε τον κωδικό πρόσβασής σας για αυτόν τον ιστότοπο. Αυτό είναι σοβαρό, αλλά η ζημιά μπορεί να είναι πολύ χειρότερη εάν έχετε χρησιμοποιήσει τον ίδιο κωδικό πρόσβασης σε άλλους ιστοτόπους — ο εισβολέας θα έχει πρόσβαση και σε αυτούς τους λογαριασμούς. Για να περιορίσετε τη ζημιά, <strong>χρησιμοποιήστε πάντα διαφορετικούς κωδικούς πρόσβασης για διαφορετικούς ιστοτόπους.</strong>
...
privacy-passwords-in-todays-internet = Στο σημερινό διαδίκτυο, όπου χιλιάδες κωδικοί πρόσβασης υποκλέπτονται καθημερινά και που λογαριασμοί ανταλλάσσονται στη μαύρη αγορά, αξίζει τον κόπο να προφυλάξετε τη διαδικτυακή σας ζωή. Με τα προϊόντα { -brand-name-firefox }, απαλλάσσεστε μερικώς από αυτόν τον κόπο, καθώς όλα τα προϊόντα μας αναπτύσσονται για να τηρούν την <a { $url_privacy_products }>υπόσχεση απορρήτου</a> μας. Και το { -brand-name-firefox } καθοδηγείται πάντα από την <a { $url_about_manifesto }>αποστολή της Mozilla</a>, του μη κερδοσκοπικού οργανισμού που μας υποστηρίζει, για τη δημιουργία ενός καλύτερου διαδικτύου.
