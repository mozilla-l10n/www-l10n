...
firefox-more-you-can-reclaim = Μπορείτε να προστατεύσετε το απόρρητό σας και να ανακτήσετε τον έλεγχο της εμπειρίας περιήγησής σας! Είναι πραγματικά εύκολο. Όλοι μπορούν να το κάνουν.
firefox-more-firefox-sync = { -brand-name-firefox-sync }
firefox-more-access-your-sync = Συγχρονισμός σελιδοδεικτών, κωδικών πρόσβασης, ανοικτών καρτελών και άλλων — σε κάθε συσκευή με { -brand-name-firefox }.
...
firefox-doesnt-spy = Το { -brand-name-firefox } δεν κατασκοπεύει τις αναζητήσεις. Εμποδίζουμε τα γνωστά cookies καταγραφής τρίτων και σάς δίνουμε τον πλήρη έλεγχο.
...
be-bold-and = Δείξτε τόλμη και θάρρος κατά την επιλογή του κατάλληλου προγράμματος περιήγησης.
...
firefox-calls-it = Το { -brand-name-firefox } το ονομάζει ιδιωτική περιήγηση, το { -brand-name-chrome } ανώνυμη περιήγηση. Και τα δύο σάς επιτρέπουν να περιηγηθείτε στο διαδίκτυο χωρίς αποθήκευση ιστορικού περιήγησης.
