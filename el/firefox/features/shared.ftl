...
features-shared-customize-your-firefox-browser = Προσαρμογή του { -brand-name-firefox }
features-shared-firefox-browser-sync = Συγχρονισμός με το { -brand-name-firefox }
...
features-shared-firefox-add-ons-and-browser-extensions = Πρόσθετα και επεκτάσεις { -brand-name-firefox }
...
features-shared-fingerprinter-blocking = Φραγή fingerprinter
