...
features-adblocker-if-ads-dont-bother-you = Αν οι διαφημίσεις δεν σάς ενοχλούν και δεν σάς πειράζει να παρακολουθείστε από ιχνηλάτες και cookies τρίτων, τότε η Τυπική ρύθμιση είναι κατάλληλη για εσάς. Για να ξεφορτωθείτε τους ιχνηλάτες, χρησιμοποιήστε ένα <a παράθυρο href="{ $url }">ιδιωτικής περιήγησης</a>.
...
features-adblocker-if-you-dont-want-your = Αν δεν θέλετε να χρησιμοποιείται για διαφημίσεις η διαδικτυακή σας συμπεριφορά, μπορείτε να ενεργοποιήσετε την επιλογή <a href="{ $url }">Αποτροπή καταγραφής</a> του { -brand-name-firefox }. Η συμμετοχή είναι εθελοντική, αλλά οι ιστοσελίδες που συμμετέχουν θα σταματήσουν άμεσα την καταγραφή σας.
...
features-adblocker-take-control-of-your-browser = Πάρτε τον έλεγχο του φυλλομετρητή σας.
