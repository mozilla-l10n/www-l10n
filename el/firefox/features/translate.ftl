...
# Obsolete string (expires: 2025-02-17)
features-translate-while-other-browsers-rely-on = Ενώ άλλα προγράμματα περιήγησης βασίζονται σε υπηρεσίες cloud, τα γλωσσικά μοντέλα των μεταφράσεων του { -brand-name-firefox } αποθηκεύονται στο πρόγραμμα περιήγησης του χρήστη και οι μεταφράσεις γίνονται τοπικά, επομένως η { -brand-name-mozilla } δεν καταγράφει τις ιστοσελίδες που μεταφράζετε.
