...
features-index-choose-how-your-browser-looks = Επιλέξτε την εμφάνιση του προγράμματος περιήγησής σας με χιλιάδες δωρεάν θέματα.
...
features-index-organize-your-bookmarks-with = Οργανώστε τους σελιδοδείκτες σας με τη βοήθεια των φακέλων και των ετικετών.
...
features-index-identify-the-exact-color-on-a = Προσδιορίστε το ακριβές χρώμα σε μια σελίδα και αντιγράψτε τον δεξαεξαδικό κωδικό του.
...
features-index-firefox-automatically-blocks = Το { -brand-name-firefox } αποκλείει αυτόματα 2000+ ιχνηλάτες διαφημίσεων σε όλο το διαδίκτυο.
