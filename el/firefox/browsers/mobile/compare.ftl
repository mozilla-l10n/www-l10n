...
mobile-compare-blocking-thirdparty-trackers = Η φραγή των ιχνηλατών τρίτων δεν είναι σημαντική μόνο για το απόρρητο — επιτρέπει επίσης την ταχύτερη φόρτωση των σελίδων, χωρίς αυτά τα μέρη κώδικα να επιβραδύνουν το πρόγραμμα περιήγησής σας.
mobile-compare-from-the-chart = Από τον παραπάνω πίνακα, είναι προφανές ότι το { -brand-name-firefox } προσφέρει το πιο πλήρες σύνολο εργαλείων απορρήτου και ασφάλειας από τα πέντε προγράμματα περιήγησης, ενώ παρέχει μια επισκόπηση της συνολικής ασφάλειας και του απορρήτου σας στο διαδίκτυο.
...
mobile-compare-based-on-the = Με βάση τα κριτήρια που περιγράψαμε — απόρρητο, δυνατότητες και συγχρονισμός — υπάρχει πραγματικά μόνο ένα πρόγραμμα περιήγησης για κινητά που να πληροί και τα τρία και αυτό είναι το { -brand-name-firefox }. Αν και διαθέτει παρόμοιες δυνατότητες και συγχρονισμό, το { -brand-name-firefox } ξεχωρίζει στο απόρρητο, επειδή πιστεύουμε ότι είναι το βασικό στοιχείο που σας επιτρέπει να απολαύσετε το διαδίκτυο — ακριβώς όπως σας αρέσει.
...
mobile-compare-spell-checking = Ορθογραφικός έλεγχος
mobile-compare-web-extensionsaddons = Επεκτάσεις ιστού/Πρόσθετα
mobile-compare-dark-mode = Σκουρόχρωμη λειτουργία
mobile-compare-desktop-mode = Έκδοση υπολογιστή
mobile-compare-find-on-page = Εύρεση στη σελίδα
mobile-compare-image-search = Αναζήτηση εικόνων
mobile-compare-voice-search = Φωνητική αναζήτηση
mobile-compare-add-to-homescreen = Προσθήκη στην αρχική οθόνη
mobile-compare-read-text-aloud = Εκφώνηση κειμένου
mobile-compare-news-feed = Ροές ειδήσεων
mobile-compare-collections = Συλλογές
mobile-compare-inapp-vpn = VPN εντός εφαρμογής
mobile-compare-shopping = Αγορές
mobile-compare-mobile-os-availability = Διαθεσιμότητα ΛΣ κινητών
