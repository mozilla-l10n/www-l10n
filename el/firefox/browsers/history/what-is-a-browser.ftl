...
# HTML page title
what-is-a-browser-what-is-a-web = Τι είναι ένα πρόγραμμα περιήγησης ιστού;
...
what-is-a-browser-a-web-browser-long = Ένα πρόγραμμα περιήγησης σάς μεταφέρει οπουδήποτε στο Διαδίκτυο. Ανακτά πληροφορίες από άλλα μέρη του ιστού και τις εμφανίζει στον υπολογιστή ή την κινητή συσκευή σας. Το περιεχόμενο μεταφέρεται με το Hypertext Transfer Protocol, το οποίο καθορίζει τον τρόπο μετάδοσης του κειμένου, των εικόνων και των βίντεο στον ιστό. Αυτές οι πληροφορίες πρέπει να κοινοποιούνται και να εμφανίζονται σε σταθερή μορφή, ώστε να προβάλλονται από τους χρήστες σε κάθε πρόγραμμα περιήγησης, οπουδήποτε στον κόσμο.
# Variables:
...
what-is-a-browser-making-your-web = Προσαρμογή του προγράμματος περιήγησής σας στα μέτρα σας
what-is-a-browser-most-major-web = Τα περισσότερα κύρια προγράμματα περιήγησης επιτρέπουν στους χρήστες την τροποποίηση της εμπειρίας τους με επεκτάσεις ή πρόσθετα. Οι επεκτάσεις είναι μέρη λογισμικού που μπορείτε να προσθέσετε στο πρόγραμμα περιήγησής σας και προσφέρουν πολλά διασκεδαστικά και πρακτικά οφέλη, όπως η προσθήκη νέων δυνατοτήτων, ξενόγλωσσων λεξικών ή οπτικών αλλαγών και θεμάτων.
