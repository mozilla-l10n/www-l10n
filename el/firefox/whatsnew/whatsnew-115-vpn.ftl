...
whatsnew-115-vpn-never-log = Δεν καταγράφουμε, δεν παρακολουθούμε και δεν κοινοποιούμε ποτέ τα δεδομένα του δικτύου σας — η διαδικτυακή σας δραστηριότητα δεν θα αφήσει ίχνη στους διακομιστές VPN μας.
