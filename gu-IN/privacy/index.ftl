...
privacy-index-contact-mozilla = { -brand-name-mozilla } નો સંપર્ક કરો
privacy-index-if-you-want-to-make-a-correction = જો તમે તમારી માહિતીમાં સુધારાં કરવા માંગો છો, અથવા તમારી પાસે અમારી ગોપનીયતા નીતિઓ વિશે કોઈ પ્રશનો હોય, તો કૃપા કરીને આમનો સંપર્ક કરો:
# Variables:
#   $dsar (url) - link to https://app.onetrust.com/app/#/webform/4ba08202-2ede-4934-a89e-f0b0870f95f0
privacy-index-see-here-for-data-subject = <a href="{ $dsar }">ડેટા વિષય ઍક્સેસ અરજીઓ માટે અહીં જુઓ.</a>
privacy-index-data-privacy-principles = માહિતી ગોપનીયતા સિદ્ધાંતો
# Variables:
