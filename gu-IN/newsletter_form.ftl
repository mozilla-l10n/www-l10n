...
newsletter-form-format = બંધારણ
newsletter-form-html = HTML
newsletter-form-text = લખાણ
newsletter-form-get-firefox-news = { -brand-name-firefox } સમાચાર મેળવો
# Variables:
#   $url (url) - link to https://www.mozilla.org/privacy/websites/
newsletter-form-im-okay-with-mozilla = હું મોઝીલા મારા માહિતી સંભાળવા તરીકે સમજાવી સાથે ઠીક છું <a href="{ $url }">આ ગોપનીયતા સૂચના</a>
newsletter-form-we-will-only-send = અમે તમને ફક્ત { -brand-name-mozilla }-સંબંધિત માહીતિ મોકલીશું.
