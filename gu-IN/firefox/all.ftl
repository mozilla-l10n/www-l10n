...
firefox-all-which-browser-would = તમને કયું બ્રાઉઝર ડાઉનલોડ કરવુ ગમશે?
# Used as an accessible label for a help button. The text is replaced with a "?" icon.
firefox-all-get-help = સહાય મેળવો
firefox-all-you-are-about-to-download = તમે ડાઉનલોડ કરવા જઇ રહ્યા છો:
firefox-all-browser = બ્રાઉઝર:
firefox-all-platform = પ્લેટફોર્મ:
firefox-all-language = ભાષા:
