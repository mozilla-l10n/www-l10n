...
privacy-firefox-transparency-first = Transparența pe primul loc
# Variables:
...
privacy-firefox-firefox-protects-you = { -brand-name-firefox } te protejează de elemente de urmărire terțe cunoscute, elemente de urmărire de pe rețelele de socializare, criptomineri, cookie-uri și tehnologii de amprentare digitală care încearcă să te urmărească pe web.
privacy-firefox-privacy-that-works = Confidențialitatea care funcționează pentru tine
privacy-firefox-firefox-makes-it = { -brand-name-firefox } facilitează gestionarea datelor tale cu funcții de confidențialitate și securitate încorporate, plus setări care îți permit să ajustezi experiența de navigare.
privacy-firefox-manage-your-privacy = Gestionează-ți setările de confidențialitate:
privacy-firefox-firefox-for-desktop-v2 = { -brand-name-firefox } pentru desktop
privacy-firefox-firefox-for-mobile-v2 = { -brand-name-firefox } pentru mobil
# heading for the table of contents, a shorter heading is better
privacy-firefox-contents = Conținut
# Variables:
#   $attrs (string) - in-page link to the start of the legal portion of the privacy notice
privacy-firefox-take-me-back = Du-mă <a { $attrs }>înapoi la începutul</a> Notificării privind confidențialitatea
# Variables:
#   $attrs (string) - in-page link to the top of the page
privacy-firefox-lost-in-the = Te-ai pierdut în detalii? Revino la <a { $attrs }>noțiunile de bază privind confidențialitatea în { -brand-name-firefox }</a>.
