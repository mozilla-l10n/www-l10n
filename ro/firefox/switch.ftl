...
switch-switching-to-firefox-is-fast-updated = Trecerea la { -brand-name-firefox } este rapidă, ușoară și fără risc, pentru că { -brand-name-firefox } îți va importa marcajele, parolele și preferințele din { -brand-name-chrome }.
...
switch-switching-to-firefox-page-description-updated = Trecerea la { -brand-name-firefox } este rapidă, ușoară și fără risc. { -brand-name-firefox } îți va importa marcajele, parolele și preferințele din { -brand-name-chrome }.
...
switch-spread-the-word = Răspândește vestea despre { -brand-name-firefox } și ajută-ți prietenii cei mai buni să spună „La revedere { -brand-name-chrome }!”.
...
switch-firefox-makes-switching-fast-email = Trecerea de la { -brand-name-chrome } la { -brand-name-firefox } este foarte rapidă. Îmi place mult și ar trebui să îl încerci.
switch-still-not-convinced = Încă nu te-ai convins că trecerea la { -brand-name-firefox } este ușoară?
...
switch-share-to-facebook-updated = Distribuie prin { -brand-name-facebook }
# Note: Bluesky is a brand name and should not be translated
switch-share-to-bluesky = Distribuie pe Bluesky
switch-hey = Salut,
switch-check-it-out = Încearcă-l și spune-mi ce părere ai:
switch-send-an-email = Trimite un e-mail
