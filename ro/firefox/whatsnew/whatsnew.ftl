...
whatsnew-firefox-browser = { -brand-name-firefox-browser(case: "definite-article", capitalization: "upper") }
whatsnew-up-to-date-notification = Felicitări! Folosești cea mai recentă versiune a { -brand-name-firefox-browser(case: "genitive-or-dative") }.
whatsnew-out-of-date-notification = Este disponibilă o versiune și mai recentă a { -brand-name-firefox-browser(case: "genitive-or-dative") }. Repornește pentru a actualiza.
# Variables:
