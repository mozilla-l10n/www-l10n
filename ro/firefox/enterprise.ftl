...
firefox-enterprise-firefox-browser = { -brand-name-firefox-browser(capitalization: "upper-definite-article") }
firefox-enterprise-firefox-browser-msi-installer = { -brand-name-firefox-browser(capitalization: "upper-definite-article") } - program de instalare MSI
