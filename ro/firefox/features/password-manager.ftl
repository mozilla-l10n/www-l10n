...
# HTML page title
password-manager-firefox-browser = { -brand-name-firefox-browser(case: "definite-article", capitalization: "upper") }: Manager de parole rapid și ușor
...
password-manager-password-magician = Magicianul parolelor
# Obsolete string
