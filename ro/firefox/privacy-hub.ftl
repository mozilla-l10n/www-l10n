...
# HTML page title
firefox-privacy-hub-firefox-privacy-promise = Promisiunea de confidențialitate { -brand-name-firefox }
# HTML page description
firefox-privacy-hub-firefox-takes-less-data-keeps = { -brand-name-firefox } colectează mai puține date, le păstrează în siguranță și fără ascunzișuri.
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words, please omit the strong tags if they need to be around multiple words in your language
firefox-privacy-hub-firefox-products-are-designed = Produsele { -brand-name-firefox } sunt concepute să îți protejeze <strong>viața privată</strong>
# Sub navigation title
firefox-privacy-privacy = Confidențialitate
# Sub navigation link
