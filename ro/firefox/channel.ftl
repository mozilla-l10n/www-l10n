...
firefox-channel-download-and-test-the-latest-desktop = Descarcă și testează cele mai noi funcționalități din { -brand-name-firefox } pentru desktop cu edițiile Developer, { -brand-name-beta } și { -brand-name-nightly }.
