...
firefox-is-not = { -brand-name-firefox } nu se bazează pe { -brand-name-chromium } (proiectul de browser open source din centrul { -brand-name-google } { -brand-name-chrome }). De fapt, suntem unul dintre ultimele browsere importante care nu o face. { -brand-name-firefox } rulează pe motorul nostru de browser Quantum, construit special pentru { -brand-name-firefox }, astfel încât să ne putem asigura că datele tale sunt gestionate cu respect și păstrate private.
