...
# HTML page title
firefox-products-firefox-is-more-than-a-browser = { -brand-name-firefox } este mai mult decât un browser
# HTML page description
firefox-products-its-a-whole-family-of-products = Este o întreagă familie de produse concepute să te mențină în siguranță și să fii mai inteligent(ă) online.
...
firefox-products-see-if-your-personal-information = Vezi dacă datele tale cu caracter personal au fost compromise într-o breșă de date ale firmelor și înregistrează-te pentru alerte viitoare.
firefox-products-check-for-breaches = Caută breșe de date
firefox-products-sign-up-for-breach-alerts = Înregistrează-te pentru alerte despre breșe de date
...
firefox-products-discover-the-best-content = Descoperă cele mai bune conținuturi de pe web — și le vizualizezi oriunde și oricând vrei.
