...
welcome-page5-get-the-lockwise-app = Obține aplicația { -brand-name-lockwise }
welcome-page5-get-firefox-lockwise-on-your = Obține { -brand-name-firefox-lockwise } pe telefon
...
welcome-page5-with-256-bit-encryption-your = Cu o criptarea de 256 de biți, parolele călătoresc întotdeauna pe dispozitivele tale în siguranță.
...
welcome-page5-lockwise-will-let-you-know = { -brand-name-lockwise } te va anunța dacă datele tale de autentificare salvate au fost implicate într-o încălcare a securității datelor corporative, astfel încât să le poți schimba cât mai repede.
