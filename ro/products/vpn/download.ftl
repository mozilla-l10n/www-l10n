...
vpn-download-page-title = Descarcă { -brand-name-mozilla-vpn }
vpn-download-page-description = Descarcă { -brand-name-mozilla-vpn } pentru { -brand-name-windows }, { -brand-name-mac }, { -brand-name-linux }, { -brand-name-android } și { -brand-name-ios }.
# Variables:
#   $devices (number) - maximum number of connected devices
vpn-download-sub-heading = Poți descărca { -brand-name-mozilla-vpn } pe până la { $devices } dispozitive cu un singur abonament.
