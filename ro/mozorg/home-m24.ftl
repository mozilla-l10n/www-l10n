...
# HTML Page title
m24-home-page-title = Internet pentru oameni, nu pentru profit — { -brand-name-mozilla }
m24-home-page-title-v2 = { -brand-name-mozilla } — Internet pentru oameni, nu pentru profit
# HTML page description
m24-home-page-desc = Știai? { -brand-name-mozilla } — creatorul { -brand-name-firefox } — luptă pentru a menține internetul o resursă publică globală, deschisă și accesibilă tuturor.
m24-home-page-desc-v2 = Lucrăm pentru a readuce controlul asupra internetului în mâinile celor care îl utilizează.

## Intro

m24-home-welcome-to-mozilla = Bine ai venit la { -brand-name-mozilla }
m24-home-from-trustworthy-tech = De la tehnologie de încredere la politici care îți apără drepturile digitale, te punem pe primul loc — întotdeauna.
m24-home-learn-about-us = Află despre noi
# Used as accessible text alternative for image
m24-home-alt-flag = Un steag verde stilizat pe fundal negru, construit din „M” de la { -brand-name-mozilla } și un pixel deplasat pentru a face referire la logo-ul original cu dinozaur.

## Products

m24-home-love-the-internet = Iubește din nou internetul
m24-home-break-free-from = Eliberează-te de influența marilor tehnologii — produsele noastre îți oferă controlul asupra unei experiențe de internet mai sigure și mai private.
m24-home-explore-our-products = Explorează produsele noastre
m24-home-firefox = { -brand-name-firefox }
m24-home-get-the-gold = Obține standardul de aur pentru navigare rapidă, cu confidențialitate și control.
m24-home-thunderbird = { -brand-name-thunderbird }
m24-home-go-chaosfree-with = Simplifică-ți viața cu o singură aplicație pentru toate e-mailurile, calendarele și contactele tale.
...
m24-home-tabstack-desc = Automatizează fiabil sarcinile web cu un API simplu, axat pe dezvoltatori.
...
m24-home-tag-product = Produs
m24-home-tag-project = Proiect
...
# Used as an accessible text alternative for an image
m24-home-alt-rise25-smiling = Un vorbitor încrezător și zâmbitor la { -brand-name-rise25 }.
# Used as an accessible text alternative for an image
