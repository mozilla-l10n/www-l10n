...
navigation-read-about-new-firefox = Citește despre noile funcții { -brand-name-firefox } și obține sfaturi pentru a te menține într-o mai mare siguranță online.
navigation-the-non-profit-behind = Entitatea non-profit din spatele { -brand-name-firefox } luptă pentru un internet sănătos pentru toți.
