...
navigation-firefox-browser-for-enterprise = { -brand-name-firefox-browser(case: "definite-article", capitalization: "upper") } pentru întreprinderi
...
navigation-your-firefox-account = { -brand-name-firefox-account(case: "definite-article", capitalization: "upper-and-you") }
...
navigation-mozilla-brings-virtual = { -brand-name-mozilla } aduce realitatea virtuală și augumentată pe webul deschis
# Outdated string
