...
navigation-access-all-of-firefox = Accesează întregul { -brand-name-firefox } cu o singură autentificare — și vei obține mai multe de la fiecare produs.
navigation-meet-the-firefox-family = Descoperă familia { -brand-name-firefox }
navigation-firefox-blog = Blog { -brand-name-firefox }
navigation-read-about-new-firefox = Citește despre noile funcționalități din { -brand-name-firefox } și obține sfaturi pentru a te menține într-o mai mare siguranță online.
navigation-the-non-profit-behind = Entitatea nonprofit din spatele { -brand-name-firefox } luptă pentru un internet sănătos pentru toți.
...
navigation-firefox-playground = Banc de probe { -brand-name-firefox }
navigation-mozilla-open-source-support = { -brand-name-mozilla } Open Source Support (MOSS)
navigation-mozilla-manifesto = Manifestul { -brand-name-mozilla }
navigation-menu = Meniu
navigation-check-out-the-benefits = Descoperă beneficiile
navigation-browsers = Browsere
navigation-close-browsers-menu = Închide meniul de browsere
navigation-download = Descarcă
navigation-extensions = Extensii
navigation-support = Asistență
navigation-privacy = Confidențialitate
...
navigation-check-for-breaches = Verifică pentru breșe de date
navigation-see-breaches = Vezi breșele de date
...
navigation-join = Hai cu noi
navigation-close-join-menu = Închide meniul de aderare
navigation-sign-in = Autentificare
...
navigation-close-about-menu = Închide meniul Despre
...
navigation-same-speed-and-safety = Aceeași viteză și siguranța în care ai încredere, concepute special pentru afaceri.
# Outdated string
...
navigation-test-soon-to-be-released = Testează funcționalități care vor fi lansate în curând în cea mai stabilă versiune preliminară de la noi.
navigation-developer-innovations = Inovații pentru dezvoltatori
navigation-projects-that-help-keep = Proiecte care ajută la păstrarea internetului deschis și accesibil pentru toți.
navigation-mixed-reality = Realitate mixtă
navigation-resources = Resurse
navigation-resources-for-developers = Resurse pentru dezvoltatori de la dezvoltatori.
navigation-developer-blog = Blogul dezvoltatorilor
navigation-build-test-scale-and = Construiește, testează, scalează și multe altele cu singurul browser construit special pentru dezvoltatori.
navigation-leadership = Conducerea
navigation-mission = Misiune
navigation-press-center = Centru de presă
...
navigation-join-the-fight-for-a = Intră și tu în lupta pentru un internet sănătos.
