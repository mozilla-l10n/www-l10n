...
newsletter-form-keep-up-with = با آخرین اخبار { -brand-name-firefox }<br> بروز باشید.
newsletter-form-get-mozilla-updates = دریافت به‌روزرسانی‌های { -brand-name-mozilla }
