...
firefox-channel-try-new-features-in-a-pre = امکانات جدید مرورگر اندروید را قبل از انتشار آن امتحان کنید | فایرفاکس
firefox-channel-download-and-test-future = نسخه‌های آینده فایرفاکس برای رومیزی، اندروید و { -brand-name-ios } را دریافت و آزمایش کنید.
firefox-channel-experience-cutting-edge-android-updated = آخرین امکانات مرورگر اندروید را با نسخه پیش از انتشار آن تجربه کنید: فایرفاکس بتا و فایرفاکس نایتلی. همین امروز نصبشان کنید!
firefox-channel-experience-cutting-edge-android = تازه‌ترین امکانات مرورگر اندروید را در نگارش‌های قبل از انتشار تجربه کنید: فایرفاکس بتا، فایرفاکس Aurora و فایرفاکس شبانه. هم‌اکنون نصب کنید!
firefox-channel-download-and-test-the-latest-android = بارگیری و بررسی آخرین امکانات فایرفاکس برای اندروید با نسخه‌های { -brand-name-aurora }، بتا و { -brand-name-nightly }.
...
firefox-channel-try-new-features-in-a-pre-release = امکانات جدید مرورگر { -brand-name-ios } را قبل از انتشار آن امتحان کنید | فایرفاکس
...
firefox-channel-test-beta-versions-of-firefox-ios-long = نسخه‌های بتا فایرفاکس برای { -brand-name-ios } را از طریق برنامه { -brand-name-test-flight } شرکت { -brand-name-apple } بررسی کنید و کمک کنید تا مرورگر ما برای { -brand-name-iphone }، { -brand-name-ipad } و iPod از این هم بهتر بشود.
