...
download-button-free-google-play = از { -brand-name-google-play } به رایگان دریافت کنید
download-button-app-store = از { -brand-name-app-store } به رایگان دریافت کنید
