...
vpn-linux-no-logs = <strong>No logs:</strong> { -brand-name-mozilla-vpn } does not keep any logs of your network activity; we don’t record which web sites you visit or inspect your traffic.
vpn-linux-additional-security = <strong>Additional security features:</strong> We use DNS blocking to block ads, trackers, and malware. While a browser can prevent only web sites from giving you malware and tracking you.
...
vpn-linux-simple-and = <strong>Simple and intuitive interface:</strong> Connect to a server with one click. You can also customise your settings and preferences according to your needs.
vpn-linux-it-helps-restore = <strong>It helps restore net neutrality:</strong> { -brand-name-mozilla-vpn } helps you take back control of your online activities by preventing internet providers from throttling your bandwidth, or from blocking web sites or services that they don’t like, or that compete with their own offerings.
