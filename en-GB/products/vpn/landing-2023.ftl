...
vpn-landing-take-control = Take control with web site specific VPN settings
vpn-landing-customize-your-vpn = Customise your VPN protections on a per web site basis with the { -brand-name-mozilla-vpn } Extension for { -brand-name-firefox } (Windows only).
