...
vpn-what-is-connecting-to-a = Connecting to a public WiFi network is at times convenient, like when you’re without internet service or can’t get any bars on your phone. On the other hand, connecting to public WiFi can be a risky endeavour. It’s impossible to be sure that someone else isn’t connecting to the same network to snoop on what you’re doing. Even if your traffic is encrypted they can still see which sites you are visiting. And if you’re using an app that doesn’t have encryption — and even today, many don’t — then they can see everything you are doing.
...
vpn-what-is-its-true-that = It’s true that most connections to web sites these days are secured by HTTPS, which means the content, but not the source or destination IP address, is encrypted. A VPN offers additional privacy by preventing web sites and third parties from learning your IP address.
