...
firefox-sync-access-and-sync = Access and synchronise your bookmarks, passwords, open tabs and more — everywhere you use { -brand-name-firefox }.
firefox-sync-firefox = { -brand-name-firefox-browser }
firefox-sync-sync-your-firefox = Synchronise your { -brand-name-firefox } on any device
...
firefox-sync-your-encryption-key = Your encryption key remains a secret, only known to you and your authorised devices.
...
firefox-sync-start-syncing-in = Start synchronising in four easy steps:
...
firefox-sync-after-you-check = After you check your email and click the verification link, { -brand-name-firefox } will start automatically synchronising in the background.
