...
developer-mdnplus-congrats-you-now-have-latest = Congratulations. You now have the latest version of { -brand-name-firefox-browser } { -brand-name-developer-edition }.
# Main title
...
developer-mdnplus-the-web-doesnt-have-a = The Web doesn’t have a changelog, but { -brand-name-mdn } can help. Follow pages and get customisable notifications when documentation changes, CSS features launch, and APIs ship.
...
developer-mdnplus-no-more-haphazard-hunting = No more haphazard hunting through the vast virtual library: unleash your inner curator and collect your favourite articles in one place for convenient consultation.
