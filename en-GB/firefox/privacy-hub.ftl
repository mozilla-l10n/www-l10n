...
firefox-privacy-hub-thats-why-everything-we-make = That’s why everything we make and do honours our Personal Data Promise
...
firefox-privacy-hub-want-to-customize-what = Want to customise what gets blocked? Your settings are only one click away.
...
firefox-privacy-hub-when-you-enter-your-email-v2 = When you enter your email address in { -brand-name-mozilla-monitor }, we forget it immediately after we’ve checked for a match in known data breaches — unless you authorise us to continue monitoring new breaches for your personal information.
# Obsolete string
firefox-privacy-hub-when-you-enter-your-email = When you enter your email address in { -brand-name-firefox-monitor }, we forget it immediately after we’ve checked for a match in known data breaches — unless you authorise us to continue monitoring new breaches for your personal information.
...
firefox-privacy-hub-all-the-information-synced-v2 = All the information synchronised through your { -brand-name-mozilla-account } — from browser history to passwords — is encrypted. And your account password is the only key.
# Obsolete string
firefox-privacy-hub-all-the-information-synced = All the information synchronised through your { -brand-name-firefox-account } — from browser history to passwords — is encrypted. And your account password is the only key.
