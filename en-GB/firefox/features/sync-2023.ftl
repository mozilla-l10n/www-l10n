...
features-sync-sign-up-for-a-free-mozilla-account = <a href="{ $fxa }">Sign up for a free { -brand-name-mozilla-account } </a> and you’ll be able to synchronise your data everywhere you use your { -brand-name-firefox } browser.
# Obsolete string
