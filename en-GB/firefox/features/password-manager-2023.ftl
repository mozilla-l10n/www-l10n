...
# Variables:
#   $fxa (url) = link to https://www.mozilla.org/firefox/accounts/
password-manager-with-a-free-firefox-account = With a <a href="{ $fxa }">free{ -brand-name-firefox } account</a> you can securely synchronise your passwords across all your devices.
