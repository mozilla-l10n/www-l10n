...
privacy-passwords-seeing-you-use = Seeing you use it with an unencrypted web site
...
privacy-passwords-its-easy-to = It’s easy to prevent attackers from stealing your password when you log into an unencrypted web site: Think twice before you type your password if you don’t see a lock icon in the URL bar, like this:
privacy-passwords-a-closed-lock = A closed padlock appears just before the web site address in the URL bar in all major browsers.
privacy-passwords-the-lock-means = The lock means that the web site you’re using is encrypted, so that even if someone is watching your browsing on the network (like another person on a public WiFi hotspot), they won’t be able to see your password. { -brand-name-firefox } will try to warn you when you’re about to enter your password on an unencrypted site.
privacy-passwords-a-padlock-with = A padlock with a line through it indicates the connection is not secure.
privacy-passwords-your-browser-also = Your browser also helps keep you informed about how trustworthy sites are, to help keep you safe from phishing. On the one hand, when you try to visit a web site that is known to be a phishing site, { -brand-name-firefox } (and any major browser) will display a full-screen warning — <strong>pay attention and think twice about using that site!</strong>
privacy-passwords-firefox-will-v2 = { -brand-name-firefox } will display a warning instead of the web site if it is known to be a phishing site.
# Outdated string
privacy-passwords-firefox-will = Firefox will display a warning instead of the web site if it is known to be a phishing site.
...
privacy-passwords-finally-most-websites = Finally, most web sites let you recover your password if you’ve forgotten it. Usually these systems make you answer some “security questions” before you can reset your password. <strong>The answers to these questions need to be just as secret as your password.</strong> Otherwise, an attacker can guess the answers and set your password to something they know.
privacy-passwords-randomness-can-be = Randomness can be a problem, since the security questions that sites often use are also things people tend to know about you, like your birthplace, your birthday, or your relatives’ names, or that can be gleaned from sources such as social media. The good news is that the web site doesn’t care whether the answer is real or not — you can lie! But lie productively: <strong>Give answers to the security questions that are long and random,</strong> like your passwords.
...
privacy-passwords-2fa-provides-much = 2FA provides much better security than passwords alone, but not every web site supports it. You can find a list of web sites that support 2FA at <a { $url_2fa }>https://2fa.directory</a>, as well as a list of sites that don’t support 2FA and ways you can ask them to add support.
