...
privacy-passwords-2fa-provides-much = 2FA provides much better security than passwords alone, but not every web site supports it. You can find a list of web sites that support 2FA at <a { $url_2fa }>https://twofactorauth.org</a>, as well as a list of sites that don’t support 2FA and ways you can ask them to add support.
