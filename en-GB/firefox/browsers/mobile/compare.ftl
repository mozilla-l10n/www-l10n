...
mobile-compare-another-mobile-feature = Another mobile feature that should be a given is the ability to prevent web sites and companies from tracking your browsing and shopping data — even in normal browsing mode.
...
mobile-compare-almost-all-of = Almost all of the mobile browsers compared here allow complete synchronisation between mobile and desktop devices.
mobile-compare-the-good-news = The good news for { -brand-name-iphone } users is that { -brand-name-apple } has recently allowed { -brand-name-iphone } users to choose their own default browser, so now users can synchronise their devices across platforms if, for example, they install { -brand-name-firefox } on their { -brand-name-iphone } and { -brand-name-windows } PC.
mobile-compare-conclusion = Conclusion
mobile-compare-based-on-the = Based on the criteria we outlined — privacy, features, and synchronisation — there’s really only one mobile browser that satisfies all three, and that’s { -brand-name-firefox }. While similar in the features and synchronisation categories, { -brand-name-firefox } stands apart in privacy, because we feel it’s the essential component that allows you to just enjoy the internet — exactly the way you like it.
...
mobile-compare-syncs-with-desktopmobile = Synchronises with desktop/mobile app
