...
facebook-container-facebook-container-for-firefox = { -brand-name-facebook-container } for { -brand-name-firefox } | Prevent { -brand-name-facebook } from seeing which web sites you visit.
...
facebook-container-try-firefox-focus-the-privacy = Try <strong>{ -brand-name-firefox-focus }</strong>, the private browser for { -brand-name-android } and { -brand-name-ios }.
facebook-container-opt-out-on-your-terms = Opt-out on your terms
# Variables:
#   $fbcontainer (url) - link to https://addons.mozilla.org/firefox/addon/facebook-container/
facebook-container-facebook-can-track-almost = { -brand-name-facebook } can track almost all of your web activity and tie it to your { -brand-name-facebook } identity. If that’s too much for you, the <a href="{ $fbcontainer }">{ -brand-name-facebook-container } extension</a> isolates your identity into a separate container tab, making it harder for { -brand-name-facebook } to track you on the rest of the web.
...
facebook-container-were-backed-by-mozilla-the = We’re backed by <a href="{ $mozilla }">{ -brand-name-mozilla }</a>, the not-for-profit organisation that puts people over profit to give everyone more power online. We created this extension because we believe that you should have easy-to-use tools that help you manage your privacy and security.
