...
cookie-settings-your-consent-desc = By agreeing to Cookies, your consent will be granted for the following list of { -brand-name-mozilla } web sites, which all follow the same strict standards for data privacy. Please note that this list may be updated over time.
