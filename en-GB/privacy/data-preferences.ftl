...
data-preferences-page-desc = Your privacy is very important to { -brand-name-mozilla }. This page will enable you to manage your first-party data collection preferences for mozilla.org web sites using { -brand-name-glean }.
...
data-preferences-mozilla-uses = { -brand-name-mozilla } uses { -brand-name-glean } to collect web site usage data on some mozilla.org web sites in order to ensure that we’re delivering the best possible user experience for our visitors. { -brand-name-glean } does not share information with any third parties. Every piece of data we collect also goes through a strict review process. You can learn more about the specific types of data we collect in the <a href="{ $dictionary }">{ -brand-name-glean } Dictionary</a>. For more information about the way we handle and share your data on { -brand-name-mozilla } web sites, you can read our <a href="{ $privacy_notice }">Websites, Communications and Cookies Privacy Notice</a>.
