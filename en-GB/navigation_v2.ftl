...
navigation-v2-get-the-customizable-mobile = Get the customisable mobile browser for { -brand-name-android } smartphones.
...
navigation-v2-new-features-and-tools = New features and tools for a customised { -brand-name-mdn } experience
...
navigation-v2-work-for-a-mission-driven-updated = Work for a mission-driven organisation that makes people-first products.
