...
m24-home-alt-flag = A stylised green flag on a black background, built from the ‘M’ for { -brand-name-mozilla } and a pixel that is displaced to reference its original dinosaur logo.
...
m24-home-create-your-website = Create your web site and connect your custom domain for free
...
m24-home-in-a-world = In a world where AI innovation is driven by a select few, we’re risking monopolisation of this technology. Applying open-source concepts to AI could change that.
...
m24-home-shake-to-summarize = Shake to Summarise in TIME’s Best Inventions of 2025
...
# Used as an accessible text alternative for an image
m24-home-alt-validation = A miniature person looking at a big keyboard key and a hypnotising computer screen
# Used as an accessible text alternative for an image
