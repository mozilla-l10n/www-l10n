...
history-in-2003-the-mozilla-project = In 2003, the { -brand-name-mozilla } project created the { -brand-name-mozilla-foundation }, an <a href="{ $foundation }">independent non-profit organisation</a> supported by individual donors and a variety of companies.
# Variables:
...
history-a-sustainable-organization = A sustainable organisation has been created that uses market mechanisms to support a public benefit mission and this model has been reused by others to create open, transparent and collaborative organisations in a <a href="{ $range }">broad range</a> <a href="{ $areas }">of areas</a>.
...
history-the-mozilla-community-together = The { -brand-name-mozilla } community, together with other open source projects and other public benefit organisations, exists only because of the people who are engaged in making our common goals a reality.
# Variables:
