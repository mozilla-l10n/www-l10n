...
manifesto-the-effectiveness-of-the = The effectiveness of the internet as a public resource depends upon interoperability (protocols, data formats, content), innovation and decentralised participation worldwide.
...
manifesto-we-are-committed-to-diverse = We are committed to an internet that catalyses collaboration among diverse communities working together for the common good.
...
manifesto-across-the-mozilla-project = Across the { -brand-name-mozilla } Project and every organisation in the { -brand-name-mozilla } family, we pledge to support the { -brand-name-mozilla } Manifesto in its activities. Specifically, we will:
manifesto-we-need-you = We Need You To Advance the Manifesto
manifesto-an-internet-with-these-v2 = An internet with these qualities will not come to life on its own. People and organisations must embed these aspirations into internet technology and into the human experience with the internet. The { -brand-name-mozilla } Manifesto and Addendum represent { -brand-name-mozilla }'s commitment to advancing these aspirations. { -brand-name-mozilla } works with people and organisations everywhere who want to make the internet an even better place for everyone.
...
manifesto-details-the-effectiveness = The effectiveness of the internet as a public resource depends upon interoperability (protocols, data formats, content), innovation and decentralised participation worldwide.
