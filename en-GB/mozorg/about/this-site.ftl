...
about-this-site-desc = About the web site www.mozilla.org and the open source tools used to make it.
# Variables:
#   $archive (url) link to https://web.archive.org/web/19981212031129/http://www.mozilla.org/
#   $coderush (url) link to https://www.youtube.com/watch?v=4Q7FTjhvZ7Y
about-this-site-this-website = The web site www.mozilla.org has been online for over two decades. That’s since <a href="{ $archive }">dinosaur times</a> in internet years. As such, www.mozilla.org is a corner stone of the web, with roots embedded in the open source movement that saw the <a href="{ $coderush }">creation of { -brand-name-mozilla }</a>.
# Variables:
...
about-this-site-like-many = Like many of our products, this web site is also open source:
...
about-this-site-fluent = { -brand-name-mozilla }’s <a href="{ $fluent }">Fluent</a> localisation system for language translation.
# Variables:
