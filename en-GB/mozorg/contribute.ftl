...
contribute-page-intro = { -brand-name-mozilla } is a non-profit organisation working to ensure the internet is open and welcoming to all. And we need your help. By joining our community, you can help drive innovation, enhance accountability and trust and make the internet a better place for everyone.
...
contribute-tag-individual-event = Individual and event organisation
contribute-tag-individual = Individual
contribute-tag-support = Support
contribute-task-translate-heading = Translate content
contribute-task-translate-desc = The internet is only global if it’s understood everywhere. Help us translate { -brand-name-mozilla } products and web sites into your local language.
