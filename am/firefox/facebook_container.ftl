...
facebook-container-were-backed-by-mozilla-the = እኛ የምንደገፈው በ <a href="{ $mozilla }">{ -brand-name-mozilla } ሲሆን፤ ለትርፍ ያልተቋቋመ፣ የህዝብን የመስመር ላይ አጠቃቀም አቅም ለመጨመር የሚሠራ ድርጅት ነው። ይኼንን ቅጥያ የፈጠርንበት ዋናው ምክንያት፤ የርስዎን ደህነነትና ግላዊነት የሚጠብቁበት ለአጠቃቀም ቀላል የሆነ መገልገያ ያስፈልግዎታል ብለን ስላሰብን ነው።
facebook-container-browse-freely-with-firefox = በነጻነት በ{ -brand-name-firefox } ያስሱ።
