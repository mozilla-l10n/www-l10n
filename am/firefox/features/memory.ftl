...
features-memory-chrome-uses-up-to-177x-more = <a href="{ $url }">ክሮም ከፋየርፎክስ በ 1.77 እጥፍ የበለጠ የማህደረ ትውስታ ቦታን ይጠቀማል</a>። ኮምፒውተርዎ ከመጀመሪያው አነስተኛ ማህደረ ትውስታ ካለው ደግሞ፤ ይኼ የበለጠ መዘግየቱን ይጨምራል። የቅርቡን ፋየርፎክስ ሲጠቀሙ ግን፤ የሚፈልጉትን ፕሮግራም ለማስኬድ በርካታ የማህደረ ትውስታ ቦታ ይኖርዎታል።
features-memory-browse-faster-privately = በፍጥነትና በግላዊነት ያስሱ
# Variables:
#   $url (url) - link to https://www.mozilla.org/firefox/features/private-browsing/
# "Decluttering" means reducing clutter
features-memory-explore-the-web-faster-with = ኢንተርኔትን በፍጥነት ይጠቀሙ <a href="{ $url }">ፋየርፎክስ የግላዊነት ማሰሻ</a>። በፋየርፎክስ የግላዊነት ዘዴ ብቻ ሰርጎ-ገቦች ማስታወቂያና ሌሎች ገፆችን እንዳይጭኑ መከላከል ይቻላል። የተበላሹ ድረ-ገፆች በፍጥነት ለመጫን ይችላሉ።
