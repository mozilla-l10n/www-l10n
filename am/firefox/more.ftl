...
firefox-rebel-with = { -brand-name-firefox }:- ለዓላማ የሚታገሉ
firefox-is-independent = { -brand-name-firefox } ራሱን የቻለ እና ለትርፍ በማይሰራው { -brand-name-mozilla } የሚደገፍ ነው፣ እሱም ለመስመር ላይ መብቶችዎ የሚታገል እና በይነመረብ ለሁሉም ሰው በሁሉም ቦታ ተደራሽ የሚያደርግ ነው።
...
firefox-more-little-book = ትንሽ የግላዊነት መጽሐፍ
firefox-more-you-can-reclaim = የእርስዎን ግላዊነት መልሰው ማግኘት እና በራስዎ የበይነመረብ ተሞክሮ ላይ እንደገና ባለ ሙሉ ስልጣን መሆን ይችላሉ! በእውነቱ በሚገርም ሁኔታ ቀላል ነው። ሁሉም ሰው ማድረግ ይችላል።
firefox-more-firefox-sync = { -brand-name-firefox-sync }
firefox-more-access-your-sync = በማንኛውም ቦታ { -brand-name-firefox }ን ሲጠቀሙ —  የእርስዎን ዕልባቶች፣ የይለፍ ቃሎች፣ ክፍት ትሮች እና ሌሎችንም ያግኙ እና ያመሳስሉ።
