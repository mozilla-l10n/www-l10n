...
download-button-supported-devices = ឧបករណ៍​ដែល​អាច​ប្រើ​បាន
...
download-button-get-firefox-android = ទាញយក { -brand-name-firefox } សម្រាប់ { -brand-name-android }
download-button-get-firefox-ios = ទាញយក { -brand-name-firefox } សម្រាប់ { -brand-name-ios }
download-button-google-play = ទទួល​បាន​វា​នៅ { -brand-name-google-play }
download-button-free-google-play = ទទួល​បាន​វា​ដោយ​ឥតគិតថ្លៃ​​​នៅ { -brand-name-google-play }
download-button-app-store = ទទួល​បាន​វា​ដោយ​ឥត​គិតថ្លៃ​ពី { -brand-name-app-store }
