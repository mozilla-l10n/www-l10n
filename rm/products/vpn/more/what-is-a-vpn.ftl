...
vpn-what-is-weve-done-the = Nus ans avain dà gronda fadia per garantir che <a href="{ $mozvpn }">{ -brand-name-mozilla-vpn }</a> respectia propi tia sfera privata.  E nus na ristgain betg nunponderadamain nossa reputaziun. { -brand-name-mozilla } ha in bun num ed è enconuschent per concepir products che gidan da proteger tias datas. Nus respectain noss <a href="{ $principles }">princips per la protecziun da datas</a> formulads cler e net senza frasas vidas ch'ans permettan d'ans focussar mo sin las datas che nus duvrain per porscher noss servetschs. La tecnologia { -brand-name-mozilla-vpn } cumpacta e moderna offra als utilisaders ina connexiun svelta cun la protecziun e segirezza cumpletta dad in VPN. E cunquai ch'il sviluppaders da quest VPN vegnan sustegnids dad <a href="{ $mission }">ina interpresa cun princips</a>, pos ti ta fidar che ti survegns per ils daners che ti spendas per quest product in VPN d'emprima classa e promovas ultra da quai era in meglier internet per tuts.
vpn-what-is-can-vpns-protect = Pon VPNs ma proteger da cybercriminals?
# Variables
