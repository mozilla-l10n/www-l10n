...
vpn-windows-page-description = Protegia tes entir PC cun ina rait privata virtuala (VPN) da { -brand-name-mozilla }, in piunier da l'internet che s'engascha per la protecziun da tias datas digitalas dapi l'onn 1998.
# Windows strings
