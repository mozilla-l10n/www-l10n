...
vpn-landing-fast-secure-heading = Ina rait svelta e segira
# Variables:
...
vpn-landing-faq-competition-question-heading = Fa { -brand-name-mozilla-vpn } buna figura en cumparegliaziun cun la concurrenza?
# Variables:
