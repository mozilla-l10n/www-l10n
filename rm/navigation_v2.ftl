...
navigation-v2-firefox-for-mobile = { -brand-name-firefox-browser } per apparats mobils
navigation-v2-take-speed-privacy-and = Piglia la sveltezza e la protecziun da datas cun tai e sta patgific. Sin { -brand-name-android } ed { -brand-name-ios }.
...
navigation-v2-get-the-details-on-the = Scuvra ils detagls da las ultimas actualisaziuns da { -brand-name-firefox }.
navigation-v2-view-all-firefox-browsers = Vesair tut ils { -brand-name-firefox-browsers }
...
navigation-v2-who-we-are = Davart nus
navigation-v2-close-who-we-are-menu = Serrar il menu «Davart nus»
navigation-v2-mozilla-manifesto = Il manifest da { -brand-name-mozilla }
navigation-v2-learn-about-the-values = Ve a savair dapli davart las valurs ed ils princips da noss engaschi.
navigation-v2-mozilla-foundation = { -brand-name-mozilla-foundation }
navigation-v2-meet-the-not-for-profit-behind = Scuvra l'organisaziun senza finamira da profit davos { -brand-name-firefox } che s'engascha per in meglier web.
navigation-v2-get-involved = Sa participar
navigation-v2-join-the-fight-for-a = Ta participescha al cumbat per in internet saun.
navigation-v2-leadership = Direcziun
navigation-v2-meet-the-team-thats-building = Emprenda d'enconuscher il team che creescha tecnologia per in meglier internet.
navigation-v2-careers = Lavura cun nus
...
navigation-v2-check-out-the-home-for-web = L'adressa cun resursas per sviluppaders dal web.
