...
home-the-health-of = «La sanadad da l’internet e da la vita online – quai è nossa raschun d’exister.»
# Obsolete string
...
home-mozilla-makes-privacy = { -brand-name-mozilla } creescha products che respectan la sfera privata
...
home-product-relay-masks = Alias per e-mail e numers da telefon pratics d’utilisar
...
home-product-monitor-data = Avertiments en cas da sperditas da datas
...
home-join-us-in-shaping = Ans gida a crear in’intelligenza artifiziala fidabla
...
# Obsolete string (expires: 2024-07-16)
home-is-mozilla-a-corporation = È { -brand-name-mozilla } ina interpresa u in’organisaziun senza finamira da profit? En vardad, omadus.
# Obsolete string (expires: 2024-07-16)
home-mozilla-consists-of = { -brand-name-mozilla } consista da duas organisaziuns. { -brand-name-mozilla-corporation } appartegna dal tuttafatg a l’organisaziun senza finamira da profit 501(c) { -brand-name-mozilla-foundation }. Quai vul dir che nus na dependain betg dad acziunaris – nus stuain mo ans tegnair a noss agens ideals.
...
home-learn-about-mofo = Ulteriuras infurmaziuns davart { -brand-name-mozilla-foundation }
home-join-the-fight = Ta participescha al cumbat per in internet saun
home-your-voice-your-code = Tia vusch. Tes code. Tias ideas. I dat effectivamain millis vias per tai da contribuir a { -brand-name-mozilla }.
home-volunteer-with-mozilla = Collavurar cun { -brand-name-mozilla }
home-that-one-time = Il di cura che nus avain regalà noss code da funtauna…
home-the-mozilla-project = Il project { -brand-name-mozilla } è vegnì fundà a San Francisco l’onn 1998 cura ch’il navigatur { -brand-name-netscape } ha prendì la decisiun radicala da regalar ses code dal program a la publicitad per ch’el possia vegnir reutilisà e meglierà. Da lezzas uras aveva ina interpresa il monopol virtual da l’experientscha en l’internet.
home-eventually-the-open = A la fin è il project open-source { -brand-name-mozilla } sa transfurmà en l’emprima versiun vaira populara da { -brand-name-firefox }.
home-today-mozilla-continues = Oz cuntinuescha { -brand-name-mozilla } cun ses engaschi per in meglier internet cun ina communitad da milliuns commembers activs en tut il mund che cumbattan per tecnologia etica, in’intelligenza artifiziala fidabla e la creaziun da products che resguardan la protecziun da datas e rinforzan la posiziun da las utilisadras ed ils utilisaders.
home-learn-more-about-mozilla = Ve a savair dapli davart { -brand-name-mozilla }
home-get-good-news = Retschaiva (bunas) novitads da { -brand-name-mozilla }
home-get-news-and-tips = Retschaiva novitads e tips da { -brand-name-mozilla } per garantir tia segirezza e per vegnir a novas da tut quai che fa dal web in meglier lieu.
# VPN Feature
home-featured-product = Product cusseglià
# HTML for visual formatting. "Blur" here is used as a metaphor for hiding or obscuring something.
home-feature-blur-your-location = Zuppenta tia posiziun e tias activitads cun agid da <span>{ -brand-name-mozilla-vpn }</span>
# Mozilla Foundation donation promo
home-mofo-build-our-movement = Sustegna noss moviment
home-mofo-donate-to-mofo-today = Fa oz ina donaziun a { -brand-name-mozilla-foundation } per garantir che l’internet restia avert ed accessibel a tuts.
home-mofo-donate = Fa ina donaziun
