...
navigation-refresh-firefox-browsers = Navigaturs { -brand-name-firefox }
navigation-refresh-close-firefox-browsers-menu = Serrar il menu dals navigaturs { -brand-name-firefox }
navigation-refresh-firefox-for-desktop = { -brand-name-firefox } per computers desktop
...
navigation-refresh-all-products = Tut ils products
navigation-refresh-firefox-blog = Blog da { -brand-name-firefox }
