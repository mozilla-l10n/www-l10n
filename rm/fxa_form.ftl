...
# Obsolete string
fxa-form-enter-your-email = <strong>Endatescha tia adressa dad e-mail</strong> per acceder al { -brand-name-firefox-accounts }.
fxa-form-enter-your-email-v2 = <strong>Endatescha tia adressa dad e-mail</strong> per crear in { -brand-name-mozilla-account }.
# Variables:
