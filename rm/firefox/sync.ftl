...
firefox-sync-access-and-sync = Acceda a tes segnapaginas, tes pleds-clav, tes tabs averts e dapli e sincronisescha tut – dapertut nua che ti utiliseschas { -brand-name-firefox }.
firefox-sync-firefox = { -brand-name-firefox-browser }
firefox-sync-sync-your-firefox = Sincronisescha { -brand-name-firefox } sin tuts tes apparats
firefox-sync-privacy-made-easy = Protecziun da datas – fitg simpel
firefox-sync-all-you-need = Tut che ti dovras per { -brand-name-firefox-sync } è in { -brand-name-firefox-account }.
