...
# HTML page title
compare-chrome-firefox-vs-chrome-which-is = { -brand-name-firefox } u { -brand-name-chrome }: Tgenin è meglier?
# HTML page description
compare-chrome-we-compare-mozilla-firefox = Nus cumparegliain { -brand-name-mozilla } { -brand-name-firefox } cun { -brand-name-google } { -brand-name-chrome } areguard la protecziun da datas, l'utilitad e la portabilitad.
# Main title.
compare-chrome-comparing-firefox-browser = La cumparegliaziun da { -brand-name-firefox-browser } cun { -brand-name-google } { -brand-name-chrome }
# Variables:
#   $attrs (string) - link to https://monitor.firefox.com with additional attributes for analytics
compare-chrome-at-firefox-we-have-a-huge = Tar { -brand-name-firefox } avain nus fitg blers utilisaders fidaivels che apprezieschan nos engaschament perseverant per la protecziun da datas en la rait. La versiun la pli actuala da { -brand-name-firefox } cuntegna per exempel ina funcziun che protegia ils utilisaders cunter fastizaders, numnada Enhanced Tracking Protection (ETP). Quella è activada en la configuraziun predefinida per tut ils utilisaders en l'entir mund. ETP blochescha dapli che 2000 fastizaders, inclus fastizaders socials dad interpresas sco per exempel { -brand-name-facebook }, { -brand-name-twitter } e LinkedIn. En pli cuntegna la nova versiun ina funcziun, numnada <a { $attrs }>{ -brand-name-firefox-monitor }</a> che t'avertescha automaticamain sche tes pled-clav è tangà dad ina sperdita da datas u sch'el sto vegnir midà. Ultra da questas protecziuns stizza il modus privat da { -brand-name-firefox } automaticamain era infurmaziuns davart tia navigaziun, sco la cronologia e cookies, uschia che ti na laschas enavos nagins fastizs suenter tia sesida.
