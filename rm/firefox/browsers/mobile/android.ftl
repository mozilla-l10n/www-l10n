...
mobile-android-go-mobile-go = Porta il navigatur cun tai. Daventa independent cun { -brand-name-firefox } per { -brand-name-android }
# Obsolete string
mobile-android-when-you-download = Sche ti telechargias { -brand-name-firefox } sustegnas ti in'interpresa tecnologica independenta. { -brand-name-firefox } è l'unic navigatur pli grond che vegn purtà dad in'interpresa d'util public che cumbatta per dapli avertezza, transparenza ed autocontrolla per la vita en l'internet.
