...
# HTML page title
firefox-privacy-hub-firefox-privacy-promise = L'engaschi da { -brand-name-firefox } per la protecziun da datas
# HTML page description
firefox-privacy-hub-firefox-takes-less-data-keeps = { -brand-name-firefox } rimna damain datas, las protegia e communitgescha avertamain.
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words, please omit the strong tags if they need to be around multiple words in your language
firefox-privacy-hub-firefox-products-are-designed = Ils products da { -brand-name-firefox } èn concepids per proteger tia <strong>sfera privata</strong>
# Sub navigation title
firefox-privacy-privacy = Protecziun da datas
# Sub navigation link
