...
firefox-more-little-book = Il cudeschet da la sfera privata
firefox-more-you-can-reclaim = Ti pos reconquistar tia sfera privata e la controlla da tia atgna experientscha online! Atgnamain èsi surprendentamain simpel da far quai – per ina e mintgin.
firefox-more-firefox-sync = { -brand-name-firefox-sync }
firefox-more-access-your-sync = Acceda a tes segnapaginas, tes pleds-clav, tes tabs averts ed auter pli e sincronisescha tut – dapertut nua che ti utiliseschas { -brand-name-firefox }.
...
comparing-firefox-chrome = La cumparegliaziun dal { -brand-name-firefox-browser } cun { -brand-name-google } { -brand-name-chrome }
big-isnt-always = Il pli grond n'è betg en mintga cas il meglier. Tscherna l'independenza.
comparing-firefox-brave = La cumparegliaziun dal { -brand-name-firefox-browser } cun { -brand-name-brave }
be-bold-and = Sajas giagliard e curaschus cun tscherner il dretg navigatur per tai.
comparing-firefox-edge = La cumparegliaziun dal { -brand-name-firefox-browser } cun { -brand-name-microsoft } { -brand-name-edge }
youll-never-guess = Ti na vegns mai ad engiavinar tge navigatur che stat a la testa areguard sveltezza e funcziunalitad.
...
comparing-firefox-safari = La cumparegliaziun dal { -brand-name-firefox-browser } cun { -brand-name-apple } { -brand-name-safari }
you-dont-have = Ti na stos betg utilisar per forza tes navigatur preinstallà.
...
firefox-more-is-firefox-a-private-browser = È { -brand-name-firefox } in navigatur discret?
firefox-more-were-focused-on-your-right-to = Nus dain paisa a tes dretg da sfera privata. Tias datas, tias activitads en il web e tia vita online èn protegidas cun { -brand-name-firefox }.
