...
# HTML page title
welcome-page6-make-firefox-your-default = Definescha { -brand-name-firefox } sco navigatur da standard
welcome-page6-make-sure-youre-protected = Fa la segira che ti es protegì mintga giada che ti navigheschas en il web
welcome-page6-when-you-choose-firefox-you = Sche ti tschernas { -brand-name-firefox }, sustegnas ti in meglier web per tai e tut tschels. Fa ussa il proxim pass per ta proteger.
welcome-page6-get-the-firefox-app = Va per l'app da { -brand-name-firefox }
welcome-page6-get-firefox-on-your-phone = Va per { -brand-name-firefox } per tes telefonin
welcome-page6-scan-the-qr-code-to-get-started = Scannescha il code QR per cumenzar
welcome-page6-qr-code-to-scan-for-firefox = Code QR scannabel per { -brand-name-firefox }
