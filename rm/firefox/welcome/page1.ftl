...
# HTML page title
welcome-page1-more-than-a-browser-firefox = Dapli ch'in navigatur – { -brand-name-firefox-monitor } tegna en egl ils hackers
...
welcome-page1-stay-ahead-of-hackers-check = Lascha enavos ils hackers. Controllescha sperditas da datas cun { -brand-name-firefox-monitor }.
