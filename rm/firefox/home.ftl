...
firefox-home-firefox-is-just = { -brand-name-firefox } è mo l’entschatta.
# Obsolete string
firefox-home-meet-our-family-of = Scuvra nossa paletta da products
firefox-home-meet-mozillas-family = Scuvra la paletta da products da { -brand-name-mozilla }
...
firefox-home-every-single-mozilla = Mintga singul product da { -brand-name-mozilla } resguarda nossa empermischun areguard la protecziun da tias datas persunalas: <strong>Rimnar pauc. Proteger bain. Nagins secrets.</strong>
