...
privacy-faq-mozilla-does-collect-a-limited-v2 = { -brand-name-mozilla } rimna en la configuraziun predefinida ina quantitad limitada da datas da { -brand-name-firefox } ch’ans gida a chapir co las persunas dovran il navigatur. Ti pos vegnir a savair dapli davart il tema en nossa <a href="{ $privacy }">decleraziun davart la protecziun da datas</a> e ti pos leger l’<a href="{ $data }">entira documentaziun da questa rimnada da datas</a>.
