...
# HTML page title
privacy-faq-mozillas-data-privacy-faq = FAQ davart la protecziun da datas da { -brand-name-mozilla }
privacy-faq-at-mozilla-we-respect-and-protect-desc = Nus da { -brand-name-mozilla } respectain e protegin tias infurmaziuns persunalas.
privacy-faq-we-stand-for-people-over-profit = Per nus vegnan ils carstgauns avant il profit.
privacy-faq-it-can-be-tricky-for-people = Ozendi èsi savens grev da savair tge ch'ins po spetgar da programs e servetschs utilisads. La tecnologia che dominescha nossa vita è cumplexa e blers n'han betg il temp da s'occupar dals detagls. Quai vala era per { -brand-name-firefox }: Nus vesain che blera glieud ha imaginaziuns fitg differentas da quai che curra e passa en il motor dal navigatur.
privacy-faq-at-mozilla-we-respect-and-protect = Nus da { -brand-name-mozilla } respectain e protegin tias infurmaziuns persunalas:
# Variables:
...
privacy-faq-mozilla-doesnt-know-as-much = { -brand-name-mozilla } na sa betg tant davart la navigaziun dals utilisaders en l'internet sco ti spetgassas forsa. Sco sviluppaders dad in navigatur è quai ina sfida per nus. Per quest motiv avain nus creà utensils che funcziunan cun participaziun voluntara (sco <a href="{ $link }">{ -brand-name-firefox } Pioneer</a>) e permettan als utilisaders interessads d'ans dar ina invista en lur navigaziun en il web. Sche ti sincroniseschas tia cronologia tranter differentas installaziuns da { -brand-name-firefox } n'avain nus dentant nagin access a quest cuntegn - perquai ch'el è criptà da tes apparat.
...
privacy-faq-we-make-our-documentation-public = Nossa documentaziun è publica per che mintgin possia verifitgar che quai che nus schain è vair. Ans fa a savair sche nus stuain meglierar insatge e hajas confidenza che nus na zuppain nagut.
...
privacy-faq-yes-user-control-is-one-of-our = Gea, la pussaivladad per ils utilisaders da controllar lur atgnas datas è in da noss princips da la protecziun da datas. { -brand-name-firefox } ha ina pagina speziala da <a href="{ $settings }">preferenzas per la protecziun da datas</a>. Là sa chattan tut las pussaivladads da controllar l'atgna sfera privata en { -brand-name-firefox }, era l'opziun da <a href="{ $data }">deactivar la rimnada da datas</a>.
privacy-faq-what-about-my-account-data = Tge esi cun las datas da mes conto?
privacy-faq-we-are-big-believers-of-data = Nus vulain mo rimnar las datas necessarias e na ta dumandain betg datas che nus na duvrain betg.
# Variables:
#   $accounts (url) - link to https://support.mozilla.org/kb/firefox-options-preferences-and-settings
privacy-faq-you-dont-need-an-account-to = Ti na dovras nagin conto per utilisar { -brand-name-firefox }. <a href="{ $accounts }">Contos</a> èn necessaris per sincronisar datas tranter differents apparats, ma per quest intent duvrain nus mo ina adressa dad e-mail. Nus na vulain betg savair tes num, tia adressa, il di da naschientscha u tes numer da telefon.
privacy-faq-you-use-digital-advertising = La reclama online fa part da vossa strategia da marketing. Cumprais vus datas da persunas per cuntanscher meglier voss public en mira?
privacy-faq-no-we-do-not-buy-peoples-data = Na, nus na cumprain betg datas da persunas per far reclama persunalisada.
privacy-faq-we-do-ask-our-advertising-partners = Nus pretendain da noss partenaris da reclama ch'els dovrian mo datas d'emprim maun che websites ed inserents han gia da tut ils utilisaders, per exempel il navigatur e l'apparat utilisà.
privacy-faq-well-it-seems-like-you-really = Bun, i para che la protecziun da datas as stettia propi a cor.
privacy-faq-yes-we-do = Exact uschia esi.
privacy-faq-find-out-more-about-how-mozilla = Ve a savair dapli tge che { -brand-name-mozilla } fa per proteger l'internet.
