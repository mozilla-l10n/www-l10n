...
privacy-index-if-you-want-to-make-a-correction = Sche ti vuls curreger tias infurmaziuns u sche ti has dumondas concernent nossas directivas da la protecziun da datas, contactescha per plaschair:
# Variables:
...
privacy-index-mozilla-subscription-services = Servetschs d'abunament da { -brand-name-mozilla }
