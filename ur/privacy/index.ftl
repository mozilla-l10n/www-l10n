...
privacy-index-contact-mozilla = { -brand-name-mozilla } سے رابطہ کریں
privacy-index-if-you-want-to-make-a-correction = اگر آپ اپنی معلومات کے بارے میں اصلاح کرنا چاہتے ہیں، یا ہماری رازداری کی پالیسیوں کے بارے میں کوئی سوالات ہیں تو، براہ کرم رابطا کریں:
# Variables:
#   $dsar (url) - link to https://app.onetrust.com/app/#/webform/4ba08202-2ede-4934-a89e-f0b0870f95f0
privacy-index-see-here-for-data-subject = <a href="{ $dsar }"> ڈیٹا سبجیکٹ تک رسائی کی درخواستوں کے لئے یہاں ملاحظہ کریں۔ </a>
# Variables:
#   $sumo (url) - link to https://support.mozilla.org/
privacy-index-for-product-support-requests = مصنوعہ کی سپورٹ کی درخواستوں کے لئے ، براہمہربانی <<a href="{ $sumo }"> ہمارے فورمز دیکھیں</a>۔
privacy-index-data-privacy-principles = کوائف کی رازداری کے اصول
# Variables:
