...
firefox-privacy-hub-firefox-takes-less-data-keeps = { -brand-name-firefox }  کم ڈیٹا لیتا ہے ، اسے محفوظ رکھتا ہے ، اور اس میں کوئی راز نہیں ہے۔
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words, please omit the strong tags if they need to be around multiple words in your language
firefox-privacy-hub-firefox-products-are-designed = { -brand-name-firefox } کی مصنوعات آپ کی <strong> رازداری </ strong> کے تحفظ کے لئے بنائی گئی ہیں
...
firefox-privacy-hub-read-the-privacy-notice-for = ہماری مصنوعات کے لئے <a href="{ $url }">رازداری کا نوٹس </a> پڑھیں
firefox-privacy-hub-get-mozilla-vpn = { -brand-name-mozilla-vpn } حاصل کریں
