...
firefox-sticky-promo-meet-our-family-of = ہماری مصنوعات کے خاندان سے ملیں
firefox-sticky-promo-get-the-latest-firefox = جدید ترین { -brand-name-firefox } براؤزر حاصل کریں۔
# Products List
firefox-sticky-promo-browsers = براؤزرز
