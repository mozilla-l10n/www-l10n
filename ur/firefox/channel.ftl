...
firefox-channel-experience-cutting-edge-android = اینڈرائیڈ کے لئے پری ریلیز براؤزر میں جدید خصوصیات کا تجربہ کریں: فائر فاکس بیٹا ، فائر فاکس ارورہ اور فائر فاکس نائٹلی۔ اب انسٹال!
...
firefox-channel-test-beta-versions-of-firefox-ios-long = { -brand-name-apple } کے آزمائشی پرواز پروگرام کے ذریعے { -brand-name-ios } کے لئے FireFox کے بیٹا ورژن کی جانچ کریں اور iPod touch { -brand-name-iphone }, { -brand-name-ipad } کے لئے مزید بہتر موبا ئل براؤزر بنانے میں ھماری مدد کریں_
