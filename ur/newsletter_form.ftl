...
newsletter-form-we-will-only-send = ہم آپکو صرف { -brand-name-mozilla } سے متعلقہ معلومات بھیجیں گے۔
newsletter-form-we-will-only-send-firefox = ہم آپ کو صرف { -brand-name-firefox } متعلقہ معلومات بھیجیں گے۔
