...
download-button-firefox-beta-android = <span>Firefox tein Beta</span> ika { -brand-name-android }
download-button-firefox-aurora-android = <span>Firefox tein Aurora</span> ika { -brand-name-android }
