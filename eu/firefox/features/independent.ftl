...
# HTML page title
features-independent-firefox-a-different = { -brand-name-firefox }, nabigatzaile desberdina garai desberdinetarako. Nabigatu libreki.
# HTML page description
features-independent-browse-the-internet = Nabigatu Interneten behar bezala… libreki, seguru eta erraz erabiliz. Aldarrikatu zure lineako independentzia.
features-independent-firefox-rebel-with-a = { -brand-name-firefox }: kausadun errebeldea
...
features-independent-in-addition-to-fighting = Zure lineako eskubideen alde borrokatzeaz gain, korporazioen indarrari muga jartzen diogu, era berean mundu osoko aliatuekin elkarlanean Interneteko praktika osasuntsuak sustatuz. Beraz, { -brand-name-firefox } aukeratzen duzunean, guk zu ere hautatzen zaitugu.
# Obsolete string
features-independent-firefox-is-a-browser = { -brand-name-firefox } kontzientziadun nabigatzailea da. Irabazi-asmorik gabeko { -brand-name-mozilla }ren parte, zure lineako eskubideen alde borrokatzen dugu, korporazioen indarra mugatzen, eta baita garatze bidean dauden herrialdeak Interneteko praktika osasuntsuetan hezten laguntzen ere. Beraz, { -brand-name-firefox } aukeratzen duzunean, guk zu ere aukeratzen zaitugu.
