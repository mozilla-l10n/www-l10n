...
newsletter-form-your-email-here = നിങ്ങളുടെ ഈമെയില്‍ വിലാസം ഇവിടെ നല്‍കുക
newsletter-form-format = ശൈലി
newsletter-form-html = എച്ച്ടി‌എം‌എല്‍
newsletter-form-text = ടെക്സ്റ്റ്
newsletter-form-get-firefox-news = ഫയര്‍ഫോക്സ് വാര്‍ത്തകള്‍ ലഭ്യമാക്കുക
# Variables:
...
newsletter-form-we-will-only-send = മോസില്ലാ സംബന്ധിച്ചുള്ള വിവരങ്ങള്‍ മാത്രമേ ഞങ്ങള്‍ അയച്ചു് തരൂ.
...
newsletter-form-keep-up-with = തുടരുക <br> എല്ലാ കാര്യങ്ങളും ഫയർഫോക്സിലൂടെ.
newsletter-form-get-mozilla-updates = മോസില്ല പരിഷ്കരണങ്ങള്‍ ലഭ്യമാക്കൂ
