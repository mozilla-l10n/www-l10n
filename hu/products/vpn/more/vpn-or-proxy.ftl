...
vpn-or-proxy-the-difference-between = A különbség a VPN és a webes proxy között
# HTML page description and intro
vpn-or-proxy-vpns-and-proxies-are = A VPN-k és proxyk online adatvédelmi és biztonsági megoldások. Ezek így védik meg Önt, és így választhatja ki az Ön számára legjobb lehetőséget.
vpn-or-proxy-virtual-private-networks = A virtuális magánhálózatok (VPN) és a biztonságos webes proxyk jobb online adatvédelmet és biztonságot nyújtó megoldások, de nehéz lehet eldönteni, hogy melyik a megfelelő az Ön számára. Íme egy pillantás arra, hogy ezek a szolgáltatások hogyan védik meg Önt, és hogyan válassza ki a legjobb megoldást.
vpn-or-proxy-stop-isps-from = Akadályozza meg, hogy az internetszolgáltatók kémkedjenek
# Variables
...
vpn-or-proxy-when-you-use-firefox = Ha a <a href="{ $firefox }">{ -brand-name-firefox(case: "accusative") } használja</a>, a <a href="{ $etp }">Továbbfejlesztett követésvédelem</a> automatikusan blokkol számos harmadik féltől származó <a href="{ $trackers }">webes követőt</a>, hogy ne követhessék a weben. De itt egy érdekes tény: az internetszolgáltatója (ISP), akinek az internetkapcsolatért fizet – továbbra is megfigyelheti és követheti Önt.
...
vpn-or-proxy-isps-can-use = Az internetszolgáltatók felhasználhatják ezeket az információkat saját hirdetéseik célzására, vagy bevételszerzési lehetőségekre, amelyek magukban foglalhatják az adatok adatbányászatban, marketingben és célzott hirdetésekkel érdekelt harmadik felekkel történő megosztását, ami kevesebb adatvédelmet és több nyomon követést jelent. A privát módban történő böngészés nem akadályozza meg az internetszolgáltatókat abban, hogy lássák, hol jár online. De a webes forgalom proxyn vagy VPN-en keresztül történő elküldése sokkal nehezebbé teheti.
...
vpn-or-proxy-firefox-private-network = A <a href="{ $fpn }">{ -brand-name-firefox-private-network }</a> egy könnyen telepíthető böngészőkiegészítő, amely biztonságos, titkosított csatornát biztosít a web felé, hogy megvédje a böngészője kapcsolatát, bárhol is használja a { -brand-name-firefox(case: "accusative") }. Bekapcsolása gyors és könnyű, bármikor is legyen szükséges a megnövelt biztonságra.
vpn-or-proxy-vpns-devicelevel-protection = VPN-ek: eszközszintű védelem
vpn-or-proxy-vpns-do-more = A VPN-ek többet nyújtanak, mint a proxyk, mivel a proxy csak azt védi, amit a böngészőben csinál, míg a VPN az egész forgalmat védi, beleértve a böngészőt is, bárhol is van telepítve és engedélyezve a VPN. A VPN-ek többletbiztonságot és adatvédelmet nyújtanak minden online tevékenységéhez – ez fontos szempont, ha szeretné, hogy a tevékenységét magának tartsa, és megnehezítse az adatéhes nyomkövetők és internetszolgáltatók számára, hogy az összes eszközén, például telefonján, számítógépén és táblagépén is profilokat készítsenek Önről.
