...
vpn-windows-using-a-windows = Windowsos eszköz nyilvános, nem biztonságos Wi-Fi hálózaton történő használata sebezhetőbbé teszi az internetes forgalmi információit a hálózati kémkedéssel szemben, és a VPN egy erős védelmi réteg hozzáadásával segíthet megőrizni az adatai biztonságát.
vpn-windows-the-mozilla = A { -brand-name-mozilla-vpn } alkalmazás nem fogja fogyasztani túl sok Windowsos eszköz memóriáját, nem lassítja le a számítógépét, és nem pazarolja az akkumulátor élettartamát.
# Variables:
#   $url (string) - url('products.vpn.landing')
vpn-windows-mozilla-vpn = A { -brand-name-mozilla-vpn }-t a Windows 10 és a Windows 11 támogatja, és akár öt eszközön is használhatja. A kezdéshez <a href="{ $url }">feliratkozhat a mozilla.org oldalon</a>, és letöltheti az alkalmazást Windowsos eszközére.
