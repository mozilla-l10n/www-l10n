...
vpn-linux-mozilla-vpn = { -brand-name-mozilla-vpn } Linuxon
vpn-linux-looking-for = VPN-t keres a linuxos gépek védelmére? A { -brand-name-mozilla-vpn } az egyetlen szolgáltatást nyújtja, amelyet nonprofit vállalat nyújt. Tudja meg, hogyan védi meg Önt egy VPN, és hogy miért bízzon meg a { -brand-name-mozilla }ban az adatvédelme és biztonsága szempontjából.
vpn-linux-mozilla-vpn-on-linux = { -brand-name-mozilla-vpn } Linuxon a privátabb és biztonságosabb internetért
vpn-linux-linux-is-free = A Linux ingyenes, nyílt forráskódú és testreszabható, de nem mentes az online biztonsági és adatvédelmi problémáktól. Csakúgy, mint a többi operációs rendszer felhasználói, a Linux felhasználók is cenzúrával, megfigyeléssel és hackeléssel néznek szembe.
vpn-linux-mozilla-vpn-is-a = A { -brand-name-mozilla-vpn } egy virtuális magánhálózati szolgáltatás, amely a legmodernebb nyílt forráskódú titkosítást használja, és nem naplózza, követi vagy osztja meg hálózati tevékenységét. Lehetővé teszi, hogy több mint 500 kiszolgálóhoz csatlakozzon 30+ országban.
...
vpn-linux-additional-security = <strong>További biztonsági funkciók:</strong> DNS-blokkolást használunk a hirdetések, nyomkövetők és rosszindulatú programok blokkolására. Míg a böngészők csak olyan weboldalak képesek megakadályozni, hogy rosszindulatú programot adjanak meg és kövessék Önt.
vpn-linux-device-level = <strong>Eszközszintű titkosítás:</strong> A VPN-ekkel ellentétben, amelyek csak a böngésző forgalmát titkosítják, a { -brand-name-mozilla-vpn } titkosítja az eszközének összes forgalmát, beleértve az alkalmazásait és játékait is.
vpn-linux-multi-hop = <strong>Többugrásos továbbítás:</strong> A nagyobb védelem érdekében a { -brand-name-mozilla-vpn } titkosíthatja a forgalmat, és egy helyett két helyen keresztül vezeti át, így nehezebb lesz nyomon követni az online tevékenységét olvasható.
vpn-linux-simple-and = <strong>Egyszerű és intuitív felület:</strong> Csatlakozzon egy kiszolgálóhoz egyetlen kattintással. A beállításait az Ön igényei szerint is testreszabhatja.
