...
vpn-download-unable-to-download = Nem sikerült letölteni a { -brand-name-mozilla-vpn }-t
vpn-download-not-in-country = Sajnáljuk, a { -brand-name-mozilla-vpn } nem érhető el az Ön országában.
...
vpn-download-faq-as-more-daily = Ahogy a mindennapi életünk egyre nagyobb része az interneten keresztül zajlik, az online adatvédelem és biztonság még fontosabbá válik. A VPN, a <a href="{ $faq }">virtuális magánhálózat</a>, titkosított alagutat hoz létre az eszközei és az internet között, biztosítva hogy a kapcsolata biztonságos és privát maradjon, miközben két fontos módon is megvédi Önt:
# Variables:
#   $ip (url) - link to https://www.mozilla.org/products/vpn/more/what-is-an-ip-address/
vpn-download-faq-concealing-ip = A valódi <a href="{ $ip }">IP-címének</a> elrejtése: ez segít megvédeni a személyazonosságát, és elfedi a tartózkodási helyét a felkeresett weboldalak elől.
vpn-download-faq-encrypting = Internetes forgalom titkosítása: így senki sem kémkedhet az online tevékenysége után.
vpn-download-faq-working = Honnan tudhatom, hogy működik-e a VPN?
# Variables:
...
vpn-download-faq-adding-another = Újabb eszköz hozzáadása olyan egyszerű, hogy letölti és telepíti a { -brand-name-mozilla-vpn } szoftvert, majd az új eszközön bejelentkezik a meglévő { -brand-name-firefox }-fiókjába. További részletekért lásd a <a href="{ $subscription }">Hogyan adjon eszközöket a { -brand-name-mozilla-vpn } előfizetéséhez</a> leírást.
vpn-download-faq-best-practices = Mik a bevált VPN gyakorlatok?
vpn-download-faq-traffic = Ha a cél az internetes forgalom védelme a nagy sebesség megtartása mellett, akkor mindig a legjobb, ha olyan kiszolgálót választana, amely a lehető legközelebb van a fizikai helyéhez. Ez növeli a kapcsolata megbízhatóságát és sebességét, mivel az internetes forgalmának nem kell jelentős kerülőt tennie, mielőtt megérkezik a rendeltetési helyéhez a weben.
vpn-download-faq-experience = Ha a cél az, hogy megtapasztalja az internetet, mintha a világ más pontján lenne, akkor ott kiválaszthatja egy kiszolgáló helyét, és az összes felkeresett webhely úgy fog megjelenni, mintha ott lenne.
vpn-download-faq-protect = Ha még jobban meg akarja védeni magát, akkor a Beállítások > Adatvédelmi funkciók alatt aktiválhatja a hirdetések, reklámkövetők és rosszindulatú programok elleni védelmet. Vegye figyelembe, hogy ez azt okozhatja, hogy egyes webhelyek nem fognak működni vagy nem fognak betöltődni, így lehet hogy ideiglenesen le kell kapcsolnia ezeket a védelmeket, ha ezzel a problémával találkozik.
vpn-download-faq-lastly = Végül, a támogatott eszközökön a VPN-t még okosabbá teheti azzal, hogy kizár bizonyos alkalmazásokat (pl. a Netflixet) a VPN-ből.
vpn-download-faq-need-more = További segítségre van szüksége?
# Variables
#   $support (url) - link to https://support.mozilla.org/products/firefox-private-network-vpn
vpn-download-faq-support = Felveheti a kapcsolatot a támogatási csapatunkkal közvetlenül a { -brand-name-mozilla-vpn } alkalmazásban, a Beállítások > Segítség kérése > Kapcsolatfelvétel az ügyfélszolgálattal lehetőségre kattintva. Felveheti velünk a kapcsolatot a <a href="{ $support }">támogatói oldalunkon</a> is.
