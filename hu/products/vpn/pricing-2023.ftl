...
vpn-pricing-we-adhere-strictly = Szigorúan betartjuk a { -brand-name-mozilla } <a { $principles }>Adatvédelmi irányelveit</a>. Csak a { -brand-name-mozilla-vpn } működőképességéhez és a termék fejlesztéséhez szükséges adatokat gyűjtjük. A kampány- és hivatkozási adatokat is nyomon követjük a mobilalkalmazásunkban, hogy segítsük a { -brand-name-mozilla(ending: "accented") }nak megérteni a marketingkampányaink hatékonyságát. További információk az <a { $notice }>Adatvédelmi nyilatkozatban</a>.
