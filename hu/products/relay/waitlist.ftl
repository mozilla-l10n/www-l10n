...
waitlist-bundle-name = { -brand-name-relay } + { -brand-name-vpn } csomag
waitlist-phone-name = { -brand-name-relay } telefonmaszkolás
...
waitlist-subscribe-success-title = Köszönjük! Felkerült a listára
# Variables:
#   $product (string) one of the following three options:
#      - { -brand-name-relay-premium }
#      - { waitlist-bundle-name }
#      - { waitlist-phone-name }
waitlist-subscribe-success-email-desc = Amint a { -brand-name-relay-premium } elérhetővé válik az Ön régiójában, e-mailt küldünk Önnek.
waitlist-subscribe-success-phone-desc = Amint a { -brand-name-relay } telefonmaszkolás elérhetővé válik az Ön régiójában, e-mailt küldünk Önnek.
waitlist-subscribe-success-bundle-desc = Amint a { -brand-name-relay } + { -brand-name-vpn } elérhetővé válik az Ön régiójában, e-mailt küldünk Önnek.
waitlist-subscribe-please-enter-a-valid = Adjon meg egy érvényes e-mail-címet
waitlist-subscribe-please-select-country = Válasszon országot vagy régiót
waitlist-subscribe-please-select-language = Válasszon egy nyelvet
