...
be-bold-and = Legyen merész és bátor, amikor kiválasztja az Önnek megfelelő böngészőt.
comparing-firefox-edge = A { -brand-name-firefox-browser } és a { -brand-name-microsoft } { -brand-name-edge } összehasonlítása
youll-never-guess = Sosem fogja kitalálni, hogy melyik böngésző jár az élen, ha a sebességről és a funkciókról van szó.
comparing-firefox-ie = A { -brand-name-firefox-browser } és a { -brand-name-microsoft } { -brand-name-ie } összehasonlítása
old-habits-that = A régi szokásoktól nehéz megszabadulni, de jobban érzi magát, ha végre sikerül.
comparing-firefox-safari = A { -brand-name-firefox-browser } és az { -brand-name-apple } { -brand-name-safari } összehasonlítása
you-dont-have = Nem kell az alapértelmezett böngészőt választania.
comparing-firefox-opera = A { -brand-name-firefox-browser } és az { -brand-name-opera } összehasonlítása
be-free-to = Szabadon énekelhet a { -brand-name-firefox }ról, amikor csak akar.
the-ad-blocker = A reklámblokkoló – titkos fegyver a bosszantó hirdetések ellen.
so-many-ads = Oly sok hirdetés, oly kevés türelem… Ideje véget vetni az őrületnek.
firefox-more-protection = { -brand-name-firefox }: több védelem. Kevesebb aggodalom.
