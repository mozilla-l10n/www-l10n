...
# html page title
whatsnew80-page-title = Újdonságok a { -brand-name-firefox }ban
whatsnew80-up-to-date-banner = Gratulálunk! A legfrissebb { -brand-name-firefox } verziót használja.
# Main title
...
whatsnew80-new-firefox-android = Új { -brand-name-firefox } for { -brand-name-android }
whatsnew80-our-latest-version = A legfrisebb { -brand-name-firefox } verziónk villámgyors oldalbetöltést biztosít, új és letisztult dizájnnal, amellyel több dolgot végezhet el, még gyorsabban.
