...
whatsnew81-the-new-firefox-for-android = Megérkezett az ÚJ { -brand-name-firefox } for { -brand-name-android }
whatsnew81-make-firefox-your-everyday = Tegye a { -brand-name-firefox }ot a mindennapi böngészőjévé { -brand-name-ios }-en
