...
nightly-whatsnew-every-4-to-5-weeks = 4-5 hetente megjelenik a { -brand-name-firefox } új főverziója, amelynek eredményeként a { -brand-name-nightly } verziószáma is növekszik.
