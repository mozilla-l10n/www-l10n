...
nightly-whatsnew-if-you-want-to-v3 = Ha szeretné tudni, hogy mi történik a { -brand-name-nightly } és közössége körül, akkor olvassa el <a { $blog }>blogunkat</a> és kövessen minket <a { $mastodon }>Mastodonon</a> vagy <a { $twitter }>X</a> jó kiindulási pont!
# Obsolete string
# Variables:
#   $blog (url) - link to https://blog.nightly.mozilla.org/
#   $mastodon (url) - link to https://mozilla.social/@FirefoxNightly
