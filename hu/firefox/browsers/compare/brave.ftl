...
compare-brave-firefox-gives-you-the-option = A { -brand-name-firefox } lehetőséget ad az elmentett jelszavak titkosítására, melyeket <a { $primary }>elsődleges jelszóval érhet el</a>; a jelszavai védettek, még akkor is, ha közösen használja a számítógépet. A Brave nem védi jelszóval a jelszavait.
# Variables:
# $howto (url) - link to https://support.mozilla.org/kb/import-data-another-browser
compare-brave-switching-to-firefox-is-easy = A { -brand-name-firefox }ra váltás könnyű és gyors – importálja a Brave könyvjelzőit, jelszavait, előzményeit és beállításait egy kattintással, és azonnal készen áll a { -brand-name-firefox } használatára. Itt van, <a { $howto }>hogyan importálhatja a Brave-adatokat</a>.
