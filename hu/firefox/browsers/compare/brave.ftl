...
compare-brave-the-brave-browser-like-so = A { -brand-name-brave } böngésző, akárcsak sok másik, a { -brand-name-google } nyílt forráskódú { -brand-name-chromium } kódjára épül. A nyílt forráskód azt jelenti, hogy bárki felhasználhatja a forráskódot, és ráépíthet bármit – mint például az <a { $opera }>{ -brand-name-opera }</a> és az <a { $edge }>{ -brand-name-edge }</a> böngészők. De ez nem jelenti azt, hogy minden { -brand-name-chromium }-alapú böngésző egyenlő, vagy maguk nyílt forráskódúak.
compare-brave-brave-differentiates-itself = A { -brand-name-brave } megkülönbözteti magát a többi { -brand-name-chromium }-alapú böngészőtől azáltal, hogy a felhasználói adatvédelemre összpontosít – konkrétan a nyomkövetőket, parancsfájlokat és hirdetéseket alapértelmezetten blokkolja. Tehát, ha a { -brand-name-brave } böngészőt használja, egy webhely azon területei, amelyek általában hirdetéseket tartalmaznak, üres helyekként jelennek meg. Bizonyos esetekben az oldalak nem töltődnek be megfelelően, ezért másik böngészőt kell választania, vagy a „Shields Up” beállítást „Shields Down”-ra kell állítania, amely kikapcsolja a magánszféra és a biztonság védelmét.
...
compare-brave-there-are-a-few-of-braves = A { -brand-name-brave }-ben van néhány biztonsági funkció, amelyet érdemes kiemelni, mint például az automatikus HTTPS kapcsolatfrissítések (amelyeket a { -brand-name-firefox } <a { $extension }>kiegészítője</a> is kínál). A { -brand-name-brave } és a { -brand-name-firefox } egyaránt natív <a { $lockwise }>jelszókezelőt</a> kínálnak, valamint lehetőséget biztosítanak, hogy bármikor ellenőrizhesse a biztonsági statisztikákat. A { -brand-name-brave } olyan statisztikákat jelenít meg, mint a blokkolt nyomkövetők száma, ha új lapot nyit meg. A { -brand-name-firefox } hasonló információkat jelenít meg, ha megtekinti az <a { $privacy }>adatvédelmi jelentését</a>, amelyhez bármikor hozzáférhet, ha a pajzsra kattint a címsorban.
...
compare-brave-what-might-surprise-some-new = Néhány új { -brand-name-brave } felhasználót meglephet az, hogy az oldalak milyen gyorsan töltődnek be a böngészőben. Ennek a gyors betöltési időnek az az oka, hogy az oldalak sokkal gyorsabban töltődnek be, ha blokkolja az összes hirdetést. Egyszerűen kevesebb a betöltendő, így kevesebb időt igényel.
compare-brave-in-terms-of-actual-precious = A valódi értékes RAM-felhasználás szempontjából a { -brand-name-brave } böngésző sokkal nehezebb, mint a { -brand-name-firefox }. A { -brand-name-brave } különféle funkciókkal és „kiegészítőkkel” érkezik, ami nagyobb memóriahasználatot eredményez. A { -brand-name-firefox } ezzel szemben lehetővé teszi, hogy eldöntse, mely bővítményekre és kiegészítőkre van szüksége.
# Variables:
...
compare-brave-customization-of-ui-elements = A felületi elemek és témák évek óta a { -brand-name-firefox }-felhasználók kedvenc funkciója, és a lelkes fejlesztői közösségünk nyílt forráskódú bővítmények és kiegészítők <a { $addons }>hatalmas könyvtárát</a> hozta létre, amelyek még nagyobb személyre szabhatóságot és funkcionalitást tesznek lehetővé. A { -brand-name-firefox } letöltésekor kapott funkciók része a <a { $screenshot }>képernyőkép-készítő eszköz</a>, az akadálymentesítési szolgáltatások és a <a { $pocket }>{ -brand-name-pocket }</a> – egy erőforrás, ami lehetővé teszi, hogy a felhasználók gyorsan elmentsenek egy cikket későbbi olvasásra, bármilyen eszközön.
...
compare-brave-braves-advertising-replacement = A { -brand-name-brave } hirdetéshelyettesítő ötlete egy csavar a jelenlegi fizetett hirdetéselhelyezési és keresési rendszeren. Viszont az elfoglalt internethasználók valószínűleg nem akarnak jobban belefolyni a wehelyek mikrofizetéseinek kezelésébe, melyet az idejükért és figyelmükért cserébe kapnak.
