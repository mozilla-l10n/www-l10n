...
compare-edge-microsoft-has-to-make-their-shareholders = A Microsoftnak elégedetté kell tennie a részvényeseit, de koncentrálhatunk arra, hogy <strong>Ön</strong> elégedett legyen, és az Ön magánszféráját helyezzük az első helyre.
# Variables:
# $howto (url) - link to https://support.mozilla.org/kb/import-bookmarks-and-other-data-microsoft-edge
compare-edge-switching-to-firefox-is-easy = A { -brand-name-firefox }ra egyszerű és gyors – importálja az Edge könyvjelzőit, jelszavait, előzményeit és beállításait egy kattintással, és azonnal készen áll a { -brand-name-firefox } használatára. Itt van, <a { $howto }>hogyan váltson át az Importálás gombbal</a>.
