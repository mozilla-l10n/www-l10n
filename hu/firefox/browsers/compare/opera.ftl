...
compare-opera-firefox-offers-a-wide-range-of = A { -brand-name-firefox } testreszabási lehetőségek széles skáláját kínálja, többek között a menük és eszköztárak böngészőablak különböző helyeire. Az Opera felülete kevésbé testreszabható.
# Variables:
# $howto (url) - link to https://support.mozilla.org/kb/import-bookmarks-and-other-data-microsoft-edge
compare-opera-switching-to-firefox-is-easy = A { -brand-name-firefox }ra könnyű és gyors – importálja az Opera könyvjelzőit, jelszavait, előzményeit és beállításait egy kattintással, és azonnal készen áll a { -brand-name-firefox } használatára. Itt van, <a { $howto }>hogyan váltson át az Importálás gombbal</a>.
