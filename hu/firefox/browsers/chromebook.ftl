...
browsers-chromebook-get-firefox-desktop = Szerezze be az asztali { -brand-name-firefox }ot { -brand-name-chromebook }ra
browsers-chromebook-x86-based-chromebook = *x86-alapú, { -brand-name-chromeos } 80-at vagy újabb futtató { -brand-name-chromebook }
browsers-chromebook-dropdown-copy = Szerezze be a { -brand-name-firefox }ot { -brand-name-chromebook }ra
# The span here is to display an underline underneath "Firefox"
browsers-chromebook-why-get-firefox = Miért szerezze be a <span>{ -brand-name-firefox }ot</span> { -brand-name-chromebook }ra?
