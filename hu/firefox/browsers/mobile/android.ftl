...
mobile-android-got-a-big = Nagy telefonja, de normál méretű ujjai vannak? Semmi gond. A Firefox for Android lehetővé teszi, hogy a keresősávot fentről alulra helyezze, így könnyebben használhatja egy kézzel. A böngészőn belül kiválaszthatja a saját keresőszolgáltatását is, és beállíthatja a { -brand-name-firefox }ot alapértelmezett böngészőként.
