...
browser-history-then-microsoft-began = Ezután a { -brand-name-microsoft } elkezdte szállítani az { -brand-name-ie }t a { -brand-name-windows } operációs rendszerükkel. 4 éven belül a piac 75%-át irányították, 1999-re pedig a 99%-át. Emiatt a cég számos trösztellenes vizsgálattal nézett szembe, a a { -brand-name-netscape } pedig úgy döntött, hogy nyílt forráskódúvá teszi a kódbázisát, és létrehozta a nonprofit <a href="{ $mozilla }">{ -brand-name-mozilla(ending: "accented") }</a>, amely aztán létrehozta, és 2002-ben kiadta a { -brand-name-firefox }ot. Felismerve, hogy a böngészőmonopólium nem áll a felhasználók és a nyílt web érdekében, a { -brand-name-firefox } azért jött létre, hogy választást adjon a web felhasználóinak. 2010-re a { -brand-name-mozilla } { -brand-name-firefox } és mások <a href="{ $marketshare }">50%-ra csökkentették az { -brand-name-ie } piaci részesedését</a>.
