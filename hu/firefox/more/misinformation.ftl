...
misinformation-content-up-to-date = A tartalom naprakész?
misinformation-outdated-information = Az elavult információ nem feltétlenül dezinformáció, de lehet, hogy már tényszerűen nem igaz.
misinformation-credible-publication = A szerző tett közzé más cikkeket vagy bejegyzéseket, ideális esetben hiteles publikációkban?
misinformation-authors-name = Ha a szerző nevét csak megkérdőjelezhető webhelyeken találja meg, akkor nem szabad túl nagy jelentőséget tulajdonítani az állításainak.
misinformation-images-captions = A képek és a feliratok egyeznek?
