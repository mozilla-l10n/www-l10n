...
pinned-tabs-if-you-click-on-a-link-within = Ha a rögzített lapon belül egy hivatkozásra kattint, a { -brand-name-firefox } automatikusan megnyitja a hivatkozást egy külön, új lapon, így a rögzített lap örökre él (vagy amíg fel nem oldja).
