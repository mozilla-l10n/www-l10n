...
features-translate-the-firefox-translations-feature-v2 = A { -brand-name-firefox-translations } funkció egy másik módja, hogy a { -brand-name-mozilla } személyesen és biztonságosabbá tegye az internetét. A { -brand-name-mozilla } nem követi nyomon, milyen weboldalakat fordít le. Világszerte felhasználók millióival, a { -brand-name-mozilla } biztosítani akarja, hogy a { -brand-name-firefox(case: "accusative") } használók a saját feltételeik szerint tanuljanak, kommunikáljanak, megosztják egymást, és tájékozódjanak. <a { $download }>Kezdje a kívánt nyelven a { -brand-name-firefox } letöltésével.</a>
# Obsolete string (expires: 2025-02-17)
