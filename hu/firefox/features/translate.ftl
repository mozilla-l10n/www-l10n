...
features-translate-if-you-are = Ha már a { -brand-name-firefox }ot használja, akkor módosíthatja a böngésző nyelvét, vagy nyelveket adhat hozzá a { -brand-name-firefox } felületéhez. <a { $attrs }>Tudja meg hogyan itt.</a>
