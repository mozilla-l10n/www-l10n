...
home-mission-driven = Küldetésvezérelt. Emberi erővel.
...
home-product-fakespot-detect = Észleljen hamis vásárlási értékeléseket
home-cta-get-fakespot = { -brand-name-fakespot } beszerzése
...
home-volunteer-with-mozilla = Legyen önkéntes a { -brand-name-mozilla(ending: "accented") }nál
home-that-one-time = Egykor közzétettük a forráskódunkat…
home-the-mozilla-project = A { -brand-name-mozilla } projektet 1998-ban alapították San Franciscóban, amikor a { -brand-name-netscape } böngésző azt a radikális döntést hozta, hogy nyilvánosan közzéteszi a programkódját, hogy a közösség azt tovább építhesse, és fejlődhessen. Akkoriban egy cég gyakorlatilag egyeduralommal rendelkezett abban, hogy az emberek hogyan tapasztalják meg az internetet.
...
home-feature-blur-your-location = Rejtse el tartózkodási helyét és tevékenységét a <span>{ -brand-name-mozilla-vpn }</span> segítségével
# Mozilla Foundation donation promo
home-mofo-build-our-movement = Építsük a mozgalmunkat
home-mofo-donate-to-mofo-today = Adományozzon a { -brand-name-mozilla-foundation } számára még ma, hogy az internet nyílt és mindenki számára elérhető maradjon.
home-mofo-donate = Adományozás
