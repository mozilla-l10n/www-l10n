...
manifesto-visualize-who-you-interact = Tegye láthatóvá, hogyan kapcsolódik másokhoz a weben a Lightbeam segítségével
manifesto-learn-about-creating-web = Tudja meg, hogyan teremthet webes erőforrásokat másokkal közösen
manifesto-host-or-join-a-maker-party = Legyen házigazdája vagy vendége egy Maker Partynak
