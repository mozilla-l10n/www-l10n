...
manifesto-written-in-2007 = A 2007-ben írt { -brand-name-mozilla } Kiáltvány felvázolja a fő elveinket. A „Fogadalom az egészséges internetért” a Kiáltvány mellékleteként íródott 2017-ben, hogy kifejezze mély elkötelezettségünket az iránt, hogy az internet szolgálja az emberek és az emberiség egészének igényeit. Ez a két dokumentum együtt vezérli a { -brand-name-mozilla } munkáját – hogy mit építünk, mit finanszírozunk, és hogyan működünk együtt közösségként.
manifesto-mozillas-pledge = A { -brand-name-mozilla } Fogadalma
manifesto-across-the-mozilla-project = Mi, a { -brand-name-mozilla } projekt és a { -brand-name-mozilla } család összes szervezete, elkötelezzük magunkat, hogy támogatjuk a { -brand-name-mozilla } Kiáltvány által megfogalmazott tevékenységeket. Konkrétan a következőket fogjuk tenni:
