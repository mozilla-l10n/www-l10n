...
manifesto-details-the-mozilla-project-global-v2 = A { -brand-name-mozilla } Projekt olyan emberek globális közössége, akik úgy vélik, hogy a nyitottság, az innováció és a lehetőség a kulcsa az internet egészséges működésének. 1998 óta dolgozunk együtt azon, hogy az internet mindenki számára előnyös irányba fejlődjön. Leginkább a(z) { -brand-name-mozilla } { -brand-name-firefox } webböngésző létrehozása kapcsán ismernek minket.
...
manifesto-details-the-mozilla-project-community-v2 = A { -brand-name-mozilla } Projekt közösségi alapú megközelítést alkalmaz, hogy világszínvonalú, nyílt forráskódú szoftvereket hozzon létre, és új típusú együttműködési tevékenységeket dolgozzon ki. Közösségeket hozunk létre, amelyben emberek közreműködnek abban, hogy az internetes élmény mindannyiunk számára jobb legyen.
# Obsolete string (expires 2026-09-20)
