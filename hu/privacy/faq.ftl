...
privacy-faq-mozilla-doesnt-know-as-much-v2 = A { -brand-name-mozilla } nem tud annyit, mint gondolná, arról, hogyan böngészik az emberek a világhálót. Böngészőkészítőként ez valójában nagy kihívás számunkra. Ezért építettünk olyan opt-in eszközöket, melyekkel az érdeklődő felhasználók bepillantást engedhetnek böngészésükbe. Ha szinkronizálja a böngészési előzményeit a { -brand-name-firefox } telepítések között, akkor nem tudjuk meg, hogy mik ezek – mert az eszköz titkosítja azokat.
# Outdated string
# Variables:
#   $link (url) - link to https://addons.mozilla.org/firefox/addon/firefox-pioneer/
privacy-faq-mozilla-doesnt-know-as-much = A { -brand-name-mozilla } sokkal kevesebbet tud arról, hogy az emberek hogyan böngészik a webet, mint azt gondolná. Böngészőgyártóként, ez egy komoly kihívás számunkra. Ezért készítettünk olyan bekapcsolható eszközöket, mint a <a href="{ $link }">{ -brand-name-firefox } Pioneer</a>, amely lehetővé teszi, hogy az érdeklődő felhasználók betekintést nyújthassanak a webböngészésükbe. Ha a { -brand-name-firefox } telepítései között szinkronizálja az előzményeit, akkor nem tudjuk hogy az mit tartalmaz – mert titkosítva van az Ön eszközén.
