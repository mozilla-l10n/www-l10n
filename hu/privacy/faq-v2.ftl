...
privacy-faq-v2-softballs = Rendben, ezek voltak a könnyű esetek. Milyen adatokat gyűjtenek?
# Variables:
#   $privacy (url) - link to https://www.mozilla.org/privacy/firefox/
#   $data (url) - link to https://firefox-source-docs.mozilla.org/toolkit/components/telemetry/telemetry/
privacy-faq-v2-mozilla-does-collect = A { -brand-name-mozilla } alapértelmezés szerint korlátozott mennyiségű adatot gyűjt a { -brand-name-firefox(case: "elative") }, amelyek segítenek nekünk megérteni, hogy az emberek miként használják a böngészőt. Erről többet tudhat meg az <a { $privacy }>Adatvédelmi nyilatkozatunkban</a>, és elolvashatja az <a { $data }>adatgyűjtés teljes dokumentációját</a>. A dokumentációnkat nyilvánossá is tesszük, így bárki ellenőrizheti, hogy igaz-e amit mondunk; tudassa velünk, ha javítanunk kell valamin, és győződjön meg róla, hogy nem rejtegetünk semmit.
privacy-faq-v2-do-you-collect = Több adatot gyűjtenek a { -brand-name-firefox } előzetes kiadású verzióiból?
...
privacy-faq-v2-if-we-dont-know = Ha nem tudjuk hogyan teljesít a böngésző, és mely funkciókat használják az emberek, akkor nem tudunk rajta javítani sem, és nem tudunk egy olyan nagyszerű terméket szállítani, amelyet szeretne. Sokat fektettünk bele olyan adatgyűjtő- és elemzőeszközök készítésébe, amelyekkel okos döntést hozhatunk a termékről, miközben tiszteletben tartjuk az emberek adatvédelmét. Többet olvashat az általunk használt egyes adatvédelem-megőrző technológiákról, mint az <a { $attrs }>OHTTP</a>.
privacy-faq-v2-data-collection-bugs-me = Az adatgyűjtés továbbra is zavar. Kikapcsolhatom?
# Variables:
...
privacy-faq-v2-you-dont-need-an-account = Nincs szüksége fiókra a { -brand-name-firefox } használatához. Az adatok eszközök közti szinkronizációhoz <a { $attrs }>fiók</a> szükséges, de csak az e-mail-címét és az életkorát kérjük (csak hogy meggyőződjön arról, hogy nem gyermek).
privacy-faq-v2-you-use-digital = Többek között digitális hirdetéseket is használnak. Megveszik az emberek adatait az online hirdetések jobb célzásához?
privacy-faq-v2-no-we-do-not-buy = Nem, nem veszünk adatokat a hirdetések célzásához.
privacy-faq-v2-we-do-not-ask = Arra kérjük a hirdetési partnereinket, hogy csak az olyan közvetlen adatokat használják, amit a weboldalak és a kiadók tudnak a felhasználókról, mint a használt böngésző, illetve az eszköz típusa.
