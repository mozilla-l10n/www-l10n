...
cookie-settings-page-intro-v2 = Ez az oldal ismerteti a { -brand-name-mozilla } által esetlegesen használt sütik különböző típusait és hasonló technológiákat, mint a pixelcímkéket, webes irányjelzőket, az üres GIF-eket, a JavaScriptet és a helyi tárolókat (a továbbiakban: „Sütik”), és átadja az irányítást hogy milyen adattípusokat fogad el a { -brand-name-mozilla } gyűjtésében.
# Obsolete string (expires: 2024-07-01)
cookie-settings-page-intro = Ez az oldal a { -brand-name-mozilla } által esetlegesen használt sütik különböző típusait és a hasonló technológiákat (például képpontcímkék, webes jelzők, üres GIF-ek, JavaScript és helyi tároló) („sütik”) írja le, és irányítást ad Önnek afelett, hogy milyen adattípusokat fogad el, hogy a { -brand-name-mozilla } begyűjtsön.
