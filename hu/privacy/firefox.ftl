...
privacy-firefox-builtin-control = Beépített vezérlés
...
privacy-firefox-firefox-protects-you = A { -brand-name-firefox } megvédi Önt az ismert harmadik féltől származó nyomkövetőktől, közösségimédia-követőktől, kriptobányászoktól, a sütiktől és az ujjlenyomat-készítő technológiáktól, melyek megpróbálják követni Önt a weben.
privacy-firefox-privacy-that-works = Adatvédelem, amely működik az Ön számára
privacy-firefox-firefox-makes-it = A { -brand-name-firefox } megkönnyíti az adatai kezelését a beépített adatvédelmi és biztonsági funkcióknak, valamint a böngészési élményén finomhangoló beállításoknak köszönhetően.
