...
download-button-download-now = ہݨ ڈاؤن لوڈ کرو
download-button-free-download = مفت ڈاون لوڈ
...
download-button-firefox-android = { -brand-name-android } کیتے <span>{ -brand-name-firefox }</span>
download-button-firefox-ios = { -brand-name-ios } کیتے <span>{ -brand-name-firefox }</span>
