...
switch-firefox-makes-switching-fast-email = { -brand-name-firefox } { -brand-name-chrome } کنوں سوئچنگ  واقعی تکھی کریندا ہے۔ میکوں ایہ ٻہوں پسند ہے، تے تہاکوں ایہ ازماوݨا چاہیدا ہے۔
switch-still-not-convinced = بھلا اڄݨ ایندے قائل نہوے تھئے جو{ -brand-name-firefox } تے سوئچ کرݨ سوکھا ہے؟
switch-enjoy-the-web-faster = تکھاجی نال ویب دا لطف گھنو، جیڑھا تہاݙے کیتے تیار ہے۔
