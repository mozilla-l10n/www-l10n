...
compare-shared-automatically-fills-out-forms = آپݨے آپ فارم بھریندے
compare-shared-automatically-fills-out-payments = آپݨے آپ ادائیگیاں بھریندے
...
compare-shared-in-browser-screenshot-tool = براؤزر وچ سکرین شاٹ ٹُول
...
compare-shared-download-firefox = { -brand-name-firefox } ڈاؤن لوڈ کرو
compare-shared-download-firefox-browser = { -brand-name-firefox-browser } ڈاؤن لوڈ کرو
compare-shared-download-the-app = ایپ ڈاؤن لوڈ کرو
