...
# Obsolete
nightly-whatsnew-every-6-to-8-weeks = ہر 6 توں 8 ہفتیاں وِچ، { -brand-name-firefox } دا ہک نیا وݙا ورژن جاری کیتا ویندا ہے تے ایندے نتیجے وِچ، { -brand-name-nightly } ورژن وی ودھدا ہے۔
...
nightly-whatsnew-if-you-want-to = جے تساں ڄاݨݨ چاہندے او جو { -brand-name-nightly } تے اوندی کمیونٹی دے چودھار کیا تھیندا پیا ہے تاں اساݙا <a href="{ $blog }">  بلاگ </a> تے اساݙی پیروی کرو <a href="{ $twitter }">{ -brand-name-twitter }</a> چنڳے نقطہ آغاز ہن!
# Variables:
...
nightly-whatsnew-want-to-know-which = ڄاݨݨ چاہندے او جو پلیٹ فارم دیاں کیڑھیاں خصوصیات تساں { -brand-name-nightly } تے جانچ سڳدے او تے ہݨ تائیں ٻئے { -brand-name-firefox } چینلز تے نہیں ݙیکھ سڳدے؟ وت  <abbr title=" { -brand-name-mozilla-developer-network } "> { -brand-name-mdn } </abbr> تجرباتی خصوصیات </a> تے ہک نظر مارو۔
# Variables:
