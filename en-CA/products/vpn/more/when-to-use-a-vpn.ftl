...
vpn-when-to-use-have-you-ever = Have you ever connected to a hotspot called something like <em>ROGERS-WiFi-Bloor</em> or <em>Bell-Hotspot-Vancouver</em>? Looks legit, right? Not so fast. In reality, anyone can set up a phony public WiFi with a legitimate sounding name to lure people to use it. Connecting to any unknown WiFi makes you an easy target for creeps and criminals who want to access your device to steal private information, install malware or worse. <a href="{ $mozvpn }">{ -brand-name-mozilla-vpn }</a> can boost your security any time you’re connected to a public WiFi by blocking unknown entities from seeing private data that travels from your phone or laptop. This goes for connecting to WiFi networks at coffee shops, stores, doctor’s offices and so on.
