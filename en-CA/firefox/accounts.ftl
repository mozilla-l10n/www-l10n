...
firefox-accounts-youll-always-get-the = You’ll always get the truth from us. Everything we make and do honours our <a href="{ $promise }">Personal Data Promise</a>:
