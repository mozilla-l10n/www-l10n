...
firefox-sticky-promo-meet-our-family-of = ພົບກັບກຸ່ມຜະລິດຕະພັນຂອງພວກເຮົາ
firefox-sticky-promo-get-the-latest-firefox = ຕິດຕັ້ງໂປແກຼມທ່ອງເວັບ { -brand-name-firefox } ລ້າສຸດ.
# Products List
firefox-sticky-promo-browsers = ຕົວທ່ອງເວັບ
