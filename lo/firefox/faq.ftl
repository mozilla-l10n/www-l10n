...
firefox-does-not = { -brand-name-firefox } ບໍ່ມີ VPN ໃນຕົວ (ເຄືອຂ່າຍສ່ວນຕົວ virtual), ແຕ່ມີສອງຜະລິດຕະພັນທີ່ຜະລິດໂດຍ { -brand-name-mozilla }/{ -brand-name-firefox } ທີ່ທ່ານສາມາດນໍາໃຊ້ໄດ້. ນອກເໜືອໄປຈາກ { -brand-name-firefox-browser } ສ່ວນຕົວທີ່ສາມາດປົກປ້ອງຕົວທ່ອງເວັບຂອງເຈົ້າໄດ້ (<a href="{ $url }">{ -brand-name-firefox-private-network }</a>) ຫຼືອຸປະກອນ (<a href="{ $url2 }">{ -brand-name-mozilla-vpn }</a>) ການເຊື່ອມຕໍ່ຢູ່ໃນ WiFi, ເຊັ່ນດຽວກັນກັບທີ່ຢູ່ IP ຂອງທ່ານ.
