...
# HTML page title
welcome-page2-pocket-save-news-videos-stories = { -brand-name-pocket } - ບັນທຶກຂ່າວ, ວິດີໂອ, ເລື່ອງເລົ່າ ແລະອື່ນໆອີກ
welcome-page2-your-time-online-is-worth = ເວລາຂອງທ່ານອອນໄລນ໌ແມ່ນຄຸ້ມຄ່າໃນການປົກປ້ອງ
welcome-page2-discover-and-save-stories = ຄົ້ນພົບ ແລະບັນທຶກເລື່ອງລາວໄວ້ໃນ { -brand-name-pocket } — ແລະກັບມາຫາພວກມັນເມື່ອທ່ານຫວ່າງ.
welcome-page2-activate-pocket = ເປີດໃຊ້ { -brand-name-pocket }
