...
firefox-new-join-firefox = ເຂົ້າຮ່ວມ { -brand-name-firefox }
# span's below are for visual formatting and line break.
firefox-new-download-firefox-for-windows = ດາວໂຫລດ { -brand-name-firefox } <br>ສຳລັບວິນໂດ
...
firefox-new-get-more-from-firefox = ຮັບຂໍ້ມູນເພີ່ມເຕີມຈາກ { -brand-name-firefox }
firefox-new-free-web-browser = ເວັບບຣາວເຊີຟຣີ
firefox-new-download-in-another-language = ດາວໂຫລດເປັນພາສາອື່ນ
firefox-new-fix-a-problem = ແກ້ໄຂບັນຫາ
firefox-new-need-help = ຕ້ອງການຄວາມຊ່ວຍເຫລືອບໍ?
firefox-new-protect-your-privacy = ຮັກສາຄວາມເປັນສ່ວນໂຕຂອງທ່ານ
firefox-new-just-download-the-browser = ພຽງແຕ່ດາວໂຫລດບຣາວເຊີ
