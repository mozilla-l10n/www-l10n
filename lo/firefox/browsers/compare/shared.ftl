...
compare-shared-password-management = ຕົວຈັດການລະຫັດຜ່ານ
...
compare-shared-download-firefox-browser = ດາວໂຫລດ { -brand-name-firefox-browser }
compare-shared-download-the-app = ດາວໂຫຼດແອັບ
