...
navigation-v2-close-firefox-browsers-menu = ປິດເມນູ { -brand-name-firefox-browsers }
navigation-v2-firefox-for-desktop = { -brand-name-firefox } ສໍາລັບເດັສທັອບ
navigation-v2-get-the-not-for-profit-backed = ຮັບເອົາຕົວທ່ອງເວັບທີ່ບໍ່ຫວັງຜົນກໍາໄລໃນ { -brand-name-windows }, { -brand-name-mac-short } ຫຼື { -brand-name-linux }.
navigation-v2-firefox-for-android = { -brand-name-firefox } ສໍາລັບ { -brand-name-android }
navigation-v2-get-the-customizable-mobile = ດາວໂຫລດຕົວທ່ອງເວັບມືຖືທີ່ສາມາດປັບແຕ່ງໄດ້ສໍາລັບສະມາດໂຟນ { -brand-name-android }.
navigation-v2-firefox-for-ios = { -brand-name-firefox } ສໍາລັບ { -brand-name-ios }
...
navigation-v2-get-the-details-on-the = ເອົາລາຍລະອຽດກ່ຽວກັບການອັບເດດຫຼ້າສຸດຂອງ { -brand-name-firefox }.
navigation-v2-view-all-firefox-browsers = ເບິ່ງທັງໝົດ { -brand-name-firefox-browsers }
...
navigation-v2-meet-the-team-thats-building = ພົບກັບທີມທີ່ກຳລັງສ້າງເທັກໂນໂລຍີສຳລັບອິນເຕີເນັດທີ່ດີຂຶ້ນ.
