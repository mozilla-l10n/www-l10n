...
navigation-close-projects-menu = Uddu dosol Eɓɓooje
navigation-developers = Topayɓe
navigation-close-developers-menu = Uddu dosol Topayɓe
navigation-projects-that-help-keep = Eɓɓooje ballooje Enternet udditaade e heɓaade mo woni kala.
navigation-build-test-scale-and = Mahto, ƴeewndo, ɓetto ekn huutoraade wanngorde wajjere waɗanaande topayɓe.
navigation-get-involved = Ar yantu e amen
navigation-release-notes = Konngol bayyinol
navigation-features = Fannuuji
navigation-products = Topirɗe
