...
firefox-channel-be-among-the-first-to-explore = Sé de los primeros n'esplorar llanzamientos futuros de { -brand-name-firefox } pa escritoriu, { -brand-name-android } ya { -brand-name-ios }.
firefox-channel-see-something-that-isnt-working = ¿Ves daqué que nun funciona? Fáinoslo saber.
firefox-channel-file-a-bug-now = Informa agora d'un fallu
firefox-channel-tips-for-filing-a-bug = Conseyos pa informar fallos
firefox-channel-try-new-features-in-a-pre = Prueba les carauterístiques nueves na versión de pre-llanzamientu del restolador p'{ -brand-name-android } | { -brand-name-firefox }
firefox-channel-download-and-test-future = Baxa y prueba los llanzamientos futuros de { -brand-name-firefox } pa escritoriu, { -brand-name-android } ya { -brand-name-ios }.
firefox-channel-experience-cutting-edge-android-updated = Esperimenta les carauterístiques más nueves nuna versión pre-llanzamientu del restolador p'{ -brand-name-android }: { -brand-name-firefox-beta } y { -brand-name-firefox-nightly }. ¡Instálalos agora!
firefox-channel-experience-cutting-edge-android = Esperimenta les carauterístiques más nueves nuna versión pre-llanzamientu del restolador p'{ -brand-name-android }: { -brand-name-firefox-beta }, { -brand-name-firefox-aurora } y { -brand-name-firefox-nightly }. ¡Instálalos agora!
firefox-channel-download-and-test-the-latest-android = Baxa y prueba lo cabero de { -brand-name-firefox } p'{ -brand-name-android } coles versiones { -brand-name-aurora }, { -brand-name-beta } y { -brand-name-nightly }.
firefox-channel-try-the-latest-android-features = Prueba les caberes carauterístiques p'{ -brand-name-android } enantes de llanzales al restu'l mundu.
...
firefox-channel-test-beta-versions-of-firefox-ios = Prueba les versiones beta pa { -brand-name-ios } pente'l programa { -brand-name-test-flight } d'{ -brand-name-apple }.
