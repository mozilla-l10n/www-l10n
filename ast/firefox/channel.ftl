...
firefox-channel-be-among-the-first-to-explore = Sé de los primeros n'esplorar les versiones futures de { -brand-name-firefox } pa escritoriu, { -brand-name-android } ya { -brand-name-ios }.
