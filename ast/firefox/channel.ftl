...
firefox-channel-be-among-the-first-to-explore = Sé de los primeros n'esplorar los llanzamientos futuros de { -brand-name-firefox } pa escritoriu, { -brand-name-android } ya { -brand-name-ios }.
...
firefox-channel-try-new-features-in-a-pre = Prueba les carauterístiques nueves na versión de prellanzamientu del restolador p'{ -brand-name-android } | { -brand-name-firefox }
...
firefox-channel-experience-cutting-edge-android-updated = Esperimenta les carauterístiques más nueves nuna versión prellanzamientu del restolador p'{ -brand-name-android }: { -brand-name-firefox-beta } y { -brand-name-firefox-nightly }. ¡Instálalos agora!
...
firefox-channel-experience-cutting-edge-features-ios = Esperimenta les carauterístiques más nueves nuna versión prellanzamientu del restolador pa { -brand-name-ios } pel programa { -brand-name-test-flight } d'{ -brand-name-apple }. ¡Instalálu agora!
firefox-channel-test-beta-versions-of-firefox-ios-long = Prueba les versiones beta de { -brand-name-firefox } pa { -brand-name-ios } pel programa { -brand-name-test-flight } d'{ -brand-name-apple } y ayudanos a facer que'l nuesu restolador pa { -brand-name-iphone }, { -brand-name-ipad } y iPod touch seya tovía meyor.
