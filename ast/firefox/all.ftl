...
firefox-all-everyone-deserves-access = Tol mundu merez acceder a internet y la to llingua enxamás ha ser una torga. Poro, per duana de collaboradores dedicaos, facemos que'l { -brand-name-firefox-browser } tea disponible en más de 90 llingües.
