...
firefox-privacy-privacy = Privacidá
# Sub navigation link
firefox-privacy-our-promise = La nuesa promesa
# Sub navigation link
firefox-privacy-our-products = Los nuesos productos
...
firefox-privacy-hub-the-passwords-and-credentials = Los anicios de sesión que guardes en { -brand-name-firefox-lockwise } cífrense en tolos preseos, tan cifraos que nun podemos velos.
firefox-privacy-hub-firefox-send = { -brand-name-firefox-send }
firefox-privacy-hub-pocket = { -brand-name-pocket }
firefox-privacy-hub-pocket-recommends-high = { -brand-name-pocket } aconseya artículos esbillaos y calidables ensin recoyer el to historial de restolar o compartir información personal colos anunciantes.
