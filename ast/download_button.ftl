download-button-download-now = Baxar agora
download-button-free-download = Baxar de baldre
...
download-button-supported-devices = Preseos sofitaos
download-button-whats-new = Novedaes
download-button-systems-languages = Sistemes y llingües
...
download-button-firefox-other-platforms = { -brand-name-firefox } pa otres plataformes y llingües
download-button-update-your-firefox = Anueva { -brand-name-firefox }
download-button-get-firefox-android = Baxar { -brand-name-firefox } p'{ -brand-name-android }
download-button-get-firefox-ios = Baxar { -brand-name-firefox } pa { -brand-name-ios }
download-button-google-play = Báxalu na { -brand-name-google-play }
download-button-free-google-play = Báxalu de baldre en { -brand-name-google-play }
