...
footer-browser-comparison = Comparanza de restoladores
footer-brand-standards = La marca
footer-browsers = Restoladores
# Outdated string
footer-desktop = Escritoriu
# Outdated string
footer-mobile = Móvil
# Outdated string
...
# Outdated string
footer-join = Participación
# Outdated string
footer-sign-up = Rexistrase
# Outdated string
footer-sign-in = Aniciar sesión
# Outdated string
footer-benefits = Beneficios
footer-developers = Desendolcadores
...
footer-press-center = Centru de prensa
footer-careers = Trabayu
# Outdated string
footer-test-new-features = Probar novedaes
# Outdated string
footer-mdn-web-docs = { -brand-name-mdn-web-docs }
footer-tools = Ferramientes
footer-resources = Recursos
footer-contact = Contautu
footer-product-help = Ayuda colos productos
