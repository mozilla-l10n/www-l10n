...
switch-firefox-makes-switching-fast-email = { -brand-name-firefox } membuat beralih dari { -brand-name-chrome } benar-benar cepat. Saya sangat menyukainya, dan Anda harus mencobanya.
switch-still-not-convinced = Masih belum yakin beralih ke { -brand-name-firefox } itu mudah?
