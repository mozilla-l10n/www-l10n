...
firefox-home-firefox-protect-your = { -brand-name-firefox } - Lindungi kehidupan daring Anda dengan produk yang mengutamakan privasi
firefox-home-firefox-is-more-than = { -brand-name-firefox } bukan sekadar peramban. Pelajari lebih lanjut tentang produk { -brand-name-firefox } yang menangani data Anda secara terhormat dan dibangun dengan prinsip privasi di mana saja Anda daring.
firefox-home-the-browser-is-just = Peramban hanyalah permulaan
firefox-home-meet-our-family-of = Temui keluarga produk kami
...
firefox-home-learn-more-about-lockwise = Pelajari lebih lanjut tentang { -brand-name-lockwise }
...
firefox-home-share-large-files-without = Bagikan berkas raksasa tanpa khawatir dimata-matai
firefox-home-start-sending-files = Mulai mengirim berkas dengan aman
firefox-home-trade-clickbait-for = Dapatkan kualitas, bukan umpan klik
...
firefox-home-get-the-facebook-container = Dapatkan Ekstensi Kontainer Facebook
firefox-home-download-the-browser = Unduh peramban
firefox-home-download-the-app = Unduh app
