...
firefox-enterprise-get-the-firefox-extended-support = Dapatkan peramban <a href="{ $url }"> { -brand-name-firefox-extended-support-release } atau Rapid Release </a> untuk keamanan data yang komprehensif dan perlindungan data.
firefox-enterprise-unmatched-data-protection = Perlindungan data yang tak tertandingi - pada irama rilis yang cocok untuk Anda
# "Enhanced Tracking Protection" is a feature name; it should be capitalized
firefox-enterprise-the-firefox-browser-is-open = Peramban { -brand-name-firefox } adalah kodesumber terbuka dan menyediakan Pengamanan Pelacakan Yang telah ditingkatkan - semua bagian dari komitmen kami yang lama terhadap perlindungan data.
firefox-enterprise-your-data-stays-your-business = Data Anda tetap bisnis Anda
firefox-enterprise-deploy-when-and-how-you-want = Sebarkan kapan dan bagaimana Anda inginkan
...
firefox-enterprise-legacy-browser-support = Dukungan browser lawas
firefox-enterprise-admx-templates = Template ADMX
firefox-enterprise-deployment-guide = Panduan instalasi
...
firefox-enterprise-download-firefox-esr-or-rapid = Unduh { -brand-name-firefox-esr } atau Rilis cepat untuk <br> <a href="{ $firefox_all }"> bahasa atau platform lain. </a>
