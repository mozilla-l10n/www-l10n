...
firefox-accounts-send-a-tab = <a href="{ $send }">Kirim tab</a> ke perangkat lain
...
firefox-accounts-protect-your-identity = Lindungi identitas Anda dengan penyamaran ponsel dan surel yang aman
