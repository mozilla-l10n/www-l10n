...
# Variables:
#   $fbcontainer (url) - link to https://addons.mozilla.org/firefox/addon/facebook-container/
facebook-container-installing-the-extension-is = Memasang <a href="{ $fbcontainer }">ekstensi</a> sangatlah mudah dan, sekali diaktifkan, akan membuka { -brand-name-facebook } di tab berwarna biru setiap kali Anda menggunakannya. Gunakan dan nikmati { -brand-name-facebook } secara normal. { -brand-name-facebook } masih dapat mengirimkan Anda iklan dan rekomendasi pada situs mereka, namun akan semakin sulit bagi { -brand-name-facebook } untuk menggunakan aktivitas Anda <strong>di luar { -brand-name-facebook }</strong> untuk mengirimkan Anda iklan atau pesan khusus lainnya.
facebook-container-about-firefox-and-mozilla = Tentang { -brand-name-firefox } dan { -brand-name-mozilla }
# Variables:
#   $mozilla (url) - link to https://www.mozilla.org/
facebook-container-were-backed-by-mozilla-the = Kami didukung oleh <a href="{ $mozilla }">{ -brand-name-mozilla }</a>, organisasi nirlaba yang mengutamakan masyarakat daripada laba usaha guna memberdayakan setiap orang daring. Kami menciptakan ekstensi ini karena kami percaya bahwa Anda semestinya memiliki alat yang mudah digunakan dalam membantu mengelola privasi dan keamanan Anda.
facebook-container-browse-freely-with-firefox = Leluasa menjelajah dengan { -brand-name-firefox }, sekarang.
