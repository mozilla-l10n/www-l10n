...
features-adblocker-how-to-stop-seeing-too = Cara berhenti melihat terlalu banyak iklan dan mencegah perusahaan mengikuti Anda saat daring. Panduan pemblokir iklan dari peramban web { -brand-name-firefox }.
features-adblocker-the-ad-blocker-a-secret = Pemblokir iklan - senjata rahasia melawan iklan yang mengganggu.
features-adblocker-so-many-ads-so-little = Iklan berlebihan, menguji kesabaran… Saatnya menghentikan kegilaan.
...
features-adblocker-to-start-click-on-the = Untuk memulai, klik menu { -brand-name-firefox } di sudut kanan atas layar Anda. Tampak di sana tiga garis yang bertumpuk. Di menu tarik-turun, klik Pemblokiran Konten. Anda akan melihat munculan biru dengan pilihan berbeda.
...
features-adblocker-the-custom-setting-gives = Pengaturan Custom memberi Anda pilihan terbaik. Anda dapat memutuskan apa yang Anda blokir, termasuk pelacak, cookie, dan lainnya. Jika Anda mengizinkan kuki dari situs web, Anda akan secara otomatis berada dalam mode Custom.
features-adblocker-cover-your-trail-block = Tutupi jejakmu, blokir pelacak
...
features-adblocker-take-control-of-your-browser = Ambil kendali peramban Anda.
