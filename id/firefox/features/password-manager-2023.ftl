...
password-manager-with-a-free-firefox-account = Dengan <a href="{ $fxa }">{ -brand-name-firefox-account } gratis</a>, Anda dapat menyinkronkan kata sandi dengan aman di semua perangkat.
