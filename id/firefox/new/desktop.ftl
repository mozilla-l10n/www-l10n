...
firefox-desktop-download-meta-desc = Dapatkan { -brand-name-firefox }, sebuah peramban web gratis yang didukung oleh { -brand-name-mozilla }, sebuah lembaga nirlaba yang didedikasikan untuk kesehatan dan privasi internet. Sekarang tersedia untuk { -brand-name-windows }, { -brand-name-mac-short }, { -brand-name-linux }, { -brand-name-android } dan { -brand-name-ios }.
...
firefox-desktop-download-available-in-over = Tersedia dalam lebih dari 90 bahasa, dan kompatibel dengan mesin { -brand-name-windows }, { -brand-name-mac-short } dan { -brand-name-linux }, { -brand-name-firefox } selalu berfungsi tak peduli apa yang Anda gunakan atau di manapun Anda berada. Pastikan sistem operasi Anda sudah diperbarui untuk pengalaman yang terbaik.
