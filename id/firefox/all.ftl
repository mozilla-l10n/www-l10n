...
firefox-all-check-the-system-requirements = Periksa persyaratan sistem
firefox-all-release-notes = Catatan rilis
firefox-all-source-code = Kode sumber
firefox-all-need-help = Butuh bantuan?
firefox-all-which-browser-would = Peramban mana yang ingin Anda unduh?
# Used as an accessible label for a help button. The text is replaced with a "?" icon.
firefox-all-get-help = Dapatkan bantuan
firefox-all-you-are-about-to-download = Anda akan mengunduh:
...
firefox-all-download-product-for = Unduh { $product_label } untuk { $platform } dalam { $locale }
firefox-all-msi-installers = Penginstal MSI
firefox-all-which-version = Versi mana yang Anda inginkan?
firefox-all-select-your-preferred-installer = Pilih penginstal yang Anda inginkan
firefox-all-select-your-preferred-language = Pilih bahasa yang Anda inginkan
