...
highlighted-features-section-bottom-cta = Mari Mulai
...
highlighted-features-section-unlimited-masks-body-v2 =
    { $mask_limit ->
       *[other] Semua orang mendapatkan { $mask_limit } topeng surel gratis. Namun dengan { -brand-name-relay-premium }, Anda dapat membuat topeng sebanyak yang dibutuhkan untuk membantu melindungi kotak masuk surel Anda dari spammer, peretas, dan pelacak daring.
    }

highlighted-features-section-masks-on-the-go-headline = Buat topeng secara instan kapan saja
# Variables:
...
highlighted-features-section-replying-body =
    ...
    ke SMS dari nomor telepon bertopeng Anda untuk melindungi nomor asli Anda.
...
highlighted-features-section-block-promotions-body =
    ...
    kotak masuk sementara masih dapat menerima surel seperti tanda terima atau informasi pengiriman.
