...
# HTML page title
vpn-landing-page-title = { -brand-name-mozilla-vpn }: Lindungi Seluruh Perangkat Anda

# HTML page description
# Variables:
#   $countries (number) - number of available countries
vpn-landing-page-desc = Gunakan { -brand-name-mozilla-vpn } untuk perlindungan perangkat sepenuhnya untuk semua aplikasi. Dengan server di { $countries }+ negara, Anda dapat terhubung ke mana saja, dari mana saja.
...
vpn-landing-brand-trust-desc = Selama lebih dari 20 tahun, { -brand-name-mozilla } memiliki rekam jejak dalam mengutamakan pengguna dan memperjuangkan privasi online. Didukung oleh organisasi nirlaba, kami berkomitmen membangun internet yang lebih baik dan lebih sehat bagi semua orang. Semua yang kami lakukan adalah bagian dari misi dengan mengikuti <a href="{ $url }">prinsip</a> kami.

## FAQ section

vpn-landing-faq-heading = Pertanyaan Umum
...
vpn-landing-faq-uses-examples = Simak <a href="{ $url }">lima contoh nyata</a> saat Anda menginginkan VPN terpasang di perangkat Anda.

vpn-landing-faq-info-question-heading = Informasi apa yang disimpan { -brand-name-mozilla-vpn }?
...
#   $attrs (string) - specific attributes added to external links
vpn-landing-faq-protected-question-desc = Protokol <a href="{ $url }" { $attrs }>{ -brand-name-wireguard }</a>® mengenkripsi traffic jaringan Anda, melindungi semua informasi pribadi Anda. Dibandingkan dengan protokol VPN yang sudah ada, kode { -brand-name-wireguard } yang ringan lebih mudah ditinjau dan diaudit oleh analis keamanan — sehingga menjadi opsi yang lebih aman untuk VPN. Selain itu, aktivitas daring Anda tetap anonim karena kami tidak pernah mencatat, melacak, atau membagikan data jaringan Anda.

vpn-landing-faq-competition-question-heading = Bagaimana { -brand-name-mozilla-vpn } dibandingkan dengan produk lain?
...
# Variables:
#   $url (url) - link to https://www.mozilla.org/products/vpn/desktop/linux/
vpn-landing-faq-compatibility-question-desc-linux-v2 = <a href="{ $url }">{ -brand-name-linux }</a> ({ -brand-name-ubuntu } saja)

# Outdated string
vpn-landing-faq-compatibility-question-desc-linux = { -brand-name-linux } ({ -brand-name-ubuntu } saja)
...
vpn-landing-faq-manage-subscription-question-desc = Jika Anda sudah berlangganan { -brand-name-mozilla-vpn }, Anda dapat mengubah paket atau <a href="{ $url }">mengelola langganan Anda</a> kapan saja.

vpn-landing-faq-download-heading = Bagaimana cara mengunduh { -brand-name-mozilla-vpn } jika saya sudah berlangganan?

# Variables:
#   $attrs (string) - link href and additional HTML attributes
vpn-landing-faq-download-desc = Kunjungi <a { $attrs }>laman unduhan</a> untuk menginstal { -brand-name-mozilla-vpn } di perangkat, lalu masuk menggunakan { -brand-name-firefox-account } Anda.
...
vpn-landing-invite-thanks-heading = Terima kasih! Anda sudah terdaftar
vpn-landing-invite-thanks-desc = Begitu { -brand-name-mozilla-vpn } tersedia untuk wilayah Anda, kami akan mengirimkan email kepada Anda.
