...
vpn-mobile-get-a-vpn = Dapatkan VPN untuk Seluler dari { -brand-name-mozilla }
vpn-mobile-looking-for-a = Perlu VPN untuk melindungi perangkat seluler Anda? { -brand-name-mozilla-vpn } didukung oleh perusahaan nirlaba. Pelajari bagaimana VPN melindungi Anda dan mengapa Anda harus memercayakan privasi dan keamanan kepada { -brand-name-mozilla }.
vpn-mobile-vpn-for-mobile = VPN untuk Seluler dari { -brand-name-mozilla }
