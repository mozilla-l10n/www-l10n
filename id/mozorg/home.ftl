...
home-read-our-internet-health-report = Bacalah Laporan Kesehatan Internet kami
home-our-innovations = Inovasi kami
home-using-the-web-as-the-platform = Menggunakan web sebagai platform, kami membangun teknologi terbuka dan inovatif yang memungkinkan pengembang untuk bekerja dengan bebas dari ekosistem korporasi tertutup dan menciptakan pengalaman web yang lebih cepat dan aman bagi kita semua.
home-virtual-reality-platform = Platform Realitas Virtual (VR)
home-common-voice = { -brand-name-common-voice }
home-extensions = Ekstensi
home-personalize-firefox-with-your = Personalisasikan { -brand-name-firefox } dengan tambahan favorit Anda seperti pengelola sandi, pemblokir iklan, dan banyak lagi.
home-careers = Karier
home-learn-about-the-benefits-of = Pelajari selengkapnya tentang manfaat bekerja di { -brand-name-mozilla } dan lihat lowongan yang ada di seluruh penjuru dunia.
home-need-help = Butuh bantuan?
home-get-answers-to-your-questions = Dapatkan jawaban atas pertanyaan Anda tentang { -brand-name-firefox } dan semua produk { -brand-name-mozilla } dari tim dukungan kami.
