...
about-mozilla-makes-browsers-apps-desc = { -brand-name-mozilla } membuat peramban, aplikasi, kode dan alat yang mengutamakan masyarakat daripada laba. Misi kami: Menjaga internet tetap terbuka dan dapat diakses semua.
# Main heading
...
about-mozilla-puts-people-over-profit = { -brand-name-mozilla } mengutamakan masyarakat daripada laba di dalam setiap apapun yang kami ucap, bangun dan lakukan. Bahkan, ada Yayasan nirlaba di jantung perusahaan kami.
about-the-mozilla-manifesto = Manifesto { -brand-name-mozilla }
about-the-principles-we-wrote-in = Prinsip-prinsip yang kami tulis pada tahun 1998 masih memandu kami hari ini. Dan pada tahun 2018, kami membuat sebuah tambahan untuk menekankan inklusi, privasi, dan keamanan untuk semua orang daring.
...
about-taipei = Taipei
# The number inside the strong tag will be big, bold, and on its own line. Remove the strong tag if you need to put the number in the middle of the phrase.
about-400-collaborative-visits-with = <strong>400</strong> kunjungan kolaboratif dengan karyawan { -brand-name-mozilla } setiap tahun.
...
about-mozilla-careers = Karier { -brand-name-mozilla }
...
about-stay-informed-about-the-issues = Tetap terinformasi tentang masalah yang mempengaruhi internet, dan pelajari bagaimana Anda bisa terlibat dalam melindungi sumber daya publik terbaru di dunia.
about-subscribe = Berlangganan
