...
download-button-get-firefox-android = { -brand-name-firefox } deļ { -brand-name-android }
download-button-get-firefox-ios = { -brand-name-firefox } deļ { -brand-name-ios }
download-button-google-play = Nūlōdej nu { -brand-name-google-play }
download-button-free-google-play = Bez moksys { -brand-name-google-play }
download-button-app-store = Bez moksys { -brand-name-app-store }
download-button-download-app-store = Nūlōdej nu { -brand-name-app-store }
download-button-download-firefox = Nūlōdēt { -brand-name-firefox }
download-button-your-system-may = Tova sistema var nabyut sadereiga ar { -brand-name-firefox } praseibom, bet tu vari paraudzēt kaidu nu itōm versejom:
download-button-firefox-beta-android = <span>{ -brand-name-firefox-beta }</span> deļ { -brand-name-android }
download-button-firefox-aurora-android = <span>{ -brand-name-firefox-aurora }</span> deļ { -brand-name-android }
download-button-firefox-nightly-android = <span>{ -brand-name-firefox-nightly }</span> deļ { -brand-name-android }
