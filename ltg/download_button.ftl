...
download-button-get-firefox-android = Nūlōdej deļ { -brand-name-android }
download-button-get-firefox-ios = Nūlōdej deļ { -brand-name-ios }
...
download-button-firefox-aurora-android = <span>Firefox Beta</span> deļ { -brand-name-android }
