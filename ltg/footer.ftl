...
footer-desktop = Dators
footer-mobile = Mobilais formats
...
footer-about = Par
footer-press-center = Preses centrs
footer-mdn-web-docs = { -brand-name-mdn-web-docs }
footer-websites-cookies = Seikdatnes
footer-websites-legal = Juridiska informaceja
footer-language = Volūda
