...
navigation-v2-get-the-not-for-profit-backed = Get the not-for-profit-backed browser on { -brand-name-windows }와 { -brand-name-mac-short }, { -brand-name-linux }에서 비영리 지원 브라우저를 받으세요.
