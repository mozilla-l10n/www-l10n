...
navigation-v2-close-firefox-browsers-menu = { -brand-name-firefox-browsers } 메뉴 닫기
navigation-v2-firefox-for-desktop = 데스크톱 용 { -brand-name-firefox }
navigation-v2-get-the-not-for-profit-backed = { -brand-name-windows }와 { -brand-name-mac-short }, { -brand-name-linux }에서 비영리 지원 브라우저를 받으세요.
navigation-v2-firefox-for-android = { -brand-name-android } 용 { -brand-name-firefox }
...
navigation-v2-firefox-for-mobile = 모바일용 { -brand-name-firefox-browser }
navigation-v2-take-speed-privacy-and = 속도, 개인정보 보호, 그리고 마음의 평화를 가져보세요. { -brand-name-android }와 { -brand-name-ios }에서 이용할 수 있습니다.
...
navigation-v2-get-the-details-on-the = 최신 { -brand-name-firefox } 업데이트에 대한 세부 정보를 확인하세요.
navigation-v2-view-all-firefox-browsers = { -brand-name-firefox-browsers } 모두보기
...
navigation-v2-learn-about-the-values = 우리의 미션을 이끄는 가치와 원칙에 대해 알아보세요.
navigation-v2-mozilla-foundation = { -brand-name-mozilla-foundation }
navigation-v2-meet-the-not-for-profit-behind = 더 나은 웹을 대표하는 { -brand-name-firefox } 뒤에 있는 비영리 단체를 만나보세요.
