...
manifesto-visualize-who-you-interact = Lightbeam으로 웹 활동에 대해 시각화하기
...
manifesto-details-articulate-a-vision = { -brand-name-mozilla } 참여자가 { -brand-name-mozilla } Foundation에 원하는 인터넷에 대한 미래 비전을 명기한다.
