...
manifesto-details-the-mozilla-project-global-v2 = { -brand-name-mozilla } 프로젝트는 공유와 혁신 그리고 기회가 인터넷을 풍요롭게 만드는데 중요한 열쇠가 된다고 믿는 사람들의 세계적 커뮤니티입니다. 우리는 1998년 이후로 인터넷이 모든 사람에게 이익이 되는 방법으로 발전할 수 있도록 함께 노력해 왔습니다. 우리는 { -brand-name-mozilla } { -brand-name-firefox }라는 유명한 웹 브라우저를 만들고 있습니다.
...
manifesto-details-the-mozilla-project-community-v2 = { -brand-name-mozilla } 프로젝트는 세계 최고의 공개 소프트웨어를 만들고 새로운 협업 활동을 만들어 내는 과정에서 커뮤니티 기반 접근 방식을 사용합니다. 우리는 모든 사람의 더 나은 인터넷 사용 경험을 누리게 하기 위해 사람들의 커뮤니티를 만듭니다.
# Obsolete string (expires 2026-09-20)
...
manifesto-written-in-2007 = 2007년에 작성된 { -brand-name-mozilla } 선언문에 핵심 원칙이 설명되어 있습니다. 건강한 인터넷을 위한 약속은 인터넷이 인류와 인류 전체의 요구에 부합하게 하려는 우리의 강한 약속을 반영하기 위해 2017년 선언문의 부록으로 작성되었습니다. 이 두 문서는 함께 { -brand-name-mozilla }의 모든 작업을 안내합니다 — 무엇을 만드는지, 어떤 자금을 모으고 커뮤니티에서 함께 협력하는지에 대해 설명합니다.
manifesto-mozillas-pledge = { -brand-name-mozilla }의 약속
manifesto-across-the-mozilla-project = { -brand-name-mozilla } 프로젝트와 { -brand-name-mozilla } 제품군의 모든 조직에 걸쳐 우리는 { -brand-name-mozilla } 선언문 활동을 지원할 것을 약속합니다. 구체적으로, 우리는:
manifesto-we-need-you = 선언문 진행을 위해 여러분의 도움이 필요합니다
manifesto-an-internet-with-these-v2 = 우리가 원하는 품질의 인터넷은 자연적으로 만들어 지지 않습니다. 개인과 기업은 인터넷 기술과 인터넷을 통한 인간의 경험에 이러한 포부를 내포해야합니다. { -brand-name-mozilla } 선언문({ -brand-name-mozilla } Manifesto)과 부록(Addendum)은 이러한 포부를 발전시키기위한 { -brand-name-mozilla }의 노력을 나타냅니다. 우리는 인터넷을 모든 사람에게 더 좋은 곳으로 만들기 위해 사명을 함께 공유하는 사람 및 커뮤니티, 기업과 모든 영역에서 함께 일하는 것을 목표로합니다.
manifesto-our-commitments = 우리의 약속
manifesto-commitment-1 = 약속 1
manifesto-commitment-2 = 약속 2
manifesto-commitment-3 = 약속 3
manifesto-commitment-4 = 약속 4
manifesto-if-you-share-this-goal-v2 = 이 목표에 공감하신다면, 저희가 도울 수 있는 방법을 알려주세요.
# Variables:
#   $github_link (url) - link to https://github.com/mozilla
manifesto-we-create-open = 여러분이 개발할 수 있는 <a { $github_link }>오픈 소스 소프트웨어</a>를 만듭니다.
# Variables:
#   $mofo_link (url) - link to https://www.mozillafoundation.org/
manifesto-we-fund-fellows = 더 나은 온라인 미래를 만들기 위해 <a { $mofo_link }>펠로우십 기금을 마련하고 프로젝트를 육성합니다</a>.
# Variables:
...
manifesto-we-make-firefox-and-thunderbird = 그리고 물론 <a { $firefox_link }>{ -brand-name-firefox }</a>와 <a { $thunderbird_link }>{ -brand-name-thunderbird }</a>도 만들고 있습니다. 이 모든 것이 인터넷을 건강한 공간으로 만드는 데 도움을 주기 위한 것입니다.
...
manifesto-share-on-bluesky = Bluesky에 공유
...
manifesto-i-support-the-vision-of-v2 = 저는 { -brand-name-mozilla }의 건강하고 나은 인터넷에 대한 비전을 지지합니다. 동참하시겠습니까?
