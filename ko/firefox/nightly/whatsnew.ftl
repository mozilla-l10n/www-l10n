...
#   $mastodon (url) - link to https://mozilla.social/@FirefoxNightly
#   $twitter (url) - link to https://twitter.com/FirefoxNightly
nightly-whatsnew-if-you-want-to-v2 = { -brand-name-nightly }와 커뮤니티 주변에서 무슨 일이 일어나고 있는지 알고 싶다면 <a href="{ $blog }">블로그</a>를 읽거나 <a href="{ $mastodon }">Mastodon</a> 또는 <a href="{ $twitter }">Twitter</a>에서 우리를 팔로우하세요!
# Variables:
