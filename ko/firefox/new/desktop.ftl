...
firefox-desktop-download-search-from-address = 주소 표시 줄에서 검색
...
firefox-desktop-download-built-in-screenshot = 내장 스크린 샷 도구
...
firefox-desktop-download-form-autofill = 양식 자동 완성
