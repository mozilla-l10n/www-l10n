...
firefox-browsers-mobile = 모바일
firefox-browsers-take-the-same-level-of-privacy = 높은 수준의 개인 정보 보호 — 어디서나 비밀번호, 검색 기록, 탭  정보 등을  이용할 수 있습니다.
firefox-browsers-download-for-mobile = 모바일용 다운로드
firefox-browsers-send-me-a-link = 나에게 링크 보내기
...
firefox-browsers-go-beyond-two-dimensions-and = 2차원을 넘어 웹에서 가장 몰입 할 수 있는 가상 콘텐츠를 즐기십시오.
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words, please omit the strong tags if they need to be around multiple words in your language
