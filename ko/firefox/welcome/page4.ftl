...
welcome-page4-privacy-every-screen = 모든 기기에서 개인 정보 보호
welcome-page4-take-privacy-with-you-on-every = 모든 기기에서 개인 정보를 보호하세요 — 데이터 추적에서 벗어나세요.
welcome-page4-on-the-move-at-home = 이동 중이든 집이든 어디서나 여러분의 개인 정보를 보호하세요.
welcome-page4-get-the-firefox-app = 지금 { -brand-name-firefox } 모바일 앱 설치
...
welcome-page4-go-faster-do-more = 더 빠르게. 더 많이.
welcome-page4-take-it-all-with-you = 어디서나 접속하세요
welcome-page4-more-done-fast-smart = 빠른 페이지 로딩 및 스마트 검색 제안으로 하루 동안 더 많은 작업을 수행 할 수 있습니다.
