...
welcome-page3-no-account-required-but-you = 계정이 필요하지 않습니다. 하지만 원하게 될 것입니다.
...
welcome-page3-have-at-least-one-company = 최소한 하나의 회사가 데이터를 유출하는 대신 데이터를 찾아 보도록하세요.
welcome-page3-firefox-lockwise = { -brand-name-firefox-lockwise }
welcome-page3-never-forget-reset-or-travel = 더이상 비밀번호를 잊어버리거나, 재설정하거나, 헤매지 마세요.
welcome-page3-facebook-container = { -brand-name-facebook-container }
welcome-page3-get-a-container-to-keep-facebook = { -brand-name-facebook }이 사생활을 침범하지 않도록 컨테이너를 사용하세요.
welcome-page3-pocket = { -brand-name-pocket }
welcome-page3-trade-clickbait-and-fake-news = 가짜 뉴스를 양질의 컨텐츠로 대체하세요.
welcome-page3-firefox-send = { -brand-name-firefox-send }
welcome-page3-send-huge-files-to-anyone = 보내고자 하는 사람에게 대용량 파일을 보내세요. 링크는 자동으로 없어집니다.
welcome-page3-why-am-i-seeing-this = 왜 이 화면을 보게 되었나요?
