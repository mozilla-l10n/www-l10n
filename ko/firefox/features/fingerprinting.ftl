...
# page title
features-fingerprinting-what-is-fingerprinting-title = 핑거프린팅이란 무엇이며 이를 차단해야 하는 이유
# page description
...
features-fingerprinting-ditch-the-sticky = { -brand-name-firefox } 브라우저에 내장된 핑거프린트 차단기를 이용하여 여러분을 따라오는 끈질긴 광고를 떼버리세요.
# description for the header image
features-fingerprinting-every-fingerprint = 모든 핑거프린트는 유일합니다.
features-fingerprinting-download-firefox = { -brand-name-firefox } 다운로드
...
features-fingerprinting-protect = 개인 정보 보호
