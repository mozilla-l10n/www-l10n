...
switch-spread-the-word = 여러분 주변의 { -brand-name-chrome } 사용자에게 { -brand-name-firefox }의 좋은 점을 전해주세요.
switch-share-with-your-friends = 여러분의 친구와 { -brand-name-firefox }로 전환하는 방법을 공유하세요
switch-firefox-makes-switching-fast-tweet = 🔥 { -brand-name-chrome }에서 { -brand-name-firefox }로 아주 빠르게 전환할 수 있습니다. 한 번 해보세요!
switch-switch-to-firefox = { -brand-name-firefox }로 전환
switch-firefox-makes-switching-fast-email = { -brand-name-chrome }에서 { -brand-name-firefox }로 아주 빠르게 전환할 수 있습니다. 저는 정말 마음에 듭니다. 여러분도 한 번 해보세요.
switch-still-not-convinced = 아직도 { -brand-name-firefox }로의 전환이 쉽다는 것을 확신하지 못하셨나요?
switch-enjoy-the-web-faster = 빠르게 웹을 즐길 준비가 되었습니다.
