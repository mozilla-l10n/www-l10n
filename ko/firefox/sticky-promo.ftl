...
firefox-sticky-promo-meet-our-family-of = 우리 제품들을 만나보세요.
firefox-sticky-promo-get-the-latest-firefox = 최신 { -brand-name-firefox }를 받으세요.
# Products List
firefox-sticky-promo-browsers = 브라우저
