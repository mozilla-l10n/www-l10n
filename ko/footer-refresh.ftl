...
footer-refresh-follow-firefox = @{ -brand-name-firefox } 팔로우
...
footer-refresh-anonym-privacy-policy = { -brand-name-anonym } 개인 정보 보호 정책
footer-refresh-anonym-terms-and-conditions = { -brand-name-anonym } 이용 약관
