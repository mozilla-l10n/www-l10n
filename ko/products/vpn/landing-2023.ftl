...
# HTML page title
vpn-landing-title = { -brand-name-mozilla-vpn }: 모든 기기 보호
# HTML page description
# Variables:
#   $countries (number) - number of available countries
vpn-landing-desc = 모든 기기와 앱 전체를 보호하려면 { -brand-name-mozilla-vpn }을 사용해 보세요. { $countries }개 이상의 국가에 있는 서버로 어느 곳에서나 모든 곳으로 연결할 수 있습니다.
vpn-landing-powerful-privacy-for-peace = 안심할 수 있는 강력한 개인 정보 보호
vpn-landing-whats-a-vpn = VPN이 무엇인가요?
