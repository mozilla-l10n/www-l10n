...
vpn-what-is-what-is-a-vpn = VPN이란 무엇인가요?
# HTML page description and intro
vpn-what-is-get-answers-to-nine = VPN에 대한 흔한 9가지 질문의 답변을 통해 VPN의 역할과 사용해야 할 상황 및 이유를 알아보세요.
vpn-what-is-many-of-us = 많은 사람이 동영상 시청과 쇼핑, 게임, 청구서 요금 결제, 복잡한 업무 프로젝트 관리, 기밀 영상 통화와 같은 일상적인 작업을 위해 하루 중 몇 시간을 인터넷을 사용하며 보냅니다. <strong>가상 사설망 (VPN)</strong>은 온라인에서 사생활을 보호하고 보안을 유지하며 개인 데이터를 보호하는 가장 좋은 방법입니다.
vpn-what-is-how-do-vpns = VPN은 어떻게 작동하나요?
vpn-what-is-a-vpn-is = VPN은 어디에서나 안전하게 인터넷에 접속할 수 있게 해주는 도구입니다. VPN은 기기와 VPN 제공자 사이에 보안 “터널”을 만들어 작동하며 2가지 주요한 방법으로 사용자를 보호합니다:
vpn-what-is-concealing-your-ip = IP 주소를 숨기고 신원과 위치 정보를 보호합니다.
vpn-what-is-encrypting-your-traffic = 사용자와 VPN 제공자 간의 트래픽을 암호화하여 로컬 네트워크의 누구도 해독하거나 변경할 수 없게 합니다.
vpn-what-is-in-the-past = 과거 VPN은 기업이 내부 서비스와 데이터 자산에 원격으로 안전하게 접속하기 위해 사용되었습니다. 그러나 요즘에는 인터넷 연결을 보호하고 싶은 누구나 VPN을 사용할 수 있고 특히 공공 와이파이 같은 보안에 취약한 네트워크를 통한 연결 뿐만 아니라 홈 네트워크에서도 유용합니다.
vpn-what-is-a-vpn-will = VPN은 브라우저나 앱 또는 기타 서비스를 통해 사용자와 VPN 제공자 사이에 전송하는 트래픽을 보호합니다. VPN을 설정하려면 VPN 제공 업체에 계정을 만들고 컴퓨터나 휴대폰에 VPN 소프트웨어를 설치해야 합니다. 활성화하면 VPN이 기기에서 실행되는 모든 앱과 소프트웨어의 트래픽을 처리하므로 안전한 사설 네트워크 연결을 통해 자유롭게 탐색하고 통신할 수 있습니다.
# Variables
#   $mozvpn (url) - https://www.mozilla.org/products/vpn/
#   $countries (number) - number of countries where Mozilla VPN has servers, e.g. "30"
vpn-what-is-a-vpn-provider = VPN 공급 업체는 일반적으로 전 세계 여러 지역에 많은 연결 게이트웨이를 제공하며 이를 통해 사용자는 다른 지역의 IP 주소를 사용할 수 있습니다. 그렇게 하면 연결하려는 장소에서 실제 IP 주소가 아닌 VPN의 IP를 트래픽 소스로 볼 수 있습니다. <a href="{ $mozvpn }">{ -brand-name-mozilla-vpn }</a>은 보안 서버를 통해 트래픽을 라우팅하고 사용자에게 { $countries }개국 이상의 위치를 선택지할 수 있게 제공됩니다.
vpn-what-is-when-should-i = 언제 VPN을 사용해야 하나요?
...
# Variables
#   $mozvpn (url) - https://www.mozilla.org/products/vpn/
vpn-what-is-vpns-can-be = VPN을 사용하여 컴퓨터와 노트북, 태블릿, 휴대폰 등 모든 기기를 보호할 수 있습니다. 브라우저를 통하지 않고 독립 실행형 앱을 통해 인터넷에 액세스하는 경우 VPN은 모든 기기에서 개인 정보와 보안을 보호하기에 좋은 선택입니다. VPN을 효과적으로 사용하려면 각 기기에 VPN을 설치해야 합니다. <a href="{ $mozvpn }">{ -brand-name-mozilla-vpn }</a>은 모든 앱 또는 브라우저에서 인터넷에 연결할 때 최대 5개의 기기까지 무제한 연결을 제공합니다.
vpn-what-is-mozilla-vpn-fast = { -brand-name-mozilla-vpn }: 빠르고 안전하며 신뢰 가능
# Variables
#   $mozvpn (url) - https://www.mozilla.org/products/vpn/
vpn-what-is-mozilla-vpn-is-a-v3 = <a href="{ $mozvpn }">{ -brand-name-mozilla-vpn }</a>은 모든 기기의 인터넷 연결을 안전하게 보호해 주는 믿을 수 있는 서비스입니다. 사용자의 네트워트 활동을 기록하지 않으며 사용자의 온라인 활동에 대한 프로필을 만드는 제3자와 협력하지 않습니다. 우리는 불가측성이 “뉴 노멀”이 된 세상에서 사용자가 안전하다고 느끼고 사용자의 온라인 활동에 대한 비밀이 보장되는 것이 그 어느 때보다 중요하다는 것을 압니다.
