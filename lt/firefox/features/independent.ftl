...
features-independent-firefox-is-independent = { -brand-name-firefox } naršyklė yra nepriklausoma. Ją vysto pelno nesiekianti { -brand-name-mozilla } bendrija, kovojanti už jūsų privatumą ir teises internete, padedanti sutvardyti korporacijų galias ir prisidedanti prie interneto kaip visiems ir visur prieinamo ištekliaus gyvavimo.
