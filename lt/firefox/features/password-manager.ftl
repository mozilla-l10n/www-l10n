...
password-manager-earn-your-second = Kažko trūksta? Pasitelkite „{ -brand-name-firefox }“ slaptažodžių tvarkytuvės <a href="{ $addons }">priedus</a>. Parsisiųskite savo jau pamėgtą priedą arba atraskite naują, pasitelkdami bendruomenės narių įvertinimus ir apžvalgas.
