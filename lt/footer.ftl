...
footer-press = Spaudai
footer-brand-standards = Prekės ženklo standartai
footer-browsers = Naršyklės
footer-enterprise = { -brand-name-enterprise }
footer-developers = Programuotojams
...
footer-press-center = Spaudos centras
footer-careers = Karjera
footer-tools = Priemonės
footer-resources = Ištekliai
footer-contact = Susisiekite
footer-product-help = Pagalba naudotojams
footer-support = Palaikymas
footer-file-a-bug = Registruoti riktą
footer-community-participation-guidelines = Dalyvavimo bendruomenėje gairės
footer-websites-privacy-notice = Svetainės privatumo pranešimas
footer-websites-cookies = Slapukai
footer-websites-legal = Teisinė informacija
