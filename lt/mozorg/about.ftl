...
# Main heading
about-mozilla-makes-browsers-apps = „{ -brand-name-mozilla }“ kuria naršykles, programas, kodą ir įrankius, žmonių gerovę iškeldama aukščiau pelno.
# Main sub-heading
about-our-mission-keep-the-internet = Mūsų misija – išsaugoti internetą atvirą ir visiems prieinamą.
# Main call to action
about-read-our-mission = Susipažinkite su mūsų misija
about-our-mission-in-action = Mūsų misija veiksmuose
...
about-with-offices-all-over-the = Turėdami <a href="{ $url }">biurus visame pasaulyje</a>, mes internetą galime matyti įvairiausių kultūrų kontekstuose.
about-san-francisco = San Franciskas
# The number inside the strong tag will be big, bold, and on its own line. Remove the strong tag if you need to put the number in the middle of the phrase.
about-2000-non-employee-guests-welcomed = Kasmet apsilanko <strong>2000</strong> svečių, kurie nėra darbuotojai
