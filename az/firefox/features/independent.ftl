...
# HTML page title
features-independent-firefox-a-different = { -brand-name-firefox }, yeni dövr üçün bənzərsiz səyyah. Azad gəzin.
# HTML page description
features-independent-browse-the-internet = İnternetdə lazım olduğu kimi gəzin… azad, təhlükəsiz və hər kəs üçün əlçatan. Onlayn azadlığınızı elan edin.
features-independent-firefox-rebel-with-a = { -brand-name-firefox }: motivasiyalı buntçu
...
features-independent-in-addition-to-fighting = Onlayn hüquqlarınız üçün mübarizə aparmanın yanında, həmçinin korporativ gücləri nəzarət altında tuturuq, müttəfiqlərimizlə dünyanın hər yerində sağlam internet təcrübələrini tədris edirik. Siz { -brand-name-firefox }-u seçdiyinizdə biz də sizi seçirik.
# Obsolete string
features-independent-firefox-is-a-browser = { -brand-name-firefox } vicdanlı səyyahdır. Qeyri-kommersial { -brand-name-mozilla }nın texnologiyalarının bir hissəsi olaraq onlayn hüquqlarınızın müdafiəsi üçün mübarizə aparırıq, korporativ gücləri nəzarətdə tuturuq və inkişafda olan ölkələrdə sağlam internet təcrübələrini tədris edirik. Siz { -brand-name-firefox }-u seçdiyinizdə biz də sizi seçirik.
