...
# HTML page title
vpn-landing-title = { -brand-name-mozilla-vpn }: pruteggi u to dispusitivu
# HTML page description
# Variables:
#   $countries (number) - number of available countries
vpn-landing-desc = Usa { -brand-name-mozilla-vpn } p'aviri na prutizzioni cumpleta pi tutti i to applicazzioni. Grazzi ê sirbura nna cchiù assai di { $countries } pajisi, ti po' cullijari unni vo', di unn'è-è.
vpn-landing-whats-a-vpn = Chi è na VPN?
vpn-landing-a-virtual-private-network-protects = Na riti privata virtuali pruteggi u to cullijamentu â riti, ammucciannu a to pusizzioni e i to attività 'n riti nna tutti i to dispusitivi.
vpn-landing-see-all-the-ways-mozilla-vpn = Vidi tutti i maneri comu { -brand-name-mozilla-vpn } ti pruteggi.
vpn-landing-how-a-vpn-helps-you = Comu t'ajuta na VPN
...
vpn-landing-learn-more-from-our-experts = Cchiù nfurmazzioni dî nostri sperti
