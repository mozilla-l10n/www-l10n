...
choose-which-firefox = Odaberi koji { -brand-name-firefox-browser } želite preuzeti na tvom jeziku
...
firefox-fights-for = { -brand-name-firefox } se bori za tebe na { -brand-name-windows }
...
firefox-respects-your = { -brand-name-firefox } poštuje tvoju privatnost na { -brand-name-mac-short }.
