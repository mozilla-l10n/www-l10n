...
# Obsolete string (expires: 2025-02-17)
features-translate-the-firefox-translations-feature = Funkcija „{ -brand-name-firefox } prijevodi” je još jedan način na koji { -brand-name-mozilla } održava tvoj internet personaliziranim i privatnijim. { -brand-name-mozilla } ne prati koje web stranice prevodiš. S milijunima korisnika diljem svijeta, { -brand-name-mozilla } želi osigurati da oni koji koriste { -brand-name-firefox } uče, komuniciraju, dijele i ostaju informirani prema vlastitim uvjetima. <a { $download }>Preuzmi { -brand-name-firefox } na željenom jeziku.</a>
