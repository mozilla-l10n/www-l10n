...
page7-if-you-still-kinda-like-facebook = Ukoliko ti se { -brand-name-facebook } još uvijek pomalo sviđa, ali mu baš i ne vjeruješ, isprobaj { -brand-name-firefox }ov dodatak { -brand-name-facebook-container } koji im otežava da te prate diljem weba.
...
page7-do-it-for-the-gram = Učini to i za Instagram
