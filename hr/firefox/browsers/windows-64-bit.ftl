...
windows-64-bit-if-youre-running = Ako imaš 64-bitni { -brand-name-windows } (<a href="{ $version }">evo kako provjeriti</a>), tvoj { -brand-name-firefox } možda već je 64-bitni. <a href="{ $check }">Provjeri svoju verziju { -brand-name-firefox }a</a> (u prozoru „O { -brand-name-firefox }u”) i potražite „(32-bitna)” ili „(64-bitnu)” nakon broja verzije:
...
windows-64-bit-if-you-see-32-bit-newer = Ako vidite „(32-bitna)” i ako koristite { -brand-name-firefox } 56.0.1 ili noviju verziju, tvoje računalo možda ne zadovoljava minimalnim potrebama 64-bitne verzije (3 GB RAM-a ili više). I dalje možeš ručno instalirati 64-bitni { -brand-name-firefox }, ako želiš.
# Variables:
