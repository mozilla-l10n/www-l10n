...
windows-64-bit-if-you-see-32-bit-newer = Ako vidiš „(32-bitna)” i ako koristiš { -brand-name-firefox } 56.0.1 ili noviju verziju, tvoje računalo možda ne zadovoljava minimalnim potrebama 64-bitne verzije (3 GB RAM-a ili više). Ako želiš, i dalje možeš ručno instalirati 64-bitni { -brand-name-firefox }.
# Variables:
