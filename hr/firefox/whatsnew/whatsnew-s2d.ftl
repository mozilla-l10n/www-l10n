...
whatsnew-s2d-download-firefox-for-android = Preuzmi { -brand-name-firefox } za { -brand-name-android } i { -brand-name-ios }
whatsnew-s2d-want-privacy-on-every-device = Želiš privatnost na svim uređajima?
