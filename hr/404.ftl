...
not-found-page-donate-to-mozilla-reclaim-from-v2 = <a { $donate }>Doniraj</a> zakladi { -brand-name-mozilla-foundation } i oduzmi velikim tehnološkim poduzećima kontrolu nad internetom.
