...
manifesto-share-on-x = Dijeli na platformi X
manifesto-share-on-x-aria-label = Dijeli na platformi X (bivši Twitter)
...
manifesto-details-use-the-mozilla = koristiti { -brand-name-mozilla } resurse (intelektualno vlasništvo kao što su autorska prava i zaštićeni trgovački znakovi, infrastrukturu, financijske resurse i ugled) kako bi Internet ostao otvorena platforma;
