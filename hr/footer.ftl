...
footer-visit-mozilla-corporations = Posjeti zakladu <a { $mofo_link }>{ -brand-name-mozilla-foundation }</a>, neprofitnu matičnu organizaciju korporacije <a { $moco_link }>{ -brand-name-mozilla-corporation }</a>
...
footer-localize-mozilla = Prevedi { -brand-name-mozilla }
