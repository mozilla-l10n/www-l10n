...
fxa-form-enter-your-email = Za pristup { -brand-name-firefox-accounts } računima <strong>upiši svoju e-adresu</strong>.
# Variables:
...
fxa-form-email-address = Adresa e-pošte
fxa-form-continue = Nastavi
fxa-form-create-account = Izradi račun
