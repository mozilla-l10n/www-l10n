...
newsletter-form-we-will-only-send = Poslat ćemo ti samo informacije u vezi s { -brand-name-mozilla }.
newsletter-form-we-will-only-send-firefox = Poslat ćemo ti samo informacije u vezi s { -brand-name-firefox }.
...
newsletter-form-keep-up-with = Budite u toku sa<br> svim { -brand-name-firefox } temama.
