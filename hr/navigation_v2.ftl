...
navigation-v2-view-all-firefox-browsers = Svi { -brand-name-firefox-browsers }
...
navigation-v2-save-and-discover-the-best = Spremi i otkrij najbolje priče iz cijelog weba.
navigation-v2-facebook-container = { -brand-name-facebook-container }
navigation-v2-help-prevent-facebook-from = Pomogni spriječiti da { -brand-name-facebook } prikuplja tvoje podatke izvan njihove web stranice.
...
navigation-v2-use-ai-to-detect = Koristi UI za otkrivanje lažnih recenzija i prijevara
