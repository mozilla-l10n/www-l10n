...
banner-firefox-daylight-launch-title = Predstavljamo naše najnovije izdanje aplikacije { -brand-name-firefox } za { -brand-name-android } – { -brand-name-firefox-daylight }
...
banner-firefox-daylight-launch-button = Preuzmi sada
