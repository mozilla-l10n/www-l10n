...
# Variables:
#   $countries (number) - number of available countries
vpn-linux-servers-copy = { -brand-name-mozilla-vpn } te da la capacidad de establecer la ubicación de tu computador basado en { -brand-name-linux } en uno de los más de { $country } países, abriéndote a emocionantes contenidos nuevos de todo el mundo.
# Variables:
