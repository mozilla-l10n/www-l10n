...
vpn-mobile-get-a-vpn = Obtèn un VPN para móviles de { -brand-name-mozilla }
vpn-mobile-looking-for-a = ¿Buscas un VPN para proteger tu dispositivo móvil? { -brand-name-mozilla-vpn } está respaldado por una empresa sin fines de lucro. Obtén información sobre cómo te protege un VPN y por qué deberías confiar en { -brand-name-mozilla } para tu privacidad y seguridad.
