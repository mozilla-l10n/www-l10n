...
vpn-ip-address-no-your-ip-v2 = No. Tu dirección IP solo está asociada con una ubicación a menos que estés usando un VPN (más adelante nos referiremos a eso). Cuando estás en tu casa y te conectas al Internet por el que pagas, estás usando una. Sin embargo, si revisas tu correo electrónico en casa por la mañana, luego revisas las noticias en una cafetería local mientras esperas tu café, y más tarde trabajas desde una oficina, habrás usado diferentes direcciones IP en cada ubicación.
# Outdated string
...
# Variables
#   $url (url) - https://www.mozilla.org/products/vpn/more/when-to-use-a-vpn/
vpn-ip-address-there-are-also = También existen razones situacionales para ocultar su dirección IP. Es posible que desees ocultarla cuando estés de viaje. Un VPN también te brindará <a href="{ $url }">más privacidad</a> cuando te conecte a WiFi para transmitir y comprar mientras exploras el mundo.
...
vpn-ip-address-a-vpn-is-v2 = Un VPN es una forma de ocultar tu dirección IP. <a href="{ $vpn }">Cuando usas un VPN</a>, tu dirección IP externa provendrá de la IP externa del servidor VPN, en lugar de la dirección IP externa de tu ubicación. Así que si tu servidor VPN de conexión está ubicado en California, tu IP externa dirá que te conectaste desde California, sin importar dónde estés. Además, tu actividad en línea se envía a través de una conexión cifrada y segura a tu servidor VPN, dándote seguridad y privacidad adicionales. <a href="{ $mozvpn }">{ -brand-name-mozilla-vpn }</a> es una forma de ocultar tu dirección IP. No guardamos registros de tu actividad de red, ni nos asociamos con terceros que crean perfiles de lo que haces en línea. Ofrecemos protección de dispositivos completos para hasta cinco dispositivos con servidores en más de { $country } países, puedes conectarte a cualquier lugar, desde cualquier lugar.
# Obsolete string
# Variables
#   $vpn (url)- https://www.mozilla.org/products/vpn/more/what-is-a-vpn/
#   $mozvpn (url) - https://www.mozilla.org/products/vpn/
#   $countries (number) - number of countries where Mozilla VPN has servers, e.g. "30". The + after indicates the number may be higher, where "30+" means "30 or more".
vpn-ip-address-a-vpn-is = Un VPN es una forma de ocultar tu dirección IP. <a href="{ $vpn }">Cuando usas un VPN</a>, tu dirección IP externa provendrá de la IP externa del servidor VPN, en lugar de la dirección IP externa de tu ubicación. Así que si tu servidor VPN de conexión está ubicado en California, tu IP externa dirá que te conectaste desde California, sin importar dónde estés. Además, tu actividad en línea se envía a través de una conexión cifrada y segura a tu servidor VPN, dándote seguridad y privacidad adicionales. <a href="{ $mozvpn }">{ -brand-name-mozilla-vpn }</a> es una forma de ocultar tu dirección IP. No guardamos registros de actividad ni nos asociamos con plataformas de análisis de terceros. Ofrecemos protección de dispositivos completos para hasta cinco dispositivos con servidores en más de { $country } países, puedes conectarte a cualquier lugar, desde cualquier lugar.
