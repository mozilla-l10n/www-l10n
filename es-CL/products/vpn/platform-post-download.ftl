...
vpn-mac-download-page-title = Bajar { -brand-name-mozilla-vpn } para { -brand-name-mac-short }
vpn-mac-downloading-mozilla-vpn = Descargando { -brand-name-mozilla-vpn } para { -brand-name-mac-short }…
vpn-mac-go-to-your-downloads = Ve a la carpeta de descargas y haz doble clic en el archivo .pkg
vpn-mac-follow-the-steps = Sigue los pasos descritos en el instalador { -brand-name-mozilla-vpn } para iniciar la aplicación
...
vpn-your-download-should-start = Tu descarga de { -brand-name-mozilla-vpn } debería comenzar automáticamente. Si no es así, <br> <a href="{ $url }" id="{ $id }">reinicia la descarga</a> o vuelve a descargar para otro dispositivo.
...
vpn-pick-a-recommended = Elige una ubicación recomendada para una conexión rápida y estable o elige la ubicación deseada manualmente, luego ACTIVA el interruptor
