...
vpn-features-block-ads = Bloquear a los anunciantes para que no te tengan como objetivo
...
vpn-features-multi-hop-feature = Nuestra <a { $feature }>funcionalidad de múltiples saltos</a> te brinda un impulso adicional de seguridad.
...
vpn-features-webste-specific-vpn = Ajustes de VPN específicos para cada sitio web, integrado a la perfección en { -brand-name-firefox }
vpn-features-with-the-mozilla-vpn-extention = Con la extensión { -brand-name-mozilla-vpn } para { -brand-name-firefox } (solo Windows), puedes ajustar tu experiencia con el VPN para cada sitio web. Excluye sitios web individuales de la protección del VPN o establece ubicaciones de servidor preferidas para sitios específicos, lo que te brinda una experiencia más flexible y personalizada.
vpn-features-personalized-server = Recomendaciones personalizadas de ubicación del servidor
vpn-features-well-suggest-which-servers = Te sugeriremos qué servidores cercanos te garantizarán la conexión a Internet más rápida y confiable.
vpn-features-personalize-which-apps = Personaliza qué aplicaciones obtienen protección VPN
vpn-features-easily-exclude-apps = Excluye fácilmente aplicaciones de la protección del VPN — no es necesario desconectar tu dispositivo de { -brand-name-mozilla-vpn }. Disponible en dispositivos Windows, Android y Linux.
vpn-features-trustworthy = Confiable
vpn-features-money-back = 30 días de garantía de devolución de dinero
vpn-features-plus-customer-support = Además de atención al cliente 24 horas al día, 7 días a la semana.
...
vpn-features-built-transparently = Desarrollado de forma transparente en código abierto
# Variables
#   $github (url) - link to https://github.com/mozilla-mobile/mozilla-vpn-client
vpn-features-made-with-open-source-code = { -brand-name-mozilla-vpn } está hecho con código abierto, lo que significa que todo el código es accesible públicamente. Revisa nuestro <a { $github }>repositorio de GitHub</a>.
vpn-features-reviewed-by-third = Revisado por expertos en seguridad externos
# Variables
#   $report (url) - link to https://blog.mozilla.org/mozilla/news/mozilla-vpn-completes-independent-security-audit-by-cure53
vpn-features-weve-been-audited = Hemos sido auditados por Cure53, una firma líder en auditorías de ciberseguridad. <a { $report }>Revisa el informe aquí</a>.
...
vpn-features-were-backed-by-mofo-v2 = Contamos con el respaldo de <a { $mofo }>{ -brand-name-mozilla-foundation }</a>, una organización sin fines de lucro que lucha para mantener la Web abierta y saludable para todas las personas.
