...
vpn-features-set-different-locations = Establece diferentes ubicaciones para cada pestaña en { -brand-name-firefox }
# Variables
#   $containers (url) - link to https://support.mozilla.org/kb/use-multi-account-containers-mozilla-vpn
vpn-features-combine-mozilla-vpn-with-containers = Combina { -brand-name-mozilla-vpn } con la extensión de { -brand-name-firefox } de contenedores multicuenta y establece diferentes ubicaciones de VPN para cada pestaña de { -brand-name-firefox }. <a { $containers }>Aprende cómo</a>.
