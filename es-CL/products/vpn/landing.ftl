...
vpn-landing-faq-compatibility-question-desc-mac-v4 = <a { $url }>{ -brand-name-mac }</a> ({ $minversion } y superior)
# Obsolete string
# Variables:
#   $url (url) - link to https://www.mozilla.org/products/vpn/desktop/mac/
...
vpn-landing-faq-compatibility-question-desc-ios-v4 = <a href="{ $url }">{ -brand-name-ios }</a> ({ $version } y superior)
# Obsolete string
# Variables:
#   $url (url) - link to https://www.mozilla.org/products/vpn/mobile/ios/
...
vpn-landing-faq-download-desc = Visita la <a { $attrs }>página de descarga</a> para instalar { -brand-name-mozilla-vpn } en tu dispositivo y luego conéctate a tu { -brand-name-firefox-account }.
