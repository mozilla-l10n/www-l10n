...
vpn-landing-faq-uses-conceal-v2 = Ocultando tu verdadera <a href="{ $url }">dirección IP</a>. Esto protege tu identidad y oculta su ubicación.
# Obsolete string
...
vpn-landing-sub-not-found = ¡Chuta! Parece que aún no te has suscrito.
