...
manifesto-details-the-mozilla-foundation-invites = La Fundación { -brand-name-mozilla } invita a todas las personas que apoyen los principios del Manifiesto de { -brand-name-mozilla } a unírsenos para encontrar nuevas formas de hacer realidad esta visión de Internet.
