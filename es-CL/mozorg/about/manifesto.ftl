...
manifesto-these-are-the-principles = Estos son los principios que guían nuestra misión para promover la apertura, innovación y oportunidad en la web.
manifesto-the-internet-is-an-integral = Internet es una parte integral de la vida moderna -un componente clave para la educación, la comunicación, la colaboración, los negocios, el entretenimiento y para la sociedad en su conjunto.
manifesto-the-internet-is-a-global = Internet es un recurso público mundial que debe seguir siendo abierto y accesible.
manifesto-the-internet-must-enrich = Internet debe enriquecer la vida de los humanos.
...
manifesto-we-are-committed-to-people = Estamos comprometidos con un internet que incluye a todas las personas del planeta — donde las características demográficas de una persona no determinan su posibilidad de conectarse, sus oportunidades ni su calidad de experiencia.
manifesto-we-are-committed-to-discourse = Estamos comprometidos con un internet que promueve el discurso civil, la dignidad humana y la expresión individual.
manifesto-we-are-committed-to-thinking = Estamos comprometidos con un internet que aumenta el pensamiento crítico, la argumentación razonada, el conocimiento compartido y los hechos verificables.
manifesto-we-are-committed-to-diverse = Estamos comprometidos con un internet que cataliza la colaboración entre diversas comunidades que trabajan juntas por el bien común.
...
manifesto-details-articulate-a-vision-v2 = definir una visión de Internet que los participantes de { -brand-name-mozilla } deseen que persiga la { -brand-name-mozilla-foundation };
...
manifesto-details-the-mozilla-foundation-pleges-v2 = La { -brand-name-mozilla-foundation } se compromete a apoyar el Manifiesto { -brand-name-mozilla } con sus actividades. Específicamente, nos comprometemos a:
...
manifesto-mozillas-pledge = Compromiso de { -brand-name-mozilla }
...
manifesto-if-you-share-this-goal = Si compartes este objetivo, dinos cómo podemos ayudarte. <a { $github_link }>Creamos software de código abierto</a> sobre el que puedes construir. <a { $mofo_link }>Financiamos becarios e incubamos proyectos</a> destinados a crear un futuro mejor en línea. <a { $mozai_link }>Creamos herramientas de IA de código abierto</a> que dan opciones a los desarrolladores y les ayudan a ahorrar dinero. <a { $mozvc_link }>Invertimos en startups tecnológicas responsables</a>. <a { $mdc_link }>Gestionamos una comunidad global</a> para el intercambio justo de datos. <a { $festival_link }>Organizamos un encuentro global anual</a> para personas que construyen cualquier de todo para avanzar en el Manifiesto. Y, por supuesto, hacemos <a { $firefox_link }>{ -brand-name-firefox }</a> y <a { $thunderbird_link }>{ -brand-name-thunderbird }</a>. Todo esto tiene como objetivo ayudar a las personas a hacer de internet un lugar saludable.
...
manifesto-details-the-internet-must = Internet debe enriquecer la vida de los humanos.
manifesto-details-individuals-security = La seguridad y privacidad de los usuarios en Internet son fundamentales y no deben ser tratados como opcionales.
manifesto-details-individuals-must = Los usuarios deben tener la posibilidad de moldear Internet y su propia experiencia en la red.
...
manifesto-details-commercial-involvement = El uso comercial de Internet proporciona muchos beneficios a su desarrollo; es crucial un equilibrio entre el beneficio comercial y público.
...
manifesto-details-some-foundation-v2 = Algunas actividades de la { -brand-name-mozilla-foundation } -actualmente, la creación, distribución y promoción de productos- se realizan principalmente a través de la empresa subsidiaria { -brand-name-mozilla-corporation } la cual es íntegramente propiedad de la Fundación Mozilla.
manifesto-details-invitation = Invitación
manifesto-details-the-mozilla-foundation-invites-v2 = { -brand-name-mozilla-foundation } invita a todas las personas que apoyen los principios del Manifiesto de { -brand-name-mozilla } a unírsenos para encontrar nuevas formas de hacer realidad esta visión de Internet.
...
manifesto-share-on-bluesky = Compartir en Bluesky
manifesto-our-10-principles = <strong>Nuestros 10</strong> principios
manifesto-the-mozilla-manifesto-addendum = Apéndice del manifiesto de { -brand-name-mozilla }
manifesto-show-your-support = Muestra tu apoyo
manifesto-i-support-the-vision-of-v2 = Yo apoyo la visión de un internet mejor y más saludable de { -brand-name-mozilla }, ¿y tú?
