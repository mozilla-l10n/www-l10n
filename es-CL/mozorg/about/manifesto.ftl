...
manifesto-visualize-who-you-interact = Visualiza con quién interactúas en la web con Lightbeam
manifesto-learn-about-creating-web = Aprende acerca de crear recursos web con otros
manifesto-host-or-join-a-maker-party = Organiza o únete a la Maker Party
