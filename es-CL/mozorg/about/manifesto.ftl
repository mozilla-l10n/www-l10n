...
# Obsolete string (expires 19-10-2025)
manifesto-details-the-mozilla-foundation-pleges = La { -brand-name-mozilla-foundation } se compromete a apoyar el Manifiesto { -brand-name-mozilla } con sus actividades. Específicamente, nos comprometemos a:
...
# Obsolete string (expires 19-10-2025)
manifesto-details-some-foundation = Algunas actividades de la { -brand-name-mozilla-foundation } -actualmente, la creación, distribución y promoción de productos- se realizan principalmente a través de la empresa subsidiaria { -brand-name-mozilla-corporation } la cual es íntegramente propiedad de la Fundación Mozilla.
manifesto-details-some-foundation-v2 = Algunas actividades de la { -brand-name-mozilla-foundation } -actualmente, la creación, distribución y promoción de productos- se realizan principalmente a través de la empresa subsidiaria { -brand-name-mozilla-corporation } la cual es íntegramente propiedad de la Fundación Mozilla.
manifesto-details-invitation = Invitación
# Obsolete string (expires 19-10-2025)
manifesto-details-the-mozilla-foundation-invites = La { -brand-name-mozilla-foundation } invita a todas las personas que apoyen los principios del Manifiesto de { -brand-name-mozilla } a unírsenos para encontrar nuevas formas de hacer realidad esta visión de Internet.
