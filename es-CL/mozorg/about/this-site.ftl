...
about-this-site-today-v2 = Hoy, este es el sitio donde la gente aprende más acerca de { -brand-name-mozilla }</a> y prueba <a href="{ $vpn }">{ -brand-name-mozilla-vpn }</a>. También puedes descubrir algunos <a href="{ $book }">huevos de Pascua</a> por el camino.
