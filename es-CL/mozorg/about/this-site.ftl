...
about-this-site-today = Hoy, este es el sitio donde la gente llega para bajar <a href="{ $firefox }">{ -brand-name-firefox }</a>, probar <a href="{ $vpn }">{ -brand-name-mozilla-vpn }</a> y conocer más <a href="{ $mozilla }">acerca de { -brand-name-mozilla }</a>. También es un perfecto lugar para descubrir algunos <a href="{ $book }">contenidos secretos (easter eggs)</a> que podrías toparte a lo largo del camino.
about-this-site-today-v2 = Hoy, este es el sitio donde la gente aprende más <a href="{ $mozilla }">acerca de { -brand-name-mozilla }</a> y prueba <a href="{ $vpn }">{ -brand-name-mozilla-vpn }</a>. También puedes descubrir algunos <a href="{ $book }">huevos de Pascua</a> por el camino.
...
about-this-site-report-a-bug = Reportar un bug
about-this-site-contribute-to-code = Contribuir al código base
...
about-this-site-mozilla-protocol = <a href="{ $protocol }">Protocolo</a> de { -brand-name-mozilla } para el sistema de diseño de los componentes frontend y de la marca.
# Variables:
