...
# HTML Page title
m24-about-page-title = Aprender más sobre { -brand-name-mozilla }
# HTML page description
m24-about-page-desc = { -brand-name-mozilla } hace navegadores, aplicaciones, código y herramientas pensando en las personas antes que en las ganancias. Nuestra misión: Mantener Internet abierto y accesible para todos.

## Intro

m24-about-reclaim-the-internet = Recupera Internet con nosotros
m24-about-mozilla-is-working = { -brand-name-mozilla } está trabajando para devolver el control de Internet a manos de las personas que lo utilizan.

## Manifesto

m24-about-together-we-can = Juntos podemos mantener Internet fácil, seguro y gratuito para todos.
m24-about-read-our-manifesto = Lee nuestro manifiesto
...
m24-about-monitor = Monitoreo
m24-about-we-uncover-insights = Descubrimos conocimientos, hacemos campañas para mejorar productos e impulsamos políticas que representan tus intereses.
# Obsolete string (expires: 2025-02-03)
m24-about-we-monitor-developments = Monitoreamos los desarrollos, realizamos investigaciones y campañas para mejorar productos e impulsamos políticas que representan tus intereses.
...
m24-about-we-fund-and = Financiamos e invertimos en las personas y en los esfuerzos que llevan la tecnología, Internet y la IA en la dirección correcta.

## News

m24-about-read-more = Leer más
m24-about-read-the-latest = Lea las últimas noticias y artículos de { -brand-name-mozilla }
m24-about-builders-program = Los { -brand-name-mozilla-builders } ayudan a los desarrolladores  a crear proyectos de IA transformadores de código abierto a través de colaboraciones, programación y comunidad.
