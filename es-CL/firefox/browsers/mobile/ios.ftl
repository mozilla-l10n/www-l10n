...
# Obsolete string
mobile-ios-get-automatic-privacy = Obtén privacidad automática en tu { -brand-name-iphone } e { -brand-name-ipad }
...
# Obsolete string
mobile-ios-add-firefox-across = Añade { -brand-name-firefox } a todos tus dispositivos para una navegación segura y sin problemas. { -brand-name-sync } tus dispositivos para llevar tus marcadores favoritos, credenciales guardadas, contraseñas e historial de navegación a donde sea que vayas. Además, envía pestañas abiertas entre tu teléfono y computador para continuar donde mismo quedaste.
...
# Obsolete string
mobile-ios-keep-tabs-on = Usa pestañas para tus pestañas
# Obsolete string
