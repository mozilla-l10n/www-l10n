...
# Outdated string
mobile-focus-focus-blocks-the = { -brand-name-focus } bloquea los anuncios que normalmente verías en las páginas web; no se necesitan complementos ni extensiones adicionales. Con menos anuncios, obtienes una mejor velocidad de carga de páginas, lo que se traduce en que llegues mucho más rápido a lo que deseas.
mobile-focus-focus-blocks-the-v2 = { -brand-name-focus } bloquea los anuncios que tratan de seguirte por la web; no se necesitan complementos ni extensiones adicionales. Con menos anuncios, obtienes una mejor velocidad de carga de páginas, lo que se traduce en que llegues mucho más rápido a lo que deseas.
...
mobile-focus-focus-removes-trackers-v2 = { -brand-name-focus } elimina rastreadores y habilita bloqueadores de anuncios para que las páginas que estás viendo requieran menos datos y se carguen mucho más rápido. Además, puedes fijar hasta cuatro accesos directos en tu pantalla de inicio y acceder a tu sitio favorito aún más rápido, sin tener que escribir nada.
