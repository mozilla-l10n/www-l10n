...
firefox-all-which-browser-would = Whit stravaiger are ye wantin tae doonload?
# Used as an accessible label for a help button. The text is replaced with a "?" icon.
firefox-all-get-help = Get hauners
firefox-all-you-are-about-to-download = Ye're aboot tae doonload:
firefox-all-browser = Stravaiger:
firefox-all-platform = Platform:
firefox-all-language = Leid:
firefox-all-lang-multi = Mair as yin leid
firefox-all-sorry-we-couldnt-find = Ach, we couldnae airt oot the doonload ye're efter. Gonnae gie it anither shot, or wale a doonload frae the list ablow.
