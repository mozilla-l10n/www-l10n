...
# HTML page title
features-independent-firefox-a-different = { -brand-name-firefox }, brabhsálaí difriúil d'aois dhifriúil. Tá cead do chinn agat!
# HTML page description
features-independent-browse-the-internet = Brabhsáil an tIdirlíon mar a ceapadh é… saor in aisce, slán sábháilte, agus ar fáil do chách. Fógair do neamhspleáchas ar líne!
features-independent-firefox-rebel-with-a = { -brand-name-firefox }: An Brabhsálaí Ríomhlóideach
...
# Obsolete string
features-independent-firefox-is-a-browser = Is é { -brand-name-firefox } an brabhsálaí amháin le coinsias sóisialta. Mar chuid den eagraíocht neamhbhrabúis { -brand-name-mozilla }, troidimid ar son do cheart ar líne, coinnímid srian ar na mórchomhlachtaí teicneolaíochta, agus cuirimid dea-chleachtais Idirlín chun cinn i dtíortha atá i mbéal forbartha. Nuair a roghnaíonn tú { -brand-name-firefox }, roghnaímid thú.
