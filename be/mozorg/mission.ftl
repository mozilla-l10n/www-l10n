...
mission-were-building-a-better-internet = Мы будуем лепшы Інтэрнэт
mission-our-mission-is-to-ensure-the-internet = Наша місія складаецца ў забеспячэнні таго, каб Інтэрнэт з'яўляўся глабальным грамадскім рэсурсам, адкрытым і даступным для ўсіх і кожнага. Інтэрнэт, які сапраўды ставіць людзей на першае месца, дзе людзі могуць фарміраваць свой уласны вопыт і быць моцнымі, незалежнымі і абароненымі.
...
mission-history = Гісторыя
mission-where-we-come-from-and-how-we-got = Адкуль мы прыйшлі і як мы трапілі туды, дзе мы ёсць
