...
home-the-health-of = «Здароўе інтэрнэту і жыцця ў ім – вось чаму мы існуём».
home-mitchell-baker-v2 = Мітчэл Бэйкер, выканаўчы старшыня праўлення, { -brand-name-mozilla-foundation }
home-mozilla-makes-privacy = { -brand-name-mozilla } стварае прадукты, якія паважаюць прыватнасць
home-product-firefox-browsing = Прыватнае і бяспечнае агляданне
home-cta-get-firefox = Атрымаць { -brand-name-firefox }
home-product-relay-hide-your = Схавайце свой нумар тэлефона і электронную пошту ад спамераў
...
home-at-its-core-v2 = Па сутнасці, { -brand-name-mozilla } з'яўляецца актывісцкай арганізацыяй пад кіраўніцтвам { -brand-name-mozilla-foundation }, якая ўносіць змены ў свет праз розныя мерапрыемствы, у тым ліку { -brand-name-mozilla-corporation }, MZLA, <a { $ventures }>{ -brand-name-mozilla-ventures }</a> і <a { $mozai }>{ -brand-name-mozilla-ai-v2 }</a>. Чым мы адрозніваемся? Паколькі мы кіруемся місіяй, гэта азначае, што ў нас ёсць свабода прымаць усе нашы рашэнні зыходзячы з таго, што лепш для інтэрнэту і ўсіх у сеціве, а не зыходзячы з патрабаванняў акцыянераў — у нас насамрэч няма ніводнага з іх.
