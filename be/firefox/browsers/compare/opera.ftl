...
compare-opera-operas-privacy-policy-lacks-fallback = Палітыцы прыватнасці { -brand-name-opera } не хапае пэўнасці ў тлумачэнні таго, якія тыпы інфармацыі яна збірае і як, у некаторых раздзелах сказана, што яны збіраюць імёны ўладальнікаў уліковых запісаў, IP-адрасы і пошукавыя запыты. Што здаецца заблытаным і трывожным, дык гэта раздзел аб міжнароднай перадачы звестак; калі, як часта і чаму ім трэба перадаваць вашыя звесткі на міжнародным узроўні, не тлумачыцца.
# Variables:
...
compare-opera-like-firefox-opera-delivers = Як і { -brand-name-firefox }, { -brand-name-opera } прапануе пракрутку картак, што азначае, што калі вы адкрываеце больш картак, чым змяшчаецца на экране, некаторыя з іх будуць схаваны за значком пракруткі, а не проста пастаянна скарачацца. Таксама { -brand-name-firefox } і { -brand-name-opera } маюць інструмент здымка экрана, які дазваляе зрабіць скрыншот з экрана або часткі старонкі. Аднак інструмент { -brand-name-opera } не дае вам магчымасці стварыць адзін суцэльны захоп усёй вэб-старонкі, толькі бачнай часткі.
# "Ex" is a former partner or spouse, as in "ex-boyfriend" or "ex-wife." Alternative: "former partner"
compare-opera-both-firefox-and-opera-are = Як { -brand-name-firefox }, так і { -brand-name-opera } сумяшчальныя з усімі платформамі, уключаючы { -brand-name-windows }, { -brand-name-mac }, { -brand-name-linux } , { -brand-name-android } і { -brand-name-ios }. Уладальнікі ўліковых запісаў { -brand-name-firefox } могуць лёгка сінхранізаваць свае закладкі, паролі, адкрытыя карткі і гісторыю аглядання на ўсіх прыладах, дзе выкананы ўваход. Тое ж самае датычна карыстальнікаў { -brand-name-opera } з уліковым запісам. Аднак многія сайты, асабліва старыя сайты, якія не абнаўляліся гадамі, цалкам блакуюць апошнюю версію { -brand-name-opera }. Такім чынам, калі важна наведваць такія месцы, як стары блог вашых колішніх, будзьце ўважлівыя, магчыма, вы не зможаце атрымаць доступ да некаторых з самых пыльных куткоў Інтэрнэту, калі карыстаецеся { -brand-name-opera }.
# "Touch" and "Mini" are brand names.
compare-opera-in-addition-to-the-regular = У дадатак да звычайнай мабільнай праграмы, { -brand-name-opera } мае яшчэ дзве мабільныя версіі свайго браўзера: Touch і Mini. Версія Touch аблегчана па функцыях, але яна прызначана для выкарыстання на хадзе і толькі адной рукой. Версія Mini нацэлена на скарачэнне інтэрнэт-трафіку і павелічэнне хуткасці на марудных злучэннях за конт зніжэння якасці малюнкаў і абразання змесціва.
# Variables:
...
compare-opera-we-also-offer-an-additional = Мы таксама прапануем дадатковую, хоць і эксперыментальную, версію нашай мабільнай праграмы { -brand-name-firefox }, <a { $attrs }>{ -brand-name-firefox } Preview</a>, засяроджаную на хуткасці і бяспецы.
compare-opera-most-major-browsers-these = У нашы дні большасць асноўных браўзераў, за выключэннем { -brand-name-safari }, працуюць бязшвова паміж платформамі і браўзерамі. { -brand-name-opera } і { -brand-name-firefox } не з'яўляюцца выключэннем, абодва браўзеры забяспечваюць выдатную пераноснасць паміж усімі прыладамі.
