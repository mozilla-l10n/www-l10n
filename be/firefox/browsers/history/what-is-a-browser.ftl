...
what-is-a-browser-a-web-browser = Браўзер перанясе вас туды, куды толькі захочаце ў Інтэрнэце. Вы зможаце праглядаць тэкст, відарысы і відэа, дзе б вы не былі.
