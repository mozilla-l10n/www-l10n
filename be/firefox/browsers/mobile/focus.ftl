...
# Outdated string
mobile-focus-focus-removes-trackers-v2 = { -brand-name-focus } выдаляе трэкеры і ўключае блакавальнікі рэкламы, таму старонкі, якія вы праглядаеце, патрабуюць менш дадзеных і загружаюцца значна хутчэй. Акрамя таго, замацуйце да чатырох цэтлікаў на галоўным экране і пераходзьце на любімы сайт яшчэ хутчэй, нічога не ўводзячы.
