...
mobile-focus-firefox-focus-blocks = { -brand-name-firefox-focus } па змаўчанні блакіруе шырокі спектр распаўсюджаных трэкераў, уключаючы трэкеры сацыяльных сетак і іншыя назойлівыя трэкеры, напрыклад, рэклама { -brand-name-facebook }.
