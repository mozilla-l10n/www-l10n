...
set-as-default-landing-the-internet-keeps = Інтэрнэт працягвае знаходзіць новыя спосабы раскрываць вашы асабістыя звесткі. { -brand-name-firefox } — адзіны браўзер з місіяй пошуку новых спосабаў вашай аховы.
set-as-default-landing-firefox-is-fast-no-interest = { -brand-name-firefox } — хуткі і бяспечны на { -brand-name-windows }, { -brand-name-ios }, { -brand-name-android }, { -brand-name-linux }… і паміж імі таксама. Мы не маем зацікаўленасці ў тым, каб абмяжоўваць вас ці скідваць вашы налады.
set-as-default-landing-firefox-is-the-only-major = { -brand-name-firefox } — адзіны буйны незалежны браўзер. { -brand-name-chrome }, { -brand-name-edge } і { -brand-name-brave } створаны на аснове коду ад { -brand-name-google }, найбуйнейшай рэкламнай сеткі у свеце.
