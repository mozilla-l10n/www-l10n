...
firstrun-sign-in-to-your-account = Увайдзіце ў свой уліковы запіс, і мы сінхранізуем закладкі, паролі і іншыя патрэбныя рэчы, якія вы захавалі ў { -brand-name-firefox } на іншых прыладах.
firstrun-already-have-an-account = Ужо маеце ўліковы запіс?
firstrun-sign-in = Увайсці
