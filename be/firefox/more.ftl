...
firefox-more-access-your-sync = Атрымлівайце доступ і сінхранізуйце закладкі, паролі, адкрытыя карткі і многае іншае — усюды, дзе вы карыстаецеся { -brand-name-firefox }.
...
firefox-doesnt-spy = { -brand-name-firefox } не шпіёніць за пошукам. Мы затрымліваем вядомыя староннія кукі сачэння і даем вам поўны кантроль.
...
youll-never-guess = Вы ніколі не здагадаецеся, які браўзер мае перавагу, калі гэта тычыцца хуткасці і магчымасцяў.
...
take-the-stress = Зніміце стрэс ад пошуку бяспечнага браўзера.
building-a-safe = Стварэнне бяспечнага браўзера — гэта мастацтва і навука, таму што няма ўсталяваных правілаў.
