...
welcome-page3-never-forget-reset-or-travel = Ніколі не забывайце, не скідвайце і не вандруйце без пароляў ізноў.
welcome-page3-facebook-container = { -brand-name-facebook-container }
welcome-page3-get-a-container-to-keep-facebook = Атрымайце кантэйнер, каб трымаць { -brand-name-facebook } далей ад вашых спраў.
welcome-page3-pocket = { -brand-name-pocket }
welcome-page3-trade-clickbait-and-fake-news = Абмяняйце клікбэйты і фальшывыя навіны на якаснае змесціва.
welcome-page3-firefox-send = { -brand-name-firefox-send }
welcome-page3-send-huge-files-to-anyone = Адпраўляйце велізарныя файлы каму хочаце з дапамогай спасылак, якія самаліквідуюцца.
welcome-page3-why-am-i-seeing-this = Чаму я бачу гэта?
