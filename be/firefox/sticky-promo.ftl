...
firefox-sticky-promo-meet-our-family-of = Пазнаёмцеся з нашым сямействам прадуктаў
firefox-sticky-promo-get-the-latest-firefox = Атрымайце апошнюю версію браўзера { -brand-name-firefox }.
# Products List
firefox-sticky-promo-browsers = Браўзеры
