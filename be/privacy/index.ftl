...
privacy-index-contact-mozilla = Звязацца з { -brand-name-mozilla }
privacy-index-if-you-want-to-make-a-correction = Калі вы хочаце паправіць свае звесткі, або маеце пытанні, датычныя нашай палітыкі прыватнасці, калі ласка, звяжыцеся з:
# Variables:
#   $dsar (url) - link to https://app.onetrust.com/app/#/webform/4ba08202-2ede-4934-a89e-f0b0870f95f0
privacy-index-see-here-for-data-subject = <a href="{ $dsar }">Паглядзіце тут запыты на доступ да суб'екта дадзеных.</a>
# Variables:
#   $sumo (url) - link to https://support.mozilla.org/
privacy-index-for-product-support-requests = Для запытаў на падтрымку прадуктаў, калі ласка, <a href="{ $sumo }">наведайце нашы форумы</a>.
privacy-index-data-privacy-principles = Прынцыпы прыватнасці звестак
# Variables:
