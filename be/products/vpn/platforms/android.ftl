...
vpn-android-ability = Адчувайце ўпэўненасць, што вашыя звесткі ў бяспецы ад хакераў і старонніх вачэй — як дома, так і ў грамадскім Wi-Fi — з { -brand-name-mozilla-vpn }. Па цане кубачка кавы вашы асабістыя дадзеныя на вашай прыладзе { -brand-name-android } атрымліваюць перадавое шыфраванне праз пратакол { -brand-name-wireguard }®. Выкарыстоўвайце { -brand-name-mozilla-vpn }, каб трансляваць шоу, гуляць у гульні, кіраваць сваімі фінансамі, купляць ці рабіць што-небудзь яшчэ ў Інтэрнэце, ведаючы, што ваша злучэнне бяспечнае.
...
# Variables:
#   $devices (number) - number of available devices
vpn-android-devices-copy = { -brand-name-mozilla-vpn } дае магчымасць падключаць { $devices } розных прылад, у тым ліку { -brand-name-android }, { -brand-name-ios }, { -brand-name-mac-short }, { -brand-name-windows } і { -brand-name-linux }. Выкарыстоўвайце яго на сваім смартфоне, камп'ютары, ноўтбуку, планшэце і інш.
