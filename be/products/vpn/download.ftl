...
vpn-download-page-title = Сцягнуць { -brand-name-mozilla-vpn }
vpn-download-page-description = Сцягніце { -brand-name-mozilla-vpn } для { -brand-name-windows }, { -brand-name-mac }, { -brand-name-linux }, { -brand-name-android } і { -brand-name-ios }.
# Variables:
...
vpn-download-for-firefox-extension = Усталяваць пашырэнне { -brand-name-firefox }
