...
# Outdated string
banner-fundraising-body = يتم جمع بياناتنا الشخصية في كل مرة ندخل فيها إلى الويب، وليس من السهل أن نعرف ما يحدث لها. كما تُصعّب المعلومات المُضلّلة علينا الوصول إلى الحقيقة. يَتم دفع الأجهزة المتصلة بالإنترنت إلى الأسواق بدون أن تفي بالحد الأدنى من معايير الأمان. تَسعى { -brand-name-mozilla-foundation } بكل ما أوتيت من قوة لجعل الإنترنت آمنًا ومفتوحًا ومتاحًا للجميع. <strong>هل ستتبرع اليوم؟</strong>
