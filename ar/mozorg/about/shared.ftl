...
about-shared-get-involved = شارِك
about-shared-volunteer = انضم إلينا وتطوّع في مجالات مُختلفة.
vision-for-the-web = ورؤية { -brand-name-mozilla } للويب
read-about-our-vision = اقرأ عن رؤيتنا للإنترنت وعن عزمنا على متابعة تنفيذ تلك الرؤية.
