...
home-promo-title-lalo = اكتشف أفكارًا جديدة
home-promo-title-soraya = الشرارة تبدأ من هنا
...
# Obsolete string
home-promo-desc-soraya = مُصمّم أثاث، أحد عُشّاق Firefox

# Obsolete string
home-promo-desc-gary = مُصمّم ألواح تزلّج، أحد عُشّاق Firefox

# Obsolete string
home-promo-desc-ryan = فنّانة ومُمثّلة ولاعبة رياضة وناشطة، إحدى عُشّاق Firefox
