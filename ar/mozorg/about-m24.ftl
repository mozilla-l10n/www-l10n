...
# HTML Page title
m24-about-page-title = معرفة المزيد عن { -brand-name-mozilla }

# HTML page description
m24-about-page-desc = تبني { -brand-name-mozilla } متصفحات وتطبيقات وبرمجيات وأدوات وهي تضع المستخدمين فوق أي ربح. مُهمتنا: الحفاظ على الإنترنت مفتوحًا ومتاحًا للجميع.
...
m24-about-we-build-products-v2 = نبتكر منتجات تمنحك التحكّم — مثل { -brand-name-firefox } وأكثر.
m24-about-fund = التمويل
m24-about-we-fund-and = نموّل ونستثمر في الأشخاص والجهود التي تقود التكنولوجيا والإنترنت والذكاء الاصطناعي في الاتجاه الصحيح.
...
m24-about-lets-build-a = هيا نبني مستقبلًا أكثر عدالة
m24-about-see-how-were = اكتشف كيف ندعم بيئة إلكترونية متنوعة وشاملة ومتاحة للجميع.
m24-about-read-about-our = اقرأ عن التزامنا
