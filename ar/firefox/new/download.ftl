...
firefox-new-download-firefox = نزّل { -brand-name-firefox }
...
firefox-new-fix-a-problem = أصلِح مشكلة
firefox-new-need-help = أتحتاج مساعدة؟
firefox-new-see-whats-being-blocked = طالِع ما سيُحجب
firefox-new-make-your-passwords-portable = احمل كلمات السر معك
firefox-new-watch-for-data-breaches = تنبّه لتسريبات البيانات
firefox-new-protect-your-privacy = احمِ خصوصيتك
firefox-new-private-browsing-clears = يمسح <strong>التصفح الخاص</strong> التأريخ ليُبقيه سرًا على أي شخص يستخدم هذا الحاسوب.
