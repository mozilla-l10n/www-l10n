...
# Outdated string
mobile-focus-disappear-your-history = حذف سِجِل التصفُّح
...
# Outdated string
mobile-focus-private-browsing-on = إنّ وضع "التصفّح الخاص" في مُعظم المتصفحات لا يمنحُك الخصوصية الكاملة حقًا. ولكن الوضع مُختلف مع مُتصفح { -brand-name-firefox-focus }، لأنه يرتقي بخصوصيتك إلى مستوى أفضل ويُحافظ عليها دائمًا، ولأنه مدعوم من مؤسسة { -brand-name-mozilla } غير الهادفة للربح التي تدافع عن حقوقك على الإنترنت.
