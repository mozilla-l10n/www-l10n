...
browsers-mobile-compare-mobile-browsers = مقارنة بين مُتصفحات الأجهزة المحمولة
browsers-mobile-see-how-firefox-stacks-up = لاحِظ مدى تفوُّق مُتصفح { -brand-name-firefox } على المتصفحات الأخرى المشهورة عندما يتعلق الأمر بأهم ثلاثة معايير: الخصوصية والميزات والمزامنة.
