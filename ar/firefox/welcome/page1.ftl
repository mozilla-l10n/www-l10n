...
welcome-page1-find-ways-to-protect-your = تعرّف على طُرق لحماية معلوماتك مع نصائح أمان <a href="{ $security_tips }">{ -brand-name-monitor }</a>.
...
welcome-page1-were-you-one-of-many = أكنت واحدًا من أصل 100,985,047 ممن دُعوا إلى حفل <a href="{ $evite_breach }">اختراق بيانات Evite</a>؟
