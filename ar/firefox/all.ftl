...
firefox-all-check-the-system-requirements = تحقّق من متطلبات النظام
firefox-all-release-notes = ملاحظات الإصدارة
firefox-all-source-code = الكود المصدري
firefox-all-need-help = أتريد يد العون والمساعدة؟
firefox-all-which-browser-would = ما المتصفح الذي تودّ تحميله؟
# Used as an accessible label for a help button. The text is replaced with a "?" icon.
firefox-all-get-help = احصل على مُساعدة
firefox-all-you-are-about-to-download = على وشك أن تنزّل:
firefox-all-browser = المتصفح:
firefox-all-platform = المنصة:
firefox-all-language = اللغة:
firefox-all-sorry-we-couldnt-find = آسفون ولكن لم نجد النسخة التي تبحث عنها. من فضلك أعِد المحاولة لاحقًا أو اختر نسخة أخرى تنزّلها من القائمة أسفله.
firefox-all-the-pre-alpha-version = النسخة ما قبل ألفا، للمستخدمين الحرفيين الذي يودون البحث عن كلّ انهيار للمتصفّح واختبار المزايا ما إن تُطوَّر.
firefox-all-64-bit-installers = المُثبّتات 64 بتّة
...
firefox-all-download-product-for = نزّل { $product_label } على { $platform } باللغة { $locale }
firefox-all-msi-installers = مُثبّتات MSI
firefox-all-which-version = أيّ إصدارة تريد؟
firefox-all-select-your-preferred-installer = اختر أداة التثبيت التي تريد
firefox-all-select-your-preferred-language = اختر اللغة التي تريد
firefox-all-learn-about-installers = اطّلع على المزيد عن المُثبّتات
