...
vpn-features-webste-specific-vpn = إعدادات VPN الخاصة بمواقع الويب، مدمجة بشكل سلِس في { -brand-name-firefox }
vpn-features-with-the-mozilla-vpn-extention = مع امتداد { -brand-name-mozilla-vpn } لـ { -brand-name-firefox } (نظام تشغيل Windows فقط)، يُمكنك تحسين تجربة VPN على أساس كل موقع على حده. استبعد مواقع مُعينة من حماية VPN أو حدّد أماكن خوادم مُفضلة لِمواقع محدّدة، لِتستمع بتجربة أكثر مرونة وتخصيصًا.
