...
moz-account-already-have = هل لديك حساب بالفعل؟ <a { $sign_in_url }>تسجيل الدخول</a> أو <a { $learn_more_url }>معرفة المزيد</a> عن { -brand-name-mozilla }
moz-account-get-a-mozilla-account = احصل على { -brand-name-mozilla-account }
