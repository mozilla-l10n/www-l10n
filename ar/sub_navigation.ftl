...
sub-navigation-android-support = دعم { -brand-name-android }
...
sub-navigation-firefox-features = ميزات { -brand-name-firefox }
sub-navigation-ad-tracker-blocking = حجب المتعقّبات الإعلانية
sub-navigation-private-browsing = التّصفّح الخاص
