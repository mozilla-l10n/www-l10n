...
footer-press-center = Matbuot markazi
footer-mdn-web-docs = { -brand-name-mdn-web-docs }
footer-websites-privacy-notice = Sayt maxfiylik qaydlari
footer-websites-cookies = Kukilar
footer-websites-legal = Huquqiy ma’lumot
footer-language = Til
