...
manifesto-host-or-join-a-maker-party = Maker Party o‘tkazing yoki qo‘shiling
...
manifesto-details-articulate-a-vision = { -brand-name-mozilla } hissa qo‘shuvchilari davom ettirish uchun { -brand-name-mozilla } Foundation’ni xohlaydigan Internet uchun tasavvurni shakllantirish.
manifesto-details-speak-to-people = texnik bilimlarga ega va ega bo‘lmagan odamlar bilan suhbatlashish
...
manifesto-details-these-principles = Ushbu tamoyillar o‘z-o‘zidan hayotimizga kelib qolmagan. Odamlar internetni ochiq va hissa qo‘shish uchun kerak - odamlar alohida-alohida harakat qilishmoqda, guruhlarda ishlashmoqda va boshqalarga sardorlik qilishmoqda. { -brand-name-mozilla } Foundation { -brand-name-mozilla } manifesti tamoyillarini o‘rnatishni kengaytirishga mo‘ljallangan. Biz boshqalarni bizga qo‘shilishga va internetni hamma uchun har doimgidan yaxshi joy qilish uchun taklif qilamiz.
...
manifesto-details-individuals-security = Yakka shaxslarning internetdagi xavfsizligi va maxfiyligi asosiydir va u ixtiyoriy sifatida qaralmasligi kerak.
...
manifesto-details-the-mozilla-foundation-pleges = { -brand-name-mozilla } Foundation { -brand-name-mozilla } manifestini o‘zining faollikigida qo‘llab-quvvatlashga va’da beradi. Asosan, biz:
