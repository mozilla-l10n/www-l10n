...
# Modal title
whatsnew79-get-firefox-on-your-phone = Installa { -brand-name-firefox } sul tuo telefono
whatsnew79-scan-the-qr-code = Scansiona il codice QR per iniziare
# Accessible text replacement for a QR code image
whatsnew79-qr-code-to-scan = Codice QR scansionabile per { -brand-name-firefox }
