...
features-sync-sign-up-for-a-free-mozilla-account-v2 = <a href="{ $fxa }">Registrati per ottenere un { -brand-name-mozilla-account } gratuito</a> e potrai sincronizzare i tuoi dati ovunque utilizzi il tuo browser { -brand-name-firefox }.
# Obsolete string
features-sync-sign-up-for-a-free-firefox-account = <a href="{ $fxa }">Registrati per ottenere un account { -brand-name-firefox } gratuito</a> e potrai sincronizzare i tuoi dati ovunque utilizzi il tuo browser { -brand-name-firefox }.
# Variables:
