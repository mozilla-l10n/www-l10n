...
# Hero title
password-manager-password-manager = Memorizzare le password? Problema risolto
...
password-manager-earn-your-second = Passa a una gestione più avanzata delle password scegliendo tra la vasta gamma di <a href="{ $addons }">componenti aggiuntivi di { -brand-name-firefox }</a> realizzati per questo scopo. Potrai scegliere tra una delle estensioni più popolari del momento o tra una di quelle di nuova generazione grazie ai consigli e alle recensioni di utenti esperti.
