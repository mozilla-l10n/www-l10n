...
firefox-more-you-can-reclaim = Puoi rivendicare la tua privacy e riprendere il controllo della tua esperienza su Internet. In effetti, è un gesto sorprendentemente facile e alla portata di tutti.
firefox-more-firefox-sync = { -brand-name-firefox-sync }
firefox-more-access-your-sync = Accedi e sincronizza segnalibri, password, schede aperte e molto altro su tutti i dispositivi in cui usi { -brand-name-firefox }.
...
six-of-the-best = Sei dei migliori browser messi a confronto
# Obsolete string
we-compare-firefox = Confrontiamo { -brand-name-firefox } con { -brand-name-chrome }, { -brand-name-edge }, { -brand-name-safari }, { -brand-name-opera }, { -brand-name-brave } e { -brand-name-ie } per aiutarti a prendere la tua decisione.
we-compare-firefox-v2 = Confrontiamo { -brand-name-firefox } con Chrome, Edge, Safari, Opera e Brave per aiutarti a prendere la tua decisione.
comparing-firefox-chrome = Confronto del { -brand-name-firefox-browser } con { -brand-name-google } { -brand-name-chrome }
...
be-bold-and = Scegliere il browser giusto per te richiede audacia e coraggio.
...
you-dont-have = Chi lo dice che devi usare per forza il browser preinstallato?
comparing-firefox-opera = Confronto del { -brand-name-firefox-browser } con { -brand-name-opera }
be-free-to = Sentiti libero di tessere le lodi di { -brand-name-firefox } ogni volta che vuoi.
the-ad-blocker = Il blocco pubblicità: un’arma segreta contro i fastidiosi annunci.
so-many-ads = Troppa pubblicità, poca pazienza… basta con questa follia!
