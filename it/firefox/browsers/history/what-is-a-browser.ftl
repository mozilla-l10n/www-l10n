...
# HTML page title
what-is-a-browser-what-is-a-web = Che cos’è un browser web?
...
what-is-a-browser-in-a-short-period-long = In un breve lasso di tempo siamo passati dall’essere meravigliati per la possibilità di inviare una email a qualcuno da qualche parte nel mondo a un radicale cambiamento nel modo di pensare alle informazioni. Non conta più quanto una persona sappia ma, più semplicemente, quale browser o applicazione può fornirci l’informazione che ci serve nel modo più veloce.
what-is-a-browser-in-a-short-period = In un breve lasso di tempo siamo passati dall’essere meravigliati per la possibilità di inviare una email a qualcuno da qualche parte nel mondo a un radicale cambiamento nel modo di pensare alle informazioni.
...
what-is-a-browser-sadly-not-all = Purtroppo, non tutti gli sviluppatori di browser decidono di interpretare i formati nello stesso modo. Dal punto di vista degli utenti questo si traduce nel fatto che un sito web può apparire e funzionare in modo differente. Basarsi sugli <a href="{ $standards }">standard del Web</a> permette di ricercare la coerenza tra browser: ogni utente può godersi Internet allo stesso modo, indipendentemente dal browser che sceglie per navigare.
# Variables:
