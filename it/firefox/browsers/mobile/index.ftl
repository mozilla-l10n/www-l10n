...
browsers-mobile-compare-mobile-browsers = Confronta i browser per dispositivi mobili
browsers-mobile-see-how-firefox-stacks-up = Scopri i risultati del confronto tra { -brand-name-firefox } e gli altri browser più usati quando si parla dei tre temi principali: privacy, funzionalità e sincronizzazione.
browsers-mobile-compare = Confronta
browsers-mobile-see-how-firefox-for-desktop-stacks = Scopri i risultati del confronto tra { -brand-name-firefox } e altri sette browser.
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words; please omit the strong tags if they need to be around multiple words in your language.
browsers-mobile-see-how-firefox-for-desktop-strong = Scopri i risultati del confronto tra { -brand-name-firefox } per <strong>desktop</strong> e altri sette browser.
browsers-mobile-join-firefox-and-get-the-most = Entra in { -brand-name-firefox } e ottieni il massimo da ogni prodotto, su tutti i tuoi dispositivi.
# Variables:
#   $fxa_attr (string) - anchor link url and attributes
#   $accounts_attr (string) - anchor link url and attributes
browsers-mobile-already-have-an-account-sign = Hai già un account? <a { $fxa_attr }>Accedi</a> o <a { $accounts_attr }>scopri</a> come entrare a far parte di { -brand-name-firefox }.
