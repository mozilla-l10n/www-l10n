...
navigation-the-non-profit-behind = L’organizzazione senza fini di lucro dietro { -brand-name-firefox } si batte per preservare un Internet sano e aperto a tutti.
