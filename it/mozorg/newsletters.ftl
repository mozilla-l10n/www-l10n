...
newsletters-it-may-take = Potrebbe volerci fino a un’ora prima che le informazioni appena sottoscritte vengano visualizzate in questa pagina.
...
newsletters-newsletter-subscriptions-for = Le iscrizioni alle newsletter per <a href="{ $foundation }">{ -brand-name-mozilla-foundation }</a> sono ora gestite separatamente.
# Variables:
...
newsletters-im-keeping-in-touch-v3 = Preferisco rimanere in contatto con { -brand-name-mozilla } su Bluesky.
