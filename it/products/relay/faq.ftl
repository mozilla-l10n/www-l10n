...
faq-question-acceptable-use-answer-measure-account-v2 = È obbligatorio utilizzare un { -brand-name-mozilla-account } con un indirizzo email verificato
# Obsolete string
...
phone-masking-faq-question-how-many = Quanti alias per numeri di telefono ho a disposizione?
phone-masking-faq-answer-how-many = Al momento hai a disposizione solo un alias per numeri di telefono. Una volta scelto il numero di telefono per l’alias, non potrai cambiarlo in seguito.
...
phone-masking-faq-answer-pictures = No, solo messaggi di testo SMS possono essere inoltrati o inviati come risposta.
