...
vpn-download-for-firefox-extension = Installa l’estensione per { -brand-name-firefox }
...
vpn-download-install-via-flathub = Installa tramite Flathub
vpn-download-install-via-apt = Installa tramite APT
