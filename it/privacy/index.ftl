...
privacy-index-contact-mozilla = Contatta { -brand-name-mozilla }
privacy-index-if-you-want-to-make-a-correction = Per richiedere una correzione relativa ai tuoi dati o informazioni sulle nostre politiche relative alla privacy contatta:
# Variables:
#   $dsar (url) - link to https://app.onetrust.com/app/#/webform/4ba08202-2ede-4934-a89e-f0b0870f95f0
privacy-index-see-here-for-data-subject = <a href="{ $dsar }">Ulteriori informazioni sulle richieste d’accesso ai propri dati personali trattati.</a>
# Variables:
#   $sumo (url) - link to https://support.mozilla.org/
privacy-index-for-product-support-requests = Per richiedere supporto sul prodotto, <a href="{ $sumo }">visita i nostri forum</a>.
privacy-index-data-privacy-principles = Privacy dei dati
# Variables:
