...
mission-our-mission-is-to-ensure-the-internet = Nuestra misión es asegurar que el Internet sea un recurso mundial, público, abierto y accesible a todos. Un internet que realmente pone a las personas primero, donde individuos pueden crear su propia experiencia - empoderados, seguros e independientes.
...
mission-read-the-mozilla-manifesto-to-learn = Lee el <a href="{ $url }">Manifiesto de Mozilla</a> para obtener más detalles sobre los valores y principios que guían la búsqueda de nuestra misión.
