...
vpn-ip-address-no-your-ip-v2 = No. Tu dirección IP solo está asociada con una ubicación a menos que estés usando una VPN (hablaremos de eso más adelante). Cuando estás en tu casa y te conectas al Internet por el que pagas, estás usando una. Sin embargo, si revisas tu correo electrónico en casa por la mañana, luego revisas las noticias en una cafetería local mientras esperas tu café y luego trabajas desde una oficina, habrás utilizado diferentes direcciones IP en cada ubicación.
# Outdated string
vpn-ip-address-no-your-ip = No. Tu dirección IP solo está asociada con una ubicación a menos que estés <a href="{ $url }">usando un VPN</a> (más adelante explicaremos eso). Cuando estás en tu casa y te conectas al iInternet por el que pagas, estás usando una. Sin embargo, si revisas tu correo electrónico en casa por la mañana, luego revisas las noticias en una cafetería local mientras esperas tu café, y más tarde trabajas desde una oficina, habrás usado diferentes direcciones IP en cada ubicación.
...
vpn-ip-address-how-do-you = ¿Cómo la escondes?
# Variables
...
#   $mozvpn (url) - https://www.mozilla.org/products/vpn/
#   $countries (number) - number of countries where Mozilla VPN has servers, e.g. "30". The + after indicates the number may be higher, where "30+" means "30 or more".
vpn-ip-address-a-vpn-is = Una VPN es una forma de ocultar tu dirección IP. <a href="{ $vpn }">Cuando usas una VPN</a>, tu dirección IP externa provendrá de la IP externa del servidor VPN, en lugar de la dirección IP externa de tu ubicación. Así que si tu servidor VPN de conexión está ubicado en California, tu IP externa dirá que te conectaste desde California, sin importar dónde estés. Además, tu actividad en línea se envía a través de una conexión cifrada y segura a tu servidor VPN, dándote seguridad y privacidad adicionales. <a href="{ $mozvpn }">{ -brand-name-mozilla-vpn }</a> es una forma de ocultar tu dirección IP. No guardamos registros de tu actividad, ni nos asociamos con plataformas de análisis de terceras partes. Ofrecemos protección de dispositivos completos para hasta cinco dispositivos con servidores en más de { $countries } países, puedes conectarte a cualquier lugar, desde cualquier lugar.
