...
vpn-download-version-requirements = Versión { $version } y más actuales
...
# Variables:
#   $version (number) - operating system version
vpn-download-for-linux-requirements = Ubuntu { $version } y más actuales
...
vpn-download-get-on-google-play = Descarga en { -brand-name-google-play } Store
vpn-download-get-on-app-store = Descarga en { -brand-name-app-store }
...
vpn-download-from-the-maker = Del creador de { -brand-name-firefox } y { -brand-name-mozilla-vpn } utiliza el avanzado <a href="{ $url }" { $attrs }>{ -brand-name-wireguard }</a>® Protocolo para cifrar tu actividad en línea y ocultar tu ubicación.
vpn-download-we-never-log = Nunca registramos, rastreamos ni compartimos los datos de tu red.
vpn-download-previous-versions = Descarga versiones anteriores de { -brand-name-windows } y { -brand-name-mac-short }
