...
# HTML page title
firefox-privacy-hub-firefox-privacy-promise = Promesa de privacidad de { -brand-name-firefox }
# HTML page description
firefox-privacy-hub-firefox-takes-less-data-keeps = { -brand-name-firefox } recoge menos datos, los mantiene seguros y sin secretos.
...
firefox-privacy-hub-learn-more-about-our-mission = Más información sobre nuestra misión
...
firefox-privacy-hub-learn-about-our-products = Más información sobre nuestros productos
...
firefox-privacy-hub-2000-trackers-blocked-automatically = Más de 2,000 rastreadores bloqueados de forma automática
...
firefox-privacy-hub-already-have-an-account = ¿Ya tienes una cuenta? <a { $sign_in } class="{ $class_name }">Conéctate</a> o <a href="{ $learn_more }">aprende más</a> acerca de cómo unirte a { -brand-name-firefox }.
# Variables:
#   $url (url) - link to https://www.mozilla.org/privacy/firefox/
firefox-privacy-hub-read-the-privacy-notice-for = Lee la <a href="{ $url }">política de privacidad</a> para nuestros productos
firefox-privacy-hub-mozilla-vpn = { -brand-name-mozilla-vpn }
firefox-privacy-hub-surf-stream-and-get-work = Navega, transmite y trabaja en servidores en más de 30 países con una conexión a Internet segura y una nueva perspectiva.
firefox-privacy-hub-get-mozilla-vpn = Obtén { -brand-name-mozilla-vpn }
