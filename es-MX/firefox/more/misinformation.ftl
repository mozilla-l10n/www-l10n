...
misinformation-page-desc = La desinformación es molesta, distrae y costosa. { -brand-name-firefox } tiene algunos consejos para evitar información falsa y ver menos cuando navegas por la web.
...
misinformation-disinformation = Información errónea, desinformación. Probablemente hayas oído estos términos en el pasado y te hayas preguntado cómo difieren en su significado. Lo que los distingue es la intención: La información errónea es cualquier tipo de información falsa en la que la gente podría caer. Puede verificarse  como incorrecta o engañosa, pero no fue creada ni compartida con la intención de engañar a la gente. Por otra parte, la desinformación se crea y difunde para desinformar y alcanzar un objetivo determinado.
misinformation-ultimately-harmful = Últimamente, tanto la información errónea como la desinformación pueden ser perjudiciales. No es solo que la gente crea información incorrecta, sino que la información falsa le cuesta mucho dinero a la economía mundial y puede amenazar la democracia y a una gobernanza eficiente. Y es difícil de parar porque las noticias falsas se difunden mucho más rápida, profunda y ampliamente que las noticias correctas.
...
misinformation-widespread-online = Puedes encontrar información errónea y desinformación en todas partes, pero se difunde e impacta más cuando se comparte en línea. Los algoritmos y <a href="{ $tracking }">rastreo</a> han aumentado la capacidad de informar erróneamente y desinformar para llegar a un público mayor en sitios web, blogs, foros y redes sociales.
...
misinformation-learn-about-our-products = Más información sobre nuestros productos
