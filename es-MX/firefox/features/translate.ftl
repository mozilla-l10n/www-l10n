...
features-translate-if-you-are = Si ya estás usando { -brand-name-firefox }, puedes cambiar el idioma de tu navegador o añadir idiomas a la interfaz de { -brand-name-firefox }. <a { $attrs }>Descubre cómo aquí.</a>
