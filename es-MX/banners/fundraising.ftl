...
banner-fundraising-title-v2 = Ayuda a { -brand-name-mozilla } a luchar por un mejor Internet esta temporada navideña.
banner-fundraising-title-giving-day = Ayuda a { -brand-name-mozilla } a luchar por un Internet mejor este martes de donaciones.
# Outdated string
banner-fundraising-title = El futuro se decide en línea. Ayuda a { -brand-name-mozilla } a luchar por una web para todos nosotros.
