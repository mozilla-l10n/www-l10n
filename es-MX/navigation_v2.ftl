...
navigation-v2-learn-how-each-firefox-product = Descubre cómo los productos de { -brand-name-firefox } protegen y respetan sus datos.
...
navigation-v2-work-for-a-mission-driven-updated = Trabaja para una organización motivada por la misión que hace productos que priorizan a las personas.
...
navigation-v2-close-innovation-menu = Cerrar menú de Innovación
