...
features-add-ons-firefox-add-ons = { -brand-name-firefox } ychwanegion
features-add-ons-firefox-add-ons-and-browser-extensions = { -brand-name-firefox } ychwanegion ac estyniadau porwr
