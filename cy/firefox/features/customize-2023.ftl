...
features-customize-you-can-find-more-free-custom = Gallwch ddod o hyd i fwy o themâu personol rhad ac am ddim yn <a { $amo }>addons.mozilla.org</a>. Porwch y <a { $top }">sgôr uchaf</a>, <a { $trending }>tueddiad</a> a <a { $recommended }>a argymhellir fwyaf</a>. Neu edrychwch am themâu yn ôl categori, gan gynnwys <a { $music }>music</a>, <a { $seasonal }>seasonal</a>, <a { $sports }>sports</a>, a <a { $nature } >natur</a> Teilwra'ch profiad at eich dant Creaduriaid ciwt, robotiaid drwg, tirweddau hardd - mae miloedd o opsiynau i wneud { -brand-name-firefox } eich hun.
# Used as accessible alternative text for an image
features-customize-image-of-three-custom-firefox = Delwedd o dair thema arferiad { -brand-name-firefox }: thema porffor a phinc tywyll gydag acenion gwyn ac oren, thema llwydfelyn golau yn cynnwys paentiad dyfrlliw o adar a blodau ceirios, a thema du a gwyrdd tywyll yn cynnwys lliw uchel. -tech patrwm circuitry.
