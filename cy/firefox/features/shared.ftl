...
features-shared-free-password-manager = Rheolwr cyfrineiriau
features-shared-customize-your-firefox-browser = Cyfaddaswch eich porwr { -brand-name-firefox }
features-shared-firefox-browser-sync = Cydweddu porwr { -brand-name-firefox }
features-shared-bookmark-manager = Rheolwr nodau tudalen
features-shared-private-browsing-mode = Y modd pori preifat
features-shared-firefox-add-ons-and-browser-extensions = Ychwanegion ac estyniadau porwr { -brand-name-firefox }
features-shared-pinned-browser-tabs = Tabiau porwr wedi'u pinio
features-shared-eyedropper-tool = Offeryn Dewisydd Lliw
features-shared-pdf-editor = Golygydd PDF
