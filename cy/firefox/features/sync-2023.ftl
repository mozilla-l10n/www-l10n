...
features-sync-sign-up-for-a-free-mozilla-account-v3 = <a { $fxa }>Cofrestrwch ar gyfer { -brand-name-mozilla-account }</a> am ddim a byddwch yn gallu cysoni eich data ym mhob man rydych yn defnyddio { -brand-name-firefox } ac arall { -brand-name-mozilla } cynnyrch.
# Obsolete string
#   $fxa (url) = link to https://www.mozilla.org/firefox/accounts/
