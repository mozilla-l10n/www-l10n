...
features-private-browsing-private-browsing-mode-will-not = Ni fydd modd pori preifat yn dileu unrhyw nodau tudalen newydd a wnewch o ffenestr bori breifat, nac yn eich amddiffyn rhag malware neu firysau. Nid yw ychwaith yn atal y gwefannau rydych chi'n ymweld â nhw rhag gweld ble rydych chi wedi'ch lleoli'n gorfforol nac yn atal eich darparwr gwasanaeth rhyngrwyd rhag logio'r hyn rydych chi'n ei wneud. Bydd angen <a href="{ $vpn }">VPN dibynadwy</a> arnoch ar gyfer hynny.
# Variables:
#   $chrome (url) = link to https://www.mozilla.org/firefox/browsers/incognito-browser/
features-private-browsing-compare-firefoxs-private-browsing = Cymharwch bori preifat { -brand-name-firefox } â <a href="{ $chrome }">modd anhysbys Chrome</a>.
