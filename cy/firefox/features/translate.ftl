...
features-translate-firefox-translations-is-a-built-in-v2 = Mae { -brand-name-firefox-translations } yn nodwedd gyfieithu integredig sy'n eich galluogi i bori'r we yn hawdd yn eich dewis iaith. Dysgwch fwy am sut mae'r nodwedd hon yn { -brand-name-firefox } yn gweithio, a sut mae { -brand-name-mozilla } yn helpu i gadw'r hyn rydych chi'n ei gyfieithu yn breifat.
...
features-translate-while-other-browsers-rely-on-v2 = Tra bod porwyr eraill yn dibynnu ar wasanaethau cwmwl, mae'r modelau iaith { -brand-name-firefox-translations } yn cael eu llwytho i lawr ar borwr y defnyddiwr a gwneir cyfieithiadau yn lleol, felly nid yw { -brand-name-mozilla } yn cofnodi pa dudalennau gwe rydych yn eu cyfieithu .
# Obsolete string (expires: 2025-02-17)
...
# Obsolete string (expires: 2025-02-17)
features-translate-the-languages-below-are-what = Mae'r ieithoedd isod yn cael eu cefnogi ar hyn o bryd gan y nodwedd Cyfieithiadau { -brand-name-firefox }:
