...
compare-shared-dashboard-to-review = Dangosfwrdd i adolygu tracwyr sydd wedi'u rhwystro
...
compare-shared-web-extensionsadd-ons = Estyniadau gwe/Ychwanegion
compare-shared-in-browser-screenshot-tool = Teclyn llun sgrin o fewn y porwr
compare-shared-os-availability = Argaeledd OS
...
compare-shared-portability = Cludadwyedd
...
compare-shared-security-and-privacy-strong = Diogelwch a <strong>Phreifatrwydd</strong>
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. If the translation includes multiple words, please choose a word to emphasize and wrap that word in the strong tag.
compare-shared-utility-strong = <strong>Gwasanaethau:</strong>
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. If the translation includes multiple words, please choose a word to emphasize and wrap that word in the strong tag.
...
compare-shared-download-firefox = Llwytho { -brand-name-firefox } i Lawr
compare-shared-download-firefox-browser = Llwytho { -brand-name-firefox-browser } i Lawr
compare-shared-download-the-app = Llwytho'r ap i lawr
compare-shared-desktop = Bwrdd Gwaith
compare-shared-brand-name-android = { -brand-name-android }
compare-shared-brand-name-ios = { -brand-name-ios }
compare-shared-compare-browsers = Cymharu Porwyr
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. If the translation includes multiple words, please choose a word to emphasize and wrap that word in the strong tag.
compare-shared-performance-strong = <strong>Perfformiad</strong>
