...
browsers-mobile-see-how-firefox-for-desktop-stacks-v2 = Gweld sut mae { -brand-name-firefox } ar gyfer penbwrdd yn pentyrru i borwyr eraill.
...
browsers-mobile-see-how-firefox-for-desktop-strong-v2 = Gweld sut mae { -brand-name-firefox } ar gyfer <strong>penbwrdd</strong> yn pentyrru i borwyr eraill.
# Obsolete string (expires 30 June 2024)
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words; please omit the strong tags if they need to be around multiple words in your language.
