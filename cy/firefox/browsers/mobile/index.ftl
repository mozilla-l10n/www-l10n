...
# Obsolete string
browsers-mobile-at-home-or-on-the-move = Gartref neu ar daith, rydych chi'n haeddu preifatrwydd ar bob dyfais. Mae Diogelwch Uwch rhag Tracio'n awtomatig ar bob porwr symudol { -brand-name-firefox }.
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words; please omit the strong tags if they need to be around multiple words in your language.
# Obsolete string
browsers-mobile-get-the-mobile-browser-privacy = Cael y porwr symudol sy'n rhoi eich <strong>preifatrwydd </strong> chi'n gyntaf
...
browsers-mobile-join-firefox-and-get-the-most = Ymunwch â { -brand-name-firefox } a chael y gorau o bob cynnyrch - ar draws pob dyfais.
# Variables:
#   $fxa_attr (string) - anchor link url and attributes
#   $accounts_attr (string) - anchor link url and attributes
browsers-mobile-already-have-an-account-sign = Eisoes â chyfrif? <a { $fxa_attr }>Mewngofnodwch</a> neu <a { $accounts_attr }> dysgu rhagor</a> am ymuno â { -brand-name-firefox }.
