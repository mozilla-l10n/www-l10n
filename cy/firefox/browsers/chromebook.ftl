...
browsers-chromebook-dropdown-copy = Estynnwch { -brand-name-firefox } { -brand-name-chromebook }
...
browsers-chromebook-while-a-chromebook = Er bod gan { -brand-name-chromebook } { -brand-name-chrome } eisoes wedi'i osod, mae llwytho i lawr a defnyddio { -brand-name-firefox } fel eich prif borwr yn dod a rhai manteision i chi:
