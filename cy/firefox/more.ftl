...
firefox-is-independent = Mae { -brand-name-firefox } yn annibynnol ac yn rhan o { -brand-name-mozilla } dim-er-elw, sy'n brwydro dros eich hawliau ar-lein ac yn gwneud y Rhyngrwyd yn agored ar gyfer pawb, ymhob man.
...
get-the-browsers = Mynnwch y porwyr sy'n rhoi eich preifatrwydd yn gyntaf - ac wedi gwneud erioed
get-the-privacy = Mynnwch y preifatrwydd rydych yn ei haeddu. Mae Diogelu rhag Tracio Uwch yn awtomatig ym mhob porwr Firefox.
...
easy-migration-of = Trosglwyddo dewisiadau a nodau tudalen hawdd pan fyddwch yn llwytho { -brand-name-firefox } { -brand-name-windows } i lawr.
firefox-respects-your = Mae { -brand-name-firefox } yn parchu eich preifatrwydd ar { -brand-name-mac-short }.
...
youll-never-guess = Fyddwch byth yn dyfalu pa borwr sydd â'r awch o ran cyflymder a nodweddion.
comparing-firefox-ie = Cymharu { -brand-name-firefox-browser } a { -brand-name-microsoft } { -brand-name-ie }
old-habits-that = Mae'n anodd newid hen arferion ond byddwch chi'n teimlo'n well pan fyddwch chi'n gwneud.
comparing-firefox-safari = Cymharu { -brand-name-firefox-browser } â { -brand-name-apple } { -brand-name-safari }
