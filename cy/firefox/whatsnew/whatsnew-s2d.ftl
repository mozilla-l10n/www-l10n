...
whatsnew-s2d-download-firefox-for-android = Llwytho i Lawr { -brand-name-firefox } { -brand-name-android } ac { -brand-name-ios }
whatsnew-s2d-want-privacy-on-every-device = Eisiau cael preifatrwydd ar bob dyfais?
...
whatsnew-s2d-qr-code-alt = Sganiwch y cod QR
