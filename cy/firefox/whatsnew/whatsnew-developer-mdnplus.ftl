...
developer-mdnplus-notifications = Hysbysiadau
developer-mdnplus-development-in-real-time = Datblygu byw: Cael rhybuddion personol
developer-mdnplus-the-web-doesnt-have-a = Does gan y We ddim cofnod newid, ond gall { -brand-name-mdn } helpu. Dilynwch dudalennau a chael hysbysiadau y mae modd eu haddasu pan fydd dogfennaeth yn newid, nodweddion CSS yn cael eu lansio, a APIs yn cael eu ryddhau.
developer-mdnplus-collections = Casgliadau
developer-mdnplus-build-your-perfect-library = Adeiladwch eich llyfrgell berffaith. Neu gadewch inni ei adeiladu i chi.
