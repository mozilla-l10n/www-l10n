...
privacy-passwords-use-mozilla-monitor = Defnyddiwch <a { $url_monitor }>{ -brand-name-mozilla-monitor }</a> i gadw llygad ar gyfeiriadau e-bost sy'n gysylltiedig â'ch cyfrifon. Os bydd eich cyfeiriad e-bost yn ymddangos mewn achos hysbys o dorri rheolau data corfforaethol, byddwch yn cael eich rhybuddio ac yn darparu camau i'w dilyn i amddiffyn y cyfrif yr effeithir arno.
# Obsolete string
#   $url_monitor (string) - link to https://monitor.firefox.com/ with additional attributes for analytics
...
privacy-passwords-randomness-can-be = Gall hap fod yn broblem, gan fod y cwestiynau diogelwch y mae gwefannau'n eu defnyddio yn aml hefyd yn bethau y mae pobl yn tueddu i wybod amdanoch chi, fel eich man geni, eich pen-blwydd, neu enwau eich perthnasau, neu y mae modd eu casglu o ffynonellau fel y cyfryngau cymdeithasol. Y newyddion da yw nad yw'r wefan yn poeni a yw'r ateb yn real ai peidio - gallwch chi ddweud celwydd! Ond byddwch yn gelwyddog gynhyrchiol: <strong>Rhowch atebion i'r cwestiynau diogelwch sy'n hir ac ar hap,</strong> fel eich cyfrineiriau.
...
privacy-passwords-when-youre-logged-v2 = Pan fyddwch wedi mewngofnodi i { -brand-name-firefox } gyda'ch { -brand-name-mozilla-account } , gallwch gysoni ar draws eich holl ddyfeisiau a chael mynediad i'ch cyfrineiriau o borwr symudol { -brand-name-firefox } . Dysgwch fwy am <a { $url_sumo_manager }>sut i ddefnyddio'r rheolwr cyfrinair integredig i'r eithaf</a>.
...
#   $url_sumo_2fa (string) - link to https://support.mozilla.org/kb/secure-firefox-account-two-step-authentication with additional attributes for analytics
privacy-passwords-your-mozilla-account = Gall eich { -brand-name-mozilla-account }, er enghraifft, gael ei ddiogelu gyda 2FA, <a { $url_sumo_2fa }>y gallwch ddysgu mwy amdano yma</a>.
