...
send-to-device-send-firefox = Anfonwch { -brand-name-firefox } i'ch ffôn neu dabled
send-to-device-your-download-link = Anfonwyd eich dolen llwytho i lawr.
...
send-to-device-send-to-another = Anfon i ddyfais arall
