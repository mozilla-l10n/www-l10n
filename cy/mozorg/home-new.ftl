...
home-mozilla-consists-of = Mae { -brand-name-mozilla } yn cynnwys dau sefydliad. Mae'r { -brand-name-mozilla-corporation } yn eiddo'n gyfan gwbl i'r corff dim-er-elw 501(c) { -brand-name-mozilla-foundation }. Mae hyn yn golygu nad ydym yn ddyledus i unrhyw gyfranddalwyr - dim ond i'n cenhadaeth.
...
home-that-one-time = Yr un tro i ni roi ein cod ffynhonnell i ffwrdd…
home-the-mozilla-project = Sefydlwyd project { -brand-name-mozilla } yn San Francisco yn 1998, pan wnaeth porwr { -brand-name-netscape } y penderfyniad radical i roi cod ei raglen i'r cyhoedd i adeiladu arno a'i wella. Bryd hynny, roedd gan un cwmni fonopoli llawn ar brofiad pobl o'r rhyngrwyd.
