...
home-mitchell-baker = Mitchell Baker, { -brand-name-mozilla } Prif Swyddog Gweithredol
home-mozilla-makes-privacy = Mae { -brand-name-mozilla } yn gwneud cynhyrchion sy'n parchu preifatrwydd
...
home-product-relay-masks = E-bost a masgiau ffôn hawdd eu defnyddio
...
home-mozilla-takes-bets = “Mae { -brand-name-mozilla } yn cymryd betiau i ddangos i’r byd bod busnes i’w wneud gydag AI dibynadwy. Mae hynny’n cynnwys rhoi pethau fel hawliau dynol, diogelu data a thryloywder wrth wraidd y ffordd y mae’r systemau cymhleth hyn yn gweithio.”
# Politico is a brand name for a news organization
home-politico-cite = Gwleidyddiaeth
home-is-mozilla-a-corporation = Ydy { -brand-name-mozilla } yn gorfforaeth neu'n gorff di-elw? Mewn gwirionedd, y ddau.
home-mozilla-consists-of = Mae { -brand-name-mozilla } yn cynnwys dau sefydliad. Mae'r { -brand-name-mozilla-corporation } yn eiddo'n gyfan gwbl i'r di-elw 501(c) { -brand-name-mozilla-foundation }. Sy'n golygu nad ydym yn amlwg i unrhyw gyfranddalwyr - dim ond i'n cenhadaeth.
home-learn-about-mofo = Dysgu am y { -brand-name-mozilla-foundation }
home-join-the-fight = Ymunwch â'r frwydr dros rhyngrwyd iach
home-your-voice-your-code = Eich llais. Eich cod. Eich syniadau. Yn llythrennol mae miloedd o ffyrdd y gallwch gyfrannu at { -brand-name-mozilla }.
home-volunteer-with-mozilla = Gwirfoddoli gyda { -brand-name-mozilla }
home-that-one-time = Y tro hwnnw fe wnaethon ni roi ein cod ffynhonnell i ffwrdd …
home-the-mozilla-project = Sefydlwyd y prosiect { -brand-name-mozilla } yn San Francisco yn 1998, pan wnaeth porwr { -brand-name-netscape } y penderfyniad radical i roi cod ei raglen i'r cyhoedd i adeiladu arno a'i wella. Bryd hynny, roedd gan un cwmni fonopoli rhithwir ar brofiad pobl o'r rhyngrwyd.
home-eventually-the-open = Yn y pen draw, trawsnewidiodd y prosiect ffynhonnell agored { -brand-name-mozilla } i mewn i'r fersiwn gyntaf hynod boblogaidd o { -brand-name-firefox }.
