...
manifesto-details-the-mozilla-project-global-v2 = Mae'r Project { -brand-name-mozilla } yn gymuned fyd-eang o bobl sy'n credu bod bod yn agored, arloesol a chynnig cyfleoedd yn allweddol i iechyd parhaus y rhyngrwyd. Rydym wedi gweithio gyda’n gilydd ers 1998 i sicrhau bod y rhyngrwyd yn cael ei datblygu mewn ffordd sydd o fudd i bawb. Rydym yn fwyaf adnabyddus am greu porwr gwe { -brand-name-mozilla } { -brand-name-firefox }.
...
manifesto-details-the-mozilla-project-community-v2 = Mae'r Project { -brand-name-mozilla } yn defnyddio dull cymunedol i greu meddalwedd cod agored o'r radd flaenaf ac i ddatblygu mathau newydd o weithgareddau cydweithredol. Rydym yn creu cymunedau o bobl sy'n ymwneud â gwneud y profiad rhyngrwyd yn well i bob un ohonom.
# Obsolete string (expires 2026-09-20)
...
manifesto-written-in-2007 = Mae Maniffesto { -brand-name-mozilla }, a ysgrifennwyd yn 2007, yn amlinellu ein hegwyddorion craidd. Ysgrifennwyd The Pledge for a Healthy Internet fel atodiad i'r Maniffesto yn 2017 i adlewyrchu ein hymrwymiad dwfn i sicrhau bod y rhyngrwyd yn gwasanaethu anghenion bodau dynol a'r ddynoliaeth gyfan. Gyda'i gilydd, mae'r ddwy ddogfen hyn yn arwain yr holl waith ar draws { -brand-name-mozilla } — yr hyn yr ydym yn ei adeiladu, yr hyn yr ydym yn ei ariannu a sut yr ydym yn gweithio gyda'n gilydd fel cymuned.
manifesto-mozillas-pledge = Addewid { -brand-name-mozilla }
manifesto-across-the-mozilla-project = Ar draws Project { -brand-name-mozilla } a phob sefydliad yn y teulu { -brand-name-mozilla }, rydym yn addo cefnogi Maniffesto { -brand-name-mozilla } yn ei weithgareddau. Yn benodol, byddwn yn:
...
manifesto-we-create-open = Rydym yn creu <a { $github_link }>meddalwedd cod agored</a> y gallwch adeiladu arno.
# Variables:
#   $mofo_link (url) - link to https://www.mozillafoundation.org/
manifesto-we-fund-fellows = Rydym yn <a { $mofo_link }>ariannu cymrodyr a phrojectau cynnar</a> gyda'r nod o greu dyfodol gwell ar-lein.
# Variables:
#   $mozai_link (url) - link to https://www.mozilla.ai
manifesto-we-build-open-source = Rydym <a { $mozai_link }>yn adeiladu offer AI cod agored</a> sy'n rhoi dewis i ddatblygwyr — ac yn eu helpu i arbed arian.
# Variables:
#   $mozvc_link (url) - link to https://mozilla.vc
manifesto-we-invest-in = Rydym yn <a { $mozvc_link }>buddsoddi mewn cwmnïau cychwyn technoleg cyfrifol</a>.
# Variables:
...
manifesto-we-host-a-yearly = Rydym yn <a { $festival_link }>cynnal cynulliad byd-eang blynyddol</a> ar gyfer pobl sy'n adeiladu unrhyw beth a phopeth i hyrwyddo'r Maniffesto.
# Variables:
#   $firefox_link (url) - link to https://www.firefox.com/
#   $thunderbird_link (url) - link to https://www.thunderbird.net/
manifesto-we-make-firefox-and-thunderbird = Ac, wrth gwrs, rydym ni'n cynhyrchu <a { $firefox_link }>{ -brand-name-firefox }</a> a <a { $thunderbird_link }>{ -brand-name-thunderbird }</a>). Nod hyn oll yw helpu pobl i wneud y rhyngrwyd yn lle iach.
