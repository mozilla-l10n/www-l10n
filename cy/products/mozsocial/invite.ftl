...
# HTML page title
mozsocial-invite-join-the-waitlist = Ymunwch â'r rhestr aros ar gyfer { -brand-name-mozilla-social }
mozsocial-invite-welcome-to-mozillasocial = Croeso i { -brand-name-mozilla-social }!
mozsocial-invite-please-join-our-waitlist = Ymunwch â'n rhestr aros trwy lenwi'r ffurflen isod.
mozsocial-invite-required-label = Angenrheidiol
mozsocial-invite-first-name-label = Enw cyntaf
mozsocial-invite-last-name-label = Enw olaf
