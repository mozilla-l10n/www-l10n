...
vpn-features-with-the-mozilla-vpn-extention = Gyda'r Estyniad { -brand-name-mozilla-vpn } ar gyfer { -brand-name-firefox } (Windows yn unig), gallwch chi fireinio eich profiad VPN fesul gwefan. Eithrio gwefannau unigol o amddiffyniad VPN neu osod lleoliadau gweinydd a ffefrir ar gyfer gwefannau penodol, gan roi profiad mwy hyblyg a phersonol i chi.
