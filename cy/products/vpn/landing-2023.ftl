...
# HTML page title
vpn-landing-title = { -brand-name-mozilla-vpn }: Diogelu Eich Dyfais Gyfan
# HTML page description
# Variables:
#   $countries (number) - number of available countries
vpn-landing-desc = Defnyddiwch { -brand-name-mozilla-vpn } i ddiogelu dyfais lawn ar gyfer pob ap. Gyda gweinyddwyr mewn { $countries }+ o wledydd, gallwch gysylltu ag unrhyw le, o unrhyw le.
vpn-landing-powerful-privacy-for-peace = Preifatrwydd pwerus ar gyfer tawelwch meddwl
vpn-landing-whats-a-vpn = Beth yw VPN?
vpn-landing-a-virtual-private-network-protects = Mae rhwydwaith preifat rhithwir yn amddiffyn eich cysylltiad â'r rhyngrwyd, gan gadw'ch lleoliad a'r hyn a wnewch ar-lein yn fwy preifat ar draws eich dyfeisiau.
vpn-landing-see-all-the-ways-mozilla-vpn = Gweld yr holl ffyrdd y mae { -brand-name-mozilla-vpn } yn eich amddiffyn.
...
vpn-landing-hide-your-activity-from = Cuddiwch eich gweithgaredd rhag olrheinwyr a meddalwedd faleisus fel y gallwch chi siopa heb gael eich gwylio.
...
vpn-landing-fast-network-speeds-even-while = Cyflymder rhwydwaith cyflym hyd yn oed wrth hapchwarae
vpn-landing-no-logging-tracking-or-sharing = Dim logio, olrhain na rhannu data rhwydwaith
vpn-landing-no-bandwidth-restrictions-or = Dim cyfyngiadau lled band na sbardun
vpn-landing-extra-security-whole-device = Diogelwch ychwanegol: amddiffyn dyfais gyfan, llwybro aml-hop a mwy
vpn-landing-see-all-features = Gweler yr holl nodweddion
vpn-landing-fram-a-brand-you-can-trust = O frand y gallwch ymddiried ynddo
vpn-landing-mozilla-is-a-non-profit-backed = Mae { -brand-name-mozilla } yn gwmni rhyngrwyd dielw sydd wedi bod yn ymladd dros we iach ers 1998.
