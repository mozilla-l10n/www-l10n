...
vpn-download-faq-need-help = Angen help i ddechrau?
vpn-download-faq-here-are-some = Dyma rai o'r cwestiynau mwyaf cyffredin am osod { -brand-name-mozilla-vpn }
...
vpn-download-faq-encrypting = Amgryptio eich traffig rhyngrwyd: felly ni all unrhyw un ar y wifren sbïo ar eich gweithgaredd ar-lein.
vpn-download-faq-working = Sut ydw i'n gwybod bod y VPN yn gweithio?
# Variables:
