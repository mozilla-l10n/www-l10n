...
vpn-download-page-title = Llwythwch { -brand-name-mozilla-vpn } i Lawr
vpn-download-page-description = Llwythwch i Lawr { -brand-name-mozilla-vpn } ar gyfer { -brand-name-windows }, { -brand-name-mac }, { -brand-name-linux }, { -brand-name-android }, ac { -brand-name-ios }.
# Variables:
#   $devices (number) - maximum number of connected devices
vpn-download-sub-heading = Gallwch lwytho i lawr { -brand-name-mozilla-vpn } ar hyd at { $devices } dyfeisiau gydag un tanysgrifiad.
...
vpn-download-get-mozilla-vpn = Cael { -brand-name-mozilla-vpn }
vpn-download-privacy-you-can = Preifatrwydd y gallwch ymddiried ynddo
vpn-download-also-available = Ar gael hefyd ar gyfer:
# Variables:
...
vpn-download-install-via-flathub = Gosod trwy Flathub
