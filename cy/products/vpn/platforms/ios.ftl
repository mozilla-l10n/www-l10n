...
vpn-ios-privacy-copy = Mae { -brand-name-mozilla-vpn } yn hawdd iawn i'w ddefnyddio. Tapiwch fotwm a bydd yn amgryptio'ch cysylltiad ac yn cymylu'r cyfeiriad IP ar eich { -brand-name-iphone } neu { -brand-name-ipad } gan ddefnyddio protocol uwch { -brand-name-wireguard }®.
# Variables:
