...
vpn-mobile-hackers-can-steal-v2 = Gall hacwyr ddwyn eich data personol pan fyddwch yn defnyddio Wi-Fi cyhoeddus, megis mewn caffis neu feysydd awyr.
# Obsolete string
vpn-mobile-hackers-can-steal = Gall hacwyr ddwyn eich data personol pan fyddwch yn defnyddio Wi-Fi cyhoeddus, megis mewn caffis neu feysydd awyr
vpn-mobile-a-vpn-works = Mae VPN yn gweithio ar draws eich dyfais, nid eich porwr yn unig, felly ar draws eich apiau symudol hefyd. Ac yn wahanol i VPNs neu wefannau dirprwy am ddim, a all dalu am eu gweinyddwyr trwy ysbïo arnoch chi a gwerthu'ch gwybodaeth, nid yw { -brand-name-mozilla } yn cadw cofnodion o ble rydych chi'n mynd a beth rydych chi'n ei wneud.
