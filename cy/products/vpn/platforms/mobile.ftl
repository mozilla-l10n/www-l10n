...
# Meta strings
vpn-mobile-page-title = { -brand-name-mozilla-vpn } ar gyfer symudol (ffonau clyfar a thabledi)
vpn-mobile-page-description = Diogelwch eich ffôn clyfar a'ch tabled gyda VPN rhag { -brand-name-mozilla }, yr arloeswr dibynadwy ym mhreifatrwydd y rhyngrwyd.
# Mobile strings
vpn-mobile-hero-headline = Diogelwch eich preifatrwydd ar ffôn symudol gyda { -brand-name-mozilla-vpn }
vpn-mobile-maker-of-firefox = Sicrhewch fod cysylltiad rhyngrwyd eich ffôn yn parhau i fod yn breifat, i lle bynnag mae'ch diwrnod yn mynd â chi gyda { -brand-name-mozilla-vpn }, teclyn preifatrwydd hanfodol gan wneuthurwyr { -brand-name-firefox }.
# Variables:
#   $devices (number) - number of available devices
vpn-mobile-ability = Mae { -brand-name-mozilla-vpn } yn atal hacwyr ac ysbïwyr rhag gweld eich cyfeiriad IP ac yn cuddio'ch lleoliad ar-lein. Gydag amgryptio datblygedig a dim cyfyngiadau lled band, mae'n gwneud ffrydio a phori ar eich ffôn clyfar neu dabled yn hynod gyflym ac yn ddibynadwy ddiogel. Am ffi fisol fach, gallwch ddiogelu hyd at { $devices } dyfais a chysylltu â dwsinau o weinyddion ledled y byd.
vpn-mobile-wifi-headline = Teimlwch yn ddiogel pan yn defnyddio wifi cyhoeddus
vpn-mobile-wifi-copy = Mae ein VPN yn diogelu'ch cysylltiad rhyngrwyd rhag hacwyr ac ysbïwyr, fel y gallwch chi siopa o'r siop goffi, gwirio'ch cyfrif banc o'r trên a mynd ymlaen â'ch busnes ar-lein yn unrhyw le heb bryderon diogelwch.
