...
vpn-linux-linux-is-free = Mae Linux yn rhad ac am ddim, yn god agored, ac yn gyfaddasadwy, ond nid yw'n rhydd o faterion diogelwch a phreifatrwydd ar-lein. Yn union fel defnyddwyr systemau gweithredu eraill, mae defnyddwyr Linux yn wynebu sensoriaeth, gwyliadwriaeth a hacio.
...
vpn-linux-multi-hop = <strong>Llwybrau aml-naid:</strong> Er mwyn cael mwy o ddiogelwch, gall { -brand-name-mozilla-vpn } amgryptio'ch traffig a'i gyfeirio trwy ddau leoliad yn lle un, gan ei gwneud hi'n anoddach i unrhyw un dracio eich gweithgaredd ar-lein .
vpn-linux-simple-and = <strong>Rhyngwyneb syml a greddfol:</strong> Cysylltwch â gweinydd gydag un clic. Gallwch hefyd gyfaddasu eich gosodiadau a dewisiadau yn ôl eich anghenion.
vpn-linux-it-helps-restore = <strong>Mae'n helpu i adfer niwtraliaeth gwe:</strong> Mae { -brand-name-mozilla-vpn } yn eich helpu i adennill rheolaeth ar eich gweithgareddau ar-lein drwy atal darparwyr rhyngrwyd rhag gyfyngu ar eich lled band, neu rhag rhwystro gwefannau neu wasanaethau nad ydyn nhw'n eu hoffi, neu sy'n cystadlu â'u cynnyrch nhw.
vpn-linux-gui-client = <strong>Rhyngwyneb Graffigol:</strong> Mae gan { -brand-name-mozilla-vpn } raglen rhyngwyneb defnyddiwr graffigol, tra bod rhai darparwyr VPN yn darparu fersiwn llinell orchymyn.
vpn-linux-by-using = Trwy ddefnyddio { -brand-name-mozilla-vpn }, gallwch adennill rheolaeth dros eich gweithgareddau ar-lein a diogelu eich preifatrwydd a data. Llwythwch { -brand-name-mozilla-vpn } heddiw a mwynhewch warant arian yn ôl 30 diwrnod heb unrhyw gofnodi, ffwdan, na risg.
...
vpn-linux-ubuntu-graphical = <strong>Rhyngwyneb defnyddiwr graffigol Ubuntu:</strong> Ewch at <a { $attrs }>yr erthygl hon</a> a dilynwch y cyfarwyddiadau yn yr adran Ychwanegu archifau pecynnau personol.
# Variables:
#   $attrs (string) includes url - https://github.com/mozilla-mobile/mozilla-vpn-client/
vpn-linux-additionally = Hefyd, ar gyfer dosbarthiadau Linux heb eu cefnogi, gallwch gymryd a chrynhoi'r cod ffynhonnell o <a { $attrs }>storfa swyddogol GitHub</a>.
