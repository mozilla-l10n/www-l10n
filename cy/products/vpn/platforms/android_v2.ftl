...
vpn-android-why-should-i = Pam ddylwn i lwytho i lawr { -brand-name-mozilla-vpn } ar gyfer Android?
vpn-android-browse-the-internet = Porwch y rhyngrwyd heb ddatgelu eich lleoliad.
vpn-android-be-more-comfortable = Bod yn fwy cyfforddus yn defnyddio Wi-Fi cyhoeddus mewn caffis, meysydd awyr, a mwy.
vpn-android-avoid-intrusive = Osgoi hysbysebu ymwthiol seiliedig ar leoliad.
vpn-android-the-mozilla-vpn-mobile = Mae ap symudol { -brand-name-mozilla-vpn } yn fach, felly nid yw'n defnyddio gormod o'ch cof, ac ni fydd yn arafu'ch ffôn nac yn llosgi trwy'ch batri.
vpn-android-unlike-free = Yn wahanol i VPNs neu wefannau dirprwy am ddim, a all dalu am eu gweinyddwyr trwy ysbïo arnoch chi a gwerthu eich manyion, nid yw { -brand-name-mozilla } yn cadw cofnodion o ble rydych chi'n mynd a beth rydych chi'n ei wneud.
