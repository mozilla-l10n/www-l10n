...
vpn-ip-address-yes-even-if = Ydw. Hyd yn oed os ydych chi'n defnyddio'r rhyngrwyd gartref yn unig, gall cyfeiriad IP eich cartref newid. Gallwch gysylltu â'ch darparwr gwasanaeth rhyngrwyd (ISP) i'w newid, ond gallai hyd yn oed rhywbeth mor arferol ag ailgychwyn eich modem neu'ch llwybrydd oherwydd problemau cysylltiad rhyngrwyd arwain at newid.
