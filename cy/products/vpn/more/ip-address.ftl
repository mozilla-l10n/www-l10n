...
vpn-ip-address-a-vpn-is-v2 = Mae VPN yn ffordd i guddio'ch cyfeiriad IP. <a href="{ $vpn }">Pan fyddwch yn defnyddio'ch VPN</a>, bydd eich cyfeiriad IP allanol yn dod o IP allanol gweinydd VPN, yn hytrach na chyfeiriad IP allanol eich lleoliad. Felly os yw'ch gweinydd VPN cysylltiol wedi'i leoli yng Nghaliffornia, bydd eich IP allanol yn edrych fel ei fod wedi'i gysylltu o California, lle bynnag rydych chi mewn gwirionedd. Hefyd, mae eich gweithgaredd ar-lein yn cael ei anfon dros gysylltiad diogel wedi'i amgryptio i'ch gweinydd VPN, gan gynnig diogelwch a phreifatrwydd ychwanegol. Mae <a href="{ $mozvpn }">{ -brand-name-mozilla-vpn }</a> yn un ffordd i guddio'ch cyfeiriad IP. Nid ydym yn cadw cofnodion gweithgaredd nac yn partneru gyda llwyfannau dadansoddeg trydydd parti. Rydym yn cynnig diogelwch dyfais lawn ar gyfer hyd at bum dyfais gyda gweinyddwyr mewn { $countries }+ gwlad, gallwch gysylltu ag unrhyw le, o unrhyw le.
# Obsolete string
# Variables
#   $vpn (url)- https://www.mozilla.org/products/vpn/more/what-is-a-vpn/
#   $mozvpn (url) - https://www.mozilla.org/products/vpn/
