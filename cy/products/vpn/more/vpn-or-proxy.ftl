...
vpn-or-proxy-the-difference-between = Y gwahaniaeth rhwng VPN a dirprwy we
...
vpn-or-proxy-a-vpn-also = Mae VPN hefyd yn cynnig diogelwch ar gysylltiadau WiFi agored a chyhoeddus. Gall WiFi agored fod yn beryglus, ac mae'n amhosibl bod yn siŵr nad yw rhywun arall yn cysylltu â'r un rhwydwaith i edrych ar yr hyn rydych chi'n ei wneud. Hyd yn oed os yw'ch traffig wedi'i amgryptio, gallan nhw weld pa wefannau rydych chi'n ymweld â nhw o hyd. Ac os ydych chi'n defnyddio ap nad oes ganddo amgryptio - a hyd yn oed heddiw, mae yna lawer sydd ddim - yna maen nhw'n gallu gweld popeth rydych chi'n ei wneud yn yr ap hwnnw. Mae { -brand-name-mozilla-vpn } yn wasanaeth cyflym, diogel a dibynadwy a all helpu i gau'r bwlch diogelwch i chi. Mae <a href="{ $mozvpn }">{ -brand-name-mozilla-vpn }</a> hefyd yn caniatáu i chi ddewis eich “lleoliad” (o le mae'n ymddangos bod eich traffig yn dod) o fwy na { $countries } gwlad.
vpn-or-proxy-choose-a-trustworthy = Dewiswch wasanaeth dibynadwy
# Variables
...
vpn-or-proxy-weve-done-the = Rydym wedi gwneud y gwaith caled i sicrhau bod y <a href="{ $mozvpn }"> { -brand-name-mozilla-vpn } </a>a'r<a href="{ $fpn }">{ -brand-name-firefox-private-network }</a> estyniad dirprwy yn parchu eich preifatrwydd go iawn, ac mae'n rhywbeth rydyn ni'n barod i'w gefnogi gyda'n enw da. Mae gan { -brand-name-mozilla } enw da am adeiladu cynnyrch sy'n eich helpu i gadw'ch manylion yn ddiogel. Rydym yn dilyn ein hegwyddorion <a href="{ $principles }">Egwyddorion Preifatrwydd Data</a> hawdd eu darllen, sy'n caniatáu inni ganolbwyntio ar y wybodaeth sydd ei hangen arnom i ddarparu gwasanaeth yn unig. A chan ein bod yn cael ein cefnogi gan gwmni <a href="{ $mission }">sy'n cael ei yrru gan genhadaeth</a>, gallwch ymddiried y bydd yr arian rydych chi'n eu gwario ar gyfer y cynnyrch hwn nid yn unig yn sicrhau bod gennych ddiogelwch o'r radd flaenaf, ond hefyd yn gwneud y rhyngrwyd yn well i bawb.
