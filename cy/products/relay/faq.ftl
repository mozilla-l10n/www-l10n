...
faq-question-longevity-question = Beth fydd yn digwydd os bydd { -brand-name-mozilla }'n cau gwasanaeth { -brand-name-firefox-relay }?
...
# Variables:
#  $size (number): maximum size for attachments in MB
faq-question-attachments-answer-v2 = Rydym nawr yn cefnogi anfon atodiadau anfon ymlaen. Fodd bynnag, mae terfyn o { $size } MB ar gyfer anfon e-byst anfon ymlaen sy'n defnyddio { -brand-name-relay }. Ni fydd unrhyw e-byst sy'n fwy na { $size } MB yn cael eu hanfon ymlaen.
...
phone-masking-faq-question-what-is = Beth yw cuddio rhifau ffôn
phone-masking-faq-answer-what-is = Yn debyg i arallenw e-bost, mae cuddio rhifau ffôn yn rhif ffôn a all anfon negeseuon testun a galwadau ymlaen at eich gwir rif ffôn. Fydd hyn ddim yn ddatgelu beth yw eich gwir rif i'r sawl sy'n eich ffonio neu'n anfon neges destun atoch.
phone-masking-faq-question-where-is = Lle mae cuddio ffôn ar gael?
...
phone-masking-faq-answer-can-reply = Gallwch, gallwch ateb y testun diwethaf gawsoch chi. Atebwch fel y byddech ar gyfer unrhyw neges destun.
...
phone-masking-faq-question-limit = A oes cyfyngiad ar faint o negeseuon testun rwy'n eu cael?
phone-masking-faq-answer-limit = Gallwch dderbyn ac ateb hyd at 75 o negeseuon testun y mis. Ni fydd unrhyw negeseuon testun ychwanegol sy'n cael eu hanfon at eich rhif ffôn cudd yn cael eu hanfon ymlaen at eich gwir rif. Ni fydd unrhyw atebion ychwanegol yn cael eu darparu. Mae'r mis yn troi drosodd ar eich dyddiad bilio, nid y dyddiad calendr. Unwaith y bydd eich mis bilio wedi troi drosodd, byddwch yn dechrau derbyn negeseuon testun eto.
phone-masking-faq-question-call-length = Pa mor hir y gallaf siarad pan fyddaf yn cael galwad?
phone-masking-faq-answer-call-length = Bob mis byddwch yn cael 50 munud o amser siarad. Unwaith y bydd y cofnodion hyn wedi dod i ben, fyddwch chi ddim yn gallu derbyn galwadau a anfonwyd ymlaen tan y mis nesaf ar eich cylch bilio.
phone-masking-faq-question-can-i-call = A allaf ffonio rhywun gyda fy rhif ffôn cudd?
phone-masking-faq-answer-can-i-call = Na, dim ond galwad a anfonwyd ymlaen y gallwch chi ei dderbyn.
phone-masking-faq-question-can-i-see = A allaf weld pwy anfonodd neges destun neu fy ffonio i?
...
phone-masking-faq-question-how-i-save-card = Sut mae cadw cerdyn cyswllt { -brand-name-relay }?
