...
data-preferences-page-title = Rheolwch eich dewisiadau casglu data parti cyntaf
data-preferences-page-desc = Mae eich preifatrwydd yn bwysig iawn i { -brand-name-mozilla }. Bydd y dudalen hon yn eich galluogi i reoli eich dewisiadau casglu data parti cyntaf gwefannau mozilla.org gan ddefnyddio { -brand-name-glean }.
data-preferences-notification-opt-out = Rydych wedi eich eithrio o gasglu data parti cyntaf.
data-preferences-notification-opt-in = Rydych wedi eich eithrio o gasglu data parti cyntaf.
# Variables:
...
data-preferences-your-privacy = Mae eich preifatrwydd yn bwysig iawn i { -brand-name-mozilla }. Mae ein platfform telemetreg a dadansoddeg parti cyntaf, o'r enw <a href="{ $glean }">{ -brand-name-glean }</a>, yn dilyn ein safonau uchel ein hunain ar <a href="{ $lean_data }" >arferion data darbodus</a>.
# Variables:
