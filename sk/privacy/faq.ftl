...
privacy-faq-mozilla-doesnt-know-as-much = { -brand-name-mozilla } o vás nevie toľko, ako by ste možno čakali. Ako tvorcovi webového prehliadača nám to však občas sťažuje prácu. Preto máme nástroje ako <a href="{ $link }">{ -brand-name-firefox } Pioneer</a>, pomocou ktorých nám môžete poskytnúť náhľad do svojho prehliadania. Ak synchronizujete svoju históriu prehliadania naprieč zariadeniami, vašu históriu nepoznáme, pretože je šifrovaná vašim zariadením.
