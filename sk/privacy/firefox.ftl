...
privacy-firefox-transparency-first = Transparentnosť na prvom mieste
# Variables:
...
privacy-firefox-firefox-protects-you = { -brand-name-firefox } vás chráni pred známymi sledovacími nástrojmi tretích strán, sledovacími nástrojmi sociálnych médií, ťažobnými nástrojmi kryptomien, súbormi cookie a technológiami odtlačkov prstov, ktoré sa vás snažia sledovať na webe.
