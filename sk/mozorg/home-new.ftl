...
home-internet-for-people-not-profit = Internet pre ľudí, nie zisk
...
home-mission-driven = Riadený misiou. Poháňaný ľuďmi.
...
home-cta-get-fakespot = Získajte { -brand-name-fakespot }
...
home-volunteer-with-mozilla = Staňte sa dobrovoľníkom v { -brand-name-mozilla(case: "loc") }
home-that-one-time = Jedného dňa sme sprístupnili náš zdrojový kód…
home-the-mozilla-project = Projekt { -brand-name-mozilla } bol založený v San Franciscu v roku 1998, keď prehliadač { -brand-name-netscape } urobil radikálne rozhodnutie poskytnúť svoj zdrojový kód verejnosti, aby na ňom mohla stavať a zlepšovať ho. V tom čase mala jedna spoločnosť virtuálny monopol na to, ako ľudia prežívali internet.
...
home-feature-blur-your-location = Rozmažte svoju polohu a aktivitu pomocou <span>{ -brand-name-mozilla-vpn }</span>
# Mozilla Foundation donation promo
home-mofo-build-our-movement = Budujte naše hnutie
home-mofo-donate-to-mofo-today = Prispejte { -brand-name-mozilla-foundation } ešte dnes, aby ste zabezpečili, že internet zostane otvorený a prístupný pre všetkých.
home-mofo-donate = Prispieť
