...
plan-matrix-offer-body-v2 = { -brand-name-firefox-relay } chráni vašu identitu a vašu schránku s doručenou poštou pomocou jedinečných e‑mailových masiek. Ešte väčšiu bezpečnosť získate vďaka maskovaniu telefónu pomocou { -brand-name-relay } a ušetrite { $savings } % pridaním ochrany pomocou { -brand-name-mozilla-vpn }.
...
plan-matrix-heading-plan-free = Obmedzená ochrana e‑mailu
plan-matrix-heading-plan-premium = Ochrana e‑mailu
plan-matrix-heading-plan-phones = Ochrana e-mailu a telefónu
plan-matrix-heading-plan-bundle-v2 = Pridaná ochrana VPN
...
# Variables:
#   $savings (string) - the percentage saved for a given plan, not including the % Examples: 50, 70
plan-matrix-price-vpn-discount-promo-v2 = <span>Ušetríte { $savings } %</span> na bežnej cene VPN
