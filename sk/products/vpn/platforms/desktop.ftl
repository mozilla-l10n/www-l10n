...
# Meta strings
vpn-desktop-page-title = { -brand-name-mozilla-vpn } pre počítače (stolné počítače a laptopy)
vpn-desktop-page-description = Získajte rýchle a jednoduché zabezpečenie svojho stolného či prenosného počítača vďaka { -brand-name-mozilla(case: "dat") }, jednej z najdôveryhodnejších značiek v oblasti technológií.
# Desktop strings
vpn-desktop-hero-headline = Zabezpečte si svoje internetové pripojenie pomocou { -brand-name-mozilla-vpn } pre počítače
# Variables:
#   $devices (number) - number of available devices
vpn-desktop-ability = { -brand-name-mozilla-vpn } vám dáva možnosť pripojiť sa s istotou a chrániť svoje informácie pred zvedavými očami a zlodejmi údajov, keď ste online. { -brand-name-mozilla-vpn } používa pokročilý protokol { -brand-name-wireguard }® na šifrovanie osobných údajov na vašom notebooku alebo stolnom počítači – až pre { $devices } zariadení. Streamujte relácie, hrajte hry, nakupujte a venujte sa svojmu každodennému životu online s vedomím, že ste v bezpečí.
vpn-desktop-maker-of-firefox = Ako tvorca webového prehliadača { -brand-name-firefox } a jeden z najdôveryhodnejších bojovníkov za súkromie na internete sa { -brand-name-mozilla } zaviazala zabezpečiť, aby ste sa pri každom pripojení k internetu cítili bezpečne a rešpektovaní.
