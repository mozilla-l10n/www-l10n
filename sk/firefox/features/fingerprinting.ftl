...
features-fingerprinting-you-probably-wouldnt = Pravdepodobne by ste neocenili, keby niekto sledoval váš pohyb v reálnom živote. Nie je dôvod akceptovať to online. Ak ešte nemáte { -brand-name-firefox }, <a { $url_download }>stiahnite si a chráňte sa</a> pred digitálnymi odtlačkami.
