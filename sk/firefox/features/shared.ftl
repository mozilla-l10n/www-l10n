...
features-shared-footer-cta-button = Stiahnite si { -brand-name-firefox }
...
features-shared-pinned-browser-tabs = Pripnuté karty prehliadača
features-shared-eyedropper-tool = Nástroj Kvapkadlo
features-shared-pdf-editor = Editor PDF
features-shared-fingerprinter-blocking = Blokovanie snímania digitálnych odtlačkov
