...
firefox-products-get-the-browser-that-blocks = Získajte prehliadač, ktorý automaticky blokuje viac ako 2 000 sledovacích prvkov. Rozšírená ochrana pred sledovaním je štandardom v každom { -brand-name-firefox(case: "loc") }.
...
firefox-products-get-relay = Získajte { -brand-name-firefox-relay }
