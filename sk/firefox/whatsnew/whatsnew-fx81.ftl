...
# html page title
whatsnew81-page-title = Novinky vo { -brand-name-firefox(case: "loc") }
# Main title
...
whatsnew81-make-firefox-your-everyday = Nastavte si { -brand-name-firefox } ako svoj predvolený prehliadač na { -brand-name-ios }
whatsnew81-attention-iphone-people = Pozor, pozor: s verziou { -brand-name-ios } 14 si môžete na svojom { -brand-name-iphone } nastaviť { -brand-name-firefox } ako predvolený prehliadač. Uistite sa, že máte taktiež nainštalovanú najnovšiu verziu { -brand-name-firefox(case: "gen") } pre { -brand-name-ios }.
