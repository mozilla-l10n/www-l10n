...
new-platform-the-best-firefox-ever = Najlepší { -brand-name-firefox } vôbec
new-platform-lightweight = Odľahčený
new-platform-uses-30-less-memory = Používa o 30 % menej pamäte než { -brand-name-chrome }
...
new-platform-own-your-online-life = Vy kontrolujete svoj život na internete.
...
new-platform-firefox-respects-your = { -brand-name-firefox } pre { -brand-name-mac-short } <span>rešpektuje vaše súkromie.</span>
...
new-platform-firefox-fights = { -brand-name-firefox } pre { -brand-name-windows } <span>za vás bojuje.</span>
