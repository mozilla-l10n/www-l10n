...
firefox-new-get-more-from-firefox = Využívajte { -brand-name-firefox } naplno
...
firefox-new-make-your-passwords-portable = Vezmite si svoje heslá so sebou
firefox-new-watch-for-data-breaches = Pozor na úniky dát
firefox-new-connect-to-a-whole-family = Firefox odteraz predstavuje rad produktov, ktoré sú ohľaduplné k vášmu súkromiu, a ktoré vám poskytujú informácie o tom, ako zostať v bezpečí na internete.
firefox-new-passwords-made-portable = Prenosné heslá
