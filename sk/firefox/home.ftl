...
firefox-home-firefox-is-just = { -brand-name-firefox } je iba začiatok.
# Obsolete string
firefox-home-meet-our-family-of = Spoznajte náš rad produktov
firefox-home-meet-mozillas-family = Zoznámte sa s rodinou produktov od { -brand-name-mozilla(case: "gen") }
