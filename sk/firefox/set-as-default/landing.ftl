...
set-as-default-landing-firefox-is-fast-and = { -brand-name-firefox } je rýchly a bezpečný na { -brand-name-windows }e, { -brand-name-ios }, { -brand-name-android }e, { -brand-name-linux }e… Vy rozhodujete o tom, aké zariadenia a prehliadače chcete používať.
