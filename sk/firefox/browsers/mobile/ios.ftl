...
mobile-ios-firefox-gives-you = { -brand-name-firefox } vám poskytuje väčšiu ochranu súkromia, keď ste na webe. V predvolenom nastavení naša vylepšená ochrana pred sledovaním blokuje sledovacie prvky a skripty, ako sú sledovacie prvky sociálnych médií, súbory cookie tretích strán, ťažbu kryptomien a vytváranie odtlačkov prehliadača.
...
# Obsolete string
mobile-ios-add-firefox-across = Pridajte { -brand-name-firefox } do svojich zariadení pre bezpečné a bezproblémové prehliadanie. Synchronizujte svoje zariadenia a vezmite si svoje obľúbené záložky, uložené prihlasovacie údaje, heslá a históriu prehliadania, nech ste kdekoľvek. Navyše posielajte otvorené karty medzi telefónom a počítačom, aby ste mohli pokračovať tam, kde ste prestali.
