...
learn-more-about = Ďalšie informácie o { -brand-name-firefox-quantum(case: "loc") }
privacy-first = Súkromie na prvom mieste
firefox-doesnt-spy = { -brand-name-firefox } vás nesleduje. Blokujeme sledovacie cookies tretích strán a dávame vám úplnú kontrolu.
super-fast = Neuveriteľne rýchly
get-speed-and = Rýchlosť aj bezpečnosť. { -brand-name-firefox } je rýchly, pretože vás nesleduje.
always-evolving = Neustále ho vylepšujeme
# Variables:
# $url (url) - link to https://www.mozilla.org/firefox/features
find-out-about = Pozrite si všetky skvelé <a href="{ $url }">funkcie { -brand-name-firefox(case: "gen") }</a>.
