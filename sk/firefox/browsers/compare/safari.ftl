...
compare-safari-safari-is-the-pre-installed = { -brand-name-safari } je predinštalovaný prehliadač na { -brand-name-mac }u a { -brand-name-iphone }. Porovnajte { -brand-name-safari } a { -brand-name-firefox-browser(case: "acc", capitalization: "lower") } a zistite, ktorý prehliadač je pre vás lepší.
# Main title.
