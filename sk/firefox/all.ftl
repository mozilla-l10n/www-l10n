...
firefox-all-which-browser-would = Ktorý prehliadač chcete prevziať?
# Used as an accessible label for a help button. The text is replaced with a "?" icon.
firefox-all-get-help = Získať pomoc
firefox-all-you-are-about-to-download = Chystáte sa prevziať:
...
firefox-all-download-product-for = Prevziať { $product_label } pre { $platform } v jazyku { $locale }
firefox-all-msi-installers = MSI inštalátory
firefox-all-which-version = Akú verziu si želáte?
firefox-all-select-your-preferred-installer = Vyberte si preferovaný inštalátor
