...
firefox-all-which-browser-would = Ktorý prehliadač chcete stiahnuť?
# Used as an accessible label for a help button. The text is replaced with a "?" icon.
firefox-all-get-help = Získať pomoc
firefox-all-you-are-about-to-download = Chystáte sa stiahnuť:
...
firefox-all-download-product-for = Stiahnuť { $product_label } pre { $platform } v jazyku { $locale }
