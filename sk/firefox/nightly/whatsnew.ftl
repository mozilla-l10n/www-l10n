...
# Obsolete
nightly-whatsnew-every-6-to-8-weeks = Každých 6 až 8 týždňov vychádza nová hlavná verzia { -brand-name-firefox(case: "gen") } a v dôsledku toho aj nová verzia { -brand-name-nightly }.
