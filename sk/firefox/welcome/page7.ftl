...
page7-those-innocent-looking-f-buttons = Nevinne vyzerajúce tlačidlá od { -brand-name-facebook }u sledujú vašu aktivitu na internete, a to aj v prípade, že na { -brand-name-facebook }u nemáte účet. Rozšírenie { -brand-name-facebook } Container ich blokuje.
