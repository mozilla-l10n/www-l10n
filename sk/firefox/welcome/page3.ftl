...
welcome-page3-never-forget-reset-or-travel = Už nikdy nezabudnete svoje heslá a nebudete ich musieť obnovovať.
welcome-page3-facebook-container = { -brand-name-facebook-container }
welcome-page3-get-a-container-to-keep-facebook = Kontajner, ktorý bráni { -brand-name-facebook }u v sledovaní vašej aktivity.
