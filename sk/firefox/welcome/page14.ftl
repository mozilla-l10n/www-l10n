...
welcome-page14-code-copied = Kód bol skopírovaný!
welcome-page14-very-fast = Je rýchla, veľmi rýchla
welcome-page14-wireguard-powered = Naše servery poháňané { -brand-name-wireguard }® sú skonštruované pre rýchlosť, takže môžete streamovať, sťahovať a hrať ako zvyčajne.
welcome-page14-without-trace = Internet bez stopy
welcome-page14-never-log = Nikdy nezaznamenávame, nesledujeme ani nezdieľame vaše sieťové údaje – vaša online aktivita nezanechá stopu na našich serveroch VPN.
welcome-page14-why-see-this = Prečo sa mi toto zobrazuje?
