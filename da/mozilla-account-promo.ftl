...
moz-account-already-have-v2 = Har du allerede en konto? <a { $sign_in_url }>Log ind</a> eller <a <a { $learn_more_url }>læs mere</a> om at være en del af { -brand-name-mozilla }.
# Obsolete string (expires: 2024-09-12)
# Variables
#   $sign_in_url - link to
#   $learn_more_url - link to https://www.mozilla.org/en-US/firefox/accounts/
moz-account-already-have = Har du allerede en konto? <a { $sign_in_url }>Log ind</a> eller <a { $learn_more_url }>læs mere</a> om { -brand-name-mozilla }
