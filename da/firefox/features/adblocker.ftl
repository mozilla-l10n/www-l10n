...
features-adblocker-how-to-block-annoying = Sådan hjælper en adblocker dig med at slippe for irriterende reklamer
...
features-adblocker-send-a-do-not-track-signal = { -brand-name-send } signalet 'Spor mig ikke'
# Variables:
...
features-adblocker-take-control-of-your-browser = Tag kontrol over din browser.
