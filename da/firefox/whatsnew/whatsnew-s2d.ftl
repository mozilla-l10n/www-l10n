...
whatsnew-s2d-want-privacy-on-every-device = Vil du have beskyttelse af dit privatliv på alle enheder?
# "You got it" here is a casual answer to the previous question, "Want privacy on every device?"
whatsnew-s2d-you-got-it-get-firefox-for = Det kan du få med { -brand-name-firefox } til mobilen.
...
whatsnew-s2d-qr-code-alt = Scan denne QR-kode
