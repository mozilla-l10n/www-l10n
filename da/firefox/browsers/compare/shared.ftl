...
compare-shared-dashboard-to-review = Oversigt over blokerede sporings-mekanismer
compare-shared-autoplay-blocking = Blokerer automatisk afspilning
compare-shared-tab-browsing = Faneblads-browsing
compare-shared-bookmark-manager = Håndtering af bogmærker
compare-shared-automatically-fills-out-forms = Udfylder automatisk formularer
compare-shared-automatically-fills-out-payments = Udfylder automatisk betalinger
compare-shared-search-engine-options = Indstillinger for søgetjenester
compare-shared-text-to-speech = Tekst til tale
compare-shared-reader-mode = Læsetilstand
compare-shared-spell-checking = Stavekontrol
...
compare-shared-download-firefox = Hent { -brand-name-firefox }
compare-shared-download-firefox-browser = Hent { -brand-name-firefox-browser }
compare-shared-download-the-app = Hent appen
compare-shared-desktop = Computer
