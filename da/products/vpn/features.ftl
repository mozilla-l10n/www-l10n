...
vpn-features-automatically-block-ads = Med { -brand-name-mozilla-vpn } blokeres reklamer automatisk og sporing via reklamer forhindres i at følge med i dine aktiviteter på nettet.
