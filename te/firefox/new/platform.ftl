...
new-platform-the-new-firefox = కొత్త <strong>{ -brand-name-firefox }</strong>
new-platform-2x-faster = 2x వేగంగా
new-platform-the-best-firefox-ever = ఇప్పటికి అత్యుత్తమ { -brand-name-firefox }
new-platform-lightweight = తేలికైన
new-platform-uses-30-less-memory = { -brand-name-chrome } కంటే 30% తక్కువ మెమొరీ వాడుకుంటుంది
new-platform-powerfully-private = శక్తివంతమైన గోప్యత
