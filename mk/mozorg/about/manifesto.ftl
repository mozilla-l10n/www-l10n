...
manifesto-use-open-badges-to-share = Користете отворени беџови за да ги споделите Вашите вештин и интереси
manifesto-learn-about-open-source = Дознајте за отворен код во новинарство
manifesto-see-how-mozilla-works = Погледни како работи Mozzila за заштита на вашата приватност
manifesto-read-about-developments = Прочитај за развивањето на приватноста и заштитата на податоци
manifesto-learn-more-about-how-to = Дознај повеќе како да се заштитиш себеси online
manifesto-add-new-voices-to-open = Додај нови гласови на отворената технологија
manifesto-set-your-do-not-track = Постави опција за Do Not Track
manifesto-learn-how-to-remix-content = Научи како да ја преработиш содржината за создавање нешто ново
manifesto-participate-in-our-governance = Учествувај во нашиот форум за управување
manifesto-join-us-as-a-volunteer = Придружи ни се како волонтер/ка
manifesto-learn-how-to-collaborate = Научи како да соработуваш online
manifesto-host-or-join-a-maker-party = Хостирај или придружи се на { -brand-name-maker-party }
manifesto-learn-how-to-build-online = Дознај како да создаваш вештини за колаборација online
...
manifesto-details-articulate-a-vision = да ја пренесе визијата за Интерент што учесниците во { -brand-name-mozilla } сакаат фондацијата { -brand-name-mozilla } да ја следи;
...
manifesto-details-mozilla-foundation = Ветување на фондацијата Mozilla
manifesto-details-the-mozilla-foundation-pleges = Фондацијата { -brand-name-mozilla } ветува дека ќе го поддржува манифестот на { -brand-name-mozilla } во своите активности. Поточно, ние ќе:
...
manifesto-details-some-foundation = Некои активности на фондацијата - моментално, создавањето, испораката и промовирањето на потрошувачки произвдои - се остваруваат преку корпорацијата Mozilla, подружница која е во целосна сопственост на фондацијата.
manifesto-details-invitation = Покана
manifesto-details-the-mozilla-foundation-invites = Фондацијата { -brand-name-mozilla } ги поканува сите други кои ги поддржуваат принцпите на манифестот на { -brand-name-mozilla } да ни се приклучат и да пронајдат нови начини оваа визија за Интернетот да стане реалност.
