...
home-need-help = Ви треба помош?
home-get-answers-to-your-questions = Добијте одговори за { -brand-name-firefox } и сите производи на { -brand-name-mozilla } од нашиот тим за поддршка.
