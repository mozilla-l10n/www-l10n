...
firefox-is-not = { -brand-name-firefox } ეფუძნება { -brand-name-chromium }-ს (ღია წყაროს ბრაუზერის კოდს, რომელიც ბირთვია { -brand-name-google } { -brand-name-chrome }-ის). აღსანიშნავია, რომ ჩვენი ბრაუზერი, მოწინავეთგან ერთ-ერთი ბოლო დარჩა ასეთი. { -brand-name-firefox } იყენებს საკუთარ Quantum-ბრაუზერის ძრავას, შექმნილს საგანგებოდ { -brand-name-firefox }-ისთვის, ასე რომ თქვენი მონაცემები სანდო ხელშია და დარჩება პირადი.
