...
firefox-products-get-the-browser-that-blocks = გამოიყენეთ ბრაუზერი, რომელიც ავტომატურად ზღუდავს 2000+ მეთვალყურეს. თვალთვალისგან გაძლიერებული დაცვა სტანდარტულად ხელმისაწვდომია ყველა { -brand-name-firefox }-ბრაუზერში.
...
firefox-products-protect-your-real = დაიცავით თქვენი ნამდვილი ელფოსტა საფოსტო ყუთის უკეთ მართვით.
firefox-products-get-relay = გადმოწერეთ { -brand-name-firefox-relay }
