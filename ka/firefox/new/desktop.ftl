...
firefox-desktop-download-do-what-you-do = რაც გსურთ, ის აკეთეთ ინტერნეტში.<br> { -brand-name-firefox-browser } <strong>არ</strong> გითვალთვალებთ.
firefox-desktop-download-how-firefox-compares = რითი განსხვავდება { -brand-name-firefox } სხვა ბრაუზერებისგან
firefox-desktop-download-get-all-the-speed = მიიღეთ სიჩქარე და უამრავი შესაძლებლობა, პირად ცხოვრებაში ჩაურევლად. { -brand-name-firefox-browser } იმდენად მცირე მონაცემებს აგროვებს, რომ ელფოსტასაც არ ვითხოვთ ჩამოსატვირთად. ეს იმიტომ, რომ სხვა ბრაუზერებისგან განსხვავებით, არ ვიღებთ ფინანსურ სარგებელს, ვებსივრცეში თქვენი დევნით.
