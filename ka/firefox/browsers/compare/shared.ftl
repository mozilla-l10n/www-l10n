...
compare-shared-firefox-also-has-built-in = { -brand-name-firefox } კიდევ შეიცავს ჩაშენებულ ხელსაწყოებს, მათ შორის:
# Variables
# $pdf (url) - link to https://www.mozilla.org/firefox/features/pdf-editor/
compare-shared-edit-pdfs-on-the-go = <a { $pdf }>PDF-ის ჩასწორება</a> პირდაპირ თქვენი { -brand-name-firefox }-ბრაუზერის ფანჯარაში – არაა საჭირო დამატებითი პროგრამები.
# Variables
