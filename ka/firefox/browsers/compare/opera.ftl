...
compare-opera-firefoxs-default-privacy-settings = { -brand-name-firefox } პირადულობის ნაგულისხმევი პარამეტრებით მეტად მძლავრია, ვიდრე Opera – და ჩვენ დამატებითი შესაძლებლობებიც გვაქვს, ვებსაიტების თქვენი თვალთვალის საშუალება რომ არ მივცეთ, თუნდაც <a { $fingerprint }>მომხმარებლის ამოცნობის არიდება</a>.
