...
compare-brave-firefox-gives-you-the-option = { -brand-name-firefox } საშუალებას გაძლევთ დაშიფროთ შენახული პაროლები, ხოლო <a { $privary }>მათთან წვდომისთვის გამოიყენეთ მთავარი პაროლი</a>; თქვენი პაროლები დაცულია იმ შემთხვევაშიც, თუ კომპიუტერის გაზიარება გიწევთ. Brave არ იცავს თქვენს პაროლებს.
# Variables:
