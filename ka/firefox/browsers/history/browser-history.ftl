...
browser-history-in-the-future-the = მომავალში, ვებსამყარო სავარაუდოდ, მეტად დაშორდება თავის ბმულებით ურთიერთდაკავშირებული ტექსტების ფესვებს, რომ იქცეს უსაზღვრო სივრცედ, სადაც მომხმარებელი შეძლებს სრულად ჩაეფლოს. წარმოსახვითი სინამდვილე ათწლეულებია გამოჩნდა (ჯერ კიდევ იმ დროიდან, როცა Lawnmower Man გამოვიდა 1992 წელს და Nintendo Virtual Boy შეიქმნა 1995 წელს), მაგრამ ხალხის დიდ ნაწილთან საბოლოოდ ვებსივრცემ მიიტანა. { -brand-name-firefox } ახლა უკვე მხარს უჭერს <a href="{ $vr }">WebVR და  A-Frame</a> გარსებს, რომელთა მეშვეობითაც შემმუშავებლები სწრაფად და მარტივად შეძლებენ ააგონ წარმოსახვითი სინამდვილის მქონე ვებსაიტები. თანამედროვე მობილური მოწყობილობების უმეტესობა ასევე მხარს უჭერს <a href="{ $vr }">WebVR</a>-ს, შესაბამისად მათი დახმარებით, თავისუფლად შეიძლება მუყაოს ჩაფხუტის აწყობა. 3D წარმოსახვითი ვებსამყარო, როგორიც წარმოედგინა სამეცნიერო ფანტასტიკის ავტორს ნილ სტეფანსონს, შესაძლოა უკვე კარს მოგვადგა. შედეგად, არაა გამორიცხული როგორც ასეთი, ვებბრაუზერი სრულად გაქრეს და გახდეს ნამდვილი ფანჯარა, ახალ სამყაროში გადასასვლელად.
browser-history-whatever-the-future = როგორი მომავალიც არ უნდა ჰქონდეს ვებსივრცეს, { -brand-name-mozilla } და { -brand-name-firefox } დარჩება მომხმარებლებთან, რომ უზრუნველყოს ისინი მძლავრი ხელსაწყოებით, ინტერნეტისა და მისი შესაძლებლობების სრულყოფილად გამოყენებისთვის. ვებსამყარო საყოველთაოა და ყველას უნდა შეეძლოს საკუთარი ინტერნეტცხოვრების თავადვე განკარგვა. სწორედ ამიტომ, { -brand-name-firefox } მომხმარებლებს საშუალებას აძლევს დაიცვან საკუთარი პირადულობა და არ ჰყიდის მათს მონაცემებს სარეკლამო მიზნებისთვის.
