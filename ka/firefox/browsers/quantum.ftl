...
privacy-first = პირადულობის უწინარესობის უზრუნველმყოფი
...
get-speed-and = მიიღეთ სისწრაფე და უსაფრთხოება. { -brand-name-firefox } სწრაფია, ვინაიდან ჩვენ არ ვადევნებთ თვალს თქვენს მოქმედებებს.
always-evolving = მუდმივად განვითარებადი
# Variables:
# $url (url) - link to https://www.mozilla.org/firefox/features
find-out-about = მოიძიეთ, ყველა გასაოცარი <a href="{ $url }">{ -brand-name-firefox }-შესაძლებლობა</a>.
