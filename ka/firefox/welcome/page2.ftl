...
welcome-page2-save-content-from-everywhere = შეინახეთ მასალები ნებისმიერი წყაროდან
welcome-page2-grab-articles-videos-and-links = წამოიღეთ სტატიები, ვიდეოები და ბმულები ნებისმიერი ვებსაიტიდან { -brand-name-pocket }-ნიშანზე დაწკაპებით, ბრაუზერის ხელსაწყოთა ზოლზე.
welcome-page2-discover-new-stories = აღმოაჩინეთ ახალი ისტორიები
welcome-page2-pocket-shows-recommended-stories = { -brand-name-pocket } შემოგთავაზებთ ისტორიებს ახალი ჩანართის ყოველი გახსნისას. რომელიც დაგაინტერესებთ, შეგიძლიათ გადაინახოთ.
welcome-page2-why-am-i-seeing-this = რატომ ვხედავ ამას?
