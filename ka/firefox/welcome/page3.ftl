...
welcome-page3-never-forget-reset-or-travel = აღარავითარი დავიწყება, განულება ან გადაადგილება პაროლების გარეშე.
welcome-page3-facebook-container = { -brand-name-facebook-container }
welcome-page3-get-a-container-to-keep-facebook = გამოიყენეთ სათავსი, { -brand-name-facebook }-ის მოსაცილებლად თქვენი პირადი საქმისგან.
welcome-page3-pocket = { -brand-name-pocket }
welcome-page3-trade-clickbait-and-fake-news = ჩაანაცვლეთ სატყუარა და ყალბი ამბები, ხარისხიანი მასალებით.
welcome-page3-firefox-send = { -brand-name-firefox-send }
welcome-page3-send-huge-files-to-anyone = გააგზავნეთ დიდი ფაილები ნებისმიერთან ბმულებით, თვითგანადგურების შესაძლებლობით.
welcome-page3-why-am-i-seeing-this = რატომ ვხედავ ამას?
