...
# HTML description
features-private-were-focused-on-your-right-to = ჩვენ ორიენტირებული ვართ თქვენი პირადი მონაცემების ხელშეუხებლობის უფლებაზე. თქვენს მონაცემებს, ინტერნეტში მოქმედებებს, ინტერნეტცხოვრებას დაცულია { -brand-name-firefox }-ით.
# Variables:
#   $url (url) = link to https://www.mozilla.org/firefox/features/private-browsing/
features-private-yes-firefox-protects-your = დიახ. { -brand-name-firefox } იცავს თქვენს პირადულობას ისეთი შესაძლებლობებით, როგორიცაა <a href="{ $url }">პირადი დათვალიერების რეჟიმი</a>. საშუალებას გაძლევთ, შეინახოთ თქვენი გვერდების ისტორია და პაროლები, იმ მოწყობილობითაც, რომელსაც სხვებისთვის უზიარებთ, მაგალითად სახლის კომპიუტერი ან { -brand-name-ipad }.
# Variables:
