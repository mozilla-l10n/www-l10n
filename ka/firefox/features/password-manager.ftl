...
password-manager-forget-the-reset-v2 = დაივიწყეთ ანგარიშების აღდგენა. { -brand-name-firefox } პაროლების მმართველი შეინახავს ყველა თქვენს პაროლს და შეგეძლებათ საიტებზე ავტომატური შესვლა, ან საჭირო პაროლის მარტივად მონახვა. დამატებითი უსაფრთხოებისთვის მიანიჭეთ კომპიუტერს <a href="{ $url }">მთავარი პაროლი</a>.
# Obsolete string
# Variables:
...
password-manager-earn-your-second = მიიღეთ უსაფრთხოების დამატებითი შავი ქამარი { -brand-name-firefox }-ის პაროლების მმართველი <a href="{ $addons }">დამატებების</a> ფართო არჩევანიდან. აარჩიეთ რჩეულებიდან, ან მონახეთ გაუმჯობესებული ანალოგები, ექსპერტების შეფასებებისა და მიმოხილვების საფუძველზე
