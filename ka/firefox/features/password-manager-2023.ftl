...
password-manager-with-a-free-firefox-account = <a href="{ $fxa }">უფასო { -brand-name-firefox-account }</a> შეგიძლიათ უსაფრთხოდ დაასინქრონოთ პაროლები ყველა თქვენს მოწყობილობაზე.
