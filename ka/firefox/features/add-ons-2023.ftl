...
features-add-ons-there-are-firefox-add-ons-that = არსებობს { -brand-name-firefox }-დამატებები, რომლებიც <a { $fbcontainer }> Facebook-ს თვალი ადევნებთ ინტერნეტში</a>, <a { $translate }>ტექსტი თარგმნეთ სხვა ენებზე</a> , <a { $language }>გადაამოწმეთ თქვენი მართლწერა და გრამატიკა</a> ან <a { $customize }>გაუუმჯობესეთ თქვენი ბრაუზერის იერსახე</a>. ამ და ათასობით სხვა უფასო გაფართოებას იხილავთ საიტზე <a { $amo }>addons.mozilla.org</a>.
