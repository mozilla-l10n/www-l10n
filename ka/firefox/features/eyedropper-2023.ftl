...
features-eyedropper-eyedropper-tool = სათვალე ხელსაწყო
features-eyedropper-select-colors-in-firefox = აირჩიეთ ფერები { -brand-name-firefox }-ში სათვალე ხელსაწყოთი
...
features-eyedropper-you-can-find-the-eyedropper = საწვეთურის ნახვა შეგიძლიათ ხელსაწყოების მენიუში „ბრაუზერის ხელსაწყოების“ განყოფილებაში ან { -brand-name-firefox }-ის ხელსაწყოთა ზოლის მენიუში „სხვა ხელსაწყოების“ ქვეშ ({ -brand-name-firefox }-ის ხელსაწყოთა ზოლის ბოლოში).
