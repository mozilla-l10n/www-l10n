...
features-translate-the-firefox-translations-feature-v2 = { -brand-name-firefox-translations }-ის შესაძლებლობა კიდევ ერთი საშუალებაა, რომ { -brand-name-mozilla } თქვენი ინტერნეტის პერსონალურად და პირადულობის შესანარჩუნებლად. { -brand-name-mozilla } არ ადევნებს თვალს, რომელ ვებგვერდებს თარგმნით. მილიონობით მომხმარებელით მსოფლიოს მასშტაბით, { -brand-name-mozilla }-ს სურს უზრუნველყოს, რომ ისინი, ვინც { -brand-name-firefox }-ს იყენებს, შეისწავლიან, ურთიერთობენ, გაუზიარებენ და იქნებიან ინფორმირებულები საკუთარი პირობებით. <a { $download }>დაიწყეთ სასურველ ენაზე { -brand-name-firefox }-ის ჩამოტვირთვით.</a>
# Obsolete string (expires: 2025-02-17)
