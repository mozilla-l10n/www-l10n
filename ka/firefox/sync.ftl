...
firefox-sync-encrypt-your-data = მონაცემები დაიშიფრება
firefox-sync-your-encryption-key = დაშიფვრის თქვენი გასაღები იქნება საიდუმლო, გეცოდინებათ მხოლოდ თქვენ და თქვენ მიერ დაშვებულ მოწყობილობებს.
