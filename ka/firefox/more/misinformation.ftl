...
misinformation-ultimately-harmful = საბოლო ჯამში, ორივე – მცდარიც და ყალბიც საზიანოა. გარდა იმისა, რომ ხალხი იჯერებს ტყუილს, ცრუ ინფორმაცია საერთაშორისო ეკონომიკასაც ძვირად უჯდება და საფრთხეს უქმნის დემოკრატიულ, სარგებლიან მმართველობას. ამასთანავე, მეტად რთულია ამგვარი არასწორი ცნობების შეჩერება, ვინაიდან გაცილებით სწრაფად, სიღრმისეულად და ფართოდ ვრცელდება, ვიდრე გადამოწმებული ამბები.
...
misinformation-widespread-online = მცდარ და ყალბ ამბებს შეიძლება ყველგან წააწყდეთ, თუმცა ყველაზე მეტად გავრცელებული და გავლენიანი ინტერნეტშია. ალგორითმები და <a href="{ $tracking }">თვალყურის დევნება</a> კიდევ უფრო ზრდის მცდარი და ყალბი ცნობების, ფართო საზოგადოებაში გავრცელების შესაძლებლობას საიტებით, სვეტებით, ფორუმებითა და სოციალური ქსელებით.
