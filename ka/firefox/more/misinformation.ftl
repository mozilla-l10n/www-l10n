...
misinformation-page-subheading = გაეცანით რჩევებს, როგორ შეამციროთ ირგვლივ ყალბი ამბები და როგორ გაამახვილოთ ყურადღება თქვენთვის მნიშვნელოვანზე
misinformation-what-is-heading = რას არის მცდარი? რა არის ყალბი?
misinformation-disinformation = მცდარი, ყალბი ანუ დეზინფორმაცია – ალბათ აქამდეც ხშირად გსმენიათ ეს ტერმინები და გაინტერესებთ, რა სხვაობაა მათ შორის. მათი ერთმანეთისგან გამორჩევა შესაძლებელია დანიშნულების მიხედვით: მცდარი, არასწორი ცნობები ეწოდება ისეთ ამბებს, რომელთაც შეიძლება, ხალხი შეცდომაში შეიყვანოს. დადასტურებულია, რომ არაზუსტი და ტყუილია, თუმცა არაა განკუთვნილი ვინმეს განგებ შესაცდენად. მეორე მხრივ კი ყალბი ამბები, ანუ დეზინფორმაცია შეთხზული და გავრცელებულია, სწორედ ხალხის შეცდომაში შეყვანისთვის რაღაც მიზნის მისაღწევად.
misinformation-ultimately-harmful = საბოლო ჯამში, ორივე – მცდარიც და ყალბიც საზიანოა. გარდა იმისა, რომ ხალხი იჯერებს ტყუილს, ცრუ ინფორმაცია საერთაშორისო ეკონომიკასაც ძვირად უჯდება და საფრთხეს უქმნის დემოკრატიულ, შედეგიან მმართველობას. ამასთანავე, მეტად რთულია ამგვარი არასწორი ცნობების შეჩერება, ვინაიდან გაცილებით სწრაფად, სიღრმისეულად და ფართოდ ვრცელდება, ვიდრე გადამოწმებული ამბები.
...
misinformation-widespread-online = მცდარ და ყალბ ამბებს შეიძლება ყველგან წააწყდეთ, თუმცა ყველაზე მეტად გავრცელებული და გავლენიანი ინტერნეტშია. ალგორითმები და <a href="{ $tracking }">თვალყურის დევნების</a> საშუალებები კიდევ უფრო ხელს უწყობს მცდარი და ყალბი ცნობების ფართო საზოგადოებაში გავრცელებას საიტებით, სვეტებით, ფორუმებითა და სოციალური ქსელებით.
misinformation-tracking-advertising = ალბათ გსმენიათ თვალთვალის შესახებ, უმეტესად რეკლამებთან დაკავშირებით. თუმცა იგი ასევე მძლავრი იარაღია, როცა საქმე ცრუ ამბების გავრცელებას ეხება. რატომ? ინტერნეტის ან თქვენი სოციალური ქსელით მოწოდებული მასალების თვალიერებისას ზოგიერთ თქვენს ქცევას, მისწრაფებას, კავშირებს და ა. შ. თვალს ადევნებს უამრავი კომპანია ვებსაიტებზე, რომ შეადგინონ დაწვრილებითი დახასიათება თქვენ შესახებ სხვა პირთათვის მისაყიდად, თქვენს ზურგს უკან, თქვენი თანხმობის გარეშე. ეს დახასიათება გამოიყენება უშუალოდ თქვენთვის გამიზნული რეკლამების შემოსათავაზებლად, თუმცა გამოსადეგია ნებისმიერი სხვა მიზნობრივი ცნობების მოსაწოდებლადაც.
misinformation-social-newtorks = როდესაც მიიღებთ შემოთავაზებულ მასალებს ნებისმიერ საიტზე ან სოციალურ ქსელში, უმეტესად ეს ნიშნავს, რომ ალგორითმი გთავაზობთ ინფორმაციას თქვენი დახასიათების საფუძველზე. მართალია, ალგორითმები თანდათან ჭკვიანდება და უმჯობესდება, მაგრამ სამწუხაროდ, მასალის სიზუსტეს მაინც ვერ ამოწმებს. ეს განსაკუთრებულ სიძნელეს ქმნის სოციალურ ქსელში: ამგვარი ქსელები აურაცხელ ინფორმაციას აწვდის მომხმარებლებს ყოველდღიურად და წვდომა აქვს თითქმის შეუზღუდავი ოდენობის მასალასთან, როგორიცაა მომხმარებლების ნაწერები, ახალი ამბების სტატიები, რეკლამები და დაფინანსებული ცნობები. ერთი მხრივ, მომხმარებლის ნაწერებითა და სტატიებით, შეიძლება შემთხვევით გავრცელდეს მცდარი სიახლეები, ხოლო რეკლამები და დაფინანსებული ცნობები კი შესაძლოა განკუთვნილი იყოს საგანგებოდ თქვენზე ზეგავლენის მოსახდენად ყალბი ამბების მეშვეობით, სწორედ ამიტომაა სასიცოცხლოდ მნიშვნელოვანი, შეძლოთ ცრუ ინფორმაციის ამოცნობა.
...
misinformation-check-out-websites = გადახედეთ ვებსაიტებსა და ახალი ამბების სააგენტოებს, რომელთაც ენდობით და ნახეთ, როგორ გადმოსცემენ მსგავს სიახლეებს. მასალა, რომელიც განკუთვნილია ზეგავლენის მოსახდენად, ხშირად უკიდურესი გადაჭარბებითაა წარმოდგენილი დაუსაბუთებლად და არ იძებნება სიღრმისეული კვლევის ანგარიშებში.
...
misinformation-images-are-powerful = სურათი მეტად მძლავრი საშუალებაა ყალბი ამბების გამიზნულად გავრცელებისთვის. დართულმა წარწერამ, შესაძლოა სრულად დაამახინჯოს მისი აღქმა და საპირისპიროდ შეცვალოს. თუ არ ხართ დარწმუნებული, თავად სურათი მონახეთ საძიებოებით სხვა საიტებზე და შეადარეთ აღწერილობა.
misinformation-how-firefox-helps-heading = როგორ გეხმარებათ { -brand-name-firefox } ყალბი ამბების არიდებაში
misinformation-firefox-keeps-trackers-heading = { -brand-name-firefox } აჩერებს მეთვალყურეებს:
# Variables:
...
misinformation-social-media-clean-desc = სოციალურმა ქსელებმა ბევრი რამ იცის თქვენ შესახებ. ამასთანავე, შეუძლია თვალი გადევნოთ სხვა საიტებზეც, გაზიარებისა და მოწონების ღილაკებით, თვალთვალისგან დაცვის მიუხედავად — ანგარიშის არ ქონის შემთხვევაშიც კი. <a href="{ $container }">{ -brand-name-facebook-container }</a> { -brand-name-firefox }-ის მეშვეობით, უზრუნველყოფს, რომ { -brand-name-facebook } და { -brand-name-instagram } ამას მარტივად ვეღარ ახერხებდეს, რაც თავისმხრივ მკვეთრად ამცირებს ალბათობას, იხილოთ ყალბი რეკლამები და დაფინანსებული მასალები.
