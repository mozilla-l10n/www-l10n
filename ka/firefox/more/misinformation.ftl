...
misinformation-widespread-online = მცდარ და ყალბ ამბებს შეიძლება ყველგან წააწყდეთ, თუმცა ყველაზე მეტად გავრცელებული და გავლენიანი ინტერნეტშია. ალგორითმები და <a href="{ $tracking }">თვალყურის დევნების</a> საშუალებები კიდევ უფრო ხელს უწყობს მცდარი და ყალბი ცნობების ფართო საზოგადოებამდე მიწოდებას საიტებით, სვეტებით, ფორუმებითა და სოციალური ქსელებით.
