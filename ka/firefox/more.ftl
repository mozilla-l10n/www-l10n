...
we-compare-firefox = ევადაროთ { -brand-name-firefox } და { -brand-name-chrome }, { -brand-name-edge }, { -brand-name-safari }, { -brand-name-opera }, { -brand-name-brave }, { -brand-name-ie } რომ გაგიადვილდეთ გადაწყვეტილების მიღება.
