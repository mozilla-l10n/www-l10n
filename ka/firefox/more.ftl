...
firefox-is-independent = { -brand-name-firefox } დამოუკიდებელი, არამომგებიანი { -brand-name-mozilla }-ს ნაწილია, რომელიც იბრძვის ხალხის უფლებების დასაცავად ინტერნეტში და მისი ხელმისაწვდომობისთვის ყველასთვის და ყველგან.
...
seven-of-the = შვიდი მოწინავე ბრაუზერის პირდაპირი შედარება
we-compare-firefox = შევადაროთ { -brand-name-firefox } და { -brand-name-chrome }, { -brand-name-edge }, { -brand-name-safari }, { -brand-name-opera }, { -brand-name-brave }, { -brand-name-ie } რომ გაგიადვილდეთ გადაწყვეტილების მიღება.
comparing-firefox-chrome = { -brand-name-firefox-browser(case: "gen") } შედარება { -brand-name-google } { -brand-name-chrome }-თან
big-isnt-always = დიდი ყოველთვის არ ნიშნავს საუკეთესოს. აირჩიეთ დამოუკიდებლობა.
comparing-firefox-brave = { -brand-name-firefox-browser(case: "gen") } შედარება { -brand-name-brave }-თან
be-bold-and = იყავით მეტად გაბედული და მამაცი, სასურველი ბრაუზერის შერჩევისას.
comparing-firefox-edge = { -brand-name-firefox-browser(case: "gen") } შედარება { -brand-name-microsoft } { -brand-name-edge }-თან
youll-never-guess = ნეტავი რომელი ბრაუზერია უკიდურესად სწრაფი და მრავალი შესაძლებლობის მქონე.
comparing-firefox-ie = { -brand-name-firefox-browser(case: "gen") } შედარება { -brand-name-microsoft } { -brand-name-ie }-სთან
...
so-many-ads = იმატებს რეკლამები, მცირდება მოთმინება… დროა, დასრულდეს ეს სიგიჟე.
firefox-more-protection = { -brand-name-firefox }: მეტი უსაფრთხოება, ნაკლები მღელვარება.
were-obsessed-with = ჩვენ დაჟინებით ვცდილობთ თქვენი პირადი მონაცემების დაცვას. სწორედ ამიტომაა, რომ { -brand-name-firefox }-ის პირადი თვალიერების რეჟიმს გაცილებით მეტი შესაძლებლობები აქვს, ვიდრე სხვებისას.
...
firefox-more-translate-more-than = თარგმნეთ 100-ზე მეტი ენიდან თქვენს ენაზე პირდაპირ { -brand-name-firefox-browser }-ში – აქამდე არნახული სიმარტივით.
...
firefox-more-avoid-misinformation-heading = აირიდეთ ყალბი ამბები ინტერნეტში – { -brand-name-firefox } მზადაა დასახმარებლად
