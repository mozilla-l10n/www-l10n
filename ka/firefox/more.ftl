...
six-of-the-best = ექვსი საუკეთესო ბრაუზერის პირდაპირი შედარება
# Obsolete string
...
we-compare-firefox-v2 = ჩვენ შევადარეთ { -brand-name-firefox }-ს Chrome, Edge, Safari, Opera და Brave, რომ გაგიადვილდეთ გადაწყვეტილების მიღება.
