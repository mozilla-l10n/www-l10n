...
new-school-meets = ახლისა და ძველის თანხვედრა, ამ დროისთვის უსწრაფესი ბრაუზერით,
firefox-for-windows = { -brand-name-firefox } 64-ბიტიანი { -brand-name-windows }-ისთვის
we-worry-about = ჩვენ ვზრუნავთ თქვენი მონაცემების დაცვაზე, ასე რომ თქვენ აღარ მოგიწევთ.
...
comparing-firefox-brave = { -brand-name-firefox-browser(case: "gen") } შედარება { -brand-name-brave }-სთან
...
comparing-firefox-ie = შევადაროთ { -brand-name-firefox-browser } და { -brand-name-microsoft } { -brand-name-ie }
