...
firefox-developer-help-build-the-last = დაგვეხმარეთ უკანასკნელი დამოუკიდებელ ბრაუზერის გამართვაში. დაწერეთ კოდი, გაასწორეთ ხარვეზები, შექმენით დამატებები და ა. შ.
...
firefox-developer-mdn-playground = მოედანი
firefox-developer-mdn-write-test-and-share = დაწერეთ, გამოცადეთ და გააზიარეთ თქვენი კოდი. თქვენი მოედანი, რომ ისწავლოთ და გაუზიაროთ თქვენი გასაოცარი შრომა მსოფლიოს.
firefox-developer-mdn-blog = { -brand-name-mdn } ბლოგი
firefox-developer-mdn-unlock-the-world = გახსნათ ვებშემუშავების სამყარო { -brand-name-mdn } ბლოგით — თქვენი ძირითადი კერა ექსპერტთა ხედვების, უახლესი ვებ სტანდარტებისა და კოდირების რჩევების მისაღებად.
firefox-developer-mdn-updates = განახლებები
firefox-developer-mdn-the-web-doesnt-have = ვებსივრცეს არ გააჩნია ცვლილებების ჩანაწერები, მაგრამ { -brand-name-mdn } დაგეხმარებათ. შეგიძლიათ თავსებადობის ცვლილებების მორგება და გაფილტვრა, ბრაუზერების ან თქვენთვის სასურველი ტექნოლოგიების მიხედვით, არის თუ არა JavaScript, CSS და ა.შ.
