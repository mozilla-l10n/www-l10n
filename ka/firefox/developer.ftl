...
firefox-developer-firefox-devtools-has-a-brand-new-v2 = { -brand-name-firefox-devtools } წარმოდგენილია მოხაზულობის დასამუშავებელი უახლესი ხელსაწყოთი, რომელიც მეტად ამარტივებს გარემოხაზულობისა და შემოჭრილი არეების შესწორებას, ვიზუალური რედაქტორის მეშვეობით.
