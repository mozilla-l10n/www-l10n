...
firefox-accounts-get-the-respect-you = მიიღეთ ღირსეული პატივსცემა, რომელსაც იმსახურებთ.
...
firefox-accounts-take-less-keep-it = ნაკლები აღრიცხვა.<br> უსაფრთხო შენახვა.<br> არანაირი საიდუმლოებები.
...
firefox-accounts-help-us-build-a-better = დაგვეხმარეთ, გავხადოთ { -brand-name-firefox } უფრო უკეთესი ყველასთვის.
...
firefox-accounts-we-support-communities = ჩვენ მხარს ვუჭერთ ყველა გაერთიანებას მთელ მსოფლიოში, რომელიც იღწვის ინტერნეტის სიჯანსაღისთვის. შეიტანეთ თქვენი წვლილი ამ ბრძოლაში.
