...
firefox-accounts-we-never = ჩვენ არასდროს აღვრიცხავთ, არ ვადევნებთ თვალს და არ გავაზიარებთ თქვენი ქსელის მონაცემებს
firefox-accounts-save-articles = გადაინახეთ სტატიები ვებსივრციდან
firefox-accounts-read-in-a = წაიკითხეთ წყნარ, პირად სივრცეში
