...
m24-about-fund = ფონდი
m24-about-we-fund-and = ჩვენ ვაფინანსებთ და ინვესტირებას ვაფინანსებთ ხალხსა და ძალისხმევაში, ტექნოლოგიების, ინტერნეტისა და ხელოვნური ინტელექტის სწორი მიმართულებით გადაყვანაში.

## News

m24-about-read-more = ვრცლად
m24-about-read-the-latest = გაეცანით { -brand-name-mozilla }-ს უახლეს სიახლეებსა და სტატიებს
m24-about-builders-program = { -brand-name-mozilla-builders } ეხმარება შემმუშავებლებს, ღია წყაროს მქონე AI პროექტების შექმნაში, თანამშრომლობის, პროგრამირებისა და ერთობის მეშვეობით
...
m24-about-lets-build-a = ავაშენოთ პატიოსანი მომავლისა
m24-about-see-how-were = ნახეთ, თუ როგორ ვქმნით მრავალფეროვან, ინკლუზიურ და ყველასთვის ხელმისაწვდომ ინტერნეტგარემოს.
m24-about-read-about-our = წაიკითხეთ ჩვენი ვალდებულებების შესახებ
