...
m24-home-alt-flag = გაფორმებული მწვანე დროშა შავ ფონზე, რომლის მთავარი შემადგენელია ‘M’ სახელიდან { -brand-name-mozilla } და პიქსელიდან, რომელიც წანაცვლებულია თავდაპირველ დინოზავრის ლოგოსთან მსგავსებისთვის.
