...
m24-home-why-does-it = რატომ გვეჩვენება ასე ხშირად, თითქოს ხელოვნური ინტელექტის მასობრივი ექსპერიმენტის მონაწილენი? როგორია ახალი ტექნოლოგიების გამოცდის საპასუხისმგებლო გზა? ბრიჯიტ ტოდი იკვლევს, თუ რას ნიშნავს ცხოვრება დაუმოწმებელი AI სისტემებით, რომლებიც გავლენას ახდენს მილიონობით ადამიანზე, საზოგადოებრივ ცხოვრებაში.
