...
m24-home-in-the-atlantic = ატლანტიკში { -brand-name-mozilla }-ს ტექნოლოგიების ხელმძღვანელი რაფი კრიკორიანი სვამს კითხვას, თანამოსაუბრე და შემოქმედი ხელგონი გამალებით რატომ ცდილობს აღგვაფრთოვანოს და რას ნიშნავს ეს კაცობრიობისთვის. (სურათის მომწოდებელია ატლანტიკი)
# Used as an accessible text alternative for an image
