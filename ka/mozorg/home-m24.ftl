...
m24-home-page-desc = იცოდით თუ არა, რომ { -brand-name-mozilla } — { -brand-name-firefox }-ის შემქმნელი — იბრძვის იმისთვის, რომ ინტერნეტი დარჩეს საერთაშორისო, საჯარო და საყოველთაო ხელმისაწვდომ რესურსად.
m24-home-page-desc-v2 = ჩვენ ვმუშაობთ, რომ ინტერნეტის მართვა ინტერნეტის მოსარგებლეების ხელში დასაბრუნებლად.

## Intro

m24-home-welcome-to-mozilla = მოგესალმებათ { -brand-name-mozilla }
m24-home-from-trustworthy-tech = სანდო ტექნიკიდან დაწყებული დებულებებით, თქვენი ციფრული უფლებების დასაცავად, ჩვენ უწინარესობაში თქვენ გაყენებთ — ყოველთვის.
m24-home-learn-about-us = გაიგეთ ჩვენს შესახებ

## Products

m24-home-love-the-internet = კვლავ შეიყვარეთ ინტერნეტი
m24-home-break-free-from = გათავისუფლდით დიდი ტექნოლოგიებისგან — ჩვენი პროდუქტები შეგიქმნით ინტერნეტის უსაფრთხოდ და პირადულობაზე.
...
m24-home-donate-to-the = დაეხმარეთ { -brand-name-mozilla }-ს, არამომგებიანი დაწესებულებას
