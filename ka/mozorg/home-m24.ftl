...
# HTML Page title
m24-home-page-title = ინტერნეტი ხალხისთვის და არა მოგებისთვის — { -brand-name-mozilla }
m24-home-page-title-v2 = { -brand-name-mozilla } — ინტერნეტი ხალხისთვის და არა მოგებისთვის
# HTML page description
m24-home-page-desc = იცოდით თუ არა, რომ { -brand-name-mozilla }, რომლის ქმნილებაცაა { -brand-name-firefox } — იბრძვის, რომ ინტერნეტი დარჩეს საერთაშორისო, საჯარო და საყოველთაოდ ხელმისაწვდომ საშუალებად.
m24-home-page-desc-v2 = ჩვენ ვიღწვით, რომ ინტერნეტის მართვის სადავეები ხალხის ხელში დაბრუნდეს.

## Intro

m24-home-welcome-to-mozilla = მოგესალმებათ { -brand-name-mozilla }
m24-home-from-trustworthy-tech = სანდო ტექნოლოგიებით დაწყებული, ხალხის ციფრული უფლებების უზრუნველმყოფი დებულებებით გაგრძელებული, ჩვენთვის უწინარესი თქვენ ხართ და იქნებით — მუდამ.
m24-home-learn-about-us = ვრცლად ჩვენ შესახებ
# Used as accessible text alternative for image
m24-home-alt-flag = თავისებურებით გამორჩეული მწვანე დროშა შავ ფონზე, რომლის მთავარი შემადგენელია ‘M’ სახელიდან { -brand-name-mozilla }, ამასთან შეიცავს წანაცვლებულ პიქსელს თავდაპირველ დინოზავრის ლოგოსთან მსგავსებისთვის.

## Products

m24-home-love-the-internet = კვლავ შეიყვარეთ ინტერნეტი
m24-home-break-free-from = გათავისუფლდით ტექგიგანტებისგან — ჩვენი პროდუქტები მოგცემთ ინტერნეტის უსაფრთხოდ და პირადულობის დაცვით გამოყენების შესაძლებლობებს.
m24-home-explore-our-products = გაეცანით ჩვენს პროდუქტებს
m24-home-firefox = { -brand-name-firefox }
m24-home-get-the-gold = სანიმუშო საშუალება გვერდების მოსანახულებლად სწრაფად, პირადულობითა და სრულად მართვის შესაძლებლობით.
m24-home-thunderbird = { -brand-name-thunderbird }
m24-home-go-chaosfree-with = გაიიოლეთ საქმე თქვენი ყველა ელფოსტის, კალენდრისა თუ სატელეფონო წიგნაკის ერთად თავმოყრით.
m24-home-mozilla-vpn = { -brand-name-mozilla-vpn }
m24-home-keep-your-location = დატოვეთ თქვენი ადგილსამყოფელი და ინტერნეტთავგადასავლები პირადი — გაუშვით პირდაპირი ეთერები ადგილობრივთა მსგავსად ნებისმიერ მხარეში.
...
m24-home-tabstack-desc = საიმედო თვითმოქმედი ვებდავალებები მარტივი და შემმუშავებელზე მორგებული API-მაკავშირებლით.

## Donate

# Obsolete string (expires 04-12-2025)
m24-home-donate-to-the = დაეხმარეთ შემოწირულობით { -brand-name-mozilla }-ს, არამომგებიან დაწესებულებას
m24-home-donate-to-v2 = გაიღეთ შემოწირულობა – { -brand-name-mozilla-foundation }
# Obsolete string (expires 04-12-2025)
m24-home-mozilla-is-building = { -brand-name-mozilla } ქმნის მოძრაობას ინტერნეტის დასაბრუნებლად. ერთად ჩვენ შეგვიძლია ავაშენოთ მომავალი, რომელშიც ჩვენი პირადულობა იქნება დაცული, ხელოვნური გონი კი სანდო, ხოლო არაკეთილსინდისიერ ტექკომპანიებს დაეკისრებათ პასუხისმგებლობა. მაგრამ ეს მხოლოდ ერთად დგომით მიიღწევა.
m24-home-mozilla-foundation-is-building-v2 = { -brand-name-mozilla-foundation } ქმნის მომავალს, რომელშიც ტექნოლოგია იქნება ხალხის ძალით მართული და იმთავითვე ღია მოწყობის მქონე. სწორედ ამიტომ ვასაზრდოებთ ერთობაზე დაფუძნებულ ტექნოლოგიებს საყოველთაო გავრცელებით, განათლებით, დაფინანსებითა თუ სიახლეების დანერგვით – რათა უზრუნველვყოთ, რომ ტექნოლოგიების მომავალი იყოს საყოველთაოდ სასიკეთო. მაგრამ ეს მხოლოდ ერთად დგომით იქნება შესაძლებელი.
m24-home-were-proudly-nonprofit = ჩვენ ვართ არამომგებიანი და ვამაყობთ ამით. გსურთ დღესვე უზრუნველყოთ შემოწირულობით { -brand-name-mozilla }?
...
m24-home-do-we-need-a = კიდევ გამოგვადგება თუ არა „LAMP-წყება“ ხელგონის ხანაში? ჩვენ გვესაჭიროება ტექნოლოგია, რომელიც იქნება გამჭვირვალე, ანგარიშვალდებული და იმ ხალხის საკუთრებაში, ვინც მას იყენებს.
m24-home-watch-now = უყურეთ ახლავე
m24-home-choice-first-stack = აირჩიეთ პირველი წყება
m24-home-your-tools-your = ხელსაწყოები თქვენს არჩევანზეა. ღია წყაროს მქონე ერთიანი ნაკრები, რომელიც გააიოლებს თანამედროვე სახის ხელგონის საშუალებებისა და პროგრამების შექმნასა თუ გამოცდას.
...
m24-home-mozilla-data-collective = { -brand-name-mozilla } – მონაცემთა კრებულები
m24-home-mozilla-data-collective-is = { -brand-name-mozilla } მონაცემთა კრებულებით აშენებს ხელგონის ისეთ გარემოს, რომლის უპირველესი საფუძველიც საზოგადოებაა.
...
m24-home-mozilla-ai-ceo = { -brand-name-mozilla-ai-v2 } – აღმასრულებელი დირექტორი ღია ხელგონის უპირატესობებზე საუბრობს
# Obsolete string (expires 2026-03-01)
m24-home-introducing-thundermail-and = გაიცანით Thundermail და Thunderbird Pro
m24-home-introducing-thundermail-and-v2 = გაეცანით { -brand-name-thundermail } და { -brand-name-thunderbird-pro }
m24-home-what-comes-next = ტექნოლოგიის მომავალია არჩევანი. აირჩიეთ ჩვენთან ერთად.
m24-home-a-good-moment = „ხელსაყრელი დრო ჩვენთვის“: { -brand-name-firefox } ხელგონის მქონე ბრაუზერების პირისპირ და რა ელის ვებსივრცეს
m24-home-the-guardian = The Guardian
m24-home-axios = Axios
m24-home-mozillas-new-message = { -brand-name-mozilla } ახალი განაცხადით: ჩვენ ვართ ერთადერთი ბრაუზერი მილიარდერების მხარდაჭერის გარეშე
m24-home-fast-company = Fast Company
m24-home-mozilla = { -brand-name-mozilla }
m24-home-the-ft = FT
m24-home-rewiring-mozilla = { -brand-name-mozilla }-ს გადაწყობა: ხელგონისთვის კეთდება ის, რასაც ვაკეთებდით ვებსივრცისთვის.
m24-home-interview-with-mark = ინტერვიუ მარკ სურმანთან: როგორ ერგება { -brand-name-mozilla } ხელგონის ხანას
m24-home-women-in-product = ქალების საუბრები ტექწარმოების შესახებ: GenAI-ის დამატება გეგმების გადაუხვევლად
m24-home-scaling-open-source = ღია წყაროს ხელგონის ზრდა: მარკ სურმანი და ტიმ ბრედშოუ

## Showcase

m24-home-rise25-awards = { -brand-name-rise25 }-ჯილდოები
m24-home-get-to-know = გაიცანით ხელოვნური გონის სანდო, ყოვლის მომცველი და გამჭვირვალე სახით შემუშავებაში მოწინავე ხელმძღვანელებს, რომლებიც ქმნიან ახალ სტანდარტებს და შთაგონების წყაროს წარმოადგენენ სიახლეების დანერგვის მსურველი ახალი თაობებისთვის.
...
# Variables
#   $year - year of report
m24-home-mozilla-is-reinventing-itself-v3 = ჩვენ ვდგავართ მომავლის ტექნოლოგიების გზაგასაყარზე, ხელგონზე მიმართული დიდი კომპანიების მიერ ძალაუფლების განმტკიცების ხანაში. მოხსენება { -brand-name-mozilla } { $year } ერთგვარი მოსაწვევია, რომ ერთად ავირჩიოთ განსხვავებული მომავალი.
# Obsolete string (expires: 2026-03-27)
# Used as an accessible text alternative for an image
...
m24-home-explore-issues-shaping = გაეცანით საკითხებს, რომლებიც აყალიბებს ინტერნეტის მომავალს
m24-home-the-validation-machines = შესამოწმებელი მანქანები
m24-home-in-the-atlantic = ატლანტიკში { -brand-name-mozilla }-ს ტექნოლოგიების ხელმძღვანელი რაფი კრიკორიანი სვამს კითხვას, თანამოსაუბრე და შემოქმედი ხელგონი გამალებით რატომ ცდილობს აღგვაფრთოვანოს და რას მოასწავებს ეს კაცობრიობისთვის. (სურათის მომწოდებელია ატლანტიკი)
# Used as an accessible text alternative for an image
m24-home-alt-validation = შემცირებული ზომის კაცი უყურებს კლავიატურის დიდ ღილაკს და კომპიუტერის მომნუსხველ ეკრანს
# Used as an accessible text alternative for an image
