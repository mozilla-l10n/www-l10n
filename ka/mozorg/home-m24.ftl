...
m24-home-mozilla-celebrates-groundbreaking = { -brand-name-mozilla } აღნიშნავს ახალ შემქმნელებს დოკუმენტური ფილმების ახალ სერიებში „{ -brand-name-firefox }-ის საჩუქრები“.
m24-home-big-techs-power = დიდი ტექნიკის ძალაუფლება ენაზე, ნიშნავს ძალაუფლებას ხალხზე. ბრიჯიტ ტოდი ესაუბრება ენის ერთობის ხელმძღვანელებს, გზას უხსნის ხმოვანი ხელოვნური ინტელექტის განვითარებას საკუთარ ენებსა და დიალექტებზე.
