...
m24-home-keep-your-location = დატოვეთ თქვენი ადგილსამყოფელი და ინტერნეტთავგადასავლები პირადი — გაუშვით პირდაპირი ეთერები ისე, თითქოს ადგილობრივი იყოთ, ნებისმიერ მხარეში.
...
# Obsolete string (expires 04-12-2025)
m24-home-mozilla-is-building = { -brand-name-mozilla } ქმნის მოძრაობას ინტერნეტის დასაბრუნებლად. ერთად ჩვენ შეგვიძლია ავაშენოთ მომავალი, რომელშიც ჩვენი პირადულობა იქნება დაცული, ხელოვნური ინტელექტი კი სანდო, ხოლო არაკეთილსინდისიერ ტექკომპანიებს დაეკისრებათ პასუხისმგებლობა. მაგრამ ეს მხოლოდ ერთად დგომით მიიღწევა.
...
m24-home-introducing-anonym = გაიცანით { -brand-name-anonym }: პირადულობის უზრუნველმყოფი ციფრული რეკლამა ახალ დონეზე.
m24-home-keeping-genai-technologies = შემოქმედებითი (GenAI) ხელოვნური ინტელექტის საშუალებების უსაფრთხოება საერთო პასუხისმგებლობაა.
m24-home-from-hollywood-to = ჰოლივუდიდან დაწყებული ჰიპ-ჰოპით დამთავრებული, ხელოვანები მოლაპარაკებებს აწარმოებენ AI-ს გამოყენების ნებართვის შესახებ.
m24-home-mozilla-celebrates-groundbreaking = { -brand-name-mozilla } გაგაცნობთ სიახლეების შემოქმედ ხალხს დოკუმენტური ფილმების ახალ წყებაში, სახელწოდებით „{ -brand-name-firefox } წარმოგიდგენთ“.
m24-home-big-techs-power = ტექგიგანტების ძალაუფლება ენის საშუალებებზე, ნიშნავს ძალაუფლებას ხალხზე. ბრიჯიტ ტოდი ესაუბრება ენების წარმომადგენლობათა ხელმძღვანელებს, როგორ გაიკვალონ გზა საკუთარი ენებისა თუ კუთხური მეტყველებისთვის ხელოვნური ინტელექტის განვითარების საქმეში.
m24-home-why-does-it = რატომ ჩანს ისე, თითქოს ხელოვნური ინტელექტის საყოველთაო ცდების მონაწილენი ვართ? როგორი უნდა იყოს ახალი ტექნოლოგიების გამოცდის საპასუხისმგებლო გზები? ბრიჯიტ ტოდი განიხილავს, თუ რას ნიშნავს ცხოვრება დაუხვეწავ AI-სისტემებთან, რომლებიც მილიონობით ადამიანზე ახდენს გავლენას საჯაროდ გამოშვებისთანავე.
m24-home-kids-are-growing = ბავშვები იზრდებიან ინტერნეტზე ზედმეტად დამოკიდებულ სამყაროში. რა შეიძლება მოიმოქმედონ შეშფოთებულმა მშობლებმა?
...
m24-home-our-multiaward-winning = მრავალი ჯილდოს მფლობელი ჩვენი პოდკასტი წარმოგიდგენთ სამყაროს უკეთესობისკენ გარდაქმნის მსურველებს, რომლებიც იღწვიან ინტერნეტის უსაფრთხოებისა და ხელოვნური ინტელექტის სანდოობის გაუმჯობესებისთვის.
