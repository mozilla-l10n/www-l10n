...
m24-home-get-the-gold = მიიღეთ ოქროს სტანდარტი, გვერდების მონახულებისას სიჩქარით, კონფიდენციალურობისა და სამართავად.
m24-home-thunderbird = { -brand-name-thunderbird }
m24-home-go-chaosfree-with = გაიმარტივეთ ცხოვრება ერთი აპლიკაციით, თქვენი ელფოსტის წერილისთვის, კალენდრისა და მომხმარებლისთვის.
m24-home-fakespot = { -brand-name-fakespot }
m24-home-spot-fake-reviews = დააფიქსირეთ ყალბი მიმოხილვები, ცუდი პროდუქტები და არასანდო გამყიდველები.
m24-home-pocket = { -brand-name-pocket }
m24-home-save-the-internets = შეინახეთ ინტერნეტის საუკეთესო შიგთავსი ნებისმიერ მოწყობილობაზე — იმიტომ რომ ვის აქვს ახლა ყველაფრის წაკითხვის დრო?
m24-home-mozilla-vpn = { -brand-name-mozilla-vpn }
m24-home-keep-your-location = შეინახეთ თქვენი მდებარეობა და ინტერნეტთავგადასავლები პირადულობაში — გაუშვით ნაკადი ადგილობრივი ხალხის მსგავსად, ყველგან.
