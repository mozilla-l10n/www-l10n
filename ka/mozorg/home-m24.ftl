...
m24-home-mozilla-foundation-is-building-v2 = { -brand-name-mozilla-foundation } აშენებს მომავალს, სადაც ტექნოლოგია აღჭურვილია ხალხით და გახსნილი დიზაინით. სწორედ ამიტომ, ჩვენ ვრთავთ ერთობაზე ორიენტირებულ ტექნოლოგიას ადვოკატირების, განათლების, დაფინანსებისა და ინოვაციების გზით – რათა უზრუნველვყოთ ტექნოლოგიების მომავალი სასიკეთო ყველასთვის. მაგრამ ეს მხოლოდ იმ შემთხვევაშია შესაძლებელი, თუ ჩვენ ერთად გავაკეთებთ.
