...
home-the-health-of = „სიჯანსაღე ინტერნეტისა და ვებსმყაროსი ისაა, რისთვისაც ვარსებობთ“.
home-mitchell-baker = მიტჩელ ბეიკერი, { -brand-name-mozilla }-ს აღმასრულებელი
...
home-product-relay-masks = ელფოსტისა და ტელეფონის მოხერხებულად შენიღბვა
...
home-mozilla-takes-bets = „{ -brand-name-mozilla }-ს განზრახული აქვს, მსოფლიოს უჩვენოს, რომ საქმის კეთება შეიძლება ნდობის მქონე ხელოვნური ინტელექტის მეშვეობითაც. ეს კი გულისხმობს, რომ ადამიანის უფლებების დაცვა, მონაცემთა უსაფრთხოება და გამჭვირვალობა უნდა იქცეს მთავარ მამოძრავებელ ძალად ამგვარი რთული სისტემების ასამუშავებლად“.
# Politico is a brand name for a news organization
home-politico-cite = Politico
home-is-mozilla-a-corporation = { -brand-name-mozilla } სააქციო საზოგადოებაა თუ – არამომგებიანი? სინამდვილეში ორივეა.
home-mozilla-consists-of = { -brand-name-mozilla } შედგება ორი დაწესებულებისგან. { -brand-name-mozilla-corporation } არის მფლობელი, რომლის საკუთრებაც სრულადაა არამომგებიანი 501(c) { -brand-name-mozilla-foundation }. ეს კი ნიშნავს, რომ არ ვართ ანგარიშვალდებულნი ვიღაც აქციონერების მიმართ — მხოლოდ დასახული მიზნებისა.
...
home-today-mozilla-continues = დღესდღეობით, { -brand-name-mozilla } განაგრძობს წინსვლას უკეთესი ინტერნეტის მშენებლობაში მილიონობით მხურვალე წევრისგან შემდგარი ერთობით მთელი მსოფლიოდან, მხარში უდგას ზნეობრივი ქცევის დანერგვას ტექნოლოგიებში, სანდო ხელოვნური ინტელექტისა და პირადულობის უზრუნველმყოფი პროდუქტების შემუშავებას, რომ მეტი ძალაუფლება აღმოჩნდეს ხალხის ხელში.
home-learn-more-about-mozilla = უკეთ გაიცანით { -brand-name-mozilla }
home-get-good-news = შეიტყვეთ (სასარგებლო) სიახლეები { -brand-name-mozilla }-სგან
home-get-news-and-tips = გაეცანით ახალ ამბებსა და რჩევებს { -brand-name-mozilla }-სგან, რომ შეინარჩუნოთ უსაფრთხოება და წინდაწინ იცოდეთ, რა აქცევს ინტერნეტს მეტად ჯანსაღ ადგილად.
# VPN Feature
