...
home-today-mozilla-continues = დღესდღეობით { -brand-name-mozilla } განაგრძობს წინსვლას უკეთესი ინტერნეტის მშენებლობაში მილიონობით მხურვალე მოხალისისგან შემდგარი ერთობით მთელი მსოფლიოდან, მხარში უდგას ზნეობრივი ქცევის დანერგვას ტექნოლოგიებში, სანდო ხელოვნური გონისა და პირადულობის უზრუნველმყოფი პროდუქტების შემუშავებას, რომ მეტი ძალაუფლება აღმოჩნდეს ხალხის ხელში.
