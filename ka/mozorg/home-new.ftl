...
home-mozilla-consists-of = { -brand-name-mozilla } შედგება ორი დაწესებულებისგან. { -brand-name-mozilla-corporation } არის სრული მფლობელი, რომლის საკუთრებაცაა არამომგებიანი 501(c) { -brand-name-mozilla-foundation }. ეს კი ნიშნავს, რომ არ ვართ ანგარიშვალდებულნი ვიღაც აქციონერების მიმართ — გარდა დასახული მიზნებისა.
