...
home-mozilla-is-the-not-for-profit = { -brand-name-mozilla } არის { -brand-name-firefox }-ის შემქმნელი არამომგებიანი ორგანიზაცია. ჩვენ ვქმნით პროდუქტებს არა ფინანსური შემოსავლის მისაღებად, არამედ იმ მიზნით, რომ ინტერნეტი სრულად მოხმარდეს საზოგადოების კეთილდღეობას.
