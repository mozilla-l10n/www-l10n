...
history-it-did-this-by-continuing = ამას აკეთებდა ისეთი პროგრამების გამოშვების უზრუნველყოფით, როგორებიცაა { -brand-name-firefox } და { -brand-name-thunderbird }, აგრეთვე, ახალი სფეროების ათვისებით, მათ შორის <a href="{ $grants }">ფინანსური</a> საშუალებების გამოყოფით, ვებსივრცეში ხელმისაწვდომობის მხარდასაჭერად.
# Variables:
