...
about-this-site-today = დღეს ამ საიტზე ხალხი შემოდის, რომ ჩამოტვირთონ <a href="{ $firefox }">{ -brand-name-firefox }</a>, მოსინჯონ <a href="{ $vpn }">{ -brand-name-mozilla-vpn }</a> და უკეთ გაიცნონ <a href="{ $mozilla }">{ -brand-name-mozilla }</a>. ამასთან ერთად, გზადაგზა წააწყდებით არაერთ <a href="{ $book }">დაფარულ მოულოდნელობასაც/a>.
