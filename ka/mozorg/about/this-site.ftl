...
about-this-site-this-website = საიტი www.mozilla.org ვებსივრცეში უკვე ორ ათეულ წელზე მეტია. შეიძლება ითქვას,<a href="{ $archive }">დინოზავრების ხანიდან</a> ინტერნეტის დროით. ასე რომ, www.mozilla.org ვებსამყაროს ერთგვარი ქვაკუთხედია ღრმა ფესვებით ღია წყაროს მოძრაობაში, რომლის <a href="{ $coderush }">ნაშიერიცაა { -brand-name-mozilla }</a>.
# Variables:
