...
footer-refresh-store = შესაძენი ნივთები
...
footer-refresh-donate-not-for-profit = შეეწიეთ არამომგებიან დაწესებულებას <a { $mofo_link }>{ -brand-name-mozilla-foundation }</a>.
