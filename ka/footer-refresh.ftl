...
footer-refresh-store = საქონლის მაღაზია
...
footer-refresh-security = უსაფრთხოება
...
footer-refresh-donate-not-for-profit = დაეხმარეთ არამომგებიანი დაწესებულებას <a { $mofo_link }>{ -brand-name-mozilla-foundation }</a>.
...
footer-refresh-community-participation-guidelines = მონაწილის გზამკვლევი
