...
footer-visit-mozilla-corporations = გაეცანით <a { $moco_link }>Mozilla-ს კორპორაციას,</a> არამომგებიან დაწესებულებას, რომლის შვილობილიცაა <a { $mofo_link }>Mozilla-ს ფონდი</a>.
