...
newsletter-form-we-will-only-send-v2 = გამოგიგზავნით მხოლოდ { -brand-name-mozilla }-სთან დაკავშირებულ მასალას. გამოწერის გაუქმება ნებისმიერ დროს შეგიძლიათ.
newsletter-form-we-will-only-send-firefox-v2 = მხოლოდ { -brand-name-firefox }-სთან დაკავშირებულ მასალას გამოგიგზავნით. გამოწერის გაუქმება ნებისმიერ დროს შეგიძლიათ.
