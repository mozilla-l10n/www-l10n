...
download-button-supported-devices = მხარდაჭერილი მოწყობილობები
...
download-button-get-firefox-android = გადმოწერეთ { -brand-name-firefox } { -brand-name-android }-ზე
download-button-get-firefox-ios = გადაიწერეთ { -brand-name-firefox } { -brand-name-ios }-ზე
download-button-google-play = ხელმისაწვდომია { -brand-name-google-play }-ზე
download-button-free-google-play = უფასოდ { -brand-name-google-play }-ზე
download-button-app-store = გადმოწერეთ უფასოდ { -brand-name-app-store }-დან
...
download-button-share-how-you-discovered = გაუზიარეთ { -brand-name-mozilla }-ს მარკეტინგული ტექნოლოგიების პარტნიორებს, თუ როგორ აღმოაჩინეთ { -brand-name-firefox } და როგორ იყენებთ მას. ეს მონაცემები არასდროს გაიყიდება და არ გამოიყენება რეკლამის საჩვენებლად. <a { $attrs }>იხილეთ, თუ როგორ ვიყენებთ მონაცემებს</a>.
