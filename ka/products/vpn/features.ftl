...
vpn-features-were-backed-by-mofo-v2 = ჩვენ ზურგს გვიმაგრებს <a { $mofo }>{ -brand-name-mozilla-foundation }</a>, არამომგებიანი დაწესებულება, რომელიც იბრძვის ვებსივრცის გახსნილობისა და სიჯანსაღისთვის ყველა ადამიანისთვის.
