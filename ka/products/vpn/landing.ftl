...
vpn-landing-brand-trust-desc = 20 წელზე მეტია, რაც { -brand-name-mozilla } ხალხს აყენებს ყველაფერზე წინ და იბრძვის ინტერნეტში პირადულობისთვის. არამომგებიანი დაწესებულების მხარდაჭერით, თავდაუზოგავად ვცდილობთ შევქმნათ უკეთესი და ჯანსაღი საყოველთაო ინტერნეტი. თითოეული ჩვენი მოქმედება, ექვემდებარება ჩვენს მიზანსა და <a href="{ $url }">პრინციპებს</a>.
