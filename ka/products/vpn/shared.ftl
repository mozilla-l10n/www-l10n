...
vpn-shared-availablity-long = ამჟამად VPN ხელმისაწვდომია { -brand-name-windows } 10, { -brand-name-android } და { -brand-name-ios } მოწყობილობებზე შტატებში, გაერთიანებულ სამეფოში, კანადაში, ახალ ზელანდიაში, სინგაპურსა და მალაიზიაში.
vpn-shared-money-back-guarantee = 30-დღიანი პერიოდი თანხის ანაზღაურებისთვის
