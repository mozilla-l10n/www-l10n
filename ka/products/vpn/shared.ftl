...
vpn-press-mozillas-vpn-can-also-integrate-into = „{ -brand-name-mozilla }-ს VPN-ს ასევე შეუძლია <a { $attrs }>ჩაამატოს პირადულობის დაცვის მოსახერხებელი შესაძლებლობები</a> მისსავე { -brand-name-firefox }-ბრაუზერში“.
