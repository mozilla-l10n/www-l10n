...
vpn-landing-a-virtual-private-network-protects = წარმოსახვითი კერძო ქსელი იცავს თქვენს კავშირებს და არ ამხელს, თუ სად იმყოფებით ან რას საქმიანობთ ინტერნეტში ნებისმიერი მოწყობილობით სარგებლობისას.
...
vpn-landing-how-a-vpn-helps-you-v2 = როგორ გეხმარებათ { -brand-name-mozilla-vpn }
