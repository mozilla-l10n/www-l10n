...
# Variables:
#   $subscription - link to https://support.mozilla.org/kb/how-add-devices-your-mozilla-vpn-subscription
vpn-download-faq-adding-another = სხვა მოწყობილობის დამატება ისეთივე ადვილია, როგორიც { -brand-name-mozilla-vpn }-ის პროგრამული უზრუნველყოფის ჩამოტვირთვა და დაყენება, შემდეგ კი ახალ მოწყობილობაზე არსებული { -brand-name-firefox-account } შესვლა. ვრცლად იხილეთ <a href="{ $subscription }">როგორ უნდა დაემატოს მოწყობილობები თქვენს { -brand-name-mozilla-vpn }-გამოწერას</a>.
...
vpn-download-faq-support = შეგიძლიათ შეეხმიანოთ ჩვენს მხარდაჭერის გუნდს პირდაპირ { -brand-name-mozilla-vpn }-პროგრამიდანვე, დაწკაპეთ პარამეტრები > დახმარების მიღება > დაუკავშირდით მხარდაჭერას. ასევე შეგიძლიათ მოგვწეროთ <a href="{ $support }">ჩვენს მხარდაჭერის გვერდზე</a>.
