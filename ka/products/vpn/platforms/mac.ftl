...
vpn-mac-page-description = იქნება ეს სამაგიდო { -brand-name-mac-short }-კომპიუტერი, ლეპტოპი, { -brand-name-ipad } თუ { -brand-name-iphone }, სრულად დაიცავს თქვენს მოწყობილობას ჰაკერებისა და მეთვალყურეებისგან VPN { -brand-name-mozilla }-სგან, ინტერნეტში უსაფრთხოებაზე ზრუნვის, ერთ-ერთი წამომწყებისგან, 1998 წლიდან.
# Mac strings
vpn-mac-hero-headline = დაიცავით თქვენი კავშირები ინტერნეტში { -brand-name-mozilla-vpn }-ით { -brand-name-mac-short }-ზე
vpn-mac-ability = მუშაობისას თუ დასვენებისას, იგრძენით თავი უსაფრთხოდ ინტერნეტში, რასაც არ უნდა აკეთებდეთ. { -brand-name-mozilla-vpn } დაგეხმარებათ საჯარო WiFi-ს მოხერხებულად გამოყენებაში, თქვენი კავშირების დაცვით ჰაკერებისა და ინტერნეტის მომწოდებლის მიერ მონაცემების შეგროვებისგან. პირადულობა ერთი დაწკაპებით ხელმისაწვდომია { -brand-name-mac-short }-სა და { -brand-name-ios }-ზე, (ისევე როგორც { -brand-name-windows } 10, { -brand-name-linux } და { -brand-name-android }), ამასთანავე, არ იმოქმედებს თქვენს სიჩქარეზე. და ვინაიდან VPN { -brand-name-mozilla }-სგან აღჭურვილია { -brand-name-wireguard }® ოქმით, შეგიძლიათ მშვიდად იყოთ, თქვენი მოქმედებები არ აღირიცხება და დარჩება პირადი — მუდამ.
