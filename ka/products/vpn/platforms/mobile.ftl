...
# Meta strings
vpn-mobile-page-title = { -brand-name-mozilla-vpn } მობილურისთვის (სმარტფონზე და პლანშეტზე)
vpn-mobile-page-description = დაიცავით სმარტფონი და პლანშეტი VPN-ით { -brand-name-mozilla }-სგან, ინტერნეტში პირადულობის უპირველესი სანდო დამცველისგან.
# Mobile strings
vpn-mobile-hero-headline = დაიცავით თქვენი პირადი ინფორმაცია მობილურზე { -brand-name-mozilla-vpn }-ით
vpn-mobile-maker-of-firefox = იყავით თავდაჯერებული თქვენი ტელეფონის კავშირების უსაფრთხოებაში, სადაც არ უნდა იყოთ, { -brand-name-mozilla-vpn }-ის მეშვეობით, რომელიც აუცილებელი საშუალებაა პირადულობის დასაცავად, { -brand-name-firefox }-ის შემქმნელებისგან.
# Variables:
#   $devices (number) - number of available devices
vpn-mobile-ability = { -brand-name-mozilla-vpn } არ აძლევს ჰაკერებსა და მეთვალყურეებს საშუალებას, იხილონ თქვენი IP-მისამართი ან თვალი ადევნონ თქვენს გადაადგილებას ინტერნეტში. მაღალი დონის დაშიფვრითა და გამტარუნარიანობის შეზღუდვების გარეშე, ტელეფონით ვიდეოების ეთერში გაშვება და ვებსივრცეში მოგზაურება, უსწრაფესად და სანდო დაცვით შეგეძლებათ. დაბალი ყოველთვიური გადასახადით, შეძლებთ დაიცვათ { $devices } მოწყობილობამდე, მსოფლიოში ათობით სერვერთან მიერთებით.
vpn-mobile-wifi-headline = იყავით დაცული საჯარო WiFi-ს გამოყენებისას
...
vpn-mobile-about-copy = უკეთ ცნობილი, როგორც ჩვენი { -brand-name-firefox-browser(case: "gen") } შემქმნელი, { -brand-name-mozilla } საერთაშორისო ერთობაა მომხმარებლების, შემომწირველებისა და შემმუშავებლების, რომლებიც ზრუნავენ, რომ ინტერნეტი დარჩეს ხალხის ხელში. დაფუძნებული 1998 წელს, ვართ ერთ-ერთი მოწინავეთაგანი, თავისუფალი და ღია ვებსივრცისთვის ბრძოლაში — და ჩვენი მიზანია, ასე განვაგრძოთ.
