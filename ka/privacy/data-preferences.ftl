...
data-preferences-page-title = მართეთ საკუთარ მონაცემთა პირდაპირი აღრიცხვის პარამეტრები
...
data-preferences-if-you-still-want-to = თუ მაინც გსურთ მონაცემთა პირდაპირ აღრიცხვაზე უარის თქმა, შეგიძლიათ მიუთითოთ ქვემოთ. გამოთიშვის ღილაკზე დაწკაპებით ჩაემატება შესაბამისი პარამეტრის ფუნთუშა, რომელიც არ მისცემს საშუალებას { -brand-name-glean }-ს, რომ გაგზავნოს მონაცემები ჩვენი ვებგვერდების მონახულებისას. ამ ფუნთუშის ვადაა 1 წელიწადი.
data-preferences-current-preference = მიმდინარე მითითება:
data-preferences-please-enable-javascript = გთხოვთ, ჩართოთ JavaScript მონაცემთა პარამეტრების გასამართად.
data-preferences-opt-out-button = გამოთიშვა მონაცემთა პირდაპირი აღრიცხვიდან
data-preferences-if-you-change = თუ გადაიფიქრებთ, კვლავ შეგეძლებათ მონაწილეობა აქედან:
data-preferences-opt-in-button = ჩართვა მონაცემთა პირდაპირ აღიცხვაში
