...
# Linux strings
vpn-linux-hero-headline = { -brand-name-mozilla-vpn } për { -brand-name-ubuntu } { -brand-name-linux } — një dyshe përsosmërisht private
vpn-linux-ability = Ndërmerrni një masë ekstra sigurie, për kur jeni në internet — në shtëpi apo jashtë saj — me { -brand-name-mozilla-vpn }. Kundrejt një tarife të vockël mujore, përdor protokollin e përparuar { -brand-name-wireguard }® për të fshehtëzuar lidhjen tuaj internet në kompjuterin tuaj { -brand-name-linux }, si dhe në lloje të tjera pajisjesh, duke ju lejuar të shihni shfaqje, të luani lojëra, të bëni blerje dhe të vazhdoni jetën tuaj internetore duke e ditur që kjo bëhet pa rrezik.
vpn-linux-maker-of-firefox = Si një nga emrat më të besuar në industrinë e teknologjisë, { -brand-name-mozilla } i është përkushtuar garantimit që të ndiheni të parrezik dhe të sigurt sa herë që lidheni në internet.
vpn-linux-wifi-headline = Jini i parrezik në internet, kur ju duhet të përdorni wifi publik
vpn-linux-wifi-copy = Ndonjëherë, wifi publik është mundësia juaj më e mirë dhe e vetmja. { -brand-name-mozilla-vpn } ju lejon të ndiheni të lirë të bëni hyrje në email-in tuaj që nga aeroporti, të përpunoni fjalëkalimet tuaj në një kafe — gjithçka që do të bënit në shtëpi me të njëjtën qetësi.
