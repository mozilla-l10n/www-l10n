...
# Meta strings
vpn-mobile-page-title = { -brand-name-mozilla-vpn } për celular (telefona të mençur & tablete)
vpn-mobile-page-description = Mbrojeni telefonin tuaj të mençur dhe tabletin tuaj me një VPN nga { -brand-name-mozilla }, pionjeri i besuar për privatësi në internet.
# Mobile strings
vpn-mobile-hero-headline = Siguroni privatësinë tuaj në celular me { -brand-name-mozilla-vpn }
