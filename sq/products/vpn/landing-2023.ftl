...
# HTML page title
vpn-landing-title = { -brand-name-mozilla-vpn }: Mbroni Krejt Pajisjen Tuaj
# HTML page description
# Variables:
#   $countries (number) - number of available countries
vpn-landing-desc = Përdoreni { -brand-name-mozilla-vpn } për mbrojtje të plotë për krejt aplikacionet tuaja. Me shërbyes në mbi { $countries } vende, mundeni të lidheni me kudo, prej ngado.
vpn-landing-powerful-privacy-for-peace = Privatësi e fuqishme, për ta pasur mendjen të fjetur
vpn-landing-whats-a-vpn = Ç’është një VPN?
...
vpn-landing-fast-network-speeds-even-while = Shpejtësi të mëdha rrjeti teksa luani
...
vpn-landing-one-subscription-for-all-your = Një pajtim për krejt pajisjet tuaja
# HTML for emphasis
vpn-landing-powered-by-mozilla-fighting-for = <strong>Sjellë nga { -brand-name-mozilla }.</strong> Njerëzit para fitimeve, që prej 1998-s.
vpn-landing-learn-more-from-our-experts = Mësoni më tepër, nga ekspertët tanë
vpn-landing-do-you-need-a-vpn-at-home = A ju duhet një VPN në shtëpi? Ja 5 arsye pse mundet.
