...
footer-refresh-x = X
footer-refresh-x-formerly-twitter = X (ish-Twitter)
...
footer-refresh-follow-firefox = Ndiqni @{ -brand-name-firefox }
footer-refresh-youtube = YouTube
footer-refresh-company = Shoqëri
footer-refresh-press-center = Qendra e Shtypit
footer-refresh-careers = Punësime
footer-refresh-contact = Kontakte
footer-refresh-support = Asistencë
...
footer-refresh-portions-of-this-content = Pjesë të kësaj lënde janë nën të drejta kopjimi ©1998–{ $current_year } nga kontribues individualë te mozilla.org. Lëndë e passhme sipas një <a rel="license" { $href }>licence { -brand-name-creative-commons }</a>.
