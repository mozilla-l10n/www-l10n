...
# HTML page title
firefox-privacy-hub-firefox-privacy-promise = Premtim Privatësie { -brand-name-firefox }
# HTML page description
firefox-privacy-hub-firefox-takes-less-data-keeps = { -brand-name-firefox } merr më pak të dhëna, i mban të parrezikuara dhe pa të fshehta.
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words, please omit the strong tags if they need to be around multiple words in your language
firefox-privacy-hub-firefox-products-are-designed = Produktet { -brand-name-firefox } janë të konceptuara për mbrojtjen e <strong>privatësisë</strong> tuaj
# Sub navigation title
firefox-privacy-privacy = Privatësi
# Sub navigation link
firefox-privacy-our-promise = Premtimi Ynë
# Sub navigation link
firefox-privacy-our-products = Produktet Tona
firefox-privacy-hub-you-should-be-able-to-decide = Duhet të jeni në gjendje të vendosni cilët i shohin të dhënat tuaja personale. Jo thjesht mes shokëve tuaj, por për çdo reklamues dhe shoqëri në internet — përfshi ne.
firefox-privacy-hub-thats-why-everything-we-make = Kjo është arsyeja pse gjithçka që bëjmë respekton Premtimin tonë mbi të Dhënat Personale
firefox-privacy-hub-take-less = Merrni Më Pak
firefox-privacy-hub-we-make-a-point-of-knowing = Insistojmë në njohjen e më pak gjërave rreth jush
...
firefox-privacy-hub-get-pocket = Merrni { -brand-name-pocket }-in
