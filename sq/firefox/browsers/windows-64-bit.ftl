...
windows-64-bit-if-you-see-32-bit-newer = Nëse shihni “(32-bit)” dhe xhironi { -brand-name-firefox } 56.0.1 ose më të ri, atëherë kompjuteri juaj mund të mos plotësojë domosdoshmëritë minimum mbi kujtesën për 64-bit (3 GB RAM ose më tepër). Mundeni ta instaloni { -brand-name-firefox }-in 64-bitësh edhe dorazi, nëse doni.
# Variables:
