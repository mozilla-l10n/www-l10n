...
# HTML page title
welcome-page6-make-firefox-your-default = Bëjeni { -brand-name-firefox }-in shfletuesin tuaj parazgjedhje
welcome-page6-make-sure-youre-protected = Sigurohuni se jeni të mbrojtur, sa herë që jeni në internet
welcome-page6-when-you-choose-firefox-you = Kur zgjidhni { -brand-name-firefox }-in, përkrahni një web më të mirë për ju dhe këdo tjetër. Tani, ndërmerrni hapin pasues për mbrojtjen e vetes.
welcome-page6-get-the-firefox-app = Merrni Aplikacionin { -brand-name-firefox }
welcome-page6-get-firefox-on-your-phone = Merreni { -brand-name-firefox }-in në Telefonin tuaj
welcome-page6-scan-the-qr-code-to-get-started = Që t’ia filloni, skanoni kodin QR
welcome-page6-qr-code-to-scan-for-firefox = Kod QR që duhet skanuar për { -brand-name-firefox }-in
