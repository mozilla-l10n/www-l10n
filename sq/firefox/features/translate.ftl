...
features-translate-while-other-browsers-rely-on = Teksa shfletues të tjerë bazohen në shërbime re, modelet gjuhësore të Përkthimeve me { -brand-name-firefox } shkarkohen në shfletuesin e përdoruesit dhe përkthimet bëhen lokalisht, kështu që { -brand-name-mozilla } s’regjistron çfarë faqesh përktheni.
...
features-translate-and-more-languages-are-in = Dhe më tepër gjuhë janë duke u zhvilluar!
