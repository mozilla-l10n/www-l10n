...
# HTML page title
features-index-protect-your-privacy-and-browse = Mbroni privatësinë tuaj dhe shfletoni më me shpejtësi, përmes veçorive të { -brand-name-firefox }-it
...
features-index-firefox-automatically = { -brand-name-firefox } bllokon automatikisht ndjekjen tuaj nëpër internet nga mbi 2000 gjurmues reklamash.
features-index-access-all-passwords = { -brand-name-firefox-lockwise } ju lejon të përdorni krejt fjalëkalimet që keni ruajtur në { -brand-name-firefox } — dhe është falas.
features-index-just-enough = { -brand-name-firefox }-i përdor aq kujtesë sa duhet për të krijuar një punim të rrjedhshëm, që kështu kompjuteri juaj të mbetet reagues ndaj punësh të tjera.
features-index-use-less-memory = { -brand-name-firefox }-i përdor më pak kujtesë se sa { -brand-name-chrome }, që kështu programet tuaj të tjerë të mund të xhirojnë me shpejtësinë maksimale.
features-index-open-source-minds = Me burim të hapët. Me mendje të hapët.
features-index-mozilla-creates = { -brand-name-mozilla } krijon teknologji të fuqishme web për këdo.
features-index-see-what-makes-us-different = Shihni ku dallojmë nga të tjerët
features-index-by-non-profit-mozilla = Nga enti jofitimprurës, { -brand-name-mozilla }
features-index-by-not-for-profit-mozilla = Nga enti jofitimprurës, { -brand-name-mozilla }
features-index-keep-corporate-power = Mbani nën kontroll pushtetin e korporatave
features-index-independent-browser = { -brand-name-firefox }-i është i vetmi shfletues i pavarur mes atyre me peshë.
features-index-on-a-mission = Me misionin e mbajtjes së internetit të hapur dhe të përdorshëm nga të gjithë.
...
features-index-private-by-default = Privat, si parazgjedhje
features-index-enhanced-tracking = Mbrojtje e thelluar nga gjurmimi
...
features-index-firefox-vs = { -brand-name-firefox } vs. shfletuesish të tjerë
features-index-stack-up = Shihni se si del { -brand-name-firefox }-i përballë shfletuesish të tjerë popullorë.
features-index-compare-browsers = Krahasoni shfletuesit
features-index-see-themes = Shihni temat kryesuese
features-index-download-latest = Shkarkoni { -brand-name-firefox }-in më të ri
features-index-fingerprinter-blocking = Bllokim Profilizimi
features-index-fingerprinting-is-a = <em>Fingerprinting</em> është një lloj gjurmimi internetor që është më i rëndë se sa gjurmimi i zakonshëm i bazuar në cookie-t — kjo është arsyeja pse { -brand-name-firefox-browser }-i e bllokon.
features-index-block-fingerprinters = Blloko krijues shenjash gishtash
