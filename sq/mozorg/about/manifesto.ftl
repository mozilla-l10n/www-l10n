...
manifesto-details-the-mozilla-project-global = Projekti { -brand-name-mozilla } është një bashkësi mbarëbotërore njerëzish që besojnë se të qenët i hapur, risitë dhe dhënia e mundësive janë kyçet e shëndetit në vazhdimësi të Internetit. Punojmë së bashku që prej 1998, për të bërë të mundur që Interneti të zhvillohet i tillë që prej tij të përfitojnë të gjithë. Më shumë na njohin për krijimin e shfletuesit { -brand-name-mozilla } { -brand-name-firefox }.
