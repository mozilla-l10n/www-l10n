...
manifesto-visualize-who-you-interact = Shihni përmes Lightbeam-it se me kë ndërveproni në Web
manifesto-learn-about-creating-web = Mësoni si të krijoni burime Web me të tjerët
manifesto-host-or-join-a-maker-party = Organizoni ose merrni pjesë në një Maker Party
...
manifesto-details-articulate-a-vision = t’i japë formë përfytyrimit që bashkëpunëtorët e { -brand-name-mozilla }-s dëshirojnë të ndiqet nga Fondacioni { -brand-name-mozilla };
...
manifesto-details-these-principles = Këto parime nuk lulëzojnë vetë. Lypsen njerëz që ta bëjnë Internetin të hapur dhe dashamirës - njerëz që punojnë më vete, që punojnë tok në grupe, dhe që udhëheqin të tjerët. Fondacioni { -brand-name-mozilla } i është përkushtuar shpënies më tej të parimeve të ravijëzuara te Manifesti { -brand-name-mozilla }. Ftojmë edhe të tjerët të bashkohen me ne për ta bërë Internetin një vend akoma më të mirë për të tërë.
