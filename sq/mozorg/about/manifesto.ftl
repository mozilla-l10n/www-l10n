...
manifesto-the-open-global-internet = Interneti i hapur, global, është burimi më i fuqishëm i komunikimit dhe bashkëpunimit që kemi parë ndonjëherë. Ai mishëron disa nga shpresat më të thekka për përparim njerëzor. Ai bën të mundur mundësi të reja për të mësuar, për të krijuar një ndjenjë humanizmi të përbashkët, dhe për zgjidhjen e problemeve urgjente me të cilat ndeshen njerëzit kudo.
...
manifesto-details-the-mozilla-foundation-invites = { -brand-name-mozilla-foundation } fton gjithë të tjerët që mbështesin parimet e Manifestit { -brand-name-mozilla } ta bashkohen me ne, dhe të gjejmë rrugë të reja për ta bërë realitet këtë përfytyrim të Internetit.
