...
newsletters-newsletter-subscriptions = Pajtime Në Buletine
...
newsletters-your-newsletter-subscription = Pajtimi juaj te buletini u konfirmua.
newsletters-please-be-sure-to-add-our = Ju lutemi, mos harroni të shtoni adresën tonë: mozilla@e.mozilla.org te libri juaj i adresave, që të siguroheni se merrni përherë çka ju dërgojmë.
...
# Form field label
newsletters-your-email-address = Adresa juaj email:
# Form field label
newsletters-country-or-region = Vend ose rajon:
# Form field label
...
newsletters-would-you-mind-telling-us = A ju prish punë të na thoni pse po largoheni?
