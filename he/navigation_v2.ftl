...
navigation-v2-get-the-details-on-the = קבלת הפרטים על העדכונים האחרונים של { -brand-name-firefox }.
navigation-v2-view-all-firefox-browsers = הצגת כל { -brand-name-firefox-browsers(case: "the") }
...
navigation-v2-learn-about-the-values = מידע על הערכים והעקרונות המנחים את המשימה שלנו.
