...
firefox-sticky-promo-meet-our-family-of = הכירו את משפחת המוצרים שלנו
firefox-sticky-promo-get-the-latest-firefox = קבלו את הדפדפן { -brand-name-firefox } העדכני ביותר.
# Products List
firefox-sticky-promo-browsers = דפדפנים
