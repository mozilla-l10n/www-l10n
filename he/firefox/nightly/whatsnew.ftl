...
nightly-whatsnew-if-you-want-to-v4 = אם ברצונך לדעת מה קורה סביב { -brand-name-nightly } והקהילה שלו, כדאי לקרוא את <a { $blog }>הבלוג</a> שלנו ולעקוב אחרינו ב־<a { $mastodon }>Mastodon</a> או ב־<a { $bluesky }>Bluesky</a>!
# Variables:
