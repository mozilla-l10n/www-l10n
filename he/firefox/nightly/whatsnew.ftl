...
nightly-whatsnew-if-you-want-to-v2 = אם ברצונך לדעת מה קורה סביב { -brand-name-nightly } והקהילה שלו, כדאי לקרוא את <a href="{ $blog }">הבלוג</a> שלנו ולעקוב אחרינו ב־<a href="{ $mastodon }">Mastodon</a> או ב־<a href="{ $twitter }">Twitter</a>!
# Obsolete string
nightly-whatsnew-if-you-want-to = אם ברצונך לדעת מה קורה סביב { -brand-name-nightly } והקהילה שלו, כדאי לקרוא את <a href="{ $blog }">הבלוג</a> שלנו ולעקוב אחרינו ב־<a href="{ $twitter }">{ -brand-name-twitter }</a>!
# Variables:
#   $attrs (string) - link href and additional attributes
nightly-whatsnew-want-to-know-which-v2 = רוצה לדעת אילו תכונות אפשר לנסות ב־{ -brand-name-nightly } שלא ניתן לראות עדיין בערוצי { -brand-name-firefox } אחרים? בדף ההעדפות <a { $attrs }> ניסויים של Nightly</a> ניתן לקבל מידע נוסף.
# Obsolete string
# Variables:
