...
features-private-browsing-download-firefox = הורדת { -brand-name-firefox }
...
features-private-browsing-catch-those-hidden = לתפוס את רכיבי המעקב החמקמקים
features-private-browsing-some-websites-and = חלק מהאתרים והפרסומות מצמידים רכיבי מעקב נסתרים שאוספים את פרטי הגלישה שלך גם לאחר יציאתך מהאתר. רק לגלישה הפרטית של { -brand-name-firefox } יש הגנת מעקב שחוסמת אותם אוטומטית.
features-private-browsing-shake-off-tracking = לנער מעליך את עול המעקב
features-private-browsing-not-only-do-trackers = לא רק שעוקבים אוספים עליך מידע, הם גם מכבידים על מהירות הגלישה שלך. רק הגלישה הפרטית ב־{ -brand-name-firefox } חוסמת פרסומות עם עוקבים נסתרים, כדי שתהיה לך אפשרות להיפטר מהעול ולגלוש בחופשיות.
