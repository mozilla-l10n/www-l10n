...
compare-opera-compare-opera-to-the-firefox = עריכת השוואה בין { -brand-name-opera } לבין ה{ -brand-name-firefox-browser(case: "a") } כדי לגלות איזה דפדפן הוא הטוב ביותר עבורך.
# Main title
