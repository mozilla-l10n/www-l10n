...
firefox-privacy-hub-we-cant-see-the-names-or = איננו יכולים לראות את השמות או את תוכן הקבצים הגדולים המשותפים דרך { -brand-name-firefox-send } מכיוון שהם מוצפנים מקצה לקצה — באפשרותך לבחור מי רואה את מה ששלחת, ואפילו להגדיר תאריך תפוגה וססמה.
