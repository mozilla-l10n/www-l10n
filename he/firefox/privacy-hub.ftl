...
# HTML page title
firefox-privacy-hub-firefox-privacy-promise = הבטחת הפרטיות של { -brand-name-firefox }
# Sub navigation title
firefox-privacy-privacy = פרטיות
# Sub navigation link
...
firefox-privacy-hub-we-cant-see-the-names-or = איננו יכולים לראות את השמות או התוכן של הקבצים הגדולים המשותפים דרך { -brand-name-firefox-send } מכיוון שהם מוצפנים מקצה לקצה — באפשרותך לבחור מי רואה את מה ששלחת, ואפילו להגדיר תאריך תפוגה וססמה.
firefox-privacy-hub-send-a-file = שליחת קובץ
