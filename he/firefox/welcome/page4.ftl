...
welcome-page4-enhanced-tracking-protection = הגנת מעקב מתקדמת <a href="{ $privacy }">חוסמת מ־2,000+ רכיבי מעקב</a> את האפשרות לרדוף אחריך ברחבי הרשת.
# "Leave no trace" is an expression for leaving nothing behind.
welcome-page4-leave-no-trace = לא להשאיר עקבות
welcome-page4-automatically-clear-your-history = ניקוי אוטומטי של ההיסטוריה והעוגיות שלך עם מצב גלישה פרטית.
