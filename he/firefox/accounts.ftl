...
# HTML page title
firefox-accounts-there-is-a-way-to = יש דרך להגן על הפרטיות שלך. להצטרף ל־{ -brand-name-firefox }.
# Old HTML page title
...
firefox-accounts-firefox-is-technology = { -brand-name-firefox } היא טכנולוגיה שנלחמת עבורך.
firefox-accounts-get-technology-that = קבלו טכנולוגיה שנלחמת עבורך.
