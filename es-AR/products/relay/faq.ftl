...
faq-question-acceptable-use-answer-measure-account-v2 = Pedir una { -brand-name-mozilla-account } con una dirección de correo electrónico verificada
# Obsolete string
...
phone-masking-faq-answer-how-i-save-card = Una vez que te actualicés al enmascaramiento de número de teléfono de { -brand-name-relay }, te enviaremos una tarjeta de contacto que contiene el número desde el cual recibirás las llamadas y los mensajes de texto reenviados, similar a cualquier tarjeta de contacto que almacena el número de teléfono de las personas que te contactan. En la mayoría de los dispositivos, podés seleccionar esa tarjeta de contacto y guardarla como cualquier otro contacto en tu teléfono.
