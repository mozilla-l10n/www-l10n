...
vpn-linux-servers-headline = Conectar a más de { $servers } en { $countries } países diferentes
# Variables:
#   $countries (number) - number of available countries
vpn-linux-servers-copy = { -brand-name-mozilla-vpn } te da la posibilidad de establecer la ubicación de tu computadora con { -brand-name-linux } a uno de más de { $countries } países, abriendo un nuevo contenido excitante de todo el mundo.
# Variables:
