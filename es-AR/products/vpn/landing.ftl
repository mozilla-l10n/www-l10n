...
vpn-landing-faq-download-desc = Navegá a la <a { $attrs }>página de descarga</a> para instalar { -brand-name-mozilla-vpn } en tu dispositivo y luego iniciá la sesión con tu { -brand-name-firefox-account }.
...
vpn-landing-invite-page-desc-v2 = Recibir una notificación cuando la { -brand-name-mozilla-vpn } esté disponible para mi región.
# Outdated string
