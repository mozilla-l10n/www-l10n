...
vpn-features-were-backed-by-mofo-v2 = Estamos respaldados por <a { $mofo }>{ -brand-name-mozilla-foundation }</a>, una organización sin fines de lucro que lucha por mantener la web abierta y saludable para todas las personas.
