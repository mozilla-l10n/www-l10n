...
newsletter-form-join-the-community = Unite a la comunidad
newsletter-form-sign-up-to-receive = Registrate para recibir actualizaciones mensuales de { -brand-name-firefox } y las tendencias de Internet que moldean tu vida en línea.
# Variables:
...
newsletter-form-keep-up-with = Mantenete al tanto<br> de todo lo que pasa con { -brand-name-firefox }.
newsletter-form-get-mozilla-updates = Conseguí actualizaciones de { -brand-name-mozilla }
...
newsletter-form-label = Formulario de suscripción al boletín de noticias
