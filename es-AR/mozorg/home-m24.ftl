...
m24-home-alt-solo-ai-logo = Logotipo de { -brand-name-solo-ai }
m24-home-solo-ai = { -brand-name-solo-ai }
m24-home-create-your-website = Creá tu sitio web y conectá tu dominio personalizado gratis
...
# Used as an accessible text alternative for an image
m24-home-alt-mozfest = Un gran grupo de personas amontonadas en un espacio interior para eventos, visto desde arriba.
m24-home-mozfest-join-us = Únase a nosotros en el { -brand-name-mozilla-festival }
m24-home-mozfest-the-future = El futuro de la tecnología no está establecido — es nuestro para moldearlo. Únase a nosotros en Barcelona del 7 al 9 de noviembre para olvidarse de los valores predeterminados, imaginar audazmente y construir lo que viene.
m24-home-mozfest-get-your = Consiga una insignia hoy
# Used as an accessible text alternative for an image
...
m24-home-mozilla-ventures-funds = { -brand-name-mozilla-ventures } financia la plataforma de red de Filament
m24-home-axios = Axios
m24-home-mozillas-new-message = { -brand-name-mozilla }'s new message: Somos el único navegador no respaldado por multimillonarios
m24-home-fast-company = Fast Company
m24-home-will-agi-be = ¿AGI será una realidad? ¿Estamos listos?
m24-home-conversation-charting-a = Conversación: Trazando un futuro para el acceso y la agencia
