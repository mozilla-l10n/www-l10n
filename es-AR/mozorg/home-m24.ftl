...
m24-home-love-the-internet = Amá internet de nuevo
...
m24-home-tabstack-desc = Automatizá tareas web de manera confiable con una API simple enfocada en desarrolladores.

## Donate

# Obsolete string (expires 04-12-2025)
m24-home-donate-to-the = Doná a la organización sin fines de lucro { -brand-name-mozilla }
m24-home-donate-to-v2 = Doná a la { -brand-name-mozilla-foundation }
# Obsolete string (expires 04-12-2025)
...
m24-home-mozilla-foundation-is-building-v2 = { -brand-name-mozilla-foundation } está construyendo un futuro donde la tecnología es impulsada por personas y tiene un diseño abierto. Es por eso que impulsamos la tecnología centrada en la comunidad a través de la promoción, la educación, la financiación y la innovación, para asegurarnos de que el futuro de la tecnología sea bueno para todos. Pero eso solo es posible si lo hacemos juntos.
...
m24-home-builders-helps-independent-v2 = { -brand-name-mozilla-builders } ayuda a los desarrolladores independientes a crear proyectos transformadores de IA de código abierto a través de colaboraciones, programación y comunidad hechas a medida.
m24-home-own-what-you = Apropiate de lo que construís
# "LAMP" (Linux, Apache, MySQL, PHP) is an open-souce software bundle (or "stack"). The acronym LAMP does not need to be translated.
m24-home-do-we-need-a = ¿Necesitamos una “LAMP Stack” para la era de la IA? Necesitamos tecnología que sea transparente, responsable y propiedad de las personas que la usan.
m24-home-watch-now = Mirá ahora
m24-home-choice-first-stack = Elección en primer lugar
m24-home-your-tools-your = Sus herramientas, su elección. Una pila unificada de código abierto que simplifica la creación y prueba de agentes y aplicaciones de IA modernos.
...
m24-home-join-today = Unite hoy
m24-home-a-double-bottom = Un doble objetivo para la tecnología
m24-home-mark-surman-discusses = Mark Surman analiza cómo podemos construir un ecosistema tecnológico con un doble resultado final, uno que valore tanto la misión como el dinero.
m24-home-agent-platform = Plataforma del agente
...
m24-home-a-good-moment = ‘Un buen momento para nosotros’: { -brand-name-firefox } se encamina a los navegadores de IA y lo que sigue para la web
...
m24-home-rewiring-mozilla = Reconfigurando { -brand-name-mozilla }: haciendo por la IA lo que hicimos por la web
m24-home-interview-with-mark = Entrevista con Mark Surman: Cómo { -brand-name-mozilla } se está adaptando a la era de la IA
m24-home-women-in-product = Conversación sobre mujeres en el producto: Agregando GenAI sin perder el argumento
...
# Variables
#   $year - year of report
m24-home-mozilla-is-reinventing-itself-v3 = Estamos en una encrucijada para el futuro de la tecnología, con las grandes empresas de IA consolidando su poder. El informe Estado de { -brand-name-mozilla } del { $year } es una invitación a elegir juntos un futuro diferente.
# Obsolete string (expires: 2026-03-27)
# Used as an accessible text alternative for an image
