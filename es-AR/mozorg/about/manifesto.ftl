...
manifesto-the-internet-is-a-global = Internet es un recurso público mundial que debe continuar siendo abierto y accesible.
...
manifesto-use-open-badges-to-share = Usá Open Badges y compartí tus habilidades e intereses
manifesto-explore-how-the-web-impacts = Conocé como la web impacta en la ciencia
manifesto-learn-about-open-source = Descubrí el código abierto en el periodismo
manifesto-read-about-open-internet = Lee acerca de las iniciativas y emprendimientos para una política de una internet abierta
manifesto-explore-how-to-help-keep = Conocé cómo podés ayudar a mantener la web abierta
manifesto-see-how-the-web-can-connect = Mirá cómo la web puede conectar el mundo con la asistencia sanitaria
manifesto-explore-how-the-web-works = Conocé cómo funciona la web
manifesto-see-how-mozilla-works = Mirá cómo trabaja { -brand-name-mozilla } para que tu privacidad sea lo principal
manifesto-read-about-developments = Informate sobre los desarrollos en privacidad y seguridad de datos
manifesto-learn-more-about-how-to = Aprendé a proteger tu vida digital
manifesto-use-these-free-tools-to = Usá estas herramientas libres para enseñar la web
manifesto-learn-about-creating-and = Aprendé sobre crear y curar contenido para la web
manifesto-add-new-voices-to-open = Sumá nuevas voces a la tecnología de código abierto
manifesto-set-your-do-not-track = Configurá tu preferencia para que no te rastreen
manifesto-understand-the-web-ecosystem = Conocé el ecosistema de la web
manifesto-explore-how-open-practices = Conocé cómo las prácticas abiertas mantienen la web accesible
manifesto-learn-how-to-remix-content = Aprendé a remezclar contenidos y crear algo nuevo
manifesto-learn-how-to-maximize = Aprendé cómo maximizar el potencial interactivo de la web
manifesto-participate-in-our-governance = Participá en nuestro foro de gobernanza
manifesto-join-us-as-a-volunteer = Unite como voluntario/a
manifesto-learn-how-to-collaborate = Aprendé a colaborar en línea
manifesto-visualize-who-you-interact = Conocé con quiénes interactuás en la web con { -brand-name-lightbeam }
manifesto-learn-about-creating-web = Aprendé cómo crear recursos web junto a otros
manifesto-host-or-join-a-maker-party = Organizá o participá a una <em>{ -brand-name-maker-party }</em>
manifesto-learn-how-to-build-online = Aprendé a desarrollar habiliadades de colaboración en línea
