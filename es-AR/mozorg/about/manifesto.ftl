...
manifesto-details-the-mozilla-project-global-v2 = The { -brand-name-mozilla } Project es una comunidad global de personas que creen que la apertura, la innovación y la oportunidad son clave para la salud continua de Internet. Trabajamos juntos desde 1998 para asegurar que Internet se desarrolle de una manera que beneficie a todos. Somos mejor conocidos por crear el navegador web { -brand-name-mozilla } { -brand-name-firefox }.
...
manifesto-details-the-mozilla-project-community-v2 = El Proyecto { -brand-name-mozilla } utiliza un enfoque basado en la comunidad para crear software de código abierto de categoría mundial y para desarrollar nuevos tipos de actividades colaborativas. Creamos comunidades de personas involucradas en mejorar la experiencia de Internet para todos nosotros.
# Obsolete string (expires 2026-09-20)
...
manifesto-details-articulate-a-vision-v2 = definir una visión de Internet que los participantes de { -brand-name-mozilla } quieren que difunda { -brand-name-mozilla-foundation };
...
manifesto-details-the-mozilla-foundation-pleges-v2 = { -brand-name-mozilla-foundation } se compromete a apoyar el Manifiesto de { -brand-name-mozilla } en sus actividades. Específicamente:
...
manifesto-we-host-a-yearly = <a { $festival_link }>Organizamos una reunión mundial anual</a> para las personas que están haciendo cualquier cosa para avanzar en el Manifiesto.
# Variables:
#   $firefox_link (url) - link to https://www.firefox.com/
#   $thunderbird_link (url) - link to https://www.thunderbird.net/
manifesto-we-make-firefox-and-thunderbird = Y, por supuesto, hacemos <a { $firefox_link }>{ -brand-name-firefox }</a> y <a { $thunderbird_link }>{ -brand-name-thunderbird }</a>. Todo esto tiene como objetivo ayudar a las personas a hacer de Internet un lugar saludable.
...
manifesto-details-some-foundation-v2 = Algunas actividades de la Fundación, en este momento, la creación, distribución y promoción de productos que se se realiza principalmente a través de la empresa subsidiaria { -brand-name-mozilla-corporation }, la cual es íntegramente propiedad de { -brand-name-mozilla-foundation }.
...
manifesto-i-support-the-vision-of-v2 = Apoyo la visión de una internet mejor y más saludable de parte de { -brand-name-mozilla }, ¿te vas a unir?
