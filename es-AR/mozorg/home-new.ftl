...
home-is-mozilla-a-corporation = ¿ { -brand-name-mozilla } es una corporación o una organización sin fines de lucro? De hecho, ambos.
...
home-join-the-fight = Únete a la lucha por una Internet saludable
home-your-voice-your-code = Tu voz Tu código. Tus ideas Hay literalmente miles de formas en las que puedes contribuir con { -brand-name-mozilla }.
home-volunteer-with-mozilla = Colabora con { -brand-name-mozilla }
home-that-one-time = Esa única vez que regalamos nuestro código fuente…
home-the-mozilla-project = El proyecto { -brand-name-mozilla } fue fundado en San Francisco en 1998, cuando el navegador { -brand-name-netscape } tomó la decisión radical de regalar el código de su programa al público para que construyera y mejorara. En ese momento, una empresa prácticamente tenía el monopolio de la experiencia de Internet.
