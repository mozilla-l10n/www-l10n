...
compare-safari-switching-to-firefox-is-easy = Cambiarse a { -brand-name-firefox } es fácil y rápido: importa tus marcadores de Safari, tus contraseñas, historial y preferencias con un solo clic y prepárate para usar { -brand-name-firefox } de inmediato. Te mostramos <a { $howto }> cómo importar tus datos de Safari </a>.
