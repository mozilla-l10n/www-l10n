...
features-fingerprinting-every-fingerprint = Cada huella digital es única.
features-fingerprinting-download-firefox = Descargar { -brand-name-firefox }
...
features-fingerprinting-the-latest-firefox = La nueva versión del navegador { -brand-name-firefox } te protege contra la toma de huellas digitales bloqueando solicitudes de terceros de empresas conocidas por participar en el rastreo de huellas digitales. Hemos trabajado duro para habilitar esta protección de privacidad sin romper los sitios web que disfrutas visitando. (Puedes leer más aquí, si quieres los <a { $url_detail }>detalles técnicos</a>).
# $url_protections (string) - https://www.mozilla.org/firefox/privacy/products/
features-fingerprinting-and-its-not = Y no es un ajuste escondido que tengas que buscar. En la nueva versión de { -brand-name-firefox }, el bloqueo de huellas digitales es la configuración estándar, predeterminada. Visita tu panel de protección de privacidad { $url_protections }>para ver cómo te están rastreando sin que lo veas y cómo { -brand-name-firefox } lo previene.
...
features-fingerprinting-protect = Protegé tu privacidad
