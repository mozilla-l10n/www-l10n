...
welcome-page5-with-256-bit-encryption-your = Con el cifrado de 256-bit, tus contraseñas siempre van a tus dispositivos de forma segura.
welcome-page5-no-more-making-up-new-passwords = Nunca más inventar contraseñas
welcome-page5-lockwise-will-recommend-new = { -brand-name-lockwise } recomendará contraseñas nuevas y seguras cada vez que configures un inicio de sesión nuevo.
welcome-page5-help-during-a-breach = Ayuda durante una violación
welcome-page5-lockwise-will-let-you-know = { -brand-name-lockwise } te va a informar si tus inicios de sesión guardados fueron parte de una violación de datos corporativos, para que puedas cambiarlos lo antes posible.
