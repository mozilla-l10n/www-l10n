...
nightly-whatsnew-if-you-want-to-v2 = Si querés saber qué está pasando alrededor de { -brand-name-nightly } y su comunidad, leyendo nuestro <a href="{ $blog }"> blog </a> y síguenos en <a href = "{ $mastodon }"> Mastodon </a> o <a href="{ $twitter }"> Twitter </a> son buenos puntos de partida.
# Obsolete
