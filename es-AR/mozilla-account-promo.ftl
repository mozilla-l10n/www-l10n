...
moz-account-already-have = ¿Ya tenés una cuenta? <a { $sign_in_url }> Inicia sesión </a> u <a { $learn_more_url }> descubre más </a> sobre { -brand-name-mozilla }
moz-account-get-a-mozilla-account = Obtener una { -brand-name-mozilla-account }
