...
footer-refresh-get-the-best = Conseguí los mejores consejos, trucos y actualizaciones de { -brand-name-firefox }. Prometemos mantener tu correo electrónico privado y seguro, solo lo mejor de { -brand-name-firefox } será enviado directamente a tu bandeja de entrada.
...
footer-refresh-x = X
footer-refresh-x-formerly-twitter = X (anteriormente Twitter)
...
footer-refresh-visit-mozilla-corporations = Visitá la empresa matriz sin fines de lucro de <a { $moco_link }>{ -brand-name-mozilla-corporation }</a>, la <a { $mofo_link }>{ -brand-name-mozilla-foundation }</a>.
...
footer-refresh-community-participation-guidelines = Pautas de participación comunitaria
