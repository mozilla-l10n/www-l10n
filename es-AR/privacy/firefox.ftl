...
privacy-firefox-we-use-data-v2 = A diferencia de muchos otros navegadores donde los datos confidenciales del usuario se recopilan y almacenan de forma rutinaria, { -brand-name-firefox } se basa en el <a { $attrs }>principio</a> de que ni siquiera { -brand-name-mozilla } debería saber qué sitios web visitás o qué hacés ahí.
