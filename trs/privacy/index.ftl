...
privacy-index-contact-mozilla = Riña ga'ue ga'mint ngà { -brand-name-mozilla }
privacy-index-if-you-want-to-make-a-correction = Sisi ruhuât nadunat nuguan' a'min rayi'ît, asi hua sa gachìnj na'anjt guenda si sun ñûnj guendâ sa tna'uej e, gi'iaj 'ngo sununj un gachrunt riña:
# Variables:
#   $dsar (url) - link to https://app.onetrust.com/app/#/webform/4ba08202-2ede-4934-a89e-f0b0870f95f0
privacy-index-see-here-for-data-subject = <a href="{ $dsar }">Ni'iāj hiūj nan guendâ nej sa achín nì'iaj ni'āj nej datô sujeto.</a>
privacy-index-data-privacy-principles = Nuguan' nikaj ñu'unj rayi'î nej sa hua huì 'iaj dâto
# Variables:
#   $principles (url) - link to https://www.mozilla.org/privacy/principles/
#   $faq (url) - link to https://www.mozilla.org/privacy/faq/
privacy-index-mozillas-data-privacy-principles = Si'iaj { -brand-name-mozilla } <a href="{ $principles }">Nuguan' narán rayi'î si nuguàn't</a> 'iaj sun ñûnj da' gā hue'ê nī gā huì riña internet garasunt. Gini'in doj rayi'î nej nuguan' 'iaj hua { -brand-name-firefox } ngà a'ngô nej si rasunj riña <a href="{ $faq }">FAQ</a>.
privacy-index-transparency-report = Nuguan' a'min rayi'î sun huā nikā
# Variables:
