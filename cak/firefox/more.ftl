...
firefox-is-independent = Alaj ruk'aslem ri { -brand-name-firefox } chuqa' xnuk' ruma { -brand-name-mozilla } jun moloj akuchi' majun ch'akoj rojqan, ri yeruch'ojij taq ruch'ojib'al pa k'amab'ey chuqa' nub'än chi tapon pa kiq'a' konojel ri k'amaya'l chijun ri ruch'akul.
...
securely-access-the =
    Ütz yatok pa ewan taq tzij e'ayakon pa 
    { -brand-name-firefox } xab'akuchi' — ke ri' chuqa' toq man at k'o ta pan okik'amaya'l.
...
firefox-more-you-can-reclaim = ¡Yatikïr naköl ri awichinanem chuqa' ri ruchajixik ri awetamab'al pa k'amaya'l! Qitzij chi man k'ayew ta. Konojel yetikïr nikib'än.
...
seven-of-the = Kijunamaxik wuqu' utziläj taq okik'amaya'l
we-compare-firefox = Niqajunamaj ri { -brand-name-firefox } rik'in ri { -brand-name-chrome }, { -brand-name-edge }, { -brand-name-safari }, { -brand-name-opera }, { -brand-name-brave } chuqa' ri { -brand-name-ie } richin yatqato' nana'ojij.
comparing-firefox-chrome = Rujunamaxik { -brand-name-firefox-browser } rik'in { -brand-name-google } { -brand-name-chrome }
big-isnt-always = K'o re man ütz ri nïm. Tacha' ri osq'opinïk chuwa.
