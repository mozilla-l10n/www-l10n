...
firefox-sync-access-and-sync = Katok chuqa' ke'axima' ri taq awetab'al, jaqäl ewan taq atzij chuqa' ch'aqa' chik — xab'akuchi' nawokisaj { -brand-name-firefox }.
firefox-sync-sync-your-firefox = Taxima' ri { -brand-name-firefox } pa xab'achike okisab'äl
firefox-sync-privacy-made-easy = Ko'öl ichinanem
firefox-sync-all-you-need = Ri nik'atzin chawe richin ri { -brand-name-firefox-sync } ja ri jun { -brand-name-firefox-account }.
firefox-sync-encrypt-your-data = Tewäx rusik'ixik atzij
