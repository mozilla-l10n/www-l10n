...
welcome-page3-sign-in = Titikirisäx Molojri'ïl
...
welcome-page3-never-forget-reset-or-travel = Majunb'ey chik ke'amestaj ri ewan taq atzij, chuqa' ni xa ta tatikirisaj chik o yab'e toq man e'ak'wan ta awik'in.
welcome-page3-facebook-container = { -brand-name-facebook-container }
welcome-page3-get-a-container-to-keep-facebook = Tak'ulu' jun k'wayöl richin najech'uj ri { -brand-name-facebook } chupam ri asamaj.
welcome-page3-pocket = { -brand-name-pocket }
welcome-page3-trade-clickbait-and-fake-news = Tajala' clickbait chuqa' itzel taq rutzijol rik'in utziläj rupam.
welcome-page3-firefox-send = { -brand-name-firefox-send }
welcome-page3-send-huge-files-to-anyone = Ke'ataqa' nïm taq yakb'äl achoj b'achike, rik'in yujel taq ximoj.
welcome-page3-why-am-i-seeing-this = ¿Aruma nintz'ët re'?
