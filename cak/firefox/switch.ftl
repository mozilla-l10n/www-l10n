...
switch-firefox-makes-switching-fast-email = { -brand-name-firefox } nub'än chi nijal ri { -brand-name-chrome } anin nib'anatäj. Yalan niqa chi nuwäch chuqa' ütz we natojtob'ej.
switch-still-not-convinced = ¿La k'a man akuqub'an ta ak'u'x chi najäl pa { -brand-name-firefox } anin nib'an?
