...
firefox-browsers-mobile = Oyonib'äl
firefox-browsers-take-the-same-level-of-privacy = Tak'waj awik'in ri junam rupalem ichinanem — achi'el ri ewan taq atzij, runatab'al kanoxïk, jaqäl taq ruwi' chuqa' ch'aqa' chik — xab'akuchi' yab'e.
firefox-browsers-download-for-mobile = Tiqasäx richin Oyonib'äl
firefox-browsers-send-me-a-link = Titaq chwe jun ximonel
...
firefox-browsers-go-beyond-two-dimensions-and = Kanab'eyij chuwäch ri ka'i' taq k'ojlib'äl chuqa' tak'owisaj ak'u'x rik'in ri utziläj rupam e k'o pa ajk'amaya'l.
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words, please omit the strong tags if they need to be around multiple words in your language
