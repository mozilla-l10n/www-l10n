...
firefox-channel-experience-cutting-edge-android-updated = Ke'atojtob'ej ruk'isib'äl taq rusamaj jun okik'amaya'l richin Androi, ri nelesäx yan pe: { -brand-name-firefox-beta } chuqa' { -brand-name-firefox-nightly }. ¡Tiyak qa wakami!
...
firefox-channel-download-and-test-the-latest-android = Tiqasäx chuqa' titojtob'ëx ri ruk'isib'äl ruwäch { -brand-name-firefox } richin { -brand-name-android } rik'in { -brand-name-aurora }, { -brand-name-beta } chuqa' molon taq ruwäch.
...
firefox-channel-download-and-test-the-latest-desktop = Tiqasäx chuqa' titojtob'ëx ri ruk'isib'äl ruwäch { -brand-name-firefox } richin kematz'ib' rik'in Ajb'anonel Nuk'uj, { -brand-name-beta } chuqa' molon taq ruwäch.
