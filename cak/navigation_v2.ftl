...
navigation-v2-get-a-firefox-account = Tik'ul jun { -brand-name-firefox-account }
...
navigation-v2-firefox-for-ios = { -brand-name-firefox } richin { -brand-name-ios }
navigation-v2-get-the-mobile-browser = Tak'ulu' ri oyonib'äl okik'amaya'l richin { -brand-name-iphone } o { -brand-name-ipad }.
...
navigation-v2-more-mozilla-innovation = Ch'aqa' rutz'ukuj { -brand-name-mozilla }
