...
# Field of a form
opt-out-confirmation-your-email = Rochochib'al ataqoya'l:
# Only localize "yourname". Do not touch @example.com.
opt-out-confirmation-yournameexamplecom = yourname@example.com
# This is a button
opt-out-confirmation-manage-preferences = Kenuk'samajïx taq Ajowab'äl
# Link to https://support.mozilla.org/
opt-out-confirmation-get-help = Tk'ul to'ïk
