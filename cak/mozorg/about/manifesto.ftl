...
manifesto-visualize-who-you-interact = Tatzu' rik'in Lightbeam achike nisamäj awik'in pa ajk'amaya'l
manifesto-learn-about-creating-web = Tawetamaj ye'anük' ajk'amaya'l taq tob'äl kik'in ch'aqa' chik
manifesto-host-or-join-a-maker-party = Tanuk'u' o katok pa jun Maker Party
...
manifesto-details-articulate-a-vision = tiya' retal jun rutzub'al K'amaya'l, akuchi' ri yeto'on pa { -brand-name-mozilla } niqajo' chi troqaj ri { -brand-name-mozilla } Moloj;
...
manifesto-details-mozilla-foundation = Ri rusujun ri Mozilla moloj
manifesto-details-the-mozilla-foundation-pleges = Ri { -brand-name-mozilla } moloj nusüj ruto'ik re Rutzijoxik { -brand-name-mozilla } re' rik'in ri taq rusamaj. Jikïl niqasüj:
...
manifesto-details-some-foundation = Jujun taq rusamaj ri Moloj—wakami, ri kitz'ukik, kijachik chuqa' kitaluxik taq tokomal—jumul nib'anatäj ruma ri talüy ajk'aymoloj Mozilla Nimamoloj, ri richin Mozilla Moloj.
manifesto-details-invitation = Peyonïk
manifesto-details-the-mozilla-foundation-invites = Ri { -brand-name-mozilla } Moloj yerupeyoj konojel ri winaqi' chi kekito' ri ruk'u'x taq rutzij Rutzijoxik { -brand-name-mozilla } chi ke'ok qik'in richin nilitäj k'ak'a' taq rub'anikil chi niwachij re rutzub'al K'amaya'l re'.
