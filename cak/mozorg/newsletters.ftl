...
newsletters-newsletter-subscriptions = Rutz'ib'axik B'i'aj pa Ko'öl taq Wuj
# Page titlefor https://www-dev.allizom.org/newsletter/
newsletters-mozilla-newsletter = Ko'öl Ruwuj { -brand-name-mozilla }
# Headline for https://www-dev.allizom.org/newsletter/
newsletters-read-all-about-it-in-our-newsletter = Tasik'in ronojel ri na'oj pa ruwi' Firefox pa <span>ko'öl qawuj</span>
# Page title the subscription confirmation page
newsletters-newsletter-confirm = Tijikib'äx ko'öl wuj
newsletters-thanks-for-subscribing = ¡Niqak'awomaj chi Xatz'ib'aj Ab'i'!
newsletters-your-newsletter-subscription = Xjikib'äx ri rutz'ib'axik ab'i' pa ri ko'öl wuj.
newsletters-please-be-sure-to-add-our = Tab'ana' utzil, tatz'aqatisaj ri rub'ey qataqoj mozilla@e.mozilla.org pa ri rutz'ib'awuj awochochib'al richin najikib'a' awi' chi junelïk  yojapon pa ri ayaktaqoj.
