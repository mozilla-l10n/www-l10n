...
home-mission-driven = Gedreven door een missie. Mogelijk gemaakt door mensen.
...
home-cta-get-relay = { -brand-name-relay } verkrijgen
...
home-volunteer-with-mozilla = Word vrijwilliger bij { -brand-name-mozilla }
home-that-one-time = Die ene keer dat we onze broncode weggaven…
home-the-mozilla-project = Het { -brand-name-mozilla }-project werd opgericht in San Francisco in 1998, toen de browser { -brand-name-netscape } de radicale beslissing nam om zijn programmacode aan het publiek weg te geven om erop voort te bouwen en te verbeteren. In die tijd had één bedrijf het virtuele monopolie op hoe mensen het internet beleefden.
