...
# HTML page title
privacy-faq-v2-title = { -brand-name-mozilla }’s FAQ over gegevensprivacy
# HTML page description
privacy-faq-v2-desc = Bij { -brand-name-mozilla } respecteren en beschermen we uw persoonlijke gegevens.
privacy-faq-v2-heading = We Staan Voor Mensen Boven Winst.
privacy-faq-v2-intro = Weten wat men van gebruikte software of diensten kan verwachten, kan tegenwoordig lastig zijn. De technologie die onze levens mogelijk maakt is complex, en mensen hebben geen tijd om zich in de details te verdiepen. Dat geldt ook nog steeds voor { -brand-name-firefox }, waarbij we denken dat mensen veel verschillende ideeën hebben over wat er in hun browser onder de motorkap gebeurt.
privacy-faq-v2-at-mozilla = Bij { -brand-name-mozilla } respecteren en beschermen we uw persoonlijke gegevens:
# Variables:
#   $attrs (url) - link to https://www.mozilla.org/privacy/principles/
privacy-faq-v2-we-follow = We volgen een aantal <a { $attrs }>Principes over gegevensprivacy</a> die onze benadering van privacy in de mobiele en desktopversies van { -brand-name-firefox } vormgeven.
privacy-faq-v2-we-strive-collect-data = We streven ernaar alleen gegevens te verzamelen die nodig zijn om de beste producten te maken.
privacy-faq-v2-we-work-to = We werken eraan om mensen controle over hun gegevens en onlinebelevingen te geven.
privacy-faq-v2-we-adhere = We houden ons aan het principe van ‘geen verrassingen’, wat inhoudt dat we er hard aan werken dat het beeld dat gebruikers hebben van { -brand-name-firefox } overeenkomt met de werkelijkheid.
privacy-faq-v2-following-questions = De volgende vragen en antwoorden zouden moeten helpen te begrijpen wat u van { -brand-name-mozilla } en { -brand-name-firefox } kunt verwachten:
