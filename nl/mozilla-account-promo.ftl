...
moz-account-already-have = Hebt u al een account? <a { $sign_in_url }>Aanmelden</a> of <a { $learn_more_url }>meer info</a> over { -brand-name-mozilla }
moz-account-get-a-mozilla-account = Maak een { -brand-name-mozilla-account } aan
