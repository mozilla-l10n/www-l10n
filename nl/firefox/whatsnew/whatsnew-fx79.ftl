...
# Modal title
whatsnew79-get-firefox-on-your-phone = Download { -brand-name-firefox } op uw telefoon
whatsnew79-scan-the-qr-code = Scan de QR-code om te beginnen
# Accessible text replacement for a QR code image
whatsnew79-qr-code-to-scan = Te scannen QR-code voor { -brand-name-firefox }
