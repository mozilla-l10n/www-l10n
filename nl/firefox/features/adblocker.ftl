...
features-adblocker-how-to-block-annoying = Zo blokkeert u vervelende advertenties met een adblocker
...
features-adblocker-send-a-do-not-track-signal = Verstuur een ‘Niet volgen’-signaal
# Variables:
