...
# Obsolete string
firefox-accounts-sign-in-to = Meld u aan bij uw { -brand-name-firefox-account } om:
# Obsolete string
...
firefox-accounts-send-a-tab = <a href="{ $send }">Een tabblad te verzenden</a> naar een ander apparaat
# Variables:
...
firefox-accounts-save-articles = Artikelen van het internet op te slaan
firefox-accounts-read-in-a = Lees in een rustige, besloten ruimte
