...
privacy-passwords-when-youre-logged-v2 = Wanneer u bij { -brand-name-firefox } bent aangemeld met uw { -brand-name-mozilla-account }, kunt u op al uw apparaten synchroniseren en toegang krijgen tot uw wachtwoorden vanuit een mobiele { -brand-name-firefox }-browser. Lees hier meer over <a { $url_sumo-manager }>hoe u de ingebouwde wachtwoordbeheerder volledig kunt benutten</a>.
