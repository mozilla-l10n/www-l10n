...
welcome-page3-never-forget-reset-or-travel = Vergeet, herinitialiseer of reis nooit meer zonder uw wachtwoorden.
welcome-page3-facebook-container = { -brand-name-facebook-container }
welcome-page3-get-a-container-to-keep-facebook = Verkrijg een container om { -brand-name-facebook } buiten uw zaken te houden.
welcome-page3-pocket = { -brand-name-pocket }
welcome-page3-trade-clickbait-and-fake-news = Verruil clickbait en nepnieuws voor hoogwaardige inhoud.
welcome-page3-firefox-send = { -brand-name-firefox-send }
welcome-page3-send-huge-files-to-anyone = Verzend enorme bestanden naar iedereen die u wilt, met zelfvernietigende koppelingen.
welcome-page3-why-am-i-seeing-this = Waarom zie ik dit?
