...
vpn-shared-one-subscription-heading = Eén abonnement voor al uw apparaten
vpn-shared-choose-a-plan-sub-heading = Kies een abonnement dat bij u past
...
vpn-subnav-subscribe = Abonneren op { -brand-name-mozilla-vpn }
