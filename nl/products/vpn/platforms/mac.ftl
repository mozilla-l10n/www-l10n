...
vpn-mac-devices-headline = Bescherm { $devices } apparaten met één abonnement
vpn-mac-speed-headline = U hoeft geen snelheid op te offeren
vpn-mac-log-headline = Wat u online doet, is uw zaak
