...
firefox-desktop-download-firefox-is-available = { -brand-name-firefox } พร้อมให้ใช้บนอุปกรณ์ทุกเครื่องของคุณ คุณสามารถนำแท็บ ประวัติ และที่คั่นหน้าไปกับคุณได้ โดยคุณจำเป็นต้องมี<a { $attrs }>บัญชี { -brand-name-firefox }</a>
# Variables:
