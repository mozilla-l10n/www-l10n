...
features-memory-chrome-uses-up-to-177x-more = <a href="{ $url }">{ -brand-name-chrome } ใช้หน่วยความจำมากกว่า { -brand-name-firefox } สูงสุดถึง 1.77 เท่า</a> ถ้าคอมพิวเตอร์ของคุณมีหน่วยความจำน้อยอยู่แล้ว นี่เป็นสาเหตุสำคัญที่ทำให้ช้าลงได้ ใช้ { -brand-name-firefox } รุ่นล่าสุดที่มีหลายการประมวลผลสามารถให้ผลลัพธ์โดยมีหน่วยความจำเหลือมากขึ้นเพื่อรันโปรแกรมที่คุณชอบ
features-memory-browse-faster-privately = ท่องเว็บอย่างเร็วและเป็นส่วนตัว
# Variables:
#   $url (url) - link to https://www.mozilla.org/firefox/features/private-browsing/
# "Decluttering" means reducing clutter
features-memory-explore-the-web-faster-with = สำรวจเว็บได้เร็วขึ้นด้วย <a href="{ $url }">การท่องเว็บแบบส่วนตัวของ { -brand-name-firefox }</a> เฉพาะโหมดการท่องเว็บแบบส่วนตัวของ { -brand-name-firefox } เท่านั้นที่มีการป้องกันการตามรอย ที่ปิดกั้นโฆษณาที่มีตัวติดตามจากการโหลดบนหน้า ลดความระเกะระกะของไซต์หมายความว่าหน้าเว็บของคุณสามารถโหลดได้ไวขึ้น
