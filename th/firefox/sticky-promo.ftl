...
firefox-sticky-promo-meet-our-family-of = พบกับกลุ่มผลิตภัณฑ์ของเรา
firefox-sticky-promo-get-the-latest-firefox = รับเบราว์เซอร์ { -brand-name-firefox } ล่าสุด
# Products List
firefox-sticky-promo-browsers = เบราว์เซอร์
