...
firefox-accounts-sign-in = সাইন ইন
...
firefox-accounts-youll-always-get-the = আপনি সর্বদা আমাদের কাছ থেকে সত্যিটাই পাবেন। আমাদের <a href="{ $promise }">ব্যক্তিগত ডাটার সুরক্ষার প্রতিশ্রুতি</a> রক্ষায় আমরা সব কিছু করি:
# Line breaks for visual formatting.
firefox-accounts-take-less-keep-it = কম লাগে।<br> নিরাপদে রাখুন।<br> কোন গোপনীয়তা নেই।
firefox-accounts-get-the-knowledge = নিজেকে সুরক্ষিত রাখার শিক্ষা লাভ করুন।
firefox-accounts-and-be-part-of-protecting = এবং ভবিষ্যতের প্রজন্মের জন্য ইন্টারনেট রক্ষায় অংশ নেন।
firefox-accounts-help-us-build-a-better = আমাদের সবার জন্য আরও ভাল { -brand-name-firefox } তৈরি করতে সহায়তা করুন।
