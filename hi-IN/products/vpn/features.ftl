...
vpn-features-page-title = फ़ीचर्स - { -brand-name-mozilla-vpn }
...
vpn-features-set-different-locations = { -brand-name-firefox } में हर टैब के लिए अलग-अलग लोकेशन सेट करें

# Variables
#   $containers (url) - link to https://support.mozilla.org/kb/use-multi-account-containers-mozilla-vpn
vpn-features-combine-mozilla-vpn-with-containers = { -brand-name-mozilla-vpn } को मल्टी-अकाउंट कंटेनर्स { -brand-name-firefox } एक्सटेंशन के साथ कंबाइन करें और { -brand-name-firefox } टैब के अनुसार अलग-अलग VPN लोकेशन सेट करें। <a { $containers }>इसका तरीका जानें</a>।
