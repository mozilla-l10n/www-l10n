...
vpn-features-were-backed-by-mofo-v2 = हम एक गैर-लाभकारी संस्था <a { $mofo }>{ -brand-name-mozilla-foundation }</a> द्वारा समर्थित हैं, जो इंटरनेट को सभी के लिए एक खुली व स्वस्थ जगह बनाने की मुहिम में लगी हुई है।
