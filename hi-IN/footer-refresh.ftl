...
footer-refresh-learn-more-about-mozilla-ads = <span>{ footer-refresh-mozilla-ads } के बारे में</span> और अधिक जानें
...
footer-refresh-store = मर्चेंडाइज स्टोर
...
footer-refresh-donate-not-for-profit = कृपया गैर-लाभकारी <a { $mofo_link }>{ -brand-name-mozilla-foundation }</a> को डोनेशन दें।
