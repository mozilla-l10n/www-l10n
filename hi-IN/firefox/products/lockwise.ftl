...
lockwise-only-in-the-firefox-browser = केवल { -brand-name-firefox-browser } में
lockwise-your-privacy-comes-first = आपकी गोपनीयता पहले आती है।
lockwise-support = सहयोग
lockwise-your-privacy = आपकी गोपनीयता
