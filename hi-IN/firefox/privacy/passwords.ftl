...
# HTML page title
privacy-passwords-security-guide-to = अधिक सुरक्षित लॉग इन और पासवर्ड के लिए एक मार्गदर्शिका

# HTML page description
privacy-passwords-more-and-more-desc = हमारे जीवन में संवेदनशील, मूल्यवान चीज़ें अधिक से अधिक पासवर्ड संरक्षित ऑनलाइन एकाउंट के माध्यम से संरक्षित हैं। हमें अपने लॉगिन की सुरक्षा कैसे करनी चाहिए?

# page content
privacy-passwords-a-security-guide = अधिक सुरक्षित लॉग इन और पासवर्ड के लिए एक मार्गदर्शिका
privacy-passwords-protecting-your-accounts = अपने एकाउंट को सुरक्षित रखना जटिल नहीं है — और { -brand-name-firefox } मदद कर सकता है।
privacy-passwords-more-and-more = हमारे जीवन में संवेदनशील, मूल्यवान चीज़ें अधिक से अधिक पासवर्ड संरक्षित ऑनलाइन एकाउंट के माध्यम से संरक्षित हैं — चाहे वो प्रेम पत्र हो या मेडिकल रिकॉर्ड, बैंक एकाउंट या और कुछ। वेबसाइट उन मूल्यवान चीज़ों की सुरक्षा के लिए लॉगिन प्रक्रियाओं का उपयोग करती हैं। आम तौर पर, जब तक कोई आपके एकाउंट में लॉग इन नहीं कर सकता है, वे आपके ईमेल को पढ़ नहीं सकते हैं या आपके बैंक एकाउंट से पैसे स्थानांतरित नहीं कर सकते हैं। जैसे-जैसे हम ऑनलाइन अपना जीवन जीते हैं, हमें अपने लॉगिन की सुरक्षा कैसे करनी चाहिए?

# tl;dr is an abbreviation for "Too long; didn't read". This is a playful way to say "summary" or "overview"
privacy-passwords-tldr = सारांश
privacy-passwords-use-random-passwords = यादृच्छिक पासवर्ड का उपयोग करें, और हर साइट के लिए एक अलग पासवर्ड का उपयोग करें
privacy-passwords-pay-attention-to = ब्राउज़र की सुरक्षा संकेतों पर ध्यान दें, और सतर्क रहें
privacy-passwords-make-your-answers = अपने पासवर्ड के समान ही सुरक्षा प्रश्नों के उत्तर मज़बूत रखें
privacy-passwords-use-a-password = पासवर्ड बनाना और याद रखना आसान बनाने के लिए पासवर्ड मैनेजर का उपयोग करें
privacy-passwords-use-twofactor-authentication = जहाँ भी आप कर सकते हैं "दो-कारक प्रमाणीकरण" का उपयोग करें
privacy-passwords-its-hard-out = एक पासवर्ड होना आसान बात नहीं है
privacy-passwords-most-logins-today = अधिकांश लॉगिन आज एक पासवर्ड द्वारा सुरक्षित हैं। यदि कोई हमलावर आपका पासवर्ड पा लेते हैं, तो वे आपके एकाउंट तक पहुँच सकते हैं और उस एकाउंट के साथ कुछ भी कर सकते हैं। इसलिए जब आप पूछते हैं कि आपका एकाउंट कितना सुरक्षित है, तो आपको वास्तव में यह सोचना चाहिए कि आपका पासवर्ड कितना सुरक्षित है। और इसका मतलब है कि आपको उन सभी तरीकों के बारे में सोचना होगा जो एक हमलावर आपके एकाउंट के पासवर्ड तक पहुँचने के लिए उपयोग कर सकता है :
privacy-passwords-seeing-you-use = आपको किसी अनएन्क्रिप्टेड वेबसाइट का उपयोग करता देखकर
privacy-passwords-guessing-it = अनुमान लगाकर
privacy-passwords-stealing-a-file = उस फ़ाइल को चुराकर जिसमें आपका पासवर्ड है
privacy-passwords-using-password-recovery = रीसेट करने के लिए पासवर्ड रिकवरी का उपयोग करना
privacy-passwords-tricking-you-into = आपको चकमा देकर पासवर्ड निकाल लेना
privacy-passwords-to-keep-your = अपने लॉगिन को सुरक्षित रखने के लिए, आपको इनमें से अधिक से अधिक को रोकने की आवश्यकता है। हर जोखिम को कम करने का तरीका अलग है।
privacy-passwords-look-for-the = अपने ब्राउज़र में लॉक ढूँढे
privacy-passwords-its-easy-to = जब आप एक अनएन्क्रिप्टेड वेबसाइट पर लॉग इन करते हैं तो हमलावरों को आपका पासवर्ड चोरी करने से रोकना आसान होता है : यदि आपको URL बार में ऐसा लॉक आइकन नहीं दिखता है, तो अपना पासवर्ड टाइप करने से पहले फिर से सोचें :
privacy-passwords-a-closed-lock = सभी प्रमुख ब्राउज़रों में URL बार में वेबसाइट पते से ठीक पहले एक बंद पैडलॉक दिखाई देता है।
privacy-passwords-the-lock-means = लॉक का मतलब है कि आप जिस वेबसाइट का उपयोग कर रहे हैं वह एन्क्रिप्टेड है, ताकि अगर कोई नेटवर्क पर आपकी ब्राउज़िंग देख रहा हो (जैसे कि सार्वजनिक वाईफाई हॉटस्पॉट पर कोई अन्य व्यक्ति), तो वे आपका पासवर्ड नहीं देख पाएँगे। जब आप एक अनएन्क्रिप्टेड साइट पर अपना पासवर्ड दर्ज करने वाले हों तो आपको { -brand-name-firefox } चेतावनी देगा।
privacy-passwords-a-padlock-with = रेखा वाला पैडलॉक इंगित करता है कि कनेक्शन सुरक्षित नहीं है।
privacy-passwords-your-browser-also = आपका ब्राउज़र आपको यह जानकारी देने में मदद करता है कि साइट कितनी भरोसेमंद है, जो आपको फ़िशिंग से सुरक्षित रखने में मदद करती हैं। एक ओर, जब आप एक ऐसी वेबसाइट पर जाने की कोशिश करते हैं, जिसे फ़िशिंग साइट के रूप में जाना जाता है, तो { -brand-name-firefox } (और कोई भी बड़ा ब्राउज़र) एक पूर्ण-स्क्रीन चेतावनी प्रदर्शित करेगा - <strong>ध्यान दें और उस साइट का उपयोग करने के बारे में दो बार सोचें!</strong>

privacy-passwords-firefox-will-v2 = यदि कोई वेबसाइट फ़िशिंग साइट के रूप में ज्ञात है, तो { -brand-name-firefox } द्वारा उस वेबसाइट के बजाय एक चेतावनी प्रदर्शित की जाएगी।

# Outdated string
privacy-passwords-firefox-will = यदि वेबसाइट फ़िशिंग साइट के रूप में जाना जाता है, तो Firefox चेतावनी प्रदर्शित करेगा।

privacy-passwords-in-general-the = सामान्य तौर पर, फ़िशिंग के खिलाफ सबसे अच्छा बचाव यह है कि <strong>आप जो भी पाएँ, उस पर संदेह करें,</strong> चाहे वह ईमेल में दिखाई दे, टेक्स्ट संदेश हो या फ़ोन पर हो। किसी ने आपको क्या भेजा, इस पर कार्रवाई करने के बजाय, सीधे साइट पर जाएँ। उदाहरण के लिए, यदि कोई ईमेल कहता है कि आपको अपना PayPal पासवर्ड रीसेट करने की आवश्यकता है, तो लिंक पर क्लिक न करें। Paypal.com खुद टाइप करें। यदि बैंक कॉल करता है, तो उन्हें वापस कॉल करें।
privacy-passwords-strength-in-diversity = अनेकता में एकता
privacy-passwords-the-secret-to = क्रमरहित पासवर्ड बनाना ही आपके पासवर्ड को चोरी होने, रिसेट होने और हमलावरों द्वारा अनुमान लगाए जाने से बचा सकता है। जब हमलावर पासवर्ड का अनुमान लगाने की कोशिश करते हैं, तो वे आमतौर पर दो काम करते हैं : 1) &quot;शब्दकोशों&quot; का उपयोग - सामान्य पासवर्ड की सूची जो लोग हर समय उपयोग करते हैं, और 2) कुछ आकस्मिक अनुमान लगाते हैं। आपका पासवर्ड जितना <strong>लंबा और अधिक क्रमरहित होगा</strong>, उतनी कम संभावना है कि इनमें से कोई भी अनुमान लगाने की तकनीक उसपर काम कर पाएगी।
...
privacy-passwords-in-todays-internet-v2 = आज के इंटरनेट में, जहाँ हर दिन हजारों पासवर्ड चोरी हो जाते हैं और ब्लैक मार्केट में अकाउंट्स बेचे व खरीदे जाते हैं, ऐसे हालात में आपके ऑनलाइन जीवन को सुरक्षित रखने का प्रयास ज़रूरी है। जब आप { -brand-name-firefox } उत्पादों का उपयोग करते हैं, तो कुछ प्रयास आपको करने की ज़रूरत नहीं पड़ती, क्योंकि हमारे सभी उत्पाद हमारे <a { $url_privacy_products }>निजता के वादे</a> को कायम रखने के लिए बनाए गए हैं। और { -brand-name-firefox } हमेशा <a { $url_about_manifesto }>{ -brand-name-mozilla } के मिशन</a> द्वारा निर्देशित होता है, जो कि हमारा समर्थन करने वाला गैर-लाभकारी ऑर्गनाइजेशन है और बेहतर इंटरनेट के निर्माण के लिए प्रतिबद्ध है।

# Outdated string
#   $url_privacy_products (string) - link to https://www.mozilla.org/firefox/privacy/products/ with additional attributes for analytics
#   $url_about_manifesto (string) - link to https://www.mozilla.org/about/manifesto/ with additional attributes for analytics
privacy-passwords-in-todays-internet = आज के इंटरनेट में, जहाँ हर दिन हज़ारों पासवर्ड चोरी हो जाते हैं और काले बाजार में एकाउंट का कारोबार होता है, आपके ऑनलाइन जीवन को सुरक्षित रखने का यह प्रयास ज़रूरी है। जब आप { -brand-name-firefox } उत्पादों का उपयोग करते हैं, तो कुछ प्रयास आपको करने की ज़रूरत नहीं पड़ती, क्योंकि हमारे सभी उत्पाद हमारे <a { $url_privacy_products }>निजता के वादे</a> को कायम रखने के लिए बनाए गए हैं। और { -brand-name-firefox } हमेशा <a { $url_about_manifesto }>Mozilla के मिशन</a> द्वारा निर्देशित होता है, जो कि हमारा समर्थन करने वाली निर्लाभ संस्था है और बेहतर इंटरनेट के निर्माण के लिए प्रतिबद्ध है।
