...
# Hero title
features-index-firefox-features = { -brand-name-firefox } की विशेषताएं
...
features-index-private-by-default = तयशुदा रूप से गोपनीय
features-index-enhanced-tracking = उन्नत ट्रैकिंग सुरक्षा
features-index-get-firefox-for-privacy = गोपनीयता के लिए { -brand-name-firefox } पाएं
features-index-firefox-vs = { -brand-name-firefox } बनाम अन्य ब्राउज़र
features-index-download-latest = नवीनतम { -brand-name-firefox } डाउनलोड करें
