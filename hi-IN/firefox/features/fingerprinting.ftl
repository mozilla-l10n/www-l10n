...
features-fingerprinting-if-you-have = अगर आपके पास ऐसा लैपटॉप, पीसी या स्मार्टफ़ोन है जिसे कई लोग इस्तेमाल करते हैं, तो फ़िंगरप्रिंटिंग के ज़रिए आपके डिवाइस को अलग से पहचानना मुश्किल हो सकता है। हालाँकि, आपके ऐड-ऑन, फ़ॉन्ट और सेटिंग जितनी अलग होंगी, आपको ढूँढ़ना उतना ही आसान होगा। कंपनी इन सभी अलग-अलग चीज़ों के कॉम्बिनेशन के ज़रिए आपका फ़िंगरप्रिंट तैयार कर सकती हैं। इसलिए { -brand-name-firefox } फ़िंगरप्रिंटिंग को ब्लॉक करता है, ताकि विज्ञापन आपका पीछा न कर सकें और आप अपने पसंदीदा एक्सटेंशन, थीम और कस्टमाइज़ेशन इस्तेमाल करते रह सकें।
