...
download-button-supported-devices = ஆதரிக்கப்படும் சாதனங்கள்
...
download-button-get-firefox-android = ஆண்ட்ராய்டுக்கான பயர்பாக்சைப் ( { -brand-name-android } { -brand-name-firefox } ) பெறுங்கள்
