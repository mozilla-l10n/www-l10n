...
footer-refresh-x = X
footer-refresh-x-formerly-twitter = X (ਪੁਰਾਣਾ Twitter)
...
footer-refresh-follow-firefox = @{ -brand-name-firefox } ਲਈ ਫ਼ਾਲੋ ਕਰੋ
footer-refresh-youtube = YouTube
footer-refresh-company = ਕੰਪਨੀ
footer-refresh-press-center = ਪਰੈੱਸ ਸੈਂਟਰ
footer-refresh-careers = ਕੈਰੀਅਰ
footer-refresh-contact = ਸੰਪਰਕ
footer-refresh-support = ਸਹਿਯੋਗ
