...
firefox-accounts-sign-in-to = ਇਸ ਲਈ ਆਪਣੇ { -brand-name-firefox-account } ਵਿੱਚ ਸਾਈਨ ਇਨ ਕਰੋ:
# Obsolete string
...
firefox-accounts-send-a-tab = ਵੱਖਰੇ ਡਿਵਾਈਸ ਉੱਤੇ <a href="{ $send }">ਟੈਬ</a> ਭੇਜੋ
# Variables:
