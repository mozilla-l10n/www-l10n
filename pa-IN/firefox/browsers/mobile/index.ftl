...
browsers-mobile-already-have-an-account-sign = ਪਹਿਲਾਂ ਹੀ ਖਾਤਾ ਹੈ? <a { $fxa_attr }>ਸਾਈਨ ਇਨ ਕਰੋ</a> ਜਾਂ { -brand-name-firefox } ਦਾ ਹਿੱਸਾ ਬਣਨ ਲਈ <a { $accounts_attr }>ਹੋਰ ਜਾਣੋ</a>।
