...
# Variables:
#   $fxa (url) = link to https://www.mozilla.org/firefox/accounts/
password-manager-with-a-free-firefox-account = <a href="{ $fxa }">ਮੁਫ਼ਤ { -brand-name-firefox } ਖਾਤੇ</a> ਨਾਲ ਤੁਸੀਂ ਆਪਣੇ ਸਾਰੇ ਡਿਵਾਈਸਾਂ ਉੱਤੇ ਆਪਣੇ ਪਾਸਵਰਡਾਂ ਨੂੰ ਸੁਰੱਖਿਅਤ ਢੰਗ ਨਾਲ ਸਿੰਕ ਕਰ ਸਕਦੇ ਹੋ।
