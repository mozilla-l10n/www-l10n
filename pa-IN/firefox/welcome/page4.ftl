...
welcome-page4-privacy-every-screen-now = ਹੁਣ ਹਰ ਸਕਰੀਨ ਉੱਤੇ ਪਰਦੇਦਾਰੀ ਲਵੋ
...
welcome-page4-privacy-on-by-default = { -brand-name-android } ਲਈ ਨਵੇਂ { -brand-name-firefox } ਨਾਲ ਤੁਹਾਡੀ ਪਰਦੇਦਾਰੀ ਸਾਡੀ ਲਈ ਮੂਲ ਆਧਾਰ ਹੈ — ਅਤੇ ਹੁਣ ਤੁਸੀਂ { -brand-name-firefox } ਨੂੰ { -brand-name-ios } 14 ਉੱਤੇ ਆਪਣਾ ਮੂਲ ਬਰਾਊਜ਼ਰ ਬਣਾ ਸਕਦੇ ਹੋ।
welcome-page4-get-the-firefox-mobile = { -brand-name-firefox } ਮੋਬਾਈਲ ਲਵੋ
...
welcome-page4-enhanced-tracking-protection = ਵਾਧਾ ਕੀਤੀ ਟਰੈਕਿੰਗ ਸੁਰੱਖਿਆ ਵੈੱਬ ਉੱਤੇ ਤੁਹਾਡਾ ਪਿੱਛਾ ਕਰਨ ਵਾਲੇ <a href="{ $privacy }">2000+ ਟਰੈਕਰਾਂ ‘ਤੇ ਰੋਕ</a> ਲਾਉਂਦੀ ਹੈ।
# "Leave no trace" is an expression for leaving nothing behind.
welcome-page4-leave-no-trace = ਕੋਈ ਪੈੜ ਨਾ ਛੱਡੋ
