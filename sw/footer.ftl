...
footer-desktop = Kompyuta
footer-mobile = Simu ya mkono
...
footer-about = Kuhusu
footer-press-center = Kituo cha Wanahabari
footer-mdn-web-docs = { -brand-name-mdn-web-docs }
footer-websites-cookies = Vidakuzi
footer-websites-legal = Kisheria
