...
home-when-you-use-firefox-you-help = Kada koristite { -brand-name-firefox }, pomažete { -brand-name-mozilla } u borbi s dezinformacijama na mreži, učite digitalne vještine i činite sekciju s komentarima više ljudskom. Pogledajte šta pomaže u stvaranju zdravijeg interneta.
home-working-to-keep-the-internet = Radeći da zadržimo web zdravim, otvorenim i dostupnim svima, mi podučavamo web pismenost, pružamo alate i zastupnike u ime svakog pojedinca koji cijeni internet kao globalni javni resurs.
home-working-at-the-grassroots-and = Radeći na razini provincija i politike, učimo web pismenost, pružamo alate i zastupnika u ime svakog pojedinca koji cijeni internet izgrađen na poštenju, uključenosti i poštovanju.
home-mozilla-information-trust-initiative = { -brand-name-mozilla } Information Trust Initiative
home-empowering-women-online = Osnaživanje žena na internetu
home-the-coral-project = Projekt Coral
home-read-our-internet-health-report = Pročitajte naš internet izvještaj o zdravlju
...
home-learn-about-the-benefits-of = Saznajte više o prednostima rada u { -brand-name-mozilla } i pogledajte otvorene pozicije širom svijeta.
home-need-help = Trebate pomoć?
home-get-answers-to-your-questions = Dobijte odgovore na vaša pitanja o { -brand-name-firefox }u i svim { -brand-name-mozilla } proizvodima od našeg tima za podršku.
