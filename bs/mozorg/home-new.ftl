...
# Obsolete string
home-mitchell-baker = Mitchell Baker, { -brand-name-mozilla } izvršni direktor
...
home-get-good-news = Primajte (dobre) { -brand-name-mozilla } vijesti
home-get-news-and-tips = Primajte vijesti i savjete od { -brand-name-mozilla }e da ostanete sigurni i informisani o svemu što web čini zdravijim mjestom.
# VPN Feature
