...
privacy-faq-mozilla-doesnt-know-as-much = { -brand-name-mozilla } ne zna toliko puno kako vi očekujete o tome kako ljudi pretražuju web. Kao graditelji browsera, to je ustvari veliki izazov za nas. Zato mi ugrađujemo opcione alate, kao što je <a href="{ $link }">{ -brand-name-firefox } Pioneer</a>, koji dozvoljavaju korisnicima da nam daju pristup njihovom web pretraživanju. Ako sinrhonizujete vašu historiju pretraživanja putem { -brand-name-firefox } instalacija, mi ne znamo šta je ta historija - jer je šifrovana od strane vašeg uređaja.
