...
# HTML description
# Obsolete string
mobile-ios-firefox-browser-for = { -brand-name-firefox } pretraživač za { -brand-name-ios } je brz, siguran i privatan od prvog otvaranja.
mobile-ios-firefox-browser = { -brand-name-firefox-browser }
# Obsolete string
mobile-ios-get-automatic-privacy = Dobijte automatsku privatnost na svom { -brand-name-iphone } i { -brand-name-ipad }
