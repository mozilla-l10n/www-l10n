...
compare-shared-dashboard-to-review = Komandna tabla za pregled blokiranih elemenata za praćenje
compare-shared-autoplay-blocking = Blokira automatske reprodukcije
compare-shared-tab-browsing = Pretraživanje po tabovima
compare-shared-bookmark-manager = Menadžer oznaka
compare-shared-automatically-fills-out-forms = Automatski popunjava obrasce
compare-shared-automatically-fills-out-payments = Automatski popunjava plaćanja
compare-shared-search-engine-options = Opcije pretraživača
...
compare-shared-download-firefox = Preuzmite { -brand-name-firefox }
compare-shared-download-firefox-browser = Preuzmite { -brand-name-firefox-browser }
compare-shared-download-the-app = Preuzmite aplikaciju
