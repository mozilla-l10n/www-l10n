...
features-private-browsing-private-browsing-mode-opens = Režim privatnog pretraživanja otvara novi prozor pretraživača. Kada ga zatvorite, vaša historija pretraživanja za taj prozor i svi kolačići za praćenje sa web stranica koje ste posjetili bit će izbrisani. <strong>{ -brand-name-firefox }ov profesionalni savjet:</strong> Ne zaboravite zatvoriti prozor privatnog pretraživanja kada završite!
