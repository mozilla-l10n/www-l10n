...
download-button-supported-devices = Podržani uređaji
download-button-whats-new = Šta je novo
download-button-systems-languages = Sistemi i jezici
...
download-button-your-system-does-not = Vaš sistem ne ispunjava <a href="{ $url }">uslove</a> za pokretanje { -brand-name-firefox }a.
download-button-firefox-other-platforms = { -brand-name-firefox } za ostale platforme i jezike
download-button-update-your-firefox = Nadogradite vaš { -brand-name-firefox }
download-button-get-firefox-android = Preuzmite { -brand-name-firefox } za { -brand-name-android }
download-button-get-firefox-ios = Preuzmite { -brand-name-firefox } za { -brand-name-ios }
download-button-google-play = Preuzmite sa { -brand-name-google-play }-a
download-button-free-google-play = Preuzmte besplatno na { -brand-name-google-play }
download-button-app-store = Preuzmite besplatno sa { -brand-name-app-store }
download-button-download-app-store = Preuzmite na { -brand-name-app-store }-u
download-button-download-firefox = Preuzmite { -brand-name-firefox }
download-button-your-system-may = Vaš sistem možda ne ispunjava uslove za { -brand-name-firefox }, ali možete probati jednu od ovih verzija:
