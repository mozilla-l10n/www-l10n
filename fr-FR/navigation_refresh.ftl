...
navigation-refresh-landmark-label = Principal
...
navigation-refresh-mozilla-new-products = Nouveaux produits { -brand-name-mozilla }

## Firefox

navigation-refresh-firefox-browsers = Navigateur { -brand-name-firefox }
navigation-refresh-close-firefox-browsers-menu = Fermer le menu du navigateur { -brand-name-firefox }
navigation-refresh-firefox-for-desktop = { -brand-name-firefox } pour ordinateur
navigation-refresh-firefox-for-android = { -brand-name-firefox } pour { -brand-name-android }
navigation-refresh-firefox-for-ios = { -brand-name-firefox } pour { -brand-name-ios }
navigation-refresh-firefox-focus = { -brand-name-firefox-focus }
navigation-refresh-firefox-relay = { -brand-name-firefox-relay }
navigation-refresh-all-products = Tous les produits
