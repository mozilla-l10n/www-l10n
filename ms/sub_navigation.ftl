...
sub-navigation-compare-mobile-browsers = Bandingkan Pelayar Mudah Alih
...
sub-navigation-android-support = Bantuan { -brand-name-android }
...
sub-navigation-firefox-features = Ciri-ciri { -brand-name-firefox }
sub-navigation-ad-tracker-blocking = Sekatan Penjejak Iklan
sub-navigation-private-browsing = Pelayaran Peribadi
