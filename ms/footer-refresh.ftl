...
footer-refresh-learn-more-about-mozilla-ads = Ketahui lebih lanjut <span>tentang { footer-refresh-mozilla-ads }</span>
...
footer-refresh-add-trust-to = Tingkatkan kepercayaan kepada belian iklan anda.
...
footer-refresh-follow-firefox = Ikuti @{ -brand-name-firefox }
footer-refresh-youtube = YouTube
footer-refresh-company = Syarikat
footer-refresh-press-center = Pusat Berita
footer-refresh-careers = Kerjaya
# Our "merch" store is an online store which sells Mozilla branded stuff. (Merch is short for merchandise).
footer-refresh-store = Kedai Barangan
footer-refresh-contact = Hubungan
footer-refresh-support = Bantuan
...
footer-refresh-tools = Alatan
footer-refresh-donate = Sumbangan
footer-refresh-donate-not-for-profit = Sumbang kepada <a { $mofo_link }>{ -brand-name-mozilla-foundation }</a>, organisasi bukan berasaskan keuntungan.
...
footer-refresh-anonym-privacy-policy = Polisi Peribadi { -brand-name-anonym }
footer-refresh-anonym-terms-and-conditions = Terma dan Syarat { -brand-name-anonym }
