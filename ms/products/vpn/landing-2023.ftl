...
# HTML page title
vpn-landing-title = { -brand-name-mozilla-vpn }: Lindungi Kesemua Peranti Anda

# HTML page description
# Variables:
#   $countries (number) - number of available countries
vpn-landing-desc = Gunakan { -brand-name-mozilla-vpn } untuk perlindungan penuh peranti untuk semua aplikasi. Dengan pelayan di negara { $countries }+, anda boleh berhubung ke mana jua, dari mana sahaja.
vpn-landing-powerful-privacy-for-peace = Privasi berkuasa demi ketenangan fikiran

vpn-landing-whats-a-vpn = Apa itu VPN?
vpn-landing-a-virtual-private-network-protects = Rangkaian peribadi maya melindungi sambungan ke internet, menjadikan lokasi dan aktiviti dalam talian anda lebih peribadi pada kesemua peranti.
...
vpn-landing-fast-network-speeds-even-while = Kelajuan jaringan pantas walaupun ketika bermain permainan video
...
vpn-landing-one-subscription-for-all-your = Langganan kami untuk semua peranti anda

# HTML for emphasis
vpn-landing-powered-by-mozilla-fighting-for = <strong>Dikuasakan oleh { -brand-name-mozilla }.</strong> Menegakkan hak anda untuk privasi sejak 1998.
vpn-landing-learn-more-from-our-experts = Ketahui lebih lanjut melalui pakar-pakar kami
vpn-landing-do-you-need-a-vpn-at-home = Anda memerlukan VPN di rumah? Lima sebab mengapa anda perlukannya.
