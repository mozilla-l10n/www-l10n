...
vpn-mobile-get-a-vpn = Dapatkan VPN mudah-alih daripada { -brand-name-mozilla }
vpn-mobile-looking-for-a = Sedang mencari VPN untuk melindungi peranti mudah-alih anda? { -brand-name-mozilla-vpn } VPN disokong oleh syarikat bukan berasaskan keuntungan. Ketahui bagaimana VPN melindungi anda dan mengapa anda harus percayakan { -brand-name-mozilla } dengan privasi dan keselamatan anda.
vpn-mobile-vpn-for-mobile = VPN untuk mudah-alih daripada { -brand-name-mozilla }
...
vpn-mobile-your-internet-v2 = Penyedia Perkhidmatan Internet (ISP) anda mengawal jalur lebar anda jika mereka tahu anda sedang menonton filem, mendengar muzik atau sedang menstrim.
# Obsolete string
...
vpn-mobile-your-isp-v2 = ISP anda mungkin menghalang laman web atau perkhidmatan yang tidak sehaluan atau tidak dimiliki mereka.
# Obsolete string
...
vpn-mobile-hackers-can-steal-v2 = Penggodam mampu mencuri data peribadi sewaktu anda menggunakan Wifi awam seperti di kafe atau lapangan terbang.
# Obsolete string
