...
newsletter-form-keep-up-with = Ikuti perkembangan<br> { -brand-name-firefox }.
newsletter-form-get-mozilla-updates = Dapatkan kemas kini { -brand-name-mozilla }
...
newsletter-form-label = Borang melanggan buletin
