...
firefox-sticky-promo-meet-our-family-of = Ketahui rangkaian produk kami

firefox-sticky-promo-meet-mozillas-family = Memperkenalkan rangkaian produk { -brand-name-mozilla }
firefox-sticky-promo-get-the-latest-firefox = Dapatkan pelayar { -brand-name-firefox } terkini.

# Products List
firefox-sticky-promo-browsers = Pelayar
