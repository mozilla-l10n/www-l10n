...
# Obsolete string
compare-shared-master-password = Kata laluan Induk
...
# Obsolete string
compare-shared-the-comparisons-made-here = Perbandingan yang dibuat di sini dilakukan dengan semua versi keluaran pelayar seperti yang berikut:
