...
# HTML Page title
m24-about-page-title = Ketahui tentang { -brand-name-mozilla }

# HTML page description
m24-about-page-desc = { -brand-name-mozilla } membangunkan pelayar, aplikasi, kod dan peralatan yang mengutamakan pengguna sebelum keuntungan. Misi kami: Memastikan internet sentiasa terbuka dan mudah diakses oleh semua orang.
...
m24-about-we-build-products-v2 = Kami membangunkan produk yang meletakkan kawalan di tangan anda — contohnya { -brand-name-firefox } dan lain-lain.
m24-about-fund = Dana
...
m24-about-builders-program = { -brand-name-mozilla-builders } membantu pembangun mencipta projek AI sumber terbuka yang transformatif menerusi kerjasama, pengaturcaraan dan komuniti
...
m24-about-lets-build-a = Mari kita bina masa depan yang lebih adil dan saksama
m24-about-see-how-were = Lihat bagaimana kami memupuk persekitaran dalam talian yang lebih beraneka, terangkum dan mudah dicapai.
m24-about-read-about-our = Bacaan yang berkaitan komitmen
