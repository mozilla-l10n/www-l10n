...
navigation-refresh-landmark-label = Utama
...
navigation-refresh-mozilla-new-products = Produk Terkini { -brand-name-mozilla }

## Firefox

navigation-refresh-firefox-browsers = Pelayar { -brand-name-firefox }
navigation-refresh-close-firefox-browsers-menu = Tutup menu pelayar { -brand-name-firefox }
navigation-refresh-firefox-for-desktop = { -brand-name-firefox } untuk Desktop
navigation-refresh-firefox-for-android = { -brand-name-firefox } untuk { -brand-name-android }
navigation-refresh-firefox-for-ios = { -brand-name-firefox } untuk { -brand-name-ios }
navigation-refresh-firefox-focus = { -brand-name-firefox-focus }
navigation-refresh-firefox-relay = { -brand-name-firefox-relay }
navigation-refresh-all-products = Semua produk
