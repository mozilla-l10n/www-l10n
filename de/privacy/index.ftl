...
privacy-index-if-you-want-to-make-a-correction = Wenn Sie Ihre Daten korrigieren möchten oder Fragen zu unseren Datenschutzregeln haben, melden Sie sich bitte bei:

# Variables:
#   $dsar (url) - link to https://app.onetrust.com/app/#/webform/4ba08202-2ede-4934-a89e-f0b0870f95f0
privacy-index-see-here-for-data-subject = <a href="{ $dsar }">Informationen zu Zugriffsanforderungen für betroffene Personen finden Sie hier.</a>

# Variables:
#   $sumo (url) - link to https://support.mozilla.org/
privacy-index-for-product-support-requests = Für Anfragen zur Hilfe mit Produkten besuchen Sie bitte <a href="{ $sumo }">unsere Foren</a>.
...
privacy-index-get-involved = Beteiligen Sie sich
...
privacy-index-to-review-and-comment-on-proposed = Um vorgeschlagene Änderungen an unseren Datenschutzrichtlinien einzusehen und zu kommentieren, <a href="{ $group }">abonnieren Sie { -brand-name-mozilla }s Verwaltungsgruppe</a>.
