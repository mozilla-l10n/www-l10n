...
firefox-privacy-hub-because-we-put-people-first = Weil Menschen bei uns an erster Stelle kommen. Hinter uns steht eine <a href="{ $foundation }">gemeinnützige Organisation</a>. Unsere Mission bestand vom ersten Tag an darin, das Internet und die Menschen, die es nutzen, zu beschützen.
...
firefox-privacy-hub-if-you-want-to-see-what = Wenn Sie wissen möchten, was { -brand-name-firefox } für Sie blockt, rufen Sie diese Seite in Ihrem { -brand-name-firefox }-Desktop-Browser auf.
