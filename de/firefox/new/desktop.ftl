...
firefox-desktop-download-available-in-over = { -brand-name-firefox } ist in über 90 Sprachen verfügbar und mit { -brand-name-windows }-, { -brand-name-mac-short }- und { -brand-name-linux }-Systemen kompatibel. Um das beste aus { -brand-name-firefox } herauszuholen, solltest du nur darauf achten, dein Betriebssystem regelmäßig upzudaten.
