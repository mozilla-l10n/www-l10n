...
the-firefox-browser = Der { -brand-name-firefox }-Browser schützt Ihre Privatsphäre auf Schritt und Tritt. Dies ist der schnellste Weg, um Sie von langsamen Ladevorgängen, störenden Anzeigen und Trackern zu befreien.
...
firefox-more-access-your-sync = Greifen Sie auf Ihre Lesezeichen, Passwörter, offenen Tabs und mehr zu und synchronisieren Sie diese überall dort, wo Sie { -brand-name-firefox } verwenden.
...
firefox-doesnt-spy = { -brand-name-firefox } spioniert keine Suchanfragen aus. Wir stoppen bekannte Tracking-Cookies von Drittanbietern und geben Ihnen die volle Kontrolle.
