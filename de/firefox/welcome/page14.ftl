...
welcome-page14-page-title = Erhalte 20 % Rabatt auf { -brand-name-mozilla-vpn } im Cybersecurity Month
...
welcome-page14-copy-code = Code kopieren

welcome-page14-code-copied = Code kopiert!
...
welcome-page14-never-log = Wir loggen, tracken oder teilen Ihre Netzwerkdaten nie – Ihre Online-Aktivitäten hinterlassen auf unseren VPN-Servern keine Spuren.

welcome-page14-why-see-this = Warum wird mir das angezeigt?
