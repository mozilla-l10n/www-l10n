...
welcome-page3-never-forget-reset-or-travel = Passwörter nie wieder vergessen, zurücksetzen müssen oder zu Hause lassen.
welcome-page3-facebook-container = { -brand-name-facebook-container }
welcome-page3-get-a-container-to-keep-facebook = Halte { -brand-name-facebook } davon ab, dich durchs Web zu tracken.
welcome-page3-pocket = { -brand-name-pocket }
welcome-page3-trade-clickbait-and-fake-news = Tausche Clickbait und Fake News gegen Inhalte, die sich lohnen.
welcome-page3-firefox-send = { -brand-name-firefox-send }
welcome-page3-send-huge-files-to-anyone = Sende große Dateien an wen immer du willst – per Link, der "sich selbst zerstört".
welcome-page3-why-am-i-seeing-this = Warum wird mir das angezeigt?
