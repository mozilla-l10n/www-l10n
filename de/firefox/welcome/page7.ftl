...
page7-facebook-container-also-works = { -brand-name-facebook-container } funktioniert auch bei anderen zu { -brand-name-facebook } gehörigen Seiten wie { -brand-name-instagram }, { -brand-name-facebook-messenger } und { -brand-name-workplace }.
