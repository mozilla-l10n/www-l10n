...
page7-if-you-still-kinda-like-facebook = Wenn du dich nicht von { -brand-name-facebook } trennen kannst, aber der Sache auch einfach nicht mehr traust, hol dir die { -brand-name-facebook-container }-Erweiterung von { -brand-name-firefox }. Damit machst du es { -brand-name-facebook } schwerer, dich durchs Web zu tracken.
page7-get-facebook-container = { -brand-name-facebook-container } hinzufügen
...
page7-do-it-for-the-gram = Auch für Instagram
page7-facebook-container-also-works = { -brand-name-facebook-container } blockiert auch Tracker von Seiten, die nicht { -brand-name-facebook } sind, aber zu { -brand-name-facebook } gehören, wie { -brand-name-instagram }, { -brand-name-facebook-messenger } und { -brand-name-workplace }.
page7-make-them-unfollow-you = Häng Social-Tracker ab
...
page7-get-firefox-monitor = Zu { -brand-name-firefox-monitor }
