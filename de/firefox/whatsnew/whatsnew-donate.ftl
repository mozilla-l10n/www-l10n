...
whatsnew-donate-whatsnew = Was ist neu
whatsnew-donate-donate-to = Spende an { -brand-name-mozilla-foundation }, die Non-Profit hinter { -brand-name-firefox }
...
whatsnew-donate-release-notes = Versionshinweise
