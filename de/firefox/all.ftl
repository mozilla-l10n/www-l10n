...
firefox-all-everyone-deserves-access-v2 = Sprache sollte keine Barriere sein. Das Internet spricht viele Sprache – auch deine. Deshalb machen wir { -brand-name-firefox } mit der Unterstützung engagierter Freiwilliger auf der ganzen Welt in mehr als 90 Sprachen verfügbar.
# Obsolete string (expires 2024-10-30)
