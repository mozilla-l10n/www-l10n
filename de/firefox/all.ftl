...
firefox-all-need-help = Benötigst du Hilfe?
firefox-all-which-browser-would = Welchen Browser möchtest du downloaden?
# Used as an accessible label for a help button. The text is replaced with a "?" icon.
firefox-all-get-help = Hilfe
firefox-all-you-are-about-to-download = Du lädst Folgendes herunter:
firefox-all-browser = Browser:
firefox-all-platform = Betriebssystem:
firefox-all-language = Sprache:
...
firefox-all-choose-which-firefox = Hol dir den { -brand-name-firefox-browser } in deiner Sprache
...
firefox-all-the-standard-firefox = Der Standard-{ -brand-name-firefox }-Browser – schnell und privat. Wenn du dir nicht sicher bist, welchen { -brand-name-firefox } du auswählen sollst, wähle diese Option.
...
firefox-all-windows-installers-for = Windows-Installationsprogramme für die Unternehmens-IT, die die Konfiguration, Bereitstellung und Verwaltung des Firefox-Browsers vereinfachen.
# Variables:
...
firefox-all-msi-installers = MSI-Installer
