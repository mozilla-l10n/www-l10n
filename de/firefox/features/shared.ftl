...
features-shared-firefox-add-ons-and-browser-extensions = { -brand-name-firefox }-Browsererweiterungen
features-shared-pinned-browser-tabs = Angeheftete Tabs
features-shared-eyedropper-tool = Farbpipette
