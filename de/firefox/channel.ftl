...
firefox-channel-take-a-browse-on-the-wild-side = Testen Sie die Zukunft.
firefox-channel-be-among-the-first-to-explore = Seien Sie einer der Ersten, die zukünftige Versionen von { -brand-name-firefox } für Desktop, { -brand-name-android } und { -brand-name-ios } ausprobieren.
firefox-channel-see-something-that-isnt-working = Haben Sie ein Problem entdeckt? Sagen Sie uns Bescheid.
...
firefox-channel-try-new-features-in-a-pre = Testen Sie neue Funktionen in der Vorabversion des { -brand-name-android }-Browsers | { -brand-name-firefox }
firefox-channel-download-and-test-future = Nutzen und testen Sie zukünftige Versionen von { -brand-name-firefox } für Desktop, { -brand-name-android } und { -brand-name-ios }.
firefox-channel-experience-cutting-edge-android-updated = Erleben Sie brandneue Funktionen in der Vorabversion des Browsers für { -brand-name-android }: { -brand-name-firefox-beta } und { -brand-name-firefox-nightly }. Jetzt installieren!
firefox-channel-experience-cutting-edge-android = Erleben Sie brandneue Funktionen in der Vorabversion des Browsers für { -brand-name-android }: { -brand-name-firefox-beta }, { -brand-name-firefox-aurora } und { -brand-name-firefox-nightly }. Jetzt installieren!
firefox-channel-download-and-test-the-latest-android = Nutzen und testen Sie die neuesten Funktionen von { -brand-name-firefox } für { -brand-name-android } mit den { -brand-name-aurora }-, { -brand-name-beta }- und { -brand-name-nightly }-Versionen.
...
firefox-channel-test-about-to-be-released = Testen Sie kurz vor der Veröffentlichung stehende Funktionen in der stabilsten Vorabversion.
...
firefox-channel-try-new-features-in-a-pre-release = Testen Sie neue Funktionen in der Vorabversion des { -brand-name-ios }-Browsers | { -brand-name-firefox }
firefox-channel-experience-cutting-edge-features-ios = Erleben Sie mit { -brand-name-apple }s { -brand-name-test-flight }-Programm brandneue Funktionen in einer Vorabversion des Browsers für { -brand-name-ios }. Jetzt installieren!
firefox-channel-test-beta-versions-of-firefox-ios-long = Testen Sie über { -brand-name-apple }s { -brand-name-test-flight }-Programm Beta-Versionen von { -brand-name-firefox } für { -brand-name-ios } und helfen Sie dabei, unseren mobilen Browser für { -brand-name-iphone }, { -brand-name-ipad } und iPod touch noch besser zu machen.
