...
misinformation-page-title = Falschinformationen im Internet vermeiden – { -brand-name-firefox } hilft dir dabei
misinformation-page-desc = Fehlinformationen stören, lenken ab und sind teuer. { -brand-name-firefox } hat einige Tipps, um falsche Informationen zu vermeiden – und weniger davon zu sehen, wenn du im Internet surfst.
misinformation-page-subheading = Sieh dir Tipps an, mit deren Hilfe du weniger Falschinformationen siehst und dich auf das konzentrieren kannst, was dir wichtig ist.
...
misinformation-look-at-url = Schau dir die URL und/oder die Quelle an.
misinformation-known-to-br-credible = Ist sie vertrauenswürdig? Wenn du dir nicht sicher bist, versuche im Internet mehr über die Quelle und ihren Ruf zu erfahren.
misinformation-overly-sensational = Ist die Überschrift auffallend reißerisch?
misinformation-check-out-websites = Schau nach, wie Webseiten und Publikationen, denen du vertraust, über dasselbe Thema berichten. Inhalte, die gezielt manipulieren sollen, verwenden oft Extreme und Übertreibungen, wenn es keine bestätigten Beweise für ihre Aussagen gibt. Das unterscheidet sie von gut recherchierter Berichterstattung.
misinformation-content-up-to-date = Ist der Inhalt aktuell?
misinformation-outdated-information = Die Verwendung von veralteten Informationen dient nicht notwendigerweise dem Zweck, falsch zu informieren. Allerdings müssen diese Inhalte nicht unbedingt noch immer zutreffen.
...
misinformation-authors-name = Wenn du den Namen des Autors nur auf fragwürdigen Seiten findest, solltest du seinen Aussagen nicht allzu viel Vertrauen schenken.
...
misinformation-firefox-keeps-trackers-desc = Wie bereits erwähnt, spielt Tracking eine wichtige Rolle bei der Verbreitung von Fehlinformationen. <a href="{ $firefox }">Wenn du { -brand-name-firefox }</a> mit <a href="{ $protection }">verbessertem Tracking-Schutz</a> benutzt, werden Drittanbieter-Tracker von vielen Werbetreibenden und anderen Instanzen automatisch geblockt, sodass du die Kontrolle über deine Online-Daten beim Surfen wieder erhältst.
...
misinformation-social-media-clean-desc = Soziale Netzwerke wissen eine Menge über dich. Außerdem können sie dich über ihre Plattformen hinweg verfolgen, über die Buttons „Gefällt mir“ und „Teilen“. Und das trotz Schutz vor Aktivitätenverfolgung und auch, wenn du kein Konto hast. Der <a href="{ $container }">{ -brand-name-facebook-container }</a> für { -brand-name-firefox } sorgt dafür, dass { -brand-name-facebook } und { -brand-name-instagram } das nicht mehr so einfach tun können, wodurch die Wahrscheinlichkeit erheblich sinkt, dass du Falschinformationen über Anzeigen und beworbene Inhalte zu sehen bekommst.
...
misinformation-designed-to-protect = Zum Schutz deiner Privatsphäre entwickelt
