...
mobile-android-got-a-big = Hast du ein großes Handy und normalgroße Daumen? Kein Problem. Mit { -brand-name-firefox } für { -brand-name-android } kannst du die Suchleiste von oben nach unten verschieben, um die Bedienung mit einer Hand zu erleichtern. Du kannst auch deine eigene Suchmaschine im Browser auswählen und bei Bedarf { -brand-name-firefox } als deinen Standardbrowser festlegen.
...
mobile-android-get-there-faster = Schneller ans Ziel kommen mit { -brand-name-firefox } für { -brand-name-android }
