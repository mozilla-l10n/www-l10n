...
# HTML description
mobile-ios-firefox-browser-for = Der { -brand-name-firefox }-Browser für { -brand-name-ios } bietet standardmäßig Geschwindigkeit, Sicherheit und Privatsphäre.
mobile-ios-firefox-browser = { -brand-name-firefox-browser }
mobile-ios-get-automatic-privacy = Holen Sie sich automatischen Datenschutz für Ihr { -brand-name-iphone } oder { -brand-name-ipad }.
mobile-ios-get-firefox-for = Holen Sie sich { -brand-name-firefox } für { -brand-name-ios }
mobile-ios-send-a-download-link-to-your = Download-Link an Ihr Telefon senden.
mobile-ios-scan-the-qr-code-to-get-started = Scannen Sie den QR-Code und legen Sie los
mobile-ios-scan-alt-text = Scannen Sie den QR-Code, um { -brand-name-firefox } auf { -brand-name-ios } zu übertragen
mobile-ios-make-firefox-your = Machen Sie { -brand-name-firefox } zu Ihrem Standardbrowser
mobile-ios-now-iphone-and = Jetzt können Benutzer von { -brand-name-iphone } und { -brand-name-ipad } ihren eigenen Standardbrowser auswählen. Das bedeutet, dass Sie nicht { -brand-name-safari } nutzen müssen und Ihr mobiler Browser mit Ihrem bevorzugten Desktop-Browser synchronisiert bleiben kann. Wenn Sie { -brand-name-firefox } als Standardbrowser festlegen, unterstützen Sie außerdem ein unabhängiges Technologieunternehmen. { -brand-name-firefox } ist auch der einzige große Browser, der von einer gemeinnützigen Organisation unterstützt wird.
mobile-ios-fast-private-secure = Schnell. Privat. Sicher
mobile-ios-keep-whats-personal = Schützen Sie Ihre persönlichen Daten, ohne auf blitzschnelle Geschwindigkeit zu verzichten. Darüber hinaus können Sie dank intelligenter Surf-Funktionen Ihre Privatsphäre, Passwörter und Lesezeichen sicher überall hin mitnehmen, was Ihnen das Online-Leben erleichtert.
mobile-ios-stay-private-online = Schützen Sie Ihre Privatsphäre im Internet
mobile-ios-firefox-gives-you = { -brand-name-firefox } bietet Ihnen besseren Datenschutz im Internet. Standardmäßig blockiert unser verbesserter Tracking-Schutz Tracker und Skripte wie Social-Media-Tracker, seitenübergreifende Cookie-Tracker, Krypto-Miner und Fingerprinter.
