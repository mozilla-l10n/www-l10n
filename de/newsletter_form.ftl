...
multi-newsletter-form-checkboxes-error = Bitte wählen Sie mindestens eine der Newsletter-Optionen aus.
multi-newsletter-form-title = Verliebt ins Web
multi-newsletter-form-desc = Abonnieren Sie den { -brand-name-mozilla }-Newsletter und unterstützen Sie uns bei unserem Einsatz für ein offenes und freies Internet.
