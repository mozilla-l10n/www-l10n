...
manifesto-details-some-foundation = Einige Aktivitäten der Foundation - darunter aktuell die Erstellung, Veröffentlichung und Bewerbung von Verbrauer-Produkten - werden hauptsächlich von der hundertprozentigen Tochterfirma der { -brand-name-mozilla-foundation }, der { -brand-name-mozilla-corporation }, durchgeführt.
