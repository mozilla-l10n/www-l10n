...
manifesto-visualize-who-you-interact = Visualisieren Sie mit Lightbeam, mit wem Sie im Internet interagieren
manifesto-learn-about-creating-web = Erfahren Sie mehr über das gemeinsame Erstellen von Ressourcen im Internet
manifesto-host-or-join-a-maker-party = Veranstalten oder besuchen Sie eine Maker Party
