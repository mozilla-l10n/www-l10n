...
history-new-versions-of-firefox = Neue { -brand-name-firefox }-Versionen erscheinen seither regelmäßig und stellen neue Rekorde auf. Die Beliebtheit von { -brand-name-firefox } hat geholfen, den Nutzern wieder die Wahl zu lassen.
# Variables:
