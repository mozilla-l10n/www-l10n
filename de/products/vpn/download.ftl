...
# Obsolete string
vpn-download-for-windows = VPN für { -brand-name-windows } 10/11

vpn-download-for-windows-v2 = VPN für { -brand-name-windows }
vpn-download-for-windows-requirements = { -brand-name-windows } 10/11 (nur 64-Bit)
vpn-download-for-windows-long = { -brand-name-mozilla-vpn } für { -brand-name-windows } herunterladen
vpn-download-for-mac = VPN für { -brand-name-mac-short }
vpn-download-for-mac-long = { -brand-name-mozilla-vpn } für { -brand-name-mac-short } herunterladen

# Variables:
#   $version (number) - operating system version
vpn-download-version-requirements = Version { $version } und höher

vpn-download-for-linux = VPN für { -brand-name-linux }
vpn-download-for-linux-long = { -brand-name-mozilla-vpn } für { -brand-name-linux } herunterladen

# Variables:
#   $version (number) - operating system version
vpn-download-for-linux-requirements = Ubuntu { $version } und höher

vpn-download-for-android = VPN für { -brand-name-android }
vpn-download-for-android-long = { -brand-name-mozilla-vpn } für { -brand-name-android } herunterladen
vpn-download-for-ios = VPN für { -brand-name-ios }
vpn-download-for-ios-long-v2 = { -brand-name-mozilla-vpn } für { -brand-name-ios } herunterladen

# Obsolete string
vpn-download-for-ios-long = Laden Sie VPN { -brand-name-mozilla-vpn } für { -brand-name-ios } herunter
vpn-download-get-on-google-play = Im { -brand-name-google-play }-Store holen
