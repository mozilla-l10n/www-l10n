...
# Obsolete string
vpn-mobile-your-internet = Ihr Internetdienstanbieter (ISP) kann Ihre Bandbreite drosseln, wenn Sie beispielsweise Filme ansehen, Musik hören oder Inhalte streamen.
...
# Obsolete string
vpn-mobile-your-isp = Ihr ISP kann Websites oder Services blockieren, die er nicht mag oder die mit seinen eigenen Angeboten konkurrieren.
...
# Obsolete string
vpn-mobile-hackers-can-steal = Hacker können Ihre personenbezogenen Daten stehlen, wenn Sie in Cafés oder an Flughäfen öffentliche WLAN-Netzwerke nutzen.
