...
vpn-download-unable-to-download = { -brand-name-mozilla-vpn } konnte nicht heruntergeladen werden
vpn-download-not-in-country = Leider ist { -brand-name-mozilla-vpn } in Ihrem Land nicht verfügbar.
...
vpn-install-firefox-extension = 5. Installiere die { -brand-name-firefox }-Erweiterung
...
vpn-download-and-install = <a href="{ $extension }">Lade und installiere die Erweiterung,</a> um Seiten individuell auszuschließen und verschiedene Standorte für verschiedene Websites zu wählen.
...
vpn-download-faq-concealing-ip = Ihre wahre <a href="{ $ip }">IP-Adresse</a> wird verborgen: So wird Ihre Identität geschützt und Ihr Standort wird vor den von Ihnen besuchten Websites verborgen.
