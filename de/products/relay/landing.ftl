...
hero-section-title = Schützen Sie Ihre Identität mit sicheren Telefon- und E-Mail-Masken
hero-section-body =
    Unsere sicheren, einfach zu bedienenden E-Mail- und Telefonnummermasken helfen dabei, Ihre Identität zu schützen, 
...
how-it-works-section-title = Wie { -brand-name-relay } Masken für E-Mail und Telefon funktionieren

how-it-works-section-extension-headline = Verwenden Sie überall E-Mail- und Telefonnummermasken von { -brand-name-relay }
...
landing-reviews-title = Bewertungen
...
landing-reviews-out-of-5 =
    { $review_count ->
       *[other] von 5 ({ $review_count } Bewertungen)
    }
...
landing-review-user-four-review-list-4 = { -brand-name-firefox-relay } wirkt wahre Wunder, probieren Sie es aus!

## FAQ SECTION

landing-faq-headline = Die häufigsten Fragen zu { -brand-name-firefox-relay }
landing-faq-cta = Weitere FAQ zu { -brand-name-firefox-relay }
