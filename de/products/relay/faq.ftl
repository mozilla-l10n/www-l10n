...
faq-question-longevity-question = Was passiert, wenn { -brand-name-mozilla } den Dienst { -brand-name-firefox-relay } einstellt?
...
faq-question-acceptable-use-answer-measure-account = ein { -brand-name-firefox-account } mit einer verifizierten E-Mail-Adresse verlangen
