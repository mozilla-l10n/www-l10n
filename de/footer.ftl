...
footer-mozilla-blog = Der { -brand-name-mozilla } Blog
...
footer-visit-mozilla-corporations = Besuche die <a { $mofo_link }>{ -brand-name-mozilla-corporation }</a>, die Not-For-Profit Muttergesellschaft der <a { $moco_link }>{ -brand-name-mozilla-foundation }</a>.
...
footer-localize-mozilla = Lokalisiere { -brand-name-mozilla }
...
footer-websites-legal = Rechtliches
footer-language = Sprache
footer-go = Los
footer-donate = Spenden

footer-x = X
footer-x-formerly-twitter = X (früher Twitter)
