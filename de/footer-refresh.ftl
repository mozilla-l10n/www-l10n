...
footer-refresh-visit-mozilla-corporations = Besuche die <a { $moco_link }>{ -brand-name-mozilla-corporation }</a>, die Not-For-Profit Muttergesellschaft der <a { $mofo_link }>{ -brand-name-mozilla-foundation }</a>.
