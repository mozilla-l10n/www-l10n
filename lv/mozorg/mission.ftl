...
mission-were-building-a-better-internet = Mēs veidojam labāku Internetu
...
mission-at-mozilla-were-a-global-community = Mozilla ir globāla tehnologu, domātāju un būvētāju kopiena, kas kopīgi strādā, lai saglabātu interneta brīvību un pieejamību, lai cilvēki visā pasaulē varētu būt zinoši interneta radītāji un atbalstītāji.
...
mission-read-the-mozilla-manifesto-to-learn = Izlasiet <a href="{ $url }">Mozilla Manifestu</a> lai uzzināt vairāk par vērtībām un principiem kuri vada mūsu misiju.
...
mission-history = Vēsture
mission-where-we-come-from-and-how-we-got = No kurienes mēs esam un kā mēs te nokļuvām
mission-forums = Forumi
mission-topics-include-support-products = Tēmas iekļauj atbalstu, produkti, un tehnoloģijas
mission-governance = Pārvaldība
mission-our-structure-organization-and-the = Mūsu struktūra, organizācija, un plašāka Mozilla kopiena
