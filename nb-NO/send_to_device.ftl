...
send-to-device-email-placeholder = dittnavn@example.com
...
send-to-device-check-your-device-email = Sjekk om du har fått en e-post på enheten din!
send-to-device-send-to-another = Send til en annen enhet
