...
privacy-faq-we-adhere-to-no-surprises-principle = Vi følger prinsippet om «ingen overraskelser», det vil si at vi jobber hardt for å sikre at våre brukere kan forstå hvordan { -brand-name-firefox } samsvarer med virkeligheten.
...
privacy-faq-firefox-the-web-browser-that = { -brand-name-firefox }, nettleseren som kjører på enheten eller datamaskinen din, er inngangen din til nettet. Nettleseren din håndterer mye informasjon om nettstedene du besøker, men den informasjonen forblir på din enhet. { -brand-name-mozilla }, selskapet som lager { -brand-name-firefox }, samler ikke inn denne informasjonen (med mindre du ber oss om det).
