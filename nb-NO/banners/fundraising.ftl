...
# Outdated string
banner-fundraising-title = Fremtiden blir avgjort på nett. Hjelp { -brand-name-mozilla } til å kjempe for et nett for oss alle.
banner-fundraising-monthly = Hver måned
