...
manifesto-visualize-who-you-interact = Få et bilde av hvem du samhandler med på nettet, med Lightbeam
manifesto-learn-about-creating-web = Les mer om hvordan du skaper nettressurser sammen med andre
manifesto-host-or-join-a-maker-party = Vær vert for eller delta i et Maker Party
...
manifesto-details-mozilla-foundation = Stiftelsen Mozilla sin lovnad
manifesto-details-the-mozilla-foundation-pleges = Stiftelsen { -brand-name-mozilla } lover å støtte { -brand-name-mozilla }-manifestet i alle aktivitetene sine. Helt konkret vil vi:
...
manifesto-details-some-foundation = Noen aktiviteter — for tiden skaping, leveranse og markedsføring av konsumentprodukt — skjer først og fremst gjennom stiftelsen Mozilla sitt heleide datterselskap, { -brand-name-mozilla-corporation }.
manifesto-details-invitation = Invitasjon
manifesto-details-the-mozilla-foundation-invites = Stiftelsen { -brand-name-mozilla } inviterer alle som støtter grunnprinsippene i { -brand-name-mozilla }-manifestet, til å være med oss og finne nye måter å virkeliggjøre denne visjonen av Internett, slik som manifestet beskriver.
