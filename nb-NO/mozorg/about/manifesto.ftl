...
manifesto-the-internet-is-an-integral = Internett er en integrert del i det moderne livet — en hjørnesten innen for utdannelse, kommunikasjon, samarbeid, forretningsvirksomhet, underholdning og samfunnet som helhet.
manifesto-the-internet-is-a-global = Internett er en global, felles ressurs, som må forbli åpen og tilgjengelig.
manifesto-the-internet-must-enrich = Internett skal forbedre det enkelte menneskes liv.
manifesto-individuals-security-and = Sikkerhet og personvern for individet på nettet er fundamentalt, og må på ingen måte sees på som valgfritt.
manifesto-individuals-must-have = Enkeltpersoner må ha mulighet til å selv forme internett og egne opplevelser av det.
manifesto-the-effectiveness-of-the = Hvor effektive nettet er som en allmenn resurs er avhengig av kompatibilitet (protokoll, dataformat, innhold), nyskapende og en desentralisert, verdensomspennende deltagelse.
...
manifesto-we-are-committed-to-people = Vi står for et internett som involverer alle mennesker på jorden — hvor en persons demografiske egenskaper ikke bestemmer deres adgang til internettet, mulighetene og kvaliteten av opplevelsene på nettet.
...
manifesto-details-the-mozilla-project-global-v2 = { -brand-name-mozilla }-projektet er et globalt fellesskap av mennesker som tror at åpenhet, nyskaping og muligheter er nøkkelen til fremdeles god internetthelse. Vi har jobbet sammen siden 1998 for å passe på at nettet blir utviklet på en måte som er til nytte for alle. Vi er mest kjente for å ha laget nettleseren { -brand-name-mozilla } { -brand-name-firefox }.
...
manifesto-details-the-mozilla-project-community-v2 = { -brand-name-mozilla }-prosjektet bruker en fellesskapsbasert tilnærming for å lage programvare i verdensklasse med åpen kildekode og for å utvikle nye typer av felles aktiviteter. Vi bygger fellesskap av folk som er involverte i å gjøre internettopplevelsen bedre for alle.
# Obsolete string (expires 2026-09-20)
manifesto-details-the-mozilla-project-community = { -brand-name-mozilla }-prosjektet bruker en fellesskapsbasert tilnærming for å lage programvare i verdensklasse med åpen kildekode og for å utvikle nye typer av felles aktiviteter. Vi bygger fellesskap av folk som er involverte i å gjøre internettopplevelsen bedre for alle.
manifesto-details-as-a-result-of = Som et resultat av disse satsingene har vi formulert en samling grunnprinsipp som vi mener er kritiske for at nettet skal fortsette med å gagne oss alle og samtidig tilgodese de kommersielle interessene. Vi skildrer disse grunnprinsippene nedenfor.
manifesto-details-the-goals-for = Målet med manifestet er å:
manifesto-details-articulate-a-vision-v2 = formulere en visjon for internett som { -brand-name-mozilla }-deltakerne ønsker at { -brand-name-mozilla-foundation } skal streve etter;
manifesto-details-speak-to-people = snakke til mennesker uansett om de har en teknisk bakgrunn eller ei;
manifesto-details-make-mozilla-contributors = gjøre de som bidrar til { -brand-name-mozilla } stolte over hva vi gjør og motivere oss til å fortsette; samt
...
manifesto-details-build-and-deliver = bygge og leverer utmerkede konsumentprodukt som støtter grunnprinsippene i manifestet;
...
manifesto-across-the-mozilla-project = På tvers av { -brand-name-mozilla }-prosjektet og alle organisasjonene i { -brand-name-mozilla }-familien forplikter vi oss til å støtte { -brand-name-mozilla }-manifestet i vårt arbeid. Konkret vil vi:
manifesto-we-need-you = Vi trenger deg for å fremme manifestet
manifesto-an-internet-with-these-v2 = Et internett med disse egenskapene vil ikke oppstå av seg selv. Mennesker og organisasjoner må bygge disse ambisjonene inn i internett-teknologien og i hvordan mennesker opplever internett. { -brand-name-mozilla }-manifestet og tillegget representerer { -brand-name-mozilla } sin forpliktelse til å fremme disse ambisjonene. { -brand-name-mozilla } samarbeider med mennesker og organisasjoner over hele verden som ønsker å gjøre internett til et enda bedre sted for alle.
