...
compare-brave-compare-brave-to-the-firefox = Sammenlign { -brand-name-brave } med { -brand-name-firefox-browser } for å finne ut hvilken som er den beste nettleseren for deg når det gjelder personvern, verktøy og portabilitet.
# Main title
