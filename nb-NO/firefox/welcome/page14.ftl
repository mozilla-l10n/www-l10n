...
welcome-page14-very-fast = Den er rask, veldig rask
welcome-page14-wireguard-powered = Vår { -brand-name-wireguard }®-drevne servere er bygget for hastighet, slik at du kan strømme, laste ned og spille som vanlig.
welcome-page14-without-trace = Internett uten spor
welcome-page14-never-log = Vi verken loggfører, sporer eller deler dine nettverksdata — din nettaktivitet vil ikke etterlate spor på våre VPN-servere.
welcome-page14-why-see-this = Hvorfor ser jeg dette?
