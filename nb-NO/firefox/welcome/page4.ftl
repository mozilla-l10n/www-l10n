...
# HTML page title
welcome-page4-download-the-firefox-browser = Last ned Firefox-nettleseren på din mobil for { -brand-name-ios } og { -brand-name-android }
...
welcome-page4-firefox-private-safe-browser = «{ -brand-name-firefox }: Privat, sikker nettleser» på { -brand-name-ios } eller { -brand-name-android }.
# "off your trail" is an expression for not being followed around.
welcome-page4-get-data-trackers-off-your = Få bort datasporere
# Variables:
...
welcome-page4-enhanced-tracking-protection = Utvidet sporingsbeskyttelse <a href="{ $privacy }">hindrer 2000+ sporere</a> fra å følge deg rundt på nettet.
