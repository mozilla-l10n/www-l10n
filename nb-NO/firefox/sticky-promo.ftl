...
firefox-sticky-promo-meet-our-family-of = Møt vår familie av produkter
firefox-sticky-promo-meet-mozillas-family = Møt produktfamilien til { -brand-name-mozilla }
firefox-sticky-promo-get-the-latest-firefox = Få den nyeste { -brand-name-firefox }-nettleseren.
# Products List
firefox-sticky-promo-browsers = Nettlesere
