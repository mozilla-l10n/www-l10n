...
# Sub navigation link
firefox-privacy-our-promise = Vårt løfte
# Sub navigation link
firefox-privacy-our-products = Våre produkter
firefox-privacy-hub-you-should-be-able-to-decide = Du skal kunne bestemme hvem som ser din personlige informasjon. Ikke bare blant vennene dine, men med alle annonsører og firma på nettet — inkludert oss.
...
firefox-privacy-hub-all-tech-companies-collect = Alle teknologiselskaper samler inn data for å forbedre produktene sine. Men det trenger ikke å inkludere så mye av den personlige informasjon din. De eneste dataene vi ønsker er de dataene som tjener deg til slutt. Vi spør oss selv: trenger vi egentlig dette? Hva trenger vi det til? Og når kan vi slette den?
...
firefox-privacy-hub-data-security-is-complicated = Datasikkerhet er komplisert — eller i det minste skal det være. Derfor tar vi de ekstra trinnene for å klassifisere dataene vi har, opprettholder regler for hvordan vi lagrer og beskytter hver type data, og aldri slutter å iterere på prosessene våre. Vi prioriterer personvernet ditt. Vi investerer i det. Vi er opptatt av det. Vi lærer selv andre selskaper hvordan de skal gjør det.
...
firefox-privacy-hub-because-we-put-people-first = Fordi vi setter mennesker først. Faktisk er vi støttet av en <a href="{ $foundation }">ideel organisasjon</a>. Fra første dag har det vært vårt oppdrag å beskytte nettet og alle som bruker det.
...
firefox-privacy-hub-if-you-want-to-see-what = Hvis du vil se hva { -brand-name-firefox } blokkerer for deg, kan du gå til denne siden i din { -brand-name-firefox }-nettleser for datamaskiner.
firefox-privacy-hub-see-what-firefox-has-blocked = Se hva { -brand-name-firefox } har blokkert for deg
# "Enhanced Tracking Protection" is a feature name; it should be capitalized
...
firefox-privacy-hub-meet-four-of-the-most-common = Dette er de fire vanligste kategorieane av sporere som ikke lenger sporer deg
