...
firefox-enterprise-with-install-packages-and = Med installasjonspakker og en omfattende samling av gruppepolicyer og funksjoner, er distribusjon raskere og mer fleksibel enn noen gang — både i { -brand-name-windows }- og { -brand-name-mac }-miljøer.
