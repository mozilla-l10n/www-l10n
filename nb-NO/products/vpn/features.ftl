...
vpn-features-were-backed-by-mofo-v2 = Vi støttes av <a { $mofo }>{ -brand-name-mozilla-foundation }</a>, en ideell organisasjon som kjemper for å holde nettet åpent og sunt for alle.
