...
vpn-features-simply-put-we-dont = Enkelt sagt samler vi ikke inn din personlige nettleserinformasjon. Her er vår <a { $privacy }>lettleselige personvernerklæring</a>.
