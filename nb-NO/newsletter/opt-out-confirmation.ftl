...
# HTML page title
opt-out-confirmation-cool-we-hear = Helt fint. Vi vet.
# Field of a form
opt-out-confirmation-your-email = Din e-postadresse:
# Only localize "yourname". Do not touch @example.com.
opt-out-confirmation-yournameexamplecom = dittnavn@example.com
# This is a button
opt-out-confirmation-manage-preferences = Behandle innstillinger
# Link to https://blog.mozilla.org/
opt-out-confirmation-check-out-our = Sjekk ut bloggene våre
