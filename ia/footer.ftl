...
footer-visit-mozilla-corporations = Visita le organisation non-lucrative matre <a { $moco_link }>de { -brand-name-mozilla-corporation }</a>, le <a { $mofo_link }>Fundation Mozilla</a>.
...
footer-product-help = Guida producto
