...
privacy-index-if-you-want-to-make-a-correction = Si tu desira apportar un correction a tu informationes, o si tu ha questiones sur nostre politicas de confidentialitate, per favor contacta:
# Variables:
...
privacy-index-for-product-support-requests = Pro requestas de supporto del producto <a href="{ $sumo }">visita nostre foros</a>.
privacy-index-data-privacy-principles = Principios de confidentialitate del datos
# Variables:
...
privacy-index-to-review-and-comment-on-proposed = Pro revider e commentar sur cambiamentos proponite a nostre politica de confidentialitate, <a href="{ $group }"> subscribe te al gruppo de governamento de { -brand-name-mozilla }</a>.
# Variables:
...
privacy-index-mozilla-subscription-services = Servicios de abonamento de { -brand-name-mozilla }
