...
privacy-faq-firefox-the-web-browser-that-v2 = { -brand-name-firefox }, le navigator del web que functiona sur tu apparato o computator, es tu porta de accesso a Internet. Tu navigator gere un quantitate de informationes sur le sitos web que tu visita, ma iste informationes generalmente resta private sur tu apparato. { -brand-name-mozilla }, le compania que produce { -brand-name-firefox }, non los collige (a minus que tu lo demanda a nos).
