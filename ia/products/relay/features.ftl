...
highlighted-features-section-bottom-title = Protege tu identitate (e tu cassa de entrata) con { -brand-name-firefox-relay }
...
highlighted-features-section-unlimited-masks-body-v2 =
    { $mask_limit ->
        [one] Omnes recipe { $mask_limit } masca de e-mail gratuite. Ma con { -brand-name-relay-premium }, tu pote generar tante mascas como tu vole pro adjutar te a proteger tu cassa de entrata de e-mail contra spammatores, piratas informatic, e traciatores online.
       *[other] Omnes recipe { $mask_limit } mascas de e-mail gratuite. Ma con { -brand-name-relay-premium }, tu pote generar tante mascas como tu vole pro adjutar te a proteger tu cassa de entrata de e-mail contra spammatores, piratas informatic, e traciatores online.
    }
...
highlighted-features-section-block-promotions-body = Con { -brand-name-relay-premium }, tu pote impedir que le e-mail promotional attinge tu cassa de entrata durante que tu continua a reciper messages como quitantias o informationes de expedition.
