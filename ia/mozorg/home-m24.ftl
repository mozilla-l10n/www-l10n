...
# HTML Page title
m24-home-page-title = Internet pro le personas, non pro profito: { -brand-name-mozilla }
m24-home-page-title-v2 = { -brand-name-mozilla }, internet pro le personas, non pro profito
# HTML page description
m24-home-page-desc = Sape tu? { -brand-name-mozilla } — le fabricante de { -brand-name-firefox } — lucta pro mantener Internet un global public ressource, aperte e accessibile a omnes.
m24-home-page-desc-v2 = Nos labora pro re-poner le controlo de internet in le manos del personas qui lo usa.
...
m24-home-create-your-website = Crea tu sito web e connecte lo a tu dominio personal gratuitemente.
