...
manifesto-the-internet-is-an-integral = Le internet es un parte integrante del vita moderne — un componente clave in le education, communication, collaboration, negotios, intertenimento e societate como un toto.
manifesto-the-internet-is-a-global = Internet es un public ressource global, que debe restar aperte e accessibile.
manifesto-the-internet-must-enrich = Internet debe inricchir le vitas de tote le individuos human.
manifesto-individuals-security-and = Le securitate e le confidentialitate del individuos sur internet es fundamental e non debe ser tractate como optional.
manifesto-individuals-must-have = Le individuos debe haber le capacitate de formar internet e lor proprie experientias sur illo.
manifesto-the-effectiveness-of-the = Le efficacia de Internet como public ressource depende del interoperabilitate (protocollos, formatos de datos, contento), innovation e participation decentralisate per tote le mundo.
...
manifesto-transparent-community = Processos transparente e basate-sur-communitate promove participation, responsabilitate e carga.
...
manifesto-we-are-committed-to-people = Nos es ingagiate pro un internet que include tote le personas del terra — ubi le characteristicas demographic de un persona non determina su accesso, opportunitates, o qualitate de experientia online.
...
manifesto-get-the-mozilla-newsletter = Recipe le littera de novas de { -brand-name-mozilla } e adjuta nos a lo mantener aperte e libere.
