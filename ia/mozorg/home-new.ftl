...
home-mitchell-baker-v2 = Mitchell Baker, Presidente executive del Consilio, { -brand-name-mozilla-foundation }
...
home-at-its-core-v2 = Fundamentalmente, { -brand-name-mozilla } es un organisation activistic ducite per { -brand-name-mozilla-foundation } que produce cambiamentos in le mundo per un varietate de interprisas riscose includite { -brand-name-mozilla-corporation }, MZLA, <a { $ventures }>{ -brand-name-mozilla-ventures }</a> e <a { $mozai }>{ -brand-name-mozilla-ai-v2 }</a>. Como es nos differente? Perque nos es ducite per mission, significa que nos ha le libertate de facer tote nostre decisiones basate sur lo que es optime pro internet e pro totes online, non basate super le exigentias de actioneros, nos vermente non ha alco de illos.
