...
firefox-developer-visual-editing = Edition visual
firefox-developer-fine-tuning-animations = Optimisa le animationes, le alineamento e le margines.
firefox-developer-learn-more-about-visual-editing = Saper plus super le edition visual
...
firefox-developer-the-new-firefox-devtools = Le nove DevTools de Firefox es utensiles de disveloppamento potente, flexibile e super toto servicial. I.A. le melior depurator de JavaScript, producite per le bibliothecas React e Redux, illo pote gerer plure navigatores al mesme tempore.
...
firefox-developer-welcome-to-the-all-new = Benvenite al novissime { -brand-name-firefox-quantum }: edition disveloppator
...
firefox-developer-congrats-you-now-have-firefox = Felicitationes. Ora tu ha { -brand-name-firefox-quantum }: edition pro le disveloppator.
