...
# Obsolete string
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words, please omit the strong tags if they need to be around multiple words in your language
firefox-products-firefox-beginning-emphasis = { -brand-name-firefox } es solo le <strong>initio</strong>
...
firefox-products-learn-more-about-pocket = Saper plus sur { -brand-name-pocket }
firefox-products-join-firefox-and-get-the-most = Junge te a { -brand-name-firefox } e tira le maximo de cata producto – sur cata apparato.
# Variables:
