...
compare-edge-switching-to-firefox-is-easy = Passar a { -brand-name-firefox } es facile e veloce, importa tu marcapaginas, tu contrasignos, chronologia e preferentias de Edge con un clic e immediatemente tu es preste a usar { -brand-name-firefox }. Ecce <a { $howto }>in qual maniera usar le button Importar pro passar</a>.
