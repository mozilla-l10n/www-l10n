...
compare-brave-switching-to-firefox-is-easy = Passar a { -brand-name-firefox } es facile e veloce, importa tu marcapaginas, tu contrasignos, chronologia e preferentias de Brave con un clic e immediatemente tu es preste a usar { -brand-name-firefox }. Ecce <a { $howto }>como importar tu datos de Brave</a>.
