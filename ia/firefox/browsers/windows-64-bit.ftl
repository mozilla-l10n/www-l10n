...
windows-64-bit-if-you-see-32-bit-older = Si tu vide “(32-bit)” e le version de { -brand-name-firefox } es 56.0 o plus ancian, actualisar al ultime version de { -brand-name-firefox } deberea cambiar te automaticamente a 64-bit.
