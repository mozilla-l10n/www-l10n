...
be-bold-and = Sia hardite e coragiose quando elige qual navigator es justo pro te.
comparing-firefox-edge = Comparation inter { -brand-name-firefox-browser } e { -brand-name-microsoft } { -brand-name-edge }
youll-never-guess = Tu non divinara jammais qual navigator ha le avantage quanto a velocitate e functionalitates.
...
be-free-to = Sia libere de cantar le laudes de { -brand-name-firefox } quandocunque que tu desira.
