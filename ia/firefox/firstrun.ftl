...
firstrun-sign-in-to-your-account = Accede a tu conto e tu synchronisa tu marcapaginas, contrasignos e altere grande cosas tu salvava per { -brand-name-firefox } sur altere apparatos.
firstrun-already-have-an-account = Ha tu ja un conto?
firstrun-sign-in = Aperir session
