...
firefox-enterprise-firefox-browser = Navigator { -brand-name-firefox }
firefox-enterprise-firefox-browser-msi-installer = Browser { -brand-name-firefox } - programma de installation MSI
