...
firefox-sticky-promo-meet-our-family-of = Incontra nostre familia de productos
firefox-sticky-promo-meet-mozillas-family = Discoperi le familia de productos de { -brand-name-mozilla }
firefox-sticky-promo-get-the-latest-firefox = Installa le ultime Navigator { -brand-name-firefox }.
# Products List
firefox-sticky-promo-browsers = Navigatores
