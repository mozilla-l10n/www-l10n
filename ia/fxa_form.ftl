...
fxa-form-enter-your-email = <strong>Insere tu email</strong> pro acceder le { -brand-name-firefox-accounts }.
# Variables:
...
fxa-form-create-account = Crea un conto
fxa-form-get-the-app = Discarga le app
