...
firefox-accounts-take-your-stand-against = Bezit a-enep ur greanterezh a sell ouzhoc'h evel ouzh ur produ.
...
firefox-accounts-youre-signed-in-to = Kennasket hoc'h <br>ouzh { -brand-name-firefox }. <br><span>Bremañ, klaskit { -brand-name-firefox-monitor }.</span>
firefox-accounts-see-if-youve-been = Sellit hag-eñ hoc'h bet tizhet gant ur fuadur roadennoù enlinenn.
firefox-accounts-sign-in-to-monitor = Kennaskañ ouzh { -brand-name-monitor }
firefox-accounts-join-firefox = Tremen da { -brand-name-firefox }
...
firefox-accounts-help-us-build-a-better = Sikourit ac'hanomp a-benn sevel ur { -brand-name-firefox } gwelloc'h evit an holl.
