...
comparing-firefox-ie = Keñveriañ { -brand-name-firefox-browser } gant { -brand-name-microsoft } { -brand-name-ie }
comparing-firefox-safari = Keñveriañ { -brand-name-firefox-browser } gant { -brand-name-apple } { -brand-name-safari }
comparing-firefox-opera = Keñveriañ { -brand-name-firefox-browser } gant { -brand-name-opera }
