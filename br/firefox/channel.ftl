...
firefox-channel-download-and-test-the-latest-desktop = Pellgargit hag amprouit ar c'heweriusterioù diwezhañ war { -brand-name-firefox } war urzhiataer gant an { -brand-name-developer-edition } hag an handelvoù { -brand-name-nightly }.
