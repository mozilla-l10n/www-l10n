...
# HTML description
features-fast-our-new-powerful-multi-process = A nova e potente plataforma multiproceso xestiona todas as lapelas sen reducir a velocidade do computador.
...
features-fast-no-one-likes-a-computer-hog = A ninguén lle gusta un programa que engula todos os recursos do computador. O { -brand-name-firefox } é un navegador que consome o xusto e necesario. Como consome menos memoria RAM que o { -brand-name-chrome }, o resto de programas seguirán a funcionar a máxima velocidade.
...
features-fast-level-up-browser-gameplay = Os xogos, a outro nivel
# Native speed refers to operating speed for games written for platforms such as macOS or Windows.
features-fast-we-led-the-tech-to-run-3d-games = Lideramos a tecnoloxía que permite executar xogos 3D a velocidades cases nativas e agora o { -brand-name-firefox } ofrece un mellor rendemento para xogar en liña. Este potente navegador reduce os tempos de espera, mellora os tempos de resposta e optimiza a forma de xogar cunha navegación máis rápida e áxil.
