...
firefox-accounts-take-your-stand-stay-smart = Enfróntese á industria que está a vender os seus datos a terceiros. Sexa intelixente e estea seguro na rede coa tecnoloxía que loita por vostede.
# Old HTML page description
firefox-accounts-securely-sync-your = Sincronice de xeito seguro os seus contrasinais, marcadores e lapelas en todos os seus dispositivos. Obteña unha { -brand-name-firefox-account } agora – un inicio de sesión – poder e privacidade en todas partes.
