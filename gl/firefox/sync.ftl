...
firefox-sync-access-and-sync = Accede e sincroniza os teus marcadores, contrasinais, lapelas abertas e moito máis; esteas onde estiveres usando o { -brand-name-firefox }
firefox-sync-sync-your-firefox = Sincroniza o teu { -brand-name-firefox } en calquera dispositivo
firefox-sync-privacy-made-easy = Privacidade simplificada
firefox-sync-all-you-need = Todo o que precisas para o { -brand-name-firefox-sync } é unha { -brand-name-firefox-account }
firefox-sync-encrypt-your-data = Cifra os teus datos
firefox-sync-your-encryption-key = A túa clave de cifraxe seguirá sendo un segredo, só coñecida por ti e nos teus dispositivos autorizados.
firefox-sync-feel-safe = Síntete seguro
