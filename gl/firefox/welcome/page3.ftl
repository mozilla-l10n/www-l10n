...
welcome-page3-never-forget-reset-or-travel = Nunca máis volva a esquecer, restablecer ou viaxar sen os contrasinais.
welcome-page3-facebook-container = { -brand-name-facebook-container }
welcome-page3-get-a-container-to-keep-facebook = Consiga un contedor para que { -brand-name-facebook } non meta os fociños nos seus asuntos.
