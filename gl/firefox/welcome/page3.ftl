...
welcome-page3-have-at-least-one-company = Teña polo menos unha empresa que busque os seus datos e non que os filtre.
welcome-page3-firefox-lockwise = { -brand-name-firefox-lockwise }
welcome-page3-never-forget-reset-or-travel = Nunca máis esqueza, restableza ou viaxe sen os contrasinais.
