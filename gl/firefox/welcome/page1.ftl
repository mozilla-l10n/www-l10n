...
# HTML page title
welcome-page1-more-than-a-browser-firefox = Máis do que un navegador, { -brand-name-firefox-monitor } é a súa arma contra os piratas informáticos
...
welcome-page1-find-ways-to-protect-your = Atope formas de protexer a súa información cos <a href="{ $security_tips }"> { -brand-name-monitor } Consellos de seguridade </a>.
...
welcome-page1-were-you-one-of-many = Foi un dos 100.985.047 convidados á <a href="{ $evite_breach }">"festa" para evitar a violación de datos </a>?
