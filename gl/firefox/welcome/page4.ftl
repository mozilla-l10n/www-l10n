...
# HTML page title
welcome-page4-download-the-firefox-browser = Descargue o { -brand-name-firefox-browser } no seu teléfono { -brand-name-ios } ou { -brand-name-android }
welcome-page4-wallet-keys-phone-firefox = Carteira. Claves. Teléfono. <strong> { -brand-name-firefox }. </strong>
welcome-page4-privacy-every-screen-now = Xa pode ter privacidade en calquera pantalla
welcome-page4-take-privacy-with-you-on-every = Leve a súa privacidade en todos os seus dispositivos e esquézase dos rastreadores de datos.
welcome-page4-privacy-on-by-default = A súa privacidade sempre activada por defecto co novo { -brand-name-firefox } para { -brand-name-android }; e agora pode facer do { -brand-name-firefox } o seu navegador predeterminado en { -brand-name-ios } 14.
welcome-page4-get-the-firefox-mobile = Obter { -brand-name-firefox } para dispositivos móbiles
welcome-page4-get-firefox-on-your-phone = Obter { -brand-name-firefox } para o seu teléfono
welcome-page4-send-the-download-link-right = Enviar a ligazón de descarga directamente ó meu teléfono ou correo electrónico.
welcome-page4-download-firefox-for-your = Descargar { -brand-name-firefox } para o seu teléfono intelixente e tableta.
