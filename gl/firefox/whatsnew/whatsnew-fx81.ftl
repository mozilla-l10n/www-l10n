...
# html page title
whatsnew81-page-title = Que novidades ten o { -brand-name-firefox }
# Main title
whatsnew81-main-title = Un novo { -brand-name-firefox } para todos os dispositivos
whatsnew81-main-intro = Sexa cal sexa o seu sistema operativo, agora pode instalar nel un navegador móbil sen ánimo de lucro e mellor que o resto.
...
whatsnew81-attention-iphone-people = Atención, usuarios de { -brand-name-iphone }: por fin poderán configurar { -brand-name-firefox } coma o seu navegador predeterminado en { -brand-name-ios } 14. Un navegador cumpridor ó que sempre poder acudir.
