...
firefox-is-independent = O { -brand-name-firefox } é independente e está respaldado por { -brand-name-mozilla }, unha marca sen fins lucrativos que loita polos teus dereitos na Internet de intenta facela accesíbel a todos e a todas, desde calquera lugar.
what-is-a = Que é un navegador web?
a-web-browser = Os navegadores web lévanche a calquera lugar da Internet, xa for ver un texto, unha imaxe ou un vídeo desde calquera lugar do planeta.
