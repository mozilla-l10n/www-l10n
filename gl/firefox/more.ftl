...
firefox-is-independent = O { -brand-name-firefox } é independente e está respaldado por { -brand-name-mozilla }, unha marca sen fins lucrativos que loita polos teus dereitos na Internet e intenta facela accesíbel a todos e a todas, desde calquera lugar.
...
choose-which-firefox = Escolle o navegador Firefox que descargar na túa lingua
...
firefox-more-little-book = O libriño da privacidade
firefox-more-you-can-reclaim = Podes reclamar a túa privacidade e voltar a ter o control sobre a túa experiencia na Internet! É sorprendentemente sinxelo. Todo o mundo pode facelo.
firefox-more-firefox-sync = { -brand-name-firefox-sync }
firefox-more-access-your-sync = Accede e sincroniza os teus marcadores, contrasinais, xanelas abertas... esteas onde estiveres usando o { -brand-name-firefox }.
we-believe-everyone = Cremos que todo o mundo debería ter acceso á Internet. Por iso tornamos dispoñíbel o navegador Firefox en máis de 90 linguas coa axuda de voluntarios de todo o mundo. Tamén en galego!
...
seven-of-the = Comparación directa de sete dos mellores navegadores
we-compare-firefox = Comparamos o { -brand-name-firefox } co { -brand-name-chrome }, co { -brand-name-edge }, co { -brand-name-safari }, co { -brand-name-opera }, co { -brand-name-brave } e co { -brand-name-ie } para axudarche a decidir.
comparing-firefox-chrome = Comparación do { -brand-name-firefox-browser } co { -brand-name-google } { -brand-name-chrome }
big-isnt-always = Ser grande non sempre significa ser mellor. Escolle, pola contra, independencia.
comparing-firefox-brave = Comparación do { -brand-name-firefox-browser } co { -brand-name-brave }
be-bold-and = Sé ousado e afouto cando escolleres que navegador é o que máis se che axusta.
comparing-firefox-edge = Comparación do { -brand-name-firefox-browser } co { -brand-name-microsoft } { -brand-name-edge }
youll-never-guess = A que non sabes que navegador remonta as ondas máis rápido e con máis funcionalidades?
comparing-firefox-ie = Comparación do { -brand-name-firefox-browser } co { -brand-name-microsoft } { -brand-name-ie }
old-habits-that = É difícil se librar de vellos hábitos, mais o certo é que te sintes ben cando o consegues.
comparing-firefox-safari = Comparación do { -brand-name-firefox-browser } co { -brand-name-apple } { -brand-name-safari }
you-dont-have = Quen di que teñas que usar o navegador que xa vén instalado?
comparing-firefox-opera = Comparación do { -brand-name-firefox-browser } co { -brand-name-opera }
be-free-to = Síntete libre de eloxiar o { -brand-name-firefox } sempre que quixeres.
the-ad-blocker = O bloqueador de publicidade: unha arma secreta contra os anuncios molestos.
