...
firefox-home-firefox-protect-your = { -brand-name-firefox }: protexa a vida en liña con produtos que se centran na privacidade
...
firefox-home-every-single-firefox = Todos os produtos de { -brand-name-firefox } respectan a nosa Promesa de datos persoais: <strong>recoller menos datos, mantelos a salvo e sen segredos.</strong>
