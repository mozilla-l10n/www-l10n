...
firefox-channel-test-beta-versions-of-firefox-ios-long = Probe as versións beta de { -brand-name-firefox } para { -brand-name-ios } a través do programa { -brand-name-test-flight } de { -brand-name-apple } e axúdenos a mellorar o noso navegador móbil para { -brand-name-iphone }, { -brand-name-ipad } e iPod touch.
firefox-channel-test-flight = { -brand-name-test-flight }
firefox-channel-test-beta-versions-of-firefox-ios = Probe as versións beta de { -brand-name-firefox } para { -brand-name-ios } a través do programa { -brand-name-test-flight } de { -brand-name-apple }.
firefox-channel-sign-up-now = Subscríbase agora
