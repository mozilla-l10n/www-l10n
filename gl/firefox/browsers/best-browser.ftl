...
best-browser-marshall-erwin-senior = Marshall Erwin, Director Senior de Confianza e Seguridade en { -brand-name-mozilla }
best-browser-if-youre-wondering = Se te andas a preguntar que significa ter un navegador privado ou rápido, velaquí tes un desglose de tres cousas que debería ter un navegador:
...
best-browser-last-but-not-least = Por último, aínda que non por iso menos importante: un navegador seguro debería ofrecer ferramentas para axudarche a controlar as túas contas. Pensa nas alertas que van directamente ao teu correo electrónico se violan algunha das túas contas, ou nas iconas que che indican se un sitio web está cifrado (é dicir, se é unha boa idea introducir o número da túa tarxeta crédito nun sitio de compras).
# Variables:
