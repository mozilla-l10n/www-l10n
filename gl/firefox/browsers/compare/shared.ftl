...
compare-shared-blocks-third-party-tracking-default = Bloqueo dos rastros de seguimento de terceiros por defecto
# Obsolete string
compare-shared-blocks-third-party-tracking = Bloqueo dos rastros de seguimento de terceiros
...
compare-shared-automatically-fills-out-forms = Cobre automaticamente os formularios
...
compare-shared-os-availability = Dispoñibilidade para sistemas operativos
compare-shared-mobile-os-availability = Dispoñibilidade para sistemas operativos móbiles
compare-shared-syncs-with-mobile = Sincronización con móbiles
compare-shared-password-management = Xestor de contrasinais
compare-shared-primary-password = Contrasinal principal
# Obsolete string
...
compare-shared-security-and-privacy-strong = Seguridade e <strong>privacidade</strong>
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. If the translation include multiple words, please choose a word to emphasize and wrap that word in the strong tag.
...
compare-shared-download-firefox = Descargar o { -brand-name-firefox }
compare-shared-download-firefox-browser = Descargar o navegador Firefox
