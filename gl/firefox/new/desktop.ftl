...
firefox-desktop-download-meta-title = Descargue { -brand-name-firefox-browser } — Rápido, privado e libre — de { -brand-name-mozilla }
...
firefox-desktop-download-make-firefox-your = Personalice <strong>{ -brand-name-firefox }</strong>
...
firefox-desktop-download-go-from-light = Pase do modo claro ao modo escuro dependendo do estado de ánimo ou das preferencias ou quizias prefira animarse cun tema personalizado con, por exemplo, unicornios de cores.
firefox-desktop-download-tweak-your-settings = Axuste a configuración
...
firefox-desktop-download-from-watching-a = Dende ver un titorial ata botarlle un ollada a un partido, o vídeo continúa mentras fai varias tarefas á vez.
...
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words, please omit the strong tags if they need to be around multiple words in your language
firefox-desktop-download-now-else = Agora remate a <strong>instalación</strong> de { -brand-name-firefox }.
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words, please omit the strong tags if they need to be around multiple words in your language
firefox-desktop-download-now-windows = <strong>Execute</strong> o instalador que acaba de descargar.
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words, please omit the strong tags if they need to be around multiple words in your language
firefox-desktop-download-now-mac = <strong>Abra</strong> o ficheiro que acaba de descargar.
# Variables:
...
# Variables:
#   $url (url) - link to https://support.mozilla.org/kb/end-support-windows-xp-and-vista
firefox-desktop-download-youre-using-an-insecure-outdated = Está empregando un sistema operativo inseguro e desactualizado <a href=" { $url }">que xa non é compatible con { -brand-name-firefox } </a>.
# Variables:
...
firefox-desktop-download-your-system-may-not = Quizais o seu sistema non cumpra cos requisitos de { -brand-name-firefox }, pero pode probar unha <a href="{ $url }">destas versións</a>.
