...
new-platform-the-best-firefox-ever = O mellor { -brand-name-firefox } nunca visto
new-platform-lightweight = Lixeiro
new-platform-uses-30-less-memory = Consume un 30% menos de memoria que o { -brand-name-chrome }
new-platform-powerfully-private = Privacidade absoluta
new-platform-truly-private-browsing = Navegación totalmente privada con protección contra o rastrexo
