...
firstrun-welcome-to-firefox = Benvida ao { -brand-name-firefox }
firstrun-take-firefox-with-you = Leve o { -brand-name-firefox } consigo
...
firstrun-sign-in = Inicie sesión
