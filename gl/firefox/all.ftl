...
firefox-all-windows-installers-for = Instaladores de Windows para departamentos informáticos empresariais; simplifican a configuración, distribución e xestión do navegador { -brand-name-firefox }.
