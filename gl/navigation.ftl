...
navigation-take-the-passwords-youve = Vaias a onde vaias, leva sempre os contrasinais gardados no { -brand-name-firefox }.
# Outdated string
navigation-firefox-is-a-whole-family = { -brand-name-firefox } é toda unha familia de produtos deseñada para navegares pola rede de forma máis segura e intelixente.
navigation-join-firefox = Unirse ao { -brand-name-firefox }
navigation-access-all-of-firefox = Accede a todos os produtos do { -brand-name-firefox } cun único inicio de sesión e poderás aproveitalos ao máximo.
navigation-meet-the-firefox-family = Coñece a familia { -brand-name-firefox }
navigation-firefox-blog = Blog do { -brand-name-firefox }
navigation-read-about-new-firefox = Descubre as novas características do { -brand-name-firefox } e recibe consellos para navegares pola rede cunha maior seguridade.
navigation-the-non-profit-behind = A fundación sen fins lucrativos que está detrás do { -brand-name-firefox } loita por unha Internet saudábel para todo o mundo.
navigation-learn-how-firefox-treats = Obtén información sobre como o { -brand-name-firefox } respecta os datos.
navigation-mozilla-careers = Oportunidades de emprego en { -brand-name-mozilla }
navigation-approach-your-career = Ten un propósito claro na túa carreira profesional. Atopa traballos que pagan a pena en { -brand-name-mozilla }.
navigation-close-firefox-menu = Pechar o menú do { -brand-name-firefox }
navigation-get-the-browser-that-gives = O navegador que che dá un maior control en { -brand-name-windows }, { -brand-name-mac } ou { -brand-name-linux }.
navigation-take-firefox-and-firefox = Leva sempre contigo o { -brand-name-firefox } e o { -brand-name-firefox-focus }. Para { -brand-name-android } e { -brand-name-ios }.
...
navigation-check-out-the-benefits = Bótalle unha ollada aos beneficios
...
navigation-support = Asistencia
navigation-privacy = Privacidade
navigation-get-unmatched-data-protection = Consigue unha protección de datos inigualable coa frecuencia de actualizacións que máis lle conveña á túa organización.
navigation-made-with-respect = Feito con respecto
navigation-close-products-menu = Pechar o menú Produtos
navigation-see-if-your-personal = Comproba se se filtraron os teus datos persoais en liña e rexístrate para recibir futuras alertas de violacións.
navigation-check-for-breaches = Comprobar se hai violacións
navigation-see-breaches = Ver as violacións
navigation-security-tips = Consellos de seguridade
navigation-share-large-files-safely = Comparte ficheiros grandes de forma segura con ligazóns que se autodestrúen.
...
navigation-protect-your-life-online = Protexe a túa vida na rede grazas a unha familia de produtos que se centran na privacidade.
...
navigation-donate-your-voice-to = Doa a túa voz para que o recoñecemento de voz estea aberto para todos.
...
navigation-resources-for-developers = Recursos feitos por e para programadores.
navigation-developer-blog = Blog de programadores
navigation-build-test-scale-and = Deseña, proba, dimensiona e moito máis co único navegador deseñado especificamente para programadores.
navigation-leadership = Liderado
...
navigation-work-for-a-mission-driven = Traballa para unha organización que busca cumprir unha misión e que crea produtos que buscan cumprir un propósito.
navigation-get-involved = Involúcrate
navigation-join-the-fight-for-a = Únete á loita por unha Internet saudábel.
navigation-events = Eventos
navigation-donate = Doazóns
navigation-your-right-to-security = O dereito á seguridade e privacidade na rede é imprescindíbel, nunca opcional.
