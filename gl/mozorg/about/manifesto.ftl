...
manifesto-host-or-join-a-maker-party = Celebre ou únase a unha Maker Party
...
manifesto-details-the-internet-must = A Internet debe enriquecer a vida dos seres humanos como individuos.
manifesto-details-individuals-security = A seguranza e a privacidade dos individuos na Internet son fundamentais e non se deben tratar como opcionais.
manifesto-details-individuals-must = Os individuos deben ter a posibilidade de moldear a Internet e a súa propia experiencia na rede.
manifesto-details-the-effectiveness = A efectividade da Internet como un recurso público depende da interoperabilidade (protocolos, formato de datos e contido), a innovación e a participación descentralizada mundialmente.
manifesto-details-free-and-open = O software libre e aberto promoven o desenvolvemento da Internet como un ben público.
manifesto-details-transparent-community = Os procesos transparentes e baseados en comunidades promoven a participación, a responsabilidade e a confianza.
manifesto-details-commercial-involvement = A participación comercial no desenvolvemento da Internet trae moitos beneficios; é fundamental estabelecer un equilibrio entre o beneficio comercial e o público.
