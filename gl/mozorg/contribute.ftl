...
contribute-how-heading = Como colaborar:
...
contribute-task-translate-desc = A Internet só é global se se entende en todas partes. Axúdanos a traducir produtos e sitios web de { -brand-name-mozilla } á túa lingua.
