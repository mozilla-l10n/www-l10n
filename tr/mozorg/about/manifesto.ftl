...
manifesto-visualize-who-you-interact = Lightbeam sayesinde web ile nasıl etkileşim kurduğunuzu görselleştirin
manifesto-learn-about-creating-web = Başkalarıyla birlikte web kaynakları yaratmayı öğrenin
manifesto-host-or-join-a-maker-party = Maker Partisi düzenleyin veya bir partiye katılın
...
manifesto-details-articulate-a-vision = { -brand-name-mozilla }’ya katkıda bulunanların, { -brand-name-mozilla } Vakfı’nın sürdürmesini istediği bir internet vizyonu oluşturmak,
...
manifesto-details-mozilla-foundation = Mozilla Vakfı’nın Andı
manifesto-details-the-mozilla-foundation-pleges = { -brand-name-mozilla } Vakfı, etkinliklerinde { -brand-name-mozilla } Manifestosu’nu desteklemeyi taahhüt eder. Özellikle şu taahhütlerde bulunuyoruz:
...
manifesto-details-some-foundation = Bazı Vakıf etkinlikleri (şu an itibarıyla tüketici ürünlerinin oluşturulması, dağıtılması ve tanıtımı) öncelikli olarak Mozilla Vakfı’nın tamamına sahip olduğu bir yan kuruluş olan Mozilla Şirketi vasıtasıyla yönetilmektedir.
manifesto-details-invitation = Davet
manifesto-details-the-mozilla-foundation-invites = { -brand-name-mozilla } Vakfı, { -brand-name-mozilla } Manifestosu’nun ilkelerini destekleyen diğer herkesi bize katılmaya ve bu internet vizyonunu gerçeğe dönüştürecek yeni yollar bulmaya davet ediyor.
