...
# HTML Page title
m24-about-page-title = { -brand-name-mozilla } hakkında bilgi alın
# HTML page description
m24-about-page-desc = { -brand-name-mozilla }, insanlığı paranın üstünde tutan tarayıcılar, uygulamalar, kodlar ve araçlar geliştirir. Misyonumuz internetin herkese açık ve erişilebilir olmasını sağlamaktır.
...
m24-about-builders-program = { -brand-name-mozilla-builders }; iş ortaklıkları, programlama ve topluluklar aracılığıyla geliştiricilerin dönüşüm yaratan açık kaynaklı yapay zekâ projeleri oluşturmasına yardımcı oluyor
