...
# HTML Page title
m24-home-page-title = Para için değil, insanlık için internet — { -brand-name-mozilla }
m24-home-page-title-v2 = { -brand-name-mozilla } — Para için değil, insanlık için internet
# HTML page description
m24-home-page-desc = Biliyor muydunuz? { -brand-name-firefox }’un yapımcısı { -brand-name-mozilla }, internetin açık ve herkesçe erişilebilir bir küresel kaynak olması için savaşıyor.
m24-home-page-desc-v2 = İnternetin kontrolünü interneti kullanan insanlara geri vermek için çalışıyoruz.
...
m24-home-topic-open-source-ai = Açık kaynaklı yapay zekâ
...
m24-home-rise25-awards = { -brand-name-rise25 } Ödülleri
m24-home-get-to-know = Güvenilir, kapsayıcı ve şeffaf yapay zekâ gelişimini savunan, yeni bir standart oluşturan ve yeni nesil mucitlere ilham veren liderleri tanıyın.
m24-home-watch-the-award = Ödül törenini izleyin
# Used as an accessible text alternative for an image
m24-home-alt-rise25-proud = Gururlu bir { -brand-name-rise25 } ödülü sahibi.
# Used as an accessible text alternative for an image
