...
mission-our-mission-is-to-ensure-the-internet = Misyonumuz, İnternet’in tüm dünyaya hizmet veren, herkese açık ve erişilebilir bir kaynak olmasını sağlamaktır. İnsanları ön plana alan, bireylerin kendi deneyimlerini şekillendirebildiği ve güçlenmiş, güvende ve bağımsız oldukları bir İnternet.
...
mission-read-the-mozilla-manifesto-to-learn = Misyonumuzu gerçekleştirmemizde bize yol gösteren değerlerimiz ve ilkelerimiz hakkında daha fazla bilgi almak için<a href="{ $url }">Mozilla Manifestosunu</a> okuyun.
