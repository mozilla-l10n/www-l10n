...
sub-navigation-compare-mobile-browsers = Mobil Tarayıcıları Karşılaştır
...
sub-navigation-ios-support = { -brand-name-ios } Desteği
sub-navigation-android-support = { -brand-name-android } Desteği
...
sub-navigation-more = Daha fazla
