...
phone-masking-faq-question-historical = Eski SMS’leri yanıtlayabilir miyim?
phone-masking-faq-answer-historical = Daha önce aldığınız SMS’lere şu anda cevap veremezsiniz, ancak bu özellik yakında gelecek.
phone-masking-faq-question-can-i-send = SMS'lere cevap vermeden SMS gönderebilir miyim?
phone-masking-faq-question-limit = Alacağım SMS sayısıyla ilgili bir limit var mı?
phone-masking-faq-question-call-length = Bir çağrı aldığımda ne kadar süre konuşabilirim?
phone-masking-faq-question-can-i-call = Telefon maskemle birini arayabilir miyim?
phone-masking-faq-question-can-i-see = Bana kimin mesaj gönderdiğini veya beni kimin aradığını görebilir miyim?
phone-masking-faq-question-can-i-block = Bir aramayı veya SMS’i engelleyebilir miyim?
phone-masking-faq-answer-can-i-block = Tek bir numaradan yapılan tüm yönlendirmeleri engelleyebilirsiniz.
phone-masking-faq-question-spam = Telefon maskem spam almaya başlarsa ne yapabilirim?
phone-masking-faq-answer-spam = Spam almaya başlarsanız size spam gönderen numaraları engelleyebilirsiniz.
phone-masking-faq-question-how-i-save-card = { -brand-name-relay } kişi kartını nasıl kaydedebilirim?
