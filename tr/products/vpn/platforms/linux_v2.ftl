...
# Obsolete string
vpn-linux-fast-and = <strong>Hızlı ve güvenilir:</strong> { -brand-name-mozilla-vpn } diğer VPN protokollerinden daha iyi performans ve kararlılık sunan { -brand-name-wireguard }® protokolünü kullanır
