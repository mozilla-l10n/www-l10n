...
privacy-faq-we-adhere-to-no-surprises-principle = “Sürprizlere yer yok” ilkesine bağlıyız, yani insanlar { -brand-name-firefox }’u nasıl tanıyorsa { -brand-name-firefox }’un gerçekten öyle olması için sıkı çalışıyoruz.
