...
firefox-developer-the-new-fonts-panel = { -brand-name-firefox-devtools }’a yeni eklenen yazı tipleri paneli, geliştiricilerin, sayfadaki bir öğede kullanılan yazı tipleriyle ilgili tüm bilgilere kolayca ulaşmasını sağlıyor. Ayrıca yazı tipi kaynağı, ağırlığı, stili gibi önemli bilgileri de içeriyor.
