...
firefox-developer-firefox-devtools-has-a-brand-new = { -brand-name-firefox-devtools }na yeni eklenen şekil yolu editörü, gölgeli ve clip-path’li şekillerine ince ayar yaparken deneme yanılma yapmak yerine görsel bir editörle kolayca her şeyi ayarlamanı sağlıyor.
firefox-developer-faster-innovation = Daha hızlı bilgi
firefox-developer-fonts-panel = Yazı tipleri paneli
firefox-developer-the-new-fonts-panel = { -brand-name-firefox-devtools }na yeni eklenen yazı tipleri paneli, geliştiricilerin, sayfadaki bir öğede kullanılan yazı tipleriyle ilgili tüm bilgilere kolayca ulaşmasını sağlıyor. Ayrıca yazı tipi kaynağı, ağırlığı, stili gibi önemli bilgileri de içeriyor.
