...
features-fingerprinting-the-practice-of = Parmak izlerinizin toplanması, tarayıcınızın depolama alanını temizlediğinizde ya da gizli gezinti modunu kullandığınızda bile <a { $url_tracked }>aylarca takip edilmenize</a> olanak tanır. Takip edilmek istemediğinize dair bildirimleriniz de dikkate almaz. <a { $url_standards }>Standart belirleme</a> <a { $url_bodies }>kuruluşları</a> ve <a { $url_browser }>tarayıcı</a> <a { $url_vendors }>şirketleri</a> arasındaki fikir birliğine ve <a { $url_harmful }>zararlı olmasına</a> karşın son on yılda parmak izi toplamanın web'de <a { $url_has }>kullanımı</a> <a { $url_steadily }>hızla</a> <a { $url_increased }>arttı</a>.
