...
# HTML page title
features-fast-get-more-done-browse-faster = Daha fazlasını yap. Birden çok sekmeyle hızlı ve daha hafif gezinti
# HTML description
features-fast-our-new-powerful-multi-process = Yeni ve güçlü çok işlemli platformumuz, bilgisayarınızı yavaşlatmadan tüm sekmelerinizi yönetir.
features-fast-firefox-is-now-faster-and-leaner = { -brand-name-firefox } artık daha hızlı ve daha yalın
