...
features-customize-firefox-comes-with-a-default = { -brand-name-firefox } varsayılan sistem temasıyla gelir. Bu temanın açık, koyu ve renkli seçnekleri de vardır.
