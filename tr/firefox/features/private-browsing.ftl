...
features-private-browsing-some-websites-and = Bazı web siteleri ve reklamlar, sen o siteden çıktıktan sonra bile nerelerde gezdiğini kaydeden takipçiler içerir. { -brand-name-firefox } Gizli Gezinti’deki izlenme koruması onları otomatik olarak engeller.
features-private-browsing-shake-off-tracking = Üstündeki ağırlıkları at
features-private-browsing-not-only-do-trackers = Takipçiler bilgi toplamakla kalmaz, gezinti hızlarını da yavaşlatabilir. { -brand-name-firefox } Gizli Gezinti, takipçi içeren reklamları engelleyerek üzerindeki yükü hafifletir ve daha hızlı gezinmeni sağlar.
