...
features-pip-got-things-to-do-do-both-with = Hem yapmanız gereken işler hem de izlemek istediğiniz şeyler mi var? { -brand-name-firefox } görüntü içinde görüntü özelliğiyle ikisini birden yapabilirsiniz. Bu özellik, videoyu web sayfasının dışına çıkarıp ekranınıza sabitliyor. Böylece başka sayfalar, sekmeler ve uygulamalarla ilgilenirken videoya da izleyebiliyorsunuz.
...
features-pip-play-any-video-in-your = { -brand-name-firefox } tarayıcınızda <strong>herhangi bir videoyu oynatın</strong> (mesela yandaki kırmızı panda yavrularının oynadığı videoyu).
