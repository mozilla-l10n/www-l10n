...
set-as-default-landing-the-internet-keeps = İnternet, kişisel verilerinizi toplamanın yeni yollarını bulmaya devam ediyor. { -brand-name-firefox }, sizi korumanın yeni yollarını bulmayı görev bilen tek tarayıcıdır.
set-as-default-landing-firefox-is-fast-no-interest = { -brand-name-firefox }’u { -brand-name-windows }, { -brand-name-ios }, { -brand-name-android } ve { -brand-name-linux }’ta hızlı ve güvenli bir şekilde kullanabilirsiniz. Sizi tek bir platforma hapsetmek hiç bize göre değil.
set-as-default-landing-firefox-is-the-only-major = { -brand-name-firefox } tek büyük bağımsız tarayıcıdır. { -brand-name-chrome }, { -brand-name-edge } ve { -brand-name-brave } ise dünyanın en büyük reklam ağı olan { -brand-name-google }’ın kodlarını temel alır.
