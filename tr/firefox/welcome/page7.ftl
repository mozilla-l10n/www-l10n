...
page7-if-you-still-kinda-like-facebook = Hâlâ { -brand-name-facebook }’tan hoşlanıyorsanız ama ona güvenmiyorsanız { -brand-name-firefox }’un { -brand-name-facebook-container } uzantısını deneyin. Bu uzantıyla { -brand-name-facebook }’un sizi izlemesini zorlaştırıyoruz.
