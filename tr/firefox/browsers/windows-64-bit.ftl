...
windows-64-bit-if-you-need-to-run = 32 bit { -brand-name-firefox } kullanmak veya 64 bit { -brand-name-firefox }’u elle yüklemek istiyorsanız istediğiniz { -brand-name-firefox } yükleyicisini <a href="{ $all }">{ -brand-name-firefox } platformları ve dilleri için indirme sayfasından</a> indirip çalıştırmanız yeterli.
