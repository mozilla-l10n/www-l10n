...
windows-64-bit-if-you-see-32-bit-newer = “(32 bit)” yazıyorsa ve Firefox 56.0.1 veya daha yeni bir sürümü kullanıyorsanız bilgisayarınız 64 bit için gereken minimum belleğe (3 GB veya daha fazla RAM) sahip olmayabilir. Yine de isterseniz 64 bit Firefox’u elle indirip kurabilirsiniz.
# Variables:
