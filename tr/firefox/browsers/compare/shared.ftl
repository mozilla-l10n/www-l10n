...
compare-shared-spell-checking = Yazım denetimi
compare-shared-web-extensionsadd-ons = Web uzantıları/Eklentiler
compare-shared-in-browser-screenshot-tool = Tarayıcı içi ekran görüntüsü aracı
compare-shared-os-availability = Farklı işletim sistemleri desteği
...
compare-shared-download-firefox = { -brand-name-firefox }’u indir
compare-shared-download-firefox-browser = { -brand-name-firefox-browser }nı indir
compare-shared-download-the-app = Uygulamayı indir
compare-shared-desktop = Masaüstü
