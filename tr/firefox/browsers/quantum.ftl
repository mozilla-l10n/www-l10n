...
firefox-doesnt-spy = { -brand-name-firefox }, internette sizi casus gibi gözetlemez. Bilinen çoğu üçüncü taraf takip çerezini engeller, tüm kontrolü size veririz.
super-fast = Çok hızlı
get-speed-and = Hem hızlı hem de güvenli. { -brand-name-firefox } web’deki hareketlerinizi takip etmediği için çok hızlı.
always-evolving = Daima gelişiyor
# Variables:
# $url (url) - link to https://www.mozilla.org/firefox/features
find-out-about = Harika <a href="{ $url }">{ -brand-name-firefox } özellikleri</a> hakkında bilgi alın.
