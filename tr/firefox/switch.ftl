...
switch-spread-the-word = Herkese { -brand-name-firefox }’tan bahsedin ve sevdiğiniz kişilerin { -brand-name-chrome }’a ​​veda etmesine yardımcı olun.
...
switch-share-to-bluesky = Bluesky’da paylaşın
switch-hey = Merhaba,
