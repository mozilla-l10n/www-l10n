...
firefox-more-you-can-reclaim = Gizliliğinizi geri alabilir, internet deneyiminiz kontrolünü yeniden ele geçirebilirsiniz! Aslında hiç de zor değil. Herkes yapabilir.
...
be-bold-and = Doğru tarayıcıyı seçerken cesur olun.
comparing-firefox-edge = { -brand-name-firefox-browser } ile { -brand-name-microsoft } { -brand-name-edge } karşılaştırması
youll-never-guess = Hız ve özellikler söz konusu olduğunda hangi tarayıcının öne çıktığını görün.
comparing-firefox-ie = { -brand-name-firefox-browser } ile { -brand-name-microsoft } { -brand-name-ie } karşılaştırması
old-habits-that = Eski alışkanlıklar kolay kaybolmaz, ama kötü alışkanlıklarınızı bırakmak şart.
comparing-firefox-safari = { -brand-name-firefox-browser } ile { -brand-name-apple } { -brand-name-safari } karşılaştırması
you-dont-have = Standart tarayıcınızı kullanmak zorunda değilsiniz.
comparing-firefox-opera = { -brand-name-firefox-browser } ile { -brand-name-opera } karşılaştırması
be-free-to = En güzel özgürlük şarkıları { -brand-name-firefox } ile söylenir.
the-ad-blocker = Reklam engelleyici: Sinir bozucu reklamlara karşı gizli bir silah.
so-many-ads = Reklam çok, sabrınız az… Artık bu çılgınlığı durdurmanın zamanı geldi.
firefox-more-protection = { -brand-name-firefox }: Daha fazla koruma, daha az dert.
...
firefox-calls-it = { -brand-name-firefox }’ta gizli gezinti, { -brand-name-chrome }’da gizli mod. İkisini de gezinti geçmişinizi kaydetmeden web'de dolaşmanızı sağlıyor.a
