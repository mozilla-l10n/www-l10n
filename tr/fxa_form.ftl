...
# Obsolete string
fxa-form-enter-your-email = { -brand-name-firefox-accounts }na erişmek için <strong>e-postanızı yazın</strong>.
fxa-form-enter-your-email-v2 = { -brand-name-mozilla-account } açmak için <strong>e-postanızı yazın</strong>.
# Variables:
