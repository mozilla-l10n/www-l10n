...
# HTML page title
lockwise-firefox-lockwise-password = { -brand-name-firefox-lockwise } – wachtwurdbehearder – nim jo wachtwurden oeral mei hinne
...
lockwise-only-in-the-firefox-browser = Allinnich yn de { -brand-name-firefox-browser }
lockwise-256-bit-encryption-protects = 256-bits fersifering beskermet jo by it syngronisearjen
lockwise-get-to-your-passwords-securely = Krij feilich tagong ta jo wachtwurden mei Face of Touch ID
lockwise-your-privacy-comes-first = Jo privacy stiet foarop
lockwise-we-keep-your-data-safe = Wy hâlde jo gegevens feilich, wy ferkeapje se nea.
lockwise-support = Stipe
lockwise-your-privacy = Jo privacy
