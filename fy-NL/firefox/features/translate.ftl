...
# page title
features-translate-translate-the-web-title = Set it ynternet oer – streekrjocht yn jo browser
# page description
...
features-translate-if-you-are = As jo { -brand-name-firefox } al brûke, dan kinne jo de taal fan de browser wizigje of talen tafoegje oan de interface fan { -brand-name-firefox }. <a { $attrs }>Lês hjir hoe.</a>
