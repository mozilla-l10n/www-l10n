...
features-adblocker-how-to-block-annoying = Sa blokkearje jo ferfelende advertinsjes mei in adblocker
...
features-adblocker-send-a-do-not-track-signal = Ferstjoer in ‘Net folgje’-sinjaal
# Variables:
