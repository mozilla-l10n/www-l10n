...
welcome-page3-never-forget-reset-or-travel = Ferjit, inisjalisearje opnij of reizgje nea mear sûnder jo wachtwurden.
welcome-page3-facebook-container = { -brand-name-facebook-container }
welcome-page3-get-a-container-to-keep-facebook = Krij in kontener om { -brand-name-facebook } bûten jo saken te hâlden.
welcome-page3-pocket = { -brand-name-pocket }
welcome-page3-trade-clickbait-and-fake-news = Ruil clickbait en nepnijs foar heechweardige ynhâld.
welcome-page3-firefox-send = { -brand-name-firefox-send }
welcome-page3-send-huge-files-to-anyone = Ferstjoer enoarme bestannen nei elkenien dy't jo wolle, mei selsferneatigjende keppelingen.
welcome-page3-why-am-i-seeing-this = Wêrom sjoch ik dit?
