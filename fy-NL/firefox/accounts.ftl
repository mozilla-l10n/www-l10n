...
# HTML page title
firefox-accounts-there-is-a-way-to = Der is in manier om jo privacy te beskermjen. Doch mei mei { -brand-name-firefox }.
# Old HTML page title
...
firefox-accounts-sign-in-to-monitor = Oanmelde by { -brand-name-monitor }
firefox-accounts-join-firefox = Doch mei mei { -brand-name-firefox }
...
firefox-accounts-take-less-keep-it = Nim minder.<br> Hâld it feilich.<br> Gjin geheimen.
firefox-accounts-get-the-knowledge = Untfang de kennis om jo feilich te hâlden.
firefox-accounts-learn-everything-you = Lear alles wat jo witte moatte (mar noch net witte) oer online tûk en feilich bliuwe, fan inkelde fan de bêste eksperts yn 'e wrâld.
firefox-accounts-and-be-part-of-protecting = En wurd ûnderdiel fan de beskerming fan it ynternet foar takomstige generaasjes.
firefox-accounts-help-us-build-a-better = Help ús in bettere { -brand-name-firefox } foar elkenien te bouwen.
