...
take-your-passwords = Nim jo wachtwurden oeral mei hinne
securely-access-the = Krij oeral feilich tagong ta wachtwurden dy't jo yn { -brand-name-firefox } bewarre hawwe – sels bûten de browser.
...
be-bold-and = Wês moedich as jo kieze hokker browser it bêste foar jo is.
comparing-firefox-edge = { -brand-name-firefox-browser } fergelykje mei { -brand-name-microsoft } { -brand-name-edge }
youll-never-guess = Jo sille nea riede hokker browser de bêste is as it giet om snelheid en funksjes.
comparing-firefox-ie = { -brand-name-firefox-browser } fergelykje mei { -brand-name-microsoft } { -brand-name-ie }
old-habits-that = Alde gewoanten binne swier, mar jo sille jo better fiele as se ferdwine.
comparing-firefox-safari = { -brand-name-firefox-browser } fergelykje mei { -brand-name-apple } { -brand-name-safari }
you-dont-have = Jo hoege jo standertbrowser net as de noarm te beskôgjen.
comparing-firefox-opera = { -brand-name-firefox-browser } fergelykje mei { -brand-name-opera }
be-free-to = Fiel jo frij om { -brand-name-firefox } lof te jaan wannear't jo dat wolle.
the-ad-blocker = De adblocker – in geheim wapen tsjin ferfelende advertinsjes.
so-many-ads = Sa folle advertinsjes, sa min geduld… It wurdt tiid om in ein te meitsjen oan de gekheid.
firefox-more-protection = { -brand-name-firefox }: mear beskerming. Minder soargen.
