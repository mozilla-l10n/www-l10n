...
firefox-sync-all-you-need = It iennige dat jo nedich hawwe foar { -brand-name-firefox-sync } is in { -brand-name-firefox-account }.
firefox-sync-encrypt-your-data = Fersiferje jo gegevens
...
firefox-sync-learn-more = Mear help by it behearen fan jo { -brand-name-firefox-account }
