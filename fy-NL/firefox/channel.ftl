...
firefox-channel-download-and-test-the-latest-android = Download en test de nijste funksjes yn { -brand-name-firefox } foar { -brand-name-android } mei { -brand-name-aurora }-, Bèta- en { -brand-name-nightly }-builds.
...
firefox-channel-firefox-beta-automatically = Firefox Bèta ferstjoert automatysk feedback nei { -brand-name-mozilla }.
# Variables:
...
firefox-channel-try-new-browser-features = Probearje nije browserfunksjes yn pre-release-ferzjes | { -brand-name-firefox }
...
firefox-channel-download-and-test-the-latest-desktop = Download en test de nijste funksjes fan { -brand-name-firefox } foar desktop mei { -brand-name-developer-edition }-, Bèta- en { -brand-name-nightly }-builds.
