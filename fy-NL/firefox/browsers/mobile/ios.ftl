...
mobile-ios-mozilla-exists-to = { -brand-name-mozilla } bestiet om it ynternet te bouwen as in iepenbiere boarne dy’t foar elkenien tagonklik is, omdat wy leauwen dat iepen en fergees better is as sluten en kontrolearre. Wy bouwe produkten as { -brand-name-firefox } en { -brand-name-pocket } om kar, transparânsje en oanstjoering te befoarderjen.
