...
# Obsolete string
browsers-mobile-at-home-or-on-the-move = Thús of ûnderweis, jo fertsjinje privacy op elk apparaat. Ferbettere beskerming tsjin folgjen is automatysk yn elke mobile browser fan { -brand-name-firefox }.
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words; please omit the strong tags if they need to be around multiple words in your language.
# Obsolete string
browsers-mobile-get-the-mobile-browser-privacy = Download de mobile browser dy’t jo <strong>privacy</strong> foarop stelt
...
browsers-mobile-compare-mobile-browsers = Mobile browsers fergelykje
