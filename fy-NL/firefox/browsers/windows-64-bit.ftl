...
windows-64-bit-if-you-see-32-bit-newer = As jo ‘(32-bits)’ sjogge en Firefox 56.0.1 of nijer brûke, dan foldocht jo kompjûter mooglik net oan de minimale ûnthâldeasken foar 64-bits (3 GB RAM of mear). Jo kinne 64-bits Firefox as jo dat wolle noch hieltiten hânmjittich ynstallearje.
# Variables:
