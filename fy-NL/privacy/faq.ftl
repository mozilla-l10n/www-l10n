...
privacy-faq-mozilla-does-collect-a-limited-v2 = { -brand-name-mozilla } sammelet standert wol in beheinde hoemannichte gegevens fan { -brand-name-firefox } út dy’t ús helpe begripe hoe’t minsken de browser brûke. Mear dêroer kinne jo yn ús <a href="{ $privacy }">privacyferklearring</a> lêze, krekt as de <a href="{ $data }">folsleine dokumintaasje foar dy gegevenssammeling</a>.
