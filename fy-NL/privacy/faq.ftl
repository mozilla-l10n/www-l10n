...
# HTML page title
privacy-faq-mozillas-data-privacy-faq = { -brand-name-mozilla }’s FAQ oer gegevensprivacy
privacy-faq-at-mozilla-we-respect-and-protect-desc = By { -brand-name-mozilla } respektearje en beskermje wy jo persoanlike gegevens.
privacy-faq-we-stand-for-people-over-profit = We Stean Foar Minsken Boppe Winst.
privacy-faq-it-can-be-tricky-for-people = Witte wat men fan brûkte software of tsjinsten ferwachtsje kin, kin tsjintwurdich lestich wêze. De technology dy’t ús libbens mooglik meitsje is kompleks, en minsken hawwe gjin tiid om har yn de details te ferdjipjen. Dat jildt ek noch hieltyd foar { -brand-name-firefox }, wêrby wy tinke dat minsken in protte ferskate ideeën hawwe oer wat der yn harren browser ûnder de motorkape bart.
privacy-faq-at-mozilla-we-respect-and-protect = { -brand-name-mozilla } respektearret en beskermet jo persoanlike gegevens:
# Variables:
...
privacy-faq-mozilla-doesnt-know-as-much = { -brand-name-mozilla } wit net sa folle oer hoe’t minsken op it web sneupe as jo dat ferwachtsje soene. As browsermakker is dat eins in grutte útdaging foar ús. Dêrom hawwe wy opsjonele helpmiddelen boud, lykas <a href="{ $link }">{ -brand-name-firefox } Pioneer</a>, wêrmei ynteressearre brûkers ús ynsichten oer harren sneupgedrach jaan kinne. As jo jo browserskiednis tusken { -brand-name-firefox }-ynstallaasjes syngronisearje, witte wy net wat dy skiednis is - omdat dizze troch jo apparaat fersifere wurdt.
...
privacy-faq-we-make-our-documentation-public = Wy meitsje ús dokumintaasje iepenbier, sadat elkenien ferifiearje kin dat wat wy sizze wier is, ús litte witte kin dat der wat ferbettere wurde moat, en der fertrouwen yn hawwe dat wy neat ferstopje.
...
privacy-faq-yes-user-control-is-one-of-our = Ja. Brûkerskontrôle is ien fan ú prinsipen oer gegevensprivacy. Dat hawwe wy yn { -brand-name-firefox } yn praktyk brocht op ús <a href="{ $settings }">side oer privacyynstellingen</a>, dy’t fungearret as ‘one-stop shop’ foar elkenien dy’t op syk is nei it hâlden fan kontrôle oer harren privacy yn { -brand-name-firefox }. Dêr kinne jo <a href="{ $data }">gegevenssammeling útsette</a>.
privacy-faq-what-about-my-account-data = Wat is der mei myn accountgegevens?
privacy-faq-we-are-big-believers-of-data = Wy hâlde in protte fan minimale gegevens en freegje net nei wat wy net nedich hawwe.
# Variables:
#   $accounts (url) - link to https://support.mozilla.org/kb/firefox-options-preferences-and-settings
privacy-faq-you-dont-need-an-account-to = Jo hawwe gjin account nedich om { -brand-name-firefox } te brûken. <a href="{ $accounts }">Accounts</a> binne nedich om gegevens tusken apparaten te syngronisearjen, mar wy freegje jo allinnich om in e-mailadres. Saken lykas jo namme, adres, bertedatum en telefoannûmer wolle wy net witte.
privacy-faq-you-use-digital-advertising = Jimme brûke digitale reklame as ûnderdiel fan jin marketingmiks. Keapje jimme gegevens oer minsken om jin online advertinsjes better rjochtsje te kinnen?
privacy-faq-no-we-do-not-buy-peoples-data = Nee, wy keapje gjin gegevens fan minsken foar doelfêste advertinsjes.
privacy-faq-we-do-ask-our-advertising-partners = Wy freegje ús advertinsjepartners wol om allinnich gegevens fan dizze partijen sels dy by websites en útjouwers oer alle brûkers bekend binne te brûken, lykas de browser dy’t jo brûke en it apparaat wêrop jo jo binne.
privacy-faq-well-it-seems-like-you-really = OK, oangeande dizze privacy hat Mozilla my wurklik beskerme.
privacy-faq-yes-we-do = Ja dat is wier.
privacy-faq-find-out-more-about-how-mozilla = Untdek mear oer hoe’t { -brand-name-mozilla } it ynternet beskermet.
