...
# HTML page title
vpn-landing-title = { -brand-name-mozilla-vpn }: beskermje jo hiele apparaat
# HTML page description
# Variables:
#   $countries (number) - number of available countries
vpn-landing-desc = Brûk { -brand-name-mozilla-vpn } foar beskerming foar alle apps op jo hiel apparaat. Mei servers yn { $countries } lannen, kinne jo oeral mei elke lokaasje ferbining meitsje.
vpn-landing-powerful-privacy-for-peace = Krêftige privacy foar gemoedsrêst
vpn-landing-whats-a-vpn = Wat is in VPN?
