...
vpn-windows-download-page-title = Download { -brand-name-mozilla-vpn } foar { -brand-name-windows }
vpn-windows-downloading-mozilla-vpn = { -brand-name-mozilla-vpn } foar { -brand-name-windows } wurdt download…
vpn-windows-go-to-your-downloads = Gean nei jo downloadmap en dûbelklik op it .msi-bestân
vpn-windows-a-progress-bar = Der ferskynt in foartgongsbalke en it ynstallaasjeproses begjint

## Mac download page

vpn-mac-download-page-title = Download { -brand-name-mozilla-vpn } foar { -brand-name-mac-short }
vpn-mac-downloading-mozilla-vpn = { -brand-name-mozilla-vpn } foar { -brand-name-mac-short } wurdt download…
vpn-mac-go-to-your-downloads = Gean nei jo downloadmap en dûbelklik op it .pkg-bestân
vpn-mac-follow-the-steps = Folgje de stappen yn it { -brand-name-mozilla-vpn }-ynstallaasjeprogramma om de app te starten
...
vpn-download-faq-adding-another-v3 = Noch in apparaat tafoegje is krekt sa ienfâldich as it downloaden en ynstallearjen fan de { -brand-name-mozilla-vpn }-software en dernei oanmelde by jo besteande { -brand-name-mozilla-account } op it nije apparaat. Gean foar mear details nei <a href="{ $subscription }">Apparaten oan jo { -brand-name-mozilla-vpn }-abonnemint tafoegje</a>.
# Obsolete string
# Variables:
#   $subscription - link to https://support.mozilla.org/kb/how-add-devices-your-mozilla-vpn-subscription
vpn-download-faq-adding-another-v2 = Noch in apparaat tafoegje is krekt sa ienfâldich as it downloaden en ynstallearjen fan de { -brand-name-mozilla-vpn }-software en dernei oanmelde by jo besteande { -brand-name-firefox-account } op it nije apparaat. Gean foar mear details nei <a href="{ $subscription }">Apparaten oan jo { -brand-name-mozilla-vpn }-abonnemint tafoegje</a>.
