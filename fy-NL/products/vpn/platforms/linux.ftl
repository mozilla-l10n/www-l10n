...
# Variables:
#   $countries (number) - number of available countries
vpn-linux-servers-copy = { -brand-name-mozilla-vpn } jout jo de mooglikheid om de lokaasje fan jo { -brand-name-linux }-basearre kompjûter yn te stellen op ien fan de mear as { $countries } lannen, wêrtroch in wrâld fan opwinende nije ynhâld foar jo iepengiet.
# Variables:
#   $devices (number) - number of available devices
vpn-linux-devices-headline = Ferbyn oant { $devices } apparaten
vpn-linux-devices-copy = Mei ien abonnemint kinne jo { -brand-name-mozilla-vpn } op maksimaal { $devices } ferskillende apparaten op ferskillende bestjoeringssystemen ûntfange, wêrûnder { -brand-name-linux }, { -brand-name-windows }, { -brand-name-android }, { -brand-name-mac-short } en { -brand-name-ios } foar { -brand-name-iphone } en { -brand-name-ipad }.
