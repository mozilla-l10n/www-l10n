...
vpn-mac-page-title = { -brand-name-mozilla-vpn } foar { -brand-name-mac-short }
...
vpn-mac-about-copy = Sûnt 1998 wurdt de non-profit { -brand-name-mozilla } laat troch har missy om i better ynternet te bouwen. Fan produkten as de { -brand-name-firefox-browser } oant pleitbesoarging oer de hiele wrâld, bliuwt it wurk fan { -brand-name-mozilla } derfoar soargjen dat it ynternet frij en iepen foar elkenien is.
vpn-mac-privacy-headline = Privacy binnen hânberik
vpn-mac-privacy-copy = Mei { -brand-name-mozilla-vpn } wurdt jo ynternteferbining fersifere en jo IP-adres beskerme tsjin hackers en nijsgjirrige ynternetproviders, tanksij it avansearre { -brand-name-wireguard }®-protokol.
vpn-mac-servers-headline = Tagong ta servers oer de hiele wrâld
# Variables:
#   $countries (number) - number of available countries
#   $servers (number) - number of available servers
vpn-mac-servers-copy = Stel de lokaasje fan jo { -brand-name-mac-short } yn op in kar út mear as { $servers } servers yn mear as { $countries } lannen. Hjirtroch kinne jo it nijs lêze, winkelje, streame en op it ynternet sneupe fan praktysk oeral út.
# Variables:
