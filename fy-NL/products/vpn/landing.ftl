...
# HTML page title
vpn-landing-page-title = { -brand-name-mozilla-vpn }: beskermje jo hiele apparaat
...
vpn-landing-fast-secure-heading = Fluch en feilich netwurk
# Variables:
...
vpn-landing-brand-trust-desc = Al mear as 20 jier stiet { -brand-name-mozilla } der om bekend dat it minsken foarop stelt en foar online privacy stridet. Stipe troch in non-profitorganisaasje, binne wy tawijd oan it bouwen fan i better en sûner ynternet foar elkenien. Alles wat wy meitsje, makket diel út fan ús missy en folget ús <a href="{ $url }">prinsipen</a>.

## FAQ section

vpn-landing-faq-heading = FAQ’s
vpn-langing-faq-uses-question-heading = Wat is in VPN en wat binne de tapassingen dêrfan?
# Variables:
...
# Variables:
#   $url (url) - link to https://www.mozilla.org/products/vpn/mobile/ios/
vpn-landing-faq-compatibility-question-desc-ios-v2 = <a href="{ $url }">{ -brand-name-ios }</a> (13.0 en heger)
# Outdated string
vpn-landing-faq-compatibility-question-desc-ios = { -brand-name-ios } (13.0 en heger)
# Variables:
...
vpn-landing-faq-download-heading = Hoe download ik { -brand-name-mozilla-vpn } as ik al abonnearre bin?
# Variables:
#   $attrs (string) - link href and additional HTML attributes
vpn-landing-faq-download-desc = Besykje de <a { $attrs }>downloadside</a> om { -brand-name-mozilla-vpn } op jo apparaat te ynstallearjen en meld jo dernei oan mei jo { -brand-name-firefox-account }.
...
vpn-landing-invite-email-placeholder = jonamme@example.com
vpn-landing-invite-country-label = Yn hokker lân wenje jo?
vpn-landing-invite-language-label = Selektearje jo foarkartaal
vpn-landing-invite-platform-label = Yn hokker platfoarms binne jo ynteressearre?
...
vpn-landing-invite-privacy-policy = Troch op ‘Op de wachtlist pleatse’ te klikken stimme jo yn mei ús <a href="{ $privacy }">privacybelied</a>.
vpn-landing-invite-your-information = Jo gegevens wurde allinnich brûkt om jo te berjochtsjen oer platfoarmbeskikberheid.
vpn-landing-invite-thanks-heading = Tank! Jo steane op de list
vpn-landing-invite-thanks-desc = Sa gau as { -brand-name-mozilla-vpn } beskikber komt foar jo regio, stjoere wy jo in e-mailberjocht.
