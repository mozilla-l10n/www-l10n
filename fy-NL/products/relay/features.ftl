...
highlighted-features-section-unlimited-masks-body-v2 =
    { $mask_limit ->
        [one]
            Elkenien ûntfangt fergees { $mask_limit } e-mailmasker.
            Mar mei { -brand-name-relay-premium } kinne jo safolle maskers oanmeitsje as jo nedich hawwe om jo Postfek YN te beskermjen tsjin spammers, hackers en online trackers.
       *[other]
