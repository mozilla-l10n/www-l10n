...
about-berlin = Berlyn
# The number inside the strong tag will be big, bold, and on its own line. Remove the strong tag if you need to put the number in the middle of the phrase.
about-500-annual-attendees-to-the = <strong>500</strong> jierlikse oanwêzigen by de lêzingen yn Berlyn
about-taipei = Taipei
# The number inside the strong tag will be big, bold, and on its own line. Remove the strong tag if you need to put the number in the middle of the phrase.
about-400-collaborative-visits-with = <strong>400</strong> jierlikse gearwurkingsbesites mei { -brand-name-mozilla }-wurknimmers
