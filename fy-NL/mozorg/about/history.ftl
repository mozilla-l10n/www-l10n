...
history-for-more-information-about = Lês foar mear ynformaasje oer de skiednis fan { -brand-name-mozilla }:
...
history-the-history-of-firefox-and = <a href="{ $link }">Posters oer de skiednis fan { -brand-name-firefox } en { -brand-name-mozilla }</a> (beskikber yn Ingelsk en Japansk)
