...
manifesto-use-open-badges-to-share = Brûk Open Badges om jo feardichheden en ynteresses te dielen
manifesto-explore-how-the-web-impacts = Untdek hoe't it web de wittenskip beynfloedet
manifesto-learn-about-open-source = Lês oer iepenboarnekoade yn de sjoernalistyk
manifesto-read-about-open-internet = Mear oer beliedsinisjativen en ûntwikkelingen fan in iepen ynternet
manifesto-explore-how-to-help-keep = Untdek hoe't jo helpe kinne it web iepen te hâlden
manifesto-see-how-the-web-can-connect = Sjoch hoe't it web de wrâld mei sûnenssoarch ferbine kin
manifesto-explore-how-the-web-works = Untdek hoe't it web wurket
manifesto-see-how-mozilla-works = Lês hoe't { -brand-name-mozilla } har ynset om jo privacy foarop te stellen
manifesto-read-about-developments = Lês oer ûntwikkelingen yn privacy en gegevensfeilichheid
manifesto-learn-more-about-how-to = Lês oer hoe't jo jo online beskermje kinne
manifesto-use-these-free-tools-to = Brûk dit fergeze ark om it web te ûnderwizen
manifesto-learn-about-creating-and = Lês oer it meitsjen en behearen fan ynhâd foar it web
manifesto-add-new-voices-to-open = Foegje nije stimmen ta oan iepenboarnetechnology
manifesto-set-your-do-not-track = Stel jo Net folgje-foarkar yn
manifesto-understand-the-web-ecosystem = It web-ekosysteem begripe
manifesto-explore-how-open-practices = Untdek hoe't iepen oefeningen it web tagonklik hâlde
manifesto-learn-how-to-remix-content = Lear hoe't jo ynhâld ombouwe om wat nijs fan te meitsjen
manifesto-learn-how-to-maximize = Lear it ynteraktive potinsjeel fan it web te maksimalisearjen
manifesto-participate-in-our-governance = Nim diel oan ús bestjoersfoarum
manifesto-join-us-as-a-volunteer = Doch mei as frijwilliger
manifesto-learn-how-to-collaborate = Lear hoe't jo online gearwurkje kinne
manifesto-visualize-who-you-interact = Meitsje jo ynteraksje op it web sichtber mei { -brand-name-lightbeam }
manifesto-learn-about-creating-web = Lês oer it meitsjen fan webhelpboarnen mei oaren
manifesto-host-or-join-a-maker-party = Organisearje of wenje in { -brand-name-maker-party } by
manifesto-learn-how-to-build-online = Lear hoe't jo online-gearwurkingsfeardichheden opbouwe kinne
