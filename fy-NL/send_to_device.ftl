...
send-to-device-send-firefox = { -brand-name-firefox } nei jo snoadfoan of tablet ferstjoere
send-to-device-your-download-link = Jo downloadkeppeling is ferstjoerd.
...
send-to-device-send-to-another = Ferstjoere nei oar apparaat
