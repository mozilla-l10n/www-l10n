...
navigation-v2-close-firefox-browsers-menu = Mdel umuɣ { -brand-name-firefox-browsers }
navigation-v2-firefox-for-desktop = { -brand-name-firefox } i uselkim
navigation-v2-get-the-not-for-profit-backed = Awi iminig yettwaḥerzen s tkebbanit ur nettnadi tadrimt di { -brand-name-windows }, { -brand-name-mac-short } neɣ { -brand-name-linux }{ -brand-name-linux }.
navigation-v2-firefox-for-android = { -brand-name-firefox } i { -brand-name-android }
