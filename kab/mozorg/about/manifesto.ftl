...
manifesto-visualize-who-you-interact = Wali anwa ukud i tettmeslayeḍ di web s useqdec n Lightbeam
manifesto-learn-about-creating-web = Issin amek ara ternuḍ tiɣbula di web akked wiyaḍ
manifesto-host-or-join-a-maker-party = Mudd tanezduɣt neɣ rnu tadyant Maker Party
...
manifesto-details-articulate-a-vision = ad nesbded tikti ifazen ɣef Internet akken ttebɣan imttekkiyen n tesbeddit { -brand-name-mozilla } yesseḥbibiren ɣef wawwaḍ ɣer iswyen agi.
...
manifesto-details-mozilla-foundation = Anmeqqen n tesbeddit Mozilla
manifesto-details-the-mozilla-foundation-pleges = Tasbeddit { -brand-name-mozilla } tegmen akken ad teddu deg ubrid n umeskan { -brand-name-mozilla } deg urmud ines. Hata wayen ad nexdem:
...
manifesto-details-some-foundation = Kra n warmud n tesbeddit—akka tura: asnulfu, asiweḍ d ummeslay ɣef iseɣẓanen— txedmiten { -brand-name-mozilla-corporation }, afurk s 100% n tesbeddit Mozilla.
