...
manifesto-details-these-principles = Insayen-a ur d-ttasen kan akka s yiman-nsen. Ilaq ad ilin yimdanen i wakken ad rren Internet yeldi yerna ad ttekkin deg-s - imdanen i yexedmen i yiman-nsen, neɣ wid iqeddcen lwaḥid deg yigrawen, rnan seddayen wiyaḍ. { -brand-name-mozilla } tettekka i wakken ansayen-a deg Umeskan n { -brand-name-mozilla }. Nuzen tinnubga i yal yiwen i wakken ad d-rnun ɣur-neɣ, ad nerr Internet d amḍiq ifazen i yal yiwen.
...
manifesto-details-the-mozilla-foundation-invites = Takebbanit n { -brand-name-mozilla } tenced-d akk wiyaḍ ara yessebɣasen imenzayen n umeskan { -brand-name-mozilla } ad d-rnun ɣur-neɣ, daɣen ad d-naf iberdan imaynuten i wakken tamuɣli-agi ɣer Internet ad tuɣal d tilawt.
