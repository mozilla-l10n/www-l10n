...
whatsnew-up-to-date-notification-v2 = Ayuz! Aql-ak·akem tesseqdaceḍ lqem aneggaru n { -brand-name-firefox }.
# Obsolete string
...
whatsnew-release-notes = Wali <a href="{ $url }">tizmilin n lqem</a> akken ad tissineḍ ugar ɣef umaynut n yiminig-ik { -brand-name-firefox }.
