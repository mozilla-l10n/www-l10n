...
# Modal title
whatsnew79-get-firefox-on-your-phone = Awi { -brand-name-firefox } deg tiliɣri-inek·inem
whatsnew79-scan-the-qr-code = Ṭṭef tangalt QR akken ad tebduḍ
# Accessible text replacement for a QR code image
whatsnew79-qr-code-to-scan = Tangalt QR i umtawi n { -brand-name-firefox }
