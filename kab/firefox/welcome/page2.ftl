...
# HTML page title
welcome-page2-pocket-save-news-videos-stories = { -brand-name-pocket } - Sekles isallen, tividyutin, tiqessiḍin d wayen-nniḍen
welcome-page2-your-time-online-is-worth = Akud-inek·inem srid yuklal ammesten
welcome-page2-discover-and-save-stories = Af-d rnu sekles tiqessiḍin deg { -brand-name-pocket } — sakin uɣal-d ɣer-sent mi ara testafiḍ.
welcome-page2-activate-pocket = Rmed { -brand-name-pocket }
