...
firefox-channel-download-and-test-the-latest-android = Sader daɣen sekyed timahilin tineggura n { -brand-name-firefox } s yileqman { -brand-name-aurora }, { -brand-name-beta } akked { -brand-name-nightly }.
