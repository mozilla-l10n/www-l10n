...
firefox-enterprise-enterprise = Takebbanit
...
firefox-enterprise-with-install-packages-and = S yikemmusen n usbeddi d usiɣzen ɣezzifen n tsertiyin d tmahilin n ugraw, aseddu ad yuɣal d arurad; d afallaẓ ugar n wakken yella — iteddu s sshala deg twennaḍin n Winows d { -brand-name-mac }.
...
firefox-enterprise-enterprise-downloads = Isidar n tkebbanit
...
firefox-enterprise-firefox-browser = Iminig { -brand-name-firefox }
firefox-enterprise-firefox-browser-msi-installer = Iminig { -brand-name-firefox }: asebdad MSI
firefox-enterprise-firefox-extended-support-release = Lqem n tallelt n usiɣzef n Firefox ({ -brand-name-esr })
firefox-enterprise-firefox-extended-support-release-msi = Lqem n tallelt n usiɣzef n Firefox ({ -brand-name-esr }) - Asebdad MSI
