...
new-platform-the-new-firefox = { -brand-name-firefox }<strong>amaynut</strong>
new-platform-2x-faster = 2x d arurad ugar
new-platform-the-best-firefox-ever = { -brand-name-firefox } ufrin i lebda
new-platform-lightweight = Fessus nezzeh
new-platform-uses-30-less-memory = ISeqdac 30% n qel n tkatut ɣef { -brand-name-chrome }
new-platform-powerfully-private = Tabaḍnit iǧehden
new-platform-truly-private-browsing = Tunigin tusligt s ummesten mgal asfuɣel
...
new-platform-own-your-online-life = Issin tudert-ik tumḍint
...
new-platform-firefox-respects-your = { -brand-name-firefox } yettqadaṛ <span>tudert-ik tabadnit deg { -brand-name-mac-short }.</span>
...
new-platform-firefox-fights = { -brand-name-firefox } ittenneɣ fell-af <span>deg { -brand-name-windows }.</span>
