...
firefox-desktop-download-meta-title = Sider { -brand-name-firefox-browser } — D arurad, d uslig & baṭṭel sɣur { -brand-name-mozilla }
...
firefox-desktop-download-og-title = Sider-d { -brand-name-firefox } arurad i lebda
