...
password-manager-earn-your-second = Ma yella tesriḍ, seqdec agus wis sin n tɣellist s ddeqs n tarrayin n { -brand-name-firefox } n <a href="{ $addons }">izegrar</a> n umsefrak n wawalen uffiren. Fren Win yellan neɣ nadi aswir-nniden gar wid yettwaszemlen neɣ yettwaceggren squr iseqdacen.
