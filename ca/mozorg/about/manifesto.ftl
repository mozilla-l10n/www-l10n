...
manifesto-visualize-who-you-interact = Visualitzeu com interaccioneu amb el Web amb el Lightbeam
manifesto-learn-about-creating-web = Apreneu sobre recursos de creativitat Web amb d'altres
manifesto-host-or-join-a-maker-party = Fer o unir-vos a una festa Maker
...
manifesto-details-articulate-a-vision = articular una visió d'Internet que els participants de { -brand-name-mozilla } volen que la Fundació { -brand-name-mozilla } persegueixi;
...
manifesto-details-these-principles = Aquests principis no s'establiran per si sols. Cal que la gent faci Internet oberta i participativa -les persones com a individus, treballant plegades en grups o liderant equips. La Fundació { -brand-name-mozilla } està compromesa a promoure els principis establerts al Manifest de { -brand-name-mozilla }. Us convidem a unir-vos a nosaltres i a fer d'Internet un lloc encara millor per a tothom.
...
manifesto-details-mozilla-foundation = El compromís de la Fundació Mozilla
manifesto-details-the-mozilla-foundation-pleges = La Fundació { -brand-name-mozilla } es compromet a donar suport al Manifest de { -brand-name-mozilla } en les seves activitats. Específicament:
...
manifesto-details-some-foundation = Algunes de les activitats de la Fundació -actualment la creació, l'oferiment i la promoció dels productes de consum- es duen a terme principalment mitjançant la Corporació Mozilla, una empresa subsidiària propietat únicament de la Fundació Mozilla.
manifesto-details-invitation = Invitació
manifesto-details-the-mozilla-foundation-invites = La Fundació { -brand-name-mozilla } convida tothom que comparteixi els principis del Manifest de { -brand-name-mozilla } a unir-s'hi, per tal de cercar noves maneres d'aconseguir que aquesta visió d'Internet es faci realitat.
