...
# HTML page title
firefox-products-firefox-is-more-than-a-browser = El { -brand-name-firefox } és més que un navegador
# HTML page description
firefox-products-its-a-whole-family-of-products = És tota una família de productes dissenyada per a navegar per Internet de forma més intel·ligent i segura.
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words, please omit the strong tags if they need to be around multiple words in your language
firefox-products-firefox-is-more-than-a-browser-emphasis = El { -brand-name-firefox } és <strong>més</strong> que un navegador
firefox-products-firefox-monitor = { -brand-name-firefox-monitor }
firefox-products-see-if-your-personal-information = Comproveu si hi ha alguna filtració de dades d'empreses que hagi afectat la vostra informació personal i subscriviu-vos a alertes futures.
