...
home-volunteer-with-mozilla = Faça trabalho voluntário com a { -brand-name-mozilla }
home-that-one-time = Aquela vez que entregamos o nosso código-fonte…
home-the-mozilla-project = O projeto { -brand-name-mozilla } foi fundado em São Francisco em 1998, quando o navegador { -brand-name-netscape } decidiu que doar o seu código de programa ao público para construir e melhorar. Nessa altura, uma empresa tinha um quase-monopolio de como as pessoas experienciaram a Internet.
