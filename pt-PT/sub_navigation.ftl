...
sub-navigation-compare-mobile-browsers = Comparar navegadores móveis
...
sub-navigation-ios-support = Apoio para { -brand-name-ios }
sub-navigation-android-support = Apoio para { -brand-name-android }
...
sub-navigation-firefox-features = Funcionalidades do { -brand-name-firefox }
sub-navigation-ad-tracker-blocking = Bloqueio de rastreadores de anúncios
sub-navigation-private-browsing = Navegação privada
...
sub-navigation-our-promise = A nossa promessa
sub-navigation-our-products = Os nossos produtos
sub-navigation-little-book-of-privacy = Pequeno livro da privacidade
sub-navigation-safe-passwords = Palavras-passe seguras
