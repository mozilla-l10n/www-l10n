...
features-eyedropper-screenshot-of-the-eyedropper-tool = Captura de ecrã da ferramenta conta-gotas no { -brand-name-firefox } a mostrar o valor de cor em hexadecimal de um único pixel numa página de Internet.
features-eyedropper-you-can-find-the-eyedropper = Pode encontrar o conta-gotas em “Ferramentas do navegador” no menu Ferramentas ou em “Mais ferramentas” no menu da barra de ferramentas do { -brand-name-firefox } (no final da barra de ferramentas do { -brand-name-firefox }).
