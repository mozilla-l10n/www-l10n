...
features-translate-while-other-browsers-rely-on-v2 = Enquanto outros navegadores dependem de serviços na nuvem, os modelos linguísticos do { -brand-name-firefox-translations } são descarregados para o navegador do utilizador e as traduções são efetuadas localmente, para que a { -brand-name-mozilla } não grave as páginas web que traduz.
