...
features-fast-firefox-is-powered-by-the-world = O { -brand-name-firefox } é potenciado pelo motor { -brand-name-gecko }, de nível mundial, com um estilo e disposição de página incrivelmente rápidos, funcionalidades modernas de JavaScript e uma lista sem fim de novas melhorias de desempenho para manter os nossos utilizadores contentes e a levar a plataforma da Internet para a frente.
# Variables
#   $link (url) - link to https://hacks.mozilla.org/2023/10/down-and-to-the-right-firefox-got-faster-for-real-users-in-2023/
features-fast-all-browsers-had-to-make = Todos os navegadores tiveram de fazer melhorias para poderem ter um bom desempenho nos novos testes do Speedómetro 3. O { -brand-name-firefox }, em particular, fez grandes progressos, <a { $link }>a ficar notoriamente mais rápido</a> para os nossos utilizadores como resultado direto deste trabalho. O { -brand-name-firefox } está mais rápido do que nunca, com uma velocidade que pode realmente sentir, incluindo carregamentos de página mais rápidos e interações mais suaves.
