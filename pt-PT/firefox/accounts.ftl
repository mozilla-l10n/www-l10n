...
# Obsolete string
firefox-accounts-sign-in-to = Iniciar sessão na sua { -brand-name-firefox-account } para:
# Obsolete string
...
firefox-accounts-send-a-tab = <a href="{ $send }">Enviar um separador</a> para um dispositivo diferente
# Variables:
