...
youll-never-guess = Nunca irá adivinhar qual é o navegador que leva a frente quando se trata de velocidade e funcionalidades..
comparing-firefox-ie = A comparar o { -brand-name-firefox-browser } com o { -brand-name-microsoft } { -brand-name-ie }
old-habits-that = Antigos hábitos que perduram no tempo, mas que irá sentir-se melhor quando o mesmo passar.
