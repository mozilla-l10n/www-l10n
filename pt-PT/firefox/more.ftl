...
firefox-doesnt-spy = O { -brand-name-firefox } não espia as pesquisas. Impedimos os cookies de rastreamento de terceiros conhecidos e damos-lhe o controlo total.
firefox-for-linux = { -brand-name-firefox } para { -brand-name-linux }
new-school-meets = A nova escola encontra a antiga escola com o navegador mais rápido de sempre.
firefox-for-windows = { -brand-name-firefox } para { -brand-name-windows } de 64 bits
we-worry-about = Nós preocupamo-nos com a sua segurança dos dados para que não tenha de se preocupar.
# Obsolete string
seven-of-the = Sete dos melhores navegadores numa comparação direta
six-of-the-best = Seis dos melhores navegadores em comparação direta
# Obsolete string
we-compare-firefox = Comparamos o { -brand-name-firefox } com o { -brand-name-chrome }, { -brand-name-edge }, { -brand-name-safari }, { -brand-name-opera }, { -brand-name-brave } e { -brand-name-ie } para o ajudar a tomar a sua decisão.
we-compare-firefox-v2 = Comparamos o { -brand-name-firefox } com o Chrome, Edge, Safari, Opera e Brave para o ajudar a tomar a sua decisão.
comparing-firefox-chrome = A comparar o navegador { -brand-name-firefox-browser } com o { -brand-name-google } { -brand-name-chrome }
...
be-bold-and = Seja ousado e corajoso ao escolher o navegador certo para si.
comparing-firefox-edge = A comparar o navegador { -brand-name-firefox-browser } com o { -brand-name-microsoft } { -brand-name-edge }
youll-never-guess = Nunca irá adivinhar qual é o navegador que está mais à frente quando se trata de velocidade e funcionalidades.
...
comparing-firefox-safari = A comparar o { -brand-name-firefox-browser } com o { -brand-name-apple } { -brand-name-safari }
you-dont-have = Não precisa de predefinir o seu navegador padrão.
comparing-firefox-opera = A comparar o { -brand-name-firefox-browser } com o { -brand-name-opera }
...
firefox-more-avoid-misinformation-desc = Consulte as dicas para ver menos desinformação e focar no que é importante para si.
firefox-more-is-firefox-a-private-browser = O { -brand-name-firefox } é um navegador privado?
firefox-more-were-focused-on-your-right-to = Estamos focados no seu direito à privacidade. Os seus dados, a sua atividade e a sua vida na Internet estão protegidos com o { -brand-name-firefox }.
