...
nightly-whatsnew-if-you-want-to-v4 = Se pretende saber o que está a acontecer à volta do { -brand-name-nightly } e da sua comunidade, a ler o nosso <a { $blog }>blogue</a> e a seguir-nos no <a { $mastodon }>Mastodon</a> ou <a { $bluesite }>Azul</a> são bons pontos de partida!
# Variables:
#   $blog (url) - link to https://blog.nightly.mozilla.org/
#   $mastodon (url) - link to https://mastodon.social/@FirefoxNightly
