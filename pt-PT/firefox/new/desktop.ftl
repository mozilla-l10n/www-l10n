...
firefox-desktop-download-fast-reliable-private = Rápido, confiável e privado — para paz de espírito online.
...
firefox-desktop-download-do-what-you-do-v2 = Faça o que quiser online.<br> O { -brand-name-firefox-browser } <strong>protege-o</strong>.
...
firefox-desktop-download-as-the-internet-v2 = À medida que a internet cresce e muda, o { -brand-name-firefox } continua a focar-se no seu direito à privacidade - esse foi sempre o nosso tema. Saiba mais sobre as nossas práticas com dados na nossa <a { $attrs }>Política de Privacidade</a>.
# Variables:
