...
# html page title
whatsnew80-page-title = Quais as novidades do { -brand-name-firefox }
whatsnew80-up-to-date-banner = Parabéns! Está a utilizar a versão mais recente do { -brand-name-firefox }.
# Main title
whatsnew80-main-title = Faça quase tudo, um pouco mais rápido
whatsnew80-main-intro = Mude do computador para o telefone sem perder o ritmo. Obtenha o { -brand-name-firefox } para dispositivos móveis.
whatsnew80-primary-cta-description = Especifique o seu e-mail ou número de telefone para obter uma ligação de transferência
