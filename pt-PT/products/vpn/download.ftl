...
vpn-download-page-title = Transferir a { -brand-name-mozilla-vpn }
vpn-download-page-description = Transfira a { -brand-name-mozilla-vpn } para { -brand-name-windows }, { -brand-name-mac }, { -brand-name-linux }, { -brand-name-android } e { -brand-name-ios }.
# Variables:
#   $devices (number) - maximum number of connected devices
vpn-download-sub-heading = Pode transferir a { -brand-name-mozilla-vpn } para até { $devices } dispositivos com uma subscrição.
...
vpn-download-version-requirements = Versão { $version } e superior
vpn-download-for-linux = VPN para { -brand-name-linux }
vpn-download-for-linux-long = Transferir a { -brand-name-mozilla-vpn } para { -brand-name-linux }
# Variables:
#   $version (number) - operating system version
vpn-download-for-linux-requirements = Ubuntu { $version } e superiores
...
vpn-download-from-the-maker = Dos criadores do { -brand-name-firefox }, a { -brand-name-mozilla-vpn } utiliza o avançado <a href="{ $url }" { $attrs }>{ -brand-name-wireguard }< Protocolo /a>® para encriptar a sua atividade online e ocultar a sua localização.
