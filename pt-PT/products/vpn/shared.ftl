...
# Outdated string
vpn-shared-available-countries-v3 = Atualmente, oferecemos a { -brand-name-mozilla-vpn } nos EUA, Canadá, Reino Unido, Alemanha, França, Itália, Espanha, Bélgica, Áustria, Suíça, Malásia, Nova Zelândia e Singapura.
