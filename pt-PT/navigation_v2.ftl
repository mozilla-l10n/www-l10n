...
navigation-v2-firefox-for-mobile = { -brand-name-firefox-browser } para dispositivos móveis
navigation-v2-take-speed-privacy-and = Leve a velocidade, privacidade e tranquilidade consigo. No { -brand-name-android } e { -brand-name-ios }.
...
navigation-v2-use-ai-to-detect = Utilize a IA para detetar avaliações falsas e fraudes
...
navigation-v2-find-out-how = Descubra como estamos a tornar a Internet mais inclusiva e sustentável.
