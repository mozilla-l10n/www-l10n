...
faq-headline = Questions fréquemment posées
...
faq-question-missing-emails-answer-a-2 = Il existe plusieurs raisons pour lesquelles vous ne recevez peut-être pas les e-mails transférés via vos alias. En voici certaines :
faq-question-missing-emails-answer-reason-spam = Les messages sont classés dans le courrier indésirable
faq-question-missing-emails-answer-reason-blocked-2 = Votre fournisseur de messagerie bloque vos alias
# Variables:
#  $size (number): maximum size for attachments in MB
faq-question-missing-emails-answer-reason-size = L’e-mail transféré contient une pièce jointe supérieure à { $size } Mo
faq-question-missing-emails-answer-reason-not-accepted-2 = Le site n’accepte pas les alias
faq-question-missing-emails-answer-reason-turned-off-2 = Le transfert depuis l’alias a peut-être été désactivé
...
faq-question-use-cases-question-2 = Quand devrais-je utiliser les alias de messagerie { -brand-name-relay } ?
faq-question-use-cases-answer-part1-2 = Vous pouvez utiliser des alias de messagerie { -brand-name-relay } dans la plupart des cas où vous utiliseriez votre adresse e-mail habituelle. Nous vous recommandons de les utiliser lors de l’inscription à des e-mails publicitaires/informatifs, dans des cas où vous voudrez peut-être contrôler la réception ou non d’e-mails à l’avenir.
...
# Variables:
#  $size (number): maximum size for attachments in MB
faq-question-attachments-answer-v2 = Nous prenons désormais en charge le transfert de pièces jointes. Toutefois, il existe une limite de { $size } Mo pour le transfert de messages par { -brand-name-relay }. Les courriers dont la taille excède { $size } Mo ne seront pas transférés.
...
#   $attrs (string) - specific attributes added to external links
faq-question-8-answer-3-html = { -brand-name-firefox-relay } dresse la liste des sites web où vous avez utilisé vos alias de messagerie et étiquette vos alias avec ces sites web. Ainsi vous pouvez facilement les identifier. Vous pouvez refuser cette opération dans la page de vos paramètres, à la rubrique « Confidentialité ». Notez bien que désactiver ce paramètre signifie que vous ne serez plus en mesure de voir où vous avez utilisé chaque alias, et les noms de vos comptes ne se synchroniseront plus entre vos appareils. Vous pouvez en savoir plus sur les données que collecte { -brand-name-firefox-relay } dans notre <a href="{ $url }" { $attrs }>Politique de confidentialité</a>.
...
faq-question-detect-promotional-answer = De nombreux e-mails sont expédiés avec des métadonnées d’« en-tête » pour indiquer qu’ils proviennent d’outils automatisés se basant sur des listes. { -brand-name-firefox-relay } détecte ces données d’en-tête afin de bloquer ces e-mails.
faq-question-disable-trackerremoval-question = Puis-je annuler la suppression des traqueurs des e-mails ?
faq-question-disable-trackerremoval-answer = Oui. Si vous avez des soucis avec des e-mails qui s’affichent mal ou si vous souhaitez arrêter la suppression des traqueurs, vous pouvez désactiver cette fonctionnalité dans les paramètres.
...
faq-question-trackerremoval-breakage-question = Que faire si mes e-mails s’affichent mal ?
faq-question-trackerremoval-breakage-answer-2 = La suppression des traqueurs peut parfois provoquer des problèmes d’affichage, car les traqueurs sont souvent contenus dans des images et des liens. Quand le traqueur est supprimé, l’e-mail semble être mal formaté car il y manque ces images. Ce problème ne peut pas être corrigé pour des e-mails déjà reçus. Si cette fonctionnalité vous empêche de lire correctement vos e-mails, désactivez la suppression des traqueurs.

## Frequently Asked Questions about Phone plans

phone-masking-faq-question-what-is = Qu’est-ce qu’un alias de numéro de téléphone ?
phone-masking-faq-answer-what-is = Tout comme un alias de messagerie, un alias de numéro de téléphone est un numéro de téléphone qui peut transférer des SMS et des appels à votre véritable numéro de téléphone sans révéler ce dernier à la personne qui vous appelle ou vous envoie des SMS.

phone-masking-faq-question-where-is = Où les alias de numéro de téléphone sont-ils disponibles ?
phone-masking-faq-answer-where-is = Pour le moment, les alias de numéros de téléphone ne sont disponibles qu’aux États-Unis et au Canada. Cela signifie que vous pouvez recevoir des appels et des SMS transférés uniquement à partir de numéros étasuniens ou canadiens. Nous travaillons à trouver un moyen de proposer les alias de numéros de téléphone en dehors de ces deux pays.
...
phone-masking-faq-answer-historical = Vous ne pouvez pas actuellement répondre aux SMS que vous avez reçus précédemment, mais cette fonctionnalité est en cours de développement.
...
phone-masking-faq-answer-limit = Vous pouvez recevoir jusqu’à 75 SMS par mois au total et y répondre. Tout SMS supplémentaire envoyé à votre alias de numéro de téléphone ne sera pas transféré à votre véritable numéro. Aucune réponse supplémentaire ne sera envoyée. Le mois se réinitialise à votre date de facturation, et non au 1er jour du mois calendaire. Une fois votre mois de facturation écoulé, vous recommencerez à recevoir des SMS.

phone-masking-faq-question-call-length = De combien de temps est-ce que je dispose lorsque je reçois un appel ?
phone-masking-faq-answer-call-length = Chaque mois, vous disposez de 50 minutes de conversation. Une fois ces minutes épuisées, vous ne pourrez plus recevoir d’appels transférés avant le mois suivant de votre cycle de facturation.
...
phone-masking-faq-question-can-i-see = Puis-je voir qui m’a envoyé un SMS ou m’a appelé·e ?
phone-masking-faq-answer-can-i-see = Oui, vous pouvez voir le numéro qui vous a envoyé un SMS ou vous a appelé·e. Vous pouvez également désactiver le stockage de ces informations, mais vous perdrez la capacité de répondre aux appels et SMS de numéros spécifiques, ou de les bloquer.
...
phone-masking-faq-question-disable-logging = Puis-je désactiver la sauvegarde des numéros d’appel ou des expéditeurs de SMS ?
phone-masking-faq-answer-disable-logging = Oui, vous pouvez désactiver la sauvegarde des numéros depuis le tableau de bord de { -brand-name-relay }. Cependant, vous ne pourrez plus répondre aux SMS ou bloquer des numéros spécifiques, car le journal nous permet de savoir qui vous a envoyé un SMS.

phone-masking-faq-question-can-i-share = Puis-je partager le numéro qui me transfère les SMS ?
phone-masking-faq-answer-can-i-share = Si vous partagez ce numéro, rien ne se passera ; ce numéro n’est pas votre alias de numéro de téléphone. Il s’agit simplement du numéro de contact à partir duquel { -brand-name-relay } transfère vos SMS et vos appels.

phone-masking-faq-question-how-i-save-card = Comment enregistrer la carte de contact { -brand-name-relay } ?
phone-masking-faq-answer-how-i-save-card = Lorsque vous passerez aux alias de numéro de téléphone { -brand-name-relay }, nous vous enverrons une carte de contact contenant le numéro à partir duquel vous recevrez les appels et les SMS transférés, semblable à toute carte de contact qui stocke le numéro de téléphone des personnes qui vous contactent. Sur la plupart des appareils, vous pouvez sélectionner cette carte de contact et l’enregistrer comme n’importe quel autre contact sur votre téléphone.

phone-masking-faq-question-install-app = Dois-je installer une application pour utiliser l’alias de téléphone { -brand-name-relay } ?
phone-masking-faq-answer-install-app = Non, les alias de numéro de téléphone { -brand-name-relay } fonctionnent avec les applications de SMS et d’appels standards de votre appareil.
