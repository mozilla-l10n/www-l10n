...
not-found-page-donate-to-mozilla-reclaim-from-v2 = <a { $donate }>Faites un don</a> à la { -brand-name-mozilla-foundation } pour ne pas laisser les géants de la tech s’accaparer Internet.
