...
footer-refresh-visit-mozilla-corporations = Découvrez la <a { $moco_link }>{ -brand-name-mozilla-corporation }</a>, filiale mère de <a { $mofo_link }>{ -brand-name-mozilla-foundation }</a>.
