...
manifesto-visualize-who-you-interact = Visualiser avec qui vous interagissez sur Internet grâce à Lightbeam
manifesto-learn-about-creating-web = Apprendre à créer collectivement des ressources pour le Web
manifesto-host-or-join-a-maker-party = Héberger ou créer un évènement Maker Party
