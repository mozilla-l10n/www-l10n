...
facebook-container-facebook-can-track-almost = { -brand-name-facebook } peut suivre presque toutes vos activités sur le Web et les relier à votre identité { -brand-name-facebook }. Si cela vous semble excessif, <a href="{ $fbcontainer }">l’extension { -brand-name-facebook-container }</a> peut isoler votre identité dans un onglet conteneur séparé, ce qui rend plus difficile pour { -brand-name-facebook } de vous pister sur le Web en dehors de { -brand-name-facebook }.
