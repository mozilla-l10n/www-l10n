...
firefox-developer-get-involved = Participez
...
firefox-developer-firefox-quantum-includes = { -brand-name-firefox-quantum } dispose d’un tout nouveau moteur CSS écrit en Rust. Il profite des toutes dernières avancées technologiques et est super rapide.
...
firefox-developer-faster-performance = Rapide comme l’éclair
firefox-developer-shapes-editor = Éditeur de formes
firefox-developer-firefox-devtools-has-a-brand-new-v2 = Un nouvel éditeur de tracés de formes dans les outils de développement permet de ne plus avancer à l’aveugle pour aligner vos formes shape-outside et clip-path et de faire vos ajustements dans un éditeur visuel.
firefox-developer-firefox-devtools-has-a-brand-new = Un nouvel éditeur de tracés de formes dans les outils de développement permet de ne plus avancer à l’aveugle pour aligner vos formes shadow-outside et clip-path et de faire vos ajustements dans un éditeur visuel.
firefox-developer-faster-innovation = Des informations plus rapides
firefox-developer-fonts-panel = Panneau de polices
firefox-developer-the-new-fonts-panel = Le nouveau panneau de polices dans les outils de développement de Firefox permet aux développeurs d’accéder rapidement à toutes les informations pertinentes concernant les polices utilisées sur un élément. Il s’agit notamment de leur source, formatage, style, etc.
...
firefox-developer-welcome-to-the-all-new = Bienvenue dans le tout nouveau { -brand-name-firefox-quantum } : { -brand-name-developer-edition }
