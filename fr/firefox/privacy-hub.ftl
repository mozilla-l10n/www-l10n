...
firefox-privacy-hub-we-make-a-point-of-knowing = Nous mettons un point d’honneur à en savoir le moins possible sur vous
firefox-privacy-hub-all-tech-companies-collect = Toutes les entreprises en ligne recueillent des données afin d’améliorer leurs services. Mais elles n’ont pas besoin de recueillir autant d’informations personnelles vous concernant. Les seules données qui nous intéressent sont celles qui finiront par vous servir. Nous nous posons toujours les questions suivantes : avons-nous vraiment besoin de ces données ? À quoi serviront-elles ? Quand pourrons-nous les supprimer ?
firefox-privacy-hub-keep-it-safe = Plus de protection
firefox-privacy-hub-we-do-the-hard-work-to-protect = C’est nous qui faisons le travail pour protéger vos données personnelles
...
firefox-privacy-hub-theres-no-hidden-agenda-here-v2 = Nous n’avons aucune intention cachée. Notre entreprise ne dépend pas de l’abus de votre confiance. Notre <a href="{ $privacy }">Politique de confidentialité</a> est lisible et facile à comprendre. Si vous voulez tout savoir sur les données que nous collectons, vous pouvez le faire à tout moment car notre code est ouvert. Comme nous.
...
firefox-privacy-hub-learn-about-our-products = En savoir plus sur nos produits
...
firefox-privacy-hub-mozilla-protects-your-privacy = { -brand-name-mozilla } protège votre vie privée dans chacun de ses produits.
...
firefox-privacy-hub-mozilla-protects-your-privacy-strong = { -brand-name-mozilla } <strong>protège</strong> votre vie privée dans chacun de ses produits.
...
firefox-privacy-hub-meet-four-of-the-most-common = Découvrez les quatre catégories de traqueurs les plus fréquents.
