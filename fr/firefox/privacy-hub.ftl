...
firefox-privacy-hub-we-make-a-point-of-knowing = Nous mettons un point d’honneur à en savoir le moins sur vous que possible
firefox-privacy-hub-all-tech-companies-collect = Toutes les entreprises en ligne recueillent des données afin d’améliorer leurs services. Mais elles n’ont pas besoin de recueillir autant d’informations personnelles vous concernant. Les seules données que nous nécessitons sont celles qui finiront par vous servir. Nous nous posons toujours les questions suivantes : avons-nous vraiment besoin de ces données ? À quoi serviront-elles ? Quand pourrons-nous les supprimer ?
...
firefox-privacy-hub-more-than-s-trackers-blocked = Plus de { $trackers } de traqueurs bloqués chaque jour pour l’ensemble des utilisateurs de Firefox dans le monde entier
