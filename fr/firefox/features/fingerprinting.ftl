...
# page description
features-fingerprinting-fingerprinting-is-a-desc = La détection d’empreinte numérique est un nouveau type de suivi en ligne, encore plus invasif que le suivi ordinaire basé sur les cookies. C’est pour cette raison que { -brand-name-firefox-browser } la bloque.
