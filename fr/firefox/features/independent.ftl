...
# Obsolete string
features-independent-firefox-is-a-browser = { -brand-name-firefox } est un navigateur avec des valeurs. Dans le cadre de la technologie de { -brand-name-mozilla }, une organisation à but non lucratif, nous luttons pour vos droits numériques, échappons à la mainmise des entreprises et aidons les pays en développement à adopter de bonnes pratiques Internet. Ainsi, quand vous choisissez { -brand-name-firefox }, c’est aussi un peu nous qui vous choisissons.
