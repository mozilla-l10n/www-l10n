...
features-adblocker-if-you-want-to-learn-more = Si vous voulez en savoir plus sur les bloqueurs de pubs, il y a des centaines d’extensions disponibles pour { -brand-name-firefox } et d’autres navigateurs. Si vous voulez essayer les bloqueurs que { -brand-name-firefox } utilise, <a href="{ $url }">cliquez ici pour télécharger</a> un navigateur qui met en avant la confidentialité.
