...
features-index-important-stuff = Assurez-vous que tous vos éléments importants (recherches sur Internet, mots de passe, onglets ouverts) apparaissent là où vous en avez besoin sur chaque appareil.
features-index-get-an-account = Créer un { -brand-name-firefox-account }
features-index-use-the-bookmark = Utilisez l’icône d’étoile des marque-pages pour rester organisé·e et ajouter des noms et des dossiers personnalisés rapidement.
features-index-from-the-company = Par une entreprise qui fait passer les gens avant les profits
features-index-private-browsing-mode = Le mode de navigation privée supprime les données des cookies et votre historique de navigation chaque fois que vous le fermez.
...
features-index-access-all-passwords = { -brand-name-firefox-lockwise } vous permet d’accéder à tous les mots de passe que vous avez enregistrés dans { -brand-name-firefox }, et c’est gratuit.
features-index-just-enough = { -brand-name-firefox } utilise juste assez de mémoire pour créer une expérience fluide et que votre ordinateur reste réactif pour les autres tâches.
features-index-use-less-memory = { -brand-name-firefox } utilise moins de mémoire que { -brand-name-chrome }, afin que vos autres programmes puissent continuer de fonctionner à leur vitesse maximale.
...
features-index-read-mozillas-mission = Lisez la mission de { -brand-name-mozilla }
...
features-index-get-firefox-for-privacy = Installez { -brand-name-firefox } pour le respect de votre vie privée
features-index-firefox-vs = { -brand-name-firefox } comparé aux autres navigateurs
features-index-stack-up = Découvrez ce qui distingue { -brand-name-firefox } d’autres navigateurs populaires.
