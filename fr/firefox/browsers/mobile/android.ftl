...
mobile-android-go-mobile-go = Passez au mobile. Soyez indépendant avec { -brand-name-firefox } pour { -brand-name-android }
# Obsolete string
mobile-android-when-you-download = Lorsque vous téléchargez { -brand-name-firefox }, vous choisissez de soutenir une entreprise tech indépendante. { -brand-name-firefox } est le seul navigateur majeur soutenu par une organisation à but non lucratif et qui vous offre plus d'ouverture, de transparence et de contrôle sur votre vie en ligne.
mobile-android-get-firefox-for = Téléchargez { -brand-name-firefox } pour { -brand-name-android }
