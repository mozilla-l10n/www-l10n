...
mobile-ios-now-iphone-and = Désormais, les utilisateurs d'{ -brand-name-iphone } et { -brand-name-ipad } peuvent choisir leur propre navigateur par défaut. Cela signifie que vous n'êtes pas obligé d'utiliser { -brand-name-safari } et que votre navigateur mobile peut rester synchronisé avec votre navigateur de bureau préféré. De plus, lorsque vous définissez { -brand-name-firefox } comme navigateur par défaut, vous soutenez une entreprise tech indépendante. { -brand-name-firefox } est également le seul navigateur majeur soutenu par une organisation à but non lucratif.
...
mobile-ios-add-firefox-across-v2 = Ajoutez { -brand-name-firefox } sur tous vos appareils pour une navigation sécurisée et transparente. Synchronisez vos appareils pour emporter partout où vous allez vos favoris, vos identifiants de connexion enregistrés, vos mots de passe et votre historique de navigation. De plus, envoyez des onglets ouverts entre votre téléphone et votre bureau pour reprendre là où vous vous étiez arrêté.
mobile-ios-get-to-your-go-to = Accédez plus rapidement à vos sites préférés sur votre { -brand-name-iphone } et { -brand-name-ipad }.
mobile-ios-see-your-open-tabs = Trouvez vos onglets ouverts, vos recherches antérieures et vos sites préférés au même endroit avec { -brand-name-firefox-browser } pour { -brand-name-ios }.
...
mobile-ios-open-a-new = Ouvrez un nouvel onglet dans { -brand-name-firefox } pour voir les sites que vous visitez le plus et vos marques-pages récents. { -brand-name-firefox } vous donne un accès rapide à vos sites les plus récemment utilisés pour vous aider à trouver ce que vous cherchez plus rapidement.
