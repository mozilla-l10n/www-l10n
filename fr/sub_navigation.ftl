...
sub-navigation-compare-mobile-browsers = Comparer les navigateurs mobiles
...
sub-navigation-ios-support = Assistance pour { -brand-name-ios }
sub-navigation-android-support = Assistance pour { -brand-name-android }
...
sub-navigation-firefox-features = Fonctionnalités de { -brand-name-firefox }
