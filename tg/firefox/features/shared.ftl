...
features-shared-free-password-manager = Мудири ниҳонвожаҳо
features-shared-customize-your-firefox-browser = Браузери «{ -brand-name-firefox }»-и худро ба таври дилхоҳ танзим кунед
features-shared-firefox-browser-sync = Ҳамоҳангсозии браузери «{ -brand-name-firefox }»
features-shared-bookmark-manager = Мудири хатбаракҳо
features-shared-private-browsing-mode = Реҷаи «Тамошокунии хусусӣ»
features-shared-firefox-add-ons-and-browser-extensions = Ҷузъҳои иловагӣ ва васеъшавиҳои браузери «{ -brand-name-firefox }»
features-shared-pinned-browser-tabs = Варақаҳои васлшудаи браузер
features-shared-eyedropper-tool = Абзори «Чинандаи ранг»
