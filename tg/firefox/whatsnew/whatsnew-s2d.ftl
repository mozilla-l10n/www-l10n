...
whatsnew-s2d-want-privacy-on-every-device = Дар ҳар як дастгоҳ махфият лозим аст?
# "You got it" here is a casual answer to the previous question, "Want privacy on every device?"
whatsnew-s2d-you-got-it-get-firefox-for = Ягон мушкилӣ нест. Браузери «{ -brand-name-firefox }»-ро барои дастгоҳи мобилии худ интихоб намоед.
