...
firefox-all-qrcode = Барои ба даст овардани «<em>{ $product_name }</em>» рамзи QR-ро аксбардорӣ намоед
...
firefox-all-windows-installers-for = Насбкунандаҳои «Windows» барои технологияҳои иттилоотии корхонаҳо, ки танзимот, ҷойгиркунӣ ва идоракунии «{ -brand-name-firefox-browser }»-ро осон месозанд.
