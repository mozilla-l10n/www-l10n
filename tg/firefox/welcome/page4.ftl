...
# HTML page title
welcome-page4-download-the-firefox-browser = Браузери «{ -brand-name-firefox-browser }»-ро дар дастгоҳи мобилии худ барои «{ -brand-name-ios }» ва «{ -brand-name-android }» боргирӣ намоед
welcome-page4-wallet-keys-phone-firefox = Ҳамён. Калидҳо. Телефон. <strong>Браузери «{ -brand-name-firefox }».</strong>
welcome-page4-privacy-every-screen-now = Акнун махфият дар ҳар як экрани шумо пайдо мешавад
welcome-page4-take-privacy-with-you-on-every = Дар ҳар як дастгоҳ махфиятро бо худ гиред - ва васоити пайгирии маълумотро дар паси худ гузоред.
welcome-page4-privacy-on-by-default = Махфияти шумо бо браузери нави «{ -brand-name-firefox }» барои «{ -brand-name-android }» ба таври пешфарз фаъол карда мешавад — ва акнун шумо метавонед браузери «{ -brand-name-firefox }»-ро ҳамчун браузери асосии худ дар «{ -brand-name-ios } 14» истифода баред.
