...
history-people-contributed-to-mozilla = Одамон бо роҳҳои гуногун ба «{ -brand-name-mozilla }» саҳм гузоштанд, аммо ҳар як кас бо эҷоди нармафзори ройгоне дӯст шуданд, ки ба одамон имкон медиҳад, то онҳо тавонанд таҷриба шахсиро барои кор дар Интернет интихоб намоянд.
