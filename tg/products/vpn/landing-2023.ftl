...
vpn-landing-customize-your-vpn = Танзимоти муҳофизати «VPN»-и худро барои ҳар як сомона бо истифода аз васеъшавии «{ -brand-name-mozilla-vpn }» барои «{ -brand-name-firefox }» (танҳо барои «Windows») фардисозӣ намоед.
...
# HTML for emphasis
vpn-landing-powered-by-mozilla-fighting-for = <strong>Аз ҷониби ташкилоти «{ -brand-name-mozilla }» дастгирӣ карда мешавад.</strong> Аз соли 1998 барои ҳуқуқҳои шумо ба махфияти ҷиддӣ дар Интернет мубориза мекунад.
vpn-landing-learn-more-from-our-experts = Маълумоти бештар аз мутахассисони мо
vpn-landing-do-you-need-a-vpn-at-home = Оё ба шумо дар хона истифодаи «VPN» лозим аст? Инак, 5 сабаби имконпазир барои шумо дар ин ҷост.
