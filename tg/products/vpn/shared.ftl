...
# Variables:
#   $amount (string) - a string containing the total annual subscription price together with the appropriate currency symbol e.g. '35,94 €'
vpn-shared-pricing-total-plus-tax = Ҳамагӣ: { $amount } + андоз
...
vpn-subnav-whats-a-vpn = «VPN» чӣ аст?
vpn-subnav-faqs = Саволҳои роиҷ (FAQ)
vpn-subnav-get-help = Гирифтани кумак
vpn-subnav-platform-android = { -brand-name-android }
vpn-subnav-platform-desktop = Мизи корӣ
vpn-subnav-platform-ios = { -brand-name-ios }
vpn-subnav-platform-linux = { -brand-name-linux }
vpn-subnav-platform-mac = { -brand-name-mac-short }
vpn-subnav-platform-mobile = Мобилӣ
vpn-subnav-platform-windows = { -brand-name-windows }
vpn-subnav-whats-an-ip-address = Нишонии «IP» чӣ аст?
vpn-subnav-when-to-use-a-vpn = Кадом вақт «VPN» истифода мешавад
vpn-subnav-vpn-vs-proxy = Муқоисаи «VPN» бо «Proxy»
vpn-subnav-subscribe = Ба «{ -brand-name-mozilla-vpn }» обуна шавед
vpn-subnav-learn-about-vpns = Маълумоти бештар дар бораи имконоти «VPN»
vpn-subnav-download-mozilla-vpn = Боргирӣ кардани «{ -brand-name-mozilla-vpn }»
vpn-subnav-features = Хусусиятҳо
