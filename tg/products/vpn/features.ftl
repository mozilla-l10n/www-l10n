...
vpn-features-page-title = Хусусиятҳо - «{ -brand-name-mozilla-vpn }»
...
vpn-features-combine-mozilla-vpn-with-containers = Барномаи «{ -brand-name-mozilla-vpn }»-ро бо васеъшавии дарбаргирандаи серҳисоби «{ -brand-name-firefox }» ҳамроҳ истифода баред ва ҷойгиршавиҳои гуногуни «VPN»-ро барои ҳар як варақаи алоҳидаи «{ -brand-name-firefox }» танзим намоед. <a { $containers }>Бифаҳмед, ки чӣ тавр</a>.
