...
footer-follow-mozilla = @{ -brand-name-mozilla } жазылу
footer-follow-firefox = @{ -brand-name-firefox } жазылу
footer-about-this-site = Бұл сайт туралы
footer-advertise = { -brand-name-mozilla } арқылы жарнамалаңыз
