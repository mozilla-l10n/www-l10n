...
footer-refresh-file-a-bug = Ақаулық жөнінде хабарлау
footer-refresh-localize-mozilla = { -brand-name-mozilla } аудару
footer-refresh-security = Қауіпсіздік
footer-refresh-developers = Әзірлеушілер
