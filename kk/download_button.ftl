...
download-button-supported-devices = Қолдауы бар құрылғылар
...
download-button-get-firefox-android = { -brand-name-android } үшін { -brand-name-firefox } қолданбасын алу
download-button-get-firefox-ios = { -brand-name-ios } үшін { -brand-name-firefox } алу
download-button-google-play = Оны { -brand-name-google-play } ішінен алыңыз
download-button-free-google-play = Оны { -brand-name-google-play } ішінен тегін алыңыз
download-button-app-store = Оны { -brand-name-app-store } ішінен тегін алыңыз
