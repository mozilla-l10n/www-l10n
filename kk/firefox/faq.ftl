...
how-do-i = { -brand-name-firefox-browser } қалай алуға болады?
...
see-how-firefox = <a href="{ $url }">{ -brand-name-firefox } пен { -brand-name-chrome } салыстырмасын көріңіз.</a>
...
does-firefox-have = { -brand-name-firefox } браузерінде іштей орнатылған VPN бар ма?
# Variables:
# $url (url) - link to https://www.mozilla.org/products/vpn/
firefox-does-not-v2 = { -brand-name-firefox } браузерінде іштей орнатылған VPN (виртуалды жеке желі) жоқ, бірақ { -brand-name-mozilla } компаниясы Wi-Fi қосылымын және IP адресіңізді қорғайтын, жеке { -brand-name-firefox-browser } браузеріне қосымша ретінде пайдалануға болатын <a href="{ $url }">{ -brand-name-mozilla-vpn }</a> өнімін жасап шығарды.
