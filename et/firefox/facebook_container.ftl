...
# Variables:
#   $fbcontainer (url) - link to https://addons.mozilla.org/firefox/addon/facebook-container/
facebook-container-installing-the-extension-is = <a href="{ $fbcontainer }">Lisa</a> paigaldamine on lihtne ja aktiveerituna avatakse { -brand-name-facebook } igal kasutamisel sinisel kaardil. Kasuta ja naudi { -brand-name-facebook }i tavapäraselt. { -brand-name-facebook } saab sulle endiselt saata reklaame ja soovitusi nende lehel, kuid sel on palju raskem kasutada <strong>väljaspool { -brand-name-facebook }i</strong> kogutud tegevusi sulle reklaami ja teiste suunatud sõnumite saatmiseks.
facebook-container-about-firefox-and-mozilla = { -brand-name-firefox }ist ja { -brand-name-mozilla }st
# Variables:
#   $mozilla (url) - link to https://www.mozilla.org/
facebook-container-were-backed-by-mozilla-the = Meid toetab <a href="{ $mozilla }">{ -brand-name-mozilla }</a>, mittetulunduslik organisatsioon, mis eelistab inimesi kasumile, et anda kõigile veebis rohkem võimu. Lõime selle lisa, sest usume, et sul peaksid olema kergesti kasutatavad vahendid, mis aitavad privaatsuse ja turvalisuse haldamisel.
facebook-container-browse-freely-with-firefox = Sirvi { -brand-name-firefox }iga veebi vabalt juba täna.
