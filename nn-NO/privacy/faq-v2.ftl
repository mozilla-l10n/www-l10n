...
# HTML page title
privacy-faq-v2-title = { -brand-name-mozilla }s ofte stilte spørsmål om informasjonssikkerheit
# HTML page description
privacy-faq-v2-desc = Hos { -brand-name-mozilla } respekterer og beskyttar vi den personlege informasjonen din.
