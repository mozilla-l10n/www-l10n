...
# HTML page title
privacy-faq-mozillas-data-privacy-faq = { -brand-name-mozilla }s ofte stilte spørsmål om informasjonssikkerheit
privacy-faq-at-mozilla-we-respect-and-protect-desc = Hos { -brand-name-mozilla } respekterer og beskyttar vi den personlege informasjonen din.
privacy-faq-we-stand-for-people-over-profit = Vi står for menneske framfor profitt.
privacy-faq-it-can-be-tricky-for-people = Det kan vere vanskeleg å vite kva ein kan vente seg av programvare og tenester no for tida. Dagens teknologi er kompleks, og dei færraste har tid til å setje seg inn i detaljane. Det gjeld òg for { -brand-name-firefox }, der vi ser, at brukarane har mange ulike idear om kva som skjer under panseret i nettlesarane deira.
privacy-faq-at-mozilla-we-respect-and-protect = Hjå { -brand-name-mozilla } respekterer og vernar vi om den personlege informasjonen din:
# Variables:
...
privacy-faq-we-never-sell-your = Vi sel aldri personopplysningane dine. I motsetning til dei store teknologigigantane som samlar inn og tener pengar på personopplysningane dine, er vi bygde med personvern som standard. Vi kjenner ikkje alderen din, kjønn, nøyaktig lokasjon eller annan informasjon som dei store teknologigigantane samlar inn og tener pengar på.
