...
manifesto-visualize-who-you-interact = Få eit bilde av kven du samhandlar med på nettet, med Lightbeam
manifesto-learn-about-creating-web = Les meir om korleis du skaper nettressursar saman med andre
manifesto-host-or-join-a-maker-party = Ver vert for eller delta i eit Maker Party
...
manifesto-details-mozilla-foundation = Stiftinga Mozilla sitt høgtidlege løfte
manifesto-details-the-mozilla-foundation-pleges = Stiftinga { -brand-name-mozilla } lovar å støtte { -brand-name-mozilla }-manifestet i alle aktivitetane sine. Vi kjem særkilt til å:
...
manifesto-details-some-foundation = Nokre aktivitetar – for tida skaping, leveranse og marknadsføring av konsumentprodukt – skjer først og fremst gjennom stiftinga Mozilla sitt heileigde dotterselskap, { -brand-name-mozilla-corporation }.
manifesto-details-invitation = Invitasjon
manifesto-details-the-mozilla-foundation-invites = Stiftinga { -brand-name-mozilla } inviterer alle som støttar grunnprinnsippa i { -brand-name-mozilla }-manifestet, til å vere med oss og finne nye måtar å verkeleggjere visjonen av internett, slik som manifestet skildrar.
