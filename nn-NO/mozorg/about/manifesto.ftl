...
manifesto-transparent-community = Transparente, fellesskapsbaserte prosessar fremmar deltaking, ansvarstaking og tiltru.
...
manifesto-share-on-x-aria-label = Del på X (tidlegare Twitter)
