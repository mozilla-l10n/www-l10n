...
vpn-download-page-description = Last ned { -brand-name-mozilla-vpn } for { -brand-name-windows }, { -brand-name-mac }, { -brand-name-linux }, { -brand-name-android } och { -brand-name-ios }.
# Variables:
