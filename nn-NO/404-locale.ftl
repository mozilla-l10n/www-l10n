...
not-found-locale-title = Vel språk for Mozilla.org
not-found-locale-desc = Vel landet eller regionen din for å indikere det føretrekte språket ditt.
not-found-locale-not-yet-translated = Sida er ikkje omsett enno
# Variables:
