...
welcome-page3-never-forget-reset-or-travel = Gløym aldri, å tilbakestille eller reise utan passorda dine igjen.
welcome-page3-facebook-container = { -brand-name-facebook-container }
welcome-page3-get-a-container-to-keep-facebook = Hindre at { -brand-name-facebook } sporar deg på nettet.
welcome-page3-pocket = { -brand-name-pocket }
welcome-page3-trade-clickbait-and-fake-news = Byt ut «clickbait» og falske nyheiter med kvalitetsinnhald.
welcome-page3-firefox-send = { -brand-name-firefox-send }
welcome-page3-send-huge-files-to-anyone = Send store filer til alle du ønskjer, med selvdestruerande lenker.
welcome-page3-why-am-i-seeing-this = Kvifor ser eg dette?
