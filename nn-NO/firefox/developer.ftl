...
firefox-developer-the-new-firefox-devtools = Dei nye utviklarverktøya (DevTools) i Firefox er avanserte og fleksible, og du kan du tilpasse dei etter behov. Du får mellom anna ein JavaScript-debugger, som er langt betre enn andre debuggarar. Den nye debuggaren er bygd i React og Redux, og du kan bruke han med ulike nettlesarar.
