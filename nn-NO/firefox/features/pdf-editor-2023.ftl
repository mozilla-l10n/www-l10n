...
pdf-editor-open-the-pdf-in-firefox-click-draw = Opne PDF-en i { -brand-name-firefox }. Klikk på Teikne-ikonet for å velje ein farge, tjukn, og opasitet før du vel kvar i dokumentet du vil teikne. So enkelt er det! Det vert venteleg ikkje meir rotete enn den vanlege signaturen din!
pdf-editor-add-image-with-alt-text = Legg til bilde med alternativ tekst
pdf-editor-open-pdf-click-image-icon = Opne PDF-en i { -brand-name-firefox }. Klikk på bilde-ikonet, som vil be deg om å laste opp eit bilde. Juster størrelse og plassering av bildet etter behov. Klikk på knappen «+Alt tekst» på bildet for å leggje til ei bildeskildring, som vil gjere PDF-en din meir tilgjengeleg.
