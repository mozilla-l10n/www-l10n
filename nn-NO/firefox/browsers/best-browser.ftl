...
best-browser-the-internet-has-become = Internett har blitt like viktig som straum og innlagt vatn, så derfor er det viktigare enn nokon gong å velje den nettlesaren, som passar for deg. Internett er eit kontor nummer to, ein lærar og nokre gongar ein medisinsk rådgivar, sjølv om legen din ikkje likar at du slo opp symptoma dine på nettet.
...
best-browser-today-is-a-different = I dag er det annleis. Annonsar, angrep på personvern, sikkerheitsbrot og falske nyheiter kan føre til at du ser på andre kvalitetar i nettlesaren. Korleis beskyttar nettlesaren privatlivet ditt? Lar han sporfølgjarar følgje deg på nettet? Er han utvikla for fleiroppgåvekøyring og kan handtere mange data- og internettoperasjonar samtidig?
best-browser-when-you-use-a-browser = Når du brukar ein nettlesar til alt, så er det viktig at han er rask. Men av akkurat same grunn er nettlesaren din nøydd til å respektere privatlivet ditt. Ein nettlesar har tilgang til alt, du gjer på nettet - så han kan sette deg i alvorleg fare, dersom han ikkje har sterke funksjonar for å beskytte privatlivet ditt.
