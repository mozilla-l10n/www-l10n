...
compare-brave-the-firefox-browser-also-gives = { -brand-name-firefox }-nettlesaren gir også brukarane moglegheita til å registrere ein gratis <a { $accounts }>{ -brand-name-firefox-account }</a>. Å ha ein { -brand-name-firefox }-konto er nøkkelen til å låse opp synkronisering på tvers av einingar, pluss at du får ein ekstra fordel med produkt som <a { $monitor }>{ -brand-name-firefox-monitor }</a> som overvakar e-postadressene dine og varslar deg om noko av informasjonen din har vore involvert i kjende <a { $breaches }>datalekkasjar</a>.
# "Basic Attention Token" is a brand name.
