...
compare-brave-brave-differentiates-itself = { -brand-name-brave } skil seg frå dei andre { -brand-name-chromium }-nettlesarane ved å fokusere på personvernet til brukaren — spesifikt ved å blokkere sporarar, skript og annonsar som standard. Så når du brukar { -brand-name-brave }-nettlesaren, visest områda på ein nettstad som normalt vil vise annonsar som tomme mellomrom. I nokre tilfelle vert ikkje sider lasta skikkeleg inn, noko som krev at du anten vel ein annan nettlesar eller vippar innstillinga «Shields Up» til «Shields Down» som slår av person- og sikkerheitsvernet.
...
compare-brave-there-are-a-few-of-braves = Det er nokre få sikkerheitsfunksjonar i { -brand-name-brave } som er verd å framheve, til dømes den automatiske oppgraderinga til HTTPS-tilkoplingar (som { -brand-name-firefox } også tilbyr med ei <a { $extension }>utviding</a> ). Både { -brand-name-brave } og { -brand-name-firefox } tilbyr brukarane ein innebygd <a { $lockwise }>passordhandterar</a> og moglegheita til å sjekke tryggingsstatistikken sin når som helst. { -brand-name-brave } viser statistikk som tal på sporarar den har blokkert når du opnar ei ny fane. { -brand-name-firefox } viser liknande informasjon når du ser <a { $privacy }>personvernrapporten</a> som du kan få tilgang til når som helst ved å klikke på skjoldet i adressefeltet.
# "Basic Attention Token" is a brand name.
compare-brave-the-bottom-line-is-that-even = Hovudpoenget er at sjølv om { -brand-name-brave } sin inntektsmodell med Basic Attention Tokens kan vere for komplisert for mange brukarar, tilbydr både { -brand-name-brave }- og { -brand-name-firefox }-nettlesarar ei rekkje måtar å glede seg over ei trygg og privat nettoppleving.
compare-brave-what-might-surprise-some-new = Det som kan overraske enkelte nye { -brand-name-brave }-brukarar, er kor raskt sider har ein tendens til å laste i nettlesaren. Årsaka til desse raske lastetidene er at sider vert lasta mykje raskare når du blokkerer all annonsering på dei. Det er ganske enkelt mindre å laste, og derfor tar det mindre tid.
compare-brave-in-terms-of-actual-precious = Når det gjeld faktisk verdifull RAM-bruk, er { -brand-name-brave }-nettlesaren mykje tyngre enn { -brand-name-firefox }. { -brand-name-brave } vert levert førehandsinnlasta med ulike og «tillegg» som kan tilskrivast bruken av meir RAM. { -brand-name-firefox } lar deg derimot bestemme kva for tillegg du vil leggje til.
# Variables:
...
compare-brave-customization-of-ui-elements = Tilpassing av brukargrensesnittelement og tema har vore ein favorittfunksjon hos { -brand-name-firefox }-brukarar i mange år, og vårt ivrige samfunn av utviklarar har laga eit <a { $addons }>enormt bibliotek</a> med open kjeldekode-tillegg og utvidingar som gir endå meir tilpassing og funksjonalitet. Funksjonar som følgjer med { -brand-name-firefox } når du lastar ned inkluderer det kraftige <a { $screenshot }>skjermdumpverktøyet</a> vårt, tilgjengefunksjonar og integrasjon med <a { $pocket }>{ -brand-name-pocket }</a> — ein ressurs som lar brukarar raskt lagre ein artikkel for seinare lesing på alle einingar.
compare-brave-brave-also-supports-the-huge = { -brand-name-brave } støttar også det enorme biblioteket med utvidingar som er tilgjengelege i { -brand-name-google } { -brand-name-chrome } nettmarknad og tilbyr ei rekkje funksjonar i nettlesaren som den nemnde { -brand-name-brave } Rewards-program, og støtte for nedlasting av torrentar direkte i nettlesaren.
compare-brave-the-ability-to-sync-your-passwords = Evna til å synkronisere passord, utvidingar, skjemadata, tilleggsprogram og andre innstillingar på tvers av alle einingane og operativsystema dine, er ein funksjon som har vore tilgjengelig i mange år i { -brand-name-firefox }. Synkroniserte data er også krypterte, noko som betyr at ingen har tilgang til dei utanfrå.
# Variables:
...
compare-brave-when-comparing-the-two-browsers = Når du samanliknar dei to nettlesarane, tilbyr både { -brand-name-firefox } og { -brand-name-brave } eit sofistikert nivå av personvern og sikkerheit som standard, automatisk tilgjengeleg heilt frå første gong du opner dei.
compare-brave-overall-brave-is-a-fast-and = Totalt sett er { -brand-name-brave } ein rask og sikker nettlesar som vil appellere til brukarar av kryptovaluta. Men for dei aller fleste internettborgarar er { -brand-name-firefox } framleis ei betre og enklare løysing.
compare-brave-braves-advertising-replacement = { -brand-name-brave } sin ide om erstatning av reklame er ein vri på den gjeldande modellen for betalt annonseplassering og betalt søk. Men igjen vil enkelte travle Internett-brukarar sannsynlegvis ikkje ønskje å bli involvert i behandling av mikrobetalingar til nettstadar i byte for tida og merksemda si.
