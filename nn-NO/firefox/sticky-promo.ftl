...
firefox-sticky-promo-meet-our-family-of = Møt produktfamilien vår
firefox-sticky-promo-get-the-latest-firefox = Last ned den siste { -brand-name-firefox }-nettlesaren.
# Products List
firefox-sticky-promo-browsers = Nettlesarar
