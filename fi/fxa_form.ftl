...
# Obsolete string
fxa-form-enter-your-email = Siirry { -brand-name-firefox-accounts(case: "illative") } <strong>syöttämällä sähköpostiosoitteesi</strong>.
fxa-form-enter-your-email-v2 = <strong>Kirjoita sähköpostiosoitteesi</strong> luodaksesi { -brand-name-mozilla-account }n.
# Variables:
