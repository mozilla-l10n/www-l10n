...
welcome-page5-with-256-bit-encryption-your = 256-bittisellä salauksella salasanat kulkevat aina mukanasi laitteillesi turvallisesti.
welcome-page5-no-more-making-up-new-passwords = Ei enää uusien salasanojen keksimistä
welcome-page5-lockwise-will-recommend-new = { -brand-name-lockwise } suosittelee uusia vahvoja salasanoja aina, kun määrität uuden kirjautumisen.
welcome-page5-help-during-a-breach = Apua tietovuodon aikana
welcome-page5-lockwise-will-let-you-know = { -brand-name-lockwise } ilmoittaa sinulle, jos tallennetut kirjautumistietosi ovat olleet tietomurron kohteena, jotta voisit muuttaa ne mahdollisimman pian.
welcome-page5-why-am-i-seeing-this = Miksi näen tämän sivun?
