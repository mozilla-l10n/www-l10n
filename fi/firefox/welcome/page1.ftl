...
welcome-page1-find-ways-to-protect-your = Löydä tapoja suojata tietojasi <a href="{ $security_tips }">{ -brand-name-monitor }in tietoturvavihjeillä</a>.
welcome-page1-stay-in-the-know = Pysy tietoisena
...
welcome-page1-were-you-one-of-many = Olitko sinä yksi 100 985 047 kutsutusta <a href="{ $evite_breach }">"Evite-tietovuotojuhlaan"</a>?
