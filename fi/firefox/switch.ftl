...
switch-switching-to-firefox-is-fast-updated = Siirtyminen { -brand-name-firefox }iin on nopeaa, helppoa ja riskitöntä, koska { -brand-name-firefox } tuo kirjanmerkkisi, salasanasi ja asetuksesi { -brand-name-chrome }sta.
...
switch-switching-to-firefox-page-description-updated = Vaihtaminen { -brand-name-firefox }iin on nopeaa, helppoa ja riskitöntä. { -brand-name-firefox } tuo kirjanmerkkisi, salasanasi ja asetuksesi kohteesta { -brand-name-chrome }sta.
...
switch-spread-the-word = Levitä sanaa { -brand-name-firefox }ista ja auta ystäviäsi sanomaan näkemiin { -brand-name-chrome }lle.
...
switch-share-to-bluesky = Jaa Blueskyssä
switch-hey = Terve,
