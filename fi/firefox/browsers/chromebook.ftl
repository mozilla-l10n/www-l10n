...
browsers-chromebook-install-firefox-as = Asenna { -brand-name-firefox } { -brand-name-linux }-sovelluksena: tällä reitillä kulkeminen on muutaman vaiheen työläämpi, mutta se on sen arvoista. Kun asennat { -brand-name-firefox }-selaimen { -brand-name-linux }-sovelluksena, saat käyttöösi { -brand-name-firefox }-työpöytäselaimen ja kaikki sen mukana tulevat edut, mukaan lukien parannetun jäljityssuojauksen, sisäänrakennetun salasananhallinnan, pääsyn tuhansiin lisäosiin (mukaan lukien UBlock Origin -mainosesto) ja teemoja selaimesi ulkoasun mukauttamiseen. <a { $url }>Lisätietoja { -brand-name-firefox }-työpöytäselaimen asentamisesta { -brand-name-chromebook }iin.</a>
