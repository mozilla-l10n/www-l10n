...
compare-shared-dashboard-to-review = Yhteenvetonäkymä estettyjen seurainten tarkistamiseen
compare-shared-autoplay-blocking = Automaattisen toiston esto
compare-shared-tab-browsing = Selaus välilehtiä käyttäen
compare-shared-bookmark-manager = Kirjanmerkkien hallinta
compare-shared-automatically-fills-out-forms = Täyttää lomakkeet automaattisesti
compare-shared-automatically-fills-out-payments = Täyttää maksut automaattisesti
compare-shared-search-engine-options = Hakukoneasetukset
compare-shared-text-to-speech = Teksti puheeksi
compare-shared-reader-mode = Lukutila
compare-shared-spell-checking = Oikeinkirjoituksen tarkistus
compare-shared-web-extensionsadd-ons = Verkkolaajennukset/lisäosat
compare-shared-in-browser-screenshot-tool = Selaimen sisäinen kuvakaappaustyökalu
compare-shared-os-availability = Saatavuus käyttöjärjestelmille
compare-shared-mobile-os-availability = Saatavuus mobiilikäyttöjärjestelmille
...
compare-shared-download-firefox = Lataa { -brand-name-firefox }
compare-shared-download-firefox-browser = Lataa { -brand-name-firefox-browser }
compare-shared-download-the-app = Lataa sovellus
compare-shared-desktop = Työpöytä
