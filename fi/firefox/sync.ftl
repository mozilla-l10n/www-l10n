...
firefox-sync-access-and-sync = Käytä ja synkronoi kirjanmerkkejä, salasanoja, avoimia välilehtiä ja paljon muuta — kaikkialla, missä käytät { -brand-name-firefox }ia.
firefox-sync-firefox = { -brand-name-firefox-browser }
firefox-sync-sync-your-firefox = Synkronoi { -brand-name-firefox } millä tahansa laitteella
firefox-sync-privacy-made-easy = Yksityisyys on tehty helpoksi
firefox-sync-all-you-need = Tarvitset { -brand-name-firefox-sync }ia varten vain { -brand-name-firefox-account }n.
firefox-sync-encrypt-your-data = Salaa tietosi
firefox-sync-your-encryption-key = Salausavaimesi pysyy salaisena, jonka tiedät vain sinä ja valtuuttamasi laitteet.
