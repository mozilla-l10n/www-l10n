...
send-to-device-send-firefox = Lähetä { -brand-name-firefox } puhelimeesi tai tablettiisi
send-to-device-your-download-link = Latauslinkki lähetettiin.
...
send-to-device-send-to-another = Lähetä toiseen laitteeseen
