...
home-mozilla-is-the-not-for-profit = { -brand-name-mozilla } on { -brand-name-firefox }ia - aitoa vaihtoehtoselainta - kehittävä voittoa tavoittelematon järjestö. Luomme tuotteita ja käytäntöjä pitääksemme Internetin palvelemassa ihmisiä liiketuloksen sijaan.
...
home-extensions = Laajennukset
home-personalize-firefox-with-your = Tee { -brand-name-firefox }ista omanlaisesi lisäosilla, kuten salasanojen hallintaohjelmilla, mainosestolla ynnä muilla.
home-careers = Urat
home-learn-about-the-benefits-of = Lue lisää { -brand-name-mozilla }lla työskentelyn eduista ja katso avoimet paikat ympäri maailman.
home-need-help = Tarvitsetko apua?
home-get-answers-to-your-questions = Löydät vastaukset kysymyksiisi { -brand-name-firefox }iin ja kaikkiin { -brand-name-mozilla }n tuotteisiin liittyen tukitiimiltämme.
