...
home-mission-driven = Tehtävävetoinen. Ihmisvoimainen.
...
home-get-good-news = Hanki (hyviä) uutisia { -brand-name-mozilla }lta
home-get-news-and-tips = Vastaanota uutisia ja vinkkejä { -brand-name-mozilla }lta pysyäksesi turvassa ja saadaksesi tietoa kaikesta, mikä tekee verkosta terveellisemmän paikan.
# VPN Feature
