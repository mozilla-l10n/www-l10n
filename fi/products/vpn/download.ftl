...
vpn-download-page-title = Lataa { -brand-name-mozilla-vpn }
vpn-download-page-description = Lataa { -brand-name-mozilla-vpn } { -brand-name-windows }ille, { -brand-name-mac }ille, { -brand-name-linux }ille, { -brand-name-android }ille ja { -brand-name-ios }:lle.
# Variables:
...
vpn-download-previous-versions = Lataa aiemmat versiot { -brand-name-windows }ille ja { -brand-name-mac-short }ille
