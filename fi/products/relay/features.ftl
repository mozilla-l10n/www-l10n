...
highlighted-features-section-unlimited-masks-body-v2 =
    { $mask_limit ->
        [one]
            Kaikki saavat { $mask_limit } sähköpostimaskin ilmaiseksi.
            { -brand-name-relay-premium }illa voit luoda niin monta maskia kuin tarvitset sähköpostisi suojaamiseksi roskapostittajilta, hakkereilta ja seuraimilta.
       *[other]
