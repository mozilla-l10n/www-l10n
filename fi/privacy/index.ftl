...
privacy-index-contact-mozilla = Ota yhteys { -brand-name-mozilla }an
privacy-index-if-you-want-to-make-a-correction = Jos haluat tehdä muutoksia tietoihisi, tai jos sinulla on mitä tahansa kysyttävää tietosuojakäytännöistämme, ota yhteyttä osoitteeseen:
# Variables:
#   $dsar (url) - link to https://app.onetrust.com/app/#/webform/4ba08202-2ede-4934-a89e-f0b0870f95f0
privacy-index-see-here-for-data-subject = <a href="{ $dsar }">Katso tästä Rekisteröidyn oikeus saada pääsy tietoihin -tietopyynnöt.</a>
# Variables:
#   $sumo (url) - link to https://support.mozilla.org/
privacy-index-for-product-support-requests = Etsi tuotetukea <a href="{ $sumo }">tukifoorumeiltamme</a>.
privacy-index-data-privacy-principles = Tietosuojan periaatteet
# Variables:
...
privacy-index-mozilla-subscription-services = { -brand-name-mozilla }n tilauspalvelut
# This is title case since it appears in a menu, so does not use the normal brand name terms for "Mozilla accounts".
privacy-index-mozilla-accounts = { -brand-name-mozilla }-tilit
