...
# HTML page title
vpn-landing-title = { -brand-name-mozilla-vpn }: Bảo vệ toàn bộ thiết bị của bạn
...
vpn-landing-connect-up-to-devices = Kết nối lên đến { $devices } thiết bị
# Variables:
#   $servers (number) - number of VPN servers
#   $countries (number) - number of available countries
vpn-landing-more-than-servers-in-countries = Hơn { $servers } máy chủ tại { $countries }+ quốc gia
vpn-landing-fast-network-speeds-even-while = Tốc độ mạng nhanh ngay cả khi chơi game
...
vpn-landing-do-you-need-a-vpn-at-home = Bạn có cần VPN ở nhà không? Dưới đây là 5 lý do bạn có thể cân nhắc.
