...
home-mission-driven = Định hướng theo sứ mệnh. Được hỗ trợ bởi mọi người.
...
home-at-its-core-v2 = Về cốt lõi, { -brand-name-mozilla } là một tổ chức hoạt động được lãnh đạo bởi { -brand-name-mozilla-foundation } tạo ra sự thay đổi trên thế giới thông qua nhiều hoạt động mạo hiểm bao gồm { -brand-name-mozilla-corporation }, MZLA, <a { $ventures }>{ -brand-name-mozilla-ventures }</a> và <a { $mozai }>{ -brand-name-mozilla-ai-v2 }</a>. Chúng tôi khác thế nào? Bởi vì chúng tôi hoạt động theo sứ mệnh, điều đó có nghĩa là chúng tôi có quyền tự do đưa ra mọi quyết định của mình dựa trên những gì tốt nhất cho Internet và cho mọi người trực tuyến, chứ không dựa trên nhu cầu của các cổ đông — chúng tôi thực sự không có bất kỳ thứ gì trong số đó.
home-learn-about-mofo = Tìm hiểu về { -brand-name-mozilla-foundation }
home-join-the-fight = Tham gia cuộc chiến vì một internet lành mạnh
home-your-voice-your-code = Giọng nói của bạn. Đoạn mã cua ban. Những ý tưởng của bạn. Thực sự có hàng nghìn cách bạn có thể đóng góp cho { -brand-name-mozilla }.
home-volunteer-with-mozilla = Tình nguyện với { -brand-name-mozilla }
home-that-one-time = Có lần chúng tôi đã công khai mã nguồn của mình…
home-the-mozilla-project = Dự án { -brand-name-mozilla } được thành lập tại San Francisco vào năm 1998, khi trình duyệt { -brand-name-netscape } đã đưa ra quyết định cấp tiến là công khai chương trình của mình cho công chúng để xây dựng và cải thiện. Hồi đó, có một công ty gần như độc quyền về cách mọi người trải nghiệm Internet.
...
home-feature-blur-your-location = Ẩn vị trí & hoạt động của bạn bằng cách sử dụng <span>{ -brand-name-mozilla-vpn }</span>
# Mozilla Foundation donation promo
home-mofo-build-our-movement = Xây dựng phong trào theo chúng tôi
home-mofo-donate-to-mofo-today = Quyên góp cho { -brand-name-mozilla-foundation } ngay hôm nay để đảm bảo Internet vẫn mở và có thể truy cập được cho tất cả mọi người.
home-mofo-donate = Quyên góp
