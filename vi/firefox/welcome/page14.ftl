...
welcome-page14-get-mozilla-vpn = Sử dụng { -brand-name-mozilla-vpn }
welcome-page14-use-code = Sử dụng mã khi thanh toán để được giảm giá 20%
welcome-page14-copy-code = Sao chép mã
welcome-page14-code-copied = Đã sao chép mã!
welcome-page14-very-fast = Rất, rất nhanh
welcome-page14-wireguard-powered = Các máy chủ của chúng tôi được hỗ trợ bởi { -brand-name-wireguard }® được xây dựng để tăng tốc độ để bạn có thể phát trực tuyến, tải xuống và chơi trò chơi như bình thường.
welcome-page14-without-trace = Internet không có dấu vết
welcome-page14-never-log = Chúng tôi không bao giờ ghi nhật ký, theo dõi hoặc chia sẻ dữ liệu mạng của bạn — hoạt động trực tuyến của bạn sẽ không để lại dấu vết trên các máy chủ VPN của chúng tôi.
welcome-page14-why-see-this = Tại sao tôi thấy cái này?
