...
# Obsolete
nightly-whatsnew-every-6-to-8-weeks = Cứ sau 6 đến 8 tuần, một phiên bản mới của { -brand-name-firefox } được phát hành và như kết quả, phiên bản { -brand-name-nightly } cũng tăng theo.
