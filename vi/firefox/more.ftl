...
get-the-browsers = Tải xuống trình duyệt đặt quyền riêng tư của bạn lên hàng đầu — và luôn có
...
be-bold-and = Hãy mạnh dạn và can đảm khi chọn trình duyệt nào phù hợp với bạn.
comparing-firefox-edge = So sánh { -brand-name-firefox-browser } với { -brand-name-microsoft } { -brand-name-edge }
youll-never-guess = Bạn sẽ không bao giờ đoán được trình duyệt nào có lợi thế về tốc độ và tính năng..
comparing-firefox-ie = So sánh { -brand-name-firefox-browser } với { -brand-name-microsoft } { -brand-name-ie }
old-habits-that = Những thói quen cũ khó có thể chết nhưng bạn sẽ cảm thấy tốt hơn khi có chúng.
comparing-firefox-safari = So sánh { -brand-name-firefox-browser } với { -brand-name-apple } { -brand-name-safari }
you-dont-have = Bạn không cần phải đặt mặc định cho trình duyệt cũ của mình.
comparing-firefox-opera = So sánh { -brand-name-firefox-browser } với { -brand-name-opera }
be-free-to = Bạn không cần phải che giấu lời khen của mình đối với { -brand-name-firefox }.
the-ad-blocker = Trình chặn quảng cáo - vũ khí bí mật chống lại quảng cáo gây phiền nhiễu.
so-many-ads = Rất nhiều quảng cáo, quá ít kiên nhẫn… Đó là thời gian để ngăn chặn sự điên rồ.
firefox-more-protection = { -brand-name-firefox }: Bảo vệ nhiều hơn, lo lắng ít hơn.
