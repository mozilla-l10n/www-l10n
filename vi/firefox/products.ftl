...
firefox-products-learn-more-about-relay = Tìm hiểu thêm về { -brand-name-firefox-relay }
# Obsolete string
...
firefox-products-get-pocket = Nhận { -brand-name-pocket }
firefox-products-learn-more-about-pocket = Tìm hiểu thêm về { -brand-name-pocket }
firefox-products-join-firefox-and-get-the-most = Tham gia { -brand-name-firefox } và tận dụng tối đa mọi sản phẩm — trên mọi thiết bị.
# Variables:
