...
# Outdated string
mobile-focus-firefox-focus-is-your-dedicated = { -brand-name-firefox-focus } là trình duyệt bảo mật chuyên dụng của bạn với tính năng tự động chống theo dõi và chặn quảng cáo.
...
# Outdated string
mobile-focus-firefox-focus-dedicated-with = { -brand-name-firefox-focus } là trình duyệt bảo mật chuyên dụng của bạn với tính năng tự động chống theo dõi và chặn quảng cáo. Với { -brand-name-focus }, các trang của bạn tải nhanh hơn và dữ liệu của bạn vẫn ở chế độ riêng tư.
...
# Outdated string
mobile-focus-disappear-your-history = Biến mất lịch sử của bạn khi thoát
