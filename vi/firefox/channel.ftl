...
firefox-channel-be-among-the-first-to-explore = Hãy là người đầu tiên khám phá các bản phát hành trong tương lai của { -brand-name-firefox } cho máy tính để bàn, { -brand-name-android } và { -brand-name-ios }.
...
firefox-channel-download-and-test-future = Tải xuống và kiểm tra các bản phát hành trong tương lai của { -brand-name-firefox } dành cho máy tính để bàn, { -brand-name-android } và { -brand-name-ios }.
