...
download-button-get-firefox-ios = Fumana i{ -brand-name-firefox } ye-OS
...
download-button-app-store = Yifumane simahla kwiVenkile ye-App
download-button-download-app-store = Khuphela kwiVenkile ye-App
