...
manifesto-transparent-community = Inkqubo zoluntu ezingenamagumgedle zikhuthaza ukuthatha inxaxheba, ukuphendula, nokuthenjwa.
manifesto-01 = 01
manifesto-02 = 02
manifesto-03 = 03
manifesto-04 = 04
...
manifesto-use-open-badges-to-share = Sebenzisa iibheji ezivulekileyo ukwabelana nezakhono zakho nomdla wakho
manifesto-learn-about-open-source = Funda ngekhowudi yesosi evulelekileyo kubuntatheli
manifesto-see-how-mozilla-works = Jonga indlela esebenza ngayo i{ -brand-name-mozilla } ekubekeni phambili ubungasese bakho
manifesto-read-about-developments = Funda ngenkqubela-phambili kukhuselo lobungasese neengcombolo
manifesto-learn-more-about-how-to = Funda ngaphezulu ngendlela yokuzikhusela kwi-intanethi
manifesto-add-new-voices-to-open = Yongeza amazwi amatsha ukuvula ubuchwepheshe besosi
manifesto-set-your-do-not-track = Seta ipriferensi yakho yeMusa ukufunisela
manifesto-learn-how-to-remix-content = Funda ngendlela yokuxuba kwakhona isiqulatho ukwenza into entsha
manifesto-participate-in-our-governance = Thabatha inxaxheba kwiqonga lethu lolawulo
manifesto-join-us-as-a-volunteer = Sijoyine njengevolontiya
manifesto-learn-how-to-collaborate = Funda ngendlela yokusebenzisana kwi-intanethi
manifesto-host-or-join-a-maker-party = Sindleka okanye dibana noMenzi-qela
manifesto-learn-how-to-build-online = Funda ngendlela yokwakha izakhono zentsebenziswano kwi-intanethi
...
manifesto-details-articulate-a-vision = chaza umbono abanawo abathathi-nxaxheba be{ -brand-name-mozilla } nge-Intanethi abafuna uMbutho we{ -brand-name-mozilla } iwuphumeze;
manifesto-details-speak-to-people = sithethe nabantu nokuba banalo okanye abanalo ufifi ngezobugcisa;
...
manifesto-details-these-principles = Le migaqo ayisoze iziqhube ngokwayo. Kufuneka abantu ukwenza i-Intanethi ivulekele wonke umntu yaye wonke ubani abe nenxaxheba kuyo - abantu ngabanye, abo basebenza kunye njengamaqela, kwanabo bakhokela abanye. UMbutho we{ -brand-name-mozilla } uzibophelele ekuqhubeleni phambili imigaqo echazwe kuXwebhu lwakwa{ -brand-name-mozilla }. Simema abanye ukuba bazimanye nathi ekwenzeni i-Intanethi ibe ngcono ngakumbi kumntu wonke.
...
manifesto-details-individuals-security = Abantu nokukhuseleko kwi-Intanethi lubalulekile yaye alunakuthathwa njengonto engenamsebenzi.
...
manifesto-details-mozilla-foundation = Nesifundo soMbutho weMozilla
manifesto-details-the-mozilla-foundation-pleges = UMbutho we{ -brand-name-mozilla } ufungile ukuba uza kuxhasa uXwebhu lwe{ -brand-name-mozilla } kwimisebenzi yawo. Ingakumbi, siza:
...
manifesto-details-some-foundation = Eminye yemisebenzi yoMbutho—sithethanje ekukudala, ukuhambisa nokukhuthaza iimveliso zabathengi—yenziwa ngokuyintloko ngoMbutho weMozilla ephantsi kwe{ -brand-name-mozilla-corporation }.
manifesto-details-invitation = Kukumema
manifesto-details-the-mozilla-foundation-invites = UMbutho we{ -brand-name-mozilla } umele bonke abanye abantu abaxhasa imigaqo yoXwebhu lwe{ -brand-name-mozilla } ukuba bazimanye nathi, baze bafumane iindlela ezintsha zokwenza umbono we-Intanethi ube yimpumelelo.
