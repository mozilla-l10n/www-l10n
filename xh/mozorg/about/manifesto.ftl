...
manifesto-details-articulate-a-vision = chaza umbono abanawo abathathi-nxaxheba be{ -brand-name-mozilla } nge-Intanethi abafuna we{ -brand-name-mozilla-foundation } iwuphumeze;
...
manifesto-details-the-mozilla-foundation-pleges = We{ -brand-name-mozilla-foundation } ufungile ukuba uza kuxhasa uXwebhu lwe{ -brand-name-mozilla } kwimisebenzi yawo. Ingakumbi, siza:
...
manifesto-details-some-foundation = Eminye yemisebenzi yoMbutho—sithethanje ekukudala, ukuhambisa nokukhuthaza iimveliso zabathengi—yenziwa ngokuyintloko ngo we{ -brand-name-mozilla-foundation } ephantsi kwe{ -brand-name-mozilla-corporation }.
manifesto-details-invitation = Kukumema
manifesto-details-the-mozilla-foundation-invites = We{ -brand-name-mozilla-foundation } umele bonke abanye abantu abaxhasa imigaqo yoXwebhu lwe{ -brand-name-mozilla } ukuba bazimanye nathi, baze bafumane iindlela ezintsha zokwenza umbono we-Intanethi ube yimpumelelo.
