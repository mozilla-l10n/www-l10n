...
# Variables:
#   $fxa (url) = link to https://www.mozilla.org/firefox/accounts/
password-manager-with-a-free-firefox-account = Con una <a href="{ $fxa }">cuenta { -brand-name-firefox } gratuita</a> puedes sincronizar de forma segura tus contraseñas en todos tus dispositivos.
