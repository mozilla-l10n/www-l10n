...
browser-history-browser-history = Historia de los navegadores: épicas luchas de poder que nos trajeron los navegadores modernos
browser-history-the-browser-wars-underdogs-giants = Las guerras de los navegadores, los más pequeños contra los gigantes y los momentos que cambiaron el mundo. Lee sobre la historia de los navegadores de web.
...
browser-history-in-1950-computers = En 1950, los ordenadores ocupaban habitaciones enteras y eran más tontas que las calculadoras de bolsillo actuales. Pero el progreso fue rápido y en 1960 pudieron ejecutar programas complejos. Gobiernos y universidades de todo el mundo pensaron que sería fantástico si las máquinas pudieran hablar, favoreciendo la colaboración y los avances científicos.
# Variables:
#   $arpanet (url) - https://en.wikipedia.org/wiki/ARPANET
browser-history-arpanet-was-the = <a href="{ $arpanet }">ARPANET</a> fue el primer proyecto de redes con éxito y en 1969 se envió el primer mensaje desde el laboratorio de informática de la Universidad de California en Los Ángeles (UCLA) al Instituto de Investigación de Stanford (SRI), también en California.
...
browser-history-british-computer = El científico informático británico Tim Berners-Lee creó el primer servidor web y navegador web gráfico en 1990 mientras <a href="{ $cern }">trabajaba en el CERN</a>, la Organización Europea para la Investigación Nuclear, en Suiza. Llamó a su nueva ventana a Internet "WorldWideWeb". Era una interfaz gráfica fácil de usar creada para el ordenador NeXT. Por primera vez, los documentos de texto se enlazaron a través de una red pública — la web tal como la conocemos.
browser-history-a-year-later-berners = Un año más tarde, Berners-Lee le pidió a Nicola Pellow, estudiante de matemáticas del CERN, que escribiera Line Mode Browser, un programa para terminales básicos de ordenador.
# Variables:
#   $firefox (url) - https://en.wikipedia.org/wiki/Firefox
browser-history-by-1993-the-web = En 1993, la web explotó. Universidades, gobiernos y corporaciones privadas vieron oportunidades en la Internet abierta. Todo el mundo necesitaba nuevos programas informáticos para acceder. Ese año, Mosaic fue creado en el Centro Nacional de Aplicaciones de Supercomputación (NCSA) en la Universidad de Illinois Urbana-Champaign por el científico informático Marc Andreessen. Fue el primer navegador web popular y el antepasado de <a href="{ $firefox }">{ -brand-name-mozilla } { -brand-name-firefox }</a>.
# Variables:
...
browser-history-the-browser-wars = Las guerras de navegadores
# Variables:
...
browser-history-other-competitors = A finales de los años 90 y principios de la década del 2000 sugieron otros compatidores, incluyendo a { -brand-name-opera }, { -brand-name-safari }, y { -brand-name-google } { -brand-name-chrome }. { -brand-name-microsoft } { -brand-name-edge } sustituyó a { -brand-name-ie } con el lanzamiento de { -brand-name-windows } 10 en 2015.
browser-history-browsing-the-web = Navegando por la Web hoy
# Variables:
