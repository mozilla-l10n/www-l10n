...
firefox-sticky-promo-meet-our-family-of = Descubre nuestra familia de productos
firefox-sticky-promo-meet-mozillas-family = Conoce la familia de productos de { -brand-name-mozilla }
firefox-sticky-promo-get-the-latest-firefox = Obtén la última versión del navegador { -brand-name-firefox }.
# Products List
firefox-sticky-promo-browsers = Navegadores
