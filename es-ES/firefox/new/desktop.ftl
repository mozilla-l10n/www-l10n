...
firefox-desktop-its-your-internet = Es tu Internet. Coloréalo como quieras con miles de herramientas, temas y extensiones. Firefox es el navegador alternativo original que coloca a las personas por encima del lucro.
# Obsolete string
...
firefox-desktop-download-firefox-is-available = { -brand-name-firefox } está disponible para todos tus dispositivos; lleva tus pestañas, historial y marcadores contigo. Todo lo que necesitas es una <a { $attrs }>cuenta { -brand-name-firefox }</a>.
# Variables:
