...
whatsnew80-up-to-date-banner = ¡Felicidades! Estás usando la última versión de { -brand-name-firefox }.
# Main title
...
whatsnew80-our-latest-version = Nuestra última versión de { -brand-name-firefox } presenta cargas de página ultrarrápidas y un nuevo diseño limpio que facilita hacer más cosas, de forma más rápida.
