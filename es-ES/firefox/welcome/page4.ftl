...
# HTML page title
welcome-page4-download-the-firefox-browser = Descarga el { -brand-name-firefox-browser } en tu teléfono para { -brand-name-ios } y { -brand-name-android }
welcome-page4-wallet-keys-phone-firefox = Monedero. Llaves. Teléfono. <strong>{ -brand-name-firefox }.</strong>
welcome-page4-privacy-every-screen-now = Ahora obtén privacidad en cada pantalla
...
welcome-page4-privacy-on-by-default = Tu privacidad está activada por defecto con el nuevo { -brand-name-firefox } para { -brand-name-android } y ahora puedes hacer de { -brand-name-firefox } tu navegador predeterminado en { -brand-name-ios } 14.
welcome-page4-get-the-firefox-mobile = Consigue { -brand-name-firefox } para móviles
...
welcome-page4-download-firefox-for-your = Descarga { -brand-name-firefox } para tu teléfono y tableta.
...
welcome-page4-get-data-trackers-off-your = Quita a los rastreadores de datos de tu camino
# Variables:
...
welcome-page4-enhanced-tracking-protection = La protección contra el rastreo mejorada <a href="{ $privacy }">bloquea más de 2.000 rastreadores</a> para que no te persigan por la web.
...
welcome-page4-more-done-fast-smart = Haz más en tu jornada con la carga rápida de las páginas  y sugerencias de búsqueda inteligentes.
