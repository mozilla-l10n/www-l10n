...
privacy-passwords-its-easy-to = Es fácil evitar que los atacantes roben tu contraseña cuando te conectas a un sitio web sin cifrar: Piénsalo dos veces antes de escribir la contraseña si no ves un icono de candado en la barra de URL, como éste:
...
privacy-passwords-finally-most-websites = Por último, la mayoría de los sitios web te permiten recuperar tu contraseña si la has olvidado. En general, estos sistemas te hacen responder algunas “preguntas de seguridad” antes de que puedas restablecer tu contraseña. <strong>Las respuestas a estas preguntas deben ser tan secretas como tu contraseña.</strong> De lo contrario, un atacante puede adivinar las respuestas y cambiar la contraseña a lo que él quiera.
...
privacy-passwords-when-youre-logged = Cuando te conectas a { -brand-name-firefox } con tu cuenta de { -brand-name-firefox }, puedes sincronizar todos tus dispositivos y acceder a tus contraseñas desde un navegador móvil { -brand-name-firefox }. Obtén más información sobre <a { $url_sumo-manager }>cómo utilizar el administrador de contraseñas integrado</a>.
...
privacy-passwords-when-youre-logged-v2 = Cuando te conectas a { -brand-name-firefox } con tu { -brand-name-mozilla-account }, puedes sincronizar todos tus dispositivos y acceder a tus contraseñas desde un navegador móvil { -brand-name-firefox }. Obtén más información sobre <a { $url_sumo_manager }>cómo utilizar el administrador de contraseñas integrado</a>.
