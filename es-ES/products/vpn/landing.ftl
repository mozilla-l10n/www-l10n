...
vpn-landing-page-desc = Utiliza { -brand-name-mozilla-vpn } para tener una protección completa en el dispositivo, para todas las apps. Con servidores en más de { $countries } países, puedes conectarte a cualquier lugar, desde cualquier lugar.
...
vpn-landing-faq-competition-question-desc-v2 = Aunque las VPN gratuitas parecen atractivas, no asumen los mismos compromisos de privacidad que { -brand-name-mozilla-vpn }. Otras VPN de pago no tienen la <a href="{ $url }">historia</a> de más de 20 años de { -brand-name-mozilla } en creación de productos que ponen a las personas y su privacidad en primer lugar.
# Obsolete string
# Variables:
#   $url (url) - link to https://www.mozilla.org/about/history/
...
vpn-landing-faq-compatibility-question-desc-v2 = { -brand-name-mozilla-vpn } es compatible con <a href="{ $mobile }">móviles</a>, tabletas y <a href="{ $desktop }">ordenadores de escritorio</a> en :
# Outdated string
...
vpn-landing-faq-compatibility-question-desc-linux-v4 = <a href="{ $url }">Linux</a> (Ubuntu 20.04 y versiones posteriores)
# Outdated string
#   $url (url) - link to https://www.mozilla.org/products/vpn/desktop/linux/
...
vpn-landing-faq-download-desc = Visita la <a { $attrs }>página de descarga</a> para instalar { -brand-name-mozilla-vpn } en tu dispositivo y luego inicia sesión con tu { -brand-name-firefox-account }.
...
vpn-landing-invite-page-desc-v2 = Recibe una notificación cuando { -brand-name-mozilla-vpn } esté disponible para tu región.
# Outdated string
