...
vpn-download-sub-heading = Puedes descargar { -brand-name-mozilla-vpn } en hasta { $devices } dispositivos con una suscripción.
...
vpn-download-for-mac-long = Descarga { -brand-name-mozilla-vpn } para { -brand-name-mac-short }
# Variables:
#   $version (number) - operating system version
vpn-download-version-requirements = Versión { $version } y superiores
vpn-download-for-linux = VPN para { -brand-name-linux }
vpn-download-for-linux-long = Descarga { -brand-name-mozilla-vpn } para { -brand-name-linux }
# Variables:
#   $version (number) - operating system version
vpn-download-for-linux-requirements = Ubuntu versión { $version } y superiores
...
vpn-download-get-mozilla-vpn = Consigue { -brand-name-mozilla-vpn }
...
vpn-download-install-via-flathub = Instalar mediante Flathub
vpn-download-install-via-apt = Instalar mediante APT
