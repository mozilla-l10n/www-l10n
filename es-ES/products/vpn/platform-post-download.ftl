...
vpn-download-and-install = <a href="{ $extension }">Descarga e instala la extensión</a> para establecer exclusiones por sitio y elegir diferentes ubicaciones para diferentes sitios web.
