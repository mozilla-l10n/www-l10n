...
vpn-windows-download-page-title = Descargar { -brand-name-mozilla-vpn } para { -brand-name-windows }
vpn-windows-downloading-mozilla-vpn = Descargando { -brand-name-mozilla-vpn } para { -brand-name-windows }…
vpn-windows-go-to-your-downloads = Abre tu carpeta de descargas y haz doble clic en el archivo .msi
vpn-windows-a-progress-bar = Aparecerá una barra de progreso y comenzará el proceso de instalación

## Mac download page

vpn-mac-download-page-title = Descargar { -brand-name-mozilla-vpn } para { -brand-name-mac-short }
vpn-mac-downloading-mozilla-vpn = Descargando { -brand-name-mozilla-vpn } para { -brand-name-mac-short }…
vpn-mac-go-to-your-downloads = Abre tu carpeta de descargas y haz doble clic en el archivo .pkg
vpn-mac-follow-the-steps = Sigue los pasos descritos en el instalador de { -brand-name-mozilla-vpn } para iniciar la aplicación

## Shared strings

vpn-download-unable-to-download = No se puede descargar { -brand-name-mozilla-vpn }
...
vpn-your-download-should-start = La descarga de la { -brand-name-mozilla-vpn } debería comenzar automáticamente. Si no lo hace, <br> <a href="{ $url }" id="{ $id }"> reinicia la descarga </a> o retrocede para descargarla para otro dispositivo.
...
vpn-enter-your-email = Introduce tu dirección de correo electrónico para iniciar sesión o registrarte y comenzar
vpn-turn-on-vpn = 4. Activar la VPN
vpn-pick-a-recommended = Selecciona una ubicación recomendada para una conexión rápida y estable o elige ta ubicación deseada manualmente, luego ACTIVA el interruptor

## FAQ Strings

vpn-download-faq-need-help = ¿Necesitas ayuda para comenzar?
vpn-download-faq-here-are-some = Estas son algunas de las preguntas más comunes sobre la configuración de { -brand-name-mozilla-vpn }
...
vpn-download-faq-adding-another-v3 = Añadir otro dispositivo es tan simple como descargar e instalar el software { -brand-name-mozilla-vpn } y luego iniciar sesión en tu { -brand-name-mozilla-account } en el nuevo dispositivo. Para obtener más detalles, consulta <a href="{ $subscription }">Cómo añadir dispositivos a tu suscripción a { -brand-name-mozilla-vpn }</a>.
# Obsolete string
# Variables:
#   $subscription - link to https://support.mozilla.org/kb/how-add-devices-your-mozilla-vpn-subscription
vpn-download-faq-adding-another-v2 = Añadir otro dispositivo es tan simple como descargar e instalar el software { -brand-name-mozilla-vpn } y luego iniciar sesión en tu { -brand-name-firefox-account } en el nuevo dispositivo. Para obtener más detalles, consulta <a href="{ $subscription }">Cómo añadir dispositivos a tu suscripción a { -brand-name-mozilla-vpn }</a>.
