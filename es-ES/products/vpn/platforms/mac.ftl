...
vpn-mac-page-description = Ya sea en un ordenador de sobremesa con { -brand-name-mac-short }, un portátil, { -brand-name-ipad } o { -brand-name-iphone }, protege tu dispositivo de hackers y ojos indiscretos con una VPN de { -brand-name-mozilla }, pionera en la seguridad de Internet desde 1998.
# Mac strings
