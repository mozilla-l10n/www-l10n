...
# Field of a form
opt-out-confirmation-your-email = Tu dirección de correo electrónico:
# Only localize "yourname". Do not touch @example.com.
opt-out-confirmation-yournameexamplecom = tunombre@example.com
# This is a button
opt-out-confirmation-manage-preferences = Gestionar preferencias
opt-out-confirmation-prefer-to-get = ¿Prefieres obtener información a través de otro medio?
# Link to https://blog.mozilla.org/
opt-out-confirmation-check-out-our = Échale un vistazo a nuestros blogs
