...
about-this-site-today-v2 = Hoy, este es el sitio donde la gente aprende más sobre { -brand-name-mozilla }</a> y prueba <a href="{ $vpn }">{ -brand-name-mozilla-vpn }</a>. También puedes descubrir algunos <a href="{ $book }">huevos de Pascua</a> por el camino.
