...
footer-refresh-get-the-best = Få de bästa { -brand-name-firefox }-tipsen, tricksen och uppdateringarna. Vi lovar att hålla din e-post privat och säker — det bästa från { -brand-name-firefox } skickas direkt till din inkorg.
...
footer-refresh-x = X
footer-refresh-x-formerly-twitter = X (tidigare Twitter)
...
footer-refresh-follow-firefox = Följ @{ -brand-name-firefox }
footer-refresh-youtube = YouTube
footer-refresh-company = Företag
footer-refresh-press-center = Presscenter
footer-refresh-careers = Karriär
footer-refresh-contact = Kontakt
footer-refresh-support = Hjälp
