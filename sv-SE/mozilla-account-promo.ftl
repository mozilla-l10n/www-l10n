...
moz-account-already-have = Har du redan ett konto? <a { $sign_in_url }>Logga in</a> eller <a { $learn_more_url }>läs mer</a> om { -brand-name-mozilla }
moz-account-get-a-mozilla-account = Skaffa ett { -brand-name-mozilla-account }
