...
manifesto-details-the-mozilla-project-global-v2 = Projektet { -brand-name-mozilla } är en global gemenskap av människor som tror att öppenhet, innovation och möjligheter är nyckeln till internets fortsatta välbefinnande. Vi har arbetat tillsammans sedan 1998 för att säkerställa att internet utvecklas på ett sätt som gynnar alla. Vi är mest kända för att ha skapat webbläsaren { -brand-name-mozilla } { -brand-name-firefox }.
...
manifesto-details-the-mozilla-project-community-v2 = Projektet { -brand-name-mozilla } använder en community-baserad metod för att skapa programvara med öppen källkod i världsklass och utveckla nya typer av samarbetsaktiviteter. Vi skapar gemenskaper av människor som är involverade i att göra internetupplevelsen bättre för oss alla.
# Obsolete string (expires 2026-09-20)
...
manifesto-details-articulate-a-vision-v2 = formulera en vision för internet som { -brand-name-mozilla }-deltagarna vill att { -brand-name-mozilla-foundation } ska sträva efter;
...
manifesto-details-the-mozilla-foundation-pleges-v2 = { -brand-name-mozilla-foundation } lovar att stödja { -brand-name-mozilla } manifestet i dess aktiviteter. Mer specifikt kommer vi att:
...
manifesto-commitment-1 = Åtagande 1
manifesto-commitment-2 = Åtagande 2
manifesto-commitment-3 = Åtagande 3
manifesto-commitment-4 = Åtagande 4
...
manifesto-details-some-foundation-v2 = En del av stiftelsens verksamhet — för närvarande skapande, leverans och marknadsföring av konsumentprodukter — bedrivs huvudsakligen genom { -brand-name-mozilla-foundation }s helägda dotterbolag, { -brand-name-mozilla-corporation }.
manifesto-details-invitation = Inbjudan
manifesto-details-the-mozilla-foundation-invites-v2 = { -brand-name-mozilla-foundation } inbjuder alla andra som stöder principerna i { -brand-name-mozilla } manifestet att gå med oss ​​och hitta nya sätt att förverkliga denna vision av internet.
manifesto-share-on-bluesky = Dela på Bluesky
...
manifesto-i-support-the-vision-of-v2 = Jag stöder visionen om ett bättre och hälsosammare internet från { -brand-name-mozilla }, vill du gå med mig?
