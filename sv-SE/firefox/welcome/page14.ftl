...
welcome-page14-code-copied = Koden kopierad!
welcome-page14-very-fast = Den är snabb, väldigt snabb
welcome-page14-wireguard-powered = Våra { -brand-name-wireguard }®-drivna servrar är byggda för hastighet så att du kan streama, ladda ner och spela som vanligt.
welcome-page14-without-trace = Internet utan spår
welcome-page14-never-log = Vi loggar, spårar eller delar aldrig dina nätverksdata — din onlineaktivitet kommer inte att lämna ett fotavtryck på våra VPN-servrar.
welcome-page14-why-see-this = Varför ser jag detta?
