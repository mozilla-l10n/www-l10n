...
privacy-passwords-the-secret-to = Hemligheten för att förhindra gissning, stöld eller återställning av lösenord är en hel del slumpmässighet. När angripare försöker gissa lösenord gör de vanligtvis två saker: 1) Använd “ordböcker” — listor över vanliga lösenord som människor använder hela tiden, och 2) gör några slumpmässiga gissningar. Ju <strong>längre och mer slumpmässigt ditt lösenord är</strong> desto mindre troligt att någon av dessa gissningstekniker hittar det.
