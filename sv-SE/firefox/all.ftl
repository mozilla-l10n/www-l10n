...
firefox-all-arm64-installers = ARM64/AArch64 installerare
firefox-all-arm64-installers-optimized = ARM64/AArch64-installerare optimerade för Snapdragon-drivna { -brand-name-windows } PCs.
# Variables:
