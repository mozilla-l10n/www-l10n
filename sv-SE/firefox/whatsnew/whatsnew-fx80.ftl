...
# html page title
whatsnew80-page-title = Vad är nytt i { -brand-name-firefox }
whatsnew80-up-to-date-banner = Gratulerar! Du använder den senaste versionen av { -brand-name-firefox }.
# Main title
whatsnew80-main-title = Gör nästan allt, lite snabbare
whatsnew80-main-intro = Flytta från dator till telefon utan att missa något Skaffa { -brand-name-firefox } för mobil.
whatsnew80-primary-cta-description = Ange din e-postadress eller telefonnummer för en nedladdningslänk
