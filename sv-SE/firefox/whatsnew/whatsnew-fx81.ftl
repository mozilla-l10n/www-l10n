...
# html page title
whatsnew81-page-title = Vad är nytt i { -brand-name-firefox }
# Main title
whatsnew81-main-title = En ny { -brand-name-firefox } för varje enhet
whatsnew81-main-intro = Oavsett vilket operativsystem du har kan du installera en mobilwebbläsare på det som är bättre än någonsin och stöds av en ideell organisation.
whatsnew81-send-form-label = Ange din e-postadress för en nedladdningslänk
whatsnew81-send-form-label-alt = Ange din e-postadress eller ditt telefonnummer för en nedladdningslänk
whatsnew81-scan-this-qr-code = Skanna den här QR-koden för att ladda ner
