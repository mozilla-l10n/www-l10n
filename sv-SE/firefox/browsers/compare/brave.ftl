...
# HTML page title
compare-brave-firefox-vs-brave-which-is = { -brand-name-firefox } mot { -brand-name-brave }: Vilken är den bättre webbläsaren för dig?
# HTML page description
compare-brave-compare-brave-to-the-firefox = Jämför { -brand-name-brave } med { -brand-name-firefox-browser } för att ta reda på vilken som är den bästa webbläsaren för dig när det gäller sekretess, verktyg och portabilitet.
# Main title
...
compare-brave-brave-differentiates-itself = { -brand-name-brave } skiljer sig från de andra { -brand-name-chromium } webbläsarna genom att fokusera på användarnas integritet — specifikt genom att blockera spårare, skript och annonser som standard. Så när du använder webbläsaren { -brand-name-brave } visas områdena på en webbplats som normalt visar annonser som tomma utrymmen. I vissa fall laddas inte sidor normalt, vilket kräver att du antingen väljer en annan webbläsare eller ändrar inställningen 'Shields Up' till 'Shields Down' som stänger av sekretess- och säkerhetsskyddet.
...
compare-brave-there-are-a-few-of-braves = Det finns några säkerhetsfunktioner i { -brand-name-brave } som är värda att lyfta fram, till exempel de automatiska uppgraderingarna av HTTPS-anslutningar (som { -brand-name-firefox } också erbjuder med <a { $extension }>tillägg</a>). { -brand-name-brave } och { -brand-name-firefox } erbjuder båda användarna en inbyggd <a { $lockwise }>lösenordshanterare</a> och möjligheten att kontrollera deras säkerhetsstatistik när som helst. { -brand-name-brave } visar statistik som antalet spårare den har blockerat när du öppnar en ny flik. { -brand-name-firefox } visar liknande information när du visar <a { $privacy }>din sekretessrapport</a> som du kan komma åt när som helst genom att klicka på skölden i adressfältet.
# "Basic Attention Token" is a brand name.
compare-brave-the-bottom-line-is-that-even = Sammanfattningen är att även om { -brand-name-brave } intäktsmodell med Basic Attention Tokens (BAT) kan vara för komplicerad för många användare, så erbjuder både { -brand-name-brave } och { -brand-name-firefox } webbläsare olika sätt att njuta av en säker och privat surfupplevelse.
compare-brave-what-might-surprise-some-new = Det som kan överraska vissa nya { -brand-name-brave }-användare är bara hur snabba sidor tenderar att ladda i webbläsaren. Anledningen till dessa snabba laddningstider är att sidorna laddas mycket snabbare när du blockerar all annonsering på dem. Det är helt enkelt mindre att ladda så det tar mindre tid.
compare-brave-in-terms-of-actual-precious = När det gäller den värdefull RAM-användning är webbläsaren { -brand-name-brave } mycket mer krävande än { -brand-name-firefox }. { -brand-name-brave } kommer förinstallerat med olika funktioner och "tillägg" som kan leder till dess användning av mer RAM. { -brand-name-firefox } å andra sidan, låter dig bestämma vilka tillägg du vill lägg till.
# Variables:
...
compare-brave-customization-of-ui-elements = Anpassning av UI-element och teman har varit en favoritfunktion hos { -brand-name-firefox } användare i flera år och vår ivriga gemenskap av utvecklare har skapat ett <a { $addons }>enormt bibliotek</a> med öppna källkodstillägg som möjliggör ännu mer anpassning och funktionalitet. Funktioner som levereras med { -brand-name-firefox } när du laddar ner inkluderar vårt kraftfulla <a { $screenshot }>skärmdumpsverktyg</a>, tillgänglighetsfunktioner och integration med <a { $pocket }>{ -brand-name-pocket }</a> — en resurs som låter användare snabbt spara en artikel för senare läsning på alla enheter.
compare-brave-brave-also-supports-the-huge = { -brand-name-brave } stöder också det enorma biblioteket med tillägg som finns tillgängligt i { -brand-name-google } { -brand-name-chrome } webbutik och erbjuder en mängd olika webbläsarfunktioner som nämnda { -brand-name-brave } Rewards-program och support för att ladda ner torrents i webbläsaren.
compare-brave-the-ability-to-sync-your-passwords = Möjligheten att synkronisera dina lösenord, tillägg, formulärdata och andra inställningar på alla dina enheter och operativsystem är en funktion som har funnits i flera år med { -brand-name-firefox }. Den synkroniserade informationen är också krypterad, vilket innebär att ingen kan komma åt den från utsidan.
# Variables:
...
compare-brave-when-comparing-the-two-browsers = När du jämför de två webbläsarna erbjuder både { -brand-name-firefox } och { -brand-name-brave } en sofistikerad nivå av integritet och säkerhet som standard som är tillgänglig automatiskt från första gången du öppnar dem.
compare-brave-overall-brave-is-a-fast-and = Sammantaget är { -brand-name-brave } en snabb och säker webbläsare som kommer att vara särskilt tilltalande för kryptovaluta-användare. Men för de allra flesta internetanvändare är { -brand-name-firefox } fortfarande en bättre och enklare lösning.
compare-brave-braves-advertising-replacement = { -brand-name-brave }:s idé om att ersätta annonser är en förändring från den nuvarande modellen för betald annonsplacering och betald sökning. Men återigen kommer vissa upptagna internetanvändare förmodligen inte att bli alltför involverade i hanteringen av mikrobetalningar till webbplatser i utbyte mot deras tid och uppmärksamhet.
