...
firefox-developer-fonts-panel = Fontpanel
firefox-developer-the-new-fonts-panel = Med den nya fontpanelen i utvecklingsverktygen i Firefox har utvecklare snabb tillgång till all information om de teckensnitt som används av ett objekt. Detta inkluderar viktig information som källa, typsnittets vikt och stil och mer.
