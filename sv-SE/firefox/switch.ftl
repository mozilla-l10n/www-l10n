...
switch-switching-to-firefox-page-description-updated = Byte till { -brand-name-firefox } är snabbt, enkelt och riskfritt, eftersom { -brand-name-firefox } importerar dina bokmärken, lösenord och inställningar från { -brand-name-chrome }.
...
switch-spread-the-word = Berätta för alla om { -brand-name-firefox } och hjälp dina favoritpersoner att säga adjö till { -brand-name-chrome }.
