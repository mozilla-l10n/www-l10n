...
firefox-products-learn-more-about-relay = Läs mer om { -brand-name-firefox-relay }
# Obsolete string
...
firefox-products-get-pocket = Skaffa { -brand-name-pocket }
firefox-products-learn-more-about-pocket = Läs mer om { -brand-name-pocket }
firefox-products-join-firefox-and-get-the-most = Gå med i { -brand-name-firefox } och få ut det mesta möjliga av varje produkt — på alla enheter.
# Variables:
