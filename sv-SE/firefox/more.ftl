...
we-compare-firefox = Vi jämför { -brand-name-firefox } med { -brand-name-chrome }, { -brand-name-edge }, { -brand-name-safari }, { -brand-name-opera }, { -brand-name-brave } och { -brand-name-ie } för att hjälpa dig att fatta ditt beslut.
comparing-firefox-chrome = Jämför { -brand-name-firefox-browser } med { -brand-name-google } { -brand-name-chrome }
big-isnt-always = Stort är inte alltid det bästa. Välj istället självständighet.
comparing-firefox-brave = Jämför { -brand-name-firefox-browser } med { -brand-name-brave }
be-bold-and = Var modig och tapper när du väljer vilken webbläsare som passar dig.
comparing-firefox-edge = Jämför { -brand-name-firefox-browser } med { -brand-name-microsoft } { -brand-name-edge }
youll-never-guess = Du kommer aldrig kunna gissa vilken webbläsare som har udden när det gäller hastighet och funktioner.
comparing-firefox-ie = Jämför { -brand-name-firefox-browser } med { -brand-name-microsoft } { -brand-name-ie }
old-habits-that = Gamla vanor som är svåra att bli av med, men du kommer att må bättre när de gör det.
comparing-firefox-safari = Jämför { -brand-name-firefox-browser } med { -brand-name-apple } { -brand-name-safari }
you-dont-have = Du behöver inte använda din standardwebbläsare som standard.
comparing-firefox-opera = Jämför { -brand-name-firefox-browser } med { -brand-name-opera }
be-free-to = Beröm { -brand-name-firefox } när du vill.
the-ad-blocker = Annonsblockeraren – ett hemligt vapen mot irriterande annonser.
so-many-ads = Så många annonser, så lite tålamod… Det är dags att stoppa galenskapen.
firefox-more-protection = { -brand-name-firefox }: Mer skydd. Mindre oro.
...
firefox-more-avoid-misinformation-heading = Undvik felaktig information på nätet – { -brand-name-firefox } är här för att hjälpa dig
firefox-more-avoid-misinformation-desc = Kolla in tips för att se mindre felaktig information och fokusera på vad som är viktigt för dig.
