...
send-to-device-send-firefox = Skicka { -brand-name-firefox } till din smarttelefon eller surfplatta
send-to-device-your-download-link = Din hämtningslänk har skickats.
...
send-to-device-send-to-another = Skicka till en annan enhet
