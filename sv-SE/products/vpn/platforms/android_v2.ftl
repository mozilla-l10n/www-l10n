...
vpn-android-your-internet-activity = Din internetaktivitet från att vara synlig och sedan säljas eller delas med annonsörer.
vpn-android-low-video = Låg videoströmningskvalitet på grund av långsammare och begränsad bandbredd från din internetleverantör (ISP)
vpn-android-your-personal = Dina personuppgifter blir stulna när du använder ett offentligt Wi-Fi-nätverk.
vpn-android-why-should-i = Varför ska jag ladda ner { -brand-name-mozilla-vpn } för Android?
vpn-android-browse-the-internet = Surfa på internet utan att uppge din plats.
vpn-android-be-more-comfortable = Var mer bekväm med att använda offentligt Wi-Fi på kaféer, flygplatser och mer.
vpn-android-avoid-intrusive = Undvik påträngande platsbaserad reklam.
vpn-android-the-mozilla-vpn-mobile = Mobilappen { -brand-name-mozilla-vpn } är liten, så den tar inte upp för mycket av ditt minne och den kommer inte att slöa ner din telefon eller tömma batteriet.
vpn-android-unlike-free = Till skillnad från gratis VPN eller proxysajter, som kan betala för deras servrar genom att spionera på dig och sälja din information, för { -brand-name-mozilla } inte register över vart du surfar och vad du gör.
