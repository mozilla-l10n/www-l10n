...
# Obsolete string
fxa-form-enter-your-email = <strong>Ange din e-postadress</strong> för att komma åt { -brand-name-firefox-accounts }.
fxa-form-enter-your-email-v2 = <strong>Ange din e-postadress</strong> för att skapa ett { -brand-name-mozilla-account }.
# Variables:
