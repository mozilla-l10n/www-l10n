...
firefox-all-you-are-about-to-download = Tha thu gu bhith luchdadh a-nuas:
firefox-all-browser = Brabhsair:
firefox-all-platform = Ùrlar:
firefox-all-language = Cànan:
...
firefox-all-download-the-firefox = Luchdaich a-nuas { -brand-name-firefox-browser } sa Ghàidhlig agus ann an còrr is 90 cànan eile
# HTML page description, also used as the introductory text.
firefox-all-everyone-deserves-access = Tha a h-uile duine airidh air cothrom air an eadar-lìon – cha bu chòir dha do chànan a bhith ’na chnap-starra ort. Seo as adhbhar gun doir sinn { -brand-name-firefox-browser } dhut ann an còrr is 90 cànan – le taic o ghrunn dhaoine saor-thoileach dìcheallach air feadh an t-saoghail.
