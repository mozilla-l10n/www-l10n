...
navigation-refresh-landmark-label = プライマリ
...
navigation-refresh-firefox-browsers = { -brand-name-firefox } ブラウザー
navigation-refresh-close-firefox-browsers-menu = { -brand-name-firefox } ブラウザーメニューを閉じる
navigation-refresh-firefox-for-desktop = デスクトップ用 { -brand-name-firefox }
navigation-refresh-firefox-for-android = { -brand-name-android } 用 { -brand-name-firefox }
navigation-refresh-firefox-for-ios = { -brand-name-ios } 用 { -brand-name-firefox }
navigation-refresh-firefox-focus = { -brand-name-firefox-focus }
navigation-refresh-firefox-relay = { -brand-name-firefox-relay }
navigation-refresh-all-products = すべての製品
navigation-refresh-firefox-blog = { -brand-name-firefox } のブログ
