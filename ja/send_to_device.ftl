...
send-to-device-send-firefox = スマートフォンおよびタブレット用に { -brand-name-firefox } を送信
send-to-device-your-download-link = ダウンロードリンクが送信されました。
...
send-to-device-send-to-another = 別のデバイスに送信
