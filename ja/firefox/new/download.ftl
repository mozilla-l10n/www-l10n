...
firefox-new-download-firefox = { -brand-name-firefox } のダウンロード
...
firefox-new-connect-to-a-whole-family = ユーザーを尊重する製品ファミリー全体に加えて、オンラインで身を守るために必要なすべての知識へとつなぎます。
...
firefox-new-its-everything-you-need-to = <strong>オンラインでの安全を確保</strong> するために知っておくべきことのすべてです。
firefox-new-its-a-community-that-believes = テクノロジーでさらに良くすることができると信じている <strong>コミュニティ</strong> です。
