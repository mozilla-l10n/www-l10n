...
switch-firefox-makes-switching-fast-email = { -brand-name-firefox } は { -brand-name-chrome } から素早く乗り換えられます。私はとても気に入ってるので、あなたもぜひ試してください。
switch-still-not-convinced = まだ { -brand-name-firefox } への乗り換えが簡単だと信じられませんか？
