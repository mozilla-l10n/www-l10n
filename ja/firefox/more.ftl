...
firefox-more-little-book = プライバシーのハンドブック
firefox-more-you-can-reclaim = ユーザーは、プライバシーを奪回して、自らのインターネントエクスペリエンスを再び自分でコントロール可能になります。実際のところ、それは至って手軽です。誰でもそうすることができます。
firefox-more-firefox-sync = { -brand-name-firefox-sync }
firefox-more-access-your-sync = どこにいても { -brand-name-firefox } でブックマークやパスワードを同期させ、タブを開くことができます。
...
be-bold-and = 自分に適したブラウザーを選ぶ時は、思い切って一刀両断に。
comparing-firefox-edge = { -brand-name-firefox-browser } と { -brand-name-microsoft } { -brand-name-edge } の比較
youll-never-guess = スピードや機能性については、どのブラウザーが有利か予想するのは困難です。
...
comparing-firefox-safari = { -brand-name-firefox-browser } と { -brand-name-apple } { -brand-name-safari } の比較
you-dont-have = 必ずしも標準ブラウザーを使用する必要はありません。
comparing-firefox-opera = { -brand-name-firefox-browser } と { -brand-name-opera } の比較
be-free-to = { -brand-name-firefox } に大きな喝采を送りましょう。
the-ad-blocker = 広告ブロッカー — 迷惑な広告に対抗する秘密兵器。
so-many-ads = 広告がたくさん、我慢ももうたくさん... ここで終わりにしましょう。
firefox-more-protection = { -brand-name-firefox }: 保護を強化して、不安を解消。
