...
compare-shared-autoplay-blocking = 自動再生のブロック
compare-shared-tab-browsing = タブブラウジング
compare-shared-bookmark-manager = ブックマークマネージャー
compare-shared-automatically-fills-out-forms = フォームの自動入力
...
compare-shared-portability = 携帯性
...
compare-shared-compare-browsers = ブラウザー比較
