...
# HTML page title
compare-chrome-firefox-vs-chrome-which-is = { -brand-name-firefox } vs { -brand-name-chrome }：優れているブラウザーは?

# HTML page description
compare-chrome-we-compare-mozilla-firefox = プライバシー、実用性、ポータブル性から { -brand-name-mozilla } { -brand-name-firefox } と { -brand-name-google } { -brand-name-chrome } を比較します

# Main title.
compare-chrome-comparing-firefox-browser = { -brand-name-firefox-browser } と { -brand-name-google } { -brand-name-chrome } の比較
...
compare-chrome-ultimately-its-up-to-you = 検索履歴や買い物履歴を共有するかどうか、どこまでそれを認めるかを決めるのは、ユーザー本人です。それでも、ほとんどの人は秘密にしておきたいものをインターネットで検索したことがあるはずです。
...
compare-chrome-while-chrome-proves-to-be = { -brand-name-chrome } が安全なウェブブラウザーであることは実証済みであるものの、プライバシーの取り扱いについては疑問があります。{ -brand-name-google } は、ユーザーの場所や検索履歴、サイト訪問など、膨大な量のデータをユーザーから収集しています。{ -brand-name-google } は、サービス向上のためにデータ収集を行っていると主張しています。ユーザーが以前に購入したり訪ねたりしたものと類似するセーターやカフェを見つけられるようにするといったものです。しかし、{ -brand-name-google } はマーケティング目的のために前例のない量のデータを収集していると指摘する人もいます。ユーザーの情報をハッカーから守っていると謳っていますが、重要なのはそこではありません。{ -brand-name-google } は、世界最大の広告ネットワークを運営しており、それができるのは主にユーザーから集めたデータがあるからです。

# "Gmail" and "Google Docs" are brand names.
compare-chrome-in-terms-of-features-both = 機能面では、{ -brand-name-firefox } と { -brand-name-chrome } の両方が拡張機能とプラグインの大規模なライブラリを提供し、{ -brand-name-chrome } のカタログは他のブラウザーを大きく上回り、Gmail や { -brand-name-google } ドキュメントなど他の { -brand-name-google } サービスと相性が良く出来ています。
compare-chrome-firefox-also-has-a-sync-feature = { -brand-name-firefox } にも同期機能があり、開いているタブと最近使用したタブ、閲覧履歴、ブックマークをすべてのデバイスで表示できます。
compare-chrome-while-chrome-gets-the-nod = { -brand-name-chrome } はアドオンや拡張機能で支持を得る一方、{ -brand-name-firefox } にも便利なスクリーンキャプチャツールや、ページから記事本文以外のすべてを排除する読書モードなど、厳選された機能を内蔵しています。
compare-chrome-although-not-as-extensive = { -brand-name-firefox } は、{ -brand-name-chrome } のアドオンライブラリほどではないものの、大規模なアクティブコントリビューターを擁するオープンソースソフトウェアとして、便利な拡張機能が豊富に揃っています。
compare-chrome-if-having-tons-of-open-tabs = タブをたくさん開くタイプなら、UI の好みで判断しましょう。{ -brand-name-firefox } は、タブを開くたびに小さく縮小していくのではなく、開いているすべてのタブを横スクロールするようにしています。{ -brand-name-google } { -brand-name-chrome } は、ファビコンだけが見えるように縮小します。唯一の問題は、同じウェブサイトから複数のタブを開いていると、複数のタブ間で同じファビコンが表示されることです。
...
compare-chrome-as-for-customization-our = カスタマイズについては、Firefox のファンは、ほとんどの UI 要素をニーズに合わせて動かせることが気に入っています。{ -brand-name-chrome } では、一定の UI 要素を非表示にできますが、好みに応じて移動させる自由はあまりありません。ただし、{ -brand-name-chrome } と { -brand-name-firefox } の両方でブラウザーの見た目とテーマを簡単に変更できます。
compare-chrome-for-practical-purposes-theres = これら両方のブラウザーを併用するのも手でしょう。{ -brand-name-firefox } はプライバシーが関わる場面、{ -brand-name-chrome } は { -brand-name-google } サービスを利用する場面のように使い分けられます。それでも、個人データの侵害が数を増していることを考慮すると、オンラインでのプライバシーを守りたい人にとっては、{ -brand-name-firefox } が長期的に正しい選択となるかもしれません。
