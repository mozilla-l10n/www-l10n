...
# Outdated string
mobile-focus-disappear-your-history = 履歴消去
...
# Outdated string
mobile-focus-private-browsing-on = ほとんどのブラウザーの「プライベートブラウジング」は、標榜するほどプライベートなものではありません。{ -brand-name-firefox-focus } は、常にプライバシーに配慮し、ウェブ上のユーザーの権利を守るために活動する非営利団体 { -brand-name-mozilla } が運営する 1 レベル上のブラウザーです。
