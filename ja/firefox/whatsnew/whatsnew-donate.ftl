...
whatsnew-donate-whatsnew = 新着情報
whatsnew-donate-donate-to = { -brand-name-firefox } を提供する非営利団体 { -brand-name-mozilla-foundation } に寄付をお願いします
...
whatsnew-donate-release-notes = リリースノート
