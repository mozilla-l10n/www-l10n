...
whatsnew-115-vpn-cta = { -brand-name-mozilla-vpn } を試用
whatsnew-115-vpn-very-fast = とにかく高速
whatsnew-115-vpn-wireguard-powered = Mozilla の { -brand-name-wireguard }® 搭載サーバーは、スピード重視の設計なので、いつも通りにストリーミング、ダウンロード、ゲームができます。
whatsnew-115-vpn-without-trace = 形跡を残さずインターネット
whatsnew-115-vpn-never-log = ユーザーのネットワークデータを記録、追跡、共有することはありません。ユーザーのオンライン活動は、Mozilla の VPN サーバーには一切残りません。
