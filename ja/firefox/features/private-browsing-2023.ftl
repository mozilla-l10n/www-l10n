...
features-private-browsing-private-browsing-mode-opens = プライベートブラウジングモードでは、新しいブラウザーウィンドウが開きます。ウィンドウを閉じると、そのウィンドウの閲覧履歴と、訪問したウェブサイトのトラッキング Cookie を消去します。<strong>{ -brand-name-firefox } プロのアドバイス:</strong> 用事が終わったら、忘れずにプライベートブラウジングウィンドウを忘れずに閉じてください。
