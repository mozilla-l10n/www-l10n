...
mission-were-building-a-better-internet = Mozilla は、より良いインターネットを作っています

mission-our-mission-is-to-ensure-the-internet = Mozilla のミッションは、インターネットを、万人にとって門戸が開かれた、利用しやすいグローバルな公共のリソースとすること、各人が自分のエクスペリエンスを決めることが可能で、各人に権限が与えられ、安全かつ独立した、真にユーザー優先のインターネットとすることです。
...
mission-watch-the-video-above-to-learn-more = Mozilla の沿革や、Mozilla によるユーザーのためのウェブ改善など、Mozilla の詳細については、上のビデオをご覧ください。

mission-get-involved = 参加する

mission-volunteer-opportunities-in-a-number = 様々な分野でのボランティアの機会

mission-history = 沿革

mission-where-we-come-from-and-how-we-got = Mozilla の沿革をご紹介します

mission-forums = フォーラム

mission-topics-include-support-products = サポートや製品、テクノロジーなどのトピックがあります
