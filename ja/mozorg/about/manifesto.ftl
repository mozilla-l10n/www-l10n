...
manifesto-use-open-badges-to-share = オープンバッジを使ってスキルや興味を共有する
manifesto-explore-how-the-web-impacts = ウェブが科学に与える影響について
manifesto-learn-about-open-source = 報道関係でのオープンソースコードについて
manifesto-read-about-open-internet = オープンインターネット方針の活動と展開について
manifesto-explore-how-to-help-keep = ウェブをオープンに保つ支援方法について
manifesto-see-how-the-web-can-connect = いかにしてウェブが社会とヘルスケアをつなぐかについて
manifesto-explore-how-the-web-works = ウェブのしくみについて
manifesto-see-how-mozilla-works = どのようにして { -brand-name-mozilla } がプライバシーを優先するかについて
manifesto-read-about-developments = プライバシーとデータの安全の発展について
manifesto-learn-more-about-how-to = オンラインで自分を守る方法の詳細について
manifesto-use-these-free-tools-to = ウェブの教育に使用する各種フリーツールについて
manifesto-learn-about-creating-and = ウェブコンテンツの作成・案内について
manifesto-add-new-voices-to-open = オープンソーステクノロジーに新たな意見を紹介することについて
manifesto-set-your-do-not-track = トラッキングを防止する設定方法について
manifesto-understand-the-web-ecosystem = ウェブのエコシステムを理解する
manifesto-explore-how-open-practices = オープン慣行がウェブを利用しやすいものに保つ
manifesto-learn-how-to-remix-content = コンテンツの組み合わせを変えて新しいものを創出する方法
manifesto-learn-how-to-maximize = ウェブにおける対話の潜在能力を最大限に発揮させる方法
manifesto-participate-in-our-governance = Mozilla のガバナンスフォーラムへの参加
manifesto-join-us-as-a-volunteer = ボランティアとして Mozilla に参加する
manifesto-learn-how-to-collaborate = オンラインでの共同作業方法について
manifesto-visualize-who-you-interact = { -brand-name-lightbeam } を使用してウェブ上の対話相手を可視化する
manifesto-learn-about-creating-web = 他者とのウェブリソース共同制作について
manifesto-host-or-join-a-maker-party = { -brand-name-maker-party } の開催・参加について
manifesto-learn-how-to-build-online = オンラインでの共同作業スキルを習得する方法について
