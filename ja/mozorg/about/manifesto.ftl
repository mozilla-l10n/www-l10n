...
manifesto-details-the-mozilla-project-global-v2 = { -brand-name-mozilla } プロジェクトとは、門戸が開かれていること、イノベーション、機会がインターネットの継続的健全性に不可欠であると考える人々によるグローバル規模のコミュニティです。Mozilla は 1998 年以来、インターネットが確実に全ての人々に有益な形で発展するよう、取り組んできました。Mozilla は主に { -brand-name-mozilla } { -brand-name-firefox } ウェブブラウザーの制作で知られています。
...
manifesto-details-the-mozilla-project-community-v2 = { -brand-name-mozilla } プロジェクトでは、コミュニティベースの方法により、世界基準のオープンソースソフトウェアを制作し、新たな形態の共同作業を開発しています。Mozilla は、万人のインターネットエクスペリエンスを向上させることに関与する人々のコミュニティを組織しています。
...
manifesto-commitment-1 = 公約 1
manifesto-commitment-2 = 公約 2
manifesto-commitment-3 = 公約 3
manifesto-commitment-4 = 公約 4

manifesto-if-you-share-this-goal-v2 = この目標にご賛同いただける方は、協力方法のご希望を教えてください。

# Variables:
#   $github_link (url) - link to https://github.com/mozilla
manifesto-we-create-open = Mozilla は、ベースとなる<a { $github_link }>オープンソースソフトウェアを開発しています</a>。

# Variables:
#   $mofo_link (url) - link to https://www.mozillafoundation.org/
manifesto-we-fund-fellows = より良いインターネットの創造を目指す<a { $mofo_link }>フェローへの資金提供やプロジェクトの助成を行っています</a>。

# Variables:
#   $mozai_link (url) - link to https://www.mozilla.ai
manifesto-we-build-open-source = 開発者に選択肢を提供し、コスト削減を支援する<a { $mozai_link }>オープンソースの AI ツールを開発しています</a>。

# Variables:
#   $mozvc_link (url) - link to https://mozilla.vc
manifesto-we-invest-in = <a { $mozvc_link }>責任あるテクノロジー系スタートアップ企業に投資しています</a>。

# Variables:
#   $mdc_link (url) - link to https://mozilladatacollective.com/
manifesto-we-run-a-global = 公正なデータ交換のための<a { $mdc_link }>グローバルなコミュニティを運営しています</a>。

# Variables:
#   $festival_link (url) - link to https://www.mozillafoundation.org/festival/
manifesto-we-host-a-yearly = マニフェストを推進するあらゆるものを創り出す人々のために、<a { $festival_link }>毎年世界規模の集いを開催しています</a>。

# Variables:
#   $firefox_link (url) - link to https://www.firefox.com/
#   $thunderbird_link (url) - link to https://www.thunderbird.net/
manifesto-we-make-firefox-and-thunderbird = そしてもちろん、Mozilla は <a { $firefox_link }>{ -brand-name-firefox }</a> と <a { $thunderbird_link }>{ -brand-name-thunderbird }</a> を開発しています。これらすべては、インターネットを健全な場所にしてくれる人々を手助けするためのものです。
...
manifesto-share-on-bluesky = Bluesky でシェア
...
manifesto-i-support-the-vision-of-v2 = 私は { -brand-name-mozilla } のより健全で優れたインターネットのビジョンに賛同します。あなたはどうですか？
