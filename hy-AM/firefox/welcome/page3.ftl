...
welcome-page3-never-forget-reset-or-travel = Երբեք մի մոռացեք, վերակայեք կամ կրկին ճանապարհորդեք առանց ձեր գաղտնաբառերի:
welcome-page3-facebook-container = { -brand-name-facebook-container }
welcome-page3-get-a-container-to-keep-facebook = Ստացեք պարունակ, որպեսզի { -brand-name-facebook }-ը չմիջամտի ձեր գործերին:
welcome-page3-pocket = { -brand-name-pocket }
welcome-page3-trade-clickbait-and-fake-news = Առևտրային clickbait և կեղծ նորություններ՝ որակյալ բովանդակության համար:
welcome-page3-firefox-send = { -brand-name-firefox-send }
welcome-page3-send-huge-files-to-anyone = Հսկայական ֆայլեր ուղարկեք յուրաքանչյուրին, ում ցանկանում եք՝ ինքնաբեռնված հղումներով:
welcome-page3-why-am-i-seeing-this = Ինչո՞ւ եմ ես սա տեսնում:
