...
firefox-home-get-the-browser-extension = Ստացեք զննարկիչի ընդայնում
firefox-home-get-the-facebook-container = Ստացեք { -brand-name-facebook-container } ընդլայնումը
firefox-home-download-the-browser = Ներբեռնել զննարկիչը
firefox-home-download-the-app = Ներբեռնել հավելվածը
firefox-home-desktop = Դեսքթոփ
firefox-home-browsers = Զննարկիչներ
