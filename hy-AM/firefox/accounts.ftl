...
firefox-accounts-securely-sync-your = Ապահով կերպով համաժամացրեք ձեր գաղտնաբառերը, էջանիշները և ներդիրները ձեր բոլոր սարքերում: Ստացեք { -brand-name-firefox-account }ը հիմա՝ մեկ մուտքագրում՝ հզոր և գաղտնիություն ամենուր:
# The span here is for visual formatting to display the phrase "Join Firefox" in a different color.
firefox-accounts-there-is-a-way-to-protect = Ձեր գաղտնիությունը պաշտպանելու միջոց կա: <span>Միացեք{ -brand-name-firefox }-ին:</span>
...
firefox-accounts-take-your-stand-against = Դեմ դուրս եկեք այն ոլորտի, որը Ձեզ դիտարկում է որպես ապրանք:
...
firefox-accounts-youre-signed-in-to = Դուք մուտք եք գործել <br>{ -brand-name-firefox }: <br><span>Այժմ փորձեք { -brand-name-firefox-monitor }:</span>
firefox-accounts-see-if-youve-been = Տեսեք, արդյոք մասնկացե՞լ եք առցանց տվյալների խախտմանը։
firefox-accounts-sign-in-to-monitor = Մուտք գործել { -brand-name-monitor }
firefox-accounts-join-firefox = Միացեք { -brand-name-firefox }֊ին
firefox-accounts-enter-your-email-address = Մուտքագրեք ձեր էլփոստի հասցեն
firefox-accounts-already-have-an-account = Արդեն ունե՞ք հաշիվ
firefox-accounts-sign-in = Մուտք գործել
firefox-accounts-meet-our-family-of = Հանդիպեք մեր առաջին գաղտնիության ընտանիքին։
firefox-accounts-firefox-is-technology = { -brand-name-firefox }֊ը տեխնոլոգիա է, որը պայքարում է ձեզ համար։
firefox-accounts-get-technology-that = Ձեռք բերեք տեխնոլոգիա,որը պայքարում է ձեզ համար։
