...
compare-shared-yes = Eyo
# Used as an accessible label for a "no" icon (a gray bar)
compare-shared-no = Ku
compare-shared-search-engine-options = Ter me ingine yeny
...
compare-shared-download-firefox = Gam { -brand-name-firefox }
compare-shared-download-firefox-browser = Gam { -brand-name-firefox-browser }
compare-shared-download-the-app = Gam purugram
...
compare-shared-compare-browsers = Por Layeny
