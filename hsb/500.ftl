...
error-page-error-page-internal-server-error = 500: Nutřkowny serwerowy zmylk
error-page-something-went-wrong = Něšto je so nimokuliło
error-page-its-probably-just-a-server-error = Je najskerje jenož serwerowy problem a dźěłamy, zo bychmy jón rozrisali.
# Variables:
