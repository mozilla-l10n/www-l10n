...
features-index-is-firefox-a-fast-browser = Je { -brand-name-firefox } spěšny wobhladowak?
features-index-firefox-uses-less-memory-than = { -brand-name-firefox } mjenje składa hač Chrome přetrjebuje, zo bychu waše druhe programy dale z najwyšej spěšnosću běželi.
...
features-index-translate-more-than = Přełožujće z wjace hač 100 rěčow direktnje do swojeje rěče w swojim { -brand-name-firefox } – lóšo hač do toho.
