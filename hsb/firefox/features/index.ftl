...
features-index-private-browsing-mode = Priwatny modus plackowe daty a wašu historiju přehladowanja zhaša, kóždy raz, hdyž jón začinjeće.
...
features-index-use-less-memory = { -brand-name-firefox } mjenje składa hač { -brand-name-chrome } přetrjebuje, zo bychu waše druhe programy dale z najwyšej spěšnosću běželi.
...
features-index-read-mozillas-mission = Čitajće misiju { -brand-name-mozilla }
