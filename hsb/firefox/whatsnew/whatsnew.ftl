...
whatsnew-release-notes-v2 = Čitajće <a { $url }>wersije informacije</a>, zo byšće wjace wo nowych funkcijach a změnach w swojim wobhladowaku { -brand-name-firefox } zhonił.
# Obsolete string
# Variables:
#   $url (url) - link to https://www.mozilla.org/firefox/notes/
whatsnew-release-notes = Čitajće <a href="{ $url }">wersije informacije</a>, zo byšće wjace wo nowych funkcijach a změnach w swojim wobhladowaku { -brand-name-firefox } zhonił.
