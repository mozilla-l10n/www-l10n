...
# html page title
whatsnew80-page-title = Nowe funkcije a změny w { -brand-name-firefox }
whatsnew80-up-to-date-banner = Zbožopřeće! Wužiwaće najnowšu wersiju { -brand-name-firefox }.
# Main title
whatsnew80-main-title = Čińće nimale wšitko trochu spěšnišo
whatsnew80-main-intro = Přeńdźće wot ličaka do telefona bjeztoho, zo byšće so komdźił. Wobstarajće sej { -brand-name-firefox } za mobilne graty.
whatsnew80-primary-cta-description = Zapodajće swoju e-mejlowu adresu abo telefonowe čisło, zo byšće sćehnjenski wotkaz dóstał
