...
privacy-passwords-your-browser-also = Waš wobhladowak was tež wo tym informuje, kak dowěryhódne sydła su, zo by was před kradnjenjom datow škitał. Z druheje strony, hdyž pospytujeće websydło wopytać, kotrež je jako sydło znate, kotrež daty kradnu, { -brand-name-firefox } (a kóždy wjetši wobhladowak) warnowanje na połnej wobrazowce pokaza – <strong>Dźiwajće na to a přemyslće sej dwójce, hač te sydło wužiwaće!
