...
firefox-doesnt-spy = { -brand-name-firefox } was online njewuskušuje. Blokujemy wjele znatych slědowacych plackow třećich a damy wam połnu kontrolu.
super-fast = Superspěšny
get-speed-and = Wobstarajće sej spěšnosć a wěstotu. { -brand-name-firefox } je spěšny, dokelž wašim aktiwitam njeslědujemy.
always-evolving = Wuwiwa so přeco
# Variables:
# $url (url) - link to https://www.mozilla.org/firefox/features
find-out-about = Wotkryjće wšě wuběrne funkcije <a href="{ $url }">{ -brand-name-firefox }</a>.
