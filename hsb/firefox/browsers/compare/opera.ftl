...
# HTML page title
compare-opera-firefox-vs-opera-which-is = { -brand-name-firefox } porno { -brand-name-opera }: Kotry je lěpši wobhladowak za was?
# HTML page description
compare-opera-compare-opera-to-the-firefox = Přirunajće { -brand-name-opera } z { -brand-name-firefox-browser }, zo byšće zwěsćił, kotry je najlěpši wobhladowak za was.
# Main title
