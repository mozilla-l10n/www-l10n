...
firefox-is-independent = { -brand-name-firefox } je njewotwisny a spěchuje so wot powšitkownosći wužitneho organizacije { -brand-name-mozilla }, kotryž za waše prawa online wojuje, a čini internet wšudźe přistupny za kóždeho.
...
comparing-firefox-edge = Přirunanje mjez { -brand-name-firefox-browser } a { -brand-name-microsoft } { -brand-name-edge }
comparing-firefox-ie = Přirunanje mjez { -brand-name-firefox-browser } a { -brand-name-microsoft } { -brand-name-ie }
