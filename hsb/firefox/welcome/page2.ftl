...
welcome-page2-pocket-is-built-right-into = { -brand-name-pocket } je w { -brand-name-firefox } zatwarjeny, móžeće lochko stawiznički składować, hdyž je namakaće a potom na kóždym graće čitać.
welcome-page2-save-content-from-everywhere = Składujće wobsah wot wšudźe
welcome-page2-grab-articles-videos-and-links = Klikńće na symbol { -brand-name-pocket } w symbolowej lajsće wašeho wobhladowaka, zo byšće přistup k nastawkam, widejam a wotkazam někajkeho websydła měł.
welcome-page2-discover-new-stories = Wotkryjće nowe stawiznički
welcome-page2-pocket-shows-recommended-stories = { -brand-name-pocket } wam kóždy raz doporučene stawiznički pokazuje, hdyž nowy rajtark wočinjeće. Składujće te, kotrež was zajimuja.
