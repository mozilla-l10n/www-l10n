...
welcome-page2-pocket-is-built-right-into = { -brand-name-pocket } je w { -brand-name-firefox } zatwarjeny, móžeće lochko stawiznički składować, hdyž je namakaće a potom ns kóždym graće čitać.
