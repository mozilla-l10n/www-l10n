...
privacy-faq-we-only-collect-the-data-we = Zběramy jenož daty, kotrež trjebamy, zo bychmy najlěpše produkty wuwiwali.
privacy-faq-we-put-people-in-control-of = Wostajamy ludźom kontrolu nad jich datami a dožiwjenjemi online.
privacy-faq-we-adhere-to-no-surprises-principle = Za nas princip „žane překwapjenki“ płaći, to rěka, dźěłamy ćežko na tym, zo so wočakowanja ludźi na { -brand-name-firefox } z woprawdźitosću kryja.
...
privacy-faq-there-are-two-categories-of = Stej dwě kategoriji datow, kotrejž po standardźe w našej kónčnej wersiji { -brand-name-firefox } zběramy.
...
privacy-faq-the-second-is-what-we-call-interaction = Druhu mjenujemy „interakciske daty“. To su daty wo interakciji jednotliweho wužiwarja z { -brand-name-firefox }, na přikład ličba wočinjenych rajtarkow, status wužiwarskich nastajenjow abo kak husto su so wěste funkcije wobhladowaku wužili, na přikład fota wobrazowki abo kontejnery. Zběramy tute daty na přikład z pomocu tłóčatka Wróćo, tutoho šipka w lěwym hornim róžku wašeho wobhladowaka, kotrež wam zmóžnja, k předchadnej stronje nawigować, zo bychmy móhli widźeć, hač něchtó je tłóčatko Wróćo wužił, ale njemóžemy widźeć, kotre webstrony sće wopytał.
privacy-faq-do-you-collect-more-data-in = Zběraće wjace datow w předwersijach { -brand-name-firefox }?
privacy-faq-sort-of-in-addition-to-the-data = We wěstym nastupanju. Přidatnje k datam, kotrež smy horjeka wopisali, dóstawamy w předwersiji { -brand-name-firefox } po standardźe rozprawy wo zmylkach a spadach.
# Variables:
#   $link (url) - link to https://support.mozilla.org/kb/shield
privacy-faq-we-may-also-collect-additional = Móžemy tež dalše daty w předwersiji zběrać, za jednu z našich <a href="{ $link }">studijow</a>. Někotre studije na přikład tak mjenowane „daty webaktiwity“ trjebaja, ke kotrymž móža URL a drihe daty wo wěstych websydłach słušeć. To nam pomha, na wěste prašenja wotmołwić, zo bychmy { -brand-name-firefox } polěpšili, na přikład, kak dadźa so wěste woblubowane websydła do wěstych rěčnych wersijow integrować.
privacy-faq-mozillas-pre-release-versions = Předwersije { -brand-name-mozilla } { -brand-name-firefox } su wuwiwanske platformy, kotrež so husto z eksperimentelnymi funkcijemi aktualizuja. Zběramy w předwersiji wjace datow hač w kónčnych wersijach, zo bychmy rozumili, kak tute eksperimentelne funkcije funguja. Móžeće zběranje tutych datow w nastajenjach znjemóžnić.
privacy-faq-but-why-do-you-collect-any-data = Ale čehodla poprawom daty zběraće?
privacy-faq-if-we-dont-know-how-the-browser = Jeli njewěmy, kak wobhladowak běži abo kotre funkcije ludźo wužiwaja, njemóžemy jón polěpšić a wam wulkotny produkt poskićić. Smy nastroje za zběranje a analyzowanje datow wuwili, kotrež nam zmóžnjeja, inteligentne rozsudy wo našim produkće činić a priwatnosć ludźi respektować.
