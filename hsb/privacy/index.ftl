...
privacy-index-contact-mozilla = Z { -brand-name-mozilla } do zwiska stajić
privacy-index-if-you-want-to-make-a-correction = Jeli chceće swoje daty porjedźić, abo maće prašenja wo našich prawidłach priwatnosće, stajće so do zwiska z:
# Variables:
#   $dsar (url) - link to https://app.onetrust.com/app/#/webform/4ba08202-2ede-4934-a89e-f0b0870f95f0
privacy-index-see-here-for-data-subject = <a href="{ $dsar }">Hlejće tu přistupne požadanja za potrjechene wosoby.</a>
# Variables:
#   $sumo (url) - link to https://support.mozilla.org/
privacy-index-for-product-support-requests = Za naprašowanja produktoweje podpěry wopytajće prošu <a href="{ $sumo }">naše forumy</a>.
privacy-index-data-privacy-principles = Principy za škit datow
# Variables:
...
privacy-index-mozilla-subscription-services = Abonementowe słužby { -brand-name-mozilla }
