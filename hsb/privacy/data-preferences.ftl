...
data-preferences-notification-opt-out = Sće wot hromadźenja datow prěnjeho poskićowarja wotzjewjeny.
...
data-preferences-if-you-still-want-to = Jeli hišće chceće so wot analyzow prěnjeje poskićowarja wotzjewić, móžeće to deleka činić. Hdyž na tłóčatko wotzjewjenja klikaće, so plack staja, kotryž so wužiwa, zo by tomu zadźěwak, zo { -brand-name-glean } daty sćele, hdyž naše webstrony začitujeće. Tutón nastajenski plack je za 1 lěto płaćiwy.
