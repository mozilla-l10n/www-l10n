...
privacy-principles-data-privacy-principles = Principy datoweho škita
# HTML page description
privacy-principles-mozilla-is-an-open-source = { -brand-name-mozilla } je projekt wotewrjeneho žórła z misiju, waše internetne dožiwjenje polěpšić. To je ćěrjaca móc za našimi praktikami datoweho škita.
# Variables:
...
privacy-principles-use-and-share-information = Wužiwamy a dźělimy daty na wašnje, kotrež je transparentne a za wužiwarja z wužitkom.
...
privacy-principles-maintain-multi-layered = Wěstota so přez wjaceworštowe wodźenje a praktiki zaručuje, kotrež su zjawnje přepruwujomne.
