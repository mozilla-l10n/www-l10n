...
privacy-firefox-privacy-isnt-just-v2 = Tu je wulki wobraz: { -brand-name-firefox } so z priwatnosću a škitom jako standard wuwiwa. Njewěmy wjele wo was. Štož wěmy, njepředamy. A na rozdźěl wot druhich wobhladowakow, přewostajamy wam wólbu, maćiznu znjemóžnić, kotraž was hněwa. Zdźělenka priwatnosće { -brand-name-firefox } so na jasnosć, kontrolu a zamołwite standardy zepěra. Móžeće z nami ličić, zo byšće jasnje wujasnił, štož { -brand-name-firefox } po standardźe čini a swoje nastajenja přiměrić, zo byšće móhł na swoje wašnje přehladować.
