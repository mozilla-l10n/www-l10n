...
vpn-download-faq-support = Móžeće so direktnje z nałoženja { -brand-name-mozilla-vpn } z teamom pomocy do zwiska stajić, hdyž na Nastajenja > Pomoc wobstarać > Pomoc skontaktować klikaće. Móžeće so tež z nami <a href="{ $support }">na  našej stronje pomocy</a> do zwiska stajić.
