...
vpn-download-page-title = { -brand-name-mozilla-vpn } sćahnyć
vpn-download-page-description = Sćehńće { -brand-name-mozilla-vpn } za { -brand-name-windows }, { -brand-name-mac }, { -brand-name-linux }, { -brand-name-android } a { -brand-name-ios }.
# Variables:
...
vpn-download-for-linux-long = Sćehńće { -brand-name-mozilla-vpn } za { -brand-name-linux }
# Variables:
#   $version (number) - operating system version
...
vpn-download-install-via-flathub = Přez Flathub instalować
vpn-download-install-via-apt = Přez APT instalować
