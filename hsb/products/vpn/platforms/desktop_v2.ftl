...
vpn-desktop-if-you-are = Jeli za VPN pytaće, zo byšće swój laptop abo PC škitał, wupruwujće { -brand-name-mozilla-vpn }. { -brand-name-mozilla-vpn } so přez powšitkownowužitne předewzaće podpěruje. Zhońće, kak VPN was škita a čehoždla wy měł { -brand-name-mozilla } ze swojej priwatnosću a wěstotu dowěrić.
...
vpn-desktop-safer-against-spying = <strong>Wěsćiši přećiwo spionowanju:</strong> Hdyž so waše daty přez VPN zaklučuja, je wirtualnje za kóždeho njemóžno, waš syćowy zwisk wuskušować, zo by zhonił, wo čim a z kim komunikujeće.
