...
vpn-linux-multi-hop = <strong>Multi-hop routing:</strong> Za zwyšenje škita móže { -brand-name-mozilla-vpn } waš wobchad zaklučować a jón po dwěmaj stejnišćomaj město jednym stejnišćom wjesć, štož za kóždeho poćežuje, wašej aktiwiće online slědować.
