...
bundle-feature-more-than-countries =
    { $num_vpn_countries ->
        [one] Wjace hač { $num_vpn_countries } kraj
        [two] Wjace hač { $num_vpn_countries } krajej
        [few] Wjace hač { $num_vpn_countries } kraje
       *[other] Wjace hač { $num_vpn_countries } krajow
    }
