...
send-to-device-send-firefox = Pósćelće { -brand-name-firefox } na swóje šmóratko abo tablet
send-to-device-your-download-link = Waš sćehnjenski wotkaz je so pósłał.
send-to-device-please-enter-an-email = Prošu zapodajće e-mejlowu adresu.
...
send-to-device-send-to-another = Na druhi grat pósłać
