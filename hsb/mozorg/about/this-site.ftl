...
about-this-site-today-v2 = Dźensa je to sydło, hdźež ludźo wjace <a href="{ $mozilla }">wo { -brand-name-mozilla }</a> zhonił a <a href="{ $vpn }">{ -brand-name-mozilla-vpn }</a> wupruwuja. Móžeće tež někotre <a href="{ $book }">jutrowne jejka</a> nimoducy wotkryć.
