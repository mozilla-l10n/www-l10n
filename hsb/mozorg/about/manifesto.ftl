...
manifesto-visualize-who-you-interact = Wizualizujće z Lightbeam, z kimž we webje interagěrujeće
manifesto-learn-about-creating-web = Zhońće, kak móžeće webresursy hromadźe z druhimi ludźimi wutworić
manifesto-host-or-join-a-maker-party = Zarjadujće abo wopytajće Maker Party
...
manifesto-details-articulate-a-vision = wiziju za internet artikulować, kotruž załožba { -brand-name-mozilla } ma po měnjenju sobuskutkowacych { -brand-name-mozilla } spěchować;
...
manifesto-details-these-principles = Tute principy so same wot so njezwoprawdźeja. Ludźo su trěbne, kotřiž internet wotewrjeny a k městnu aktiwneho wobdźělenja činja - ludźo, kotřiž jako jednotliwcy jednaja, w skupinach hromadźe dźěłaja a druhich nawjeduja. Załožba { -brand-name-mozilla } ma nadawk, principy manifesta { -brand-name-mozilla } spěchować. Přeprošujemy druhich, so nam přidružić a internet k dźeń a lěpšemu městnu za kóždeho činić.
...
manifesto-details-mozilla-foundation = Lubjenje załožby Mozilla
manifesto-details-the-mozilla-foundation-pleges = Załožba { -brand-name-mozilla } lubi aktiwity manifesta { -brand-name-mozilla } podpěrać. Předewšěm budźemy:
...
manifesto-details-some-foundation = Někotre aktiwity załožby - tuchwilu wutorjenje, poskićenje a spěchowanje kupcowskich produktow - so hłownje přez { -brand-name-mozilla-corporation }, stoprocentowu wotnožku towarstwa załožby Mozilla přewjedu.
manifesto-details-invitation = Přeprošenje
manifesto-details-the-mozilla-foundation-invites = Załožba { -brand-name-mozilla } přeprošuje wšěch druhich, kotřiž principy manifesta { -brand-name-mozilla } podpěruja, so nam přidružić a nowe puće namakać, tutu wiziju interneta zwoprawdźić.
