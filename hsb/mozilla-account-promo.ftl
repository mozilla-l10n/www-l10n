...
moz-account-already-have = Maće hižo konto? <a { $sign_in_url }>Přizjewće so</a> abo <a { $learn_more_url }>zhońće wjace</a> wo { -brand-name-mozilla }.
moz-account-get-a-mozilla-account = Wobstarajće sej { -brand-name-mozilla-account }
