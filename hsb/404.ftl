...
not-found-page-donate-to-mozilla-reclaim-from-v2 = <a { $donate }>Darće</a> załožbje { -brand-name-mozilla-foundation } a dóstańće internet wot wulkich technologiskich předewzaćow wróćo.
