...
-brand-name-firefox-account = konto Firefox
...
-brand-name-tabstack = Stapl rajtarkow
...
-brand-name-mozilla-ads = Wabjenje Mozilla
-brand-name-builders = Wuwiwarjo
