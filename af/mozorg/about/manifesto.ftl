...
manifesto-use-open-badges-to-share = Gebruik Oop Kentekens om vaardighede en belangstellings te deel
manifesto-learn-about-open-source = Leer oor oopbronkode in joernalistiek
manifesto-see-how-mozilla-works = Kyk hoe { -brand-name-mozilla } werk om u privaatheid te prioritiseer
manifesto-read-about-developments = Meer inligting oor privaatheid en dataveiligheid
manifesto-learn-more-about-how-to = Meer inligting oor hoe om mens self te beskerm aanlyn
manifesto-add-new-voices-to-open = Voeg nuwe stemme by oopbrontegnologie
manifesto-set-your-do-not-track = Stel u voorkeur vir “Moenie volg nie”
manifesto-learn-how-to-remix-content = Leer hoe om inhoud te herkombineer om iets nuuts te skep
manifesto-participate-in-our-governance = Neem deel in ons oorsigforum
manifesto-join-us-as-a-volunteer = Sluit aan as 'n vrywilliger
manifesto-learn-how-to-collaborate = Lees oor samewerking aanlyn
manifesto-host-or-join-a-maker-party = Hou 'n Makerpartytjie, of woon een by
manifesto-learn-how-to-build-online = Leer meer oor samewerking aanlyn
...
manifesto-details-articulate-a-vision = spel uit 'n visie vir die Internet wat { -brand-name-mozilla }-deelnemers wil hê dat die { -brand-name-mozilla }-stigting heen moet mik;
manifesto-details-speak-to-people = spreek tot mense of hulle 'n tegniese agtergrond het of nie;
...
manifesto-details-individuals-security = Individue se sekuriteit en privaatheid op die Internet is van fundamentele belang en mag nie as opsioneel hanteer word nie.
...
manifesto-details-mozilla-foundation = Belofte van die Mozilla-stigting
manifesto-details-the-mozilla-foundation-pleges = Die { -brand-name-mozilla }-stigting belowe om die { -brand-name-mozilla }-manifes te ondersteun in al sy aktiwiteite. Meer spesifiek belowe ons om:
...
manifesto-details-some-foundation = Sommige van die Stigting se aktiwiteite — tans die skep, verskaffing en bevordering van produkte vir eindgebruikers — word primêr uitgevoer deur die Mozilla-stigting se volfiliaal, die Mozilla-korporasie.
manifesto-details-invitation = Uitnodiging
manifesto-details-the-mozilla-foundation-invites = Die { -brand-name-mozilla }-stigting nooi almal uit wat die beginsels van die { -brand-name-mozilla }-manifes ondersteun om by ons aan te sluit en nuwe maniere te vind om dié visie van die Internet 'n realiteit te maak.
