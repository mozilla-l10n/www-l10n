...
newsletter-form-im-okay-with-mozilla = Dis reg as my inligting hanteer word soos verduidelik in <a href="{ $url }">dié privaatheidkennisgewing</a>
...
newsletter-form-keep-up-with = Bly op datum met<br>alles oor { -brand-name-firefox }.
newsletter-form-get-mozilla-updates = Jongste { -brand-name-mozilla }-nuus
