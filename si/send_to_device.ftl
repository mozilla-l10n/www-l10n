...
send-to-device-intended-recipient-email = විද්‍යුත් තැපෑල ලැබීමට අදහස් කල ග්‍රාහකයා එය අනුමත කර තිබිය යුතුයි.
send-to-device-check-your-device-email = විද්‍යුත් තැපෑල සඳහා ඔබගේ මෙවලම පරීක්ෂා කරන්න!
send-to-device-send-to-another = වෙනත් උපාංගයකට යවන්න
