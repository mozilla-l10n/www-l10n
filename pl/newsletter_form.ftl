...
newsletter-form-join-the-community = Dołącz do społeczności
newsletter-form-sign-up-to-receive = Zarejestruj się, aby co miesiąc otrzymywać aktualności od { -brand-name-firefox(case: "gen") } i informacje o trendach internetowych, które kształtują Twoje życie w sieci.
# Variables:
...
newsletter-form-label = Formularz rejestracji biuletynu
