...
vpn-features-were-backed-by-mofo-v2 = Jesteśmy wspierani przez <a { $mofo }>{ -brand-name-mozilla-foundation(case: "gen") }</a>, organizację non-profit walczącą o utrzymanie otwartej i zdrowej sieci dla wszystkich ludzi.
