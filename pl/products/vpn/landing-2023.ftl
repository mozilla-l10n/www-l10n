...
vpn-landing-see-all-the-ways-mozilla-vpn = Poznaj wszystkie sposoby, w jakie { -brand-name-mozilla-vpn } Cię chroni.
vpn-landing-how-a-vpn-helps-you = W jaki sposób VPN pomaga użytkownikowi?
vpn-landing-how-a-vpn-helps-you-v2 = W jaki sposób { -brand-name-mozilla-vpn } pomaga użytkownikowi?
vpn-landing-keeps-your-data-safe = Zapewnia bezpieczeństwo Twoich danych w publicznej sieci Wi-Fi
vpn-landing-log-in-to-your-bank-or = Loguj się bez obaw do swojego banku lub gabinetu lekarskiego z lotniska, kawiarni lub dowolnego innego miejsca.
vpn-landing-blocks-advertisers-from = Blokuje reklamodawcom możliwość targetowania Cię
vpn-landing-hide-your-activity-from = Ukryj swoją aktywność przed skryptami śledzącymi i złośliwym oprogramowaniem, aby móc robić zakupy bez obawy, że ktoś Cię obserwuje.
...
vpn-landing-easy-firefox-integration = Łatwa integracja z { -brand-name-firefox(case: "loc") } za pomocą rozszerzenia { -brand-name-mozilla-vpn } (tylko dla Windows)
