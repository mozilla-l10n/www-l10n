...
# HTML page title
privacy-faq-v2-title = Najczęściej zadawane pytania o ochronę prywatności danych { -brand-name-mozilla(case: "gen") }
# HTML page description
privacy-faq-v2-desc = W { -brand-name-mozilla(case: "loc") } szanujemy i chronimy Twoje dane osobowe.
privacy-faq-v2-heading = Stawiamy ludzi ponad zyskiem.
privacy-faq-v2-intro = Czasami nie wiadomo, czego się spodziewać po używanym oprogramowaniu lub usłudze. Technologia wspierająca nasze życie jest skomplikowana i nie każdy ma czas, aby zgłębiać się w szczegóły. To dotyczy także { -brand-name-firefox(case: "gen") } — okazuje się, że różni ludzie mają różne rozumienie tego, co dzieje się pod maską ich przeglądarki.
privacy-faq-v2-at-mozilla = W { -brand-name-mozilla(case: "loc") } szanujemy i chronimy Twoje dane osobowe:
# Variables:
#   $attrs (url) - link to https://www.mozilla.org/privacy/principles/
privacy-faq-v2-we-follow = Działamy zgodnie z <a { $attrs }>pryncypiami prywatności danych</a>, które kształtują nasze podejście do prywatności w przeglądarkach { -brand-name-firefox } dla komputerów i telefonów.
privacy-faq-v2-we-strive-collect-data = Staramy się gromadzić tylko te dane, których potrzebujemy do tworzenia najlepszych produktów.
privacy-faq-v2-we-work-to = Pracujemy nad tym, aby dać ludziom kontrolę nad ich danymi i życiem w Internecie.
privacy-faq-v2-we-adhere = Trzymamy się zasady „żadnych niespodzianek”, co oznacza, że ciężko pracujemy aby zapewnić, że wszyscy rozumieją, jaki { -brand-name-firefox } jest w rzeczywistości.
privacy-faq-v2-following-questions = Poniższe pytania i odpowiedzi pomogą w zrozumieniu, czego można oczekiwać od { -brand-name-mozilla(case: "gen") } i { -brand-name-firefox(case: "gen") }.
