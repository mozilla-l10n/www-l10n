...
footer-nightly-for-android = { -brand-name-nightly } na { -brand-name-android }a
footer-beta-for-android = { -brand-name-beta } na { -brand-name-android }a
footer-visit-mozilla-corporations = Odwiedź <a { $mofo_link }>Fundację Mozilli</a>, nadrzędną organizację <a { $moco_link }>{ -brand-name-mozilla-corporation }</a>.
