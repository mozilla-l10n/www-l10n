...
switch-share-with-your-friends = Podziel się ze znajomymi, jak przejść na { -brand-name-firefox(case: "acc") }
switch-firefox-makes-switching-fast-tweet = 🔥 Przejście z { -brand-name-chrome } na { -brand-name-firefox(case: "acc") } jest superszybkie. Ty też spróbuj!
switch-switch-to-firefox = Przejdź na { -brand-name-firefox(case: "acc") }
switch-firefox-makes-switching-fast-email = Przejście z { -brand-name-chrome } na { -brand-name-firefox(case: "acc") } jest superszybkie. Ja bardzo lubię { -brand-name-firefox(case: "acc") }, Ty też spróbuj.
...
switch-share-to-facebook-updated = Udostępnij na { -brand-name-facebook(case: "loc") }
switch-hey = Hej,
switch-check-it-out = Wypróbuj i daj mi znać, jak poszło:
switch-send-an-email = Wyślij e-mail
