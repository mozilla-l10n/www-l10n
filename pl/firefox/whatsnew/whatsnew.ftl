...
whatsnew-out-of-date-notification = Dostępna jest jeszcze nowsza wersja przeglądarki { -brand-name-firefox-browser }. Aby zaktualizować przeglądarkę, uruchom ją ponownie.
# Variables:
#   $url (url) - link to https://www.mozilla.org/firefox/notes/
whatsnew-release-notes = W <a href="{ $url }">informacjach o wydaniu</a> znajdziesz więcej informacji na temat nowych funkcji w przeglądarce { -brand-name-firefox }.
