...
pdf-editor-if-you-need-to-add-stuff-to-a-pdf = Jeśli chcesz dodać coś do dokumentu PDF, teraz możesz to zrobić online z pomocą { -brand-name-firefox }. Otwórz plik PDF w przeglądarce { -brand-name-firefox } i kliknij przycisk Tekst lub Rysuj w prawym górnym rogu, aby wprowadzić zmiany w dokumencie. Pobierz plik, aby zachować zmiany.
