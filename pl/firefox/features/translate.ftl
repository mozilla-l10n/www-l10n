...
# page title
features-translate-translate-the-web-title = Tłumacz Internet — bezpośrednio w przeglądarce
# page description
...
features-translate-for-everyone-v2 = { -brand-name-firefox } jest dla wszystkich
# Outdated string
