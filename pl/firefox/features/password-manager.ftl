...
# HTML page title
password-manager-firefox-browser = { -brand-name-firefox-browser }: szybki i prosty menedżer haseł
# HTML page description
password-manager-firefox-password = Menedżer haseł { -brand-name-firefox(case: "gen") } umożliwia zachowywanie wszystkich haseł w jednym miejscu, ułatwiając automatycznie logowanie na stronach lub odzyskanie zachowanych haseł.
# Hero title
password-manager-password-manager = Osiągnięcie zaliczone: menedżer haseł
