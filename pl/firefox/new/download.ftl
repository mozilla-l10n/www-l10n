...
firefox-new-download-firefox = Pobierz Firefoksa
firefox-new-download-mozilla-firefox = Pobierz Mozillę { -brand-name-firefox }, darmową przeglądarkę. { -brand-name-firefox } jest tworzony przez ogólnoświatową organizację non-profit, której celem jest oddanie użytkownikom kontroli nad siecią. Zacznij go używać na systemie { -brand-name-windows }, { -brand-name-mac }, { -brand-name-linux }, { -brand-name-android } lub { -brand-name-ios } już dzisiaj!
firefox-new-download-the-fastest-firefox = Pobierz najszybszego Firefoksa w historii
firefox-new-faster-page-loading-less-memory = Szybsze wczytywanie stron, mniejsze zużycie pamięci i mnóstwo funkcji w nowym Firefoksie.
...
firefox-new-download-firefox-for-linux = Pobierz Firefoksa <br>na Linuksa
# The phrase “Now get even more from Firefox” is in specific reference to signing up for an account, which unlocks access to all our new products and services.
firefox-new-youve-already-got-the-browser = Masz już przeglądarkę. Teraz wyciągnij z Firefoksa jeszcze więcej.
...
firefox-new-get-more-from-firefox = Wyciągnij więcej z Firefoksa
...
firefox-new-youre-using-an-insecure-outdated = Używasz niebezpiecznego, przestarzałego systemu operacyjnego, który <a href="{ $url }">nie jest już obsługiwany przez Firefoksa</a>.
# Variables:
