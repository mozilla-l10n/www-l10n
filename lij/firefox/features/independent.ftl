...
# HTML page title
features-independent-firefox-a-different = { -brand-name-firefox }, un navegatô diverso pe tenpi diversi. Navega libero.
# HTML page description
features-independent-browse-the-internet = Navega l'internet comme o dovieva ese in òrigine: libero, seguo e acesibile a tutti. Deciara a teu indipendensa in linia.
features-independent-firefox-rebel-with-a = { -brand-name-firefox }: Ribelle pe 'na bonn-a caoza
...
features-independent-in-addition-to-fighting = No solo lotemmo pe i teu diritti in linea, çerchemmo ascì de tegnî sotto contròllo o potere de-e grendi aziende, travagiando insemme a atre realtæ internaçionâ pe aomentâ e pratiche che peuan sarvâ a salute de l'internet. Coscì quande ti ti çerni { -brand-name-firefox }, niatri çernemmo ti.
# Obsolete string
features-independent-firefox-is-a-browser = { -brand-name-firefox } o l'é 'n navegatô co-ina cosciensa. Parte de { -brand-name-mozilla }, 'na òrganizaçion sensa fin de goagno che travaggia co-a tecnòlogia, a conbatte pe-i teu diritti in linia, contròlla e corporaçioin pin de palanche e agiutta e paixi inta via do sviluppo a-e megio pratiche pe mantegnî san l'Internet. Coscì quande t'ê apreuvo a çerne { -brand-name-firefox }, niatri ascì semmo apreuvo a çerne ti.
