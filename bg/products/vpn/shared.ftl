...
vpn-press-mozilla-vpns-feature-list-has-grown = „Списъкът с възможности на { -brand-name-mozilla-vpn } нарастна значително от пускането му и сега услугата изпреварва много специализирани VPN в някои области.“
