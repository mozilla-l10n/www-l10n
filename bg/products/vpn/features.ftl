...
vpn-features-were-backed-by-mofo-v2 = Ние сме подкрепени от <a { $mofo }>{ -brand-name-mozilla-foundation }</a>, организация с нестопанска цел, бореща се да запази Мрежата отворена и полезна за всички.
