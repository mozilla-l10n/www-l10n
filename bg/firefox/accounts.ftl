...
# HTML page title
firefox-accounts-there-is-a-way-to = Има начин да защитите поверителността си. Присъединете се към { -brand-name-firefox }.
# HTML page description
firefox-accounts-take-your-stand-stay-smart = Заемете позицията си срещу индустрия, която продава вашите данни на трети страни. Бъдете умни и в безопасност, когато сте онлайн, с технология, която се бори за вас.
# The span here is for visual formatting to display the phrase "Join Firefox" in a different color.
firefox-accounts-there-is-a-way-to-protect = Има начин да защитите поверителността си. <span>Присъединете се към { -brand-name-firefox }.</span>
