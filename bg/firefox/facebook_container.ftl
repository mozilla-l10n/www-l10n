...
# Variables:
#   $fbcontainer (url) - link to https://addons.mozilla.org/firefox/addon/facebook-container/
facebook-container-installing-the-extension-is = Инсталирането на <a href="{ $fbcontainer }">разширението</a> е лесно и веднъж активирано, ще отваря { -brand-name-facebook } в син раздел всеки път, когато го използвате. Използвайте { -brand-name-facebook } нормално и му се наслаждавайте. { -brand-name-facebook } все още ще бъде в състояние да ви предлага реклама и препоръки на сайта си, но ще бъде много по-трудно да използва вашата дейност, събрана <strong>извън { -brand-name-facebook }</strong>, за да ви предлага реклами и други целеви съобщения.
facebook-container-about-firefox-and-mozilla = За { -brand-name-firefox } и { -brand-name-mozilla }
# Variables:
#   $mozilla (url) - link to https://www.mozilla.org/
facebook-container-were-backed-by-mozilla-the = Ние сме подкрепени от <a href="{ $mozilla }">{ -brand-name-mozilla }</a>, нестопанска организация, която поставя хората над печалбата, за да даде на всеки повече контрол в Мрежата. Ние създадохме това разширение, защото вярваме, че трябва да имате лесни за използване инструменти, които да ви помагат да управлявате личните си данни и сигурност.
facebook-container-browse-freely-with-firefox = Четете освободено с { -brand-name-firefox } още днес.
