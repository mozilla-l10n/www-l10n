...
# This is a button
opt-out-confirmation-manage-preferences = 管理首选项
opt-out-confirmation-prefer-to-get = 想用其他方式接收信息吗？
# Link to https://blog.mozilla.org/
opt-out-confirmation-check-out-our = 访问我们的博客
# Link to https://support.mozilla.org/
opt-out-confirmation-get-help = 获取帮助
opt-out-confirmation-subscribe-to = 订阅 { -brand-name-firefox } 的时事新闻通讯
