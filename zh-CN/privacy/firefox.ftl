...
privacy-firefox-privacy-isnt-just-v2 = { -brand-name-firefox } 将隐私与保护深植于设计理念。我们并不掌握您多少信息，而即使了解到一小部分，也绝不会用于出售。且与其他浏览器不同，我们为您提供选择权，让您可以关闭自己厌烦的功能。{ -brand-name-firefox } 的隐私声明基于明确、可控、负责任的默认设置拟定。我们愿阐明 { -brand-name-firefox } 的默认处理方式，而您也可以调整设置以按自己希望的方式来浏览。
...
privacy-firefox-how-we-use-v2 = 隐私深植设计
# Obsolete string (expires: 2026-02-10)
