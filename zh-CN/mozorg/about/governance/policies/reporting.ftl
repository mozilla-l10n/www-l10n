...
reporting-if-you-have-a-report-about-employee = 如果您要报告有关<strong>一名员工</strong>那么您应该拨打 <a href="{ $employee_hotline }">{ -brand-name-mozilla } 员工热线</a>提出举报。如果您是一名员工需要提交举报请参阅 { -brand-name-mozilla } 的内部政策与程序以了解可用的举报选项。
