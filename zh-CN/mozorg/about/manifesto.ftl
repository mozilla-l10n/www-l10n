...
manifesto-the-mozilla-manifesto = { -brand-name-mozilla } 宣言
# HTML page description
manifesto-these-are-the-principles = 以下是我们促进 Web 的开放、创新与机遇之使命的指导准则。
manifesto-the-internet-is-an-integral = 互联网是现代生活不可分割的一部分，是教育、交流、合作、商业、娱乐，以及整体社会的关键组成部分。
manifesto-the-internet-is-a-global = 互联网是全球公共资源，必须保证开放性和可用性。
manifesto-the-internet-must-enrich = 互联网必定会丰富人类生活。
manifesto-individuals-security-and = 用户在互联网上的安全和隐私保护是基本要求，不可忽视。
manifesto-individuals-must-have = 互联网用户必须能够依照个人意愿塑造互联网及其使用体验。
manifesto-the-effectiveness-of-the = 作为公共资源的互联网其有效性取决于信息交互（网络协议，数据格式，内容）创新，和世界各地用户的自主参与。
manifesto-free-and-open-source-software = 自由和开放源代码软件有助于互联网作为公共资源的持续发展。
manifesto-commercial-involvement = 互联网发展过程中的商业化参与有众多优点。维持商业利益和公共利益之间的平衡至关重要。
manifesto-magnifying-the-public = 扩展互联网的公共利益层面是一个非常重要的目标，值得我们赋予时间、精力，和承诺。
...
manifesto-we-are-committed-to-thinking = 我们承诺，要让互联网激发批判性思考、有理有据的论证、共享的知识和经得起推敲的真相。
...
manifesto-details-the-internet-is-becoming = 互联网作为人们生活的一部分，其重要性日益增加。
manifesto-details-the-mozilla-project-global-v2 = { -brand-name-mozilla } 项目是一个全球化的社区。社区成员们坚信开放、创新和机遇是互联网保持健康的关键因素。我们自 1998 年起通力合作，确保互联网以造福全体用户的方式发展。我们因创作 { -brand-name-mozilla } { -brand-name-firefox } 网页浏览器而广为人知。
# Obsolete string (expires 2026-09-20)
manifesto-details-the-mozilla-project-global = { -brand-name-mozilla } 是一个全球化的社区。社区成员们坚信开放，创新和机遇是互联网持续健康发展的关键因素。作为一个社区，我们从 1998 年开始为确保互联网的发展造福所有用户而共同努力。我们因创作 { -brand-name-mozilla } { -brand-name-firefox } 网络浏览器而广为人知。
manifesto-details-the-mozilla-project-community-v2 = { -brand-name-mozilla } 项目基于社区创建世界一流的开放源代码软件，并且开拓各种新式的合作活动。我们志同道合，致力于改善广大互联网用户的上网体验。
# Obsolete string (expires 2026-09-20)
...
manifesto-details-articulate-a-vision-v2 = 清晰的展示 { -brand-name-mozilla } 参与者期望 { -brand-name-mozilla-foundation }追求的互联网未来的发展前景；
...
manifesto-details-these-principles-v2 = 这些准则需要大家的共同努力得以实现。互联网的开放和参与需要大家的个人贡献、团队协作并发挥领导作用。{ -brand-name-mozilla-foundation }承诺推行 { -brand-name-mozilla }  宣言里制定的准则。我们邀请更多的同仁加入我们，共同奋斗使互联网变得更好。
manifesto-details-principles = 准则
manifesto-principle-1 = 准则 1
manifesto-principle-2 = 准则 2
manifesto-principle-3 = 准则 3
manifesto-principle-4 = 准则 4
manifesto-principle-5 = 准则 5
manifesto-principle-6 = 准则 6
manifesto-principle-7 = 准则 7
manifesto-principle-8 = 准则 8
manifesto-principle-9 = 准则 9
manifesto-principle-10 = 准则 10
manifesto-details-transparent-community = 透明的社区化流程有利于提升参与性、责任感和信任度。
...
manifesto-an-internet-with-these-v2 = 这样的互联网不会自行产生。每个人和组织都应当将这些愿景融入互联网技术，融入互联网带给人类的体验中。{ -brand-name-mozilla } 宣言及其修正案代表了 { -brand-name-mozilla } 对推进这些愿景的承诺。{ -brand-name-mozilla } 与世界各地有意为所有人缔造更美好的互联网的人士和组织开展合作。
manifesto-our-commitments = 我们的承诺
manifesto-commitment-1 = 承诺 1
manifesto-commitment-2 = 承诺 2
manifesto-commitment-3 = 承诺 3
manifesto-commitment-4 = 承诺 4
manifesto-if-you-share-this-goal-v2 = 如果您也有相同的目标请告诉我们能帮上什么忙。
# Variables:
#   $github_link (url) - link to https://github.com/mozilla
manifesto-we-create-open = 我们打造<a { $github_link }>开源软件</a>您可以在其上构建。
# Variables:
#   $mofo_link (url) - link to https://www.mozillafoundation.org/
manifesto-we-fund-fellows = 我们<a { $mofo_link }>资助研究员和孵化项目</a>旨在创造一个更美好的互联网未来。
# Variables:
#   $mozai_link (url) - link to https://www.mozilla.ai
manifesto-we-build-open-source = 我们<a { $mozai_link }>构建开源 AI 工具</a>让开发者既有选择权又能帮助开发者节省资金。
# Variables:
#   $mozvc_link (url) - link to https://mozilla.vc
manifesto-we-invest-in = 我们 <a { $mozvc_link }>投资负责任的科技初创公司</a>。
# Variables:
#   $mdc_link (url) - link to https://mozilladatacollective.com/
manifesto-we-run-a-global = 我们<a { $mdc_link }>运行一个全球社区</a>促进公平的数据交换。
# Variables:
#   $festival_link (url) - link to https://www.mozillafoundation.org/festival/
manifesto-we-host-a-yearly = 我们<a { $festival_link }>举办年度全球聚会</a>人们不遗余力地推进宣言。
# Variables:
#   $firefox_link (url) - link to https://www.firefox.com/
#   $thunderbird_link (url) - link to https://www.thunderbird.net/
manifesto-we-make-firefox-and-thunderbird = 当然我们还制作了 <a { $firefox_link }>{ -brand-name-firefox }</a> 和 <a { $thunderbird_link }>{ -brand-name-thunderbird }</a>。所有这一切旨在帮助人们让互联网成为一个健康的地方。
...
manifesto-details-the-internet-is-global = 互联网是全球公共资源，必须保证开放性和可用性。
manifesto-details-the-internet-must = 互联网必定会丰富人类生活。
manifesto-details-individuals-security = 用户在互联网上的安全和隐私保护是基本要求，不可忽视。
manifesto-details-individuals-must = 互联网用户必须能够依照个人意愿塑造互联网及其使用体验。
manifesto-details-the-effectiveness = 作为公共资源的互联网其有效性取决于信息交互（网络协议，数据格式，内容）创新，和世界各地用户的自主参与。
manifesto-details-free-and-open = 自由和开放源代码软件有助于互联网作为公共资源的持续发展。
manifesto-details-commercial-involvement = 互联网发展过程中的商业化参与有众多优点。维持商业利益和公共利益之间的平衡至关重要。
manifesto-details-magnifying-the = 扩展互联网的公共利益层面是一个非常重要的目标，值得我们赋予时间、精力，和承诺。
...
manifesto-i-support-the-vision-of-v2 = 我支持 { -brand-name-mozilla } 去创造一个更好的、更健康的互联网的愿景 , 你愿同我一道吗？
