...
manifesto-visualize-who-you-interact = 借助 Lightbeam，直观看出网络上哪些网站与您有所接触
manifesto-learn-about-creating-web = 学习如何与其他人一起创建网络资源
manifesto-host-or-join-a-maker-party = 主办或参加 Maker Party
...
manifesto-details-articulate-a-vision = 清晰的展示 { -brand-name-mozilla } 参与者期望 { -brand-name-mozilla } 基金会追求的互联网未来的发展前景；
...
manifesto-details-these-principles = 这些准则需要大家的共同努力得以实现。互联网的开放和参与需要大家的个人贡献、团队协作并发挥领导作用。{ -brand-name-mozilla } 基金会承诺推行 { -brand-name-mozilla } 宣言里制定的准则。我们邀请更多的同仁加入我们，共同奋斗使互联网变得更好。
...
manifesto-details-mozilla-foundation = Mozilla基金会的承诺
manifesto-details-the-mozilla-foundation-pleges = { -brand-name-mozilla } 基金会承诺支持 { -brand-name-mozilla } 宣言。具体地，我们将会：
...
manifesto-details-some-foundation = Mozilla 基金会的部分活动，目前包括消费类产品的研发、传递和推广，主要通过基金会全资子公司 Mozilla 公司进行。
