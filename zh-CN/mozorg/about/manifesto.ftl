...
manifesto-details-the-mozilla-project-global-v2 = { -brand-name-mozilla } 项目是一个全球化的社区。社区成员们坚信开放、创新和机遇是互联网持续健康的关键。我们从 1998 年开始携手努力确保互联网的发展造福每个人。我们因开发 { -brand-name-mozilla } { -brand-name-firefox } 版网络浏览器而广为人知。
...
manifesto-details-the-mozilla-project-community-v2 = { -brand-name-mozilla } 项目使用基于社区的方法来创建世界一流的开源软件并开展新型的协作活动。我们创建了一个社区让所有致力于改善互联网体验的人参与进来。
# Obsolete string (expires 2026-09-20)
