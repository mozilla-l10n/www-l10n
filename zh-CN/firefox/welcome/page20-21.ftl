...
welcome-page20-21-old-version = 您正在使用旧版本 { -brand-name-firefox }
# Page 20 header
welcome-page20-21-your-firefox = 2025 年 1 月 14 日起，您的 { -brand-name-firefox } 可能会出现问题
# Page 20 body
# Variables:
...
welcome-page20-21-make-sure-your-passwords = 更新前请确认您已备份密码和书签。
welcome-page20-21-how-to-back-up = 如何备份
welcome-page20-21-keep-using = 继续使用您需要的功能
