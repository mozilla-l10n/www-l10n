...
comparing-firefox-chrome = { -brand-name-firefox-browser }与 { -brand-name-google } { -brand-name-chrome } 的比较
big-isnt-always = 大，并不总意味着好。请选择独立自主的。
comparing-firefox-brave = { -brand-name-firefox-browser }与 { -brand-name-brave } 之间的比较
be-bold-and = 请大胆勇敢地选择最适合您的浏览器。
comparing-firefox-edge = { -brand-name-firefox-browser }与 { -brand-name-microsoft } { -brand-name-edge } 的比较
youll-never-guess = 您是否能猜到哪款浏览器在速度和功能方面更具优势..
comparing-firefox-ie = { -brand-name-firefox-browser }与 { -brand-name-microsoft } { -brand-name-ie } 的比较
old-habits-that = 旧的习惯根深蒂固，但当您作出改变时，云现花开。
comparing-firefox-safari = { -brand-name-firefox-browser }与 { -brand-name-apple } { -brand-name-safari } 之间的比较
you-dont-have = 其实并无必要将自带浏览器不假思索地设为默认。
comparing-firefox-opera = { -brand-name-firefox-browser }与 { -brand-name-opera } 之间的比较
be-free-to = 您无须掩饰对 { -brand-name-firefox } 的赞美。
the-ad-blocker = 广告拦截器 - 对付恼人广告的秘密武器。
so-many-ads = 广告太多了，我的耐心是有限的......是时候干掉这些广告了。
firefox-more-protection = { -brand-name-firefox }：更多保护，更少担忧。
were-obsessed-with = 我们竭诚保护您的隐私。这也是我们将 { -brand-name-firefox } 的隐私浏览模式打造得比其他浏览器更加强大的原因。
...
firefox-more-fingerprinting-is-a = 数字指纹识别是一种比 Cookie 更具侵入性的跟踪方式，这就是 { -brand-name-firefox-browser } 阻止它的原因。
