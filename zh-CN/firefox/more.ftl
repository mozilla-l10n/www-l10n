...
comparing-firefox-edge = { -brand-name-firefox-browser }与 { -brand-name-microsoft } { -brand-name-edge } 之间的比较
youll-never-guess = 您是否能猜到哪款浏览器在速度和功能方面更具优势..
comparing-firefox-ie = { -brand-name-firefox-browser }与 { -brand-name-microsoft } { -brand-name-ie } 之间的比较
...
firefox-more-avoid-misinformation-heading = 远离网上的虚假信息 – { -brand-name-firefox } 可为您提供帮助
firefox-more-avoid-misinformation-desc = 了解如何减少错误信息传播，专注于更重要的事情。
