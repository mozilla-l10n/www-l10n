...
firefox-desktop-download-dark-mode = 黑暗模式
...
firefox-desktop-download-watch-for-hackers-with-v2 = 使用 { -brand-name-firefox-monitor } 监视黑客行为、使用 { -brand-name-firefox-relay } 保护您的邮箱，还有种种等你探索。
# Outdated string
