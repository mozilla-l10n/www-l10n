...
browsers-chromebook-get-firefox-browser = 下载  { -brand-name-chromebook } 版 { -brand-name-firefox-browser }
...
browsers-chromebook-x86-based-chromebook = *运行 { -brand-name-chromeos } 80 或更高版本的 x86 架构 { -brand-name-chromebook }
