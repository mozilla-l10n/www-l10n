...
compare-edge-compare-microsoft-edge-to-the = 将 { -brand-name-microsoft } { -brand-name-edge } 与 Firefox 浏览器进行比较，以确定哪款浏览器更适合您。
# Main title.
compare-edge-comparing-firefox-browser-with = Firefox 浏览器与 { -brand-name-microsoft } { -brand-name-edge } 之间的比较
...
compare-edge-here-well-compare-our-firefox = 在此，我们将 Firefox 浏览器与基于 { -brand-name-chromium } 的 { -brand-name-microsoft } { -brand-name-edge } 在隐私、实用和跨平台方面进行比较，以便您更好地了解哪款浏览器更符合自身需求与偏好。
...
compare-edge-out-of-the-gate-firefox-has = { -brand-name-firefox } 内置有更多的功能和集成，并可通过下载轻松获得。两款浏览器都有大量附加组件和扩展，但 Edge 因其 { -brand-name-google } { -brand-name-chromium } 平台的兼容性为其在数量上占据了优势。
