...
compare-edge-compare-microsoft-edge-to-the = 将 { -brand-name-microsoft } { -brand-name-edge } 与 { -brand-name-firefox-browser } 浏览器进行比较，以确定哪款浏览器更适合您。
# Main title.
compare-edge-comparing-firefox-browser-with = { -brand-name-firefox-browser } 浏览器与 { -brand-name-microsoft } { -brand-name-edge } 的比较
...
compare-edge-here-well-compare-our-firefox = 在此，我们将 { -brand-name-firefox-browser } 浏览器与基于 { -brand-name-chromium } 的 { -brand-name-microsoft } { -brand-name-edge } 在隐私、实用和跨平台方面进行比较，以便您更好地了解哪款浏览器更符合自身需求与偏好。
