...
compare-index-firefox-engineers-focus-on-improving = { -brand-name-firefox } 的工程师们致力于提升浏览器的性能和响应速度，旨在提供一个<a { $url1 }>快速的浏览体验</a>，帮助您更顺畅地找到需要的内容并完成工作。我们与其他浏览器制造商的团队正携手进行一个名为 <a { $url2 }>Speedometer 3</a> 的项目。这是一项行业标准的性能基准测试，它可为所有浏览器乃至整个开放网络带来好处。这为 <a { -brand-name-firefox } 用户带来了 { $url3 }> 巨大的改进</a>，速度之快让您感受到了包括页面加载更快和交互更顺畅。
# Variables:
