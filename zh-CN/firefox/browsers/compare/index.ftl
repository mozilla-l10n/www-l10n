...
compare-index-firefox-engineers-focus-on-improving = { -brand-name-firefox } 工程师致力于提升浏览器的性能和响应速度，带来<a { $url1 }>高速的浏览体验</a>，助您快速收集信息，高效搞定工作。我们与其他浏览器开发商的团队合作开展了 <a { $url2 }>Speedometer 3</a> 项目，这是业界标准的性能基准测试，所有浏览器以及整个开放网络都能从中受益。{ -brand-name-firefox } 用户同样可以通过更快的页面加载、更顺畅的交互体验，切身感受到这项成果带来的<a { $url3 }>巨大提升</a>。
# Variables:
