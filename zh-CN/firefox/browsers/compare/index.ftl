...
compare-index-seven-of-the-best-browsers-in = 七款最佳浏览器同台对比
compare-index-six-of-the-best-browsers-fallback = 六款最佳浏览器同台对比
# Sub-headline
...
compare-index-which-browser-is-best-at-keeping = 哪款浏览器最能保守您的秘密？
...
compare-index-another-browser-feature-that = 浏览器应该提供的另一个功能是，即使普通浏览模式下，也能够能够阻止网站和企业跟踪您的浏览和购物数据。
...
compare-index-using-a-browser-that-blocks = 浏览器能够阻止第三方跟踪器不仅对隐私很重要 — 通常也意味着可以运行得更快。大多数跟踪器只是一些网站后台运行的脚本。您看不到它们，但可以感觉到它们拖慢了浏览器的速度。从 { -brand-name-firefox } 67 版本开始，数字指纹跟踪程序和加密货币挖矿程序也会被拦截。如果你不熟悉“挖矿”，这里有一个案例可以说明它们是如何影响您的：也许您经历过计算机突然升温变卡，或者电量消耗得比平时更快。这往往是“矿工”在您的设备上肆虐的“杰作”。
compare-index-what-has-your-browser-done = 您的浏览器最近帮您做了什么？
compare-index-in-addition-to-privacy-protection = 浏览器除了在后台保护隐私之外，另一出色浏览器的关键要素是实际的用户界面与功能。在标签页浏览、书签管理、自动填写、拼写检查、主题扩展等方面，七款浏览器可谓旗鼓相当。{ -brand-name-firefox }、{ -brand-name-edge } 及 { -brand-name-opera } 还提供方便快速的屏幕截图功能，当您切换到没有此功能的浏览器时肯定会感到不惯。
compare-index-in-addition-to-privacy-protection-fallback = 浏览器除了在后台保护隐私之外，另一出色浏览器的关键要素是实际的用户界面与功能。在标签页浏览、书签管理、自动填写、拼写检查、主题扩展等方面，六款浏览器可谓旗鼓相当。{ -brand-name-firefox }、{ -brand-name-edge } 及 { -brand-name-opera } 还提供方便快速的屏幕截图功能，当您切换到没有此功能的浏览器时肯定会感到不惯。
compare-index-how-well-does-your-browser = 您的浏览器是否可在各平台不同设备上使用？
compare-index-almost-all-of-the-browsers = 参与比较的几乎所有浏览器都支持在桌面版与移动版之间进行同步。只要拥有账户，并在所有设备上的浏览器登录即可同步密码、浏览历史、书签、设置等数据。
compare-index-conclusion = 结论：
...
compare-index-find-out-how-firefox-fallback = 了解 { -brand-name-firefox }、{ -brand-name-chrome }、{ -brand-name-edge }、{ -brand-name-safari }、{ -brand-name-opera } 和 { -brand-name-ie } 在隐私、实用和平台支持方面有何不同。
...
compare-index-looking-for-a-better-fallback = 寻找更好的浏览器？我们将 { -brand-name-firefox } 与 { -brand-name-chrome }、{ -brand-name-edge }、{ -brand-name-safari }、{ -brand-name-opera } 和 { -brand-name-ie } 进行比较，以便助您作出选择。
...
compare-index-so-is-your-browser-the-fallback = 那么，您的浏览器是最好的网页浏览器吗？合适的浏览器可以极大改善您的网络体验。因此，闲话少叙，让我们来比较一下 { -brand-name-google } { -brand-name-chrome }、{ -brand-name-firefox }、{ -brand-name-safari }、{ -brand-name-opera }、{ -brand-name-microsoft } { -brand-name-ie } 和 { -brand-name-edge }，看看哪款最符合您的需求。
...
compare-index-the-first-thing-to-point-fallback = 首先要指出的是，并非所有浏览器都能在所有操作系统运行。尽管 { -brand-name-firefox }、{ -brand-name-chrome } 及 { -brand-name-opera } 能在各主要操作系统运行，且很容易安装，但 { -brand-name-ie }、{ -brand-name-edge } 及 { -brand-name-safari } 仅能运行于 { -brand-name-microsoft } 或 Apple 各自系统中。Apple 移动设备预装移动版 { -brand-name-safari }，而大多数 { -brand-name-android } 设备都预装其制造商的定制版浏览器。{ -brand-name-firefox }、{ -brand-name-chrome }、{ -brand-name-edge } 和 { -brand-name-opera } 均可以轻松安装，甚至可以同时使用。
compare-index-browsers-have-come-a-long = 自 { -brand-name-chrome } 推出并占领市场份额以来，各个浏览器已经取得了长足的进步。大多数现代浏览器已经缩小了在跨平台和功能方面的差距，在一些方面，如速度和隐私，实际上已经超过了 { -brand-name-chrome }。不过，决定哪种浏览器适合您，最终将取决于您的个人需求和网络浏览最看重的体验取向。
...
compare-index-see-how-firefox-for-mobile = 看看 { -brand-name-firefox } 移动版与其他浏览器有何不同。
compare-index-compare = 比较
