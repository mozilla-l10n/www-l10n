...
compare-shared-its-easy-to-switch = 切换很容易
compare-shared-since-we-dont-have-to-make = 我们无需讨好股东，所以可以<strong>专注于您</strong>，让您用得愉快，并将确保隐私与便利作为首要事项。
# Used as a small link to a cited source
compare-shared-source = 源代码
