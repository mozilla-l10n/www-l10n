...
# Outdated string
mobile-focus-disappear-your-history = 销毁历史记录
...
# Outdated string
mobile-focus-private-browsing-on = 大多数浏览器的“隐私浏览”并没有那么隐私。{ -brand-name-firefox-focus } 则将其推向新的高度，专注于隐私保护。在非营利组织 { -brand-name-mozilla } 的支持下，为您在网上的权利而战。
...
mobile-focus-focus-blocks-the-v2 = { -brand-name-focus } 可拦截试图跨网站跟踪您的广告——不用安装其他附加组件或扩展。广告越少，页面加载速度就越快，这意味着您可以更快地获得想要的内容。
