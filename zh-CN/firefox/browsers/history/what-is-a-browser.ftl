...
what-is-a-browser-when-the-web-browser = 当网页浏览器从连接到互联网的服务器上获取数据时，它会使用一种被称为渲染引擎的软件将数据转换为文本和图像。这些数据使用<a href="{ $html }">超文本标记语言</a>（HTML）所编写，网页浏览器将阅读这些代码，生成我们在互联网上看到、听到和感受到的内容。
# Variables:
