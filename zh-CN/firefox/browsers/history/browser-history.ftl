...
browser-history-ncsa-mosaic-ran = NCSA Mosaic 易于使用，又可以在 { -brand-name-windows } 计算机运行，让任何拥有 PC 的人都可以浏览早期的网页、聊天室、图库。隔年（1994 年），安德森创办 <a href="{ $netscape }">{ -brand-name-netscape }</a> 并公开发行了 { -brand-name-netscape } Navigator。这是第一款面向普通用户的浏览器，取得了巨大成功。 这也是针对互联网用户的新型战争的开端。
