...
firefox-products-learn-more-about-relay = 详细了解 { -brand-name-firefox-relay }
# Obsolete string
...
firefox-products-join-firefox-and-get-the-most = 加入 { -brand-name-firefox } 的行列，跨越设备边界，体验各个产品的智能技术。
# Variables:
