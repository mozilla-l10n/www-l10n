...
# Variables:
#   $link (url) - link to https://www.mozilla.org/privacy/firefox/#pre-release
firefox-channel-developer-edition-is-an = 开发者版本是不稳定的测试和开发平台。默认情况下，开发者版本会向 { -brand-name-mozilla } 发送数据，有时数据也会发送给我们的合作伙伴，以帮助我们处理问题与测试一些新点子。<a href="{ $link }">了解会回传哪些数据</a>。
firefox-channel-firefox-developer-edition = Firefox 开发者版会自动发送反馈到 { -brand-name-mozilla }。
...
firefox-channel-experience-cutting-edge-features-ios = 通过苹果公司的 { -brand-name-test-flight } 计划，体验 { -brand-name-ios } 版浏览器的最新功能。立即安装！
firefox-channel-test-beta-versions-of-firefox-ios-long = 通过苹果公司的 { -brand-name-test-flight } 计划帮助测试 { -brand-name-firefox } { -brand-name-ios } 版的公测版本，使我们适用于 { -brand-name-iphone }、{ -brand-name-ipad } 和 iPod touch 等设备的移动浏览器变得更好。
firefox-channel-test-flight = { -brand-name-test-flight }
firefox-channel-test-beta-versions-of-firefox-ios = 通过苹果公司的 { -brand-name-test-flight } 计划帮助测试 { -brand-name-firefox } { -brand-name-ios } 版的公测版本。
