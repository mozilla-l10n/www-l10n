...
features-fast-how-is-browser-speed-measured = 浏览器速度是如何衡量的
features-fast-speedometer-is-the-most-widely = 速度计是使用最广泛的测量 Web 应用程序响应能力的浏览器性能基准测试。尽管市场上还有其他浏览器基准测试但 Speedometer 3 应该成为衡量您浏览速度的新标准。最新的测试更好地反映了当今的网络——处理视觉丰富的图表、编辑文本、与新闻网站等复杂繁杂的网页交互——它测量的是浏览器性能的全貌。
...
features-fast-theres-been-an-encouraging = { -brand-name-mozilla } <a { $link }>致力于</a>不断改进我们自己的浏览器以及整个网络。这也是我们投资合作开发的 Speedometer 3 的原因而Speedometer 3 提升了所有浏览器的性能。无论您选择浏览器{ -brand-name-mozilla } 都希望它更快。
