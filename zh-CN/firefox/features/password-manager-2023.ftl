...
password-manager-with-a-free-firefox-account = 您还可以使用<a href="{ $fxa }">免费的 { -brand-name-firefox-account }</a>来在所有设备间安全同步密码。
...
password-manager-firefox-alerts-you-if-a-password-has = { -brand-name-firefox } 会在您的密码出现数据外泄事件中时警告您，这样您就可以在黑客用您的信用卡去租兰博基尼（或做诸如此类的事情）前及时更改密码。
# Used as an accessible text alternative for an image
