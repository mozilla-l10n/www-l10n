...
features-bookmarks-take-your-favorites-on = 书签随身带着走！使用 Firefox 同步即可在您的所有设备之间同步您的书签，无论它是桌面设备或移动设备。您还可以尝试用 <a href="{ $url }">{ -brand-name-pocket }</a> 来保存网上文章、页面以便稍后阅读，它还支持离线阅读。
# Obsolete string
