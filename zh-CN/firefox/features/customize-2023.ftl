...
features-customize-you-can-find-more-free-custom = <a { $amo }>addons.mozilla.org</a> 上还有更多免费的自定义主题。您可以浏览<a { $top }">最受好评</a>、<a { $trending }>热门</a>、<a { $recommended }>推荐</a>的主题，或是按分类查找主题，例如<a { $music }>音乐</a>、<a { $seasonal }>季节</a>、<a { $sports }>运动</a>、<a { $nature }>自然</a>等，依自己的喜好选择主题。可爱小动物、邪恶机器人、美丽好风光……数千款主题，总有一款能让 { -brand-name-firefox } 彰显您的个性。
# Used as accessible alternative text for an image
