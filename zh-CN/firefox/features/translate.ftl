...
features-translate-while-other-browsers-rely-on = 其他浏览器的翻译功能均依靠云服务实现，而 { -brand-name-firefox } 浏览器会将翻译功能的语言模型下载到用户的浏览器中，并在本地完成翻译，因此 { -brand-name-mozilla } 并不记录您所翻译的网页。
