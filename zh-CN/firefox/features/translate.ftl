...
# Obsolete string (expires: 2025-02-17)
features-translate-while-other-browsers-rely-on = 其他浏览器的翻译功能均依靠云服务来进行，而 { -brand-name-firefox } 浏览器会将翻译功能的语言模型下载到用户的浏览器中，并在本地完成翻译，因此 { -brand-name-mozilla } 并不记录您所翻译的网页。
...
# Obsolete string (expires: 2025-02-17)
features-translate-the-firefox-translations-feature = { -brand-name-mozilla } 通过 { -brand-name-firefox } 翻译功能这一新途径，让您的互联网体验更有个性，更具隐私。{ -brand-name-mozilla } 不会跟踪您翻译了哪些网页，并希望确保全世界亿万 { -brand-name-firefox } 用户都能以自己习惯的方式来学习、交流、分享，并了解各类信息。<a { $download }>下载 { -brand-name-firefox }</a>，以您所需的语言畅游互联网吧。
