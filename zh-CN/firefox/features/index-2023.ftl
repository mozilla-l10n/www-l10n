...
features-index-add-new-tools-capabilities-and = 为您的浏览器添加新工具、新功能和有趣的东西。
features-index-pinned-browser-tabs = 固定的浏览器标签页
features-index-keep-your-favorite-pages-open = 常用的网页只需轻轻一点。使用固定标签页随时处理您的电子邮件或短信应用。
features-index-eyedropper-tool = 取色器工具
features-index-identify-the-exact-color-on-a = 找出页面上的确切颜色并复制其十六进制代码。
