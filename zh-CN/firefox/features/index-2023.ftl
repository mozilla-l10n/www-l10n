...
features-index-translate-websites-to-your = 直接在您的 { -brand-name-firefox } 浏览器中将网站翻译为您的语言 – 无需与任何人共享您的数据。
# Obsolete string
features-index-translate-more-than = 直接在 { -brand-name-firefox } 浏览器中将 100 多种语言翻译成您的语言，体验前所未有的方便。
