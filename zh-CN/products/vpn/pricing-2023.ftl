...
vpn-pricing-scan-qrcode-to-download-android = 要下载该应用请使用您的 Android 设备或平板电脑扫描二维码
vpn-pricing-sign-up-on-your-mobile-device = 在移动设备上订阅 { -brand-name-mozilla-vpn }
vpn-pricing-sign-up-on-your-android-device = 在您的 Android 设备上订阅 { -brand-name-mozilla-vpn }
