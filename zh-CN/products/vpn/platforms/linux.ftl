...
vpn-linux-ability = 无论在家还是外出，{ -brand-name-mozilla-vpn } 都能够为您的网络生活多添一层保护。只需较低的月费，就可以通过 { -brand-name-wireguard }® 高级协议加密您在 { -brand-name-linux } 系统计算机和其他种类设备上的个人数据，让您可以安心地看直播、玩游戏、管理财务、购物及其他日常网上操作。
...
vpn-linux-privacy-headline = 一点即得的隐私
...
# Variables:
#   $countries (number) - number of available countries
vpn-linux-servers-copy = { -brand-name-mozilla-vpn } 可以将 { -brand-name-linux } 系统计算机的“位置”在 { $countries }+ 个国家/地区间随心切换，世界各地的精彩内容向您扑面而来。
# Variables:
...
vpn-linux-speed-copy = 玩游戏、看电影和电视节目、网上冲浪，速度超快不限速——{ -brand-name-mozilla-vpn } 无限制。
vpn-linux-log-headline = 您的数据只属于您
vpn-linux-log-copy = 某些 VPN 服务商会记录您在其服务器上的活动，但 { -brand-name-mozilla-vpn } 绝不会在网上跟踪您——实际上，这是 Mozilla 公司的重要行事原则之一。
