...
highlighted-features-section-unlimited-masks-body-v2 = 每个人都可以免费获得 { $mask_limit } 个邮箱马甲。但使用 { -brand-name-relay-premium }，您可以根据需要生成任意数量的马甲，以帮助保护您的电子邮件收件箱免受垃圾邮件发送者、黑客和在线跟踪器的侵害。
