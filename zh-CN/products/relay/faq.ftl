...
phone-masking-faq-answer-how-i-save-card = 升级到 { -brand-name-relay } 虚拟手机号后，我们会通过短信给您发送一份包含电话号码的联系人卡片，所用号码即为您今后接收转移通话和短信的号码。此卡片与其他存储了联系人电话号码的联系人卡片相似。在大部分设备上，您可以选择这份联系人卡片并保存，方法同在手机上保存其他联系人一样。
