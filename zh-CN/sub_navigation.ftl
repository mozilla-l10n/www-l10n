...
sub-navigation-ios-test-flight = { -brand-name-test-flight } { -brand-name-ios } 版
sub-navigation-firefox-features = { -brand-name-firefox } 特色
...
sub-navigation-our-products = 我们的产品
sub-navigation-little-book-of-privacy = 隐私口袋书
sub-navigation-safe-passwords = 安全的密码
