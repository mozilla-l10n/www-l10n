...
footer-refresh-follow-firefox = Пратите @{ -brand-name-firefox }
footer-refresh-youtube = YouTube
footer-refresh-company = Предузеће
footer-refresh-press-center = Центар за медије
footer-refresh-careers = Каријере
footer-refresh-contact = Контакт
footer-refresh-support = Подршка
...
footer-refresh-security = Безбедност
