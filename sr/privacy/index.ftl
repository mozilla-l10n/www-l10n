...
privacy-index-for-product-support-requests = Ако имате питања о подршци за производ, посетите <a href="{ $sumo }">наше форуме</a>.
privacy-index-data-privacy-principles = Принципи приватности података
# Variables:
...
privacy-index-mozilla-websites-communications = { -brand-name-mozilla } веб-сајтови, комуникације и колачићи
