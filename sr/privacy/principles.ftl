...
privacy-principles-data-privacy-principles = Принципи приватности података
# HTML page description
privacy-principles-mozilla-is-an-open-source = { -brand-name-mozilla } је пројекат отвореног кода са мисијом да унапреди ваше искуство на интернету. Ово је водећа сила иза наше политике приватности.
# Variables:
#   $link (url) - link to https://www.mozilla.org/about/manifesto/
privacy-principles-the-following-five-principles = Следећих пет принципа произилазе из <a href="{ $link }">{ -brand-name-mozilla } манифеста</a> и информишу како ми:
...
privacy-principles-design-for-a-thoughtful = Дизајнирајте за промишљен баланс безбедности и корисничког искуства.
privacy-principles-defense-in-depth = Одбрана у детаљима
privacy-principles-maintain-multi-layered = Одржите више-слојевите праксе и контроле безбедности, многе од којих се могу јавно верификовати.
