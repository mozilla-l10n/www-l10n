...
manifesto-visualize-who-you-interact = Визуелно прикажите са ким комуницирате на вебу помоћу Lightbeam-а
manifesto-learn-about-creating-web = Сазнајте више о креирању веб ресурса са другима
manifesto-host-or-join-a-maker-party = Угостите или се придружите Maker Party-у
...
manifesto-details-articulate-a-vision = одреди визију интернета какву учесници { -brand-name-mozilla }-e желе да { -brand-name-mozilla } фондација следи;
...
manifesto-details-mozilla-foundation = Завет Mozilla фондације
manifesto-details-the-mozilla-foundation-pleges = { -brand-name-mozilla } фондација се заветује да ће подржавати { -brand-name-mozilla }-ин манифест у њеним активностима. Посебно ћемо:
...
manifesto-details-some-foundation = Неке активности фондације(тренутно су то стварање, испорука и промоција потрошачких производа) се врше преко корпорације Mozilla, подружнице у потпуном власништву Mozilla фондације.
manifesto-details-invitation = Позив
manifesto-details-the-mozilla-foundation-invites = { -brand-name-mozilla } фондација позива све који подржавају принципе { -brand-name-mozilla }-иног манифеста да нам се придруже и потраже нове начине како би ова визија интернета постала стварност.
