...
vpn-features-convenient = Погодан
# Variables
...
vpn-features-multi-hop-feature = Наша <a { $feature }>функција за вишеструко усмеравање</a> пружа додатни слој заштите.
...
vpn-features-combine-mozilla-vpn-with-containers = Комбинујте { -brand-name-mozilla-vpn } са { -brand-name-firefox } додатком „Контејнери за више налога” и поставите различите VPN локације за { -brand-name-firefox } картице. <a { $containers }>Сазнајте како</a>.
...
vpn-features-reviewed-by-third = Рецензију дали сигурносни стручњаци трећих страна
# Variables
#   $report (url) - link to https://blog.mozilla.org/mozilla/news/mozilla-vpn-completes-independent-security-audit-by-cure53
vpn-features-weve-been-audited = Ревизију је обавило Cure53, водеће предузеће у подручју ревизија сајбер безбедности. <a { $report }>Погледајте извештај овде</a>.
vpn-features-people-over-profits = Људи изнад профита
# Variables
