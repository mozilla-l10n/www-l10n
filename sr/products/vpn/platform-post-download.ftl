...
vpn-your-download-should-start = { -brand-name-mozilla-vpn } преузимање би требало да почне аутоматски. Ако не почне, онда <br> <a href="{ $url }" id="{ $id }">поново покрените преузимање</a> или преузмите са другог уређаја.
vpn-open-the-file = 1. Отворите датотеку
vpn-launch-the-app = 2. Покрените апликацију
...
vpn-download-faq-as-more-daily = Како се све већи део нашег свакодневног живота одвија на интернету, приватност и безбедност на мрежи постају све важнији. VPN, <a href="{ $faq }">виртуелна приватна мрежа</a>, прави шифровани тунел између вашег уређаја и интернета, чувајући вашу везу безбедном и приватном док вас штити на два битна начина:
# Variables:
...
vpn-download-faq-protect = Ако желите да се додатно заштитите од огласа, елемената за праћење и малвера, можете да активирате заштиту преко Подешавања > Функције приватности. Имајте на уму да ово може довести до престанка рада или учитавања неких сајтова, у ком случају ћете можда желети да привремено искључите ове заштите.
vpn-download-faq-lastly = Коначно, на доступним уређајима, VPN можете учинити паметнијим тако што ћете искључити одређене апликације из VPN-а, нпр. Netflix.
vpn-download-faq-need-more = Треба вам додатна помоћ?
# Variables
#   $support (url) - link to https://support.mozilla.org/products/firefox-private-network-vpn
vpn-download-faq-support = Можете да контактирате тим за подршку директно у { -brand-name-mozilla-vpn } апликацији, идите на Подешавања > Добијте помоћ > Контактирајте подршку или преко <a href="{ $support }">странице за подршку</a>.
