...
vpn-landing-a-virtual-private-network-protects = Виртуелна приватна мрежа штити вашу интернетску везу и чува вашу локацију и радње на мрежи приватнима на свим вашим уређајима.
vpn-landing-see-all-the-ways-mozilla-vpn = Погледајте начине на које вас { -brand-name-mozilla-vpn } штити.
vpn-landing-how-a-vpn-helps-you = Како вам VPN помаже
vpn-landing-how-a-vpn-helps-you-v2 = Како вам { -brand-name-mozilla-vpn } помаже
vpn-landing-keeps-your-data-safe = Чува ваше податке безбедним на јавној Wi-Fi мрежи
...
vpn-landing-take-control = Преузмите контролу уз ВПН подешавања за специфичне веб сајтове
vpn-landing-customize-your-vpn = Прилагодите своју ВПН заштиту за сваки веб сајт појединачно уз { -brand-name-mozilla-vpn } проширење за { -brand-name-firefox } (само за Windows).
...
vpn-landing-built-transparently = Изграђен транспарентно као отворени код
vpn-landing-easy-firefox-integration = Једноставна { -brand-name-firefox } интеграција уз { -brand-name-mozilla-vpn } проширење (само за Windows)
