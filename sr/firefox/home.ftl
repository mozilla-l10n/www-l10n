...
firefox-home-firefox-protect-your = { -brand-name-firefox } - заштите ваш онлајн живот најприкладнијим производима
firefox-home-firefox-is-more-than = { -brand-name-firefox } је више од прегледача. Сазнајте више о { -brand-name-firefox } производима који с вашим подацима поступају с поштовањем и који су изграђени за приватност где год да уђете на веб.
firefox-home-the-browser-is-just = Прегледач је само почетак
firefox-home-meet-our-family-of = Упознајте нашу породицу производа
