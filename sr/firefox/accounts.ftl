...
firefox-accounts-already = Већ имате { -brand-name-firefox-account }. Честитамо!
firefox-accounts-manage = Управљајте налогом
# This is followed by a list of things you can do with your Firefox account
firefox-accounts-sign-in-to = Пријавите се на ваш { -brand-name-firefox-account } да:
# Obsolete string
