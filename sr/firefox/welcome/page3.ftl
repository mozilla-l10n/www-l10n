...
welcome-page3-never-forget-reset-or-travel = Никада више немојте заборавити, ресетовати или путовати без лозинке.
welcome-page3-facebook-container = { -brand-name-facebook-container }
welcome-page3-get-a-container-to-keep-facebook = Преузмите контејнер за изоловање { -brand-name-facebook }-а из вашег радног времена.
welcome-page3-pocket = { -brand-name-pocket }
welcome-page3-trade-clickbait-and-fake-news = Замените кликбејт и лажне вести за квалитетан садржај.
welcome-page3-firefox-send = { -brand-name-firefox-send }
welcome-page3-send-huge-files-to-anyone = Шаљите велике датотеке било коме преко самоуништавајућих веза.
welcome-page3-why-am-i-seeing-this = Зашто ми се ово приказује?
