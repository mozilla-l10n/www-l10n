...
welcome-page1-find-ways-to-protect-your = Сазнајте како да заштитите ваше податке уз <a href="{ $security_tips }">{ -brand-name-monitor } безбедносне савете</a>.
welcome-page1-stay-in-the-know = Будите у току
...
welcome-page1-were-you-one-of-many = Да ли сте били међу 100,985,047 позваних на <a href="{ $evite_breach }">Evite “журку” цурења података</a>?
welcome-page1-why-am-i-seeing-this = Зашто ми се ово приказује?
