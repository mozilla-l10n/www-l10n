...
welcome-page14-use-code = Користите код при плаћању за 20% попуста.
welcome-page14-copy-code = Копирајте код
welcome-page14-code-copied = Код је копиран!
welcome-page14-very-fast = Брзо је, веома брзо
welcome-page14-wireguard-powered = Наши сервери, које покреће { -brand-name-wireguard }®, направљени су за брзину, тако да можете гледати филмове, преузимати и играти игре.
welcome-page14-without-trace = Сурфујте без трага
welcome-page14-never-log = Никада не евидентирамо, пратимо или делимо ваше мрежне податке — ваше активности на мрежи не остављају траг на нашим VPN серверима.
welcome-page14-why-see-this = Зашто ми се ово приказује?
