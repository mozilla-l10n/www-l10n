...
firefox-browsers-mobile = Мобилни
firefox-browsers-take-the-same-level-of-privacy = Понесите исти ниво приватности — плус своје лозинке, историју претраге, отворене картице и још много тога — са собом где год да идете.
firefox-browsers-download-for-mobile = Преузмите за мобилни
firefox-browsers-send-me-a-link = Пошаљи ми везу
...
firefox-browsers-go-beyond-two-dimensions-and = Гледајте даље од стварности и уживајте у најбољем садржају који је доступан на вебу.
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words, please omit the strong tags if they need to be around multiple words in your language
