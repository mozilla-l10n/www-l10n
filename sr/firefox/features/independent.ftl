...
# HTML page title
features-independent-firefox-a-different = { -brand-name-firefox }, другачији прегледач за другачија времена. Сурфујте слободно.
...
features-independent-in-addition-to-fighting = Додатно вашој борби за ваша интернет права, такође држимо око на корпорације, док радимо са савезницима око света како би одржали интернет здравијим. Тако да када изаберете { -brand-name-firefox }, ми бирамо вас такође.
# Obsolete string
features-independent-firefox-is-a-browser = { -brand-name-firefox } је прегледач са савешћу. Као део технологије непрофитне { -brand-name-mozilla }-е, ми се боримо за ваша интернет права, помажемо у едукацији и напредовању држава са принципима здравог интернета. Тако да када изаберете { -brand-name-firefox }, и ми бирамо вас.
