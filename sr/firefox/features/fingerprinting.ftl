...
# page title
features-fingerprinting-what-is-fingerprinting-title = Шта је сакупљање дигиталних отисака и зашто треба да га блокирате
# page description
...
features-fingerprinting-ditch-the-sticky = Ослободите се упорних огласа који вас прате помоћу уграђеног блокатора сакупљања дигиталних отисака у { -brand-name-firefox } прегледачу.
# description for the header image
features-fingerprinting-every-fingerprint = Сваки отисак је јединствен.
features-fingerprinting-download-firefox = Преузмите { -brand-name-firefox }
...
features-fingerprinting-protect = Заштитите вашу приватност
