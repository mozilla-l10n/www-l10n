...
features-index-identify-the-exact-color-on-a = Препознајте тачну боју на страници и копирајте њен хексадецимални код.
features-index-pdf-editor = PDF уређивач
features-index-view-and-edit-pdf-files = Прегледајте и уређујте PDF датотеке директно у { -brand-name-firefox }-у.
...
features-index-ditch-the-sticky-ads = Решите се наметљивих огласа који вас прате помоћу уграђених блокатора дигиталних отисака у { -brand-name-firefox }-у.
features-index-translate-the-web = Преведите веб
features-index-translate-websites-to-your = Преведите веб странице на свој језик директно у свом прегледачу { -brand-name-firefox } – без дељења својих података са било ким другим.
features-index-picture-in-picture = Слика у слици
features-index-got-things-to-do = Имате ствари које треба да урадите и ствари које желите да гледате? Радите обоје користећи функцију „Слика у слици” у { -brand-name-firefox }-у.
