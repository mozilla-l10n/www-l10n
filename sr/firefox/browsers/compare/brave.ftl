...
compare-brave-the-internet-as-a-whole-is = Интернет у целини се у великој мери финансира од приказивања огласа, што одржава садржај који желите да прегледате бесплатним. { -brand-name-brave } је покушао побољшати овај модел подстичући своје кориснике да се одлуче за { -brand-name-brave } систем награђивања, који је у ствари његова сопствена рекламна платформа. Ако пристанете на ово, { -brand-name-brave } ће приказати тзв. “огласе који поштују приватност” за које можете, гледајући их, зарадити тзв. токен основне пажње (Basic Attention Token). Тада корисници { -brand-name-brave }-а могу потрошити своје токене на подршку страница или појединих сарадника који им се допадају, а они заузврат могу претворити токене у стварну валуту.
