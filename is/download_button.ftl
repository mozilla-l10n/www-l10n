...
download-button-supported-devices = Tæki sem eru með stuðning
...
download-button-get-firefox-android = Ná í { -brand-name-firefox } fyrir { -brand-name-android }
download-button-get-firefox-ios = Ná í { -brand-name-firefox } fyrir { -brand-name-ios }
