...
# HTML page title
features-private-browsing-private-browser = Huliðsvafur með vörn gegn gagnasöfnun
# HTML page description
features-private-browsing-firefox-protects = { -brand-name-firefox } verndar þig á netinu og lokar á rakningaforrit sem fylgjast með þér á vefnum.
...
features-private-browsing-some-websites-and = Sum vefsvæði og auglýsingar bæta við földum snuðrara sem fylgist með þér löngu eftir að þú ert hættur að vafra. Aðeins huliðsvafur { -brand-name-firefox } er með vörn til að loka á þá sjálfkrafa.
features-private-browsing-shake-off-tracking = Hristu af þér óþarfa snuðrara
features-private-browsing-not-only-do-trackers = Ekki aðeins safna snuðrar upplýsingum, heldur minnka þeir afkastagetu vafra. Aðeins huliðsvafur { -brand-name-firefox } lokar á snuðrara í auglýsingum, og þannig geturðu vafrað frjáls.
