...
# HTML page title
features-private-browsing-private-browser = Huliðsgluggi með vörn gegn gagnasöfnun
...
features-private-browsing-not-only-do-trackers = Ekki aðeins safna snuðrar upplýsingum, heldur minnka þeir afkastagetu vafra. Aðeins huliðsgluggi { -brand-name-firefox } lokar á snuðrara í auglýsingum, og þannig geturðu vafrað frjáls.
