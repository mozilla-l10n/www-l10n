...
# Obsolete string
browsers-mobile-at-home-or-on-the-move = Heima eða á ferðinni, þú átt skilið næði á hverju tæki. Aukin rakningarvernd er sjálfvirk í öllum { -brand-name-firefox } farsímavöfrum.
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words; please omit the strong tags if they need to be around multiple words in your language.
# Obsolete string
browsers-mobile-get-the-mobile-browser-privacy = Fáðu þér farsímavafrinn sem setur <strong>friðhelgi þína</strong> í fyrsta sæti.
