...
privacy-principles-data-privacy-principles = Reglur fyrir gagnaleynd
# HTML page description
privacy-principles-mozilla-is-an-open-source = { -brand-name-mozilla } er með opinn kóða og tilgangurinn er að bæta þína upplifun á netinu. Þetta er ástæðan fyrir reglurnar okkar um gagnaöryggi.
# Variables:
...
privacy-principles-design-for-a-thoughtful = Hönnun á að taka mið af því að hanna fyrir ákveðið jafnvægi á milli öryggis og upplifun notanda.
privacy-principles-defense-in-depth = Vörn með dýpt
privacy-principles-maintain-multi-layered = Nota margfaldar öryggisstillingar og aðferðir, sem hægt er að sannreyna opinberlega.
