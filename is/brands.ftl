...
-brand-name-firefox-marketplace = Firefox-markaður
-brand-name-firefox-os = Firefox stýrikerfi
...
-brand-name-irl-podcast = IRL-hlaðvarp
-brand-name-solo-ai = Sóló gervigreind
