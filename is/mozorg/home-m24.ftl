...
# HTML Page title
m24-home-page-title = Internet fyrir fólk, ekki hagnað - { -brand-name-mozilla }
m24-home-page-title-v2 = { -brand-name-mozilla } - Internet fyrir fólk, ekki hagnað
# HTML page description
m24-home-page-desc = Vissirðu þetta? Að { -brand-name-mozilla } - sem býr til { -brand-name-firefox } - berst fyrir því að viðhalda Internetinu opnu og aðgengilegu fyrir alla.
m24-home-page-desc-v2 = Við erum að vinna að því að setja stjórnina á internetinu aftur í hendur fólksins sem notar það.
