...
history-within-the-first-year-new = Á <a href="{ $firstyear }">fyrsta árinu</a> höfðu nýir samfélagsmeðlimir víðsvegar að úr heiminum þegar lagt til nýja virkni, bætt fyrirliggjandi eiginleika og tekið þátt í stjórnun og skipulagningu verkefnisins sjálfs.
# Variables:
...
history-for-more-information-about = Fyrir frekari upplýsingar um sögu { -brand-name-mozilla }, geturðu skoðað eftirfarandi:
