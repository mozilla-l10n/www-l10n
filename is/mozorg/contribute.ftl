...
contribute-mission-desc = Okkar takmark er að stuðla að því að internetið sé opið, opinbert og fyrir alla. Að internetið sé þar sem fólkið er í forgangi, þar sem einstaklingar geta mótað sína eigin upplifun og hafa völd til þess að vera öruggir og sjálfstæðir.
contribute-learn = Frekari upplýsingar um { -brand-name-mozilla }
contribute-read-manifesto = Lestu stefnuskrána okkar
contribute-find-event = Finndu viðburð
contribute-meet-volunteers = Hittu ástríðufulla sjálfboðaliða okkar
